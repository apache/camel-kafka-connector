...
You can use the Camel Kafka conenctors also on Kubernetes and OpenShift with the link:https://strimzi.io[Strimzi project].
...
We can nowinstall the Strimzi operator into this project:
