...
| *camel.source.endpoint.delay* | Milliseconds before first event is triggered. | 1000L | MEDIUM
...
| *camel.source.endpoint.period* | If greater than 0, generate periodic events every period milliseconds. | 1000L | MEDIUM
