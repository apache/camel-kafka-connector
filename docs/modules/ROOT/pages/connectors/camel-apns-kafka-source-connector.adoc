...
The camel-apns source connector supports 24 options, which are listed below.
...
| *camel.source.path.name* | Name of the endpoint | null | false | MEDIUM
| *camel.source.endpoint.tokens* | Configure this property in case you want to statically declare tokens related to devices you want to notify. Tokens are separated by comma. | null | false | MEDIUM
