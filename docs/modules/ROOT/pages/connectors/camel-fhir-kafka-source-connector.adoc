...
| *camel.source.path.apiName* | What kind of operation to perform One of: [capabilities] [create] [delete] [history] [load-page] [meta] [operation] [patch] [read] [search] [transaction] [update] [validate] | null | HIGH
