...
The camel-jsonata sink connector supports 9 options, which are listed below.
...
| *camel.sink.endpoint.inputType* | Specifies if the output should be Jackson JsonNode or a JSON String. One of: [Jackson] [JsonString] | "Jackson" | false | MEDIUM
