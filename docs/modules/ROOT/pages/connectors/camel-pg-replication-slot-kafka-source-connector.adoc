...
| *camel.source.path.slot* | Replication Slot name | null | true | HIGH
| *camel.source.path.host* | Postgres host | "localhost" | false | MEDIUM
| *camel.source.path.port* | Postgres port | "5432" | false | MEDIUM
| *camel.source.path.database* | Postgres database name | null | true | HIGH
| *camel.source.path.outputPlugin* | Output plugin name | null | true | HIGH
| *camel.source.endpoint.password* | Postgres password | null | false | MEDIUM
| *camel.source.endpoint.user* | Postgres user | "postgres" | false | MEDIUM
...
| *camel.source.endpoint.autoCreateSlot* | Auto create slot if it does not exist | "true" | false | MEDIUM
...
| *camel.source.endpoint.slotOptions* | Slot options to be passed to the output plugin. | null | false | MEDIUM
| *camel.source.endpoint.statusInterval* | Specifies the number of seconds between status packets sent back to Postgres server. | "10" | false | MEDIUM
...
| *camel.component.pg-replication-slot.basicProperty Binding* | Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities | false | false | LOW
|===
