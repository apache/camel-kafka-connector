...
To get started try it out xref:user-guide/getting-started/try-it-out-locally.adoc[locally], on xref:user-guide/getting-started/try-it-out-on-docker.adoc[Docker], on xref:user-guide/getting-started/try-it-out-on-kubernetes.adoc[Kubernetes] or xref:user-guide/getting-started/try-it-out-on-openshift-with-strimzi.adoc[OpenShift] with https://strimzi.io/[Strimzi].
