[[ArchetypeDataformatConnector-ArchetypeDataformatConnector]]
...
[source,bash]
----
> mvn archetype:generate  -DarchetypeGroupId=org.apache.camel.kafkaconnector.archetypes  -DarchetypeArtifactId=camel-kafka-connector-extensible-dataformat-archetype  -DarchetypeVersion=0.8.0-SNAPSHOT
...
[INFO] Archetype repository not defined. Using the one from [org.apache.camel.kafkaconnector.archetypes:camel-kafka-connector-extensible-dataformat-archetype:0.8.0-SNAPSHOT] found in catalog local
...
camel-version: 3.6.0
 Y: : Y
[INFO] ----------------------------------------------------------------------------
[INFO] Using following parameters for creating project from Archetype: camel-kafka-connector-extensible-dataformat-archetype:0.8.0-SNAPSHOT
[INFO] ----------------------------------------------------------------------------
