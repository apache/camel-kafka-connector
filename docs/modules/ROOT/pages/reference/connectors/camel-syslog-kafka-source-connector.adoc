...
The camel-syslog source connector supports is based on camel-netty source connector and supports all its options (see: xref:reference/connectors/camel-netty-kafka-source-connector.adoc[Netty Source Docs]);
