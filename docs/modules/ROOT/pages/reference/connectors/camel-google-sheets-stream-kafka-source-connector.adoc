...
The camel-google-sheets-stream source connector supports 48 options, which are listed below.
...
| *camel.source.path.spreadsheetId* | Specifies the spreadsheet identifier that is used to identify the target to obtain. | null | true | HIGH
