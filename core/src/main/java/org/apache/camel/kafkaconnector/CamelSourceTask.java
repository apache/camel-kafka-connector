...
public class CamelSourceTask extends SourceTask {
	...
	public void start(Map<String, String> props) {
		try {
			...
			// pollingConsumerBlockWhenFull and pollingConsumerBlockTimeout in LOCAL_URL
	...
	public List<SourceRecord> poll() {
		...
		SourceRecord record = new SourceRecord(sourcePartition, sourceOffset, topic, Schema.BYTES_SCHEMA,
