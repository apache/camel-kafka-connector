...
public class CamelSourceConnectorConfig extends CamelConnectorConfig {
    ...
    public static final String CAMEL_SOURCE_KAMELET_DEFAULT = "kamelet:ckcSource";
    public static final String CAMEL_SOURCE_KAMELET_CONF = "camel.source.kamelet";
    public static final String CAMEL_SOURCE_KAMELET_DOC = "The kamelet to use as the Camel source endpoint. This is normally set by default for you.";
    ...
    private static final ConfigDef CONFIG_DEF = new ConfigDef()
        ...
        .define(CAMEL_SOURCE_KAMELET_CONF, Type.STRING, CAMEL_SOURCE_KAMELET_DEFAULT, Importance.MEDIUM, CAMEL_SOURCE_KAMELET_DOC)
        ...
        .define(CAMEL_CONNECTOR_ERROR_HANDLER_CONF, Type.STRING, CAMEL_CONNECTOR_ERROR_HANDLER_DEFAULT, CAMEL_CONNECTOR_ERROR_HANDLER_VALIDATOR, Importance.LOW, CAMEL_CONNECTOR_ERROR_HANDLER_DOC)
        ...
        .define(CAMEL_CONNECTOR_IDEMPOTENCY_EXPRESSION_TYPE_CONF, Type.STRING, CAMEL_CONNECTOR_IDEMPOTENCY_EXPRESSION_TYPE_DEFAULT,
        CAMEL_CONNECTOR_IDEMPOTENCY_EXPRESSION_TYPE_VALIDATOR, Importance.LOW, CAMEL_CONNECTOR_IDEMPOTENCY_EXPRESSION_TYPE_DOC)
        ...
        .define(CAMEL_CONNECTOR_IDEMPOTENCY_REPOSITORY_TYPE_CONF, Type.STRING, CAMEL_CONNECTOR_IDEMPOTENCY_REPOSITORY_TYPE_DEFAULT,
        CAMEL_CONNECTOR_IDEMPOTENCY_REPOSITORY_TYPE_VALIDATOR, Importance.LOW, CAMEL_CONNECTOR_IDEMPOTENCY_REPOSITORY_TYPE_DOC)
        ...
        .define(CAMEL_CONNECTOR_DUMP_ROUTES_CONF, Type.BOOLEAN, CAMEL_CONNECTOR_DUMP_ROUTES_DEFAULT, Importance.LOW, CAMEL_CONNECTOR_DUMP_ROUTES_DOC);
