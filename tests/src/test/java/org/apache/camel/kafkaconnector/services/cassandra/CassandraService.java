...
/**
 * A specialized container for running the official Cassandra image
 */
public class CassandraService extends GenericContainer {
    private static final String CASSANDRA_IMAGE = "cassandra:2.2";
