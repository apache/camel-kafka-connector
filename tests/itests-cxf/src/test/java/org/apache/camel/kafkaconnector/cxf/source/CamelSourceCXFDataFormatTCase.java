 ...
 */
public class CamelSourceCXFDataFormatTCase extends CamelSourceCXFITCase {
    @Test
    @Timeout(30)
    public void testSendReceiveUsingDataFormat() throws ExecutionException, InterruptedException {
