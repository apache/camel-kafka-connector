...
- Make kafka connect connectors compatible with `ServiceLoad` mode of `plugin.discovery` [\#1644](https://github.com/apache/camel-kafka-connector/issues/1644)
...
- Bump lastReleasedVersion to 4.22.0 and regen [\#1840](https://github.com/apache/camel-kafka-connector/issues/1840)
- Update the Antora playbook on camel-website [\#1839](https://github.com/apache/camel-kafka-connector/issues/1839)
- Create the release note on camel-website [\#1838](https://github.com/apache/camel-kafka-connector/issues/1838)
- Upload the sources to the Apache dist server [\#1837](https://github.com/apache/camel-kafka-connector/issues/1837)
- Release the artifacts on Apache Nexus [\#1836](https://github.com/apache/camel-kafka-connector/issues/1836)
- Close the VOTE and send the \[RESULT\] email [\#1835](https://github.com/apache/camel-kafka-connector/issues/1835)
- Update documentation versions in antora.yml [\#1834](https://github.com/apache/camel-kafka-connector/issues/1834)
- Merge the release branch back into main [\#1833](https://github.com/apache/camel-kafka-connector/issues/1833)
- Open the release VOTE on dev@camel.apache.org [\#1832](https://github.com/apache/camel-kafka-connector/issues/1832)
- Upload the staging sources to the Apache dev SVN [\#1831](https://github.com/apache/camel-kafka-connector/issues/1831)
- Close the Apache Nexus staging repository [\#1830](https://github.com/apache/camel-kafka-connector/issues/1830)
- Run release:prepare and release:perform for 4.22.0 [\#1829](https://github.com/apache/camel-kafka-connector/issues/1829)
- Create the release branch camel-kafka-connector-4.22.x [\#1828](https://github.com/apache/camel-kafka-connector/issues/1828)
- Curate and close the 4.22.0 GitHub milestone [\#1827](https://github.com/apache/camel-kafka-connector/issues/1827)
- Upgrade to Camel 4.22.0 and Kamelets catalog 4.22.0 [\#1826](https://github.com/apache/camel-kafka-connector/issues/1826)
...
- Fix \#1826: upgrade to Camel 4.22.0 and Kamelets catalog 4.22.0 [\#1841](https://github.com/apache/camel-kafka-connector/pull/1841) ([oscerd](https://github.com/oscerd))
- Fix \#1803: hold back sink offsets until the aggregated exchange is delivered [\#1821](https://github.com/apache/camel-kafka-connector/pull/1821) ([oscerd](https://github.com/oscerd))
- Fix \#1802: acknowledge a source exchange only after every topic has committed [\#1820](https://github.com/apache/camel-kafka-connector/pull/1820) ([oscerd](https://github.com/oscerd))
- chore: assert the ckcMarshal route template still marshals [\#1818](https://github.com/apache/camel-kafka-connector/pull/1818) ([oscerd](https://github.com/oscerd))
- Fix \#1804: harden CI workflows and pin the build toolchain [\#1816](https://github.com/apache/camel-kafka-connector/pull/1816) ([oscerd](https://github.com/oscerd))
- Fix \#1806: apply camel.remove.headers.pattern before the sink route stages [\#1815](https://github.com/apache/camel-kafka-connector/pull/1815) ([oscerd](https://github.com/oscerd))
- Fix \#1797: sanitize property values in the startup properties log [\#1814](https://github.com/apache/camel-kafka-connector/pull/1814) ([oscerd](https://github.com/oscerd))
- ci: fix checkstyle import order in DataFormatTest [\#1813](https://github.com/apache/camel-kafka-connector/pull/1813) ([oscerd](https://github.com/oscerd))
- Fix \#1801: reject unknown values for enum-like connector options [\#1812](https://github.com/apache/camel-kafka-connector/pull/1812) ([oscerd](https://github.com/oscerd))
- Fix \#1800: scope the SMT TypeConverter and CamelContext to the instance [\#1811](https://github.com/apache/camel-kafka-connector/pull/1811) ([oscerd](https://github.com/oscerd))
- Fix \#1799: FileTransforms fails the record instead of emitting a null value [\#1810](https://github.com/apache/camel-kafka-connector/pull/1810) ([oscerd](https://github.com/oscerd))
- Sync password-typed connector options with the generator [\#1809](https://github.com/apache/camel-kafka-connector/pull/1809) ([oscerd](https://github.com/oscerd))
- Fix \#1795: use unmarshal instead of marshal in ckcUnMarshal route template [\#1796](https://github.com/apache/camel-kafka-connector/pull/1796) ([adityaanikam](https://github.com/adityaanikam))
- Fix \#1786: Resolve open TODO/XXX comments in core module [\#1789](https://github.com/apache/camel-kafka-connector/pull/1789) ([oscerd](https://github.com/oscerd))
- Eliminate generated Task classes from connector modules [\#1788](https://github.com/apache/camel-kafka-connector/pull/1788) ([oscerd](https://github.com/oscerd))
- build\(deps\): bump actions/cache from 5 to 6 [\#1784](https://github.com/apache/camel-kafka-connector/pull/1784) ([dependabot[bot]](https://github.com/apps/dependabot))
- build\(deps\): bump actions/setup-java from 5.2.0 to 5.4.0 [\#1783](https://github.com/apache/camel-kafka-connector/pull/1783) ([dependabot[bot]](https://github.com/apps/dependabot))
- Add OSS Helper project rules for AI-assisted contributions [\#1782](https://github.com/apache/camel-kafka-connector/pull/1782) ([orpiske](https://github.com/orpiske))
- build\(deps\): bump actions/checkout from 6.0.2 to 7.0.0 [\#1780](https://github.com/apache/camel-kafka-connector/pull/1780) ([dependabot[bot]](https://github.com/apps/dependabot))
- Upgrade to Apache Kafka 4.2.1 [\#1779](https://github.com/apache/camel-kafka-connector/pull/1779) ([oscerd](https://github.com/oscerd))
- ci: use relative links in security-model.adoc [\#1774](https://github.com/apache/camel-kafka-connector/pull/1774) ([oscerd](https://github.com/oscerd))
- \[INFRA\] Set up default rulesets for default and release branches [\#1773](https://github.com/apache/camel-kafka-connector/pull/1773) ([asf-gitbox-commits](https://github.com/asf-gitbox-commits))
- ci: fix broken build - define squareup-okhttp-version for itests [\#1772](https://github.com/apache/camel-kafka-connector/pull/1772) ([oscerd](https://github.com/oscerd))
- Add project Security Model, SECURITY.md and AGENTS.md [\#1771](https://github.com/apache/camel-kafka-connector/pull/1771) ([oscerd](https://github.com/oscerd))
- build\(deps\): bump actions/dependency-review-action from 4 to 5 [\#1770](https://github.com/apache/camel-kafka-connector/pull/1770) ([dependabot[bot]](https://github.com/apps/dependabot))
- build\(deps\): bump org.postgresql:postgresql from 42.7.10 to 42.7.11 in /connectors/camel-postgresql-sink-kafka-connector [\#1769](https://github.com/apache/camel-kafka-connector/pull/1769) ([dependabot[bot]](https://github.com/apps/dependabot))
- build\(deps-dev\): bump org.postgresql:postgresql from 42.4.4 to 42.7.11 in /parent [\#1768](https://github.com/apache/camel-kafka-connector/pull/1768) ([dependabot[bot]](https://github.com/apps/dependabot))
- ci: bump camel version from 4.19.0-SNAPSHOT to 4.21.0-SNAPSHOT [\#1766](https://github.com/apache/camel-kafka-connector/pull/1766) ([Croway](https://github.com/Croway))
...
- build\(deps-dev\): bump org.apache.kafka:kafka-clients from 3.9.1 to 3.9.2 in /parent [\#1763](https://github.com/apache/camel-kafka-connector/pull/1763) ([dependabot[bot]](https://github.com/apps/dependabot))
...
- Bump actions/checkout from 4.2.0 to 4.2.2 [\#1684](https://github.com/apache/camel-kafka-connector/pull/1684) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump org.apache.avro:avro from 1.11.3 to 1.11.4 in /core [\#1680](https://github.com/apache/camel-kafka-connector/pull/1680) ([dependabot[bot]](https://github.com/apps/dependabot))
...
- \[Github Actions\] Periodic Sync Camel-kafka-connector main Branch [\#1651](https://github.com/apache/camel-kafka-connector/pull/1651) ([github-actions[bot]](https://github.com/apps/github-actions))
- Bump com.azure:azure-identity from 1.11.1 to 1.12.2 in /connectors/camel-kafka-azure-schema-registry-source-kafka-connector [\#1650](https://github.com/apache/camel-kafka-connector/pull/1650) ([dependabot[bot]](https://github.com/apps/dependabot))
...
- Bump actions/checkout from 4.1.1 to 4.1.4 [\#1616](https://github.com/apache/camel-kafka-connector/pull/1616) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump peter-evans/create-pull-request from 6.0.1 to 6.0.5 [\#1615](https://github.com/apache/camel-kafka-connector/pull/1615) ([dependabot[bot]](https://github.com/apps/dependabot))
...
- Bump org.postgresql:postgresql from 42.7.1 to 42.7.2 in /connectors/camel-postgresql-sink-kafka-connector [\#1601](https://github.com/apache/camel-kafka-connector/pull/1601) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump org.postgresql:postgresql from 42.7.1 to 42.7.2 in /connectors/camel-postgresql-source-kafka-connector [\#1599](https://github.com/apache/camel-kafka-connector/pull/1599) ([dependabot[bot]](https://github.com/apps/dependabot))
