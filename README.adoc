...
Read https://camel.apache.org/camel-kafka-connector/latest/index.html[official latest documentation] or the local link:./docs/modules/ROOT/pages/getting-started.adoc[Getting started guide].
