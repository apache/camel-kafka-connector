...
public class CamelAws2kinesisSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AWS2KINESIS_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_CONF = "camel.source.endpoint.useDefaultCredentialsProvider";
    public static final String CAMEL_SOURCE_AWS2KINESIS_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_DOC = "Set whether the Kinesis client should expect to load credentials through a default credentials provider or to expect static credentials to be passed in.";
    public static final Boolean CAMEL_SOURCE_AWS2KINESIS_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_AWS2KINESIS_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_CONF = "camel.component.aws2-kinesis.useDefaultCredentialsProvider";
    public static final String CAMEL_SOURCE_AWS2KINESIS_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_DOC = "Set whether the Kinesis client should expect to load credentials through a default credentials provider or to expect static credentials to be passed in.";
    public static final Boolean CAMEL_SOURCE_AWS2KINESIS_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_AWS2KINESIS_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AWS2KINESIS_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWS2KINESIS_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_DOC);
        ...
        conf.define(CAMEL_SOURCE_AWS2KINESIS_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AWS2KINESIS_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWS2KINESIS_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_DOC);
