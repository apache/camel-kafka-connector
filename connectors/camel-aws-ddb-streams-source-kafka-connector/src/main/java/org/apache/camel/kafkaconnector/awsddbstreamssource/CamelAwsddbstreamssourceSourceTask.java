...
public class CamelAwsddbstreamssourceSourceTask extends CamelSourceTask {

    @Override
    protected CamelSourceConnectorConfig getCamelSourceConnectorConfig(
            Map<String, String> props) {
        return new CamelAwsddbstreamssourceSourceConnectorConfig(props);
    }
    @Override
    protected String getSourceKamelet() {
        return "kamelet:aws-ddb-streams-source";
    }
}