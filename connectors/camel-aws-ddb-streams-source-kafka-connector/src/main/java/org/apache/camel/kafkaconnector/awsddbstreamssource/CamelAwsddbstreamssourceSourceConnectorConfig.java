...
public class CamelAwsddbstreamssourceSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_CONF = "camel.kamelet.aws-ddb-streams-source.useProfileCredentialsProvider";
    public static final String CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DOC = "Set whether the DynamoDB client should expect to load credentials through a profile credentials provider.";
    public static final Boolean CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DEFAULT = false;
    public static final String CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_USE_SESSION_CREDENTIALS_CONF = "camel.kamelet.aws-ddb-streams-source.useSessionCredentials";
    public static final String CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_USE_SESSION_CREDENTIALS_DOC = "Set whether the DynamoDB client should expect to use Session Credentials. This is useful in situation in which the user needs to assume a IAM role for doing operations in DynamoDB.";
    public static final Boolean CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_USE_SESSION_CREDENTIALS_DEFAULT = false;
    public static final String CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_PROFILE_CREDENTIALS_NAME_CONF = "camel.kamelet.aws-ddb-streams-source.profileCredentialsName";
    public static final String CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_PROFILE_CREDENTIALS_NAME_DOC = "If using a profile credentials provider this parameter will set the profile name.";
    public static final String CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_PROFILE_CREDENTIALS_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_SESSION_TOKEN_CONF = "camel.kamelet.aws-ddb-streams-source.sessionToken";
    public static final String CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_SESSION_TOKEN_DOC = "Amazon AWS Session Token used when the user needs to assume a IAM role.";
    public static final String CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_SESSION_TOKEN_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DOC);
        conf.define(CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_USE_SESSION_CREDENTIALS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_USE_SESSION_CREDENTIALS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_USE_SESSION_CREDENTIALS_DOC);
        conf.define(CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_PROFILE_CREDENTIALS_NAME_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_PROFILE_CREDENTIALS_NAME_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_PROFILE_CREDENTIALS_NAME_DOC);
        conf.define(CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_SESSION_TOKEN_CONF, ConfigDef.Type.PASSWORD, CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_SESSION_TOKEN_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSDDBSTREAMSSOURCE_KAMELET_SESSION_TOKEN_DOC);
