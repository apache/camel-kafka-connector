...
public class CamelAws2eventbridgeSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_ENDPOINT_OPERATION_DOC = "The operation to perform One of: [putRule] [putTargets]";
    ...
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_ENDPOINT_PROXY_HOST_DOC = "To define a proxy host when instantiating the STS client";
    ...
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_ENDPOINT_PROXY_PORT_DOC = "To define a proxy port when instantiating the STS client";
    ...
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_ENDPOINT_PROXY_PROTOCOL_DOC = "To define a proxy protocol when instantiating the STS client One of: [HTTP] [HTTPS]";
    ...
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_ENDPOINT_REGION_DOC = "The region in which STS client needs to work. When using this parameter, the configuration will expect the lowercase name of the region (for example ap-east-1) You'll need to use the name Region.EU_WEST_1.id()";
    ...
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SINK_AWS2EVENTBRIDGE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_AUTO_DISCOVER_CLIENT_CONF = "camel.component.aws2-eventbridge.autoDiscoverClient";
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_AUTO_DISCOVER_CLIENT_DOC = "Setting the autoDiscoverClient mechanism, if true, the component will look for a client instance in the registry automatically otherwise it will skip that checking.";
    public static final Boolean CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_AUTO_DISCOVER_CLIENT_DEFAULT = true;
    ...
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_OPERATION_DOC = "The operation to perform One of: [putRule] [putTargets]";
    ...
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_PROXY_HOST_DOC = "To define a proxy host when instantiating the STS client";
    ...
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_PROXY_PORT_DOC = "To define a proxy port when instantiating the STS client";
    ...
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_PROXY_PROTOCOL_DOC = "To define a proxy protocol when instantiating the STS client One of: [HTTP] [HTTPS]";
    ...
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_REGION_DOC = "The region in which STS client needs to work. When using this parameter, the configuration will expect the lowercase name of the region (for example ap-east-1) You'll need to use the name Region.EU_WEST_1.id()";
    ...
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.aws2-eventbridge.basicPropertyBinding";
    public static final String CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_AWS2EVENTBRIDGE_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_AWS2EVENTBRIDGE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWS2EVENTBRIDGE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
        ...
        conf.define(CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_AWS2EVENTBRIDGE_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
