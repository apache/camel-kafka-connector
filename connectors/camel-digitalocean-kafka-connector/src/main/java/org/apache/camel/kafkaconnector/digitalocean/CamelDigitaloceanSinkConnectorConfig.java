...
public class CamelDigitaloceanSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_DIGITALOCEAN_PATH_OPERATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_DIGITALOCEAN_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_PAGE_CONF = "camel.sink.endpoint.page";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_PAGE_DOC = "Use for pagination. Force the page number.";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_PAGE_DEFAULT = "1";
    public static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_PER_PAGE_CONF = "camel.sink.endpoint.perPage";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_PER_PAGE_DOC = "Use for pagination. Set the number of item per request. The maximum number of results per page is 200.";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_PER_PAGE_DEFAULT = "25";
    public static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_RESOURCE_CONF = "camel.sink.endpoint.resource";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_RESOURCE_DOC = "The DigitalOcean resource type on which perform the operation. One of: [account] [actions] [blockStorages] [droplets] [mages] [snapshots] [keys] [regions] [sizes] [floatingIPs] [tags]";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_RESOURCE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_DIGITALOCEAN_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_DIGITAL_OCEAN_CLIENT_DOC = "To use a existing configured DigitalOceanClient as client";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_DIGITAL_OCEAN_CLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_DIGITALOCEAN_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_HTTP_PROXY_HOST_CONF = "camel.sink.endpoint.httpProxyHost";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_HTTP_PROXY_HOST_DOC = "Set a proxy host if needed";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_HTTP_PROXY_HOST_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_HTTP_PROXY_PASSWORD_DOC = "Set a proxy password if needed";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_HTTP_PROXY_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_HTTP_PROXY_PORT_CONF = "camel.sink.endpoint.httpProxyPort";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_HTTP_PROXY_PORT_DOC = "Set a proxy port if needed";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_HTTP_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_HTTP_PROXY_USER_CONF = "camel.sink.endpoint.httpProxyUser";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_HTTP_PROXY_USER_DOC = "Set a proxy host if needed";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_HTTP_PROXY_USER_DEFAULT = null;
    public static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_OAUTH_TOKEN_CONF = "camel.sink.endpoint.oAuthToken";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_OAUTH_TOKEN_DOC = "DigitalOcean OAuth Token";
    private static final String CAMEL_SINK_DIGITALOCEAN_ENDPOINT_OAUTH_TOKEN_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_DIGITALOCEAN_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_DIGITALOCEAN_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_DIGITALOCEAN_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
