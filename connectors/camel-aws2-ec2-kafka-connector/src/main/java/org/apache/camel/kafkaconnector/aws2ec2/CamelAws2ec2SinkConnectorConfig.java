...
public class CamelAws2ec2SinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWS2EC2_COMPONENT_REGION_DOC = "The region in which EC2 client needs to work";
    ...
    public static final String CAMEL_SINK_AWS2EC2_COMPONENT_CONFIGURATION_DOC = "The AWS EC2 default configuration";
