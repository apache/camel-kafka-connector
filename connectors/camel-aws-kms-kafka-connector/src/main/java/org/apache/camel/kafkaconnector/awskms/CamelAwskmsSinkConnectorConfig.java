...
public class CamelAwskmsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWSKMS_COMPONENT_REGION_DOC = "The region in which KMS client needs to work";
    ...
    public static final String CAMEL_SINK_AWSKMS_COMPONENT_CONFIGURATION_DOC = "The AWS KMS default configuration";
