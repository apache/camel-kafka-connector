...
public class CamelSchedulerSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_SCHEDULER_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component. Use value spring or quartz for built in scheduler";
