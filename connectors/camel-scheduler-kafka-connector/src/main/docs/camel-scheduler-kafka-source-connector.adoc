...
| *camel.source.path.name* | The name of the scheduler | null | true | HIGH
...
| *camel.component.scheduler.basicPropertyBinding* | Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities | false | false | LOW
