...
public class CamelScpSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_SCP_PATH_HOST_DOC = "Hostname of the FTP server";
    private static final String CAMEL_SINK_SCP_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_SCP_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_SCP_PATH_PORT_DOC = "Port of the FTP server";
    private static final Integer CAMEL_SINK_SCP_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_SCP_PATH_DIRECTORY_NAME_CONF = "camel.sink.path.directoryName";
    private static final String CAMEL_SINK_SCP_PATH_DIRECTORY_NAME_DOC = "The starting directory";
    private static final String CAMEL_SINK_SCP_PATH_DIRECTORY_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_SCP_ENDPOINT_CHMOD_CONF = "camel.sink.endpoint.chmod";
    private static final String CAMEL_SINK_SCP_ENDPOINT_CHMOD_DOC = "Allows you to set chmod on the stored file. For example chmod=664.";
    private static final String CAMEL_SINK_SCP_ENDPOINT_CHMOD_DEFAULT = "664";
    ...
    private static final Boolean CAMEL_SINK_SCP_ENDPOINT_DISCONNECT_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SCP_ENDPOINT_FILE_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SCP_ENDPOINT_FLATTEN_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SCP_ENDPOINT_JAIL_STARTING_DIRECTORY_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_SCP_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SCP_ENDPOINT_STRICT_HOST_KEY_CHECKING_DOC = "Sets whether to use strict host key checking. Possible values are: no, yes One of: [no] [yes]";
    private static final String CAMEL_SINK_SCP_ENDPOINT_STRICT_HOST_KEY_CHECKING_DEFAULT = "no";
    ...
    private static final Boolean CAMEL_SINK_SCP_ENDPOINT_ALLOW_NULL_BODY_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SCP_ENDPOINT_DISCONNECT_ON_BATCH_COMPLETE_DOC = "Whether or not to disconnect from remote FTP server right after a Batch upload is complete. disconnectOnBatchComplete will only disconnect the current connection to the FTP server.";
    private static final Boolean CAMEL_SINK_SCP_ENDPOINT_DISCONNECT_ON_BATCH_COMPLETE_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SCP_ENDPOINT_MOVE_EXISTING_FILE_STRATEGY_DOC = "Strategy (Custom Strategy) used to move file with special naming token to use when fileExist=Move is configured. By default, there is an implementation used if no custom strategy is provided";
    private static final String CAMEL_SINK_SCP_ENDPOINT_MOVE_EXISTING_FILE_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SINK_SCP_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_SCP_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SCP_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SCP_ENDPOINT_CONNECT_TIMEOUT_CONF = "camel.sink.endpoint.connectTimeout";
    private static final String CAMEL_SINK_SCP_ENDPOINT_CONNECT_TIMEOUT_DOC = "Sets the connect timeout for waiting for a connection to be established Used by both FTPClient and JSCH";
    private static final Integer CAMEL_SINK_SCP_ENDPOINT_CONNECT_TIMEOUT_DEFAULT = 10000;
    ...
    private static final Integer CAMEL_SINK_SCP_ENDPOINT_SO_TIMEOUT_DEFAULT = 300000;
    public static final String CAMEL_SINK_SCP_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_SCP_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_SCP_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_SCP_ENDPOINT_TIMEOUT_CONF = "camel.sink.endpoint.timeout";
    private static final String CAMEL_SINK_SCP_ENDPOINT_TIMEOUT_DOC = "Sets the data timeout for waiting for reply Used only by FTPClient";
    private static final Integer CAMEL_SINK_SCP_ENDPOINT_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SINK_SCP_ENDPOINT_KNOWN_HOSTS_FILE_CONF = "camel.sink.endpoint.knownHostsFile";
    private static final String CAMEL_SINK_SCP_ENDPOINT_KNOWN_HOSTS_FILE_DOC = "Sets the known_hosts file, so that the jsch endpoint can do host key verification. You can prefix with classpath: to load the file from classpath instead of file system.";
    private static final String CAMEL_SINK_SCP_ENDPOINT_KNOWN_HOSTS_FILE_DEFAULT = null;
    public static final String CAMEL_SINK_SCP_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_SCP_ENDPOINT_PASSWORD_DOC = "Password to use for login";
    private static final String CAMEL_SINK_SCP_ENDPOINT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SCP_ENDPOINT_PREFERRED_AUTHENTICATIONS_DEFAULT = null;
    public static final String CAMEL_SINK_SCP_ENDPOINT_PRIVATE_KEY_BYTES_CONF = "camel.sink.endpoint.privateKeyBytes";
    private static final String CAMEL_SINK_SCP_ENDPOINT_PRIVATE_KEY_BYTES_DOC = "Set the private key bytes to that the endpoint can do private key verification. This must be used only if privateKeyFile wasn't set. Otherwise the file will have the priority.";
    private static final String CAMEL_SINK_SCP_ENDPOINT_PRIVATE_KEY_BYTES_DEFAULT = null;
    public static final String CAMEL_SINK_SCP_ENDPOINT_PRIVATE_KEY_FILE_CONF = "camel.sink.endpoint.privateKeyFile";
    private static final String CAMEL_SINK_SCP_ENDPOINT_PRIVATE_KEY_FILE_DOC = "Set the private key file to that the endpoint can do private key verification. You can prefix with classpath: to load the file from classpath instead of file system.";
    private static final String CAMEL_SINK_SCP_ENDPOINT_PRIVATE_KEY_FILE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SCP_ENDPOINT_PRIVATE_KEY_FILE_PASSPHRASE_DOC = "Set the private key file passphrase to that the endpoint can do private key verification.";
    private static final String CAMEL_SINK_SCP_ENDPOINT_PRIVATE_KEY_FILE_PASSPHRASE_DEFAULT = null;
    public static final String CAMEL_SINK_SCP_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_SCP_ENDPOINT_USERNAME_DOC = "Username to use for login";
    private static final String CAMEL_SINK_SCP_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SCP_ENDPOINT_USE_USER_KNOWN_HOSTS_FILE_DOC = "If knownHostFile has not been explicit configured, then use the host file from System.getProperty(user.home) /.ssh/known_hosts";
    private static final Boolean CAMEL_SINK_SCP_ENDPOINT_USE_USER_KNOWN_HOSTS_FILE_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_SCP_ENDPOINT_CIPHERS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SCP_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_SCP_COMPONENT_VERBOSE_LOGGING_CONF = "camel.component.scp.verboseLogging";
    private static final String CAMEL_SINK_SCP_COMPONENT_VERBOSE_LOGGING_DOC = "JSCH is verbose logging out of the box. Therefore we turn the logging down to DEBUG logging by default. But setting this option to true turns on the verbose logging again.";
    private static final Boolean CAMEL_SINK_SCP_COMPONENT_VERBOSE_LOGGING_DEFAULT = false;
    public static final String CAMEL_SINK_SCP_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.scp.basicPropertyBinding";
    private static final String CAMEL_SINK_SCP_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SCP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
