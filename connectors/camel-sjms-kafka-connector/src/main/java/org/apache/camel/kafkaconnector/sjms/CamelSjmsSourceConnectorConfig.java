...
public class CamelSjmsSourceConnectorConfig
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_SJMS_COMPONENT_CONNECTION_PASSWORD_CONF, ConfigDef.Type.PASSWORD, CAMEL_SOURCE_SJMS_COMPONENT_CONNECTION_PASSWORD_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SJMS_COMPONENT_CONNECTION_PASSWORD_DOC);
        conf.define(CAMEL_SOURCE_SJMS_COMPONENT_CONNECTION_USERNAME_CONF, ConfigDef.Type.PASSWORD, CAMEL_SOURCE_SJMS_COMPONENT_CONNECTION_USERNAME_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SJMS_COMPONENT_CONNECTION_USERNAME_DOC);
