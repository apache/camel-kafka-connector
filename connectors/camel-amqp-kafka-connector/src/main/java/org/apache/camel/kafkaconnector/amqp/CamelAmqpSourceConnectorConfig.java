...
public class CamelAmqpSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AMQP_COMPONENT_ACKNOWLEDGEMENT_MODE_CONF = "camel.component.amqp.acknowledgementMode";
    public static final String CAMEL_SOURCE_AMQP_COMPONENT_ACKNOWLEDGEMENT_MODE_DOC = "The JMS acknowledgement mode defined as an Integer. Allows you to set vendor-specific extensions to the acknowledgment mode. For the regular modes, it is preferable to use the acknowledgementModeName instead.";
    public static final Integer CAMEL_SOURCE_AMQP_COMPONENT_ACKNOWLEDGEMENT_MODE_DEFAULT = null;
    ...
    public static final Boolean CAMEL_SOURCE_AMQP_COMPONENT_ALLOW_AUTO_WIRED_CONNECTION_FACTORY_DEFAULT = false;
    ...
    public static final Boolean CAMEL_SOURCE_AMQP_COMPONENT_ALLOW_AUTO_WIRED_DESTINATION_RESOLVER_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_AMQP_COMPONENT_JMS_OPERATIONS_CONF = "camel.component.amqp.jmsOperations";
    public static final String CAMEL_SOURCE_AMQP_COMPONENT_JMS_OPERATIONS_DOC = "Allows you to use your own implementation of the org.springframework.jms.core.JmsOperations interface. Camel uses JmsTemplate as default. Can be used for testing purpose, but not used much as stated in the spring API docs.";
    public static final String CAMEL_SOURCE_AMQP_COMPONENT_JMS_OPERATIONS_DEFAULT = null;
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SOURCE_AMQP_COMPONENT_ACKNOWLEDGEMENT_MODE_CONF, ConfigDef.Type.INT, CAMEL_SOURCE_AMQP_COMPONENT_ACKNOWLEDGEMENT_MODE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AMQP_COMPONENT_ACKNOWLEDGEMENT_MODE_DOC);
        ...
        conf.define(CAMEL_SOURCE_AMQP_COMPONENT_JMS_OPERATIONS_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_AMQP_COMPONENT_JMS_OPERATIONS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AMQP_COMPONENT_JMS_OPERATIONS_DOC);
