...
public class CamelAmqpSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AMQP_ENDPOINT_ARTEMIS_STREAMING_ENABLED_DOC = "Whether optimizing for Apache Artemis streaming mode. This can reduce memory overhead when using Artemis with JMS StreamMessage types. This option must only be enabled if Apache Artemis is being used.";
    public static final Boolean CAMEL_SOURCE_AMQP_ENDPOINT_ARTEMIS_STREAMING_ENABLED_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_AMQP_COMPONENT_ARTEMIS_STREAMING_ENABLED_DOC = "Whether optimizing for Apache Artemis streaming mode. This can reduce memory overhead when using Artemis with JMS StreamMessage types. This option must only be enabled if Apache Artemis is being used.";
    public static final Boolean CAMEL_SOURCE_AMQP_COMPONENT_ARTEMIS_STREAMING_ENABLED_DEFAULT = false;
