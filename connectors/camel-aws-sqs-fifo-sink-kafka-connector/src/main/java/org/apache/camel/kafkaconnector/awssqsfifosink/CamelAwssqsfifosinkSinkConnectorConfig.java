...
public class CamelAwssqsfifosinkSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_AWSSQSFIFOSINK_KAMELET_PROFILE_CREDENTIALS_NAME_DOC = "If using a profile credentials provider this parameter sets the profile name.";
