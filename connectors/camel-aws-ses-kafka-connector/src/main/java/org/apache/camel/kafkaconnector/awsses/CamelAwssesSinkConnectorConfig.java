...
public class CamelAwssesSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWSSES_COMPONENT_REGION_DOC = "The region in which SES client needs to work";
    ...
    public static final String CAMEL_SINK_AWSSES_COMPONENT_CONFIGURATION_DOC = "The AWS SES default configuration";
