...
public class CamelAvroSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_AVRO_PATH_TRANSPORT_DOC = "Transport to use, can be either http or netty One of: [http] [netty]";
    private static final String CAMEL_SINK_AVRO_PATH_TRANSPORT_DEFAULT = null;
    public static final String CAMEL_SINK_AVRO_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_AVRO_PATH_PORT_DOC = "Port number to use";
    private static final Integer CAMEL_SINK_AVRO_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_AVRO_PATH_HOST_CONF = "camel.sink.path.host";
    private static final String CAMEL_SINK_AVRO_PATH_HOST_DOC = "Hostname to use";
    private static final String CAMEL_SINK_AVRO_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_AVRO_PATH_MESSAGE_NAME_CONF = "camel.sink.path.messageName";
    private static final String CAMEL_SINK_AVRO_PATH_MESSAGE_NAME_DOC = "The name of the message to send.";
    private static final String CAMEL_SINK_AVRO_PATH_MESSAGE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_AVRO_ENDPOINT_PROTOCOL_CONF = "camel.sink.endpoint.protocol";
    private static final String CAMEL_SINK_AVRO_ENDPOINT_PROTOCOL_DOC = "Avro protocol to use";
    private static final String CAMEL_SINK_AVRO_ENDPOINT_PROTOCOL_DEFAULT = null;
    public static final String CAMEL_SINK_AVRO_ENDPOINT_PROTOCOL_CLASS_NAME_CONF = "camel.sink.endpoint.protocolClassName";
    private static final String CAMEL_SINK_AVRO_ENDPOINT_PROTOCOL_CLASS_NAME_DOC = "Avro protocol to use defined by the FQN class name";
    private static final String CAMEL_SINK_AVRO_ENDPOINT_PROTOCOL_CLASS_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_AVRO_ENDPOINT_PROTOCOL_LOCATION_CONF = "camel.sink.endpoint.protocolLocation";
    private static final String CAMEL_SINK_AVRO_ENDPOINT_PROTOCOL_LOCATION_DOC = "Avro protocol location";
    private static final String CAMEL_SINK_AVRO_ENDPOINT_PROTOCOL_LOCATION_DEFAULT = null;
    public static final String CAMEL_SINK_AVRO_ENDPOINT_REFLECTION_PROTOCOL_CONF = "camel.sink.endpoint.reflectionProtocol";
    private static final String CAMEL_SINK_AVRO_ENDPOINT_REFLECTION_PROTOCOL_DOC = "If protocol object provided is reflection protocol. Should be used only with protocol parameter because for protocolClassName protocol type will be auto detected";
    private static final Boolean CAMEL_SINK_AVRO_ENDPOINT_REFLECTION_PROTOCOL_DEFAULT = false;
    public static final String CAMEL_SINK_AVRO_ENDPOINT_SINGLE_PARAMETER_CONF = "camel.sink.endpoint.singleParameter";
    private static final String CAMEL_SINK_AVRO_ENDPOINT_SINGLE_PARAMETER_DOC = "If true, consumer parameter won't be wrapped into array. Will fail if protocol specifies more then 1 parameter for the message";
    private static final Boolean CAMEL_SINK_AVRO_ENDPOINT_SINGLE_PARAMETER_DEFAULT = false;
    public static final String CAMEL_SINK_AVRO_ENDPOINT_URI_AUTHORITY_CONF = "camel.sink.endpoint.uriAuthority";
    private static final String CAMEL_SINK_AVRO_ENDPOINT_URI_AUTHORITY_DOC = "Authority to use (username and password)";
    private static final String CAMEL_SINK_AVRO_ENDPOINT_URI_AUTHORITY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_AVRO_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_AVRO_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_AVRO_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AVRO_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AVRO_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_AVRO_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_AVRO_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_AVRO_COMPONENT_PROTOCOL_CONF = "camel.component.avro.protocol";
    private static final String CAMEL_SINK_AVRO_COMPONENT_PROTOCOL_DOC = "Avro protocol to use";
    private static final String CAMEL_SINK_AVRO_COMPONENT_PROTOCOL_DEFAULT = null;
    public static final String CAMEL_SINK_AVRO_COMPONENT_PROTOCOL_CLASS_NAME_CONF = "camel.component.avro.protocolClassName";
    private static final String CAMEL_SINK_AVRO_COMPONENT_PROTOCOL_CLASS_NAME_DOC = "Avro protocol to use defined by the FQN class name";
    private static final String CAMEL_SINK_AVRO_COMPONENT_PROTOCOL_CLASS_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_AVRO_COMPONENT_PROTOCOL_LOCATION_CONF = "camel.component.avro.protocolLocation";
    private static final String CAMEL_SINK_AVRO_COMPONENT_PROTOCOL_LOCATION_DOC = "Avro protocol location";
    private static final String CAMEL_SINK_AVRO_COMPONENT_PROTOCOL_LOCATION_DEFAULT = null;
    public static final String CAMEL_SINK_AVRO_COMPONENT_REFLECTION_PROTOCOL_CONF = "camel.component.avro.reflectionProtocol";
    private static final String CAMEL_SINK_AVRO_COMPONENT_REFLECTION_PROTOCOL_DOC = "If protocol object provided is reflection protocol. Should be used only with protocol parameter because for protocolClassName protocol type will be auto detected";
    private static final Boolean CAMEL_SINK_AVRO_COMPONENT_REFLECTION_PROTOCOL_DEFAULT = false;
    public static final String CAMEL_SINK_AVRO_COMPONENT_SINGLE_PARAMETER_CONF = "camel.component.avro.singleParameter";
    private static final String CAMEL_SINK_AVRO_COMPONENT_SINGLE_PARAMETER_DOC = "If true, consumer parameter won't be wrapped into array. Will fail if protocol specifies more then 1 parameter for the message";
    private static final Boolean CAMEL_SINK_AVRO_COMPONENT_SINGLE_PARAMETER_DEFAULT = false;
    public static final String CAMEL_SINK_AVRO_COMPONENT_URI_AUTHORITY_CONF = "camel.component.avro.uriAuthority";
    private static final String CAMEL_SINK_AVRO_COMPONENT_URI_AUTHORITY_DOC = "Authority to use (username and password)";
    private static final String CAMEL_SINK_AVRO_COMPONENT_URI_AUTHORITY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_AVRO_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_AVRO_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AVRO_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AVRO_COMPONENT_CONFIGURATION_CONF = "camel.component.avro.configuration";
    private static final String CAMEL_SINK_AVRO_COMPONENT_CONFIGURATION_DOC = "To use a shared AvroConfiguration to configure options once";
    private static final String CAMEL_SINK_AVRO_COMPONENT_CONFIGURATION_DEFAULT = null;
