...
public class CamelMsvSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_MSV_PATH_RESOURCE_URI_DOC = "URL to a local resource on the classpath, or a reference to lookup a bean in the Registry, or a full URL to a remote resource or resource on the file system which contains the XSD to validate against.";
    private static final String CAMEL_SINK_MSV_PATH_RESOURCE_URI_DEFAULT = null;
    public static final String CAMEL_SINK_MSV_ENDPOINT_FAIL_ON_NULL_BODY_CONF = "camel.sink.endpoint.failOnNullBody";
    private static final String CAMEL_SINK_MSV_ENDPOINT_FAIL_ON_NULL_BODY_DOC = "Whether to fail if no body exists.";
    private static final Boolean CAMEL_SINK_MSV_ENDPOINT_FAIL_ON_NULL_BODY_DEFAULT = true;
    public static final String CAMEL_SINK_MSV_ENDPOINT_FAIL_ON_NULL_HEADER_CONF = "camel.sink.endpoint.failOnNullHeader";
    private static final String CAMEL_SINK_MSV_ENDPOINT_FAIL_ON_NULL_HEADER_DOC = "Whether to fail if no header exists when validating against a header.";
    private static final Boolean CAMEL_SINK_MSV_ENDPOINT_FAIL_ON_NULL_HEADER_DEFAULT = true;
    public static final String CAMEL_SINK_MSV_ENDPOINT_HEADER_NAME_CONF = "camel.sink.endpoint.headerName";
    private static final String CAMEL_SINK_MSV_ENDPOINT_HEADER_NAME_DOC = "To validate against a header instead of the message body.";
    private static final String CAMEL_SINK_MSV_ENDPOINT_HEADER_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_MSV_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_MSV_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_MSV_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_MSV_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_MSV_ENDPOINT_ERROR_HANDLER_CONF = "camel.sink.endpoint.errorHandler";
    private static final String CAMEL_SINK_MSV_ENDPOINT_ERROR_HANDLER_DOC = "To use a custom org.apache.camel.processor.validation.ValidatorErrorHandler. The default error handler captures the errors and throws an exception.";
    private static final String CAMEL_SINK_MSV_ENDPOINT_ERROR_HANDLER_DEFAULT = null;
    public static final String CAMEL_SINK_MSV_ENDPOINT_RESOURCE_RESOLVER_CONF = "camel.sink.endpoint.resourceResolver";
    private static final String CAMEL_SINK_MSV_ENDPOINT_RESOURCE_RESOLVER_DOC = "To use a custom LSResourceResolver. Do not use together with resourceResolverFactory";
    private static final String CAMEL_SINK_MSV_ENDPOINT_RESOURCE_RESOLVER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_MSV_ENDPOINT_RESOURCE_RESOLVER_FACTORY_DEFAULT = null;
    public static final String CAMEL_SINK_MSV_ENDPOINT_SCHEMA_FACTORY_CONF = "camel.sink.endpoint.schemaFactory";
    private static final String CAMEL_SINK_MSV_ENDPOINT_SCHEMA_FACTORY_DOC = "To use a custom javax.xml.validation.SchemaFactory";
    private static final String CAMEL_SINK_MSV_ENDPOINT_SCHEMA_FACTORY_DEFAULT = null;
    public static final String CAMEL_SINK_MSV_ENDPOINT_SCHEMA_LANGUAGE_CONF = "camel.sink.endpoint.schemaLanguage";
    private static final String CAMEL_SINK_MSV_ENDPOINT_SCHEMA_LANGUAGE_DOC = "Configures the W3C XML Schema Namespace URI.";
    private static final String CAMEL_SINK_MSV_ENDPOINT_SCHEMA_LANGUAGE_DEFAULT = "http://www.w3.org/2001/XMLSchema";
    public static final String CAMEL_SINK_MSV_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_MSV_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_MSV_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_MSV_ENDPOINT_USE_SHARED_SCHEMA_CONF = "camel.sink.endpoint.useSharedSchema";
    private static final String CAMEL_SINK_MSV_ENDPOINT_USE_SHARED_SCHEMA_DOC = "Whether the Schema instance should be shared or not. This option is introduced to work around a JDK 1.6.x bug. Xerces should not have this issue.";
    private static final Boolean CAMEL_SINK_MSV_ENDPOINT_USE_SHARED_SCHEMA_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_MSV_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_MSV_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.msv.basicPropertyBinding";
    private static final String CAMEL_SINK_MSV_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_MSV_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_MSV_COMPONENT_RESOURCE_RESOLVER_FACTORY_DOC = "To use a custom LSResourceResolver which depends on a dynamic endpoint resource URI";
    private static final String CAMEL_SINK_MSV_COMPONENT_RESOURCE_RESOLVER_FACTORY_DEFAULT = null;
    public static final String CAMEL_SINK_MSV_COMPONENT_SCHEMA_FACTORY_CONF = "camel.component.msv.schemaFactory";
    private static final String CAMEL_SINK_MSV_COMPONENT_SCHEMA_FACTORY_DOC = "To use the javax.xml.validation.SchemaFactory.";
    private static final String CAMEL_SINK_MSV_COMPONENT_SCHEMA_FACTORY_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_MSV_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_MSV_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_MSV_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
