...
public class CamelJmsSourceConnectorConfig extends CamelSourceConnectorConfig {
    ...
    public static final String CAMEL_SOURCE_JMS_ENDPOINT_ARTEMIS_CONSUMER_PRIORITY_CONF = "camel.source.endpoint.artemisConsumerPriority";
    ...
    public static final Integer CAMEL_SOURCE_JMS_ENDPOINT_ARTEMIS_CONSUMER_PRIORITY_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_JMS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used";
    ...
    public static final String CAMEL_SOURCE_JMS_COMPONENT_ARTEMIS_CONSUMER_PRIORITY_CONF = "camel.component.jms.artemisConsumerPriority";
    public static final String CAMEL_SOURCE_JMS_COMPONENT_ARTEMIS_CONSUMER_PRIORITY_DOC = "Consumer priorities allow you to ensure that high priority consumers receive messages while they are active. Normally, active consumers connected to a queue receive messages from it in a round-robin fashion. When consumer priorities are in use, messages are delivered round-robin if multiple active consumers exist with the same high priority. Messages will only going to lower priority consumers when the high priority consumers do not have credit available to consume the message, or those high priority consumers have declined to accept the message (for instance because it does not meet the criteria of any selectors associated with the consumer).";
    public static final Integer CAMEL_SOURCE_JMS_COMPONENT_ARTEMIS_CONSUMER_PRIORITY_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_JMS_COMPONENT_AUTOWIRED_ENABLED_CONF = "camel.component.jms.autowiredEnabled";
    public static final String CAMEL_SOURCE_JMS_COMPONENT_AUTOWIRED_ENABLED_DOC = "Whether autowiring is enabled. This is used for automatic autowiring options (the option must be marked as autowired) by looking up in the registry to find if there is a single instance of matching type, which then gets configured on the component. This can be used for automatic configuring JDBC data sources, JMS connection factories, AWS Clients, etc.";
    public static final Boolean CAMEL_SOURCE_JMS_COMPONENT_AUTOWIRED_ENABLED_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_JMS_COMPONENT_SYNCHRONOUS_CONF = "camel.component.jms.synchronous";
    public static final String CAMEL_SOURCE_JMS_COMPONENT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used";
    public static final Boolean CAMEL_SOURCE_JMS_COMPONENT_SYNCHRONOUS_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_JMS_ENDPOINT_ARTEMIS_CONSUMER_PRIORITY_CONF, ConfigDef.Type.INT, CAMEL_SOURCE_JMS_ENDPOINT_ARTEMIS_CONSUMER_PRIORITY_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_JMS_ENDPOINT_ARTEMIS_CONSUMER_PRIORITY_DOC);
        ...
        conf.define(CAMEL_SOURCE_JMS_COMPONENT_ARTEMIS_CONSUMER_PRIORITY_CONF, ConfigDef.Type.INT, CAMEL_SOURCE_JMS_COMPONENT_ARTEMIS_CONSUMER_PRIORITY_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_JMS_COMPONENT_ARTEMIS_CONSUMER_PRIORITY_DOC);
        ...
        conf.define(CAMEL_SOURCE_JMS_COMPONENT_AUTOWIRED_ENABLED_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_JMS_COMPONENT_AUTOWIRED_ENABLED_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_JMS_COMPONENT_AUTOWIRED_ENABLED_DOC);
        ...
        conf.define(CAMEL_SOURCE_JMS_COMPONENT_SYNCHRONOUS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_JMS_COMPONENT_SYNCHRONOUS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_JMS_COMPONENT_SYNCHRONOUS_DOC);
