...
public class CamelTwilioSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_TWILIO_PATH_API_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_TWILIO_PATH_METHOD_NAME_CONF = "camel.sink.path.methodName";
    private static final String CAMEL_SINK_TWILIO_PATH_METHOD_NAME_DOC = "What sub operation to use for the selected operation One of: [create] [delete] [fetch] [read] [update]";
    private static final String CAMEL_SINK_TWILIO_PATH_METHOD_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_TWILIO_ENDPOINT_IN_BODY_CONF = "camel.sink.endpoint.inBody";
    private static final String CAMEL_SINK_TWILIO_ENDPOINT_IN_BODY_DOC = "Sets the name of a parameter to be passed in the exchange In Body";
    private static final String CAMEL_SINK_TWILIO_ENDPOINT_IN_BODY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_TWILIO_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_TWILIO_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_TWILIO_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_TWILIO_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_TWILIO_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_TWILIO_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_TWILIO_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_TWILIO_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_TWILIO_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_TWILIO_COMPONENT_CONFIGURATION_CONF = "camel.component.twilio.configuration";
    private static final String CAMEL_SINK_TWILIO_COMPONENT_CONFIGURATION_DOC = "To use the shared configuration";
    private static final String CAMEL_SINK_TWILIO_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_TWILIO_COMPONENT_REST_CLIENT_CONF = "camel.component.twilio.restClient";
    private static final String CAMEL_SINK_TWILIO_COMPONENT_REST_CLIENT_DOC = "To use the shared REST client";
    private static final String CAMEL_SINK_TWILIO_COMPONENT_REST_CLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_TWILIO_COMPONENT_ACCOUNT_SID_CONF = "camel.component.twilio.accountSid";
    private static final String CAMEL_SINK_TWILIO_COMPONENT_ACCOUNT_SID_DOC = "The account SID to use.";
    private static final String CAMEL_SINK_TWILIO_COMPONENT_ACCOUNT_SID_DEFAULT = null;
    public static final String CAMEL_SINK_TWILIO_COMPONENT_PASSWORD_CONF = "camel.component.twilio.password";
    private static final String CAMEL_SINK_TWILIO_COMPONENT_PASSWORD_DOC = "Auth token for the account.";
    private static final String CAMEL_SINK_TWILIO_COMPONENT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_TWILIO_COMPONENT_USERNAME_CONF = "camel.component.twilio.username";
    private static final String CAMEL_SINK_TWILIO_COMPONENT_USERNAME_DOC = "The account to use.";
    private static final String CAMEL_SINK_TWILIO_COMPONENT_USERNAME_DEFAULT = null;
