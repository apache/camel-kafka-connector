...
public class CamelAwsiamSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWSIAM_COMPONENT_REGION_DOC = "The region in which IAM client needs to work";
    ...
    public static final String CAMEL_SINK_AWSIAM_COMPONENT_CONFIGURATION_DOC = "The AWS IAM default configuration";
