...
public class CamelPahoSourceConnectorConfig
    ...
    public static final Boolean CAMEL_SOURCE_PAHO_COMPONENT_AUTOMATIC_RECONNECT_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_BROKER_URL_DEFAULT = "tcp://localhost:1883";
    ...
    public static final Boolean CAMEL_SOURCE_PAHO_COMPONENT_CLEAN_SESSION_DEFAULT = true;
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_CLIENT_ID_CONF = "camel.component.paho.clientId";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_CLIENT_ID_DOC = "MQTT client identifier. The identifier must be unique.";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_CLIENT_ID_DEFAULT = null;
    ...
    public static final Integer CAMEL_SOURCE_PAHO_COMPONENT_CONNECTION_TIMEOUT_DEFAULT = 30;
    ...
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_FILE_PERSISTENCE_DIRECTORY_DOC = "Base directory used by file persistence. Will by default use user directory.";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_FILE_PERSISTENCE_DIRECTORY_DEFAULT = null;
    ...
    public static final Integer CAMEL_SOURCE_PAHO_COMPONENT_KEEP_ALIVE_INTERVAL_DEFAULT = 60;
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_MAX_INFLIGHT_CONF = "camel.component.paho.maxInflight";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_MAX_INFLIGHT_DOC = "Sets the max inflight. please increase this value in a high traffic environment. The default value is 10";
    public static final Integer CAMEL_SOURCE_PAHO_COMPONENT_MAX_INFLIGHT_DEFAULT = 10;
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_MAX_RECONNECT_DELAY_CONF = "camel.component.paho.maxReconnectDelay";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_MAX_RECONNECT_DELAY_DOC = "Get the maximum time (in millis) to wait between reconnects";
    public static final Integer CAMEL_SOURCE_PAHO_COMPONENT_MAX_RECONNECT_DELAY_DEFAULT = 128000;
    ...
    public static final Integer CAMEL_SOURCE_PAHO_COMPONENT_MQTT_VERSION_DEFAULT = null;
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_PERSISTENCE_CONF = "camel.component.paho.persistence";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_PERSISTENCE_DOC = "Client persistence to be used - memory or file. One of: [FILE] [MEMORY]";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_PERSISTENCE_DEFAULT = "MEMORY";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_QOS_CONF = "camel.component.paho.qos";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_QOS_DOC = "Client quality of service level (0-2).";
    public static final Integer CAMEL_SOURCE_PAHO_COMPONENT_QOS_DEFAULT = 2;
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_RETAINED_CONF = "camel.component.paho.retained";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_RETAINED_DOC = "Retain option";
    public static final Boolean CAMEL_SOURCE_PAHO_COMPONENT_RETAINED_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_SERVER_URIS_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_WILL_PAYLOAD_DEFAULT = null;
    ...
    public static final Integer CAMEL_SOURCE_PAHO_COMPONENT_WILL_QOS_DEFAULT = null;
    ...
    public static final Boolean CAMEL_SOURCE_PAHO_COMPONENT_WILL_RETAINED_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_WILL_TOPIC_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_AUTOWIRED_ENABLED_CONF = "camel.component.paho.autowiredEnabled";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_AUTOWIRED_ENABLED_DOC = "Whether autowiring is enabled. This is used for automatic autowiring options (the option must be marked as autowired) by looking up in the registry to find if there is a single instance of matching type, which then gets configured on the component. This can be used for automatic configuring JDBC data sources, JMS connection factories, AWS Clients, etc.";
    public static final Boolean CAMEL_SOURCE_PAHO_COMPONENT_AUTOWIRED_ENABLED_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_CUSTOM_WEB_SOCKET_HEADERS_DOC = "Sets the Custom WebSocket Headers for the WebSocket Connection.";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_CUSTOM_WEB_SOCKET_HEADERS_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_EXECUTOR_SERVICE_TIMEOUT_DOC = "Set the time in seconds that the executor service should wait when terminating before forcefully terminating. It is not recommended to change this value unless you are absolutely sure that you need to.";
    public static final Integer CAMEL_SOURCE_PAHO_COMPONENT_EXECUTOR_SERVICE_TIMEOUT_DEFAULT = 1;
    ...
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_HTTPS_HOSTNAME_VERIFICATION_ENABLED_DOC = "Whether SSL HostnameVerifier is enabled or not. The default value is true.";
    public static final Boolean CAMEL_SOURCE_PAHO_COMPONENT_HTTPS_HOSTNAME_VERIFICATION_ENABLED_DEFAULT = true;
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_PASSWORD_CONF = "camel.component.paho.password";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_PASSWORD_DOC = "Password to be used for authentication against the MQTT broker";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_PASSWORD_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_SOCKET_FACTORY_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_SSL_CLIENT_PROPS_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_SSL_HOSTNAME_VERIFIER_DOC = "Sets the HostnameVerifier for the SSL connection. Note that it will be used after handshake on a connection and you should do actions by yourself when hostname is verified error. There is no default HostnameVerifier";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_SSL_HOSTNAME_VERIFIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_USER_NAME_CONF = "camel.component.paho.userName";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_USER_NAME_DOC = "Username to be used for authentication against the MQTT broker";
    public static final String CAMEL_SOURCE_PAHO_COMPONENT_USER_NAME_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_PAHO_COMPONENT_AUTOWIRED_ENABLED_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_PAHO_COMPONENT_AUTOWIRED_ENABLED_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_PAHO_COMPONENT_AUTOWIRED_ENABLED_DOC);
