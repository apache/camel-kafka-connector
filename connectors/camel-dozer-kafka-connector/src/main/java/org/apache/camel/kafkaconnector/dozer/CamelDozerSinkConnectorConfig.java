...
public class CamelDozerSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_DOZER_PATH_NAME_DOC = "A human readable name of the mapping.";
    private static final String CAMEL_SINK_DOZER_PATH_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_DOZER_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_DOZER_ENDPOINT_MAPPING_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_DOZER_ENDPOINT_MAPPING_FILE_CONF = "camel.sink.endpoint.mappingFile";
    private static final String CAMEL_SINK_DOZER_ENDPOINT_MAPPING_FILE_DOC = "The location of a Dozer configuration file. The file is loaded from the classpath by default, but you can use file:, classpath:, or http: to load the configuration from a specific location.";
    private static final String CAMEL_SINK_DOZER_ENDPOINT_MAPPING_FILE_DEFAULT = "dozerBeanMapping.xml";
    public static final String CAMEL_SINK_DOZER_ENDPOINT_MARSHAL_ID_CONF = "camel.sink.endpoint.marshalId";
    private static final String CAMEL_SINK_DOZER_ENDPOINT_MARSHAL_ID_DOC = "The id of a dataFormat defined within the Camel Context to use for marshalling the mapping output to a non-Java type.";
    private static final String CAMEL_SINK_DOZER_ENDPOINT_MARSHAL_ID_DEFAULT = null;
    public static final String CAMEL_SINK_DOZER_ENDPOINT_SOURCE_MODEL_CONF = "camel.sink.endpoint.sourceModel";
    private static final String CAMEL_SINK_DOZER_ENDPOINT_SOURCE_MODEL_DOC = "Fully-qualified class name for the source type used in the mapping. If specified, the input to the mapping is converted to the specified type before being mapped with Dozer.";
    private static final String CAMEL_SINK_DOZER_ENDPOINT_SOURCE_MODEL_DEFAULT = null;
    public static final String CAMEL_SINK_DOZER_ENDPOINT_TARGET_MODEL_CONF = "camel.sink.endpoint.targetModel";
    private static final String CAMEL_SINK_DOZER_ENDPOINT_TARGET_MODEL_DOC = "Fully-qualified class name for the target type used in the mapping.";
    private static final String CAMEL_SINK_DOZER_ENDPOINT_TARGET_MODEL_DEFAULT = null;
    public static final String CAMEL_SINK_DOZER_ENDPOINT_UNMARSHAL_ID_CONF = "camel.sink.endpoint.unmarshalId";
    private static final String CAMEL_SINK_DOZER_ENDPOINT_UNMARSHAL_ID_DOC = "The id of a dataFormat defined within the Camel Context to use for unmarshalling the mapping input from a non-Java type.";
    private static final String CAMEL_SINK_DOZER_ENDPOINT_UNMARSHAL_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_DOZER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_DOZER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_DOZER_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_DOZER_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_DOZER_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_DOZER_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_DOZER_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_DOZER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
