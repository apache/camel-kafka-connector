...
public class CamelMustacheSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_MUSTACHE_PATH_RESOURCE_URI_DEFAULT = null;
    ...
    public static final Boolean CAMEL_SINK_MUSTACHE_ENDPOINT_ALLOW_CONTEXT_MAP_ALL_DEFAULT = false;
    ...
    public static final Boolean CAMEL_SINK_MUSTACHE_ENDPOINT_ALLOW_TEMPLATE_FROM_HEADER_DEFAULT = false;
    public static final String CAMEL_SINK_MUSTACHE_ENDPOINT_CONTENT_CACHE_CONF = "camel.sink.endpoint.contentCache";
    public static final String CAMEL_SINK_MUSTACHE_ENDPOINT_CONTENT_CACHE_DOC = "Sets whether to use resource content cache or not";
    public static final Boolean CAMEL_SINK_MUSTACHE_ENDPOINT_CONTENT_CACHE_DEFAULT = false;
    public static final String CAMEL_SINK_MUSTACHE_ENDPOINT_ENCODING_CONF = "camel.sink.endpoint.encoding";
    public static final String CAMEL_SINK_MUSTACHE_ENDPOINT_ENCODING_DOC = "Character encoding of the resource content.";
    public static final String CAMEL_SINK_MUSTACHE_ENDPOINT_ENCODING_DEFAULT = null;
    public static final String CAMEL_SINK_MUSTACHE_ENDPOINT_END_DELIMITER_CONF = "camel.sink.endpoint.endDelimiter";
    public static final String CAMEL_SINK_MUSTACHE_ENDPOINT_END_DELIMITER_DOC = "Characters used to mark template code end.";
    public static final String CAMEL_SINK_MUSTACHE_ENDPOINT_END_DELIMITER_DEFAULT = "}}";
    ...
    public static final Boolean CAMEL_SINK_MUSTACHE_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    public static final Boolean CAMEL_SINK_MUSTACHE_COMPONENT_ALLOW_CONTEXT_MAP_ALL_DEFAULT = false;
    ...
    public static final Boolean CAMEL_SINK_MUSTACHE_COMPONENT_ALLOW_TEMPLATE_FROM_HEADER_DEFAULT = false;
