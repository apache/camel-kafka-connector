...
public class CamelSmppSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_SMPP_ENDPOINT_ENQUIRE_LINK_TIMER_DEFAULT = "60000";
    public static final String CAMEL_SOURCE_SMPP_ENDPOINT_PDU_PROCESSOR_DEGREE_CONF = "camel.source.endpoint.pduProcessorDegree";
    public static final String CAMEL_SOURCE_SMPP_ENDPOINT_PDU_PROCESSOR_DEGREE_DOC = "Sets the number of threads which can read PDU and process them in parallel.";
    public static final String CAMEL_SOURCE_SMPP_ENDPOINT_PDU_PROCESSOR_DEGREE_DEFAULT = "3";
    public static final String CAMEL_SOURCE_SMPP_ENDPOINT_PDU_PROCESSOR_QUEUE_CAPACITY_CONF = "camel.source.endpoint.pduProcessorQueueCapacity";
    public static final String CAMEL_SOURCE_SMPP_ENDPOINT_PDU_PROCESSOR_QUEUE_CAPACITY_DOC = "Sets the capacity of the working queue for PDU processing.";
    public static final String CAMEL_SOURCE_SMPP_ENDPOINT_PDU_PROCESSOR_QUEUE_CAPACITY_DEFAULT = "100";
    ...
    public static final String CAMEL_SOURCE_SMPP_COMPONENT_ENQUIRE_LINK_TIMER_DEFAULT = "60000";
    public static final String CAMEL_SOURCE_SMPP_COMPONENT_PDU_PROCESSOR_DEGREE_CONF = "camel.component.smpp.pduProcessorDegree";
    public static final String CAMEL_SOURCE_SMPP_COMPONENT_PDU_PROCESSOR_DEGREE_DOC = "Sets the number of threads which can read PDU and process them in parallel.";
    public static final String CAMEL_SOURCE_SMPP_COMPONENT_PDU_PROCESSOR_DEGREE_DEFAULT = "3";
    public static final String CAMEL_SOURCE_SMPP_COMPONENT_PDU_PROCESSOR_QUEUE_CAPACITY_CONF = "camel.component.smpp.pduProcessorQueueCapacity";
    public static final String CAMEL_SOURCE_SMPP_COMPONENT_PDU_PROCESSOR_QUEUE_CAPACITY_DOC = "Sets the capacity of the working queue for PDU processing.";
    public static final String CAMEL_SOURCE_SMPP_COMPONENT_PDU_PROCESSOR_QUEUE_CAPACITY_DEFAULT = "100";
