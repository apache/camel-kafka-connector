...
public class CamelAws2ecsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWS2ECS_COMPONENT_REGION_DOC = "The region in which ECS client needs to work";
    ...
    public static final String CAMEL_SINK_AWS2ECS_COMPONENT_CONFIGURATION_DOC = "The AWS ECS default configuration";
