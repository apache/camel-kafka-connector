...
public class CamelAwssdbSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_AWSSDB_PATH_DOMAIN_NAME_DOC = "The name of the domain currently worked with.";
    private static final String CAMEL_SINK_AWSSDB_PATH_DOMAIN_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_AWSSDB_ENDPOINT_ACCESS_KEY_CONF = "camel.sink.endpoint.accessKey";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_ACCESS_KEY_DOC = "Amazon AWS Access Key";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_ACCESS_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AWSSDB_ENDPOINT_AMAZON_SDBCLIENT_CONF = "camel.sink.endpoint.amazonSDBClient";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_AMAZON_SDBCLIENT_DOC = "To use the AmazonSimpleDB as the client";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_AMAZON_SDBCLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_AWSSDB_ENDPOINT_CONSISTENT_READ_CONF = "camel.sink.endpoint.consistentRead";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_CONSISTENT_READ_DOC = "Determines whether or not strong consistency should be enforced when data is read.";
    private static final Boolean CAMEL_SINK_AWSSDB_ENDPOINT_CONSISTENT_READ_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_AWSSDB_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_AWSSDB_ENDPOINT_MAX_NUMBER_OF_DOMAINS_CONF = "camel.sink.endpoint.maxNumberOfDomains";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_MAX_NUMBER_OF_DOMAINS_DOC = "The maximum number of domain names you want returned. The range is 1 to 100.";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_MAX_NUMBER_OF_DOMAINS_DEFAULT = null;
    public static final String CAMEL_SINK_AWSSDB_ENDPOINT_OPERATION_CONF = "camel.sink.endpoint.operation";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_OPERATION_DOC = "Operation to perform One of: [BatchDeleteAttributes] [BatchPutAttributes] [DeleteAttributes] [DeleteDomain] [DomainMetadata] [GetAttributes] [ListDomains] [PutAttributes] [Select]";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_OPERATION_DEFAULT = "PutAttributes";
    public static final String CAMEL_SINK_AWSSDB_ENDPOINT_PROXY_HOST_CONF = "camel.sink.endpoint.proxyHost";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_PROXY_HOST_DOC = "To define a proxy host when instantiating the SDB client";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_AWSSDB_ENDPOINT_PROXY_PORT_CONF = "camel.sink.endpoint.proxyPort";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_PROXY_PORT_DOC = "To define a proxy port when instantiating the SDB client";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_AWSSDB_ENDPOINT_PROXY_PROTOCOL_CONF = "camel.sink.endpoint.proxyProtocol";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_PROXY_PROTOCOL_DOC = "To define a proxy protocol when instantiating the SDB client One of: [HTTP] [HTTPS]";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_PROXY_PROTOCOL_DEFAULT = "HTTPS";
    public static final String CAMEL_SINK_AWSSDB_ENDPOINT_REGION_CONF = "camel.sink.endpoint.region";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_REGION_DOC = "The region in which SDB client needs to work. When using this parameter, the configuration will expect the capitalized name of the region (for example AP_EAST_1) You'll need to use the name Regions.EU_WEST_1.name()";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_REGION_DEFAULT = null;
    public static final String CAMEL_SINK_AWSSDB_ENDPOINT_SECRET_KEY_CONF = "camel.sink.endpoint.secretKey";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_SECRET_KEY_DOC = "Amazon AWS Secret Key";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_SECRET_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AWSSDB_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AWSSDB_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_AWSSDB_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_AWSSDB_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_AWSSDB_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_AWSSDB_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AWSSDB_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
