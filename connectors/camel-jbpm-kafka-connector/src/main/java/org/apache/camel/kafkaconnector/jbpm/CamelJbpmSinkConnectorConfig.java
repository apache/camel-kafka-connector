...
public class CamelJbpmSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_JBPM_PATH_CONNECTION_URLDOC = "The URL to the jBPM server.";
    private static final String CAMEL_SINK_JBPM_PATH_CONNECTION_URLDEFAULT = null;
    public static final String CAMEL_SINK_JBPM_PATH_EVENT_LISTENER_TYPE_CONF = "camel.sink.path.eventListenerType";
    private static final String CAMEL_SINK_JBPM_PATH_EVENT_LISTENER_TYPE_DOC = "Sets the event listener type to attach to";
    private static final String CAMEL_SINK_JBPM_PATH_EVENT_LISTENER_TYPE_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_ATTACHMENT_ID_CONF = "camel.sink.endpoint.attachmentId";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_ATTACHMENT_ID_DOC = "attachId to use when retrieving attachments";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_ATTACHMENT_ID_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_CONTENT_ID_CONF = "camel.sink.endpoint.contentId";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_CONTENT_ID_DOC = "contentId to use when retrieving attachments";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_CONTENT_ID_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_DEPLOYMENT_ID_CONF = "camel.sink.endpoint.deploymentId";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_DEPLOYMENT_ID_DOC = "The id of the deployment";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_DEPLOYMENT_ID_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_EMITTER_SEND_ITEMS_CONF = "camel.sink.endpoint.emitterSendItems";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_EMITTER_SEND_ITEMS_DOC = "Sets if event produced by emitter should be sent as single items or complete collection";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_EMITTER_SEND_ITEMS_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_EVENT_CONF = "camel.sink.endpoint.event";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_EVENT_DOC = "the data associated with this event when signalEvent operation is performed";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_EVENT_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_EVENT_TYPE_CONF = "camel.sink.endpoint.eventType";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_EVENT_TYPE_DOC = "the type of event to use when signalEvent operation is performed";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_EVENT_TYPE_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_IDENTIFIER_CONF = "camel.sink.endpoint.identifier";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_IDENTIFIER_DOC = "identifier the global identifier";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_IDENTIFIER_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_MAX_NUMBER_CONF = "camel.sink.endpoint.maxNumber";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_MAX_NUMBER_DOC = "the maximum number of rules that should be fired";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_MAX_NUMBER_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_PAGE_CONF = "camel.sink.endpoint.page";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_PAGE_DOC = "The page to use when retrieving user tasks";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_PAGE_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_PAGE_SIZE_CONF = "camel.sink.endpoint.pageSize";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_PAGE_SIZE_DOC = "The page size to use when retrieving user tasks";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_PAGE_SIZE_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_PROCESS_ID_CONF = "camel.sink.endpoint.processId";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_PROCESS_ID_DOC = "the id of the process that should be acted upon";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_PROCESS_ID_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_PROCESS_INSTANCE_ID_CONF = "camel.sink.endpoint.processInstanceId";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_PROCESS_INSTANCE_ID_DOC = "the id of the process instance";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_PROCESS_INSTANCE_ID_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_TARGET_USER_ID_CONF = "camel.sink.endpoint.targetUserId";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_TARGET_USER_ID_DOC = "The targetUserId used when delegating a task";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_TARGET_USER_ID_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_TASK_CONF = "camel.sink.endpoint.task";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_TASK_DOC = "The task instance to use with task operations";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_TASK_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_TASK_ID_CONF = "camel.sink.endpoint.taskId";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_TASK_ID_DOC = "the id of the task";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_TASK_ID_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_TIMEOUT_CONF = "camel.sink.endpoint.timeout";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_TIMEOUT_DOC = "A timeout value";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_USER_ID_CONF = "camel.sink.endpoint.userId";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_USER_ID_DOC = "userId to use with task operations";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_USER_ID_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_VALUE_CONF = "camel.sink.endpoint.value";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_VALUE_DOC = "the value to assign to the global identifier";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_VALUE_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_WORK_ITEM_ID_CONF = "camel.sink.endpoint.workItemId";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_WORK_ITEM_ID_DOC = "the id of the work item";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_WORK_ITEM_ID_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JBPM_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_OPERATION_CONF = "camel.sink.endpoint.operation";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_OPERATION_DOC = "The operation to perform";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_OPERATION_DEFAULT = "startProcess";
    public static final String CAMEL_SINK_JBPM_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JBPM_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_ENTITIES_CONF = "camel.sink.endpoint.entities";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_ENTITIES_DOC = "The potentialOwners when nominateTask operation is performed";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_ENTITIES_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_EXTRA_JAXB_CLASSES_CONF = "camel.sink.endpoint.extraJaxbClasses";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_EXTRA_JAXB_CLASSES_DOC = "To load additional classes when working with XML";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_EXTRA_JAXB_CLASSES_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_PARAMETERS_CONF = "camel.sink.endpoint.parameters";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_PARAMETERS_DOC = "the variables that should be set for various operations";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_JBPM_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_STATUSES_CONF = "camel.sink.endpoint.statuses";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_STATUSES_DOC = "The list of status to use when filtering tasks";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_STATUSES_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_PASSWORD_DOC = "Password for authentication";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_JBPM_ENDPOINT_USER_NAME_CONF = "camel.sink.endpoint.userName";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_USER_NAME_DOC = "Username for authentication";
    private static final String CAMEL_SINK_JBPM_ENDPOINT_USER_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JBPM_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_JBPM_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JBPM_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
