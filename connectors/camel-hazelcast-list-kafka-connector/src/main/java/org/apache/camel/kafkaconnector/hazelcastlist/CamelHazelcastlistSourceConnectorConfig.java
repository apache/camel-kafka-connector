...
public class CamelHazelcastlistSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_HAZELCASTLIST_PATH_CACHE_NAME_DOC = "The name of the cache";
    private static final String CAMEL_SOURCE_HAZELCASTLIST_PATH_CACHE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_DEFAULT_OPERATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_HAZELCAST_INSTANCE_DOC = "The hazelcast instance reference which can be used for hazelcast endpoint.";
    private static final String CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_HAZELCAST_INSTANCE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_HAZELCAST_INSTANCE_NAME_DOC = "The hazelcast instance reference name which can be used for hazelcast endpoint. If you don't specify the instance reference, camel use the default hazelcast instance from the camel-hazelcast instance.";
    private static final String CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_HAZELCAST_INSTANCE_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    public static final String CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.source.endpoint.basicPropertyBinding";
    private static final String CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_HAZELCASTLIST_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_HAZELCASTLIST_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_HAZELCASTLIST_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.hazelcast-list.basicPropertyBinding";
    private static final String CAMEL_SOURCE_HAZELCASTLIST_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_HAZELCASTLIST_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTLIST_COMPONENT_HAZELCAST_INSTANCE_DOC = "The hazelcast instance reference which can be used for hazelcast endpoint. If you don't specify the instance reference, camel use the default hazelcast instance from the camel-hazelcast instance.";
    private static final String CAMEL_SOURCE_HAZELCASTLIST_COMPONENT_HAZELCAST_INSTANCE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTLIST_COMPONENT_HAZELCAST_MODE_DOC = "The hazelcast mode reference which kind of instance should be used. If you don't specify the mode, then the node mode will be the default.";
    private static final String CAMEL_SOURCE_HAZELCASTLIST_COMPONENT_HAZELCAST_MODE_DEFAULT = "node";
