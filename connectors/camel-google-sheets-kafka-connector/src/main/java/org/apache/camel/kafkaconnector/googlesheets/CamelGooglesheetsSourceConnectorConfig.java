...
public class CamelGooglesheetsSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DOC = "If the polling consumer did not poll any files, you can enable this option to send an empty message (no body) instead.";
    public static final Boolean CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_SPLIT_RESULT_CONF = "camel.source.endpoint.splitResult";
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_SPLIT_RESULT_DOC = "When consumer return an array or collection this will generate one exchange per element, and their routes will be executed once for each exchange. Set this value to false to use a single exchange for the entire list or array.";
    public static final Boolean CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_SPLIT_RESULT_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DOC = "The number of subsequent error polls (failed due some error) that should happen before the backoffMultipler should kick-in.";
    public static final Integer CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DOC = "The number of subsequent idle polls that should happen before the backoffMultipler should kick-in.";
    public static final Integer CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DEFAULT = null;
    ...
    public static final Long CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    ...
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_RUN_LOGGING_LEVEL_DOC = "The consumer logs a start/complete log line when it polls. This option allows you to configure the logging level for that. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_RUN_LOGGING_LEVEL_DEFAULT = "TRACE";
    ...
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_SCHEDULER_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_START_SCHEDULER_CONF = "camel.source.endpoint.startScheduler";
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_START_SCHEDULER_DOC = "Whether the scheduler should be auto started.";
    public static final Boolean CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_START_SCHEDULER_DEFAULT = true;
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_TIME_UNIT_CONF = "camel.source.endpoint.timeUnit";
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_TIME_UNIT_DOC = "Time unit for initialDelay and delay options. One of: [NANOSECONDS] [MICROSECONDS] [MILLISECONDS] [SECONDS] [MINUTES] [HOURS] [DAYS]";
    public static final String CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_TIME_UNIT_DEFAULT = "MILLISECONDS";
    ...
    public static final Boolean CAMEL_SOURCE_GOOGLESHEETS_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_SPLIT_RESULT_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_SPLIT_RESULT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_GOOGLESHEETS_ENDPOINT_SPLIT_RESULT_DOC);
