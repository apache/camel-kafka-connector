...
public class CamelGitSourceConnectorConfig extends CamelSourceConnectorConfig {
    ...
    private static final String CAMEL_SOURCE_GIT_PATH_LOCAL_PATH_DOC = "Local repository path";
    private static final String CAMEL_SOURCE_GIT_PATH_LOCAL_PATH_DEFAULT = null;
    public static final String CAMEL_SOURCE_GIT_ENDPOINT_BRANCH_NAME_CONF = "camel.source.endpoint.branchName";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_BRANCH_NAME_DOC = "The branch name to work on";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_BRANCH_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_GIT_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_PASSWORD_DOC = "Remote repository password";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_GIT_ENDPOINT_REMOTE_NAME_CONF = "camel.source.endpoint.remoteName";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_REMOTE_NAME_DOC = "The remote repository name to use in particular operation like pull";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_REMOTE_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_GIT_ENDPOINT_REMOTE_PATH_CONF = "camel.source.endpoint.remotePath";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_REMOTE_PATH_DOC = "The remote repository path";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_REMOTE_PATH_DEFAULT = null;
    public static final String CAMEL_SOURCE_GIT_ENDPOINT_TAG_NAME_CONF = "camel.source.endpoint.tagName";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_TAG_NAME_DOC = "The tag name to work on";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_TAG_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_GIT_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_USERNAME_DOC = "Remote repository username";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_GIT_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_GIT_ENDPOINT_TYPE_CONF = "camel.source.endpoint.type";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_TYPE_DOC = "The consumer type One of: [commit] [tag] [branch]";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_TYPE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_GIT_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_GIT_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_GIT_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_GIT_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_GIT_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_GIT_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_GIT_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_GIT_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
