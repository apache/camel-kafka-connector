...
public class CamelGitSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_GIT_PATH_LOCAL_PATH_DOC = "Local repository path";
    private static final String CAMEL_SINK_GIT_PATH_LOCAL_PATH_DEFAULT = null;
    public static final String CAMEL_SINK_GIT_ENDPOINT_BRANCH_NAME_CONF = "camel.sink.endpoint.branchName";
    private static final String CAMEL_SINK_GIT_ENDPOINT_BRANCH_NAME_DOC = "The branch name to work on";
    private static final String CAMEL_SINK_GIT_ENDPOINT_BRANCH_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_GIT_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_GIT_ENDPOINT_PASSWORD_DOC = "Remote repository password";
    private static final String CAMEL_SINK_GIT_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_GIT_ENDPOINT_REMOTE_NAME_CONF = "camel.sink.endpoint.remoteName";
    private static final String CAMEL_SINK_GIT_ENDPOINT_REMOTE_NAME_DOC = "The remote repository name to use in particular operation like pull";
    private static final String CAMEL_SINK_GIT_ENDPOINT_REMOTE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_GIT_ENDPOINT_REMOTE_PATH_CONF = "camel.sink.endpoint.remotePath";
    private static final String CAMEL_SINK_GIT_ENDPOINT_REMOTE_PATH_DOC = "The remote repository path";
    private static final String CAMEL_SINK_GIT_ENDPOINT_REMOTE_PATH_DEFAULT = null;
    public static final String CAMEL_SINK_GIT_ENDPOINT_TAG_NAME_CONF = "camel.sink.endpoint.tagName";
    private static final String CAMEL_SINK_GIT_ENDPOINT_TAG_NAME_DOC = "The tag name to work on";
    private static final String CAMEL_SINK_GIT_ENDPOINT_TAG_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_GIT_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_GIT_ENDPOINT_USERNAME_DOC = "Remote repository username";
    private static final String CAMEL_SINK_GIT_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_GIT_ENDPOINT_ALLOW_EMPTY_CONF = "camel.sink.endpoint.allowEmpty";
    private static final String CAMEL_SINK_GIT_ENDPOINT_ALLOW_EMPTY_DOC = "The flag to manage empty git commits";
    private static final Boolean CAMEL_SINK_GIT_ENDPOINT_ALLOW_EMPTY_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_GIT_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_GIT_ENDPOINT_OPERATION_CONF = "camel.sink.endpoint.operation";
    private static final String CAMEL_SINK_GIT_ENDPOINT_OPERATION_DOC = "The operation to do on the repository One of: [clone] [init] [add] [remove] [commit] [commitAll] [createBranch] [deleteBranch] [createTag] [deleteTag] [status] [log] [push] [pull] [showBranches] [cherryPick] [remoteAdd] [remoteList]";
    private static final String CAMEL_SINK_GIT_ENDPOINT_OPERATION_DEFAULT = null;
    public static final String CAMEL_SINK_GIT_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_GIT_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GIT_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_GIT_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_GIT_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_GIT_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_GIT_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_GIT_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.git.basicPropertyBinding";
    private static final String CAMEL_SINK_GIT_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GIT_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
