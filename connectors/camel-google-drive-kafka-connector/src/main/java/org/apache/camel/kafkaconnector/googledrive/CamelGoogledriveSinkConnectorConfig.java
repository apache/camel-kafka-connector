...
public class CamelGoogledriveSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_GOOGLEDRIVE_PATH_API_NAME_DOC = "What kind of operation to perform One of: [drive-about] [drive-apps] [drive-changes] [drive-channels] [drive-children] [drive-comments] [drive-files] [drive-parents] [drive-permissions] [drive-properties] [drive-realtime] [drive-replies] [drive-revisions]";
    private static final String CAMEL_SINK_GOOGLEDRIVE_PATH_API_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEDRIVE_PATH_METHOD_NAME_CONF = "camel.sink.path.methodName";
    private static final String CAMEL_SINK_GOOGLEDRIVE_PATH_METHOD_NAME_DOC = "What sub operation to use for the selected operation One of: [copy] [delete] [get] [getIdForEmail] [insert] [list] [patch] [stop] [touch] [trash] [untrash] [update] [watch]";
    private static final String CAMEL_SINK_GOOGLEDRIVE_PATH_METHOD_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_APPLICATION_NAME_CONF = "camel.sink.endpoint.applicationName";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_APPLICATION_NAME_DOC = "Google drive application name. Example would be camel-google-drive/1.0";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_APPLICATION_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_CLIENT_FACTORY_CONF = "camel.sink.endpoint.clientFactory";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_CLIENT_FACTORY_DOC = "To use the GoogleCalendarClientFactory as factory for creating the client. Will by default use BatchGoogleDriveClientFactory";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_CLIENT_FACTORY_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_CLIENT_ID_CONF = "camel.sink.endpoint.clientId";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_CLIENT_ID_DOC = "Client ID of the drive application";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_CLIENT_ID_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_IN_BODY_CONF = "camel.sink.endpoint.inBody";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_IN_BODY_DOC = "Sets the name of a parameter to be passed in the exchange In Body";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_IN_BODY_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_SCOPES_CONF = "camel.sink.endpoint.scopes";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_SCOPES_DOC = "Specifies the level of permissions you want a drive application to have to a user account. See https://developers.google.com/drive/web/scopes for more info.";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_SCOPES_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_ACCESS_TOKEN_CONF = "camel.sink.endpoint.accessToken";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_ACCESS_TOKEN_DOC = "OAuth 2 access token. This typically expires after an hour so refreshToken is recommended for long term usage.";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_ACCESS_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_CLIENT_SECRET_CONF = "camel.sink.endpoint.clientSecret";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_CLIENT_SECRET_DOC = "Client secret of the drive application";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_CLIENT_SECRET_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_REFRESH_TOKEN_CONF = "camel.sink.endpoint.refreshToken";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_REFRESH_TOKEN_DOC = "OAuth 2 refresh token. Using this, the Google Calendar component can obtain a new accessToken whenever the current one expires - a necessity if the application is long-lived.";
    private static final String CAMEL_SINK_GOOGLEDRIVE_ENDPOINT_REFRESH_TOKEN_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_APPLICATION_NAME_DOC = "Google drive application name. Example would be camel-google-drive/1.0";
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_APPLICATION_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_CLIENT_ID_CONF = "camel.component.google-drive.clientId";
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_CLIENT_ID_DOC = "Client ID of the drive application";
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_CLIENT_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_CONFIGURATION_DOC = "To use the shared configuration";
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_SCOPES_CONF = "camel.component.google-drive.scopes";
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_SCOPES_DOC = "Specifies the level of permissions you want a drive application to have to a user account. See https://developers.google.com/drive/web/scopes for more info.";
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_SCOPES_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_GOOGLEDRIVE_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GOOGLEDRIVE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_CLIENT_FACTORY_DOC = "To use the GoogleCalendarClientFactory as factory for creating the client. Will by default use BatchGoogleDriveClientFactory";
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_CLIENT_FACTORY_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_ACCESS_TOKEN_CONF = "camel.component.google-drive.accessToken";
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_ACCESS_TOKEN_DOC = "OAuth 2 access token. This typically expires after an hour so refreshToken is recommended for long term usage.";
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_ACCESS_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_CLIENT_SECRET_CONF = "camel.component.google-drive.clientSecret";
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_CLIENT_SECRET_DOC = "Client secret of the drive application";
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_CLIENT_SECRET_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_REFRESH_TOKEN_CONF = "camel.component.google-drive.refreshToken";
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_REFRESH_TOKEN_DOC = "OAuth 2 refresh token. Using this, the Google Calendar component can obtain a new accessToken whenever the current one expires - a necessity if the application is long-lived.";
    private static final String CAMEL_SINK_GOOGLEDRIVE_COMPONENT_REFRESH_TOKEN_DEFAULT = null;
