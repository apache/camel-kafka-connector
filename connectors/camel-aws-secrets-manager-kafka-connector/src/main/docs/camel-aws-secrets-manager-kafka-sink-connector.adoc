...
The camel-aws-secrets-manager sink connector supports 29 options, which are listed below.
...
| *camel.sink.endpoint.operation* | The operation to perform One of: [listSecrets] | null | true | HIGH
...
| *camel.component.aws-secrets-manager.operation* | The operation to perform One of: [listSecrets] | null | true | HIGH
