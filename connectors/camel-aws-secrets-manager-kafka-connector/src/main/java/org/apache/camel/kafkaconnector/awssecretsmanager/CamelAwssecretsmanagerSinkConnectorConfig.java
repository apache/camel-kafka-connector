...
public class CamelAwssecretsmanagerSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_AWSSECRETSMANAGER_ENDPOINT_OPERATION_DOC = "The operation to perform One of: [listSecrets] [createSecret] [getSecret] [describeSecret] [deleteSecret] [rotateSecret] [updateSecret] [restoreSecret] [replicateSecretToRegions]";
    ...
    public static final String CAMEL_SINK_AWSSECRETSMANAGER_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_CONF = "camel.sink.endpoint.useDefaultCredentialsProvider";
    public static final String CAMEL_SINK_AWSSECRETSMANAGER_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_DOC = "Set whether the Translate client should expect to load credentials through a default credentials provider or to expect static credentials to be passed in.";
    public static final Boolean CAMEL_SINK_AWSSECRETSMANAGER_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_AWSSECRETSMANAGER_COMPONENT_OPERATION_DOC = "The operation to perform One of: [listSecrets] [createSecret] [getSecret] [describeSecret] [deleteSecret] [rotateSecret] [updateSecret] [restoreSecret] [replicateSecretToRegions]";
    ...
    public static final String CAMEL_SINK_AWSSECRETSMANAGER_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_CONF = "camel.component.aws-secrets-manager.useDefaultCredentialsProvider";
    public static final String CAMEL_SINK_AWSSECRETSMANAGER_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_DOC = "Set whether the Translate client should expect to load credentials through a default credentials provider or to expect static credentials to be passed in.";
    public static final Boolean CAMEL_SINK_AWSSECRETSMANAGER_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_AWSSECRETSMANAGER_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_AWSSECRETSMANAGER_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWSSECRETSMANAGER_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_DOC);
        ...
        conf.define(CAMEL_SINK_AWSSECRETSMANAGER_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_AWSSECRETSMANAGER_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWSSECRETSMANAGER_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_DOC);
