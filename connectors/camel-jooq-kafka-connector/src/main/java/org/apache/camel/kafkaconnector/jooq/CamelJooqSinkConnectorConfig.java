...
public class CamelJooqSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_JOOQ_PATH_ENTITY_TYPE_DOC = "JOOQ entity class";
    private static final String CAMEL_SINK_JOOQ_PATH_ENTITY_TYPE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_JOOQ_ENDPOINT_DATABASE_CONFIGURATION_DOC = "To use a specific database configuration";
    private static final String CAMEL_SINK_JOOQ_ENDPOINT_DATABASE_CONFIGURATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JOOQ_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_JOOQ_ENDPOINT_OPERATION_CONF = "camel.sink.endpoint.operation";
    private static final String CAMEL_SINK_JOOQ_ENDPOINT_OPERATION_DOC = "Type of operation to execute on query One of: [EXECUTE] [FETCH] [NONE]";
    private static final String CAMEL_SINK_JOOQ_ENDPOINT_OPERATION_DEFAULT = "NONE";
    public static final String CAMEL_SINK_JOOQ_ENDPOINT_QUERY_CONF = "camel.sink.endpoint.query";
    private static final String CAMEL_SINK_JOOQ_ENDPOINT_QUERY_DOC = "To execute plain SQL query";
    private static final String CAMEL_SINK_JOOQ_ENDPOINT_QUERY_DEFAULT = null;
    public static final String CAMEL_SINK_JOOQ_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_JOOQ_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JOOQ_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JOOQ_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_JOOQ_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_JOOQ_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_JOOQ_COMPONENT_CONFIGURATION_CONF = "camel.component.jooq.configuration";
    private static final String CAMEL_SINK_JOOQ_COMPONENT_CONFIGURATION_DOC = "Component configuration (database connection, database entity type, etc.)";
    private static final String CAMEL_SINK_JOOQ_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_JOOQ_COMPONENT_DATABASE_CONFIGURATION_DOC = "To use a specific database configuration";
    private static final String CAMEL_SINK_JOOQ_COMPONENT_DATABASE_CONFIGURATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JOOQ_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_JOOQ_COMPONENT_OPERATION_CONF = "camel.component.jooq.operation";
    private static final String CAMEL_SINK_JOOQ_COMPONENT_OPERATION_DOC = "Type of operation to execute on query One of: [EXECUTE] [FETCH] [NONE]";
    private static final String CAMEL_SINK_JOOQ_COMPONENT_OPERATION_DEFAULT = "NONE";
    public static final String CAMEL_SINK_JOOQ_COMPONENT_QUERY_CONF = "camel.component.jooq.query";
    private static final String CAMEL_SINK_JOOQ_COMPONENT_QUERY_DOC = "To execute plain SQL query";
    private static final String CAMEL_SINK_JOOQ_COMPONENT_QUERY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_JOOQ_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JOOQ_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
