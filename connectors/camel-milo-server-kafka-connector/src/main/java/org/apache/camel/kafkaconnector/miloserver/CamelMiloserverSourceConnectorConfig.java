...
public class CamelMiloserverSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_MILOSERVER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_MILOSERVER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_MILOSERVER_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    public static final String CAMEL_SOURCE_MILOSERVER_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    public static final Boolean CAMEL_SOURCE_MILOSERVER_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_MILOSERVER_COMPONENT_BIND_PORT_CONF = "camel.component.milo-server.bindPort";
    public static final String CAMEL_SOURCE_MILOSERVER_COMPONENT_BIND_PORT_DOC = "The TCP port the server binds to";
    public static final Integer CAMEL_SOURCE_MILOSERVER_COMPONENT_BIND_PORT_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_MILOSERVER_COMPONENT_SECURITY_POLICIES_BY_ID_DOC = "Security policies by URI or name";
    public static final String CAMEL_SOURCE_MILOSERVER_COMPONENT_SECURITY_POLICIES_BY_ID_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOSERVER_COMPONENT_SERVER_CERTIFICATE_CONF = "camel.component.milo-server.serverCertificate";
    public static final String CAMEL_SOURCE_MILOSERVER_COMPONENT_SERVER_CERTIFICATE_DOC = "Server certificate";
    public static final String CAMEL_SOURCE_MILOSERVER_COMPONENT_SERVER_CERTIFICATE_DEFAULT = null;
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SOURCE_MILOSERVER_COMPONENT_BIND_PORT_CONF, ConfigDef.Type.INT, CAMEL_SOURCE_MILOSERVER_COMPONENT_BIND_PORT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_MILOSERVER_COMPONENT_BIND_PORT_DOC);
        ...
        conf.define(CAMEL_SOURCE_MILOSERVER_COMPONENT_SERVER_CERTIFICATE_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_MILOSERVER_COMPONENT_SERVER_CERTIFICATE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_MILOSERVER_COMPONENT_SERVER_CERTIFICATE_DOC);
