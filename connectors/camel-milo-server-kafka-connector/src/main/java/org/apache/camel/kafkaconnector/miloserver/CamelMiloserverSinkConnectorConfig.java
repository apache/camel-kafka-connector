...
public class CamelMiloserverSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_MILOSERVER_COMPONENT_BIND_PORT_CONF = "camel.component.milo-server.bindPort";
    public static final String CAMEL_SINK_MILOSERVER_COMPONENT_BIND_PORT_DOC = "The TCP port the server binds to";
    public static final Integer CAMEL_SINK_MILOSERVER_COMPONENT_BIND_PORT_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_MILOSERVER_COMPONENT_SECURITY_POLICIES_BY_ID_DOC = "Security policies by URI or name";
    public static final String CAMEL_SINK_MILOSERVER_COMPONENT_SECURITY_POLICIES_BY_ID_DEFAULT = null;
    public static final String CAMEL_SINK_MILOSERVER_COMPONENT_SERVER_CERTIFICATE_CONF = "camel.component.milo-server.serverCertificate";
    public static final String CAMEL_SINK_MILOSERVER_COMPONENT_SERVER_CERTIFICATE_DOC = "Server certificate";
    public static final String CAMEL_SINK_MILOSERVER_COMPONENT_SERVER_CERTIFICATE_DEFAULT = null;
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SINK_MILOSERVER_COMPONENT_BIND_PORT_CONF, ConfigDef.Type.INT, CAMEL_SINK_MILOSERVER_COMPONENT_BIND_PORT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_MILOSERVER_COMPONENT_BIND_PORT_DOC);
        ...
        conf.define(CAMEL_SINK_MILOSERVER_COMPONENT_SERVER_CERTIFICATE_CONF, ConfigDef.Type.STRING, CAMEL_SINK_MILOSERVER_COMPONENT_SERVER_CERTIFICATE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_MILOSERVER_COMPONENT_SERVER_CERTIFICATE_DOC);
