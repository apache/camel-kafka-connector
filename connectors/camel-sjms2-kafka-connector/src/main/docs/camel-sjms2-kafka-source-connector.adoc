...
| *camel.source.endpoint.durable* | Sets the topic to be durable | false | false | MEDIUM
...
| *camel.source.endpoint.shared* | Sets the topic to be shared | false | false | MEDIUM
| *camel.source.endpoint.subscriptionId* | Sets the topic subscription id, required for durable or shared topics. | null | false | MEDIUM
