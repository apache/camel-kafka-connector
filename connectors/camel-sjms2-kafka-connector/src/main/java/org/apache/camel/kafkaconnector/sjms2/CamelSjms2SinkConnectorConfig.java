...
public class CamelSjms2SinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_SJMS2_COMPONENT_CONNECTION_PASSWORD_CONF, ConfigDef.Type.PASSWORD, CAMEL_SINK_SJMS2_COMPONENT_CONNECTION_PASSWORD_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SJMS2_COMPONENT_CONNECTION_PASSWORD_DOC);
        conf.define(CAMEL_SINK_SJMS2_COMPONENT_CONNECTION_USERNAME_CONF, ConfigDef.Type.PASSWORD, CAMEL_SINK_SJMS2_COMPONENT_CONNECTION_USERNAME_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SJMS2_COMPONENT_CONNECTION_USERNAME_DOC);
