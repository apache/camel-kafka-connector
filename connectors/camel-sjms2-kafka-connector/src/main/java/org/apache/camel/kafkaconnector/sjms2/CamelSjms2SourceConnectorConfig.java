...
public class CamelSjms2SourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_SJMS2_ENDPOINT_CONCURRENT_CONSUMERS_DOC = "Specifies the number of concurrent consumers when consuming from JMS (not for request/reply over JMS). The concurrent consumer is fixed at startup and cannot be dynamic scaled like the camel-jms component. When doing request/reply over JMS then the option replyToConcurrentConsumers is used to control number of concurrent consumers on the reply message listener.";
    ...
    public static final String CAMEL_SOURCE_SJMS2_ENDPOINT_JMS_MESSAGE_TYPE_CONF = "camel.source.endpoint.jmsMessageType";
    public static final String CAMEL_SOURCE_SJMS2_ENDPOINT_JMS_MESSAGE_TYPE_DOC = "Allows you to force the use of a specific jakarta.jms.Message implementation for sending JMS messages. Possible values are: Bytes, Map, Object, Stream, Text. By default, Camel would determine which JMS message type to use from the In body type. This option allows you to specify it. One of: [Bytes] [Map] [Object] [Stream] [Text]";
    public static final String CAMEL_SOURCE_SJMS2_ENDPOINT_JMS_MESSAGE_TYPE_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_SJMS2_COMPONENT_CLIENT_ID_CONF = "camel.component.sjms2.clientId";
    public static final String CAMEL_SOURCE_SJMS2_COMPONENT_CLIENT_ID_DOC = "Sets the JMS client ID to use. Note that this value, if specified, must be unique and can only be used by a single JMS connection instance. It is typically only required for durable topic subscriptions. If using Apache ActiveMQ you may prefer to use Virtual Topics instead.";
    public static final String CAMEL_SOURCE_SJMS2_COMPONENT_CLIENT_ID_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_SJMS2_COMPONENT_BRIDGE_ERROR_HANDLER_DOC = "Allows for bridging the consumer to the Camel routing Error Handler, which mean any exceptions (if possible) occurred while the Camel consumer is trying to pickup incoming messages, or the likes, will now be processed as a message and handled by the routing Error Handler. Important: This is only possible if the 3rd party component allows Camel to be alerted if an exception was thrown. Some components handle this internally only, and therefore bridgeErrorHandler is not possible. In other situations we may improve the Camel component to hook into the 3rd party component and make this possible for future releases. By default the consumer will use the org.apache.camel.spi.ExceptionHandler to deal with exceptions, that will be logged at WARN or ERROR level and ignored.";
    ...
    public static final String CAMEL_SOURCE_SJMS2_COMPONENT_OBJECT_MESSAGE_ENABLED_CONF = "camel.component.sjms2.objectMessageEnabled";
    public static final String CAMEL_SOURCE_SJMS2_COMPONENT_OBJECT_MESSAGE_ENABLED_DOC = "Whether to enable sending and receiving JMS ObjectMessage. By default this is disabled because Java object serialization is a known source of security vulnerabilities. Enable this option only if you trust the source of the messages and need to send or receive Java serialized objects via JMS. When disabled, Camel will refuse to create or read JMS ObjectMessage instances. Options that rely on ObjectMessage internally (such as transferException) require this option to be enabled.";
    public static final Boolean CAMEL_SOURCE_SJMS2_COMPONENT_OBJECT_MESSAGE_ENABLED_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_SJMS2_COMPONENT_DESERIALIZATION_FILTER_CONF = "camel.component.sjms2.deserializationFilter";
    public static final String CAMEL_SOURCE_SJMS2_COMPONENT_DESERIALIZATION_FILTER_DOC = "Sets an ObjectInputFilter pattern (jdk.serialFilter syntax) applied as a defense-in-depth check on the class of the body returned by jakarta.jms.ObjectMessage.getObject(). The pattern is evaluated after the JMS provider has deserialized the payload, so this option alone does not prevent gadget-chain execution that happens inside the provider's ObjectInputStream; to block such attacks, also configure the JMS provider's own deserialization filter and/or the JVM-wide -Djdk.serialFilter. When this option is not set and no JVM-wide filter is configured, a conservative default filter denying java.net. and otherwise allowing java., javax. and org.apache.camel. is applied.";
    public static final String CAMEL_SOURCE_SJMS2_COMPONENT_DESERIALIZATION_FILTER_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_SJMS2_ENDPOINT_JMS_MESSAGE_TYPE_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_SJMS2_ENDPOINT_JMS_MESSAGE_TYPE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SJMS2_ENDPOINT_JMS_MESSAGE_TYPE_DOC);
        ...
        conf.define(CAMEL_SOURCE_SJMS2_ENDPOINT_OBJECT_MESSAGE_ENABLED_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_SJMS2_ENDPOINT_OBJECT_MESSAGE_ENABLED_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SJMS2_ENDPOINT_OBJECT_MESSAGE_ENABLED_DOC);
        ...
        conf.define(CAMEL_SOURCE_SJMS2_ENDPOINT_DESERIALIZATION_FILTER_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_SJMS2_ENDPOINT_DESERIALIZATION_FILTER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SJMS2_ENDPOINT_DESERIALIZATION_FILTER_DOC);
        ...
        conf.define(CAMEL_SOURCE_SJMS2_COMPONENT_CLIENT_ID_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_SJMS2_COMPONENT_CLIENT_ID_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SJMS2_COMPONENT_CLIENT_ID_DOC);
        ...
        conf.define(CAMEL_SOURCE_SJMS2_COMPONENT_OBJECT_MESSAGE_ENABLED_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_SJMS2_COMPONENT_OBJECT_MESSAGE_ENABLED_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SJMS2_COMPONENT_OBJECT_MESSAGE_ENABLED_DOC);
        ...
        conf.define(CAMEL_SOURCE_SJMS2_COMPONENT_DESERIALIZATION_FILTER_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_SJMS2_COMPONENT_DESERIALIZATION_FILTER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SJMS2_COMPONENT_DESERIALIZATION_FILTER_DOC);
        return conf;
    }
}