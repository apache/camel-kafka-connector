...
public class CamelSmtpsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_PASSWORD_DOC = "The password for login";
    ...
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_USERNAME_DOC = "The username for login";
