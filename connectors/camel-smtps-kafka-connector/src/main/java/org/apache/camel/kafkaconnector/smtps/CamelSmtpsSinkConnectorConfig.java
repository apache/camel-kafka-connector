...
public class CamelSmtpsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_SMTPS_PATH_HOST_DOC = "The mail server host name";
    private static final String CAMEL_SINK_SMTPS_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_SMTPS_PATH_PORT_DOC = "The port number of the mail server";
    private static final Integer CAMEL_SINK_SMTPS_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_BCC_CONF = "camel.sink.endpoint.bcc";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_BCC_DOC = "Sets the BCC email address. Separate multiple email addresses with comma.";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_BCC_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_CC_CONF = "camel.sink.endpoint.cc";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_CC_DOC = "Sets the CC email address. Separate multiple email addresses with comma.";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_CC_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_FROM_CONF = "camel.sink.endpoint.from";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_FROM_DOC = "The from email address";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_FROM_DEFAULT = "camel@localhost";
    ...
    private static final Boolean CAMEL_SINK_SMTPS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_REPLY_TO_CONF = "camel.sink.endpoint.replyTo";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_REPLY_TO_DOC = "The Reply-To recipients (the receivers of the response mail). Separate multiple email addresses with a comma.";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_REPLY_TO_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_SUBJECT_CONF = "camel.sink.endpoint.subject";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_SUBJECT_DOC = "The Subject of the message being sent. Note: Setting the subject in the header takes precedence over this option.";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_SUBJECT_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_TO_CONF = "camel.sink.endpoint.to";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_TO_DOC = "Sets the To email address. Separate multiple email addresses with comma.";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_TO_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_JAVA_MAIL_SENDER_CONF = "camel.sink.endpoint.javaMailSender";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_JAVA_MAIL_SENDER_DOC = "To use a custom org.apache.camel.component.mail.JavaMailSender for sending emails.";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_JAVA_MAIL_SENDER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_ADDITIONAL_JAVA_MAIL_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_ALTERNATIVE_BODY_HEADER_DEFAULT = "CamelMailAlternativeBody";
    ...
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_ATTACHMENTS_CONTENT_TRANSFER_ENCODING_RESOLVER_DOC = "To use a custom AttachmentsContentTransferEncodingResolver to resolve what content-type-encoding to use for attachments.";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_ATTACHMENTS_CONTENT_TRANSFER_ENCODING_RESOLVER_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_AUTHENTICATOR_CONF = "camel.sink.endpoint.authenticator";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_AUTHENTICATOR_DOC = "The authenticator for login. If set then the password and username are ignored. Can be used for tokens which can expire and therefore must be read dynamically.";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_AUTHENTICATOR_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SMTPS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_BINDING_CONF = "camel.sink.endpoint.binding";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_BINDING_DOC = "Sets the binding used to convert from a Camel message to and from a Mail message";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_BINDING_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_CONNECTION_TIMEOUT_CONF = "camel.sink.endpoint.connectionTimeout";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_CONNECTION_TIMEOUT_DOC = "The connection timeout in milliseconds.";
    private static final Integer CAMEL_SINK_SMTPS_ENDPOINT_CONNECTION_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_CONTENT_TYPE_CONF = "camel.sink.endpoint.contentType";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_CONTENT_TYPE_DOC = "The mail message content type. Use text/html for HTML mails.";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_CONTENT_TYPE_DEFAULT = "text/plain";
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_CONTENT_TYPE_RESOLVER_CONF = "camel.sink.endpoint.contentTypeResolver";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_CONTENT_TYPE_RESOLVER_DOC = "Resolver to determine Content-Type for file attachments.";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_CONTENT_TYPE_RESOLVER_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_DEBUG_MODE_CONF = "camel.sink.endpoint.debugMode";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_DEBUG_MODE_DOC = "Enable debug mode on the underlying mail framework. The SUN Mail framework logs the debug messages to System.out by default.";
    private static final Boolean CAMEL_SINK_SMTPS_ENDPOINT_DEBUG_MODE_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter headers.";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SMTPS_ENDPOINT_IGNORE_UNSUPPORTED_CHARSET_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SMTPS_ENDPOINT_IGNORE_URI_SCHEME_DEFAULT = false;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_JAVA_MAIL_PROPERTIES_CONF = "camel.sink.endpoint.javaMailProperties";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_JAVA_MAIL_PROPERTIES_DOC = "Sets the java mail options. Will clear any default properties and only use the properties provided for this method.";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_JAVA_MAIL_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_SESSION_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_SMTPS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_USE_INLINE_ATTACHMENTS_DOC = "Whether to use disposition inline or attachment.";
    private static final Boolean CAMEL_SINK_SMTPS_ENDPOINT_USE_INLINE_ATTACHMENTS_DEFAULT = false;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_PASSWORD_DOC = "The password for login. See also setAuthenticator(MailAuthenticator).";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters.";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_USERNAME_DOC = "The username for login. See also setAuthenticator(MailAuthenticator).";
    private static final String CAMEL_SINK_SMTPS_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_BCC_CONF = "camel.component.smtps.bcc";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_BCC_DOC = "Sets the BCC email address. Separate multiple email addresses with comma.";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_BCC_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_CC_CONF = "camel.component.smtps.cc";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_CC_DOC = "Sets the CC email address. Separate multiple email addresses with comma.";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_CC_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_FROM_CONF = "camel.component.smtps.from";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_FROM_DOC = "The from email address";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_FROM_DEFAULT = "camel@localhost";
    ...
    private static final Boolean CAMEL_SINK_SMTPS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_REPLY_TO_CONF = "camel.component.smtps.replyTo";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_REPLY_TO_DOC = "The Reply-To recipients (the receivers of the response mail). Separate multiple email addresses with a comma.";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_REPLY_TO_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_SUBJECT_CONF = "camel.component.smtps.subject";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_SUBJECT_DOC = "The Subject of the message being sent. Note: Setting the subject in the header takes precedence over this option.";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_SUBJECT_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_TO_CONF = "camel.component.smtps.to";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_TO_DOC = "Sets the To email address. Separate multiple email addresses with comma.";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_TO_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_JAVA_MAIL_SENDER_CONF = "camel.component.smtps.javaMailSender";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_JAVA_MAIL_SENDER_DOC = "To use a custom org.apache.camel.component.mail.JavaMailSender for sending emails.";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_JAVA_MAIL_SENDER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMTPS_COMPONENT_ADDITIONAL_JAVA_MAIL_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMTPS_COMPONENT_ALTERNATIVE_BODY_HEADER_DEFAULT = "CamelMailAlternativeBody";
    ...
    private static final String CAMEL_SINK_SMTPS_COMPONENT_ATTACHMENTS_CONTENT_TRANSFER_ENCODING_RESOLVER_DOC = "To use a custom AttachmentsContentTransferEncodingResolver to resolve what content-type-encoding to use for attachments.";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_ATTACHMENTS_CONTENT_TRANSFER_ENCODING_RESOLVER_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_AUTHENTICATOR_CONF = "camel.component.smtps.authenticator";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_AUTHENTICATOR_DOC = "The authenticator for login. If set then the password and username are ignored. Can be used for tokens which can expire and therefore must be read dynamically.";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_AUTHENTICATOR_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMTPS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SMTPS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_CONFIGURATION_CONF = "camel.component.smtps.configuration";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_CONFIGURATION_DOC = "Sets the Mail configuration";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_CONNECTION_TIMEOUT_CONF = "camel.component.smtps.connectionTimeout";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_CONNECTION_TIMEOUT_DOC = "The connection timeout in milliseconds.";
    private static final Integer CAMEL_SINK_SMTPS_COMPONENT_CONNECTION_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_CONTENT_TYPE_CONF = "camel.component.smtps.contentType";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_CONTENT_TYPE_DOC = "The mail message content type. Use text/html for HTML mails.";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_CONTENT_TYPE_DEFAULT = "text/plain";
    ...
    private static final String CAMEL_SINK_SMTPS_COMPONENT_CONTENT_TYPE_RESOLVER_DOC = "Resolver to determine Content-Type for file attachments.";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_CONTENT_TYPE_RESOLVER_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_DEBUG_MODE_CONF = "camel.component.smtps.debugMode";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_DEBUG_MODE_DOC = "Enable debug mode on the underlying mail framework. The SUN Mail framework logs the debug messages to System.out by default.";
    private static final Boolean CAMEL_SINK_SMTPS_COMPONENT_DEBUG_MODE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SMTPS_COMPONENT_IGNORE_UNSUPPORTED_CHARSET_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SMTPS_COMPONENT_IGNORE_URI_SCHEME_DEFAULT = false;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_JAVA_MAIL_PROPERTIES_CONF = "camel.component.smtps.javaMailProperties";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_JAVA_MAIL_PROPERTIES_DOC = "Sets the java mail options. Will clear any default properties and only use the properties provided for this method.";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_JAVA_MAIL_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMTPS_COMPONENT_SESSION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMTPS_COMPONENT_USE_INLINE_ATTACHMENTS_DOC = "Whether to use disposition inline or attachment.";
    private static final Boolean CAMEL_SINK_SMTPS_COMPONENT_USE_INLINE_ATTACHMENTS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SMTPS_COMPONENT_HEADER_FILTER_STRATEGY_DOC = "To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_PASSWORD_CONF = "camel.component.smtps.password";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_PASSWORD_DOC = "The password for login. See also setAuthenticator(MailAuthenticator).";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMTPS_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters.";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMTPS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SINK_SMTPS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
    public static final String CAMEL_SINK_SMTPS_COMPONENT_USERNAME_CONF = "camel.component.smtps.username";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_USERNAME_DOC = "The username for login. See also setAuthenticator(MailAuthenticator).";
    private static final String CAMEL_SINK_SMTPS_COMPONENT_USERNAME_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_SMTPS_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_SMTPS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SMTPS_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
