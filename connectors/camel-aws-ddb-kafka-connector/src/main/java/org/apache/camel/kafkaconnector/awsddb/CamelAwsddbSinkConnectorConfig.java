...
public class CamelAwsddbSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_AWSDDB_PATH_TABLE_NAME_DOC = "The name of the table currently worked with.";
    private static final String CAMEL_SINK_AWSDDB_PATH_TABLE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_AMAZON_DDBCLIENT_CONF = "camel.sink.endpoint.amazonDDBClient";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_AMAZON_DDBCLIENT_DOC = "To use the AmazonDynamoDB as the client";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_AMAZON_DDBCLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_CONSISTENT_READ_CONF = "camel.sink.endpoint.consistentRead";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_CONSISTENT_READ_DOC = "Determines whether or not strong consistency should be enforced when data is read.";
    private static final Boolean CAMEL_SINK_AWSDDB_ENDPOINT_CONSISTENT_READ_DEFAULT = false;
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_KEY_ATTRIBUTE_NAME_CONF = "camel.sink.endpoint.keyAttributeName";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_KEY_ATTRIBUTE_NAME_DOC = "Attribute name when creating table";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_KEY_ATTRIBUTE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_KEY_ATTRIBUTE_TYPE_CONF = "camel.sink.endpoint.keyAttributeType";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_KEY_ATTRIBUTE_TYPE_DOC = "Attribute type when creating table";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_KEY_ATTRIBUTE_TYPE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_AWSDDB_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_OPERATION_CONF = "camel.sink.endpoint.operation";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_OPERATION_DOC = "What operation to perform One of: [BatchGetItems] [DeleteItem] [DeleteTable] [DescribeTable] [GetItem] [PutItem] [Query] [Scan] [UpdateItem] [UpdateTable]";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_OPERATION_DEFAULT = "PutItem";
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_PROXY_HOST_CONF = "camel.sink.endpoint.proxyHost";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_PROXY_HOST_DOC = "To define a proxy host when instantiating the DDB client";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_PROXY_PORT_CONF = "camel.sink.endpoint.proxyPort";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_PROXY_PORT_DOC = "To define a proxy port when instantiating the DDB client. When using this parameter, the configuration will expect the capitalized name of the region (for example AP_EAST_1) You'll need to use the name Regions.EU_WEST_1.name()";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_PROXY_PROTOCOL_CONF = "camel.sink.endpoint.proxyProtocol";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_PROXY_PROTOCOL_DOC = "To define a proxy protocol when instantiating the DDB client One of: [HTTP] [HTTPS]";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_PROXY_PROTOCOL_DEFAULT = "HTTPS";
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_READ_CAPACITY_CONF = "camel.sink.endpoint.readCapacity";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_READ_CAPACITY_DOC = "The provisioned throughput to reserve for reading resources from your table";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_READ_CAPACITY_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_REGION_CONF = "camel.sink.endpoint.region";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_REGION_DOC = "The region in which DDB client needs to work";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_REGION_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_WRITE_CAPACITY_CONF = "camel.sink.endpoint.writeCapacity";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_WRITE_CAPACITY_DOC = "The provisioned throughput to reserved for writing resources to your table";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_WRITE_CAPACITY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AWSDDB_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_AWSDDB_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_ACCESS_KEY_CONF = "camel.sink.endpoint.accessKey";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_ACCESS_KEY_DOC = "Amazon AWS Access Key";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_ACCESS_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_ENDPOINT_SECRET_KEY_CONF = "camel.sink.endpoint.secretKey";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_SECRET_KEY_DOC = "Amazon AWS Secret Key";
    private static final String CAMEL_SINK_AWSDDB_ENDPOINT_SECRET_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_AMAZON_DDBCLIENT_CONF = "camel.component.aws-ddb.amazonDDBClient";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_AMAZON_DDBCLIENT_DOC = "To use the AmazonDynamoDB as the client";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_AMAZON_DDBCLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_CONFIGURATION_CONF = "camel.component.aws-ddb.configuration";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_CONFIGURATION_DOC = "The component configuration";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_CONSISTENT_READ_CONF = "camel.component.aws-ddb.consistentRead";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_CONSISTENT_READ_DOC = "Determines whether or not strong consistency should be enforced when data is read.";
    private static final Boolean CAMEL_SINK_AWSDDB_COMPONENT_CONSISTENT_READ_DEFAULT = false;
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_KEY_ATTRIBUTE_NAME_CONF = "camel.component.aws-ddb.keyAttributeName";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_KEY_ATTRIBUTE_NAME_DOC = "Attribute name when creating table";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_KEY_ATTRIBUTE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_KEY_ATTRIBUTE_TYPE_CONF = "camel.component.aws-ddb.keyAttributeType";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_KEY_ATTRIBUTE_TYPE_DOC = "Attribute type when creating table";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_KEY_ATTRIBUTE_TYPE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_AWSDDB_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_OPERATION_CONF = "camel.component.aws-ddb.operation";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_OPERATION_DOC = "What operation to perform One of: [BatchGetItems] [DeleteItem] [DeleteTable] [DescribeTable] [GetItem] [PutItem] [Query] [Scan] [UpdateItem] [UpdateTable]";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_OPERATION_DEFAULT = "PutItem";
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_PROXY_HOST_CONF = "camel.component.aws-ddb.proxyHost";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_PROXY_HOST_DOC = "To define a proxy host when instantiating the DDB client";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_PROXY_PORT_CONF = "camel.component.aws-ddb.proxyPort";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_PROXY_PORT_DOC = "To define a proxy port when instantiating the DDB client. When using this parameter, the configuration will expect the capitalized name of the region (for example AP_EAST_1) You'll need to use the name Regions.EU_WEST_1.name()";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_PROXY_PROTOCOL_CONF = "camel.component.aws-ddb.proxyProtocol";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_PROXY_PROTOCOL_DOC = "To define a proxy protocol when instantiating the DDB client One of: [HTTP] [HTTPS]";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_PROXY_PROTOCOL_DEFAULT = "HTTPS";
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_READ_CAPACITY_CONF = "camel.component.aws-ddb.readCapacity";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_READ_CAPACITY_DOC = "The provisioned throughput to reserve for reading resources from your table";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_READ_CAPACITY_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_REGION_CONF = "camel.component.aws-ddb.region";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_REGION_DOC = "The region in which DDB client needs to work";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_REGION_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_WRITE_CAPACITY_CONF = "camel.component.aws-ddb.writeCapacity";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_WRITE_CAPACITY_DOC = "The provisioned throughput to reserved for writing resources to your table";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_WRITE_CAPACITY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AWSDDB_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_ACCESS_KEY_CONF = "camel.component.aws-ddb.accessKey";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_ACCESS_KEY_DOC = "Amazon AWS Access Key";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_ACCESS_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AWSDDB_COMPONENT_SECRET_KEY_CONF = "camel.component.aws-ddb.secretKey";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_SECRET_KEY_DOC = "Amazon AWS Secret Key";
    private static final String CAMEL_SINK_AWSDDB_COMPONENT_SECRET_KEY_DEFAULT = null;
