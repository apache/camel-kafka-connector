...
public class CamelOpenstackcinderSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_OPENSTACKCINDER_PATH_HOST_DOC = "OpenStack host url";
    private static final String CAMEL_SINK_OPENSTACKCINDER_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_API_VERSION_CONF = "camel.sink.endpoint.apiVersion";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_API_VERSION_DOC = "OpenStack API version One of: [V2] [V3]";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_API_VERSION_DEFAULT = "V3";
    public static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_CONFIG_CONF = "camel.sink.endpoint.config";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_CONFIG_DOC = "OpenStack configuration";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_CONFIG_DEFAULT = null;
    public static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_DOMAIN_CONF = "camel.sink.endpoint.domain";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_DOMAIN_DOC = "Authentication domain";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_DOMAIN_DEFAULT = "default";
    ...
    private static final Boolean CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_OPERATION_CONF = "camel.sink.endpoint.operation";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_OPERATION_DOC = "The operation to do";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_OPERATION_DEFAULT = null;
    public static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_PASSWORD_DOC = "OpenStack password";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_PROJECT_CONF = "camel.sink.endpoint.project";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_PROJECT_DOC = "The project ID";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_PROJECT_DEFAULT = null;
    public static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_SUBSYSTEM_CONF = "camel.sink.endpoint.subsystem";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_SUBSYSTEM_DOC = "OpenStack Cinder subsystem One of: [snapshots] [volumes]";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_SUBSYSTEM_DEFAULT = null;
    public static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_USERNAME_DOC = "OpenStack username";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_OPENSTACKCINDER_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_OPENSTACKCINDER_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_OPENSTACKCINDER_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_OPENSTACKCINDER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
