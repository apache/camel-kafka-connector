...
public class CamelSolrSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_SOLR_PATH_URL_DOC = "Hostname and port for the solr server";
    private static final String CAMEL_SINK_SOLR_PATH_URL_DEFAULT = null;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_ALLOW_COMPRESSION_CONF = "camel.sink.endpoint.allowCompression";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_ALLOW_COMPRESSION_DOC = "Server side must support gzip or deflate for this to have any effect";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_ALLOW_COMPRESSION_DEFAULT = null;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_CONNECTION_TIMEOUT_CONF = "camel.sink.endpoint.connectionTimeout";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_CONNECTION_TIMEOUT_DOC = "connectionTimeout on the underlying HttpConnectionManager";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_CONNECTION_TIMEOUT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SOLR_ENDPOINT_DEFAULT_MAX_CONNECTIONS_PER_HOST_DOC = "maxConnectionsPerHost on the underlying HttpConnectionManager";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_DEFAULT_MAX_CONNECTIONS_PER_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_FOLLOW_REDIRECTS_CONF = "camel.sink.endpoint.followRedirects";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_FOLLOW_REDIRECTS_DOC = "indicates whether redirects are used to get to the Solr server";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_FOLLOW_REDIRECTS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SOLR_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_MAX_RETRIES_CONF = "camel.sink.endpoint.maxRetries";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_MAX_RETRIES_DOC = "Maximum number of retries to attempt in the event of transient errors";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_MAX_RETRIES_DEFAULT = null;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_MAX_TOTAL_CONNECTIONS_CONF = "camel.sink.endpoint.maxTotalConnections";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_MAX_TOTAL_CONNECTIONS_DOC = "maxTotalConnection on the underlying HttpConnectionManager";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_MAX_TOTAL_CONNECTIONS_DEFAULT = null;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_REQUEST_HANDLER_CONF = "camel.sink.endpoint.requestHandler";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_REQUEST_HANDLER_DOC = "Set the request handler to be used";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_REQUEST_HANDLER_DEFAULT = null;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_SO_TIMEOUT_CONF = "camel.sink.endpoint.soTimeout";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_SO_TIMEOUT_DOC = "Read timeout on the underlying HttpConnectionManager. This is desirable for queries, but probably not for indexing";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_SO_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_STREAMING_QUEUE_SIZE_CONF = "camel.sink.endpoint.streamingQueueSize";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_STREAMING_QUEUE_SIZE_DOC = "Set the queue size for the StreamingUpdateSolrServer";
    private static final Integer CAMEL_SINK_SOLR_ENDPOINT_STREAMING_QUEUE_SIZE_DEFAULT = 10;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_STREAMING_THREAD_COUNT_CONF = "camel.sink.endpoint.streamingThreadCount";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_STREAMING_THREAD_COUNT_DOC = "Set the number of threads for the StreamingUpdateSolrServer";
    private static final Integer CAMEL_SINK_SOLR_ENDPOINT_STREAMING_THREAD_COUNT_DEFAULT = 2;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SOLR_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_SOLR_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_PASSWORD_DOC = "Sets password for basic auth plugin enabled servers";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_USERNAME_DOC = "Sets username for basic auth plugin enabled servers";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_COLLECTION_CONF = "camel.sink.endpoint.collection";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_COLLECTION_DOC = "Set the collection name which the solrCloud server could use";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_COLLECTION_DEFAULT = null;
    public static final String CAMEL_SINK_SOLR_ENDPOINT_ZK_HOST_CONF = "camel.sink.endpoint.zkHost";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_ZK_HOST_DOC = "Set the ZooKeeper host information which the solrCloud could use, such as zkhost=localhost:8123.";
    private static final String CAMEL_SINK_SOLR_ENDPOINT_ZK_HOST_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SOLR_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SOLR_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SOLR_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
