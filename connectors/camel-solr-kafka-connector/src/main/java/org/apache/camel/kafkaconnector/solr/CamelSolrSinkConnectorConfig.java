...
public class CamelSolrSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_SOLR_ENDPOINT_HTTP_CLIENT_DOC = "Sets the http client to be used by the solrClient";
