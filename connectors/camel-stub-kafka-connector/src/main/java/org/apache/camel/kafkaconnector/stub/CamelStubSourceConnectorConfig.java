...
public class CamelStubSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_STUB_PATH_NAME_DOC = "Name of queue";
    private static final String CAMEL_SOURCE_STUB_PATH_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_STUB_ENDPOINT_SIZE_CONF = "camel.source.endpoint.size";
    private static final String CAMEL_SOURCE_STUB_ENDPOINT_SIZE_DOC = "The maximum capacity of the SEDA queue (i.e., the number of messages it can hold). Will by default use the defaultSize set on the SEDA component.";
    private static final Integer CAMEL_SOURCE_STUB_ENDPOINT_SIZE_DEFAULT = 1000;
    ...
    private static final Boolean CAMEL_SOURCE_STUB_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_STUB_ENDPOINT_CONCURRENT_CONSUMERS_DOC = "Number of concurrent threads processing exchanges.";
    private static final Integer CAMEL_SOURCE_STUB_ENDPOINT_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final String CAMEL_SOURCE_STUB_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_STUB_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_STUB_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_STUB_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_STUB_ENDPOINT_LIMIT_CONCURRENT_CONSUMERS_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_STUB_ENDPOINT_MULTIPLE_CONSUMERS_DEFAULT = false;
    public static final String CAMEL_SOURCE_STUB_ENDPOINT_POLL_TIMEOUT_CONF = "camel.source.endpoint.pollTimeout";
    private static final String CAMEL_SOURCE_STUB_ENDPOINT_POLL_TIMEOUT_DOC = "The timeout used when polling. When a timeout occurs, the consumer can check whether it is allowed to continue running. Setting a lower value allows the consumer to react more quickly upon shutdown.";
    private static final Integer CAMEL_SOURCE_STUB_ENDPOINT_POLL_TIMEOUT_DEFAULT = 1000;
    public static final String CAMEL_SOURCE_STUB_ENDPOINT_PURGE_WHEN_STOPPING_CONF = "camel.source.endpoint.purgeWhenStopping";
    private static final String CAMEL_SOURCE_STUB_ENDPOINT_PURGE_WHEN_STOPPING_DOC = "Whether to purge the task queue when stopping the consumer/route. This allows to stop faster, as any pending messages on the queue is discarded.";
    private static final Boolean CAMEL_SOURCE_STUB_ENDPOINT_PURGE_WHEN_STOPPING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_STUB_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_STUB_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_STUB_ENDPOINT_QUEUE_CONF = "camel.source.endpoint.queue";
    private static final String CAMEL_SOURCE_STUB_ENDPOINT_QUEUE_DOC = "Define the queue instance which will be used by the endpoint";
    private static final String CAMEL_SOURCE_STUB_ENDPOINT_QUEUE_DEFAULT = null;
    public static final String CAMEL_SOURCE_STUB_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_STUB_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_STUB_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_STUB_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_STUB_COMPONENT_CONCURRENT_CONSUMERS_DOC = "Sets the default number of concurrent threads processing exchanges.";
    private static final Integer CAMEL_SOURCE_STUB_COMPONENT_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final String CAMEL_SOURCE_STUB_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_STUB_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_STUB_COMPONENT_DEFAULT_QUEUE_FACTORY_DOC = "Sets the default queue factory.";
    private static final String CAMEL_SOURCE_STUB_COMPONENT_DEFAULT_QUEUE_FACTORY_DEFAULT = null;
    public static final String CAMEL_SOURCE_STUB_COMPONENT_QUEUE_SIZE_CONF = "camel.component.stub.queueSize";
    private static final String CAMEL_SOURCE_STUB_COMPONENT_QUEUE_SIZE_DOC = "Sets the default maximum capacity of the SEDA queue (i.e., the number of messages it can hold).";
    private static final Integer CAMEL_SOURCE_STUB_COMPONENT_QUEUE_SIZE_DEFAULT = 1000;
