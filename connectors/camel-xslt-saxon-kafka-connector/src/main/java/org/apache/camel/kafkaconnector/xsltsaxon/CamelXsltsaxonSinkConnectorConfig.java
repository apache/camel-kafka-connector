...
public class CamelXsltsaxonSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_XSLTSAXON_PATH_RESOURCE_URI_DEFAULT = null;
    public static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_ALLOW_ST_AXCONF = "camel.sink.endpoint.allowStAX";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_ALLOW_ST_AXDOC = "Whether to allow using StAX as the javax.xml.transform.Source. You can enable this if the XSLT library supports StAX such as the Saxon library (camel-saxon). The Xalan library (default in JVM) does not support StAXSource.";
    private static final Boolean CAMEL_SINK_XSLTSAXON_ENDPOINT_ALLOW_ST_AXDEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_XSLTSAXON_ENDPOINT_CONTENT_CACHE_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_XSLTSAXON_ENDPOINT_DELETE_OUTPUT_FILE_DEFAULT = false;
    public static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_FAIL_ON_NULL_BODY_CONF = "camel.sink.endpoint.failOnNullBody";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_FAIL_ON_NULL_BODY_DOC = "Whether or not to throw an exception if the input body is null.";
    private static final Boolean CAMEL_SINK_XSLTSAXON_ENDPOINT_FAIL_ON_NULL_BODY_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_XSLTSAXON_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_OUTPUT_DEFAULT = "string";
    ...
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_TRANSFORMER_CACHE_SIZE_DOC = "The number of javax.xml.transform.Transformer object that are cached for reuse to avoid calls to Template.newTransformer().";
    private static final Integer CAMEL_SINK_XSLTSAXON_ENDPOINT_TRANSFORMER_CACHE_SIZE_DEFAULT = 0;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_XSLTSAXON_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_ENTITY_RESOLVER_CONF = "camel.sink.endpoint.entityResolver";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_ENTITY_RESOLVER_DOC = "To use a custom org.xml.sax.EntityResolver with javax.xml.transform.sax.SAXSource.";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_ENTITY_RESOLVER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_ERROR_LISTENER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_RESULT_HANDLER_FACTORY_DOC = "Allows you to use a custom org.apache.camel.builder.xml.ResultHandlerFactory which is capable of using custom org.apache.camel.builder.xml.ResultHandler types.";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_RESULT_HANDLER_FACTORY_DEFAULT = null;
    public static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_SAXON_CONFIGURATION_CONF = "camel.sink.endpoint.saxonConfiguration";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_SAXON_CONFIGURATION_DOC = "To use a custom Saxon configuration";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_SAXON_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_SAXON_EXTENSION_FUNCTIONS_DEFAULT = null;
    public static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_XSLTSAXON_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_TRANSFORMER_FACTORY_CONF = "camel.sink.endpoint.transformerFactory";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_TRANSFORMER_FACTORY_DOC = "To use a custom XSLT transformer factory";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_TRANSFORMER_FACTORY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_TRANSFORMER_FACTORY_CLASS_DOC = "To use a custom XSLT transformer factory, specified as a FQN class name";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_TRANSFORMER_FACTORY_CLASS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_TRANSFORMER_FACTORY_CONFIGURATION_STRATEGY_DOC = "A configuration strategy to apply on freshly created instances of TransformerFactory.";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_TRANSFORMER_FACTORY_CONFIGURATION_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_URI_RESOLVER_CONF = "camel.sink.endpoint.uriResolver";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_URI_RESOLVER_DOC = "To use a custom javax.xml.transform.URIResolver";
    private static final String CAMEL_SINK_XSLTSAXON_ENDPOINT_URI_RESOLVER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_XSLTSAXON_COMPONENT_CONTENT_CACHE_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_XSLTSAXON_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_XSLTSAXON_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_SAXON_CONFIGURATION_DOC = "To use a custom Saxon configuration";
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_SAXON_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_SAXON_CONFIGURATION_PROPERTIES_DOC = "To set custom Saxon configuration properties";
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_SAXON_CONFIGURATION_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_SAXON_EXTENSION_FUNCTIONS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_TRANSFORMER_FACTORY_CLASS_DOC = "To use a custom XSLT transformer factory, specified as a FQN class name";
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_TRANSFORMER_FACTORY_CLASS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_TRANSFORMER_FACTORY_CONFIGURATION_STRATEGY_DOC = "A configuration strategy to apply on freshly created instances of TransformerFactory.";
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_TRANSFORMER_FACTORY_CONFIGURATION_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SINK_XSLTSAXON_COMPONENT_URI_RESOLVER_CONF = "camel.component.xslt-saxon.uriResolver";
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_URI_RESOLVER_DOC = "To use a custom UriResolver. Should not be used together with the option 'uriResolverFactory'.";
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_URI_RESOLVER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_URI_RESOLVER_FACTORY_DOC = "To use a custom UriResolver which depends on a dynamic endpoint resource URI. Should not be used together with the option 'uriResolver'.";
    private static final String CAMEL_SINK_XSLTSAXON_COMPONENT_URI_RESOLVER_FACTORY_DEFAULT = null;
