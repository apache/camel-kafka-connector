...
public class CamelLuceneSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_LUCENE_PATH_HOST_DOC = "The URL to the lucene server";
    private static final String CAMEL_SINK_LUCENE_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_LUCENE_PATH_OPERATION_CONF = "camel.sink.path.operation";
    private static final String CAMEL_SINK_LUCENE_PATH_OPERATION_DOC = "Operation to do such as insert or query. One of: [insert] [query]";
    private static final String CAMEL_SINK_LUCENE_PATH_OPERATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_LUCENE_ENDPOINT_ANALYZER_DEFAULT = null;
    public static final String CAMEL_SINK_LUCENE_ENDPOINT_INDEX_DIR_CONF = "camel.sink.endpoint.indexDir";
    private static final String CAMEL_SINK_LUCENE_ENDPOINT_INDEX_DIR_DOC = "A file system directory in which index files are created upon analysis of the document by the specified analyzer";
    private static final String CAMEL_SINK_LUCENE_ENDPOINT_INDEX_DIR_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_LUCENE_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_LUCENE_ENDPOINT_MAX_HITS_CONF = "camel.sink.endpoint.maxHits";
    private static final String CAMEL_SINK_LUCENE_ENDPOINT_MAX_HITS_DOC = "An integer value that limits the result set of the search operation";
    private static final Integer CAMEL_SINK_LUCENE_ENDPOINT_MAX_HITS_DEFAULT = null;
    public static final String CAMEL_SINK_LUCENE_ENDPOINT_SRC_DIR_CONF = "camel.sink.endpoint.srcDir";
    private static final String CAMEL_SINK_LUCENE_ENDPOINT_SRC_DIR_DOC = "An optional directory containing files to be used to be analyzed and added to the index at producer startup.";
    private static final String CAMEL_SINK_LUCENE_ENDPOINT_SRC_DIR_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_LUCENE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_LUCENE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_LUCENE_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_LUCENE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_LUCENE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_LUCENE_COMPONENT_ANALYZER_DEFAULT = null;
    public static final String CAMEL_SINK_LUCENE_COMPONENT_INDEX_DIR_CONF = "camel.component.lucene.indexDir";
    private static final String CAMEL_SINK_LUCENE_COMPONENT_INDEX_DIR_DOC = "A file system directory in which index files are created upon analysis of the document by the specified analyzer";
    private static final String CAMEL_SINK_LUCENE_COMPONENT_INDEX_DIR_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_LUCENE_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_LUCENE_COMPONENT_MAX_HITS_CONF = "camel.component.lucene.maxHits";
    private static final String CAMEL_SINK_LUCENE_COMPONENT_MAX_HITS_DOC = "An integer value that limits the result set of the search operation";
    private static final Integer CAMEL_SINK_LUCENE_COMPONENT_MAX_HITS_DEFAULT = null;
    public static final String CAMEL_SINK_LUCENE_COMPONENT_SRC_DIR_CONF = "camel.component.lucene.srcDir";
    private static final String CAMEL_SINK_LUCENE_COMPONENT_SRC_DIR_DOC = "An optional directory containing files to be used to be analyzed and added to the index at producer startup.";
    private static final String CAMEL_SINK_LUCENE_COMPONENT_SRC_DIR_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_LUCENE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_LUCENE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_LUCENE_COMPONENT_CONFIG_CONF = "camel.component.lucene.config";
    private static final String CAMEL_SINK_LUCENE_COMPONENT_CONFIG_DOC = "To use a shared lucene configuration";
    private static final String CAMEL_SINK_LUCENE_COMPONENT_CONFIG_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_LUCENE_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_LUCENE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_LUCENE_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
