...
public class CamelPlatformhttpSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_PLATFORMHTTP_PATH_PATH_DOC = "The path under which this endpoint serves the HTTP requests";
    private static final String CAMEL_SOURCE_PLATFORMHTTP_PATH_PATH_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_CONSUMES_CONF = "camel.source.endpoint.consumes";
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_CONSUMES_DOC = "The content type this endpoint accepts as an input, such as application/xml or application/json. null or &#42;/&#42; mean no restriction.";
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_CONSUMES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_HTTP_METHOD_RESTRICT_DOC = "A comma separated list of HTTP methods to serve, e.g. GET,POST . If no methods are specified, all methods will be served.";
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_HTTP_METHOD_RESTRICT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_MATCH_ON_URI_PREFIX_DOC = "Whether or not the consumer should try to find a target consumer by matching the URI prefix if no exact match is found.";
    private static final Boolean CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_MATCH_ON_URI_PREFIX_DEFAULT = false;
    public static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_PRODUCES_CONF = "camel.source.endpoint.produces";
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_PRODUCES_DOC = "The content type this endpoint produces, such as application/xml or application/json.";
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_PRODUCES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_FILE_NAME_EXT_WHITELIST_DOC = "A comma or whitespace separated list of file extensions. Uploads having these extensions will be stored locally. Null value or asterisk () will allow all files.";
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_FILE_NAME_EXT_WHITELIST_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom HeaderFilterStrategy to filter headers to and from Camel message.";
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_PLATFORM_HTTP_ENGINE_DOC = "An HTTP Server engine implementation to serve the requests of this endpoint.";
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_PLATFORM_HTTP_ENGINE_DEFAULT = null;
    public static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_PLATFORMHTTP_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_PLATFORMHTTP_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_PLATFORMHTTP_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_PLATFORMHTTP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_PLATFORMHTTP_COMPONENT_ENGINE_CONF = "camel.component.platform-http.engine";
    private static final String CAMEL_SOURCE_PLATFORMHTTP_COMPONENT_ENGINE_DOC = "An HTTP Server engine implementation to serve the requests";
    private static final String CAMEL_SOURCE_PLATFORMHTTP_COMPONENT_ENGINE_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_PLATFORMHTTP_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_PLATFORMHTTP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_PLATFORMHTTP_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
