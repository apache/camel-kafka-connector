...
public class CamelRobotframeworkSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_PATH_RESOURCE_URI_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_ALLOW_CONTEXT_MAP_ALL_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_ALLOW_TEMPLATE_FROM_HEADER_DEFAULT = false;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_ARGUMENT_FILE_CONF = "camel.source.endpoint.argumentFile";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_ARGUMENT_FILE_DOC = "A text file to read more arguments from.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_ARGUMENT_FILE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_COMBINED_TAG_STATS_DOC = "Creates combined statistics based on tags. Use the format tags:title List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_COMBINED_TAG_STATS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_CONTENT_CACHE_CONF = "camel.source.endpoint.contentCache";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_CONTENT_CACHE_DOC = "Sets whether to use resource content cache or not";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_CONTENT_CACHE_DEFAULT = false;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_CRITICAL_TAGS_CONF = "camel.source.endpoint.criticalTags";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_CRITICAL_TAGS_DOC = "Tests that have the given tags are considered critical. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_CRITICAL_TAGS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_DEBUG_FILE_CONF = "camel.source.endpoint.debugFile";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_DEBUG_FILE_DOC = "A debug file that is written during execution.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_DEBUG_FILE_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_DOCUMENT_CONF = "camel.source.endpoint.document";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_DOCUMENT_DOC = "Sets the documentation of the top-level tests suites.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_DOCUMENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_DRYRUN_CONF = "camel.source.endpoint.dryrun";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_DRYRUN_DOC = "Sets dryrun mode on use. In the dry run mode tests are run without executing keywords originating from test libraries. Useful for validating test data syntax.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_DRYRUN_DEFAULT = false;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_EXCLUDES_CONF = "camel.source.endpoint.excludes";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_EXCLUDES_DOC = "Selects the tests cases by tags. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_EXCLUDES_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_EXIT_ON_FAILURE_CONF = "camel.source.endpoint.exitOnFailure";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_EXIT_ON_FAILURE_DOC = "Sets robot to stop execution immediately if a critical test fails.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_EXIT_ON_FAILURE_DEFAULT = false;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_INCLUDES_CONF = "camel.source.endpoint.includes";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_INCLUDES_DOC = "Selects the tests cases by tags. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_INCLUDES_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LISTENER_CONF = "camel.source.endpoint.listener";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LISTENER_DOC = "Sets a single listener for monitoring tests execution";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LISTENER_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LISTENERS_CONF = "camel.source.endpoint.listeners";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LISTENERS_DOC = "Sets multiple listeners for monitoring tests execution. Use the format ListenerWithArgs:arg1:arg2 or simply ListenerWithoutArgs List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LISTENERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LOG_CONF = "camel.source.endpoint.log";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LOG_DOC = "Sets the path to the generated log file.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LOG_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LOG_LEVEL_CONF = "camel.source.endpoint.logLevel";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LOG_LEVEL_DOC = "Sets the threshold level for logging.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LOG_LEVEL_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LOG_TITLE_CONF = "camel.source.endpoint.logTitle";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LOG_TITLE_DOC = "Sets a title for the generated tests log.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_LOG_TITLE_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_METADATA_CONF = "camel.source.endpoint.metadata";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_METADATA_DOC = "Sets free metadata for the top level tests suites. comma seperated list of string resulting as List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_METADATA_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_MONITOR_COLORS_CONF = "camel.source.endpoint.monitorColors";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_MONITOR_COLORS_DOC = "Using ANSI colors in console. Normally colors work in unixes but not in Windows. Default is 'on'. 'on' - use colors in unixes but not in Windows 'off' - never use colors 'force' - always use colors (also in Windows)";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_MONITOR_COLORS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_MONITOR_WIDTH_CONF = "camel.source.endpoint.monitorWidth";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_MONITOR_WIDTH_DOC = "Width of the monitor output. Default is 78.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_MONITOR_WIDTH_DEFAULT = "78";
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_NAME_CONF = "camel.source.endpoint.name";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_NAME_DOC = "Sets the name of the top-level tests suites.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_NON_CRITICAL_TAGS_DOC = "Tests that have the given tags are not critical. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_NON_CRITICAL_TAGS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_NO_STATUS_RETURN_CODE_DOC = "If true, sets the return code to zero regardless of failures in test cases. Error codes are returned normally.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_NO_STATUS_RETURN_CODE_DEFAULT = false;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_OUTPUT_CONF = "camel.source.endpoint.output";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_OUTPUT_DOC = "Sets the path to the generated output file.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_OUTPUT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_OUTPUT_DIRECTORY_DOC = "Configures where generated reports are to be placed.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_OUTPUT_DIRECTORY_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RANDOMIZE_CONF = "camel.source.endpoint.randomize";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RANDOMIZE_DOC = "Sets the test execution order to be randomized. Valid values are all, suite, and test";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RANDOMIZE_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_REPORT_CONF = "camel.source.endpoint.report";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_REPORT_DOC = "Sets the path to the generated report file.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_REPORT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_REPORT_BACKGROUND_DOC = "Sets background colors for the generated report and summary.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_REPORT_BACKGROUND_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_REPORT_TITLE_CONF = "camel.source.endpoint.reportTitle";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_REPORT_TITLE_DOC = "Sets a title for the generated tests report.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_REPORT_TITLE_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RUN_EMPTY_SUITE_CONF = "camel.source.endpoint.runEmptySuite";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RUN_EMPTY_SUITE_DOC = "Executes tests also if the top level test suite is empty. Useful e.g. with --include/--exclude when it is not an error that no test matches the condition.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RUN_EMPTY_SUITE_DEFAULT = false;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RUN_FAILED_CONF = "camel.source.endpoint.runFailed";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RUN_FAILED_DOC = "Re-run failed tests, based on output.xml file.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RUN_FAILED_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RUN_MODE_CONF = "camel.source.endpoint.runMode";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RUN_MODE_DOC = "Sets the execution mode for this tests run. Note that this setting has been deprecated in Robot Framework 2.8. Use separate dryryn, skipTeardownOnExit, exitOnFailure, and randomize settings instead.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RUN_MODE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SKIP_TEARDOWN_ON_EXIT_DOC = "Sets whether the teardowns are skipped if the test execution is prematurely stopped.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SKIP_TEARDOWN_ON_EXIT_DEFAULT = false;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SPLIT_OUTPUTS_CONF = "camel.source.endpoint.splitOutputs";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SPLIT_OUTPUTS_DOC = "Splits output and log files.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SPLIT_OUTPUTS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SUITES_CONF = "camel.source.endpoint.suites";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SUITES_DOC = "Selects the tests suites by name. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SUITES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SUITE_STAT_LEVEL_DOC = "Defines how many levels to show in the Statistics by Suite table in outputs.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SUITE_STAT_LEVEL_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SUMMARY_TITLE_CONF = "camel.source.endpoint.summaryTitle";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SUMMARY_TITLE_DOC = "Sets a title for the generated summary report.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SUMMARY_TITLE_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TAG_DOCS_CONF = "camel.source.endpoint.tagDocs";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TAG_DOCS_DOC = "Adds documentation to the specified tags. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TAG_DOCS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TAGS_CONF = "camel.source.endpoint.tags";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TAGS_DOC = "Sets the tags(s) to all executed tests cases. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TAGS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TAG_STAT_EXCLUDES_DOC = "Excludes these tags from the Statistics by Tag and Test Details by Tag tables in outputs. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TAG_STAT_EXCLUDES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TAG_STAT_INCLUDES_DOC = "Includes only these tags in the Statistics by Tag and Test Details by Tag tables in outputs. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TAG_STAT_INCLUDES_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TAG_STAT_LINKS_CONF = "camel.source.endpoint.tagStatLinks";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TAG_STAT_LINKS_DOC = "Adds external links to the Statistics by Tag table in outputs. Use the format pattern:link:title List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TAG_STAT_LINKS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TESTS_CONF = "camel.source.endpoint.tests";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TESTS_DOC = "Selects the tests cases by name. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TESTS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TIMESTAMP_OUTPUTS_DOC = "Adds a timestamp to all output files.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TIMESTAMP_OUTPUTS_DEFAULT = false;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_VARIABLE_FILES_CONF = "camel.source.endpoint.variableFiles";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_VARIABLE_FILES_DOC = "Sets variables using variables files. Use the format path:args List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_VARIABLE_FILES_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_VARIABLES_CONF = "camel.source.endpoint.variables";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_VARIABLES_DOC = "Sets individual variables. Use the format name:value List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_VARIABLES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_WARN_ON_SKIPPED_FILES_DOC = "Show a warning when an invalid file is skipped.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_WARN_ON_SKIPPED_FILES_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_XUNIT_FILE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DOC = "If the polling consumer did not poll any files, you can enable this option to send an empty message (no body) instead.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_POLL_STRATEGY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DOC = "The number of subsequent error polls (failed due some error) that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DOC = "The number of subsequent idle polls that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_BACKOFF_MULTIPLIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll.";
    private static final Long CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_DELAY_DEFAULT = 500L;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_GREEDY_CONF = "camel.source.endpoint.greedy";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_GREEDY_DOC = "If greedy is enabled, then the ScheduledPollConsumer will run immediately again, if the previous run polled 1 or more messages.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_GREEDY_DEFAULT = false;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_INITIAL_DELAY_CONF = "camel.source.endpoint.initialDelay";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts.";
    private static final Long CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_REPEAT_COUNT_CONF = "camel.source.endpoint.repeatCount";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_REPEAT_COUNT_DOC = "Specifies a maximum limit of number of fires. So if you set it to 1, the scheduler will only fire once. If you set it to 5, it will only fire five times. A value of zero or negative means fire forever.";
    private static final Long CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RUN_LOGGING_LEVEL_DOC = "The consumer logs a start/complete log line when it polls. This option allows you to configure the logging level for that. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_RUN_LOGGING_LEVEL_DEFAULT = "TRACE";
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DOC = "Allows for configuring a custom/shared thread pool to use for the consumer. By default each consumer has its own single threaded thread pool.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SCHEDULER_CONF = "camel.source.endpoint.scheduler";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component One of: [none] [spring] [quartz]";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SCHEDULER_DEFAULT = "none";
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SCHEDULER_PROPERTIES_DOC = "To configure additional properties when using a custom scheduler or any of the Quartz, Spring based scheduler.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_SCHEDULER_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_START_SCHEDULER_DOC = "Whether the scheduler should be auto started.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_START_SCHEDULER_DEFAULT = true;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TIME_UNIT_CONF = "camel.source.endpoint.timeUnit";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TIME_UNIT_DOC = "Time unit for initialDelay and delay options. One of: [NANOSECONDS] [MICROSECONDS] [MILLISECONDS] [SECONDS] [MINUTES] [HOURS] [DAYS]";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_TIME_UNIT_DEFAULT = "MILLISECONDS";
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_USE_FIXED_DELAY_CONF = "camel.source.endpoint.useFixedDelay";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_USE_FIXED_DELAY_DOC = "Controls if fixed delay or fixed rate is used. See ScheduledExecutorService in JDK for details.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_ENDPOINT_USE_FIXED_DELAY_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_ALLOW_CONTEXT_MAP_ALL_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_ALLOW_TEMPLATE_FROM_HEADER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_ARGUMENT_FILE_DOC = "A text file to read more arguments from.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_ARGUMENT_FILE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_COMBINED_TAG_STATS_DOC = "Creates combined statistics based on tags. Use the format tags:title List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_COMBINED_TAG_STATS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_CRITICAL_TAGS_DOC = "Tests that have the given tags are considered critical. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_CRITICAL_TAGS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_DEBUG_FILE_DOC = "A debug file that is written during execution.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_DEBUG_FILE_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_DOCUMENT_CONF = "camel.component.robotframework.document";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_DOCUMENT_DOC = "Sets the documentation of the top-level tests suites.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_DOCUMENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_DRYRUN_CONF = "camel.component.robotframework.dryrun";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_DRYRUN_DOC = "Sets dryrun mode on use. In the dry run mode tests are run without executing keywords originating from test libraries. Useful for validating test data syntax.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_DRYRUN_DEFAULT = false;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_EXCLUDES_CONF = "camel.component.robotframework.excludes";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_EXCLUDES_DOC = "Selects the tests cases by tags. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_EXCLUDES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_EXIT_ON_FAILURE_DOC = "Sets robot to stop execution immediately if a critical test fails.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_EXIT_ON_FAILURE_DEFAULT = false;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_INCLUDES_CONF = "camel.component.robotframework.includes";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_INCLUDES_DOC = "Selects the tests cases by tags. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_INCLUDES_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LISTENER_CONF = "camel.component.robotframework.listener";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LISTENER_DOC = "Sets a single listener for monitoring tests execution";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LISTENER_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LISTENERS_CONF = "camel.component.robotframework.listeners";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LISTENERS_DOC = "Sets multiple listeners for monitoring tests execution. Use the format ListenerWithArgs:arg1:arg2 or simply ListenerWithoutArgs List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LISTENERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LOG_CONF = "camel.component.robotframework.log";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LOG_DOC = "Sets the path to the generated log file.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LOG_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LOG_LEVEL_CONF = "camel.component.robotframework.logLevel";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LOG_LEVEL_DOC = "Sets the threshold level for logging.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LOG_LEVEL_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LOG_TITLE_CONF = "camel.component.robotframework.logTitle";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LOG_TITLE_DOC = "Sets a title for the generated tests log.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_LOG_TITLE_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_METADATA_CONF = "camel.component.robotframework.metadata";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_METADATA_DOC = "Sets free metadata for the top level tests suites. comma seperated list of string resulting as List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_METADATA_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_MONITOR_COLORS_DOC = "Using ANSI colors in console. Normally colors work in unixes but not in Windows. Default is 'on'. 'on' - use colors in unixes but not in Windows 'off' - never use colors 'force' - always use colors (also in Windows)";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_MONITOR_COLORS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_MONITOR_WIDTH_DOC = "Width of the monitor output. Default is 78.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_MONITOR_WIDTH_DEFAULT = "78";
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_NAME_CONF = "camel.component.robotframework.name";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_NAME_DOC = "Sets the name of the top-level tests suites.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_NON_CRITICAL_TAGS_DOC = "Tests that have the given tags are not critical. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_NON_CRITICAL_TAGS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_NO_STATUS_RETURN_CODE_DOC = "If true, sets the return code to zero regardless of failures in test cases. Error codes are returned normally.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_NO_STATUS_RETURN_CODE_DEFAULT = false;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_OUTPUT_CONF = "camel.component.robotframework.output";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_OUTPUT_DOC = "Sets the path to the generated output file.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_OUTPUT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_OUTPUT_DIRECTORY_DOC = "Configures where generated reports are to be placed.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_OUTPUT_DIRECTORY_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_RANDOMIZE_CONF = "camel.component.robotframework.randomize";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_RANDOMIZE_DOC = "Sets the test execution order to be randomized. Valid values are all, suite, and test";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_RANDOMIZE_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_REPORT_CONF = "camel.component.robotframework.report";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_REPORT_DOC = "Sets the path to the generated report file.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_REPORT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_REPORT_BACKGROUND_DOC = "Sets background colors for the generated report and summary.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_REPORT_BACKGROUND_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_REPORT_TITLE_DOC = "Sets a title for the generated tests report.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_REPORT_TITLE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_RUN_EMPTY_SUITE_DOC = "Executes tests also if the top level test suite is empty. Useful e.g. with --include/--exclude when it is not an error that no test matches the condition.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_RUN_EMPTY_SUITE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_RUN_FAILED_DOC = "Re-run failed tests, based on output.xml file.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_RUN_FAILED_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_RUN_MODE_CONF = "camel.component.robotframework.runMode";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_RUN_MODE_DOC = "Sets the execution mode for this tests run. Note that this setting has been deprecated in Robot Framework 2.8. Use separate dryryn, skipTeardownOnExit, exitOnFailure, and randomize settings instead.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_RUN_MODE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_SKIP_TEARDOWN_ON_EXIT_DOC = "Sets whether the teardowns are skipped if the test execution is prematurely stopped.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_SKIP_TEARDOWN_ON_EXIT_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_SPLIT_OUTPUTS_DOC = "Splits output and log files.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_SPLIT_OUTPUTS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_SUITES_CONF = "camel.component.robotframework.suites";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_SUITES_DOC = "Selects the tests suites by name. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_SUITES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_SUITE_STAT_LEVEL_DOC = "Defines how many levels to show in the Statistics by Suite table in outputs.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_SUITE_STAT_LEVEL_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_SUMMARY_TITLE_DOC = "Sets a title for the generated summary report.";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_SUMMARY_TITLE_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TAG_DOCS_CONF = "camel.component.robotframework.tagDocs";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TAG_DOCS_DOC = "Adds documentation to the specified tags. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TAG_DOCS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TAGS_CONF = "camel.component.robotframework.tags";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TAGS_DOC = "Sets the tags(s) to all executed tests cases. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TAGS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TAG_STAT_EXCLUDES_DOC = "Excludes these tags from the Statistics by Tag and Test Details by Tag tables in outputs. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TAG_STAT_EXCLUDES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TAG_STAT_INCLUDES_DOC = "Includes only these tags in the Statistics by Tag and Test Details by Tag tables in outputs. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TAG_STAT_INCLUDES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TAG_STAT_LINKS_DOC = "Adds external links to the Statistics by Tag table in outputs. Use the format pattern:link:title List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TAG_STAT_LINKS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TESTS_CONF = "camel.component.robotframework.tests";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TESTS_DOC = "Selects the tests cases by name. List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TESTS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TIMESTAMP_OUTPUTS_DOC = "Adds a timestamp to all output files.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_TIMESTAMP_OUTPUTS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_VARIABLE_FILES_DOC = "Sets variables using variables files. Use the format path:args List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_VARIABLE_FILES_DEFAULT = null;
    public static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_VARIABLES_CONF = "camel.component.robotframework.variables";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_VARIABLES_DOC = "Sets individual variables. Use the format name:value List";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_VARIABLES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_WARN_ON_SKIPPED_FILES_DOC = "Show a warning when an invalid file is skipped.";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_WARN_ON_SKIPPED_FILES_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_XUNIT_FILE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_CONFIGURATION_DOC = "The configuration";
    private static final String CAMEL_SOURCE_ROBOTFRAMEWORK_COMPONENT_CONFIGURATION_DEFAULT = null;
