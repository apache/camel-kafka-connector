...
public class CamelAsteriskSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_ASTERISK_PATH_NAME_DOC = "Name of component";
    public static final String CAMEL_SINK_ASTERISK_PATH_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_HOSTNAME_CONF = "camel.sink.endpoint.hostname";
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_HOSTNAME_DOC = "The hostname of the asterisk server";
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_HOSTNAME_DEFAULT = null;
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_PASSWORD_DOC = "Login password";
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_USERNAME_DOC = "Login username";
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_ACTION_CONF = "camel.sink.endpoint.action";
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_ACTION_DOC = "What action to perform such as getting queue status, sip peers or extension state. One of: [QUEUE_STATUS] [SIP_PEERS] [EXTENSION_STATE]";
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_ACTION_DEFAULT = null;
