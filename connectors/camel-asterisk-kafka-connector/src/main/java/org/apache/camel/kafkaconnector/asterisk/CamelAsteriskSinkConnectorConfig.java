 ...
 */
package org.apache.camel.kafkaconnector.asterisk;
...
public class CamelAsteriskSinkConnectorConfig
        extends
            CamelSinkConnectorConfig {

    public static final String CAMEL_SINK_ASTERISK_PATH_NAME_CONF = "camel.sink.path.name";
    private static final String CAMEL_SINK_ASTERISK_PATH_NAME_DOC = "Name of component";
    private static final String CAMEL_SINK_ASTERISK_PATH_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_HOSTNAME_CONF = "camel.sink.endpoint.hostname";
    private static final String CAMEL_SINK_ASTERISK_ENDPOINT_HOSTNAME_DOC = "The hostname of the asterisk server";
    private static final String CAMEL_SINK_ASTERISK_ENDPOINT_HOSTNAME_DEFAULT = null;
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_ASTERISK_ENDPOINT_PASSWORD_DOC = "Login password";
    private static final String CAMEL_SINK_ASTERISK_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_ASTERISK_ENDPOINT_USERNAME_DOC = "Login username";
    private static final String CAMEL_SINK_ASTERISK_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_ACTION_CONF = "camel.sink.endpoint.action";
    private static final String CAMEL_SINK_ASTERISK_ENDPOINT_ACTION_DOC = "What action to perform such as getting queue status, sip peers or extension state. One of: [QUEUE_STATUS] [SIP_PEERS] [EXTENSION_STATE]";
    private static final String CAMEL_SINK_ASTERISK_ENDPOINT_ACTION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ASTERISK_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ASTERISK_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_ASTERISK_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_ASTERISK_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_ASTERISK_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_ASTERISK_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ASTERISK_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ASTERISK_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_ASTERISK_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public CamelAsteriskSinkConnectorConfig(Map<String, String> parsedConfig) {
