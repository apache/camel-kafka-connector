...
public class CamelSmppsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_SMPPS_PATH_HOST_DOC = "Hostname for the SMSC server to use.";
    private static final String CAMEL_SINK_SMPPS_PATH_HOST_DEFAULT = "localhost";
    public static final String CAMEL_SINK_SMPPS_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_SMPPS_PATH_PORT_DOC = "Port number for the SMSC server to use.";
    private static final String CAMEL_SINK_SMPPS_PATH_PORT_DEFAULT = "2775";
    ...
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_INITIAL_RECONNECT_DELAY_DOC = "Defines the initial delay in milliseconds after the consumer/producer tries to reconnect to the SMSC, after the connection was lost.";
    private static final Long CAMEL_SINK_SMPPS_ENDPOINT_INITIAL_RECONNECT_DELAY_DEFAULT = 5000L;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_MAX_RECONNECT_CONF = "camel.sink.endpoint.maxReconnect";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_MAX_RECONNECT_DOC = "Defines the maximum number of attempts to reconnect to the SMSC, if SMSC returns a negative bind response";
    private static final Integer CAMEL_SINK_SMPPS_ENDPOINT_MAX_RECONNECT_DEFAULT = 2147483647;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_RECONNECT_DELAY_CONF = "camel.sink.endpoint.reconnectDelay";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_RECONNECT_DELAY_DOC = "Defines the interval in milliseconds between the reconnect attempts, if the connection to the SMSC was lost and the previous was not succeed.";
    private static final Long CAMEL_SINK_SMPPS_ENDPOINT_RECONNECT_DELAY_DEFAULT = 5000L;
    ...
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_SPLITTING_POLICY_DEFAULT = "ALLOW";
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_SYSTEM_TYPE_CONF = "camel.sink.endpoint.systemType";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_SYSTEM_TYPE_DOC = "This parameter is used to categorize the type of ESME (External Short Message Entity) that is binding to the SMSC (max. 13 characters).";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_SYSTEM_TYPE_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_DEST_ADDR_CONF = "camel.sink.endpoint.destAddr";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_DEST_ADDR_DOC = "Defines the destination SME address. For mobile terminated messages, this is the directory number of the recipient MS. Only for SubmitSm, SubmitMulti, CancelSm and DataSm.";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_DEST_ADDR_DEFAULT = "1717";
    ...
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_DEST_ADDR_NPI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_DEST_ADDR_TON_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SMPPS_ENDPOINT_LAZY_SESSION_CREATION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SMPPS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_NUMBERING_PLAN_INDICATOR_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_PRIORITY_FLAG_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_PROTOCOL_ID_CONF = "camel.sink.endpoint.protocolId";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_PROTOCOL_ID_DOC = "The protocol id";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_PROTOCOL_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_REGISTERED_DELIVERY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_REPLACE_IF_PRESENT_FLAG_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_SERVICE_TYPE_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_SOURCE_ADDR_CONF = "camel.sink.endpoint.sourceAddr";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_SOURCE_ADDR_DOC = "Defines the address of SME (Short Message Entity) which originated this message.";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_SOURCE_ADDR_DEFAULT = "1616";
    ...
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_SOURCE_ADDR_NPI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_SOURCE_ADDR_TON_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_TYPE_OF_NUMBER_CONF = "camel.sink.endpoint.typeOfNumber";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_TYPE_OF_NUMBER_DOC = "Defines the type of number (TON) to be used in the SME. The following TON values are defined: 0: Unknown 1: International 2: National 3: Network Specific 4: Subscriber Number 5: Alphanumeric 6: Abbreviated One of: [0] [1] [2] [3] [4] [5] [6]";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_TYPE_OF_NUMBER_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SMPPS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_ENQUIRE_LINK_TIMER_CONF = "camel.sink.endpoint.enquireLinkTimer";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_ENQUIRE_LINK_TIMER_DOC = "Defines the interval in milliseconds between the confidence checks. The confidence check is used to test the communication path between an ESME and an SMSC.";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_ENQUIRE_LINK_TIMER_DEFAULT = "5000";
    ...
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_SESSION_STATE_LISTENER_DOC = "You can refer to a org.jsmpp.session.SessionStateListener in the Registry to receive callbacks when the session state changed.";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_SESSION_STATE_LISTENER_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_SMPPS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_TRANSACTION_TIMER_CONF = "camel.sink.endpoint.transactionTimer";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_TRANSACTION_TIMER_DOC = "Defines the maximum period of inactivity allowed after a transaction, after which an SMPP entity may assume that the session is no longer active. This timer may be active on either communicating SMPP entity (i.e. SMSC or ESME).";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_TRANSACTION_TIMER_DEFAULT = "10000";
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_ALPHABET_CONF = "camel.sink.endpoint.alphabet";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_ALPHABET_DOC = "Defines encoding of data according the SMPP 3.4 specification, section 5.2.19. 0: SMSC Default Alphabet 4: 8 bit Alphabet 8: UCS2 Alphabet One of: [0] [4] [8]";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_ALPHABET_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_DATA_CODING_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_ENCODING_CONF = "camel.sink.endpoint.encoding";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_ENCODING_DOC = "Defines the encoding scheme of the short message user data. Only for SubmitSm, ReplaceSm and SubmitMulti.";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_ENCODING_DEFAULT = "ISO-8859-1";
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_HTTP_PROXY_HOST_CONF = "camel.sink.endpoint.httpProxyHost";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_HTTP_PROXY_HOST_DOC = "If you need to tunnel SMPP through a HTTP proxy, set this attribute to the hostname or ip address of your HTTP proxy.";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_HTTP_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_HTTP_PROXY_PASSWORD_CONF = "camel.sink.endpoint.httpProxyPassword";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_HTTP_PROXY_PASSWORD_DOC = "If your HTTP proxy requires basic authentication, set this attribute to the password required for your HTTP proxy.";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_HTTP_PROXY_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_HTTP_PROXY_PORT_CONF = "camel.sink.endpoint.httpProxyPort";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_HTTP_PROXY_PORT_DOC = "If you need to tunnel SMPP through a HTTP proxy, set this attribute to the port of your HTTP proxy.";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_HTTP_PROXY_PORT_DEFAULT = "3128";
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_HTTP_PROXY_USERNAME_CONF = "camel.sink.endpoint.httpProxyUsername";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_HTTP_PROXY_USERNAME_DOC = "If your HTTP proxy requires basic authentication, set this attribute to the username required for your HTTP proxy.";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_HTTP_PROXY_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_PROXY_HEADERS_CONF = "camel.sink.endpoint.proxyHeaders";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_PROXY_HEADERS_DOC = "These headers will be passed to the proxy server while establishing the connection.";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_PROXY_HEADERS_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_PASSWORD_DOC = "The password for connecting to SMSC server.";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_SYSTEM_ID_CONF = "camel.sink.endpoint.systemId";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_SYSTEM_ID_DOC = "The system id (username) for connecting to SMSC server.";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_SYSTEM_ID_DEFAULT = "smppclient";
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_USING_SSLCONF = "camel.sink.endpoint.usingSSL";
    private static final String CAMEL_SINK_SMPPS_ENDPOINT_USING_SSLDOC = "Whether using SSL with the smpps protocol";
    private static final Boolean CAMEL_SINK_SMPPS_ENDPOINT_USING_SSLDEFAULT = false;
    ...
    private static final String CAMEL_SINK_SMPPS_COMPONENT_INITIAL_RECONNECT_DELAY_DOC = "Defines the initial delay in milliseconds after the consumer/producer tries to reconnect to the SMSC, after the connection was lost.";
    private static final Long CAMEL_SINK_SMPPS_COMPONENT_INITIAL_RECONNECT_DELAY_DEFAULT = 5000L;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_MAX_RECONNECT_CONF = "camel.component.smpps.maxReconnect";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_MAX_RECONNECT_DOC = "Defines the maximum number of attempts to reconnect to the SMSC, if SMSC returns a negative bind response";
    private static final Integer CAMEL_SINK_SMPPS_COMPONENT_MAX_RECONNECT_DEFAULT = 2147483647;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_RECONNECT_DELAY_CONF = "camel.component.smpps.reconnectDelay";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_RECONNECT_DELAY_DOC = "Defines the interval in milliseconds between the reconnect attempts, if the connection to the SMSC was lost and the previous was not succeed.";
    private static final Long CAMEL_SINK_SMPPS_COMPONENT_RECONNECT_DELAY_DEFAULT = 5000L;
    ...
    private static final String CAMEL_SINK_SMPPS_COMPONENT_SPLITTING_POLICY_DEFAULT = "ALLOW";
    public static final String CAMEL_SINK_SMPPS_COMPONENT_SYSTEM_TYPE_CONF = "camel.component.smpps.systemType";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_SYSTEM_TYPE_DOC = "This parameter is used to categorize the type of ESME (External Short Message Entity) that is binding to the SMSC (max. 13 characters).";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_SYSTEM_TYPE_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_DEST_ADDR_CONF = "camel.component.smpps.destAddr";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_DEST_ADDR_DOC = "Defines the destination SME address. For mobile terminated messages, this is the directory number of the recipient MS. Only for SubmitSm, SubmitMulti, CancelSm and DataSm.";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_DEST_ADDR_DEFAULT = "1717";
    ...
    private static final String CAMEL_SINK_SMPPS_COMPONENT_DEST_ADDR_NPI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_COMPONENT_DEST_ADDR_TON_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SMPPS_COMPONENT_LAZY_SESSION_CREATION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SMPPS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SMPPS_COMPONENT_NUMBERING_PLAN_INDICATOR_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_COMPONENT_PRIORITY_FLAG_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_PROTOCOL_ID_CONF = "camel.component.smpps.protocolId";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_PROTOCOL_ID_DOC = "The protocol id";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_PROTOCOL_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_COMPONENT_REGISTERED_DELIVERY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_COMPONENT_REPLACE_IF_PRESENT_FLAG_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_COMPONENT_SERVICE_TYPE_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_SOURCE_ADDR_CONF = "camel.component.smpps.sourceAddr";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_SOURCE_ADDR_DOC = "Defines the address of SME (Short Message Entity) which originated this message.";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_SOURCE_ADDR_DEFAULT = "1616";
    ...
    private static final String CAMEL_SINK_SMPPS_COMPONENT_SOURCE_ADDR_NPI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_COMPONENT_SOURCE_ADDR_TON_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_TYPE_OF_NUMBER_CONF = "camel.component.smpps.typeOfNumber";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_TYPE_OF_NUMBER_DOC = "Defines the type of number (TON) to be used in the SME. The following TON values are defined: 0: Unknown 1: International 2: National 3: Network Specific 4: Subscriber Number 5: Alphanumeric 6: Abbreviated One of: [0] [1] [2] [3] [4] [5] [6]";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_TYPE_OF_NUMBER_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.smpps.basicPropertyBinding";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SMPPS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_CONFIGURATION_CONF = "camel.component.smpps.configuration";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_CONFIGURATION_DOC = "To use the shared SmppConfiguration as configuration.";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_ENQUIRE_LINK_TIMER_CONF = "camel.component.smpps.enquireLinkTimer";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_ENQUIRE_LINK_TIMER_DOC = "Defines the interval in milliseconds between the confidence checks. The confidence check is used to test the communication path between an ESME and an SMSC.";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_ENQUIRE_LINK_TIMER_DEFAULT = "5000";
    ...
    private static final String CAMEL_SINK_SMPPS_COMPONENT_SESSION_STATE_LISTENER_DOC = "You can refer to a org.jsmpp.session.SessionStateListener in the Registry to receive callbacks when the session state changed.";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_SESSION_STATE_LISTENER_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_TRANSACTION_TIMER_CONF = "camel.component.smpps.transactionTimer";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_TRANSACTION_TIMER_DOC = "Defines the maximum period of inactivity allowed after a transaction, after which an SMPP entity may assume that the session is no longer active. This timer may be active on either communicating SMPP entity (i.e. SMSC or ESME).";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_TRANSACTION_TIMER_DEFAULT = "10000";
    public static final String CAMEL_SINK_SMPPS_COMPONENT_ALPHABET_CONF = "camel.component.smpps.alphabet";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_ALPHABET_DOC = "Defines encoding of data according the SMPP 3.4 specification, section 5.2.19. 0: SMSC Default Alphabet 4: 8 bit Alphabet 8: UCS2 Alphabet One of: [0] [4] [8]";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_ALPHABET_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SMPPS_COMPONENT_DATA_CODING_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_ENCODING_CONF = "camel.component.smpps.encoding";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_ENCODING_DOC = "Defines the encoding scheme of the short message user data. Only for SubmitSm, ReplaceSm and SubmitMulti.";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_ENCODING_DEFAULT = "ISO-8859-1";
    public static final String CAMEL_SINK_SMPPS_COMPONENT_HTTP_PROXY_HOST_CONF = "camel.component.smpps.httpProxyHost";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_HTTP_PROXY_HOST_DOC = "If you need to tunnel SMPP through a HTTP proxy, set this attribute to the hostname or ip address of your HTTP proxy.";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_HTTP_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_HTTP_PROXY_PASSWORD_CONF = "camel.component.smpps.httpProxyPassword";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_HTTP_PROXY_PASSWORD_DOC = "If your HTTP proxy requires basic authentication, set this attribute to the password required for your HTTP proxy.";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_HTTP_PROXY_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_HTTP_PROXY_PORT_CONF = "camel.component.smpps.httpProxyPort";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_HTTP_PROXY_PORT_DOC = "If you need to tunnel SMPP through a HTTP proxy, set this attribute to the port of your HTTP proxy.";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_HTTP_PROXY_PORT_DEFAULT = "3128";
    public static final String CAMEL_SINK_SMPPS_COMPONENT_HTTP_PROXY_USERNAME_CONF = "camel.component.smpps.httpProxyUsername";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_HTTP_PROXY_USERNAME_DOC = "If your HTTP proxy requires basic authentication, set this attribute to the username required for your HTTP proxy.";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_HTTP_PROXY_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_PROXY_HEADERS_CONF = "camel.component.smpps.proxyHeaders";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_PROXY_HEADERS_DOC = "These headers will be passed to the proxy server while establishing the connection.";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_PROXY_HEADERS_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_PASSWORD_CONF = "camel.component.smpps.password";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_PASSWORD_DOC = "The password for connecting to SMSC server.";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_SMPPS_COMPONENT_SYSTEM_ID_CONF = "camel.component.smpps.systemId";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_SYSTEM_ID_DOC = "The system id (username) for connecting to SMSC server.";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_SYSTEM_ID_DEFAULT = "smppclient";
    public static final String CAMEL_SINK_SMPPS_COMPONENT_USING_SSLCONF = "camel.component.smpps.usingSSL";
    private static final String CAMEL_SINK_SMPPS_COMPONENT_USING_SSLDOC = "Whether using SSL with the smpps protocol";
    private static final Boolean CAMEL_SINK_SMPPS_COMPONENT_USING_SSLDEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_SMPPS_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_SMPPS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SMPPS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
        ...
        conf.define(CAMEL_SINK_SMPPS_ENDPOINT_SYNCHRONOUS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_SMPPS_ENDPOINT_SYNCHRONOUS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SMPPS_ENDPOINT_SYNCHRONOUS_DOC);
        ...
        conf.define(CAMEL_SINK_SMPPS_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_SMPPS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SMPPS_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
