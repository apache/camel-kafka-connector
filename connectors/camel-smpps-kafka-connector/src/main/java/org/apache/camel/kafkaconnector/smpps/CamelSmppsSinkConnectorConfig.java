...
public class CamelSmppsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_PDU_PROCESSOR_DEGREE_CONF = "camel.sink.endpoint.pduProcessorDegree";
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_PDU_PROCESSOR_DEGREE_DOC = "Sets the number of threads which can read PDU and process them in parallel.";
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_PDU_PROCESSOR_DEGREE_DEFAULT = "3";
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_PDU_PROCESSOR_QUEUE_CAPACITY_CONF = "camel.sink.endpoint.pduProcessorQueueCapacity";
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_PDU_PROCESSOR_QUEUE_CAPACITY_DOC = "Sets the capacity of the working queue for PDU processing.";
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_PDU_PROCESSOR_QUEUE_CAPACITY_DEFAULT = "100";
    ...
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_SINGLE_DLRCONF = "camel.sink.endpoint.singleDLR";
    public static final String CAMEL_SINK_SMPPS_ENDPOINT_SINGLE_DLRDOC = "When true, the SMSC delivery receipt would be requested only for the last segment of a multi-segment (long) message. For short messages, with only 1 segment the behaviour is unchanged.";
    public static final Boolean CAMEL_SINK_SMPPS_ENDPOINT_SINGLE_DLRDEFAULT = false;
    ...
    public static final String CAMEL_SINK_SMPPS_COMPONENT_PDU_PROCESSOR_DEGREE_CONF = "camel.component.smpps.pduProcessorDegree";
    public static final String CAMEL_SINK_SMPPS_COMPONENT_PDU_PROCESSOR_DEGREE_DOC = "Sets the number of threads which can read PDU and process them in parallel.";
    public static final String CAMEL_SINK_SMPPS_COMPONENT_PDU_PROCESSOR_DEGREE_DEFAULT = "3";
    public static final String CAMEL_SINK_SMPPS_COMPONENT_PDU_PROCESSOR_QUEUE_CAPACITY_CONF = "camel.component.smpps.pduProcessorQueueCapacity";
    public static final String CAMEL_SINK_SMPPS_COMPONENT_PDU_PROCESSOR_QUEUE_CAPACITY_DOC = "Sets the capacity of the working queue for PDU processing.";
    public static final String CAMEL_SINK_SMPPS_COMPONENT_PDU_PROCESSOR_QUEUE_CAPACITY_DEFAULT = "100";
    ...
    public static final String CAMEL_SINK_SMPPS_COMPONENT_SINGLE_DLRCONF = "camel.component.smpps.singleDLR";
    public static final String CAMEL_SINK_SMPPS_COMPONENT_SINGLE_DLRDOC = "When true, the SMSC delivery receipt would be requested only for the last segment of a multi-segment (long) message. For short messages, with only 1 segment the behaviour is unchanged.";
    public static final Boolean CAMEL_SINK_SMPPS_COMPONENT_SINGLE_DLRDEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_SMPPS_ENDPOINT_PDU_PROCESSOR_DEGREE_CONF, ConfigDef.Type.STRING, CAMEL_SINK_SMPPS_ENDPOINT_PDU_PROCESSOR_DEGREE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SMPPS_ENDPOINT_PDU_PROCESSOR_DEGREE_DOC);
        conf.define(CAMEL_SINK_SMPPS_ENDPOINT_PDU_PROCESSOR_QUEUE_CAPACITY_CONF, ConfigDef.Type.STRING, CAMEL_SINK_SMPPS_ENDPOINT_PDU_PROCESSOR_QUEUE_CAPACITY_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SMPPS_ENDPOINT_PDU_PROCESSOR_QUEUE_CAPACITY_DOC);
        ...
        conf.define(CAMEL_SINK_SMPPS_ENDPOINT_SINGLE_DLRCONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_SMPPS_ENDPOINT_SINGLE_DLRDEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SMPPS_ENDPOINT_SINGLE_DLRDOC);
        ...
        conf.define(CAMEL_SINK_SMPPS_COMPONENT_PDU_PROCESSOR_DEGREE_CONF, ConfigDef.Type.STRING, CAMEL_SINK_SMPPS_COMPONENT_PDU_PROCESSOR_DEGREE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SMPPS_COMPONENT_PDU_PROCESSOR_DEGREE_DOC);
        conf.define(CAMEL_SINK_SMPPS_COMPONENT_PDU_PROCESSOR_QUEUE_CAPACITY_CONF, ConfigDef.Type.STRING, CAMEL_SINK_SMPPS_COMPONENT_PDU_PROCESSOR_QUEUE_CAPACITY_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SMPPS_COMPONENT_PDU_PROCESSOR_QUEUE_CAPACITY_DOC);
        ...
        conf.define(CAMEL_SINK_SMPPS_COMPONENT_SINGLE_DLRCONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_SMPPS_COMPONENT_SINGLE_DLRDEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SMPPS_COMPONENT_SINGLE_DLRDOC);
