...
public class CamelAwsecsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWSECS_COMPONENT_REGION_DOC = "The region in which ECS client needs to work";
    ...
    public static final String CAMEL_SINK_AWSECS_COMPONENT_CONFIGURATION_DOC = "The AWS ECS default configuration";
