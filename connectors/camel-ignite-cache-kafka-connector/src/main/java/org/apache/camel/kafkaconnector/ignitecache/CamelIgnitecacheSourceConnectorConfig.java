...
public class CamelIgnitecacheSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_IGNITECACHE_PATH_CACHE_NAME_DOC = "The cache name.";
    private static final String CAMEL_SOURCE_IGNITECACHE_PATH_CACHE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_PROPAGATE_INCOMING_BODY_IF_NO_RETURN_VALUE_DOC = "Sets whether to propagate the incoming body if the return type of the underlying Ignite operation is void.";
    private static final Boolean CAMEL_SOURCE_IGNITECACHE_ENDPOINT_PROPAGATE_INCOMING_BODY_IF_NO_RETURN_VALUE_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_TREAT_COLLECTIONS_AS_CACHE_OBJECTS_DOC = "Sets whether to treat Collections as cache objects or as Collections of items to insert/update/compute, etc.";
    private static final Boolean CAMEL_SOURCE_IGNITECACHE_ENDPOINT_TREAT_COLLECTIONS_AS_CACHE_OBJECTS_DEFAULT = false;
    public static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_AUTO_UNSUBSCRIBE_CONF = "camel.source.endpoint.autoUnsubscribe";
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_AUTO_UNSUBSCRIBE_DOC = "Whether auto unsubscribe is enabled in the Continuous Query Consumer. Default value notice: ContinuousQuery.DFLT_AUTO_UNSUBSCRIBE";
    private static final Boolean CAMEL_SOURCE_IGNITECACHE_ENDPOINT_AUTO_UNSUBSCRIBE_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_IGNITECACHE_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_FIRE_EXISTING_QUERY_RESULTS_DOC = "Whether to process existing results that match the query. Used on initialization of the Continuous Query Consumer.";
    private static final Boolean CAMEL_SOURCE_IGNITECACHE_ENDPOINT_FIRE_EXISTING_QUERY_RESULTS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_ONE_EXCHANGE_PER_UPDATE_DOC = "Whether to pack each update in an individual Exchange, even if multiple updates are received in one batch. Only used by the Continuous Query Consumer.";
    private static final Boolean CAMEL_SOURCE_IGNITECACHE_ENDPOINT_ONE_EXCHANGE_PER_UPDATE_DEFAULT = true;
    public static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_PAGE_SIZE_CONF = "camel.source.endpoint.pageSize";
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_PAGE_SIZE_DOC = "The page size. Only used by the Continuous Query Consumer. Default value notice: ContinuousQuery.DFLT_PAGE_SIZE";
    private static final Integer CAMEL_SOURCE_IGNITECACHE_ENDPOINT_PAGE_SIZE_DEFAULT = 1;
    public static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_QUERY_CONF = "camel.source.endpoint.query";
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_QUERY_DOC = "The Query to execute, only needed for operations that require it, and for the Continuous Query Consumer.";
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_QUERY_DEFAULT = null;
    public static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_REMOTE_FILTER_CONF = "camel.source.endpoint.remoteFilter";
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_REMOTE_FILTER_DOC = "The remote filter, only used by the Continuous Query Consumer.";
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_REMOTE_FILTER_DEFAULT = null;
    public static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_TIME_INTERVAL_CONF = "camel.source.endpoint.timeInterval";
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_TIME_INTERVAL_DOC = "The time interval for the Continuous Query Consumer. Default value notice: ContinuousQuery.DFLT_TIME_INTERVAL";
    private static final Long CAMEL_SOURCE_IGNITECACHE_ENDPOINT_TIME_INTERVAL_DEFAULT = 0L;
    ...
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_IGNITECACHE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_IGNITECACHE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_IGNITECACHE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_IGNITECACHE_COMPONENT_CONFIGURATION_RESOURCE_DOC = "Resource from where to load configuration.";
    private static final String CAMEL_SOURCE_IGNITECACHE_COMPONENT_CONFIGURATION_RESOURCE_DEFAULT = null;
    public static final String CAMEL_SOURCE_IGNITECACHE_COMPONENT_IGNITE_CONF = "camel.component.ignite-cache.ignite";
    private static final String CAMEL_SOURCE_IGNITECACHE_COMPONENT_IGNITE_DOC = "Ignite instance.";
    private static final String CAMEL_SOURCE_IGNITECACHE_COMPONENT_IGNITE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_IGNITECACHE_COMPONENT_IGNITE_CONFIGURATION_DOC = "Ignite configuration.";
    private static final String CAMEL_SOURCE_IGNITECACHE_COMPONENT_IGNITE_CONFIGURATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_IGNITECACHE_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_IGNITECACHE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_IGNITECACHE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
