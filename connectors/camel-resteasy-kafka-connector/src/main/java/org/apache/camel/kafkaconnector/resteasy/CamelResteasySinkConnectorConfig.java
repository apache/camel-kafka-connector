...
public class CamelResteasySinkConnectorConfig
    ...
    public static final String CAMEL_SINK_RESTEASY_ENDPOINT_USER_AGENT_CONF = "camel.sink.endpoint.userAgent";
    public static final String CAMEL_SINK_RESTEASY_ENDPOINT_USER_AGENT_DOC = "To set a custom HTTP User-Agent request header";
    public static final String CAMEL_SINK_RESTEASY_ENDPOINT_USER_AGENT_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_RESTEASY_ENDPOINT_USER_AGENT_CONF, ConfigDef.Type.STRING, CAMEL_SINK_RESTEASY_ENDPOINT_USER_AGENT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_RESTEASY_ENDPOINT_USER_AGENT_DOC);
