...
public class CamelAwsddbsinkSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_AWSDDBSINK_KAMELET_PROFILE_CREDENTIALS_NAME_DOC = "If using a profile credentials provider this parameter sets the profile name.";
