...
public class CamelYammerSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_YAMMER_PATH_FUNCTION_DOC = "The function to use One of: [MESSAGES] [MY_FEED] [ALGO] [FOLLOWING] [SENT] [PRIVATE] [RECEIVED] [USERS] [CURRENT]";
    private static final String CAMEL_SINK_YAMMER_PATH_FUNCTION_DEFAULT = null;
    public static final String CAMEL_SINK_YAMMER_ENDPOINT_USE_JSON_CONF = "camel.sink.endpoint.useJson";
    private static final String CAMEL_SINK_YAMMER_ENDPOINT_USE_JSON_DOC = "Set to true if you want to use raw JSON rather than converting to POJOs.";
    private static final Boolean CAMEL_SINK_YAMMER_ENDPOINT_USE_JSON_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_YAMMER_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_YAMMER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_YAMMER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_YAMMER_ENDPOINT_REQUESTOR_CONF = "camel.sink.endpoint.requestor";
    private static final String CAMEL_SINK_YAMMER_ENDPOINT_REQUESTOR_DOC = "To use a specific requester to communicate with Yammer.";
    private static final String CAMEL_SINK_YAMMER_ENDPOINT_REQUESTOR_DEFAULT = null;
    public static final String CAMEL_SINK_YAMMER_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_YAMMER_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_YAMMER_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_YAMMER_ENDPOINT_ACCESS_TOKEN_CONF = "camel.sink.endpoint.accessToken";
    private static final String CAMEL_SINK_YAMMER_ENDPOINT_ACCESS_TOKEN_DOC = "The access token";
    private static final String CAMEL_SINK_YAMMER_ENDPOINT_ACCESS_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_YAMMER_ENDPOINT_CONSUMER_KEY_CONF = "camel.sink.endpoint.consumerKey";
    private static final String CAMEL_SINK_YAMMER_ENDPOINT_CONSUMER_KEY_DOC = "The consumer key";
    private static final String CAMEL_SINK_YAMMER_ENDPOINT_CONSUMER_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_YAMMER_ENDPOINT_CONSUMER_SECRET_CONF = "camel.sink.endpoint.consumerSecret";
    private static final String CAMEL_SINK_YAMMER_ENDPOINT_CONSUMER_SECRET_DOC = "The consumer secret";
    private static final String CAMEL_SINK_YAMMER_ENDPOINT_CONSUMER_SECRET_DEFAULT = null;
    public static final String CAMEL_SINK_YAMMER_COMPONENT_USE_JSON_CONF = "camel.component.yammer.useJson";
    private static final String CAMEL_SINK_YAMMER_COMPONENT_USE_JSON_DOC = "Set to true if you want to use raw JSON rather than converting to POJOs.";
    private static final Boolean CAMEL_SINK_YAMMER_COMPONENT_USE_JSON_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_YAMMER_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_YAMMER_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_YAMMER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_YAMMER_COMPONENT_CONFIGURATION_CONF = "camel.component.yammer.configuration";
    private static final String CAMEL_SINK_YAMMER_COMPONENT_CONFIGURATION_DOC = "Component configuration";
    private static final String CAMEL_SINK_YAMMER_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_YAMMER_COMPONENT_REQUESTOR_CONF = "camel.component.yammer.requestor";
    private static final String CAMEL_SINK_YAMMER_COMPONENT_REQUESTOR_DOC = "To use a specific requester to communicate with Yammer.";
    private static final String CAMEL_SINK_YAMMER_COMPONENT_REQUESTOR_DEFAULT = null;
    public static final String CAMEL_SINK_YAMMER_COMPONENT_ACCESS_TOKEN_CONF = "camel.component.yammer.accessToken";
    private static final String CAMEL_SINK_YAMMER_COMPONENT_ACCESS_TOKEN_DOC = "The access token";
    private static final String CAMEL_SINK_YAMMER_COMPONENT_ACCESS_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_YAMMER_COMPONENT_CONSUMER_KEY_CONF = "camel.component.yammer.consumerKey";
    private static final String CAMEL_SINK_YAMMER_COMPONENT_CONSUMER_KEY_DOC = "The consumer key";
    private static final String CAMEL_SINK_YAMMER_COMPONENT_CONSUMER_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_YAMMER_COMPONENT_CONSUMER_SECRET_CONF = "camel.component.yammer.consumerSecret";
    private static final String CAMEL_SINK_YAMMER_COMPONENT_CONSUMER_SECRET_DOC = "The consumer secret";
    private static final String CAMEL_SINK_YAMMER_COMPONENT_CONSUMER_SECRET_DEFAULT = null;
