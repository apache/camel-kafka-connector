...
public class CamelPgeventSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_PGEVENT_PATH_HOST_DOC = "To connect using hostname and port to the database.";
    private static final String CAMEL_SOURCE_PGEVENT_PATH_HOST_DEFAULT = "localhost";
    public static final String CAMEL_SOURCE_PGEVENT_PATH_PORT_CONF = "camel.source.path.port";
    private static final String CAMEL_SOURCE_PGEVENT_PATH_PORT_DOC = "To connect using hostname and port to the database.";
    private static final String CAMEL_SOURCE_PGEVENT_PATH_PORT_DEFAULT = "5432";
    public static final String CAMEL_SOURCE_PGEVENT_PATH_DATABASE_CONF = "camel.source.path.database";
    private static final String CAMEL_SOURCE_PGEVENT_PATH_DATABASE_DOC = "The database name";
    private static final String CAMEL_SOURCE_PGEVENT_PATH_DATABASE_DEFAULT = null;
    public static final String CAMEL_SOURCE_PGEVENT_PATH_CHANNEL_CONF = "camel.source.path.channel";
    private static final String CAMEL_SOURCE_PGEVENT_PATH_CHANNEL_DOC = "The channel name";
    private static final String CAMEL_SOURCE_PGEVENT_PATH_CHANNEL_DEFAULT = null;
    public static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_DATASOURCE_CONF = "camel.source.endpoint.datasource";
    private static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_DATASOURCE_DOC = "To connect using the given javax.sql.DataSource instead of using hostname and port.";
    private static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_DATASOURCE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_PGEVENT_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_PGEVENT_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_PGEVENT_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_PASS_CONF = "camel.source.endpoint.pass";
    private static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_PASS_DOC = "Password for login";
    private static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_PASS_DEFAULT = null;
    public static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_USER_CONF = "camel.source.endpoint.user";
    private static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_USER_DOC = "Username for login";
    private static final String CAMEL_SOURCE_PGEVENT_ENDPOINT_USER_DEFAULT = "postgres";
    ...
    private static final Boolean CAMEL_SOURCE_PGEVENT_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_PGEVENT_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_PGEVENT_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
