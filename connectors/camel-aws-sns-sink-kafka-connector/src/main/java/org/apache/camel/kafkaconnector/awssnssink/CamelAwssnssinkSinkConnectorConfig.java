...
public class CamelAwssnssinkSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_AWSSNSSINK_KAMELET_PROFILE_CREDENTIALS_NAME_DOC = "If using a profile credentials provider this parameter sets the profile name.";
