...
public class CamelMongodbSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_HOSTS_CONF = "camel.sink.endpoint.hosts";
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_HOSTS_DOC = "Host address of mongodb server in host:port format. It's possible also use more than one address, as comma separated list of hosts: host1:port1,host2:port2. If hosts parameter is specified, provided connectionBean is ignored.";
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_HOSTS_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_PASSWORD_DOC = "User password for mongodb connection";
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_USERNAME_DOC = "Username for mongodb connection";
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_MONGODB_ENDPOINT_HOSTS_CONF, ConfigDef.Type.STRING, CAMEL_SINK_MONGODB_ENDPOINT_HOSTS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_MONGODB_ENDPOINT_HOSTS_DOC);
        ...
        conf.define(CAMEL_SINK_MONGODB_ENDPOINT_PASSWORD_CONF, ConfigDef.Type.PASSWORD, CAMEL_SINK_MONGODB_ENDPOINT_PASSWORD_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_MONGODB_ENDPOINT_PASSWORD_DOC);
        conf.define(CAMEL_SINK_MONGODB_ENDPOINT_USERNAME_CONF, ConfigDef.Type.PASSWORD, CAMEL_SINK_MONGODB_ENDPOINT_USERNAME_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_MONGODB_ENDPOINT_USERNAME_DOC);
