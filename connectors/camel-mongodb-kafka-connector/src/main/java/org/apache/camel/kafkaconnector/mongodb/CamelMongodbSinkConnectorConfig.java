...
public class CamelMongodbSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_MONGODB_PATH_CONNECTION_BEAN_DOC = "Sets the connection bean reference used to lookup a client for connecting to a database.";
    private static final String CAMEL_SINK_MONGODB_PATH_CONNECTION_BEAN_DEFAULT = null;
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_COLLECTION_CONF = "camel.sink.endpoint.collection";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_COLLECTION_DOC = "Sets the name of the MongoDB collection to bind to this endpoint";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_COLLECTION_DEFAULT = null;
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_COLLECTION_INDEX_CONF = "camel.sink.endpoint.collectionIndex";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_COLLECTION_INDEX_DOC = "Sets the collection index (JSON FORMAT : { field1 : order1, field2 : order2})";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_COLLECTION_INDEX_DEFAULT = null;
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_CREATE_COLLECTION_CONF = "camel.sink.endpoint.createCollection";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_CREATE_COLLECTION_DOC = "Create collection during initialisation if it doesn't exist. Default is true.";
    private static final Boolean CAMEL_SINK_MONGODB_ENDPOINT_CREATE_COLLECTION_DEFAULT = true;
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_DATABASE_CONF = "camel.sink.endpoint.database";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_DATABASE_DOC = "Sets the name of the MongoDB database to target";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_DATABASE_DEFAULT = null;
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_MONGO_CONNECTION_CONF = "camel.sink.endpoint.mongoConnection";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_MONGO_CONNECTION_DOC = "Sets the connection bean used as a client for connecting to a database.";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_MONGO_CONNECTION_DEFAULT = null;
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_OPERATION_CONF = "camel.sink.endpoint.operation";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_OPERATION_DOC = "Sets the operation this endpoint will execute against MongoDB. One of: [findById] [findOneByQuery] [findAll] [findDistinct] [insert] [save] [update] [remove] [bulkWrite] [aggregate] [getDbStats] [getColStats] [count] [command]";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_OPERATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_OUTPUT_TYPE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_MONGODB_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_MONGODB_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final Long CAMEL_SINK_MONGODB_ENDPOINT_CURSOR_REGENERATION_DELAY_DEFAULT = 1000L;
    ...
    private static final Boolean CAMEL_SINK_MONGODB_ENDPOINT_DYNAMICITY_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_READ_PREFERENCE_DEFAULT = "PRIMARY";
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_MONGODB_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_WRITE_CONCERN_DEFAULT = "ACKNOWLEDGED";
    ...
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_WRITE_RESULT_AS_HEADER_DOC = "In write operations, it determines whether instead of returning WriteResult as the body of the OUT message, we transfer the IN message to the OUT and attach the WriteResult as a header.";
    private static final Boolean CAMEL_SINK_MONGODB_ENDPOINT_WRITE_RESULT_AS_HEADER_DEFAULT = false;
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_STREAM_FILTER_CONF = "camel.sink.endpoint.streamFilter";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_STREAM_FILTER_DOC = "Filter condition for change streams consumer.";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_STREAM_FILTER_DEFAULT = null;
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_PERSISTENT_ID_CONF = "camel.sink.endpoint.persistentId";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_PERSISTENT_ID_DOC = "One tail tracking collection can host many trackers for several tailable consumers. To keep them separate, each tracker should have its own unique persistentId.";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_PERSISTENT_ID_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_MONGODB_ENDPOINT_PERSISTENT_TAIL_TRACKING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_TAIL_TRACK_COLLECTION_DOC = "Collection where tail tracking information will be persisted. If not specified, MongoDbTailTrackingConfig#DEFAULT_COLLECTION will be used by default.";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_TAIL_TRACK_COLLECTION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_TAIL_TRACK_DB_DEFAULT = null;
    public static final String CAMEL_SINK_MONGODB_ENDPOINT_TAIL_TRACK_FIELD_CONF = "camel.sink.endpoint.tailTrackField";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_TAIL_TRACK_FIELD_DOC = "Field where the last tracked value will be placed. If not specified, MongoDbTailTrackingConfig#DEFAULT_FIELD will be used by default.";
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_TAIL_TRACK_FIELD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_MONGODB_ENDPOINT_TAIL_TRACK_INCREASING_FIELD_DEFAULT = null;
    public static final String CAMEL_SINK_MONGODB_COMPONENT_MONGO_CONNECTION_CONF = "camel.component.mongodb.mongoConnection";
    private static final String CAMEL_SINK_MONGODB_COMPONENT_MONGO_CONNECTION_DOC = "A connection client provided externally";
    private static final String CAMEL_SINK_MONGODB_COMPONENT_MONGO_CONNECTION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_MONGODB_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_MONGODB_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_MONGODB_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
