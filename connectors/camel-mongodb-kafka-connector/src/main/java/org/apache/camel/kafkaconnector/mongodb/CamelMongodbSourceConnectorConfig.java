...
public class CamelMongodbSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_MONGODB_ENDPOINT_HOSTS_CONF = "camel.source.endpoint.hosts";
    public static final String CAMEL_SOURCE_MONGODB_ENDPOINT_HOSTS_DOC = "Host address of mongodb server in host:port format. It's possible also use more than one address, as comma separated list of hosts: host1:port1,host2:port2. If hosts parameter is specified, provided connectionBean is ignored.";
    public static final String CAMEL_SOURCE_MONGODB_ENDPOINT_HOSTS_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_MONGODB_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    public static final String CAMEL_SOURCE_MONGODB_ENDPOINT_PASSWORD_DOC = "User password for mongodb connection";
    public static final String CAMEL_SOURCE_MONGODB_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_MONGODB_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    public static final String CAMEL_SOURCE_MONGODB_ENDPOINT_USERNAME_DOC = "Username for mongodb connection";
    public static final String CAMEL_SOURCE_MONGODB_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_MONGODB_ENDPOINT_HOSTS_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_MONGODB_ENDPOINT_HOSTS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_MONGODB_ENDPOINT_HOSTS_DOC);
        ...
        conf.define(CAMEL_SOURCE_MONGODB_ENDPOINT_PASSWORD_CONF, ConfigDef.Type.PASSWORD, CAMEL_SOURCE_MONGODB_ENDPOINT_PASSWORD_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_MONGODB_ENDPOINT_PASSWORD_DOC);
        conf.define(CAMEL_SOURCE_MONGODB_ENDPOINT_USERNAME_CONF, ConfigDef.Type.PASSWORD, CAMEL_SOURCE_MONGODB_ENDPOINT_USERNAME_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_MONGODB_ENDPOINT_USERNAME_DOC);
