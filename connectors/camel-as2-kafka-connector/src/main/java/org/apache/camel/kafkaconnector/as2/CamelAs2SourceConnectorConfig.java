...
public class CamelAs2SourceConnectorConfig extends CamelSourceConnectorConfig {
    ...
    public static final String CAMEL_SOURCE_AS2_ENDPOINT_ATTACHED_FILE_NAME_CONF = "camel.source.endpoint.attachedFileName";
    public static final String CAMEL_SOURCE_AS2_ENDPOINT_ATTACHED_FILE_NAME_DOC = "The name of the attached file";
    public static final String CAMEL_SOURCE_AS2_ENDPOINT_ATTACHED_FILE_NAME_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_AS2_ENDPOINT_ATTACHED_FILE_NAME_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_AS2_ENDPOINT_ATTACHED_FILE_NAME_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AS2_ENDPOINT_ATTACHED_FILE_NAME_DOC);
