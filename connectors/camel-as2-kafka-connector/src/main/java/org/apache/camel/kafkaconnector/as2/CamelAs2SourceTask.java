...
public class CamelAs2SourceTask extends CamelSourceTask {

    @Override
    protected CamelSourceConnectorConfig getCamelSourceConnectorConfig(
            Map<String, String> props) {
        return new CamelAs2SourceConnectorConfig(props);
    }
    @Override
    protected Map<String, String> getDefaultConfig() {
        return new HashMap<String, String>() {{
            put(CamelSourceConnectorConfig.CAMEL_SOURCE_COMPONENT_CONF, "as2");
        }};
    }
}