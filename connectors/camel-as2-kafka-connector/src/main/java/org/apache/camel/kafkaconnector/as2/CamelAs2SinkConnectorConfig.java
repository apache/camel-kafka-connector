...
public class CamelAs2SinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AS2_ENDPOINT_ATTACHED_FILE_NAME_CONF = "camel.sink.endpoint.attachedFileName";
    public static final String CAMEL_SINK_AS2_ENDPOINT_ATTACHED_FILE_NAME_DOC = "The name of the attached file";
    public static final String CAMEL_SINK_AS2_ENDPOINT_ATTACHED_FILE_NAME_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_AS2_ENDPOINT_ATTACHED_FILE_NAME_CONF, ConfigDef.Type.STRING, CAMEL_SINK_AS2_ENDPOINT_ATTACHED_FILE_NAME_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AS2_ENDPOINT_ATTACHED_FILE_NAME_DOC);
