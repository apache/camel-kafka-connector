...
public class CamelAs2SinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_AS2_PATH_API_NAME_DOC = "What kind of operation to perform One of: [CLIENT] [SERVER]";
    private static final String CAMEL_SINK_AS2_PATH_API_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_PATH_METHOD_NAME_CONF = "camel.sink.path.methodName";
    private static final String CAMEL_SINK_AS2_PATH_METHOD_NAME_DOC = "What sub operation to use for the selected operation";
    private static final String CAMEL_SINK_AS2_PATH_METHOD_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_AS_2FROM_CONF = "camel.sink.endpoint.as2From";
    private static final String CAMEL_SINK_AS2_ENDPOINT_AS_2FROM_DOC = "The value of the AS2From header of AS2 message.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_AS_2FROM_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AS2_ENDPOINT_AS_2MESSAGE_STRUCTURE_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_AS_2TO_CONF = "camel.sink.endpoint.as2To";
    private static final String CAMEL_SINK_AS2_ENDPOINT_AS_2TO_DOC = "The value of the AS2To header of AS2 message.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_AS_2TO_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_AS_2VERSION_CONF = "camel.sink.endpoint.as2Version";
    private static final String CAMEL_SINK_AS2_ENDPOINT_AS_2VERSION_DOC = "The version of the AS2 protocol. One of: [1.0] [1.1]";
    private static final String CAMEL_SINK_AS2_ENDPOINT_AS_2VERSION_DEFAULT = "1.1";
    public static final String CAMEL_SINK_AS2_ENDPOINT_CLIENT_FQDN_CONF = "camel.sink.endpoint.clientFqdn";
    private static final String CAMEL_SINK_AS2_ENDPOINT_CLIENT_FQDN_DOC = "The Client Fully Qualified Domain Name (FQDN). Used in message ids sent by endpoint.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_CLIENT_FQDN_DEFAULT = "camel.apache.org";
    public static final String CAMEL_SINK_AS2_ENDPOINT_COMPRESSION_ALGORITHM_CONF = "camel.sink.endpoint.compressionAlgorithm";
    private static final String CAMEL_SINK_AS2_ENDPOINT_COMPRESSION_ALGORITHM_DOC = "The algorithm used to compress EDI message. One of: [ZLIB]";
    private static final String CAMEL_SINK_AS2_ENDPOINT_COMPRESSION_ALGORITHM_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_DECRYPTING_PRIVATE_KEY_CONF = "camel.sink.endpoint.decryptingPrivateKey";
    private static final String CAMEL_SINK_AS2_ENDPOINT_DECRYPTING_PRIVATE_KEY_DOC = "The key used to encrypt the EDI message.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_DECRYPTING_PRIVATE_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AS2_ENDPOINT_DISPOSITION_NOTIFICATION_TO_DOC = "The value of the Disposition-Notification-To header. Assigning a value to this parameter requests a message disposition notification (MDN) for the AS2 message.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_DISPOSITION_NOTIFICATION_TO_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AS2_ENDPOINT_EDI_MESSAGE_TRANSFER_ENCODING_DOC = "The transfer encoding of EDI message.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_EDI_MESSAGE_TRANSFER_ENCODING_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_EDI_MESSAGE_TYPE_CONF = "camel.sink.endpoint.ediMessageType";
    private static final String CAMEL_SINK_AS2_ENDPOINT_EDI_MESSAGE_TYPE_DOC = "The content type of EDI message. One of application/edifact, application/edi-x12, application/edi-consent";
    private static final String CAMEL_SINK_AS2_ENDPOINT_EDI_MESSAGE_TYPE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AS2_ENDPOINT_ENCRYPTING_ALGORITHM_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AS2_ENDPOINT_ENCRYPTING_CERTIFICATE_CHAIN_DOC = "The chain of certificates used to encrypt EDI message.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_ENCRYPTING_CERTIFICATE_CHAIN_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_FROM_CONF = "camel.sink.endpoint.from";
    private static final String CAMEL_SINK_AS2_ENDPOINT_FROM_DOC = "The value of the From header of AS2 message.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_FROM_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_IN_BODY_CONF = "camel.sink.endpoint.inBody";
    private static final String CAMEL_SINK_AS2_ENDPOINT_IN_BODY_DOC = "Sets the name of a parameter to be passed in the exchange In Body";
    private static final String CAMEL_SINK_AS2_ENDPOINT_IN_BODY_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_MDN_MESSAGE_TEMPLATE_CONF = "camel.sink.endpoint.mdnMessageTemplate";
    private static final String CAMEL_SINK_AS2_ENDPOINT_MDN_MESSAGE_TEMPLATE_DOC = "The template used to format MDN message";
    private static final String CAMEL_SINK_AS2_ENDPOINT_MDN_MESSAGE_TEMPLATE_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_REQUEST_URI_CONF = "camel.sink.endpoint.requestUri";
    private static final String CAMEL_SINK_AS2_ENDPOINT_REQUEST_URI_DOC = "The request URI of EDI message.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_REQUEST_URI_DEFAULT = "/";
    public static final String CAMEL_SINK_AS2_ENDPOINT_SERVER_CONF = "camel.sink.endpoint.server";
    private static final String CAMEL_SINK_AS2_ENDPOINT_SERVER_DOC = "The value included in the Server message header identifying the AS2 Server.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_SERVER_DEFAULT = "Camel AS2 Server Endpoint";
    public static final String CAMEL_SINK_AS2_ENDPOINT_SERVER_FQDN_CONF = "camel.sink.endpoint.serverFqdn";
    private static final String CAMEL_SINK_AS2_ENDPOINT_SERVER_FQDN_DOC = "The Server Fully Qualified Domain Name (FQDN). Used in message ids sent by endpoint.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_SERVER_FQDN_DEFAULT = "camel.apache.org";
    public static final String CAMEL_SINK_AS2_ENDPOINT_SERVER_PORT_NUMBER_CONF = "camel.sink.endpoint.serverPortNumber";
    private static final String CAMEL_SINK_AS2_ENDPOINT_SERVER_PORT_NUMBER_DOC = "The port number of server.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_SERVER_PORT_NUMBER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AS2_ENDPOINT_SIGNED_RECEIPT_MIC_ALGORITHMS_DOC = "The list of algorithms, in order of preference, requested to generate a message integrity check (MIC) returned in message dispostion notification (MDN)";
    private static final String CAMEL_SINK_AS2_ENDPOINT_SIGNED_RECEIPT_MIC_ALGORITHMS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AS2_ENDPOINT_SIGNING_ALGORITHM_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AS2_ENDPOINT_SIGNING_CERTIFICATE_CHAIN_DOC = "The chain of certificates used to sign EDI message.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_SIGNING_CERTIFICATE_CHAIN_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_SIGNING_PRIVATE_KEY_CONF = "camel.sink.endpoint.signingPrivateKey";
    private static final String CAMEL_SINK_AS2_ENDPOINT_SIGNING_PRIVATE_KEY_DOC = "The key used to sign the EDI message.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_SIGNING_PRIVATE_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_SUBJECT_CONF = "camel.sink.endpoint.subject";
    private static final String CAMEL_SINK_AS2_ENDPOINT_SUBJECT_DOC = "The value of Subject header of AS2 message.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_SUBJECT_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_TARGET_HOSTNAME_CONF = "camel.sink.endpoint.targetHostname";
    private static final String CAMEL_SINK_AS2_ENDPOINT_TARGET_HOSTNAME_DOC = "The host name (IP or DNS name) of target host.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_TARGET_HOSTNAME_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_TARGET_PORT_NUMBER_CONF = "camel.sink.endpoint.targetPortNumber";
    private static final String CAMEL_SINK_AS2_ENDPOINT_TARGET_PORT_NUMBER_DOC = "The port number of target host. -1 indicates the scheme default port.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_TARGET_PORT_NUMBER_DEFAULT = null;
    public static final String CAMEL_SINK_AS2_ENDPOINT_USER_AGENT_CONF = "camel.sink.endpoint.userAgent";
    private static final String CAMEL_SINK_AS2_ENDPOINT_USER_AGENT_DOC = "The value included in the User-Agent message header identifying the AS2 user agent.";
    private static final String CAMEL_SINK_AS2_ENDPOINT_USER_AGENT_DEFAULT = "Camel AS2 Client Endpoint";
    ...
    private static final Boolean CAMEL_SINK_AS2_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_AS2_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_AS2_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AS2_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AS2_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_AS2_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_AS2_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_AS2_COMPONENT_CONFIGURATION_CONF = "camel.component.as2.configuration";
    private static final String CAMEL_SINK_AS2_COMPONENT_CONFIGURATION_DOC = "To use the shared configuration";
    private static final String CAMEL_SINK_AS2_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_AS2_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_AS2_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.as2.basicPropertyBinding";
    private static final String CAMEL_SINK_AS2_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AS2_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
