...
public class CamelIgniteidgenSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_IGNITEIDGEN_PATH_NAME_DOC = "The sequence name.";
    private static final String CAMEL_SINK_IGNITEIDGEN_PATH_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_IGNITEIDGEN_ENDPOINT_BATCH_SIZE_CONF = "camel.sink.endpoint.batchSize";
    private static final String CAMEL_SINK_IGNITEIDGEN_ENDPOINT_BATCH_SIZE_DOC = "The batch size.";
    private static final String CAMEL_SINK_IGNITEIDGEN_ENDPOINT_BATCH_SIZE_DEFAULT = null;
    public static final String CAMEL_SINK_IGNITEIDGEN_ENDPOINT_INITIAL_VALUE_CONF = "camel.sink.endpoint.initialValue";
    private static final String CAMEL_SINK_IGNITEIDGEN_ENDPOINT_INITIAL_VALUE_DOC = "The initial value.";
    private static final String CAMEL_SINK_IGNITEIDGEN_ENDPOINT_INITIAL_VALUE_DEFAULT = "0";
    ...
    private static final Boolean CAMEL_SINK_IGNITEIDGEN_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_IGNITEIDGEN_ENDPOINT_OPERATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IGNITEIDGEN_ENDPOINT_PROPAGATE_INCOMING_BODY_IF_NO_RETURN_VALUE_DOC = "Sets whether to propagate the incoming body if the return type of the underlying Ignite operation is void.";
    private static final Boolean CAMEL_SINK_IGNITEIDGEN_ENDPOINT_PROPAGATE_INCOMING_BODY_IF_NO_RETURN_VALUE_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_IGNITEIDGEN_ENDPOINT_TREAT_COLLECTIONS_AS_CACHE_OBJECTS_DOC = "Sets whether to treat Collections as cache objects or as Collections of items to insert/update/compute, etc.";
    private static final Boolean CAMEL_SINK_IGNITEIDGEN_ENDPOINT_TREAT_COLLECTIONS_AS_CACHE_OBJECTS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_IGNITEIDGEN_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_IGNITEIDGEN_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_IGNITEIDGEN_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_IGNITEIDGEN_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_IGNITEIDGEN_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_IGNITEIDGEN_COMPONENT_CONFIGURATION_RESOURCE_DOC = "Resource from where to load configuration.";
    private static final String CAMEL_SINK_IGNITEIDGEN_COMPONENT_CONFIGURATION_RESOURCE_DEFAULT = null;
    public static final String CAMEL_SINK_IGNITEIDGEN_COMPONENT_IGNITE_CONF = "camel.component.ignite-idgen.ignite";
    private static final String CAMEL_SINK_IGNITEIDGEN_COMPONENT_IGNITE_DOC = "Ignite instance.";
    private static final String CAMEL_SINK_IGNITEIDGEN_COMPONENT_IGNITE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IGNITEIDGEN_COMPONENT_IGNITE_CONFIGURATION_DOC = "Ignite configuration.";
    private static final String CAMEL_SINK_IGNITEIDGEN_COMPONENT_IGNITE_CONFIGURATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_IGNITEIDGEN_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_IGNITEIDGEN_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_IGNITEIDGEN_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
