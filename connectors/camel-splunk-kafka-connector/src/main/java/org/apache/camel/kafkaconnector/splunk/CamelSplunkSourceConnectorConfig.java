...
public class CamelSplunkSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_SPLUNK_PATH_NAME_DOC = "Name has no purpose";
    private static final String CAMEL_SOURCE_SPLUNK_PATH_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_APP_CONF = "camel.source.endpoint.app";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_APP_DOC = "Splunk app";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_APP_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_CONNECTION_TIMEOUT_CONF = "camel.source.endpoint.connectionTimeout";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_CONNECTION_TIMEOUT_DOC = "Timeout in MS when connecting to Splunk server";
    private static final Integer CAMEL_SOURCE_SPLUNK_ENDPOINT_CONNECTION_TIMEOUT_DEFAULT = 5000;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_HOST_CONF = "camel.source.endpoint.host";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_HOST_DOC = "Splunk host.";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_HOST_DEFAULT = "localhost";
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_OWNER_CONF = "camel.source.endpoint.owner";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_OWNER_DOC = "Splunk owner";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_OWNER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_PORT_CONF = "camel.source.endpoint.port";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_PORT_DOC = "Splunk port";
    private static final Integer CAMEL_SOURCE_SPLUNK_ENDPOINT_PORT_DEFAULT = 8089;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SCHEME_CONF = "camel.source.endpoint.scheme";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SCHEME_DOC = "Splunk scheme";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SCHEME_DEFAULT = "https";
    ...
    private static final Boolean CAMEL_SOURCE_SPLUNK_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_COUNT_CONF = "camel.source.endpoint.count";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_COUNT_DOC = "A number that indicates the maximum number of entities to return.";
    private static final Integer CAMEL_SOURCE_SPLUNK_ENDPOINT_COUNT_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_EARLIEST_TIME_CONF = "camel.source.endpoint.earliestTime";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_EARLIEST_TIME_DOC = "Earliest time of the search time window.";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_EARLIEST_TIME_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_INIT_EARLIEST_TIME_CONF = "camel.source.endpoint.initEarliestTime";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_INIT_EARLIEST_TIME_DOC = "Initial start offset of the first search";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_INIT_EARLIEST_TIME_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_LATEST_TIME_CONF = "camel.source.endpoint.latestTime";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_LATEST_TIME_DOC = "Latest time of the search time window.";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_LATEST_TIME_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SAVED_SEARCH_CONF = "camel.source.endpoint.savedSearch";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SAVED_SEARCH_DOC = "The name of the query saved in Splunk to run";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SAVED_SEARCH_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SEARCH_CONF = "camel.source.endpoint.search";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SEARCH_DOC = "The Splunk query to run";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SEARCH_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DOC = "If the polling consumer did not poll any files, you can enable this option to send an empty message (no body) instead.";
    private static final Boolean CAMEL_SOURCE_SPLUNK_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_STREAMING_CONF = "camel.source.endpoint.streaming";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_STREAMING_DOC = "Sets streaming mode. Streaming mode sends exchanges as they are received, rather than in a batch.";
    private static final Boolean CAMEL_SOURCE_SPLUNK_ENDPOINT_STREAMING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_POLL_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.source.endpoint.basicPropertyBinding";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SPLUNK_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_SPLUNK_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DOC = "The number of subsequent error polls (failed due some error) that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_SPLUNK_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DOC = "The number of subsequent idle polls that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_SPLUNK_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_SPLUNK_ENDPOINT_BACKOFF_MULTIPLIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll.";
    private static final Long CAMEL_SOURCE_SPLUNK_ENDPOINT_DELAY_DEFAULT = 500L;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_GREEDY_CONF = "camel.source.endpoint.greedy";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_GREEDY_DOC = "If greedy is enabled, then the ScheduledPollConsumer will run immediately again, if the previous run polled 1 or more messages.";
    private static final Boolean CAMEL_SOURCE_SPLUNK_ENDPOINT_GREEDY_DEFAULT = false;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_INITIAL_DELAY_CONF = "camel.source.endpoint.initialDelay";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts.";
    private static final Long CAMEL_SOURCE_SPLUNK_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_REPEAT_COUNT_CONF = "camel.source.endpoint.repeatCount";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_REPEAT_COUNT_DOC = "Specifies a maximum limit of number of fires. So if you set it to 1, the scheduler will only fire once. If you set it to 5, it will only fire five times. A value of zero or negative means fire forever.";
    private static final Long CAMEL_SOURCE_SPLUNK_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_RUN_LOGGING_LEVEL_CONF = "camel.source.endpoint.runLoggingLevel";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_RUN_LOGGING_LEVEL_DOC = "The consumer logs a start/complete log line when it polls. This option allows you to configure the logging level for that. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_RUN_LOGGING_LEVEL_DEFAULT = "TRACE";
    ...
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DOC = "Allows for configuring a custom/shared thread pool to use for the consumer. By default each consumer has its own single threaded thread pool.";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SCHEDULER_CONF = "camel.source.endpoint.scheduler";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component One of: [none] [spring] [quartz]";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SCHEDULER_DEFAULT = "none";
    ...
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SCHEDULER_PROPERTIES_DOC = "To configure additional properties when using a custom scheduler or any of the Quartz, Spring based scheduler.";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SCHEDULER_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_START_SCHEDULER_CONF = "camel.source.endpoint.startScheduler";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_START_SCHEDULER_DOC = "Whether the scheduler should be auto started.";
    private static final Boolean CAMEL_SOURCE_SPLUNK_ENDPOINT_START_SCHEDULER_DEFAULT = true;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_TIME_UNIT_CONF = "camel.source.endpoint.timeUnit";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_TIME_UNIT_DOC = "Time unit for initialDelay and delay options. One of: [NANOSECONDS] [MICROSECONDS] [MILLISECONDS] [SECONDS] [MINUTES] [HOURS] [DAYS]";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_TIME_UNIT_DEFAULT = "MILLISECONDS";
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_USE_FIXED_DELAY_CONF = "camel.source.endpoint.useFixedDelay";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_USE_FIXED_DELAY_DOC = "Controls if fixed delay or fixed rate is used. See ScheduledExecutorService in JDK for details.";
    private static final Boolean CAMEL_SOURCE_SPLUNK_ENDPOINT_USE_FIXED_DELAY_DEFAULT = true;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_PASSWORD_DOC = "Password for Splunk";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SSL_PROTOCOL_CONF = "camel.source.endpoint.sslProtocol";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SSL_PROTOCOL_DOC = "Set the ssl protocol to use One of: [TLSv1.2] [TLSv1.1] [TLSv1] [SSLv3]";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_SSL_PROTOCOL_DEFAULT = "TLSv1.2";
    public static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_USERNAME_DOC = "Username for Splunk";
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SPLUNK_ENDPOINT_USE_SUN_HTTPS_HANDLER_DOC = "Use sun.net.www.protocol.https.Handler Https handler to establish the Splunk Connection. Can be useful when running in application servers to avoid app. server https handling.";
    private static final Boolean CAMEL_SOURCE_SPLUNK_ENDPOINT_USE_SUN_HTTPS_HANDLER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_SPLUNK_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_SPLUNK_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.splunk.basicPropertyBinding";
    private static final String CAMEL_SOURCE_SPLUNK_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SPLUNK_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SPLUNK_COMPONENT_SPLUNK_CONFIGURATION_FACTORY_DOC = "To use the SplunkConfigurationFactory";
    private static final String CAMEL_SOURCE_SPLUNK_COMPONENT_SPLUNK_CONFIGURATION_FACTORY_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_SPLUNK_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_SPLUNK_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SPLUNK_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
        conf.define(CAMEL_SOURCE_SPLUNK_ENDPOINT_SYNCHRONOUS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_SPLUNK_ENDPOINT_SYNCHRONOUS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SPLUNK_ENDPOINT_SYNCHRONOUS_DOC);
        ...
        conf.define(CAMEL_SOURCE_SPLUNK_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_SPLUNK_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SPLUNK_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
