...
public class CamelSplunkSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_SPLUNK_PATH_NAME_DOC = "Name has no purpose";
    private static final String CAMEL_SINK_SPLUNK_PATH_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_APP_CONF = "camel.sink.endpoint.app";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_APP_DOC = "Splunk app";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_APP_DEFAULT = null;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_CONNECTION_TIMEOUT_CONF = "camel.sink.endpoint.connectionTimeout";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_CONNECTION_TIMEOUT_DOC = "Timeout in MS when connecting to Splunk server";
    private static final Integer CAMEL_SINK_SPLUNK_ENDPOINT_CONNECTION_TIMEOUT_DEFAULT = 5000;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_HOST_CONF = "camel.sink.endpoint.host";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_HOST_DOC = "Splunk host.";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_HOST_DEFAULT = "localhost";
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_OWNER_CONF = "camel.sink.endpoint.owner";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_OWNER_DOC = "Splunk owner";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_OWNER_DEFAULT = null;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_PORT_CONF = "camel.sink.endpoint.port";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_PORT_DOC = "Splunk port";
    private static final Integer CAMEL_SINK_SPLUNK_ENDPOINT_PORT_DEFAULT = 8089;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_SCHEME_CONF = "camel.sink.endpoint.scheme";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_SCHEME_DOC = "Splunk scheme";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_SCHEME_DEFAULT = "https";
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_EVENT_HOST_CONF = "camel.sink.endpoint.eventHost";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_EVENT_HOST_DOC = "Override the default Splunk event host field";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_EVENT_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_INDEX_CONF = "camel.sink.endpoint.index";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_INDEX_DOC = "Splunk index to write to";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_INDEX_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SPLUNK_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_RAW_CONF = "camel.sink.endpoint.raw";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_RAW_DOC = "Should the payload be inserted raw";
    private static final Boolean CAMEL_SINK_SPLUNK_ENDPOINT_RAW_DEFAULT = false;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_SOURCE_CONF = "camel.sink.endpoint.source";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_SOURCE_DOC = "Splunk source argument";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_SOURCE_DEFAULT = null;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_SOURCE_TYPE_CONF = "camel.sink.endpoint.sourceType";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_SOURCE_TYPE_DOC = "Splunk sourcetype argument";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_SOURCE_TYPE_DEFAULT = null;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_TCP_RECEIVER_PORT_CONF = "camel.sink.endpoint.tcpReceiverPort";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_TCP_RECEIVER_PORT_DOC = "Splunk tcp receiver port";
    private static final Integer CAMEL_SINK_SPLUNK_ENDPOINT_TCP_RECEIVER_PORT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SPLUNK_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_SPLUNK_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_PASSWORD_DOC = "Password for Splunk";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_SSL_PROTOCOL_CONF = "camel.sink.endpoint.sslProtocol";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_SSL_PROTOCOL_DOC = "Set the ssl protocol to use One of: [TLSv1.2] [TLSv1.1] [TLSv1] [SSLv3]";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_SSL_PROTOCOL_DEFAULT = "TLSv1.2";
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_USERNAME_DOC = "Username for Splunk";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_SPLUNK_ENDPOINT_USE_SUN_HTTPS_HANDLER_CONF = "camel.sink.endpoint.useSunHttpsHandler";
    private static final String CAMEL_SINK_SPLUNK_ENDPOINT_USE_SUN_HTTPS_HANDLER_DOC = "Use sun.net.www.protocol.https.Handler Https handler to establish the Splunk Connection. Can be useful when running in application servers to avoid app. server https handling.";
    private static final Boolean CAMEL_SINK_SPLUNK_ENDPOINT_USE_SUN_HTTPS_HANDLER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SPLUNK_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SPLUNK_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SPLUNK_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SPLUNK_COMPONENT_SPLUNK_CONFIGURATION_FACTORY_DOC = "To use the SplunkConfigurationFactory";
    private static final String CAMEL_SINK_SPLUNK_COMPONENT_SPLUNK_CONFIGURATION_FACTORY_DEFAULT = null;
