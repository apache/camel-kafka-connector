...
public class CamelGooglemailsourceSourceTask extends CamelSourceTask {

    @Override
    protected CamelSourceConnectorConfig getCamelSourceConnectorConfig(
            Map<String, String> props) {
        return new CamelGooglemailsourceSourceConnectorConfig(props);
    }
    @Override
    protected String getSourceKamelet() {
        return "kamelet:google-mail-source";
    }
}