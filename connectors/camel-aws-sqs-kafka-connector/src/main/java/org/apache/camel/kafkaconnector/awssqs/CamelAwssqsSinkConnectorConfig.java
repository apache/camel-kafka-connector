...
public class CamelAwssqsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWSSQS_COMPONENT_REGION_DOC = "Specify the queue region which could be used with queueOwnerAWSAccountId to build the service URL.";
    ...
    public static final String CAMEL_SINK_AWSSQS_COMPONENT_CONFIGURATION_DOC = "The AWS SQS default configuration";
