...
public class CamelAwssqsSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll. You can also specify time values using units, such as 60s (60 seconds), 5m30s (5 minutes and 30 seconds), and 1h (1 hour).";
    ...
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts. You can also specify time values using units, such as 60s (60 seconds), 5m30s (5 minutes and 30 seconds), and 1h (1 hour).";
    ...
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_REGION_DOC = "Specify the queue region which could be used with queueOwnerAWSAccountId to build the service URL.";
    ...
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_CONFIGURATION_DOC = "The AWS SQS default configuration";
