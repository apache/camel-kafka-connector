...
public class CamelAwssqsSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_AWSSQS_PATH_QUEUE_NAME_OR_ARN_DOC = "Queue name or ARN";
    private static final String CAMEL_SOURCE_AWSSQS_PATH_QUEUE_NAME_OR_ARN_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_AMAZON_AWSHOST_CONF = "camel.source.endpoint.amazonAWSHost";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_AMAZON_AWSHOST_DOC = "The hostname of the Amazon AWS cloud.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_AMAZON_AWSHOST_DEFAULT = "amazonaws.com";
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_AMAZON_SQSCLIENT_CONF = "camel.source.endpoint.amazonSQSClient";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_AMAZON_SQSCLIENT_DOC = "To use the AmazonSQS as client";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_AMAZON_SQSCLIENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_AUTO_CREATE_QUEUE_CONF = "camel.source.endpoint.autoCreateQueue";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_AUTO_CREATE_QUEUE_DOC = "Setting the autocreation of the queue";
    private static final Boolean CAMEL_SOURCE_AWSSQS_ENDPOINT_AUTO_CREATE_QUEUE_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom HeaderFilterStrategy to map headers to/from Camel.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_PROTOCOL_CONF = "camel.source.endpoint.protocol";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_PROTOCOL_DOC = "The underlying protocol used to communicate with SQS";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_PROTOCOL_DEFAULT = "https";
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_PROXY_PROTOCOL_CONF = "camel.source.endpoint.proxyProtocol";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_PROXY_PROTOCOL_DOC = "To define a proxy protocol when instantiating the SQS client One of: [HTTP] [HTTPS]";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_PROXY_PROTOCOL_DEFAULT = "HTTPS";
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_QUEUE_OWNER_AWSACCOUNT_ID_DOC = "Specify the queue owner aws account id when you need to connect the queue with different account owner.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_QUEUE_OWNER_AWSACCOUNT_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_REGION_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_ATTRIBUTE_NAMES_CONF = "camel.source.endpoint.attributeNames";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_ATTRIBUTE_NAMES_DOC = "A list of attribute names to receive when consuming. Multiple names can be separated by comma.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_ATTRIBUTE_NAMES_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_AWSSQS_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_CONCURRENT_CONSUMERS_DOC = "Allows you to use multiple threads to poll the sqs queue to increase throughput";
    private static final Integer CAMEL_SOURCE_AWSSQS_ENDPOINT_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_DEFAULT_VISIBILITY_TIMEOUT_DOC = "The default visibility timeout (in seconds)";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_DEFAULT_VISIBILITY_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_DELETE_AFTER_READ_CONF = "camel.source.endpoint.deleteAfterRead";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_DELETE_AFTER_READ_DOC = "Delete message from SQS after it has been read";
    private static final Boolean CAMEL_SOURCE_AWSSQS_ENDPOINT_DELETE_AFTER_READ_DEFAULT = true;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_DELETE_IF_FILTERED_CONF = "camel.source.endpoint.deleteIfFiltered";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_DELETE_IF_FILTERED_DOC = "Whether or not to send the DeleteMessage to the SQS queue if an exchange fails to get through a filter. If 'false' and exchange does not make it through a Camel filter upstream in the route, then don't send DeleteMessage.";
    private static final Boolean CAMEL_SOURCE_AWSSQS_ENDPOINT_DELETE_IF_FILTERED_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_AWSSQS_ENDPOINT_EXTEND_MESSAGE_VISIBILITY_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_KMS_DATA_KEY_REUSE_PERIOD_SECONDS_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_KMS_MASTER_KEY_ID_CONF = "camel.source.endpoint.kmsMasterKeyId";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_KMS_MASTER_KEY_ID_DOC = "The ID of an AWS-managed customer master key (CMK) for Amazon SQS or a custom CMK.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_KMS_MASTER_KEY_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_MAX_MESSAGES_PER_POLL_DOC = "Gets the maximum number of messages as a limit to poll at each polling. Is default unlimited, but use 0 or negative number to disable it as unlimited.";
    private static final Integer CAMEL_SOURCE_AWSSQS_ENDPOINT_MAX_MESSAGES_PER_POLL_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_MESSAGE_ATTRIBUTE_NAMES_DOC = "A list of message attribute names to receive when consuming. Multiple names can be separated by comma.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_MESSAGE_ATTRIBUTE_NAMES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DOC = "If the polling consumer did not poll any files, you can enable this option to send an empty message (no body) instead.";
    private static final Boolean CAMEL_SOURCE_AWSSQS_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SERVER_SIDE_ENCRYPTION_ENABLED_DOC = "Define if Server Side Encryption is enabled or not on the queue";
    private static final Boolean CAMEL_SOURCE_AWSSQS_ENDPOINT_SERVER_SIDE_ENCRYPTION_ENABLED_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_VISIBILITY_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_WAIT_TIME_SECONDS_CONF = "camel.source.endpoint.waitTimeSeconds";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_WAIT_TIME_SECONDS_DOC = "Duration in seconds (0 to 20) that the ReceiveMessage action call will wait until a message is in the queue to include in the response.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_WAIT_TIME_SECONDS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_POLL_STRATEGY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_AWSSQS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_DELAY_QUEUE_CONF = "camel.source.endpoint.delayQueue";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_DELAY_QUEUE_DOC = "Define if you want to apply delaySeconds option to the queue or on single messages";
    private static final Boolean CAMEL_SOURCE_AWSSQS_ENDPOINT_DELAY_QUEUE_DEFAULT = false;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_QUEUE_URL_CONF = "camel.source.endpoint.queueUrl";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_QUEUE_URL_DOC = "To define the queueUrl explicitly. All other parameters, which would influence the queueUrl, are ignored. This parameter is intended to be used, to connect to a mock implementation of SQS, for testing purposes.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_QUEUE_URL_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_AWSSQS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_PROXY_HOST_CONF = "camel.source.endpoint.proxyHost";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_PROXY_HOST_DOC = "To define a proxy host when instantiating the SQS client";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_PROXY_PORT_CONF = "camel.source.endpoint.proxyPort";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_PROXY_PORT_DOC = "To define a proxy port when instantiating the SQS client";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_PROXY_PORT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_MAXIMUM_MESSAGE_SIZE_DOC = "The maximumMessageSize (in bytes) an SQS message can contain for this queue.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_MAXIMUM_MESSAGE_SIZE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_MESSAGE_RETENTION_PERIOD_DOC = "The messageRetentionPeriod (in seconds) a message will be retained by SQS for this queue.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_MESSAGE_RETENTION_PERIOD_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_POLICY_CONF = "camel.source.endpoint.policy";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_POLICY_DOC = "The policy for this queue";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_POLICY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_RECEIVE_MESSAGE_WAIT_TIME_SECONDS_DOC = "If you do not specify WaitTimeSeconds in the request, the queue attribute ReceiveMessageWaitTimeSeconds is used to determine how long to wait.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_RECEIVE_MESSAGE_WAIT_TIME_SECONDS_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_REDRIVE_POLICY_CONF = "camel.source.endpoint.redrivePolicy";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_REDRIVE_POLICY_DOC = "Specify the policy that send message to DeadLetter queue. See detail at Amazon docs.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_REDRIVE_POLICY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DOC = "The number of subsequent error polls (failed due some error) that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_AWSSQS_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DOC = "The number of subsequent idle polls that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_AWSSQS_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_AWSSQS_ENDPOINT_BACKOFF_MULTIPLIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll.";
    private static final Long CAMEL_SOURCE_AWSSQS_ENDPOINT_DELAY_DEFAULT = 500L;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_GREEDY_CONF = "camel.source.endpoint.greedy";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_GREEDY_DOC = "If greedy is enabled, then the ScheduledPollConsumer will run immediately again, if the previous run polled 1 or more messages.";
    private static final Boolean CAMEL_SOURCE_AWSSQS_ENDPOINT_GREEDY_DEFAULT = false;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_INITIAL_DELAY_CONF = "camel.source.endpoint.initialDelay";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts.";
    private static final Long CAMEL_SOURCE_AWSSQS_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_REPEAT_COUNT_CONF = "camel.source.endpoint.repeatCount";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_REPEAT_COUNT_DOC = "Specifies a maximum limit of number of fires. So if you set it to 1, the scheduler will only fire once. If you set it to 5, it will only fire five times. A value of zero or negative means fire forever.";
    private static final Long CAMEL_SOURCE_AWSSQS_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_RUN_LOGGING_LEVEL_CONF = "camel.source.endpoint.runLoggingLevel";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_RUN_LOGGING_LEVEL_DOC = "The consumer logs a start/complete log line when it polls. This option allows you to configure the logging level for that. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_RUN_LOGGING_LEVEL_DEFAULT = "TRACE";
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DOC = "Allows for configuring a custom/shared thread pool to use for the consumer. By default each consumer has its own single threaded thread pool.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SCHEDULER_CONF = "camel.source.endpoint.scheduler";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component One of: [none] [spring] [quartz]";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SCHEDULER_DEFAULT = "none";
    ...
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SCHEDULER_PROPERTIES_DOC = "To configure additional properties when using a custom scheduler or any of the Quartz, Spring based scheduler.";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SCHEDULER_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_START_SCHEDULER_CONF = "camel.source.endpoint.startScheduler";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_START_SCHEDULER_DOC = "Whether the scheduler should be auto started.";
    private static final Boolean CAMEL_SOURCE_AWSSQS_ENDPOINT_START_SCHEDULER_DEFAULT = true;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_TIME_UNIT_CONF = "camel.source.endpoint.timeUnit";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_TIME_UNIT_DOC = "Time unit for initialDelay and delay options. One of: [NANOSECONDS] [MICROSECONDS] [MILLISECONDS] [SECONDS] [MINUTES] [HOURS] [DAYS]";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_TIME_UNIT_DEFAULT = "MILLISECONDS";
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_USE_FIXED_DELAY_CONF = "camel.source.endpoint.useFixedDelay";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_USE_FIXED_DELAY_DOC = "Controls if fixed delay or fixed rate is used. See ScheduledExecutorService in JDK for details.";
    private static final Boolean CAMEL_SOURCE_AWSSQS_ENDPOINT_USE_FIXED_DELAY_DEFAULT = true;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_ACCESS_KEY_CONF = "camel.source.endpoint.accessKey";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_ACCESS_KEY_DOC = "Amazon AWS Access Key";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_ACCESS_KEY_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SECRET_KEY_CONF = "camel.source.endpoint.secretKey";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SECRET_KEY_DOC = "Amazon AWS Secret Key";
    private static final String CAMEL_SOURCE_AWSSQS_ENDPOINT_SECRET_KEY_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_AMAZON_AWSHOST_CONF = "camel.component.aws-sqs.amazonAWSHost";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_AMAZON_AWSHOST_DOC = "The hostname of the Amazon AWS cloud.";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_AMAZON_AWSHOST_DEFAULT = "amazonaws.com";
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_AMAZON_SQSCLIENT_CONF = "camel.component.aws-sqs.amazonSQSClient";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_AMAZON_SQSCLIENT_DOC = "To use the AmazonSQS as client";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_AMAZON_SQSCLIENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_AUTO_CREATE_QUEUE_CONF = "camel.component.aws-sqs.autoCreateQueue";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_AUTO_CREATE_QUEUE_DOC = "Setting the autocreation of the queue";
    private static final Boolean CAMEL_SOURCE_AWSSQS_COMPONENT_AUTO_CREATE_QUEUE_DEFAULT = true;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_CONFIGURATION_CONF = "camel.component.aws-sqs.configuration";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_CONFIGURATION_DOC = "The component configuration";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_PROTOCOL_CONF = "camel.component.aws-sqs.protocol";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_PROTOCOL_DOC = "The underlying protocol used to communicate with SQS";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_PROTOCOL_DEFAULT = "https";
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_PROXY_PROTOCOL_CONF = "camel.component.aws-sqs.proxyProtocol";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_PROXY_PROTOCOL_DOC = "To define a proxy protocol when instantiating the SQS client One of: [HTTP] [HTTPS]";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_PROXY_PROTOCOL_DEFAULT = "HTTPS";
    ...
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_QUEUE_OWNER_AWSACCOUNT_ID_DOC = "Specify the queue owner aws account id when you need to connect the queue with different account owner.";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_QUEUE_OWNER_AWSACCOUNT_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_REGION_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_ATTRIBUTE_NAMES_CONF = "camel.component.aws-sqs.attributeNames";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_ATTRIBUTE_NAMES_DOC = "A list of attribute names to receive when consuming. Multiple names can be separated by comma.";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_ATTRIBUTE_NAMES_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_AWSSQS_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_CONCURRENT_CONSUMERS_DOC = "Allows you to use multiple threads to poll the sqs queue to increase throughput";
    private static final Integer CAMEL_SOURCE_AWSSQS_COMPONENT_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_DEFAULT_VISIBILITY_TIMEOUT_DOC = "The default visibility timeout (in seconds)";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_DEFAULT_VISIBILITY_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_DELETE_AFTER_READ_CONF = "camel.component.aws-sqs.deleteAfterRead";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_DELETE_AFTER_READ_DOC = "Delete message from SQS after it has been read";
    private static final Boolean CAMEL_SOURCE_AWSSQS_COMPONENT_DELETE_AFTER_READ_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_DELETE_IF_FILTERED_DOC = "Whether or not to send the DeleteMessage to the SQS queue if an exchange fails to get through a filter. If 'false' and exchange does not make it through a Camel filter upstream in the route, then don't send DeleteMessage.";
    private static final Boolean CAMEL_SOURCE_AWSSQS_COMPONENT_DELETE_IF_FILTERED_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_AWSSQS_COMPONENT_EXTEND_MESSAGE_VISIBILITY_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_KMS_DATA_KEY_REUSE_PERIOD_SECONDS_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_KMS_MASTER_KEY_ID_CONF = "camel.component.aws-sqs.kmsMasterKeyId";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_KMS_MASTER_KEY_ID_DOC = "The ID of an AWS-managed customer master key (CMK) for Amazon SQS or a custom CMK.";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_KMS_MASTER_KEY_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_MESSAGE_ATTRIBUTE_NAMES_DOC = "A list of message attribute names to receive when consuming. Multiple names can be separated by comma.";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_MESSAGE_ATTRIBUTE_NAMES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_SERVER_SIDE_ENCRYPTION_ENABLED_DOC = "Define if Server Side Encryption is enabled or not on the queue";
    private static final Boolean CAMEL_SOURCE_AWSSQS_COMPONENT_SERVER_SIDE_ENCRYPTION_ENABLED_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_VISIBILITY_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_WAIT_TIME_SECONDS_CONF = "camel.component.aws-sqs.waitTimeSeconds";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_WAIT_TIME_SECONDS_DOC = "Duration in seconds (0 to 20) that the ReceiveMessage action call will wait until a message is in the queue to include in the response.";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_WAIT_TIME_SECONDS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_AWSSQS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_DELAY_QUEUE_CONF = "camel.component.aws-sqs.delayQueue";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_DELAY_QUEUE_DOC = "Define if you want to apply delaySeconds option to the queue or on single messages";
    private static final Boolean CAMEL_SOURCE_AWSSQS_COMPONENT_DELAY_QUEUE_DEFAULT = false;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_QUEUE_URL_CONF = "camel.component.aws-sqs.queueUrl";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_QUEUE_URL_DOC = "To define the queueUrl explicitly. All other parameters, which would influence the queueUrl, are ignored. This parameter is intended to be used, to connect to a mock implementation of SQS, for testing purposes.";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_QUEUE_URL_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_PROXY_HOST_CONF = "camel.component.aws-sqs.proxyHost";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_PROXY_HOST_DOC = "To define a proxy host when instantiating the SQS client";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_PROXY_PORT_CONF = "camel.component.aws-sqs.proxyPort";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_PROXY_PORT_DOC = "To define a proxy port when instantiating the SQS client";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_PROXY_PORT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_MAXIMUM_MESSAGE_SIZE_DOC = "The maximumMessageSize (in bytes) an SQS message can contain for this queue.";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_MAXIMUM_MESSAGE_SIZE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_MESSAGE_RETENTION_PERIOD_DOC = "The messageRetentionPeriod (in seconds) a message will be retained by SQS for this queue.";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_MESSAGE_RETENTION_PERIOD_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_POLICY_CONF = "camel.component.aws-sqs.policy";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_POLICY_DOC = "The policy for this queue";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_POLICY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_RECEIVE_MESSAGE_WAIT_TIME_SECONDS_DOC = "If you do not specify WaitTimeSeconds in the request, the queue attribute ReceiveMessageWaitTimeSeconds is used to determine how long to wait.";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_RECEIVE_MESSAGE_WAIT_TIME_SECONDS_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_REDRIVE_POLICY_CONF = "camel.component.aws-sqs.redrivePolicy";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_REDRIVE_POLICY_DOC = "Specify the policy that send message to DeadLetter queue. See detail at Amazon docs.";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_REDRIVE_POLICY_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_ACCESS_KEY_CONF = "camel.component.aws-sqs.accessKey";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_ACCESS_KEY_DOC = "Amazon AWS Access Key";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_ACCESS_KEY_DEFAULT = null;
    public static final String CAMEL_SOURCE_AWSSQS_COMPONENT_SECRET_KEY_CONF = "camel.component.aws-sqs.secretKey";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_SECRET_KEY_DOC = "Amazon AWS Secret Key";
    private static final String CAMEL_SOURCE_AWSSQS_COMPONENT_SECRET_KEY_DEFAULT = null;
