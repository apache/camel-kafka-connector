...
public class CamelRabbitmqSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_RABBITMQ_PATH_EXCHANGE_NAME_DOC = "The exchange name determines which exchange produced messages will sent to. In the case of consumers, the exchange name determines which exchange the queue will bind to.";
