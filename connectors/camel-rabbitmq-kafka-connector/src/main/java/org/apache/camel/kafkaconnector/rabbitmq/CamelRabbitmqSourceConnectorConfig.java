...
public class CamelRabbitmqSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_RECOVER_FROM_DECLARE_EXCEPTION_CONF = "camel.source.endpoint.recoverFromDeclareException";
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_RECOVER_FROM_DECLARE_EXCEPTION_DOC = "Decides whether an exception during declaration of exchanges or queues is recoverable or not. If the option is false, camel will throw an exception when starting the consumer, which will interrupt application startup (e.g. in the case when the exchange / queue is already declared in RabbitMQ and has incompatible configuration). If set to true, the consumer will try to reconnect periodically.";
    public static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_RECOVER_FROM_DECLARE_EXCEPTION_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_RECOVER_FROM_DECLARE_EXCEPTION_CONF = "camel.component.rabbitmq.recoverFromDeclareException";
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_RECOVER_FROM_DECLARE_EXCEPTION_DOC = "Decides whether an exception during declaration of exchanges or queues is recoverable or not. If the option is false, camel will throw an exception when starting the consumer, which will interrupt application startup (e.g. in the case when the exchange / queue is already declared in RabbitMQ and has incompatible configuration). If set to true, the consumer will try to reconnect periodically.";
    public static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_RECOVER_FROM_DECLARE_EXCEPTION_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_RABBITMQ_ENDPOINT_RECOVER_FROM_DECLARE_EXCEPTION_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_RABBITMQ_ENDPOINT_RECOVER_FROM_DECLARE_EXCEPTION_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_RABBITMQ_ENDPOINT_RECOVER_FROM_DECLARE_EXCEPTION_DOC);
        ...
        conf.define(CAMEL_SOURCE_RABBITMQ_COMPONENT_RECOVER_FROM_DECLARE_EXCEPTION_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_RABBITMQ_COMPONENT_RECOVER_FROM_DECLARE_EXCEPTION_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_RABBITMQ_COMPONENT_RECOVER_FROM_DECLARE_EXCEPTION_DOC);
