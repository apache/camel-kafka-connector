...
public class CamelRabbitmqSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_PATH_EXCHANGE_NAME_DOC = "The exchange name determines the exchange to which the produced messages will be sent to. In the case of consumers, the exchange name determines the exchange the queue will be bound to.";
    private static final String CAMEL_SOURCE_RABBITMQ_PATH_EXCHANGE_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_ADDRESSES_CONF = "camel.source.endpoint.addresses";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_ADDRESSES_DOC = "If this option is set, camel-rabbitmq will try to create connection based on the setting of option addresses. The addresses value is a string which looks like server1:12345, server2:12345";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_ADDRESSES_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_AUTO_DELETE_CONF = "camel.source.endpoint.autoDelete";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_AUTO_DELETE_DOC = "If it is true, the exchange will be deleted when it is no longer in use";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_AUTO_DELETE_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_AUTOMATIC_RECOVERY_ENABLED_DOC = "Enables connection automatic recovery (uses connection implementation that performs automatic recovery when existing connection has failures)";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_AUTOMATIC_RECOVERY_ENABLED_DEFAULT = "true";
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_CONNECTION_FACTORY_DOC = "To use a custom RabbitMQ connection factory. When this option is set, all connection options (connectionTimeout, requestedChannelMax...) set on URI are not used";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_CONNECTION_FACTORY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_DEAD_LETTER_EXCHANGE_DOC = "The name of the dead letter exchange";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_DEAD_LETTER_EXCHANGE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_DEAD_LETTER_EXCHANGE_TYPE_DOC = "The type of the dead letter exchange One of: [direct] [fanout] [headers] [topic]";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_DEAD_LETTER_EXCHANGE_TYPE_DEFAULT = "direct";
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_DEAD_LETTER_QUEUE_CONF = "camel.source.endpoint.deadLetterQueue";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_DEAD_LETTER_QUEUE_DOC = "The name of the dead letter queue";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_DEAD_LETTER_QUEUE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_DEAD_LETTER_ROUTING_KEY_DOC = "The routing key for the dead letter exchange";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_DEAD_LETTER_ROUTING_KEY_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_DECLARE_CONF = "camel.source.endpoint.declare";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_DECLARE_DOC = "If the option is true, camel declare the exchange and queue name and bind them together. If the option is false, camel won't declare the exchange and queue name on the server.";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_DECLARE_DEFAULT = true;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_DURABLE_CONF = "camel.source.endpoint.durable";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_DURABLE_DOC = "If we are declaring a durable exchange (the exchange will survive a server restart)";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_DURABLE_DEFAULT = true;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_EXCHANGE_TYPE_CONF = "camel.source.endpoint.exchangeType";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_EXCHANGE_TYPE_DOC = "The exchange type such as direct or topic. One of: [direct] [fanout] [headers] [topic]";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_EXCHANGE_TYPE_DEFAULT = "direct";
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_EXCLUSIVE_CONF = "camel.source.endpoint.exclusive";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_EXCLUSIVE_DOC = "Exclusive queues may only be accessed by the current connection, and are deleted when that connection closes.";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_EXCLUSIVE_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_HOSTNAME_CONF = "camel.source.endpoint.hostname";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_HOSTNAME_DOC = "The hostname of the running rabbitmq instance or cluster.";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_HOSTNAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PASSIVE_CONF = "camel.source.endpoint.passive";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PASSIVE_DOC = "Passive queues depend on the queue already to be available at RabbitMQ.";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_PASSIVE_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PORT_NUMBER_CONF = "camel.source.endpoint.portNumber";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PORT_NUMBER_DOC = "Port number for the host with the running rabbitmq instance or cluster. Default value is 5672.";
    private static final Integer CAMEL_SOURCE_RABBITMQ_ENDPOINT_PORT_NUMBER_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_QUEUE_CONF = "camel.source.endpoint.queue";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_QUEUE_DOC = "The queue to receive messages from";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_QUEUE_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_ROUTING_KEY_CONF = "camel.source.endpoint.routingKey";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_ROUTING_KEY_DOC = "The routing key to use when binding a consumer queue to the exchange. For producer routing keys, you set the header rabbitmq.ROUTING_KEY.";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_ROUTING_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_SKIP_EXCHANGE_DECLARE_DOC = "This can be used if we need to declare the queue but not the exchange";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_SKIP_EXCHANGE_DECLARE_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_SKIP_QUEUE_BIND_CONF = "camel.source.endpoint.skipQueueBind";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_SKIP_QUEUE_BIND_DOC = "If true the queue will not be bound to the exchange after declaring it";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_SKIP_QUEUE_BIND_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_SKIP_QUEUE_DECLARE_CONF = "camel.source.endpoint.skipQueueDeclare";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_SKIP_QUEUE_DECLARE_DOC = "If true the producer will not declare and bind a queue. This can be used for directing messages via an existing routing key.";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_SKIP_QUEUE_DECLARE_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_VHOST_CONF = "camel.source.endpoint.vhost";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_VHOST_DOC = "The vhost for the channel";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_VHOST_DEFAULT = "/";
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_AUTO_ACK_CONF = "camel.source.endpoint.autoAck";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_AUTO_ACK_DOC = "If messages should be auto acknowledged";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_AUTO_ACK_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_CONCURRENT_CONSUMERS_DOC = "Number of concurrent consumers when consuming from broker. (eg similar as to the same option for the JMS component).";
    private static final Integer CAMEL_SOURCE_RABBITMQ_ENDPOINT_CONCURRENT_CONSUMERS_DEFAULT = 1;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_CONSUMER_TAG_CONF = "camel.source.endpoint.consumerTag";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_CONSUMER_TAG_DOC = "Specify a client-generated consumer tag to establish context when invoking the consume operation";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_CONSUMER_TAG_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_EXCLUSIVE_CONSUMER_DOC = "Request exclusive access to the queue (meaning only this consumer can access the queue). This is useful when you want a long-lived shared queue to be temporarily accessible by just one consumer.";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_EXCLUSIVE_CONSUMER_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PREFETCH_COUNT_CONF = "camel.source.endpoint.prefetchCount";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PREFETCH_COUNT_DOC = "The maximum number of messages that the server will deliver, 0 if unlimited. You need to specify the option of prefetchSize, prefetchCount, prefetchGlobal at the same time";
    private static final Integer CAMEL_SOURCE_RABBITMQ_ENDPOINT_PREFETCH_COUNT_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PREFETCH_ENABLED_CONF = "camel.source.endpoint.prefetchEnabled";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PREFETCH_ENABLED_DOC = "Enables the quality of service on the RabbitMQConsumer side. You need to specify the option of prefetchSize, prefetchCount, prefetchGlobal at the same time";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_PREFETCH_ENABLED_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PREFETCH_GLOBAL_CONF = "camel.source.endpoint.prefetchGlobal";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PREFETCH_GLOBAL_DOC = "If the settings should be applied to the entire channel rather than each consumer You need to specify the option of prefetchSize, prefetchCount, prefetchGlobal at the same time";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_PREFETCH_GLOBAL_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PREFETCH_SIZE_CONF = "camel.source.endpoint.prefetchSize";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PREFETCH_SIZE_DOC = "The maximum amount of content (measured in octets) that the server will deliver, 0 if unlimited. You need to specify the option of prefetchSize, prefetchCount, prefetchGlobal at the same time";
    private static final Integer CAMEL_SOURCE_RABBITMQ_ENDPOINT_PREFETCH_SIZE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_THREAD_POOL_SIZE_CONF = "camel.source.endpoint.threadPoolSize";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_THREAD_POOL_SIZE_DOC = "The consumer uses a Thread Pool Executor with a fixed number of threads. This setting allows you to set that number of threads.";
    private static final Integer CAMEL_SOURCE_RABBITMQ_ENDPOINT_THREAD_POOL_SIZE_DEFAULT = 10;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_ARGS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_CLIENT_PROPERTIES_CONF = "camel.source.endpoint.clientProperties";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_CLIENT_PROPERTIES_DOC = "Connection client properties (client info used in negotiating with the server)";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_CLIENT_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_CONNECTION_FACTORY_EXCEPTION_HANDLER_DOC = "Custom rabbitmq ExceptionHandler for ConnectionFactory";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_CONNECTION_FACTORY_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_CONNECTION_TIMEOUT_DOC = "Connection timeout";
    private static final Integer CAMEL_SOURCE_RABBITMQ_ENDPOINT_CONNECTION_TIMEOUT_DEFAULT = 60000;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_NETWORK_RECOVERY_INTERVAL_DOC = "Network recovery interval in milliseconds (interval used when recovering from network failure)";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_NETWORK_RECOVERY_INTERVAL_DEFAULT = "5000";
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_REQUESTED_CHANNEL_MAX_DOC = "Connection requested channel max (max number of channels offered)";
    private static final Integer CAMEL_SOURCE_RABBITMQ_ENDPOINT_REQUESTED_CHANNEL_MAX_DEFAULT = 2047;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_REQUESTED_FRAME_MAX_DOC = "Connection requested frame max (max size of frame offered)";
    private static final Integer CAMEL_SOURCE_RABBITMQ_ENDPOINT_REQUESTED_FRAME_MAX_DEFAULT = 0;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_REQUESTED_HEARTBEAT_DOC = "Connection requested heartbeat (heart-beat in seconds offered)";
    private static final Integer CAMEL_SOURCE_RABBITMQ_ENDPOINT_REQUESTED_HEARTBEAT_DEFAULT = 60;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_REQUEST_TIMEOUT_CONF = "camel.source.endpoint.requestTimeout";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_REQUEST_TIMEOUT_DOC = "Set timeout for waiting for a reply when using the InOut Exchange Pattern (in milliseconds)";
    private static final Long CAMEL_SOURCE_RABBITMQ_ENDPOINT_REQUEST_TIMEOUT_DEFAULT = 20000L;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_REQUEST_TIMEOUT_CHECKER_INTERVAL_DOC = "Set requestTimeoutCheckerInterval for inOut exchange";
    private static final Long CAMEL_SOURCE_RABBITMQ_ENDPOINT_REQUEST_TIMEOUT_CHECKER_INTERVAL_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_TOPOLOGY_RECOVERY_ENABLED_DOC = "Enables connection topology recovery (should topology recovery be performed)";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_TOPOLOGY_RECOVERY_ENABLED_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_TRANSFER_EXCEPTION_DOC = "When true and an inOut Exchange failed on the consumer side send the caused Exception back in the response";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_TRANSFER_EXCEPTION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_RABBITMQ_ENDPOINT_ALLOW_MESSAGE_BODY_SERIALIZATION_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PASSWORD_DOC = "Password for authenticated access";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_PASSWORD_DEFAULT = "guest";
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_SSL_PROTOCOL_CONF = "camel.source.endpoint.sslProtocol";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_SSL_PROTOCOL_DOC = "Enables SSL on connection, accepted value are true, TLS and 'SSLv3";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_SSL_PROTOCOL_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_TRUST_MANAGER_CONF = "camel.source.endpoint.trustManager";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_TRUST_MANAGER_DOC = "Configure SSL trust manager, SSL should be enabled for this option to be effective";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_TRUST_MANAGER_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_USERNAME_DOC = "Username in case of authenticated access";
    private static final String CAMEL_SOURCE_RABBITMQ_ENDPOINT_USERNAME_DEFAULT = "guest";
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_ADDRESSES_CONF = "camel.component.rabbitmq.addresses";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_ADDRESSES_DOC = "If this option is set, camel-rabbitmq will try to create connection based on the setting of option addresses. The addresses value is a string which looks like server1:12345, server2:12345";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_ADDRESSES_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_AUTO_DELETE_CONF = "camel.component.rabbitmq.autoDelete";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_AUTO_DELETE_DOC = "If it is true, the exchange will be deleted when it is no longer in use";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_AUTO_DELETE_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_CONNECTION_FACTORY_DOC = "To use a custom RabbitMQ connection factory. When this option is set, all connection options (connectionTimeout, requestedChannelMax...) set on URI are not used";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_CONNECTION_FACTORY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_DEAD_LETTER_EXCHANGE_DOC = "The name of the dead letter exchange";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_DEAD_LETTER_EXCHANGE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_DEAD_LETTER_EXCHANGE_TYPE_DOC = "The type of the dead letter exchange One of: [direct] [fanout] [headers] [topic]";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_DEAD_LETTER_EXCHANGE_TYPE_DEFAULT = "direct";
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_DEAD_LETTER_QUEUE_DOC = "The name of the dead letter queue";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_DEAD_LETTER_QUEUE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_DEAD_LETTER_ROUTING_KEY_DOC = "The routing key for the dead letter exchange";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_DEAD_LETTER_ROUTING_KEY_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_DECLARE_CONF = "camel.component.rabbitmq.declare";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_DECLARE_DOC = "If the option is true, camel declare the exchange and queue name and bind them together. If the option is false, camel won't declare the exchange and queue name on the server.";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_DECLARE_DEFAULT = true;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_DURABLE_CONF = "camel.component.rabbitmq.durable";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_DURABLE_DOC = "If we are declaring a durable exchange (the exchange will survive a server restart)";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_DURABLE_DEFAULT = true;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_EXCLUSIVE_CONF = "camel.component.rabbitmq.exclusive";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_EXCLUSIVE_DOC = "Exclusive queues may only be accessed by the current connection, and are deleted when that connection closes.";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_EXCLUSIVE_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_HOSTNAME_CONF = "camel.component.rabbitmq.hostname";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_HOSTNAME_DOC = "The hostname of the running RabbitMQ instance or cluster.";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_HOSTNAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PASSIVE_CONF = "camel.component.rabbitmq.passive";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PASSIVE_DOC = "Passive queues depend on the queue already to be available at RabbitMQ.";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_PASSIVE_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PORT_NUMBER_CONF = "camel.component.rabbitmq.portNumber";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PORT_NUMBER_DOC = "Port number for the host with the running rabbitmq instance or cluster.";
    private static final Integer CAMEL_SOURCE_RABBITMQ_COMPONENT_PORT_NUMBER_DEFAULT = 5672;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_SKIP_EXCHANGE_DECLARE_DOC = "This can be used if we need to declare the queue but not the exchange";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_SKIP_EXCHANGE_DECLARE_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_SKIP_QUEUE_BIND_CONF = "camel.component.rabbitmq.skipQueueBind";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_SKIP_QUEUE_BIND_DOC = "If true the queue will not be bound to the exchange after declaring it";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_SKIP_QUEUE_BIND_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_SKIP_QUEUE_DECLARE_DOC = "If true the producer will not declare and bind a queue. This can be used for directing messages via an existing routing key.";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_SKIP_QUEUE_DECLARE_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_VHOST_CONF = "camel.component.rabbitmq.vhost";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_VHOST_DOC = "The vhost for the channel";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_VHOST_DEFAULT = "/";
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_AUTO_ACK_CONF = "camel.component.rabbitmq.autoAck";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_AUTO_ACK_DOC = "If messages should be auto acknowledged";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_AUTO_ACK_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_EXCLUSIVE_CONSUMER_DOC = "Request exclusive access to the queue (meaning only this consumer can access the queue). This is useful when you want a long-lived shared queue to be temporarily accessible by just one consumer.";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_EXCLUSIVE_CONSUMER_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PREFETCH_COUNT_CONF = "camel.component.rabbitmq.prefetchCount";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PREFETCH_COUNT_DOC = "The maximum number of messages that the server will deliver, 0 if unlimited. You need to specify the option of prefetchSize, prefetchCount, prefetchGlobal at the same time";
    private static final Integer CAMEL_SOURCE_RABBITMQ_COMPONENT_PREFETCH_COUNT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PREFETCH_ENABLED_DOC = "Enables the quality of service on the RabbitMQConsumer side. You need to specify the option of prefetchSize, prefetchCount, prefetchGlobal at the same time";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_PREFETCH_ENABLED_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PREFETCH_GLOBAL_CONF = "camel.component.rabbitmq.prefetchGlobal";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PREFETCH_GLOBAL_DOC = "If the settings should be applied to the entire channel rather than each consumer You need to specify the option of prefetchSize, prefetchCount, prefetchGlobal at the same time";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_PREFETCH_GLOBAL_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PREFETCH_SIZE_CONF = "camel.component.rabbitmq.prefetchSize";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PREFETCH_SIZE_DOC = "The maximum amount of content (measured in octets) that the server will deliver, 0 if unlimited. You need to specify the option of prefetchSize, prefetchCount, prefetchGlobal at the same time";
    private static final Integer CAMEL_SOURCE_RABBITMQ_COMPONENT_PREFETCH_SIZE_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_THREAD_POOL_SIZE_CONF = "camel.component.rabbitmq.threadPoolSize";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_THREAD_POOL_SIZE_DOC = "The consumer uses a Thread Pool Executor with a fixed number of threads. This setting allows you to set that number of threads.";
    private static final Integer CAMEL_SOURCE_RABBITMQ_COMPONENT_THREAD_POOL_SIZE_DEFAULT = 10;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_ARGS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_AUTO_DETECT_CONNECTION_FACTORY_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_AUTOMATIC_RECOVERY_ENABLED_DOC = "Enables connection automatic recovery (uses connection implementation that performs automatic recovery when connection shutdown is not initiated by the application)";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_AUTOMATIC_RECOVERY_ENABLED_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_CLIENT_PROPERTIES_DOC = "Connection client properties (client info used in negotiating with the server)";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_CLIENT_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_CONNECTION_FACTORY_EXCEPTION_HANDLER_DOC = "Custom rabbitmq ExceptionHandler for ConnectionFactory";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_CONNECTION_FACTORY_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_CONNECTION_TIMEOUT_DOC = "Connection timeout";
    private static final Integer CAMEL_SOURCE_RABBITMQ_COMPONENT_CONNECTION_TIMEOUT_DEFAULT = 60000;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_NETWORK_RECOVERY_INTERVAL_DOC = "Network recovery interval in milliseconds (interval used when recovering from network failure)";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_NETWORK_RECOVERY_INTERVAL_DEFAULT = "5000";
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_REQUESTED_CHANNEL_MAX_DOC = "Connection requested channel max (max number of channels offered)";
    private static final Integer CAMEL_SOURCE_RABBITMQ_COMPONENT_REQUESTED_CHANNEL_MAX_DEFAULT = 2047;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_REQUESTED_FRAME_MAX_DOC = "Connection requested frame max (max size of frame offered)";
    private static final Integer CAMEL_SOURCE_RABBITMQ_COMPONENT_REQUESTED_FRAME_MAX_DEFAULT = 0;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_REQUESTED_HEARTBEAT_DOC = "Connection requested heartbeat (heart-beat in seconds offered)";
    private static final Integer CAMEL_SOURCE_RABBITMQ_COMPONENT_REQUESTED_HEARTBEAT_DEFAULT = 60;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_REQUEST_TIMEOUT_CONF = "camel.component.rabbitmq.requestTimeout";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_REQUEST_TIMEOUT_DOC = "Set timeout for waiting for a reply when using the InOut Exchange Pattern (in milliseconds)";
    private static final Long CAMEL_SOURCE_RABBITMQ_COMPONENT_REQUEST_TIMEOUT_DEFAULT = 20000L;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_REQUEST_TIMEOUT_CHECKER_INTERVAL_DOC = "Set requestTimeoutCheckerInterval for inOut exchange";
    private static final Long CAMEL_SOURCE_RABBITMQ_COMPONENT_REQUEST_TIMEOUT_CHECKER_INTERVAL_DEFAULT = 1000L;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_TOPOLOGY_RECOVERY_ENABLED_DOC = "Enables connection topology recovery (should topology recovery be performed)";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_TOPOLOGY_RECOVERY_ENABLED_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_TRANSFER_EXCEPTION_DOC = "When true and an inOut Exchange failed on the consumer side send the caused Exception back in the response";
    private static final Boolean CAMEL_SOURCE_RABBITMQ_COMPONENT_TRANSFER_EXCEPTION_DEFAULT = false;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PASSWORD_CONF = "camel.component.rabbitmq.password";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PASSWORD_DOC = "Password for authenticated access";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_PASSWORD_DEFAULT = "guest";
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_SSL_PROTOCOL_CONF = "camel.component.rabbitmq.sslProtocol";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_SSL_PROTOCOL_DOC = "Enables SSL on connection, accepted value are true, TLS and 'SSLv3";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_SSL_PROTOCOL_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_TRUST_MANAGER_CONF = "camel.component.rabbitmq.trustManager";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_TRUST_MANAGER_DOC = "Configure SSL trust manager, SSL should be enabled for this option to be effective";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_TRUST_MANAGER_DEFAULT = null;
    public static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_USERNAME_CONF = "camel.component.rabbitmq.username";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_USERNAME_DOC = "Username in case of authenticated access";
    private static final String CAMEL_SOURCE_RABBITMQ_COMPONENT_USERNAME_DEFAULT = "guest";
