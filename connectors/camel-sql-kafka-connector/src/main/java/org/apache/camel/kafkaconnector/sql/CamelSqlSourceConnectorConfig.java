...
public class CamelSqlSourceConnectorConfig extends CamelSourceConnectorConfig {
    ...
    private static final String CAMEL_SOURCE_SQL_PATH_QUERY_DOC = "Sets the SQL query to perform. You can externalize the query by using file: or classpath: as prefix and specify the location of the file.";
    private static final String CAMEL_SOURCE_SQL_PATH_QUERY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_ALLOW_NAMED_PARAMETERS_DOC = "Whether to allow using named parameters in the queries.";
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_ALLOW_NAMED_PARAMETERS_DEFAULT = true;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_DATA_SOURCE_CONF = "camel.source.endpoint.dataSource";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_DATA_SOURCE_DOC = "Sets the DataSource to use to communicate with the database.";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_DATA_SOURCE_DEFAULT = null;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_DATA_SOURCE_REF_CONF = "camel.source.endpoint.dataSourceRef";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_DATA_SOURCE_REF_DOC = "Sets the reference to a DataSource to lookup from the registry, to use for communicating with the database.";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_DATA_SOURCE_REF_DEFAULT = null;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_OUTPUT_CLASS_CONF = "camel.source.endpoint.outputClass";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_OUTPUT_CLASS_DOC = "Specify the full package and class name to use as conversion when outputType=SelectOne.";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_OUTPUT_CLASS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_OUTPUT_HEADER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_OUTPUT_TYPE_DEFAULT = "SelectList";
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_SEPARATOR_CONF = "camel.source.endpoint.separator";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_SEPARATOR_DOC = "The separator to use when parameter values is taken from message body (if the body is a String type), to be inserted at # placeholders. Notice if you use named parameters, then a Map type is used instead. The default value is comma";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_SEPARATOR_DEFAULT = ",";
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_BREAK_BATCH_ON_CONSUME_FAIL_DOC = "Sets whether to break batch if onConsume failed.";
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_BREAK_BATCH_ON_CONSUME_FAIL_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_EXPECTED_UPDATE_COUNT_DOC = "Sets an expected update count to validate when using onConsume.";
    private static final Integer CAMEL_SOURCE_SQL_ENDPOINT_EXPECTED_UPDATE_COUNT_DEFAULT = -1;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_MAX_MESSAGES_PER_POLL_CONF = "camel.source.endpoint.maxMessagesPerPoll";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_MAX_MESSAGES_PER_POLL_DOC = "Sets the maximum number of messages to poll";
    private static final Integer CAMEL_SOURCE_SQL_ENDPOINT_MAX_MESSAGES_PER_POLL_DEFAULT = null;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_ON_CONSUME_CONF = "camel.source.endpoint.onConsume";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_ON_CONSUME_DOC = "After processing each row then this query can be executed, if the Exchange was processed successfully, for example to mark the row as processed. The query can have parameter.";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_ON_CONSUME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_ON_CONSUME_BATCH_COMPLETE_DOC = "After processing the entire batch, this query can be executed to bulk update rows etc. The query cannot have parameters.";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_ON_CONSUME_BATCH_COMPLETE_DEFAULT = null;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_ON_CONSUME_FAILED_CONF = "camel.source.endpoint.onConsumeFailed";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_ON_CONSUME_FAILED_DOC = "After processing each row then this query can be executed, if the Exchange failed, for example to mark the row as failed. The query can have parameter.";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_ON_CONSUME_FAILED_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_ROUTE_EMPTY_RESULT_SET_DOC = "Sets whether empty resultset should be allowed to be sent to the next hop. Defaults to false. So the empty resultset will be filtered out.";
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_ROUTE_EMPTY_RESULT_SET_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DOC = "If the polling consumer did not poll any files, you can enable this option to send an empty message (no body) instead.";
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_TRANSACTED_CONF = "camel.source.endpoint.transacted";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_TRANSACTED_DOC = "Enables or disables transaction. If enabled then if processing an exchange failed then the consumer breaks out processing any further exchanges to cause a rollback eager.";
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_TRANSACTED_DEFAULT = false;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_USE_ITERATOR_CONF = "camel.source.endpoint.useIterator";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_USE_ITERATOR_DOC = "Sets how resultset should be delivered to route. Indicates delivery as either a list or individual object. defaults to true.";
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_USE_ITERATOR_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_POLL_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_PROCESSING_STRATEGY_CONF = "camel.source.endpoint.processingStrategy";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_PROCESSING_STRATEGY_DOC = "Allows to plugin to use a custom org.apache.camel.component.sql.SqlProcessingStrategy to execute queries when the consumer has processed the rows/batch.";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_PROCESSING_STRATEGY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_ALWAYS_POPULATE_STATEMENT_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final Integer CAMEL_SOURCE_SQL_ENDPOINT_PARAMETERS_COUNT_DEFAULT = null;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_PLACEHOLDER_CONF = "camel.source.endpoint.placeholder";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_PLACEHOLDER_DOC = "Specifies a character that will be replaced to in SQL query. Notice, that it is simple String.replaceAll() operation and no SQL parsing is involved (quoted strings will also change).";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_PLACEHOLDER_DEFAULT = "#";
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_PREPARE_STATEMENT_STRATEGY_DOC = "Allows to plugin to use a custom org.apache.camel.component.sql.SqlPrepareStatementStrategy to control preparation of the query and prepared statement.";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_PREPARE_STATEMENT_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_TEMPLATE_OPTIONS_CONF = "camel.source.endpoint.templateOptions";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_TEMPLATE_OPTIONS_DOC = "Configures the Spring JdbcTemplate with the key/values from the Map";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_TEMPLATE_OPTIONS_DEFAULT = null;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_USE_PLACEHOLDER_CONF = "camel.source.endpoint.usePlaceholder";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_USE_PLACEHOLDER_DOC = "Sets whether to use placeholder and replace all placeholder characters with sign in the SQL queries.";
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_USE_PLACEHOLDER_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DOC = "The number of subsequent error polls (failed due some error) that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_SQL_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DOC = "The number of subsequent idle polls that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_SQL_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_SQL_ENDPOINT_BACKOFF_MULTIPLIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll.";
    private static final Long CAMEL_SOURCE_SQL_ENDPOINT_DELAY_DEFAULT = 500L;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_GREEDY_CONF = "camel.source.endpoint.greedy";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_GREEDY_DOC = "If greedy is enabled, then the ScheduledPollConsumer will run immediately again, if the previous run polled 1 or more messages.";
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_GREEDY_DEFAULT = false;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_INITIAL_DELAY_CONF = "camel.source.endpoint.initialDelay";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts.";
    private static final Long CAMEL_SOURCE_SQL_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_REPEAT_COUNT_CONF = "camel.source.endpoint.repeatCount";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_REPEAT_COUNT_DOC = "Specifies a maximum limit of number of fires. So if you set it to 1, the scheduler will only fire once. If you set it to 5, it will only fire five times. A value of zero or negative means fire forever.";
    private static final Long CAMEL_SOURCE_SQL_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_RUN_LOGGING_LEVEL_CONF = "camel.source.endpoint.runLoggingLevel";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_RUN_LOGGING_LEVEL_DOC = "The consumer logs a start/complete log line when it polls. This option allows you to configure the logging level for that. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_RUN_LOGGING_LEVEL_DEFAULT = "TRACE";
    ...
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DOC = "Allows for configuring a custom/shared thread pool to use for the consumer. By default each consumer has its own single threaded thread pool.";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DEFAULT = null;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_SCHEDULER_CONF = "camel.source.endpoint.scheduler";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component One of: [none] [spring] [quartz]";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_SCHEDULER_DEFAULT = "none";
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_SCHEDULER_PROPERTIES_CONF = "camel.source.endpoint.schedulerProperties";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_SCHEDULER_PROPERTIES_DOC = "To configure additional properties when using a custom scheduler or any of the Quartz, Spring based scheduler.";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_SCHEDULER_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_START_SCHEDULER_CONF = "camel.source.endpoint.startScheduler";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_START_SCHEDULER_DOC = "Whether the scheduler should be auto started.";
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_START_SCHEDULER_DEFAULT = true;
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_TIME_UNIT_CONF = "camel.source.endpoint.timeUnit";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_TIME_UNIT_DOC = "Time unit for initialDelay and delay options. One of: [NANOSECONDS] [MICROSECONDS] [MILLISECONDS] [SECONDS] [MINUTES] [HOURS] [DAYS]";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_TIME_UNIT_DEFAULT = "MILLISECONDS";
    public static final String CAMEL_SOURCE_SQL_ENDPOINT_USE_FIXED_DELAY_CONF = "camel.source.endpoint.useFixedDelay";
    private static final String CAMEL_SOURCE_SQL_ENDPOINT_USE_FIXED_DELAY_DOC = "Controls if fixed delay or fixed rate is used. See ScheduledExecutorService in JDK for details.";
    private static final Boolean CAMEL_SOURCE_SQL_ENDPOINT_USE_FIXED_DELAY_DEFAULT = true;
    public static final String CAMEL_SOURCE_SQL_COMPONENT_DATA_SOURCE_CONF = "camel.component.sql.dataSource";
    private static final String CAMEL_SOURCE_SQL_COMPONENT_DATA_SOURCE_DOC = "Sets the DataSource to use to communicate with the database.";
    private static final String CAMEL_SOURCE_SQL_COMPONENT_DATA_SOURCE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_SQL_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SQL_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SQL_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_SQL_COMPONENT_USE_PLACEHOLDER_CONF = "camel.component.sql.usePlaceholder";
    private static final String CAMEL_SOURCE_SQL_COMPONENT_USE_PLACEHOLDER_DOC = "Sets whether to use placeholder and replace all placeholder characters with sign in the SQL queries. This option is default true";
    private static final Boolean CAMEL_SOURCE_SQL_COMPONENT_USE_PLACEHOLDER_DEFAULT = true;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_SQL_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_SQL_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SQL_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
