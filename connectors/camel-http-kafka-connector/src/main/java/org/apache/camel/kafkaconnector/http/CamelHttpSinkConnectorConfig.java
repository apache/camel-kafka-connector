...
public class CamelHttpSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_NT_HOST_CONF = "camel.sink.endpoint.proxyAuthNtHost";
    public static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_NT_HOST_DOC = "Proxy authentication domain (workstation name) to use with NTML";
    public static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_NT_HOST_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_DOMAIN_CONF = "camel.component.http.proxyAuthDomain";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_DOMAIN_DOC = "Proxy authentication domain to use";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_DOMAIN_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_HOST_CONF = "camel.component.http.proxyAuthHost";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_HOST_DOC = "Proxy authentication host";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_METHOD_CONF = "camel.component.http.proxyAuthMethod";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_METHOD_DOC = "Proxy authentication method to use One of: [Basic] [Digest] [NTLM]";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_METHOD_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_NT_HOST_CONF = "camel.component.http.proxyAuthNtHost";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_NT_HOST_DOC = "Proxy authentication domain (workstation name) to use with NTML";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_NT_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_PASSWORD_CONF = "camel.component.http.proxyAuthPassword";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_PASSWORD_DOC = "Proxy authentication password";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_PORT_CONF = "camel.component.http.proxyAuthPort";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_PORT_DOC = "Proxy authentication port";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_USERNAME_CONF = "camel.component.http.proxyAuthUsername";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_USERNAME_DOC = "Proxy authentication username";
    public static final String CAMEL_SINK_HTTP_COMPONENT_PROXY_AUTH_USERNAME_DEFAULT = null;
