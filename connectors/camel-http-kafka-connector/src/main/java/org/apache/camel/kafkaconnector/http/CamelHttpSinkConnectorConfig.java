...
public class CamelHttpSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_HTTP_PATH_HTTP_URI_DOC = "The url of the HTTP endpoint to call.";
    private static final String CAMEL_SINK_HTTP_PATH_HTTP_URI_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_DISABLE_STREAM_CACHE_DEFAULT = false;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_HEADER_FILTER_STRATEGY_CONF = "camel.sink.endpoint.headerFilterStrategy";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_BINDING_CONF = "camel.sink.endpoint.httpBinding";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_BINDING_DOC = "To use a custom HttpBinding to control the mapping between Camel message and HttpClient.";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_BINDING_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_BRIDGE_ENDPOINT_DEFAULT = false;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_CHUNKED_CONF = "camel.sink.endpoint.chunked";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_CHUNKED_DOC = "If this option is false the Servlet will disable the HTTP streaming and set the content-length header on the response";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_CHUNKED_DEFAULT = true;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_CLEAR_EXPIRED_COOKIES_CONF = "camel.sink.endpoint.clearExpiredCookies";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_CLEAR_EXPIRED_COOKIES_DOC = "Whether to clear expired cookies before sending the HTTP request. This ensures the cookies store does not keep growing by adding new cookies which is newer removed when they are expired.";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_CLEAR_EXPIRED_COOKIES_DEFAULT = true;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_CONNECTION_CLOSE_CONF = "camel.sink.endpoint.connectionClose";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_CONNECTION_CLOSE_DOC = "Specifies whether a Connection Close header must be added to HTTP Request. By default connectionClose is false.";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_CONNECTION_CLOSE_DEFAULT = false;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_COPY_HEADERS_CONF = "camel.sink.endpoint.copyHeaders";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_COPY_HEADERS_DOC = "If this option is true then IN exchange headers will be copied to OUT exchange headers according to copy strategy. Setting this to false, allows to only include the headers from the HTTP response (not propagating IN headers).";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_COPY_HEADERS_DEFAULT = true;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_CUSTOM_HOST_HEADER_CONF = "camel.sink.endpoint.customHostHeader";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_CUSTOM_HOST_HEADER_DOC = "To use custom host header for producer. When not set in query will be ignored. When set will override host header derived from url.";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_CUSTOM_HOST_HEADER_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_METHOD_CONF = "camel.sink.endpoint.httpMethod";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_METHOD_DOC = "Configure the HTTP method to use. The HttpMethod header cannot override this option if set. One of: [GET] [POST] [PUT] [DELETE] [HEAD] [OPTIONS] [TRACE] [PATCH]";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_METHOD_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_IGNORE_RESPONSE_BODY_CONF = "camel.sink.endpoint.ignoreResponseBody";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_IGNORE_RESPONSE_BODY_DOC = "If this option is true, The http producer won't read response body and cache the input stream";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_IGNORE_RESPONSE_BODY_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_PRESERVE_HOST_HEADER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_HTTP_ENDPOINT_THROW_EXCEPTION_ON_FAILURE_DOC = "Option to disable throwing the HttpOperationFailedException in case of failed responses from the remote server. This allows you to get all responses regardless of the HTTP status code.";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_THROW_EXCEPTION_ON_FAILURE_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_TRANSFER_EXCEPTION_DEFAULT = false;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_COOKIE_HANDLER_CONF = "camel.sink.endpoint.cookieHandler";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_COOKIE_HANDLER_DOC = "Configure a cookie handler to maintain a HTTP session";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_COOKIE_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_HTTP_ENDPOINT_COOKIE_STORE_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_DELETE_WITH_BODY_CONF = "camel.sink.endpoint.deleteWithBody";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_DELETE_WITH_BODY_DOC = "Whether the HTTP DELETE should include the message body or not. By default HTTP DELETE do not include any HTTP body. However in some rare cases users may need to be able to include the message body.";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_DELETE_WITH_BODY_DEFAULT = false;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_GET_WITH_BODY_CONF = "camel.sink.endpoint.getWithBody";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_GET_WITH_BODY_DOC = "Whether the HTTP GET should include the message body or not. By default HTTP GET do not include any HTTP body. However in some rare cases users may need to be able to include the message body.";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_GET_WITH_BODY_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_HTTP_ENDPOINT_OK_STATUS_CODE_RANGE_DEFAULT = "200-299";
    public static final String CAMEL_SINK_HTTP_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_CLIENT_BUILDER_CONF = "camel.sink.endpoint.clientBuilder";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_CLIENT_BUILDER_DOC = "Provide access to the http client request parameters used on new RequestConfig instances used by producers or consumers of this endpoint.";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_CLIENT_BUILDER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_HTTP_ENDPOINT_CLIENT_CONNECTION_MANAGER_DOC = "To use a custom HttpClientConnectionManager to manage connections";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_CLIENT_CONNECTION_MANAGER_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_CONNECTIONS_PER_ROUTE_CONF = "camel.sink.endpoint.connectionsPerRoute";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_CONNECTIONS_PER_ROUTE_DOC = "The maximum number of connections per route.";
    private static final Integer CAMEL_SINK_HTTP_ENDPOINT_CONNECTIONS_PER_ROUTE_DEFAULT = 20;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_CLIENT_CONF = "camel.sink.endpoint.httpClient";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_CLIENT_DOC = "Sets a custom HttpClient to be used by the producer";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_CLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_CLIENT_CONFIGURER_CONF = "camel.sink.endpoint.httpClientConfigurer";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_CLIENT_CONFIGURER_DOC = "Register a custom configuration strategy for new HttpClient instances created by producers or consumers such as to configure authentication mechanisms etc.";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_CLIENT_CONFIGURER_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_CLIENT_OPTIONS_CONF = "camel.sink.endpoint.httpClientOptions";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_CLIENT_OPTIONS_DOC = "To configure the HttpClient using the key/values from the Map.";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_CLIENT_OPTIONS_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_CONTEXT_CONF = "camel.sink.endpoint.httpContext";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_CONTEXT_DOC = "To use a custom HttpContext instance";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_HTTP_CONTEXT_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_MAP_HTTP_MESSAGE_BODY_CONF = "camel.sink.endpoint.mapHttpMessageBody";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_MAP_HTTP_MESSAGE_BODY_DOC = "If this option is true then IN exchange Body of the exchange will be mapped to HTTP body. Setting this to false will avoid the HTTP mapping.";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_MAP_HTTP_MESSAGE_BODY_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_HTTP_ENDPOINT_MAP_HTTP_MESSAGE_FORM_URL_ENCODED_BODY_DOC = "If this option is true then IN exchange Form Encoded body of the exchange will be mapped to HTTP. Setting this to false will avoid the HTTP Form Encoded body mapping.";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_MAP_HTTP_MESSAGE_FORM_URL_ENCODED_BODY_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_HTTP_ENDPOINT_MAP_HTTP_MESSAGE_HEADERS_DOC = "If this option is true then IN exchange Headers of the exchange will be mapped to HTTP headers. Setting this to false will avoid the HTTP Headers mapping.";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_MAP_HTTP_MESSAGE_HEADERS_DEFAULT = true;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_MAX_TOTAL_CONNECTIONS_CONF = "camel.sink.endpoint.maxTotalConnections";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_MAX_TOTAL_CONNECTIONS_DOC = "The maximum number of connections.";
    private static final Integer CAMEL_SINK_HTTP_ENDPOINT_MAX_TOTAL_CONNECTIONS_DEFAULT = 200;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_USE_SYSTEM_PROPERTIES_CONF = "camel.sink.endpoint.useSystemProperties";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_USE_SYSTEM_PROPERTIES_DOC = "To use System Properties as fallback for configuration";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_USE_SYSTEM_PROPERTIES_DEFAULT = false;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_DOMAIN_CONF = "camel.sink.endpoint.proxyAuthDomain";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_DOMAIN_DOC = "Proxy authentication domain to use with NTML";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_DOMAIN_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_HOST_CONF = "camel.sink.endpoint.proxyAuthHost";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_HOST_DOC = "Proxy authentication host";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_METHOD_CONF = "camel.sink.endpoint.proxyAuthMethod";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_METHOD_DOC = "Proxy authentication method to use One of: [Basic] [Digest] [NTLM]";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_METHOD_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_PASSWORD_CONF = "camel.sink.endpoint.proxyAuthPassword";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_PASSWORD_DOC = "Proxy authentication password";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_PORT_CONF = "camel.sink.endpoint.proxyAuthPort";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_PORT_DOC = "Proxy authentication port";
    private static final Integer CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_SCHEME_CONF = "camel.sink.endpoint.proxyAuthScheme";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_SCHEME_DOC = "Proxy authentication scheme to use One of: [http] [https]";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_SCHEME_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_USERNAME_CONF = "camel.sink.endpoint.proxyAuthUsername";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_USERNAME_DOC = "Proxy authentication username";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_AUTH_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_HOST_CONF = "camel.sink.endpoint.proxyHost";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_HOST_DOC = "Proxy hostname to use";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_PORT_CONF = "camel.sink.endpoint.proxyPort";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_PROXY_PORT_DOC = "Proxy port to use";
    private static final Integer CAMEL_SINK_HTTP_ENDPOINT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_DOMAIN_CONF = "camel.sink.endpoint.authDomain";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_DOMAIN_DOC = "Authentication domain to use with NTML";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_DOMAIN_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_HTTP_ENDPOINT_AUTHENTICATION_PREEMPTIVE_DOC = "If this option is true, camel-http sends preemptive basic authentication to the server.";
    private static final Boolean CAMEL_SINK_HTTP_ENDPOINT_AUTHENTICATION_PREEMPTIVE_DEFAULT = false;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_HOST_CONF = "camel.sink.endpoint.authHost";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_HOST_DOC = "Authentication host to use with NTML";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_METHOD_CONF = "camel.sink.endpoint.authMethod";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_METHOD_DOC = "Authentication methods allowed to use as a comma separated list of values Basic, Digest or NTLM.";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_METHOD_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_METHOD_PRIORITY_CONF = "camel.sink.endpoint.authMethodPriority";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_METHOD_PRIORITY_DOC = "Which authentication method to prioritize to use, either as Basic, Digest or NTLM. One of: [Basic] [Digest] [NTLM]";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_METHOD_PRIORITY_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_PASSWORD_CONF = "camel.sink.endpoint.authPassword";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_PASSWORD_DOC = "Authentication password";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_USERNAME_CONF = "camel.sink.endpoint.authUsername";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_USERNAME_DOC = "Authentication username";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_AUTH_USERNAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_HTTP_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_ENDPOINT_X509HOSTNAME_VERIFIER_CONF = "camel.sink.endpoint.x509HostnameVerifier";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_X509HOSTNAME_VERIFIER_DOC = "To use a custom X509HostnameVerifier such as DefaultHostnameVerifier or NoopHostnameVerifier";
    private static final String CAMEL_SINK_HTTP_ENDPOINT_X509HOSTNAME_VERIFIER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_HTTP_COMPONENT_COOKIE_STORE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_HTTP_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_HTTP_COMPONENT_ALLOW_JAVA_SERIALIZED_OBJECT_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_HTTP_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_HTTP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_HTTP_COMPONENT_CLIENT_CONNECTION_MANAGER_DOC = "To use a custom and shared HttpClientConnectionManager to manage connections. If this has been configured then this is always used for all endpoints created by this component.";
    private static final String CAMEL_SINK_HTTP_COMPONENT_CLIENT_CONNECTION_MANAGER_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_COMPONENT_CONNECTIONS_PER_ROUTE_CONF = "camel.component.http.connectionsPerRoute";
    private static final String CAMEL_SINK_HTTP_COMPONENT_CONNECTIONS_PER_ROUTE_DOC = "The maximum number of connections per route.";
    private static final Integer CAMEL_SINK_HTTP_COMPONENT_CONNECTIONS_PER_ROUTE_DEFAULT = 20;
    ...
    private static final String CAMEL_SINK_HTTP_COMPONENT_CONNECTION_TIME_TO_LIVE_DOC = "The time for connection to live, the time unit is millisecond, the default value is always keep alive.";
    private static final Long CAMEL_SINK_HTTP_COMPONENT_CONNECTION_TIME_TO_LIVE_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_COMPONENT_HTTP_BINDING_CONF = "camel.component.http.httpBinding";
    private static final String CAMEL_SINK_HTTP_COMPONENT_HTTP_BINDING_DOC = "To use a custom HttpBinding to control the mapping between Camel message and HttpClient.";
    private static final String CAMEL_SINK_HTTP_COMPONENT_HTTP_BINDING_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_HTTP_COMPONENT_HTTP_CLIENT_CONFIGURER_DOC = "To use the custom HttpClientConfigurer to perform configuration of the HttpClient that will be used.";
    private static final String CAMEL_SINK_HTTP_COMPONENT_HTTP_CLIENT_CONFIGURER_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_COMPONENT_HTTP_CONFIGURATION_CONF = "camel.component.http.httpConfiguration";
    private static final String CAMEL_SINK_HTTP_COMPONENT_HTTP_CONFIGURATION_DOC = "To use the shared HttpConfiguration as base configuration.";
    private static final String CAMEL_SINK_HTTP_COMPONENT_HTTP_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_COMPONENT_HTTP_CONTEXT_CONF = "camel.component.http.httpContext";
    private static final String CAMEL_SINK_HTTP_COMPONENT_HTTP_CONTEXT_DOC = "To use a custom org.apache.http.protocol.HttpContext when executing requests.";
    private static final String CAMEL_SINK_HTTP_COMPONENT_HTTP_CONTEXT_DEFAULT = null;
    public static final String CAMEL_SINK_HTTP_COMPONENT_MAX_TOTAL_CONNECTIONS_CONF = "camel.component.http.maxTotalConnections";
    private static final String CAMEL_SINK_HTTP_COMPONENT_MAX_TOTAL_CONNECTIONS_DOC = "The maximum number of connections.";
    private static final Integer CAMEL_SINK_HTTP_COMPONENT_MAX_TOTAL_CONNECTIONS_DEFAULT = 200;
    ...
    private static final String CAMEL_SINK_HTTP_COMPONENT_HEADER_FILTER_STRATEGY_DOC = "To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SINK_HTTP_COMPONENT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_HTTP_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_HTTP_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SINK_HTTP_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_HTTP_COMPONENT_X509HOSTNAME_VERIFIER_DOC = "To use a custom X509HostnameVerifier such as DefaultHostnameVerifier or NoopHostnameVerifier.";
    private static final String CAMEL_SINK_HTTP_COMPONENT_X509HOSTNAME_VERIFIER_DEFAULT = null;
    ...
    private static final Integer CAMEL_SINK_HTTP_COMPONENT_CONNECTION_REQUEST_TIMEOUT_DEFAULT = -1;
    ...
    private static final Integer CAMEL_SINK_HTTP_COMPONENT_CONNECT_TIMEOUT_DEFAULT = -1;
    ...
    private static final Integer CAMEL_SINK_HTTP_COMPONENT_SOCKET_TIMEOUT_DEFAULT = -1;
