...
public class CamelWeatherSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_WEATHER_PATH_NAME_DOC = "The name value is not used.";
    private static final String CAMEL_SINK_WEATHER_PATH_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_APPID_CONF = "camel.sink.endpoint.appid";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_APPID_DOC = "APPID ID used to authenticate the user connected to the API Server";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_APPID_DEFAULT = null;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_HEADER_NAME_CONF = "camel.sink.endpoint.headerName";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_HEADER_NAME_DOC = "To store the weather result in this header instead of the message body. This is useable if you want to keep current message body as-is.";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_HEADER_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_LANGUAGE_CONF = "camel.sink.endpoint.language";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_LANGUAGE_DOC = "Language of the response. One of: [en] [ru] [it] [es] [sp] [uk] [ua] [de] [pt] [ro] [pl] [fi] [nl] [fr] [bg] [sv] [se] [zh_tw] [zh] [zh_cn] [tr] [hr] [ca]";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_LANGUAGE_DEFAULT = "en";
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_MODE_CONF = "camel.sink.endpoint.mode";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_MODE_DOC = "The output format of the weather data. One of: [HTML] [JSON] [XML]";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_MODE_DEFAULT = "JSON";
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_PERIOD_CONF = "camel.sink.endpoint.period";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_PERIOD_DOC = "If null, the current weather will be returned, else use values of 5, 7, 14 days. Only the numeric value for the forecast period is actually parsed, so spelling, capitalisation of the time period is up to you (its ignored)";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_PERIOD_DEFAULT = null;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_UNITS_CONF = "camel.sink.endpoint.units";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_UNITS_DOC = "The units for temperature measurement. One of: [IMPERIAL] [METRIC]";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_UNITS_DEFAULT = null;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_WEATHER_API_CONF = "camel.sink.endpoint.weatherApi";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_WEATHER_API_DOC = "The API to be use (current, forecast/3 hour, forecast daily, station) One of: [Current] [Station] [Hourly] [Daily]";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_WEATHER_API_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_WEATHER_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_WEATHER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_WEATHER_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_CNT_CONF = "camel.sink.endpoint.cnt";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_CNT_DOC = "Number of results to be found";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_CNT_DEFAULT = null;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_IDS_CONF = "camel.sink.endpoint.ids";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_IDS_DOC = "List of id's of city/stations. You can separate multiple ids by comma.";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_IDS_DEFAULT = null;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_LAT_CONF = "camel.sink.endpoint.lat";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_LAT_DOC = "Latitude of location. You can use lat and lon options instead of location. For boxed queries this is the bottom latitude.";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_LAT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_LOCATION_DEFAULT = null;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_LON_CONF = "camel.sink.endpoint.lon";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_LON_DOC = "Longitude of location. You can use lat and lon options instead of location. For boxed queries this is the left longtitude.";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_LON_DEFAULT = null;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_RIGHT_LON_CONF = "camel.sink.endpoint.rightLon";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_RIGHT_LON_DOC = "For boxed queries this is the right longtitude. Needs to be used in combination with topLat and zoom.";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_RIGHT_LON_DEFAULT = null;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_TOP_LAT_CONF = "camel.sink.endpoint.topLat";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_TOP_LAT_DOC = "For boxed queries this is the top latitude. Needs to be used in combination with rightLon and zoom.";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_TOP_LAT_DEFAULT = null;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_ZIP_CONF = "camel.sink.endpoint.zip";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_ZIP_DOC = "Zip-code, e.g. 94040,us";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_ZIP_DEFAULT = null;
    public static final String CAMEL_SINK_WEATHER_ENDPOINT_ZOOM_CONF = "camel.sink.endpoint.zoom";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_ZOOM_DOC = "For boxed queries this is the zoom. Needs to be used in combination with rightLon and topLat.";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_ZOOM_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_GEOLOCATION_ACCESS_KEY_DOC = "The geolocation service now needs an accessKey to be used";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_GEOLOCATION_ACCESS_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_GEOLOCATION_REQUEST_HOST_IPDOC = "The geolocation service now needs to specify the IP associated to the accessKey you're using";
    private static final String CAMEL_SINK_WEATHER_ENDPOINT_GEOLOCATION_REQUEST_HOST_IPDEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_WEATHER_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_WEATHER_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_WEATHER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_WEATHER_COMPONENT_HTTP_CLIENT_CONF = "camel.component.weather.httpClient";
    private static final String CAMEL_SINK_WEATHER_COMPONENT_HTTP_CLIENT_DOC = "To use an existing configured http client (for example with http proxy)";
    private static final String CAMEL_SINK_WEATHER_COMPONENT_HTTP_CLIENT_DEFAULT = null;
