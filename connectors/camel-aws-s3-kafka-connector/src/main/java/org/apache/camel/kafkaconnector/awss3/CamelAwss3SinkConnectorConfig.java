...
public class CamelAwss3SinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWSS3_COMPONENT_REGION_DOC = "The region where the bucket is located. This option is used in the com.amazonaws.services.s3.model.CreateBucketRequest.";
    ...
    public static final String CAMEL_SINK_AWSS3_COMPONENT_CONFIGURATION_DOC = "The AWS S3 default configuration";
