...
public class CamelAwss3SourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AWSS3_ENDPOINT_DONE_FILE_NAME_CONF = "camel.source.endpoint.doneFileName";
    public static final String CAMEL_SOURCE_AWSS3_ENDPOINT_DONE_FILE_NAME_DOC = "If provided, Camel will only consume files if a done file exists.";
    public static final String CAMEL_SOURCE_AWSS3_ENDPOINT_DONE_FILE_NAME_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_AWSS3_COMPONENT_DONE_FILE_NAME_CONF = "camel.component.aws-s3.doneFileName";
    public static final String CAMEL_SOURCE_AWSS3_COMPONENT_DONE_FILE_NAME_DOC = "If provided, Camel will only consume files if a done file exists.";
    public static final String CAMEL_SOURCE_AWSS3_COMPONENT_DONE_FILE_NAME_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_AWSS3_ENDPOINT_DONE_FILE_NAME_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_AWSS3_ENDPOINT_DONE_FILE_NAME_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSS3_ENDPOINT_DONE_FILE_NAME_DOC);
        ...
        conf.define(CAMEL_SOURCE_AWSS3_COMPONENT_DONE_FILE_NAME_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_AWSS3_COMPONENT_DONE_FILE_NAME_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSS3_COMPONENT_DONE_FILE_NAME_DOC);
