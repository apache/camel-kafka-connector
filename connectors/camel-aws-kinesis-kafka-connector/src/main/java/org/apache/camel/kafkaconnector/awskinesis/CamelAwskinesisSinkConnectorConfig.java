...
public class CamelAwskinesisSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_AWSKINESIS_COMPONENT_REGION_DOC = "Amazon AWS Region";
    ...
    public static final String CAMEL_SINK_AWSKINESIS_COMPONENT_CONFIGURATION_DOC = "The AWS S3 default configuration";
