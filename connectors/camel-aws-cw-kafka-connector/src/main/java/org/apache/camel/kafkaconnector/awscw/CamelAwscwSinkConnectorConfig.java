...
public class CamelAwscwSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWSCW_COMPONENT_REGION_DOC = "The region in which CW client needs to work";
    ...
    public static final String CAMEL_SINK_AWSCW_COMPONENT_CONFIGURATION_DOC = "The AWS CW default configuration";
