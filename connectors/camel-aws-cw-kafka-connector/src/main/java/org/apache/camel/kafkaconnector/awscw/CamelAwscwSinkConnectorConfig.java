...
public class CamelAwscwSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_AWSCW_PATH_NAMESPACE_DOC = "The metric namespace";
    private static final String CAMEL_SINK_AWSCW_PATH_NAMESPACE_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_ENDPOINT_AMAZON_CW_CLIENT_CONF = "camel.sink.endpoint.amazonCwClient";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_AMAZON_CW_CLIENT_DOC = "To use the AmazonCloudWatch as the client";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_AMAZON_CW_CLIENT_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_AWSCW_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_AWSCW_ENDPOINT_NAME_CONF = "camel.sink.endpoint.name";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_NAME_DOC = "The metric name";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_ENDPOINT_PROXY_HOST_CONF = "camel.sink.endpoint.proxyHost";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_PROXY_HOST_DOC = "To define a proxy host when instantiating the CW client";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_ENDPOINT_PROXY_PORT_CONF = "camel.sink.endpoint.proxyPort";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_PROXY_PORT_DOC = "To define a proxy port when instantiating the CW client";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_ENDPOINT_PROXY_PROTOCOL_CONF = "camel.sink.endpoint.proxyProtocol";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_PROXY_PROTOCOL_DOC = "To define a proxy protocol when instantiating the CW client One of: [HTTP] [HTTPS]";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_PROXY_PROTOCOL_DEFAULT = "HTTPS";
    public static final String CAMEL_SINK_AWSCW_ENDPOINT_REGION_CONF = "camel.sink.endpoint.region";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_REGION_DOC = "The region in which CW client needs to work. When using this parameter, the configuration will expect the capitalized name of the region (for example AP_EAST_1) You'll need to use the name Regions.EU_WEST_1.name()";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_REGION_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_ENDPOINT_TIMESTAMP_CONF = "camel.sink.endpoint.timestamp";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_TIMESTAMP_DOC = "The metric timestamp";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_TIMESTAMP_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_ENDPOINT_UNIT_CONF = "camel.sink.endpoint.unit";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_UNIT_DOC = "The metric unit";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_UNIT_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_ENDPOINT_VALUE_CONF = "camel.sink.endpoint.value";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_VALUE_DOC = "The metric value";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_VALUE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AWSCW_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AWSCW_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_AWSCW_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_AWSCW_ENDPOINT_ACCESS_KEY_CONF = "camel.sink.endpoint.accessKey";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_ACCESS_KEY_DOC = "Amazon AWS Access Key";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_ACCESS_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_ENDPOINT_SECRET_KEY_CONF = "camel.sink.endpoint.secretKey";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_SECRET_KEY_DOC = "Amazon AWS Secret Key";
    private static final String CAMEL_SINK_AWSCW_ENDPOINT_SECRET_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_COMPONENT_AMAZON_CW_CLIENT_CONF = "camel.component.aws-cw.amazonCwClient";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_AMAZON_CW_CLIENT_DOC = "To use the AmazonCloudWatch as the client";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_AMAZON_CW_CLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_COMPONENT_CONFIGURATION_CONF = "camel.component.aws-cw.configuration";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_CONFIGURATION_DOC = "The component configuration";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_AWSCW_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_AWSCW_COMPONENT_NAME_CONF = "camel.component.aws-cw.name";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_NAME_DOC = "The metric name";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_COMPONENT_PROXY_HOST_CONF = "camel.component.aws-cw.proxyHost";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_PROXY_HOST_DOC = "To define a proxy host when instantiating the CW client";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_COMPONENT_PROXY_PORT_CONF = "camel.component.aws-cw.proxyPort";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_PROXY_PORT_DOC = "To define a proxy port when instantiating the CW client";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_COMPONENT_PROXY_PROTOCOL_CONF = "camel.component.aws-cw.proxyProtocol";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_PROXY_PROTOCOL_DOC = "To define a proxy protocol when instantiating the CW client One of: [HTTP] [HTTPS]";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_PROXY_PROTOCOL_DEFAULT = "HTTPS";
    public static final String CAMEL_SINK_AWSCW_COMPONENT_REGION_CONF = "camel.component.aws-cw.region";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_REGION_DOC = "The region in which CW client needs to work. When using this parameter, the configuration will expect the capitalized name of the region (for example AP_EAST_1) You'll need to use the name Regions.EU_WEST_1.name()";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_REGION_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_COMPONENT_TIMESTAMP_CONF = "camel.component.aws-cw.timestamp";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_TIMESTAMP_DOC = "The metric timestamp";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_TIMESTAMP_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_COMPONENT_UNIT_CONF = "camel.component.aws-cw.unit";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_UNIT_DOC = "The metric unit";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_UNIT_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_COMPONENT_VALUE_CONF = "camel.component.aws-cw.value";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_VALUE_DOC = "The metric value";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_VALUE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AWSCW_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AWSCW_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AWSCW_COMPONENT_ACCESS_KEY_CONF = "camel.component.aws-cw.accessKey";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_ACCESS_KEY_DOC = "Amazon AWS Access Key";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_ACCESS_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AWSCW_COMPONENT_SECRET_KEY_CONF = "camel.component.aws-cw.secretKey";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_SECRET_KEY_DOC = "Amazon AWS Secret Key";
    private static final String CAMEL_SINK_AWSCW_COMPONENT_SECRET_KEY_DEFAULT = null;
