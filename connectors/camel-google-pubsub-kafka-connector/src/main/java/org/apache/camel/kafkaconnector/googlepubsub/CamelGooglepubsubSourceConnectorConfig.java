...
public class CamelGooglepubsubSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_GOOGLEPUBSUB_PATH_PROJECT_ID_DOC = "The Google Cloud PubSub Project Id";
    ...
    public static final String CAMEL_SOURCE_GOOGLEPUBSUB_PATH_DESTINATION_NAME_DOC = "The Destination Name. For the consumer this will be the subscription name, while for the producer this will be the topic name.";
    public static final String CAMEL_SOURCE_GOOGLEPUBSUB_PATH_DESTINATION_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_GOOGLEPUBSUB_ENDPOINT_AUTHENTICATE_CONF = "camel.source.endpoint.authenticate";
    public static final String CAMEL_SOURCE_GOOGLEPUBSUB_ENDPOINT_AUTHENTICATE_DOC = "Use Credentials when interacting with PubSub service (no authentication is required when using emulator).";
    public static final Boolean CAMEL_SOURCE_GOOGLEPUBSUB_ENDPOINT_AUTHENTICATE_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_AUTHENTICATE_CONF = "camel.component.google-pubsub.authenticate";
    public static final String CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_AUTHENTICATE_DOC = "Use Credentials when interacting with PubSub service (no authentication is required when using emulator).";
    public static final Boolean CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_AUTHENTICATE_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_SERVICE_ACCOUNT_KEY_CONF = "camel.component.google-pubsub.serviceAccountKey";
    public static final String CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_SERVICE_ACCOUNT_KEY_DOC = "The Service account key that can be used as credentials for the PubSub publisher/subscriber. It can be loaded by default from classpath, but you can prefix with classpath:, file:, or http: to load the resource from different systems.";
    public static final String CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_SERVICE_ACCOUNT_KEY_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_AUTOWIRED_ENABLED_CONF = "camel.component.google-pubsub.autowiredEnabled";
    ...
    public static final Boolean CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_AUTOWIRED_ENABLED_DEFAULT = true;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_GOOGLEPUBSUB_ENDPOINT_AUTHENTICATE_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_GOOGLEPUBSUB_ENDPOINT_AUTHENTICATE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_GOOGLEPUBSUB_ENDPOINT_AUTHENTICATE_DOC);
        ...
        conf.define(CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_AUTHENTICATE_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_AUTHENTICATE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_AUTHENTICATE_DOC);
        ...
        conf.define(CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_SERVICE_ACCOUNT_KEY_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_SERVICE_ACCOUNT_KEY_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_SERVICE_ACCOUNT_KEY_DOC);
        ...
        conf.define(CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_AUTOWIRED_ENABLED_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_AUTOWIRED_ENABLED_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_GOOGLEPUBSUB_COMPONENT_AUTOWIRED_ENABLED_DOC);
