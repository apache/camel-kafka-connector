...
public class CamelGooglepubsubSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_GOOGLEPUBSUB_ENDPOINT_AUTHENTICATE_CONF = "camel.sink.endpoint.authenticate";
    public static final String CAMEL_SINK_GOOGLEPUBSUB_ENDPOINT_AUTHENTICATE_DOC = "Use Credentials when interacting with PubSub service (no authentication is required when using emulator).";
    public static final Boolean CAMEL_SINK_GOOGLEPUBSUB_ENDPOINT_AUTHENTICATE_DEFAULT = true;
    ...
    public static final String CAMEL_SINK_GOOGLEPUBSUB_COMPONENT_AUTHENTICATE_CONF = "camel.component.google-pubsub.authenticate";
    public static final String CAMEL_SINK_GOOGLEPUBSUB_COMPONENT_AUTHENTICATE_DOC = "Use Credentials when interacting with PubSub service (no authentication is required when using emulator).";
    public static final Boolean CAMEL_SINK_GOOGLEPUBSUB_COMPONENT_AUTHENTICATE_DEFAULT = true;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_GOOGLEPUBSUB_ENDPOINT_AUTHENTICATE_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_GOOGLEPUBSUB_ENDPOINT_AUTHENTICATE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_GOOGLEPUBSUB_ENDPOINT_AUTHENTICATE_DOC);
        ...
        conf.define(CAMEL_SINK_GOOGLEPUBSUB_COMPONENT_AUTHENTICATE_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_GOOGLEPUBSUB_COMPONENT_AUTHENTICATE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_GOOGLEPUBSUB_COMPONENT_AUTHENTICATE_DOC);
        ...
        conf.define(CAMEL_SINK_GOOGLEPUBSUB_COMPONENT_SERVICE_ACCOUNT_KEY_CONF, ConfigDef.Type.STRING, CAMEL_SINK_GOOGLEPUBSUB_COMPONENT_SERVICE_ACCOUNT_KEY_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_GOOGLEPUBSUB_COMPONENT_SERVICE_ACCOUNT_KEY_DOC);
