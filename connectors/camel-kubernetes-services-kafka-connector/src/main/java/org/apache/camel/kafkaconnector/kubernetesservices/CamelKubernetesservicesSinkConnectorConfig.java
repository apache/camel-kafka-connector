...
public class CamelKubernetesservicesSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_KUBERNETESSERVICES_PATH_MASTER_URL_DOC = "Kubernetes Master url";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_PATH_MASTER_URL_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_API_VERSION_CONF = "camel.sink.endpoint.apiVersion";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_API_VERSION_DOC = "The Kubernetes API Version to use";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_API_VERSION_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_DNS_DOMAIN_CONF = "camel.sink.endpoint.dnsDomain";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_DNS_DOMAIN_DOC = "The dns domain, used for ServiceCall EIP";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_DNS_DOMAIN_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_KUBERNETES_CLIENT_DOC = "Default KubernetesClient to use if provided";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_KUBERNETES_CLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_PORT_NAME_CONF = "camel.sink.endpoint.portName";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_PORT_NAME_DOC = "The port name, used for ServiceCall EIP";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_PORT_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_PORT_PROTOCOL_CONF = "camel.sink.endpoint.portProtocol";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_PORT_PROTOCOL_DOC = "The port protocol, used for ServiceCall EIP";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_PORT_PROTOCOL_DEFAULT = "tcp";
    ...
    private static final Boolean CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_OPERATION_CONF = "camel.sink.endpoint.operation";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_OPERATION_DOC = "Producer operation to do on Kubernetes";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_OPERATION_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CONNECTION_TIMEOUT_DOC = "Connection timeout in milliseconds to use when making requests to the Kubernetes API server.";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CONNECTION_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CA_CERT_DATA_CONF = "camel.sink.endpoint.caCertData";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CA_CERT_DATA_DOC = "The CA Cert Data";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CA_CERT_DATA_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CA_CERT_FILE_CONF = "camel.sink.endpoint.caCertFile";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CA_CERT_FILE_DOC = "The CA Cert File";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CA_CERT_FILE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_CERT_DATA_DOC = "The Client Cert Data";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_CERT_DATA_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_CERT_FILE_DOC = "The Client Cert File";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_CERT_FILE_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_KEY_ALGO_CONF = "camel.sink.endpoint.clientKeyAlgo";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_KEY_ALGO_DOC = "The Key Algorithm used by the client";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_KEY_ALGO_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_KEY_DATA_CONF = "camel.sink.endpoint.clientKeyData";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_KEY_DATA_DOC = "The Client Key data";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_KEY_DATA_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_KEY_FILE_CONF = "camel.sink.endpoint.clientKeyFile";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_KEY_FILE_DOC = "The Client Key file";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_KEY_FILE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_KEY_PASSPHRASE_DOC = "The Client Key Passphrase";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_CLIENT_KEY_PASSPHRASE_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_OAUTH_TOKEN_CONF = "camel.sink.endpoint.oauthToken";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_OAUTH_TOKEN_DOC = "The Auth Token";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_OAUTH_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_PASSWORD_DOC = "Password to connect to Kubernetes";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_TRUST_CERTS_CONF = "camel.sink.endpoint.trustCerts";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_TRUST_CERTS_DOC = "Define if the certs we used are trusted anyway or not";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_TRUST_CERTS_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_USERNAME_DOC = "Username to connect to Kubernetes";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_KUBERNETESSERVICES_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_KUBERNETESSERVICES_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.kubernetes-services.basicPropertyBinding";
    private static final String CAMEL_SINK_KUBERNETESSERVICES_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_KUBERNETESSERVICES_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
        ...
        conf.define(CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_SYNCHRONOUS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_SYNCHRONOUS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_KUBERNETESSERVICES_ENDPOINT_SYNCHRONOUS_DOC);
        ...
        conf.define(CAMEL_SINK_KUBERNETESSERVICES_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_KUBERNETESSERVICES_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_KUBERNETESSERVICES_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
        return conf;
    }
}