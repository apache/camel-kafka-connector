...
public class CamelRestopenapiSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_PATH_SPECIFICATION_URI_DEFAULT = "openapi.json";
    public static final String CAMEL_SINK_RESTOPENAPI_PATH_OPERATION_ID_CONF = "camel.sink.path.operationId";
    private static final String CAMEL_SINK_RESTOPENAPI_PATH_OPERATION_ID_DOC = "ID of the operation from the OpenApi specification.";
    private static final String CAMEL_SINK_RESTOPENAPI_PATH_OPERATION_ID_DEFAULT = null;
    public static final String CAMEL_SINK_RESTOPENAPI_ENDPOINT_BASE_PATH_CONF = "camel.sink.endpoint.basePath";
    private static final String CAMEL_SINK_RESTOPENAPI_ENDPOINT_BASE_PATH_DOC = "API basePath, for example /v2. Default is unset, if set overrides the value present in OpenApi specification and in the component configuration.";
    private static final String CAMEL_SINK_RESTOPENAPI_ENDPOINT_BASE_PATH_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_ENDPOINT_COMPONENT_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_ENDPOINT_CONSUMES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_ENDPOINT_HOST_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_RESTOPENAPI_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_ENDPOINT_PRODUCES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_RESTOPENAPI_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_RESTOPENAPI_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_RESTOPENAPI_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_RESTOPENAPI_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_RESTOPENAPI_COMPONENT_BASE_PATH_CONF = "camel.component.rest-openapi.basePath";
    private static final String CAMEL_SINK_RESTOPENAPI_COMPONENT_BASE_PATH_DOC = "API basePath, for example /v2. Default is unset, if set overrides the value present in OpenApi specification.";
    private static final String CAMEL_SINK_RESTOPENAPI_COMPONENT_BASE_PATH_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_COMPONENT_COMPONENT_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_COMPONENT_CONSUMES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_COMPONENT_HOST_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_RESTOPENAPI_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_COMPONENT_PRODUCES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_COMPONENT_SPECIFICATION_URI_DEFAULT = "openapi.json";
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_RESTOPENAPI_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "Customize TLS parameters used by the component. If not set defaults to the TLS parameters set in the Camel context";
    private static final String CAMEL_SINK_RESTOPENAPI_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_RESTOPENAPI_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SINK_RESTOPENAPI_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
