...
public class CamelAwsmqSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWSMQ_COMPONENT_REGION_DOC = "The region in which MQ client needs to work";
    ...
    public static final String CAMEL_SINK_AWSMQ_COMPONENT_CONFIGURATION_DOC = "The AWS MQ default configuration";
