...
public class CamelJoltSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_JOLT_PATH_RESOURCE_URI_DEFAULT = null;
    public static final String CAMEL_SINK_JOLT_ENDPOINT_ALLOW_CONTEXT_MAP_ALL_CONF = "camel.sink.endpoint.allowContextMapAll";
    private static final String CAMEL_SINK_JOLT_ENDPOINT_ALLOW_CONTEXT_MAP_ALL_DOC = "Sets whether the context map should allow access to all details. By default only the message body and headers can be accessed. This option can be enabled for full access to the current Exchange and CamelContext. Doing so impose a potential security risk as this opens access to the full power of CamelContext API.";
    private static final Boolean CAMEL_SINK_JOLT_ENDPOINT_ALLOW_CONTEXT_MAP_ALL_DEFAULT = false;
    public static final String CAMEL_SINK_JOLT_ENDPOINT_ALLOW_TEMPLATE_FROM_HEADER_CONF = "camel.sink.endpoint.allowTemplateFromHeader";
    private static final String CAMEL_SINK_JOLT_ENDPOINT_ALLOW_TEMPLATE_FROM_HEADER_DOC = "Whether to allow to use resource template from header or not (default false). Enabling this allows to specify dynamic templates via message header. However this can be seen as a potential security vulnerability if the header is coming from a malicious user, so use this with care.";
    private static final Boolean CAMEL_SINK_JOLT_ENDPOINT_ALLOW_TEMPLATE_FROM_HEADER_DEFAULT = false;
    public static final String CAMEL_SINK_JOLT_ENDPOINT_CONTENT_CACHE_CONF = "camel.sink.endpoint.contentCache";
    private static final String CAMEL_SINK_JOLT_ENDPOINT_CONTENT_CACHE_DOC = "Sets whether to use resource content cache or not";
    private static final Boolean CAMEL_SINK_JOLT_ENDPOINT_CONTENT_CACHE_DEFAULT = false;
    public static final String CAMEL_SINK_JOLT_ENDPOINT_INPUT_TYPE_CONF = "camel.sink.endpoint.inputType";
    private static final String CAMEL_SINK_JOLT_ENDPOINT_INPUT_TYPE_DOC = "Specifies if the input is hydrated JSON or a JSON String. One of: [Hydrated] [JsonString]";
    private static final String CAMEL_SINK_JOLT_ENDPOINT_INPUT_TYPE_DEFAULT = "Hydrated";
    ...
    private static final Boolean CAMEL_SINK_JOLT_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_JOLT_ENDPOINT_OUTPUT_TYPE_CONF = "camel.sink.endpoint.outputType";
    private static final String CAMEL_SINK_JOLT_ENDPOINT_OUTPUT_TYPE_DOC = "Specifies if the output should be hydrated JSON or a JSON String. One of: [Hydrated] [JsonString]";
    private static final String CAMEL_SINK_JOLT_ENDPOINT_OUTPUT_TYPE_DEFAULT = "Hydrated";
    public static final String CAMEL_SINK_JOLT_ENDPOINT_TRANSFORM_DSL_CONF = "camel.sink.endpoint.transformDsl";
    private static final String CAMEL_SINK_JOLT_ENDPOINT_TRANSFORM_DSL_DOC = "Specifies the Transform DSL of the endpoint resource. If none is specified Chainr will be used. One of: [Chainr] [Shiftr] [Defaultr] [Removr] [Sortr]";
    private static final String CAMEL_SINK_JOLT_ENDPOINT_TRANSFORM_DSL_DEFAULT = "Chainr";
    public static final String CAMEL_SINK_JOLT_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_JOLT_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JOLT_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JOLT_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_JOLT_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_JOLT_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_JOLT_COMPONENT_ALLOW_TEMPLATE_FROM_HEADER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_JOLT_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_JOLT_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JOLT_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JOLT_COMPONENT_TRANSFORM_CONF = "camel.component.jolt.transform";
    private static final String CAMEL_SINK_JOLT_COMPONENT_TRANSFORM_DOC = "Explicitly sets the Transform to use. If not set a Transform specified by the transformDsl will be created";
    private static final String CAMEL_SINK_JOLT_COMPONENT_TRANSFORM_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_JOLT_ENDPOINT_ALLOW_CONTEXT_MAP_ALL_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_JOLT_ENDPOINT_ALLOW_CONTEXT_MAP_ALL_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_JOLT_ENDPOINT_ALLOW_CONTEXT_MAP_ALL_DOC);
        conf.define(CAMEL_SINK_JOLT_ENDPOINT_ALLOW_TEMPLATE_FROM_HEADER_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_JOLT_ENDPOINT_ALLOW_TEMPLATE_FROM_HEADER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_JOLT_ENDPOINT_ALLOW_TEMPLATE_FROM_HEADER_DOC);
