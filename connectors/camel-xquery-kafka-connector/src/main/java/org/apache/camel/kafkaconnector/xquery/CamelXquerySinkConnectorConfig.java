...
public class CamelXquerySinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_XQUERY_PATH_RESOURCE_URI_DOC = "The name of the template to load from classpath or file system";
    private static final String CAMEL_SINK_XQUERY_PATH_RESOURCE_URI_DEFAULT = null;
    public static final String CAMEL_SINK_XQUERY_ENDPOINT_ALLOW_ST_AXCONF = "camel.sink.endpoint.allowStAX";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_ALLOW_ST_AXDOC = "Whether to allow using StAX mode";
    private static final Boolean CAMEL_SINK_XQUERY_ENDPOINT_ALLOW_ST_AXDEFAULT = false;
    public static final String CAMEL_SINK_XQUERY_ENDPOINT_HEADER_NAME_CONF = "camel.sink.endpoint.headerName";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_HEADER_NAME_DOC = "To use a Camel Message header as the input source instead of Message body.";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_HEADER_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_XQUERY_ENDPOINT_NAMESPACE_PREFIXES_CONF = "camel.sink.endpoint.namespacePrefixes";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_NAMESPACE_PREFIXES_DOC = "Allows to control which namespace prefixes to use for a set of namespace mappings";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_NAMESPACE_PREFIXES_DEFAULT = null;
    public static final String CAMEL_SINK_XQUERY_ENDPOINT_RESULTS_FORMAT_CONF = "camel.sink.endpoint.resultsFormat";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_RESULTS_FORMAT_DOC = "What output result to use One of: [Bytes] [BytesSource] [DOM] [DOMSource] [List] [String] [StringSource]";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_RESULTS_FORMAT_DEFAULT = "DOM";
    public static final String CAMEL_SINK_XQUERY_ENDPOINT_RESULT_TYPE_CONF = "camel.sink.endpoint.resultType";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_RESULT_TYPE_DOC = "What output result to use defined as a class";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_RESULT_TYPE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_STRIPS_ALL_WHITE_SPACE_DOC = "Whether to strip all whitespaces";
    private static final Boolean CAMEL_SINK_XQUERY_ENDPOINT_STRIPS_ALL_WHITE_SPACE_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_XQUERY_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_XQUERY_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_XQUERY_ENDPOINT_CONFIGURATION_CONF = "camel.sink.endpoint.configuration";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_CONFIGURATION_DOC = "To use a custom Saxon configuration";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_CONFIGURATION_PROPERTIES_DOC = "To set custom Saxon configuration properties";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_CONFIGURATION_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SINK_XQUERY_ENDPOINT_MODULE_URIRESOLVER_CONF = "camel.sink.endpoint.moduleURIResolver";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_MODULE_URIRESOLVER_DOC = "To use the custom ModuleURIResolver";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_MODULE_URIRESOLVER_DEFAULT = null;
    public static final String CAMEL_SINK_XQUERY_ENDPOINT_PARAMETERS_CONF = "camel.sink.endpoint.parameters";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_PARAMETERS_DOC = "Additional parameters";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_XQUERY_ENDPOINT_PROPERTIES_CONF = "camel.sink.endpoint.properties";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_PROPERTIES_DOC = "Properties to configure the serialization parameters";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SINK_XQUERY_ENDPOINT_STATIC_QUERY_CONTEXT_CONF = "camel.sink.endpoint.staticQueryContext";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_STATIC_QUERY_CONTEXT_DOC = "To use a custom Saxon StaticQueryContext";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_STATIC_QUERY_CONTEXT_DEFAULT = null;
    public static final String CAMEL_SINK_XQUERY_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_XQUERY_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_XQUERY_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_XQUERY_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_XQUERY_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_XQUERY_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_XQUERY_COMPONENT_CONFIGURATION_CONF = "camel.component.xquery.configuration";
    private static final String CAMEL_SINK_XQUERY_COMPONENT_CONFIGURATION_DOC = "To use a custom Saxon configuration";
    private static final String CAMEL_SINK_XQUERY_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XQUERY_COMPONENT_CONFIGURATION_PROPERTIES_DOC = "To set custom Saxon configuration properties";
    private static final String CAMEL_SINK_XQUERY_COMPONENT_CONFIGURATION_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SINK_XQUERY_COMPONENT_MODULE_URIRESOLVER_CONF = "camel.component.xquery.moduleURIResolver";
    private static final String CAMEL_SINK_XQUERY_COMPONENT_MODULE_URIRESOLVER_DOC = "To use the custom ModuleURIResolver";
    private static final String CAMEL_SINK_XQUERY_COMPONENT_MODULE_URIRESOLVER_DEFAULT = null;
