...
public class CamelAwseksSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWSEKS_COMPONENT_REGION_DOC = "The region in which EKS client needs to work";
    ...
    public static final String CAMEL_SINK_AWSEKS_COMPONENT_CONFIGURATION_DOC = "The AWS EKS default configuration";
