...
public class CamelSftpSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_SFTP_PATH_HOST_DOC = "Hostname of the FTP server";
    private static final String CAMEL_SINK_SFTP_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_SFTP_PATH_PORT_DOC = "Port of the FTP server";
    private static final Integer CAMEL_SINK_SFTP_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_PATH_DIRECTORY_NAME_CONF = "camel.sink.path.directoryName";
    private static final String CAMEL_SINK_SFTP_PATH_DIRECTORY_NAME_DOC = "The starting directory";
    private static final String CAMEL_SINK_SFTP_PATH_DIRECTORY_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_BINARY_CONF = "camel.sink.endpoint.binary";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_BINARY_DOC = "Specifies the file transfer mode, BINARY or ASCII. Default is ASCII (false).";
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_BINARY_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_CHARSET_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_DISCONNECT_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_DONE_FILE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_FILE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_JSCH_LOGGING_LEVEL_CONF = "camel.sink.endpoint.jschLoggingLevel";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_JSCH_LOGGING_LEVEL_DOC = "The logging level to use for JSCH activity logging. As JSCH is verbose at by default at INFO level the threshold is WARN by default. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_JSCH_LOGGING_LEVEL_DEFAULT = "WARN";
    public static final String CAMEL_SINK_SFTP_ENDPOINT_PASSIVE_MODE_CONF = "camel.sink.endpoint.passiveMode";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PASSIVE_MODE_DOC = "Sets passive mode connections. Default is active mode connections.";
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_PASSIVE_MODE_DEFAULT = false;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_SEPARATOR_CONF = "camel.sink.endpoint.separator";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_SEPARATOR_DOC = "Sets the path separator to be used. UNIX = Uses unix style path separator Windows = Uses windows style path separator Auto = (is default) Use existing path separator in file name One of: [UNIX] [Windows] [Auto]";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_SEPARATOR_DEFAULT = "UNIX";
    ...
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_FAST_EXISTS_CHECK_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_FILE_EXIST_DEFAULT = "Override";
    ...
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_FLATTEN_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_JAIL_STARTING_DIRECTORY_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_MOVE_EXISTING_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_TEMP_FILE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_TEMP_PREFIX_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_ALLOW_NULL_BODY_DEFAULT = false;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_CHMOD_CONF = "camel.sink.endpoint.chmod";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_CHMOD_DOC = "Allows you to set chmod on the stored file. For example chmod=640.";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_CHMOD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_DISCONNECT_ON_BATCH_COMPLETE_DOC = "Whether or not to disconnect from remote FTP server right after a Batch upload is complete. disconnectOnBatchComplete will only disconnect the current connection to the FTP server.";
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_DISCONNECT_ON_BATCH_COMPLETE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_EAGER_DELETE_TARGET_FILE_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_KEEP_LAST_MODIFIED_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_MOVE_EXISTING_FILE_STRATEGY_DOC = "Strategy (Custom Strategy) used to move file with special naming token to use when fileExist=Move is configured. By default, there is an implementation used if no custom strategy is provided";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_MOVE_EXISTING_FILE_STRATEGY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_SEND_NOOP_DEFAULT = true;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_AUTO_CREATE_CONF = "camel.sink.endpoint.autoCreate";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_AUTO_CREATE_DOC = "Automatically create missing directories in the file's pathname. For the file consumer, that means creating the starting directory. For the file producer, it means the directory the files should be written to.";
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_AUTO_CREATE_DEFAULT = true;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_BIND_ADDRESS_CONF = "camel.sink.endpoint.bindAddress";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_BIND_ADDRESS_DOC = "Specifies the address of the local interface against which the connection should bind.";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_BIND_ADDRESS_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_BULK_REQUESTS_CONF = "camel.sink.endpoint.bulkRequests";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_BULK_REQUESTS_DOC = "Specifies how many requests may be outstanding at any one time. Increasing this value may slightly improve file transfer speed but will increase memory usage.";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_BULK_REQUESTS_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_COMPRESSION_CONF = "camel.sink.endpoint.compression";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_COMPRESSION_DOC = "To use compression. Specify a level from 1 to 10. Important: You must manually add the needed JSCH zlib JAR to the classpath for compression support.";
    private static final Integer CAMEL_SINK_SFTP_ENDPOINT_COMPRESSION_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_CONNECT_TIMEOUT_CONF = "camel.sink.endpoint.connectTimeout";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_CONNECT_TIMEOUT_DOC = "Sets the connect timeout for waiting for a connection to be established Used by both FTPClient and JSCH";
    private static final Integer CAMEL_SINK_SFTP_ENDPOINT_CONNECT_TIMEOUT_DEFAULT = 10000;
    ...
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_EXIST_DIR_CHECK_USING_LS_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_MAXIMUM_RECONNECT_ATTEMPTS_DOC = "Specifies the maximum reconnect attempts Camel performs when it tries to connect to the remote FTP server. Use 0 to disable this behavior.";
    private static final Integer CAMEL_SINK_SFTP_ENDPOINT_MAXIMUM_RECONNECT_ATTEMPTS_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_PROXY_CONF = "camel.sink.endpoint.proxy";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PROXY_DOC = "To use a custom configured com.jcraft.jsch.Proxy. This proxy is used to consume/send messages from the target SFTP host.";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PROXY_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_RECONNECT_DELAY_CONF = "camel.sink.endpoint.reconnectDelay";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_RECONNECT_DELAY_DOC = "Delay in millis Camel will wait before performing a reconnect attempt.";
    private static final Long CAMEL_SINK_SFTP_ENDPOINT_RECONNECT_DELAY_DEFAULT = null;
    ...
    private static final Integer CAMEL_SINK_SFTP_ENDPOINT_SERVER_ALIVE_COUNT_MAX_DEFAULT = 1;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_SERVER_ALIVE_INTERVAL_CONF = "camel.sink.endpoint.serverAliveInterval";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_SERVER_ALIVE_INTERVAL_DOC = "Sets the interval (millis) to send a keep-alive message. If zero is specified, any keep-alive message must not be sent. The default interval is zero.";
    private static final Integer CAMEL_SINK_SFTP_ENDPOINT_SERVER_ALIVE_INTERVAL_DEFAULT = null;
    ...
    private static final Integer CAMEL_SINK_SFTP_ENDPOINT_SO_TIMEOUT_DEFAULT = 300000;
    ...
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_STEPWISE_DEFAULT = true;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_THROW_EXCEPTION_ON_CONNECT_FAILED_DEFAULT = false;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_TIMEOUT_CONF = "camel.sink.endpoint.timeout";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_TIMEOUT_DOC = "Sets the data timeout for waiting for reply Used only by FTPClient";
    private static final Integer CAMEL_SINK_SFTP_ENDPOINT_TIMEOUT_DEFAULT = 30000;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_CIPHERS_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_KEY_PAIR_CONF = "camel.sink.endpoint.keyPair";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_KEY_PAIR_DOC = "Sets a key pair of the public and private key so to that the SFTP endpoint can do public/private key verification.";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_KEY_PAIR_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_KNOWN_HOSTS_CONF = "camel.sink.endpoint.knownHosts";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_KNOWN_HOSTS_DOC = "Sets the known_hosts from the byte array, so that the SFTP endpoint can do host key verification.";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_KNOWN_HOSTS_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_KNOWN_HOSTS_FILE_CONF = "camel.sink.endpoint.knownHostsFile";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_KNOWN_HOSTS_FILE_DOC = "Sets the known_hosts file, so that the SFTP endpoint can do host key verification.";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_KNOWN_HOSTS_FILE_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_KNOWN_HOSTS_URI_CONF = "camel.sink.endpoint.knownHostsUri";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_KNOWN_HOSTS_URI_DOC = "Sets the known_hosts file (loaded from classpath by default), so that the SFTP endpoint can do host key verification.";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_KNOWN_HOSTS_URI_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PASSWORD_DOC = "Password to use for login";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PREFERRED_AUTHENTICATIONS_DOC = "Set the preferred authentications which SFTP endpoint will used. Some example include:password,publickey. If not specified the default list from JSCH will be used.";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PREFERRED_AUTHENTICATIONS_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_PRIVATE_KEY_CONF = "camel.sink.endpoint.privateKey";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PRIVATE_KEY_DOC = "Set the private key as byte so that the SFTP endpoint can do private key verification.";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PRIVATE_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_PRIVATE_KEY_FILE_CONF = "camel.sink.endpoint.privateKeyFile";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PRIVATE_KEY_FILE_DOC = "Set the private key file so that the SFTP endpoint can do private key verification.";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PRIVATE_KEY_FILE_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_PRIVATE_KEY_PASSPHRASE_CONF = "camel.sink.endpoint.privateKeyPassphrase";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PRIVATE_KEY_PASSPHRASE_DOC = "Set the private key file passphrase so that the SFTP endpoint can do private key verification.";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PRIVATE_KEY_PASSPHRASE_DEFAULT = null;
    public static final String CAMEL_SINK_SFTP_ENDPOINT_PRIVATE_KEY_URI_CONF = "camel.sink.endpoint.privateKeyUri";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PRIVATE_KEY_URI_DOC = "Set the private key file (loaded from classpath by default) so that the SFTP endpoint can do private key verification.";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_PRIVATE_KEY_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_STRICT_HOST_KEY_CHECKING_DOC = "Sets whether to use strict host key checking. One of: [no] [yes]";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_STRICT_HOST_KEY_CHECKING_DEFAULT = "no";
    public static final String CAMEL_SINK_SFTP_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_USERNAME_DOC = "Username to use for login";
    private static final String CAMEL_SINK_SFTP_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SFTP_ENDPOINT_USE_USER_KNOWN_HOSTS_FILE_DOC = "If knownHostFile has not been explicit configured then use the host file from System.getProperty(user.home)/.ssh/known_hosts";
    private static final Boolean CAMEL_SINK_SFTP_ENDPOINT_USE_USER_KNOWN_HOSTS_FILE_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_SFTP_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SFTP_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SFTP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
