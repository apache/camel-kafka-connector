...
public class CamelMybatisSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_MYBATIS_PATH_STATEMENT_DOC = "The statement name in the MyBatis XML mapping file which maps to the query, insert, update or delete operation you wish to evaluate.";
    public static final String CAMEL_SOURCE_MYBATIS_PATH_STATEMENT_DEFAULT = null;
    ...
    public static final Boolean CAMEL_SOURCE_MYBATIS_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    public static final Integer CAMEL_SOURCE_MYBATIS_ENDPOINT_MAX_MESSAGES_PER_POLL_DEFAULT = 0;
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_ON_CONSUME_CONF = "camel.source.endpoint.onConsume";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_ON_CONSUME_DOC = "Statement to run after data has been processed in the route";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_ON_CONSUME_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_ROUTE_EMPTY_RESULT_SET_DOC = "Whether allow empty resultset to be routed to the next hop";
    public static final Boolean CAMEL_SOURCE_MYBATIS_ENDPOINT_ROUTE_EMPTY_RESULT_SET_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DOC = "If the polling consumer did not poll any files, you can enable this option to send an empty message (no body) instead.";
    public static final Boolean CAMEL_SOURCE_MYBATIS_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_TRANSACTED_CONF = "camel.source.endpoint.transacted";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_TRANSACTED_DOC = "Enables or disables transaction. If enabled then if processing an exchange failed then the consumer breaks out processing any further exchanges to cause a rollback eager.";
    public static final Boolean CAMEL_SOURCE_MYBATIS_ENDPOINT_TRANSACTED_DEFAULT = false;
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_USE_ITERATOR_CONF = "camel.source.endpoint.useIterator";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_USE_ITERATOR_DOC = "Process resultset individually or as a list";
    public static final Boolean CAMEL_SOURCE_MYBATIS_ENDPOINT_USE_ITERATOR_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_POLL_STRATEGY_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DOC = "The number of subsequent error polls (failed due some error) that should happen before the backoffMultipler should kick-in.";
    public static final Integer CAMEL_SOURCE_MYBATIS_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DOC = "The number of subsequent idle polls that should happen before the backoffMultipler should kick-in.";
    public static final Integer CAMEL_SOURCE_MYBATIS_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DEFAULT = null;
    ...
    public static final Integer CAMEL_SOURCE_MYBATIS_ENDPOINT_BACKOFF_MULTIPLIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll. You can also specify time values using units, such as 60s (60 seconds), 5m30s (5 minutes and 30 seconds), and 1h (1 hour).";
    public static final Long CAMEL_SOURCE_MYBATIS_ENDPOINT_DELAY_DEFAULT = 500L;
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_GREEDY_CONF = "camel.source.endpoint.greedy";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_GREEDY_DOC = "If greedy is enabled, then the ScheduledPollConsumer will run immediately again, if the previous run polled 1 or more messages.";
    public static final Boolean CAMEL_SOURCE_MYBATIS_ENDPOINT_GREEDY_DEFAULT = false;
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_INITIAL_DELAY_CONF = "camel.source.endpoint.initialDelay";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts. You can also specify time values using units, such as 60s (60 seconds), 5m30s (5 minutes and 30 seconds), and 1h (1 hour).";
    public static final Long CAMEL_SOURCE_MYBATIS_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_REPEAT_COUNT_CONF = "camel.source.endpoint.repeatCount";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_REPEAT_COUNT_DOC = "Specifies a maximum limit of number of fires. So if you set it to 1, the scheduler will only fire once. If you set it to 5, it will only fire five times. A value of zero or negative means fire forever.";
    public static final Long CAMEL_SOURCE_MYBATIS_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_RUN_LOGGING_LEVEL_CONF = "camel.source.endpoint.runLoggingLevel";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_RUN_LOGGING_LEVEL_DOC = "The consumer logs a start/complete log line when it polls. This option allows you to configure the logging level for that. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_RUN_LOGGING_LEVEL_DEFAULT = "TRACE";
    ...
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DOC = "Allows for configuring a custom/shared thread pool to use for the consumer. By default each consumer has its own single threaded thread pool.";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DEFAULT = null;
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_SCHEDULER_CONF = "camel.source.endpoint.scheduler";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component One of: [none] [spring] [quartz]";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_SCHEDULER_DEFAULT = "none";
    ...
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_SCHEDULER_PROPERTIES_DOC = "To configure additional properties when using a custom scheduler or any of the Quartz, Spring based scheduler.";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_SCHEDULER_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_START_SCHEDULER_CONF = "camel.source.endpoint.startScheduler";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_START_SCHEDULER_DOC = "Whether the scheduler should be auto started.";
    public static final Boolean CAMEL_SOURCE_MYBATIS_ENDPOINT_START_SCHEDULER_DEFAULT = true;
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_TIME_UNIT_CONF = "camel.source.endpoint.timeUnit";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_TIME_UNIT_DOC = "Time unit for initialDelay and delay options. One of: [NANOSECONDS] [MICROSECONDS] [MILLISECONDS] [SECONDS] [MINUTES] [HOURS] [DAYS]";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_TIME_UNIT_DEFAULT = "MILLISECONDS";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_USE_FIXED_DELAY_CONF = "camel.source.endpoint.useFixedDelay";
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_USE_FIXED_DELAY_DOC = "Controls if fixed delay or fixed rate is used. See ScheduledExecutorService in JDK for details.";
    public static final Boolean CAMEL_SOURCE_MYBATIS_ENDPOINT_USE_FIXED_DELAY_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_MYBATIS_COMPONENT_CONFIGURATION_URI_DOC = "Location of MyBatis xml configuration file. The default value is: SqlMapConfig.xml loaded from the classpath";
    public static final String CAMEL_SOURCE_MYBATIS_COMPONENT_CONFIGURATION_URI_DEFAULT = "SqlMapConfig.xml";
