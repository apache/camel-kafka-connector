...
public class CamelMybatisSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll.";
    ...
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts.";
    ...
    public static final String CAMEL_SOURCE_MYBATIS_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component. Use value spring or quartz for built in scheduler";
