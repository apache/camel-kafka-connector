...
public class CamelKafkabatchscramsourceSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_KAFKABATCHSCRAMSOURCE_KAMELET_BATCHING_INTERVAL_MS_CONF = "camel.kamelet.kafka-batch-scram-source.batchingIntervalMs";
    public static final String CAMEL_SOURCE_KAFKABATCHSCRAMSOURCE_KAMELET_BATCHING_INTERVAL_MS_DOC = "In consumer batching mode, then this option is specifying a time in millis, to trigger batch completion eager when the current batch size has not reached the maximum size defined by maxPollRecords. Notice the trigger is not exact at the given interval, as this can only happen between kafka polls (see pollTimeoutMs option).";
    public static final Integer CAMEL_SOURCE_KAFKABATCHSCRAMSOURCE_KAMELET_BATCHING_INTERVAL_MS_DEFAULT = null;
    public static final String CAMEL_SOURCE_KAFKABATCHSCRAMSOURCE_KAMELET_TOPIC_IS_PATTERN_CONF = "camel.kamelet.kafka-batch-scram-source.topicIsPattern";
    public static final String CAMEL_SOURCE_KAFKABATCHSCRAMSOURCE_KAMELET_TOPIC_IS_PATTERN_DOC = "Whether the topic is a pattern (regular expression). This can be used to subscribe to dynamic number of topics matching the pattern.";
    public static final Boolean CAMEL_SOURCE_KAFKABATCHSCRAMSOURCE_KAMELET_TOPIC_IS_PATTERN_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_KAFKABATCHSCRAMSOURCE_KAMELET_BATCHING_INTERVAL_MS_CONF, ConfigDef.Type.INT, CAMEL_SOURCE_KAFKABATCHSCRAMSOURCE_KAMELET_BATCHING_INTERVAL_MS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_KAFKABATCHSCRAMSOURCE_KAMELET_BATCHING_INTERVAL_MS_DOC);
        conf.define(CAMEL_SOURCE_KAFKABATCHSCRAMSOURCE_KAMELET_TOPIC_IS_PATTERN_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_KAFKABATCHSCRAMSOURCE_KAMELET_TOPIC_IS_PATTERN_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_KAFKABATCHSCRAMSOURCE_KAMELET_TOPIC_IS_PATTERN_DOC);
        return conf;
    }
}