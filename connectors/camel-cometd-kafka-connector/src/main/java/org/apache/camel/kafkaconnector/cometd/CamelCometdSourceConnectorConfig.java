...
public class CamelCometdSourceConnectorConfig
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_COMETD_COMPONENT_AUTOWIRED_ENABLED_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_COMETD_COMPONENT_AUTOWIRED_ENABLED_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_COMETD_COMPONENT_AUTOWIRED_ENABLED_DOC);
