...
public class CamelSpringredisSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_SPRINGREDIS_PATH_HOST_DOC = "The host where Redis server is running.";
    private static final String CAMEL_SOURCE_SPRINGREDIS_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPRINGREDIS_PATH_PORT_CONF = "camel.source.path.port";
    private static final String CAMEL_SOURCE_SPRINGREDIS_PATH_PORT_DOC = "Redis server port number";
    private static final String CAMEL_SOURCE_SPRINGREDIS_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_CHANNELS_CONF = "camel.source.endpoint.channels";
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_CHANNELS_DOC = "List of topic names or name patterns to subscribe to. Multiple names can be separated by comma.";
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_CHANNELS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_COMMAND_DEFAULT = "SET";
    ...
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_CONNECTION_FACTORY_DOC = "Reference to a pre-configured RedisConnectionFactory instance to use.";
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_CONNECTION_FACTORY_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_REDIS_TEMPLATE_CONF = "camel.source.endpoint.redisTemplate";
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_REDIS_TEMPLATE_DOC = "Reference to a pre-configured RedisTemplate instance to use.";
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_REDIS_TEMPLATE_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_SERIALIZER_CONF = "camel.source.endpoint.serializer";
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_SERIALIZER_DOC = "Reference to a pre-configured RedisSerializer instance to use.";
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_SERIALIZER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_LISTENER_CONTAINER_DOC = "Reference to a pre-configured RedisMessageListenerContainer instance to use.";
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_LISTENER_CONTAINER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_SPRINGREDIS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_SPRINGREDIS_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SPRINGREDIS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SPRINGREDIS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_SPRINGREDIS_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_SPRINGREDIS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SPRINGREDIS_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
        return conf;
    }
}