...
public class CamelAws2eksSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWS2EKS_COMPONENT_REGION_DOC = "The region in which EKS client needs to work";
    ...
    public static final String CAMEL_SINK_AWS2EKS_COMPONENT_CONFIGURATION_DOC = "The AWS EKS default configuration";
