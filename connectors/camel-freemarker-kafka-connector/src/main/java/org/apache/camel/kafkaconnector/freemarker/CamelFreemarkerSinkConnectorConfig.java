...
public class CamelFreemarkerSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_FREEMARKER_PATH_RESOURCE_URI_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_FREEMARKER_ENDPOINT_ALLOW_CONTEXT_MAP_ALL_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_FREEMARKER_ENDPOINT_ALLOW_TEMPLATE_FROM_HEADER_DEFAULT = false;
    public static final String CAMEL_SINK_FREEMARKER_ENDPOINT_CONFIGURATION_CONF = "camel.sink.endpoint.configuration";
    private static final String CAMEL_SINK_FREEMARKER_ENDPOINT_CONFIGURATION_DOC = "Sets the Freemarker configuration to use";
    private static final String CAMEL_SINK_FREEMARKER_ENDPOINT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_FREEMARKER_ENDPOINT_CONTENT_CACHE_CONF = "camel.sink.endpoint.contentCache";
    private static final String CAMEL_SINK_FREEMARKER_ENDPOINT_CONTENT_CACHE_DOC = "Sets whether to use resource content cache or not";
    private static final Boolean CAMEL_SINK_FREEMARKER_ENDPOINT_CONTENT_CACHE_DEFAULT = false;
    public static final String CAMEL_SINK_FREEMARKER_ENDPOINT_ENCODING_CONF = "camel.sink.endpoint.encoding";
    private static final String CAMEL_SINK_FREEMARKER_ENDPOINT_ENCODING_DOC = "Sets the encoding to be used for loading the template file.";
    private static final String CAMEL_SINK_FREEMARKER_ENDPOINT_ENCODING_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_FREEMARKER_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_FREEMARKER_ENDPOINT_TEMPLATE_UPDATE_DELAY_DOC = "Number of seconds the loaded template resource will remain in the cache.";
    private static final Integer CAMEL_SINK_FREEMARKER_ENDPOINT_TEMPLATE_UPDATE_DELAY_DEFAULT = null;
    public static final String CAMEL_SINK_FREEMARKER_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_FREEMARKER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_FREEMARKER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_FREEMARKER_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_FREEMARKER_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_FREEMARKER_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_FREEMARKER_COMPONENT_ALLOW_CONTEXT_MAP_ALL_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_FREEMARKER_COMPONENT_ALLOW_TEMPLATE_FROM_HEADER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_FREEMARKER_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_FREEMARKER_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.freemarker.basicPropertyBinding";
    private static final String CAMEL_SINK_FREEMARKER_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_FREEMARKER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_FREEMARKER_COMPONENT_CONFIGURATION_CONF = "camel.component.freemarker.configuration";
    private static final String CAMEL_SINK_FREEMARKER_COMPONENT_CONFIGURATION_DOC = "To use an existing freemarker.template.Configuration instance as the configuration.";
    private static final String CAMEL_SINK_FREEMARKER_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_FREEMARKER_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_FREEMARKER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_FREEMARKER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
