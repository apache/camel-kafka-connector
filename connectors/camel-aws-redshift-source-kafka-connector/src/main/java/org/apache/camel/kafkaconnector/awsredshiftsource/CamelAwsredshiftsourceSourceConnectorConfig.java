...
public class CamelAwsredshiftsourceSourceConnectorConfig
        extends
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_AWSREDSHIFTSOURCE_KAMELET_SERVER_NAME_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_AWSREDSHIFTSOURCE_KAMELET_SERVER_NAME_DEFAULT, ConfigDef.Importance.HIGH, CAMEL_SOURCE_AWSREDSHIFTSOURCE_KAMELET_SERVER_NAME_DOC);
        conf.define(CAMEL_SOURCE_AWSREDSHIFTSOURCE_KAMELET_SERVER_PORT_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_AWSREDSHIFTSOURCE_KAMELET_SERVER_PORT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSREDSHIFTSOURCE_KAMELET_SERVER_PORT_DOC);
        conf.define(CAMEL_SOURCE_AWSREDSHIFTSOURCE_KAMELET_USERNAME_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_AWSREDSHIFTSOURCE_KAMELET_USERNAME_DEFAULT, ConfigDef.Importance.HIGH, CAMEL_SOURCE_AWSREDSHIFTSOURCE_KAMELET_USERNAME_DOC);
        conf.define(CAMEL_SOURCE_AWSREDSHIFTSOURCE_KAMELET_PASSWORD_CONF, ConfigDef.Type.PASSWORD, CAMEL_SOURCE_AWSREDSHIFTSOURCE_KAMELET_PASSWORD_DEFAULT, ConfigDef.Importance.HIGH, CAMEL_SOURCE_AWSREDSHIFTSOURCE_KAMELET_PASSWORD_DOC);
