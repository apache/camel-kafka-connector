...
public class CamelStreamSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_STREAM_PATH_KIND_DOC = "Kind of stream to use such as System.in or System.out. One of: [in] [out] [err] [header] [file]";
    private static final String CAMEL_SOURCE_STREAM_PATH_KIND_DEFAULT = null;
    public static final String CAMEL_SOURCE_STREAM_ENDPOINT_ENCODING_CONF = "camel.source.endpoint.encoding";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_ENCODING_DOC = "You can configure the encoding (is a charset name) to use text-based streams (for example, message body is a String object). If not provided, Camel uses the JVM default Charset.";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_ENCODING_DEFAULT = null;
    public static final String CAMEL_SOURCE_STREAM_ENDPOINT_FILE_NAME_CONF = "camel.source.endpoint.fileName";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_FILE_NAME_DOC = "When using the stream:file URI format, this option specifies the filename to stream to/from.";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_FILE_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_STREAM_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_STREAM_ENDPOINT_FILE_WATCHER_CONF = "camel.source.endpoint.fileWatcher";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_FILE_WATCHER_DOC = "To use JVM file watcher to listen for file change events to support re-loading files that may be overwritten, somewhat like tail --retry";
    private static final Boolean CAMEL_SOURCE_STREAM_ENDPOINT_FILE_WATCHER_DEFAULT = false;
    public static final String CAMEL_SOURCE_STREAM_ENDPOINT_GROUP_LINES_CONF = "camel.source.endpoint.groupLines";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_GROUP_LINES_DOC = "To group X number of lines in the consumer. For example to group 10 lines and therefore only spit out an Exchange with 10 lines, instead of 1 Exchange per line.";
    private static final Integer CAMEL_SOURCE_STREAM_ENDPOINT_GROUP_LINES_DEFAULT = null;
    public static final String CAMEL_SOURCE_STREAM_ENDPOINT_GROUP_STRATEGY_CONF = "camel.source.endpoint.groupStrategy";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_GROUP_STRATEGY_DOC = "Allows to use a custom GroupStrategy to control how to group lines.";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_GROUP_STRATEGY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_INITIAL_PROMPT_DELAY_DOC = "Initial delay in milliseconds before showing the message prompt. This delay occurs only once. Can be used during system startup to avoid message prompts being written while other logging is done to the system out.";
    private static final Long CAMEL_SOURCE_STREAM_ENDPOINT_INITIAL_PROMPT_DELAY_DEFAULT = 2000L;
    public static final String CAMEL_SOURCE_STREAM_ENDPOINT_PROMPT_DELAY_CONF = "camel.source.endpoint.promptDelay";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_PROMPT_DELAY_DOC = "Optional delay in milliseconds before showing the message prompt.";
    private static final Long CAMEL_SOURCE_STREAM_ENDPOINT_PROMPT_DELAY_DEFAULT = null;
    public static final String CAMEL_SOURCE_STREAM_ENDPOINT_PROMPT_MESSAGE_CONF = "camel.source.endpoint.promptMessage";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_PROMPT_MESSAGE_DOC = "Message prompt to use when reading from stream:in; for example, you could set this to Enter a command:";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_PROMPT_MESSAGE_DEFAULT = null;
    public static final String CAMEL_SOURCE_STREAM_ENDPOINT_RETRY_CONF = "camel.source.endpoint.retry";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_RETRY_DOC = "Will retry opening the stream if it's overwritten, somewhat like tail --retry If reading from files then you should also enable the fileWatcher option, to make it work reliable.";
    private static final Boolean CAMEL_SOURCE_STREAM_ENDPOINT_RETRY_DEFAULT = false;
    public static final String CAMEL_SOURCE_STREAM_ENDPOINT_SCAN_STREAM_CONF = "camel.source.endpoint.scanStream";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_SCAN_STREAM_DOC = "To be used for continuously reading a stream such as the unix tail command.";
    private static final Boolean CAMEL_SOURCE_STREAM_ENDPOINT_SCAN_STREAM_DEFAULT = false;
    public static final String CAMEL_SOURCE_STREAM_ENDPOINT_SCAN_STREAM_DELAY_CONF = "camel.source.endpoint.scanStreamDelay";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_SCAN_STREAM_DELAY_DOC = "Delay in milliseconds between read attempts when using scanStream.";
    private static final Long CAMEL_SOURCE_STREAM_ENDPOINT_SCAN_STREAM_DELAY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_STREAM_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_STREAM_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final Integer CAMEL_SOURCE_STREAM_ENDPOINT_READ_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SOURCE_STREAM_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_STREAM_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_STREAM_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_STREAM_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_STREAM_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_STREAM_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
