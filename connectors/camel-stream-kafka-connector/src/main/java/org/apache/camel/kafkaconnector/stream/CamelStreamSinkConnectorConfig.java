...
public class CamelStreamSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_STREAM_PATH_KIND_DOC = "Kind of stream to use such as System.in or System.out. One of: [in] [out] [err] [header] [file]";
    private static final String CAMEL_SINK_STREAM_PATH_KIND_DEFAULT = null;
    public static final String CAMEL_SINK_STREAM_ENDPOINT_ENCODING_CONF = "camel.sink.endpoint.encoding";
    private static final String CAMEL_SINK_STREAM_ENDPOINT_ENCODING_DOC = "You can configure the encoding (is a charset name) to use text-based streams (for example, message body is a String object). If not provided, Camel uses the JVM default Charset.";
    private static final String CAMEL_SINK_STREAM_ENDPOINT_ENCODING_DEFAULT = null;
    public static final String CAMEL_SINK_STREAM_ENDPOINT_FILE_NAME_CONF = "camel.sink.endpoint.fileName";
    private static final String CAMEL_SINK_STREAM_ENDPOINT_FILE_NAME_DOC = "When using the stream:file URI format, this option specifies the filename to stream to/from.";
    private static final String CAMEL_SINK_STREAM_ENDPOINT_FILE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_STREAM_ENDPOINT_AUTO_CLOSE_COUNT_CONF = "camel.sink.endpoint.autoCloseCount";
    private static final String CAMEL_SINK_STREAM_ENDPOINT_AUTO_CLOSE_COUNT_DOC = "Number of messages to process before closing stream on Producer side. Never close stream by default (only when Producer is stopped). If more messages are sent, the stream is reopened for another autoCloseCount batch.";
    private static final Integer CAMEL_SINK_STREAM_ENDPOINT_AUTO_CLOSE_COUNT_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_STREAM_ENDPOINT_CLOSE_ON_DONE_DEFAULT = false;
    public static final String CAMEL_SINK_STREAM_ENDPOINT_DELAY_CONF = "camel.sink.endpoint.delay";
    private static final String CAMEL_SINK_STREAM_ENDPOINT_DELAY_DOC = "Initial delay in milliseconds before producing the stream.";
    private static final Long CAMEL_SINK_STREAM_ENDPOINT_DELAY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_STREAM_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_STREAM_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_STREAM_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final Integer CAMEL_SINK_STREAM_ENDPOINT_READ_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_STREAM_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_STREAM_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_STREAM_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_STREAM_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_STREAM_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_STREAM_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_STREAM_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_STREAM_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_STREAM_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
        return conf;
    }
}