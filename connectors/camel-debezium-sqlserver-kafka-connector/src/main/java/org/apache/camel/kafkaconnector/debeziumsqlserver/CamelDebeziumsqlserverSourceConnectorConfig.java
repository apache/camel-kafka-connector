...
public class CamelDebeziumsqlserverSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_PATH_NAME_DOC = "Unique name for the connector. Attempting to register again with the same name will fail.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_PATH_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_ADDITIONAL_PROPERTIES_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_INTERNAL_KEY_CONVERTER_DOC = "The Converter class that should be used to serialize and deserialize key data for offsets. The default is JSON converter.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_INTERNAL_KEY_CONVERTER_DEFAULT = "org.apache.kafka.connect.json.JsonConverter";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_INTERNAL_VALUE_CONVERTER_DOC = "The Converter class that should be used to serialize and deserialize value data for offsets. The default is JSON converter.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_INTERNAL_VALUE_CONVERTER_DEFAULT = "org.apache.kafka.connect.json.JsonConverter";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_COMMIT_POLICY_DEFAULT = "io.debezium.embedded.spi.OffsetCommitPolicy.PeriodicCommitOffsetPolicy";
    ...
    private static final Long CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_COMMIT_TIMEOUT_MS_DEFAULT = 5000L;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_FLUSH_INTERVAL_MS_DOC = "Interval at which to try committing offsets. The default is 1 minute.";
    private static final Long CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_FLUSH_INTERVAL_MS_DEFAULT = 60000L;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_STORAGE_DOC = "The name of the Java class that is responsible for persistence of connector offsets.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_STORAGE_DEFAULT = "org.apache.kafka.connect.storage.FileOffsetBackingStore";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_STORAGE_FILE_NAME_DOC = "Path to file where offsets are to be stored. Required when offset.storage is set to the FileOffsetBackingStore.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_STORAGE_FILE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_STORAGE_PARTITIONS_DOC = "The number of partitions used when creating the offset storage topic. Required when offset.storage is set to the 'KafkaOffsetBackingStore'.";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_STORAGE_PARTITIONS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_STORAGE_REPLICATION_FACTOR_DOC = "Replication factor used when creating the offset storage topic. Required when offset.storage is set to the KafkaOffsetBackingStore";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_STORAGE_REPLICATION_FACTOR_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_STORAGE_TOPIC_DOC = "The name of the Kafka topic where offsets are to be stored. Required when offset.storage is set to the KafkaOffsetBackingStore.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_OFFSET_STORAGE_TOPIC_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_COLUMN_BLACKLIST_DOC = "Description is not available here, please check Debezium website for corresponding key 'column.blacklist' description.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_COLUMN_BLACKLIST_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_DBNAME_DOC = "The name of the database the connector should be monitoring. When working with a multi-tenant set-up, must be set to the CDB name.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_DBNAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_HISTORY_DOC = "The name of the DatabaseHistory class that should be used to store and recover database schema changes. The configuration properties for the history are prefixed with the 'database.history.' string.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_HISTORY_DEFAULT = "io.debezium.relational.history.FileDatabaseHistory";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_HISTORY_FILE_FILENAME_DOC = "The path to the file that will be used to record the database history";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_HISTORY_FILE_FILENAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_HISTORY_KAFKA_BOOTSTRAP_SERVERS_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_HISTORY_KAFKA_RECOVERY_ATTEMPTS_DEFAULT = 100;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_HISTORY_KAFKA_RECOVERY_POLL_INTERVAL_MS_DOC = "The number of milliseconds to wait while polling for persisted data during recovery.";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_HISTORY_KAFKA_RECOVERY_POLL_INTERVAL_MS_DEFAULT = 100;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_HISTORY_KAFKA_TOPIC_DOC = "The name of the topic for the database schema history";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_HISTORY_KAFKA_TOPIC_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_HOSTNAME_DOC = "Resolvable hostname or IP address of the SQL Server database server.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_HOSTNAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_PASSWORD_DOC = "Password of the SQL Server database user to be used when connecting to the database.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_PORT_CONF = "camel.source.endpoint.databasePort";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_PORT_DOC = "Port of the SQL Server database server.";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_PORT_DEFAULT = 1433;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_SERVER_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_SERVER_TIMEZONE_DOC = "The timezone of the server used to correctly shift the commit transaction timestamp on the client sideOptions include: Any valid Java ZoneId";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_SERVER_TIMEZONE_DEFAULT = null;
    public static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_USER_CONF = "camel.source.endpoint.databaseUser";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_USER_DOC = "Name of the SQL Server database user to be used when connecting to the database.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DATABASE_USER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_DECIMAL_HANDLING_MODE_DEFAULT = "precise";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_EVENT_PROCESSING_FAILURE_HANDLING_MODE_DEFAULT = "fail";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_HEARTBEAT_INTERVAL_MS_DOC = "Length of an interval in milli-seconds in in which the connector periodically sends heartbeat messages to a heartbeat topic. Use 0 to disable heartbeat messages. Disabled by default.";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_HEARTBEAT_INTERVAL_MS_DEFAULT = 0;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_HEARTBEAT_TOPICS_PREFIX_DOC = "The prefix that is used to name heartbeat topics.Defaults to __debezium-heartbeat.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_HEARTBEAT_TOPICS_PREFIX_DEFAULT = "__debezium-heartbeat";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_MAX_BATCH_SIZE_DOC = "Maximum size of each batch of source records. Defaults to 2048.";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_MAX_BATCH_SIZE_DEFAULT = 2048;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_MAX_QUEUE_SIZE_DOC = "Maximum size of the queue for change events read from the database log but not yet recorded or forwarded. Defaults to 8192, and should always be larger than the maximum batch size.";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_MAX_QUEUE_SIZE_DEFAULT = 8192;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_MESSAGE_KEY_COLUMNS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_POLL_INTERVAL_MS_DOC = "Frequency in milliseconds to wait for new change events to appear after receiving no events. Defaults to 500ms.";
    private static final Long CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_POLL_INTERVAL_MS_DEFAULT = 500L;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_PROVIDE_TRANSACTION_METADATA_DOC = "Enables transaction metadata extraction together with event counting";
    private static final Boolean CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_PROVIDE_TRANSACTION_METADATA_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_SNAPSHOT_DELAY_MS_DOC = "The number of milliseconds to delay before a snapshot will begin.";
    private static final Long CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_SNAPSHOT_DELAY_MS_DEFAULT = 0L;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_SNAPSHOT_FETCH_SIZE_DOC = "The maximum number of records that should be loaded into memory while performing a snapshot";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_SNAPSHOT_FETCH_SIZE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_SNAPSHOT_LOCK_TIMEOUT_MS_DOC = "The maximum number of millis to wait for table locks at the beginning of a snapshot. If locks cannot be acquired in this time frame, the snapshot will be aborted. Defaults to 10 seconds";
    private static final Long CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_SNAPSHOT_LOCK_TIMEOUT_MS_DEFAULT = 10000L;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_SNAPSHOT_MODE_DEFAULT = "initial";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_SNAPSHOT_SELECT_STATEMENT_OVERRIDES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_SOURCE_STRUCT_VERSION_DOC = "A version of the format of the publicly visible source part in the message";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_SOURCE_STRUCT_VERSION_DEFAULT = "v2";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_TABLE_BLACKLIST_DOC = "Description is not available here, please check Debezium website for corresponding key 'table.blacklist' description.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_TABLE_BLACKLIST_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_TABLE_IGNORE_BUILTIN_DOC = "Flag specifying whether built-in tables should be ignored.";
    private static final Boolean CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_TABLE_IGNORE_BUILTIN_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_TABLE_WHITELIST_DOC = "The tables for which changes are to be captured";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_TABLE_WHITELIST_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_TIME_PRECISION_MODE_DEFAULT = "adaptive";
    ...
    private static final Boolean CAMEL_SOURCE_DEBEZIUMSQLSERVER_ENDPOINT_TOMBSTONES_ON_DELETE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_ADDITIONAL_PROPERTIES_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_CONFIGURATION_DOC = "Allow pre-configured Configurations to be set.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_INTERNAL_KEY_CONVERTER_DOC = "The Converter class that should be used to serialize and deserialize key data for offsets. The default is JSON converter.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_INTERNAL_KEY_CONVERTER_DEFAULT = "org.apache.kafka.connect.json.JsonConverter";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_INTERNAL_VALUE_CONVERTER_DOC = "The Converter class that should be used to serialize and deserialize value data for offsets. The default is JSON converter.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_INTERNAL_VALUE_CONVERTER_DEFAULT = "org.apache.kafka.connect.json.JsonConverter";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_COMMIT_POLICY_DEFAULT = "io.debezium.embedded.spi.OffsetCommitPolicy.PeriodicCommitOffsetPolicy";
    ...
    private static final Long CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_COMMIT_TIMEOUT_MS_DEFAULT = 5000L;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_FLUSH_INTERVAL_MS_DOC = "Interval at which to try committing offsets. The default is 1 minute.";
    private static final Long CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_FLUSH_INTERVAL_MS_DEFAULT = 60000L;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_STORAGE_DOC = "The name of the Java class that is responsible for persistence of connector offsets.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_STORAGE_DEFAULT = "org.apache.kafka.connect.storage.FileOffsetBackingStore";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_STORAGE_FILE_NAME_DOC = "Path to file where offsets are to be stored. Required when offset.storage is set to the FileOffsetBackingStore.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_STORAGE_FILE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_STORAGE_PARTITIONS_DOC = "The number of partitions used when creating the offset storage topic. Required when offset.storage is set to the 'KafkaOffsetBackingStore'.";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_STORAGE_PARTITIONS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_STORAGE_REPLICATION_FACTOR_DOC = "Replication factor used when creating the offset storage topic. Required when offset.storage is set to the KafkaOffsetBackingStore";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_STORAGE_REPLICATION_FACTOR_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_STORAGE_TOPIC_DOC = "The name of the Kafka topic where offsets are to be stored. Required when offset.storage is set to the KafkaOffsetBackingStore.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_OFFSET_STORAGE_TOPIC_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_COLUMN_BLACKLIST_DOC = "Description is not available here, please check Debezium website for corresponding key 'column.blacklist' description.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_COLUMN_BLACKLIST_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_DBNAME_DOC = "The name of the database the connector should be monitoring. When working with a multi-tenant set-up, must be set to the CDB name.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_DBNAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_HISTORY_DOC = "The name of the DatabaseHistory class that should be used to store and recover database schema changes. The configuration properties for the history are prefixed with the 'database.history.' string.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_HISTORY_DEFAULT = "io.debezium.relational.history.FileDatabaseHistory";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_HISTORY_FILE_FILENAME_DOC = "The path to the file that will be used to record the database history";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_HISTORY_FILE_FILENAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_HISTORY_KAFKA_BOOTSTRAP_SERVERS_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_HISTORY_KAFKA_RECOVERY_ATTEMPTS_DEFAULT = 100;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_HISTORY_KAFKA_RECOVERY_POLL_INTERVAL_MS_DOC = "The number of milliseconds to wait while polling for persisted data during recovery.";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_HISTORY_KAFKA_RECOVERY_POLL_INTERVAL_MS_DEFAULT = 100;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_HISTORY_KAFKA_TOPIC_DOC = "The name of the topic for the database schema history";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_HISTORY_KAFKA_TOPIC_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_HOSTNAME_DOC = "Resolvable hostname or IP address of the SQL Server database server.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_HOSTNAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_PASSWORD_DOC = "Password of the SQL Server database user to be used when connecting to the database.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_PORT_DOC = "Port of the SQL Server database server.";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_PORT_DEFAULT = 1433;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_SERVER_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_SERVER_TIMEZONE_DOC = "The timezone of the server used to correctly shift the commit transaction timestamp on the client sideOptions include: Any valid Java ZoneId";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_SERVER_TIMEZONE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_USER_DOC = "Name of the SQL Server database user to be used when connecting to the database.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DATABASE_USER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_DECIMAL_HANDLING_MODE_DEFAULT = "precise";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_EVENT_PROCESSING_FAILURE_HANDLING_MODE_DEFAULT = "fail";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_HEARTBEAT_INTERVAL_MS_DOC = "Length of an interval in milli-seconds in in which the connector periodically sends heartbeat messages to a heartbeat topic. Use 0 to disable heartbeat messages. Disabled by default.";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_HEARTBEAT_INTERVAL_MS_DEFAULT = 0;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_HEARTBEAT_TOPICS_PREFIX_DOC = "The prefix that is used to name heartbeat topics.Defaults to __debezium-heartbeat.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_HEARTBEAT_TOPICS_PREFIX_DEFAULT = "__debezium-heartbeat";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_MAX_BATCH_SIZE_DOC = "Maximum size of each batch of source records. Defaults to 2048.";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_MAX_BATCH_SIZE_DEFAULT = 2048;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_MAX_QUEUE_SIZE_DOC = "Maximum size of the queue for change events read from the database log but not yet recorded or forwarded. Defaults to 8192, and should always be larger than the maximum batch size.";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_MAX_QUEUE_SIZE_DEFAULT = 8192;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_MESSAGE_KEY_COLUMNS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_POLL_INTERVAL_MS_DOC = "Frequency in milliseconds to wait for new change events to appear after receiving no events. Defaults to 500ms.";
    private static final Long CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_POLL_INTERVAL_MS_DEFAULT = 500L;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_PROVIDE_TRANSACTION_METADATA_DOC = "Enables transaction metadata extraction together with event counting";
    private static final Boolean CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_PROVIDE_TRANSACTION_METADATA_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_SNAPSHOT_DELAY_MS_DOC = "The number of milliseconds to delay before a snapshot will begin.";
    private static final Long CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_SNAPSHOT_DELAY_MS_DEFAULT = 0L;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_SNAPSHOT_FETCH_SIZE_DOC = "The maximum number of records that should be loaded into memory while performing a snapshot";
    private static final Integer CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_SNAPSHOT_FETCH_SIZE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_SNAPSHOT_LOCK_TIMEOUT_MS_DOC = "The maximum number of millis to wait for table locks at the beginning of a snapshot. If locks cannot be acquired in this time frame, the snapshot will be aborted. Defaults to 10 seconds";
    private static final Long CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_SNAPSHOT_LOCK_TIMEOUT_MS_DEFAULT = 10000L;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_SNAPSHOT_MODE_DEFAULT = "initial";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_SNAPSHOT_SELECT_STATEMENT_OVERRIDES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_SOURCE_STRUCT_VERSION_DOC = "A version of the format of the publicly visible source part in the message";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_SOURCE_STRUCT_VERSION_DEFAULT = "v2";
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_TABLE_BLACKLIST_DOC = "Description is not available here, please check Debezium website for corresponding key 'table.blacklist' description.";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_TABLE_BLACKLIST_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_TABLE_IGNORE_BUILTIN_DOC = "Flag specifying whether built-in tables should be ignored.";
    private static final Boolean CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_TABLE_IGNORE_BUILTIN_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_TABLE_WHITELIST_DOC = "The tables for which changes are to be captured";
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_TABLE_WHITELIST_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_TIME_PRECISION_MODE_DEFAULT = "adaptive";
    ...
    private static final Boolean CAMEL_SOURCE_DEBEZIUMSQLSERVER_COMPONENT_TOMBSTONES_ON_DELETE_DEFAULT = false;
