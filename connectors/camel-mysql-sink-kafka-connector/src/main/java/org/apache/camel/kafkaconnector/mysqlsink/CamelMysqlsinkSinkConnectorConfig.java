...
public class CamelMysqlsinkSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_MYSQLSINK_KAMELET_PORT_CONF = "camel.kamelet.mysql-sink.port";
    public static final String CAMEL_SINK_MYSQLSINK_KAMELET_PORT_DOC = "Server Port for the data source";
    public static final String CAMEL_SINK_MYSQLSINK_KAMELET_PORT_DEFAULT = "3306";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_MYSQLSINK_KAMELET_PORT_CONF, ConfigDef.Type.STRING, CAMEL_SINK_MYSQLSINK_KAMELET_PORT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_MYSQLSINK_KAMELET_PORT_DOC);
