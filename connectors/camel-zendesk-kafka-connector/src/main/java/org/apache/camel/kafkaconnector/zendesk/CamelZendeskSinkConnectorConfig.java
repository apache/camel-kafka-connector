...
public class CamelZendeskSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_ZENDESK_PATH_METHOD_NAME_DOC = "What operation to use";
    private static final String CAMEL_SINK_ZENDESK_PATH_METHOD_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_ZENDESK_ENDPOINT_IN_BODY_CONF = "camel.sink.endpoint.inBody";
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_IN_BODY_DOC = "Sets the name of a parameter to be passed in the exchange In Body";
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_IN_BODY_DEFAULT = null;
    public static final String CAMEL_SINK_ZENDESK_ENDPOINT_SERVER_URL_CONF = "camel.sink.endpoint.serverUrl";
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_SERVER_URL_DOC = "The server URL to connect.";
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_SERVER_URL_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ZENDESK_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_ZENDESK_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_ZENDESK_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_ZENDESK_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_ZENDESK_ENDPOINT_OAUTH_TOKEN_CONF = "camel.sink.endpoint.oauthToken";
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_OAUTH_TOKEN_DOC = "The OAuth token.";
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_OAUTH_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_ZENDESK_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_PASSWORD_DOC = "The password.";
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_ZENDESK_ENDPOINT_TOKEN_CONF = "camel.sink.endpoint.token";
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_TOKEN_DOC = "The security token.";
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_ZENDESK_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_USERNAME_DOC = "The user name.";
    private static final String CAMEL_SINK_ZENDESK_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ZENDESK_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ZENDESK_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_ZENDESK_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_ZENDESK_COMPONENT_CONFIGURATION_CONF = "camel.component.zendesk.configuration";
    private static final String CAMEL_SINK_ZENDESK_COMPONENT_CONFIGURATION_DOC = "Component configuration";
    private static final String CAMEL_SINK_ZENDESK_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_ZENDESK_COMPONENT_ZENDESK_CONF = "camel.component.zendesk.zendesk";
    private static final String CAMEL_SINK_ZENDESK_COMPONENT_ZENDESK_DOC = "To use a shared Zendesk instance.";
    private static final String CAMEL_SINK_ZENDESK_COMPONENT_ZENDESK_DEFAULT = null;
