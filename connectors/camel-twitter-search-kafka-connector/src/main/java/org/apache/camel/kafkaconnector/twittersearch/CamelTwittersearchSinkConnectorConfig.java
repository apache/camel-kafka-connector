...
public class CamelTwittersearchSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_TWITTERSEARCH_PATH_KEYWORDS_DOC = "The search query, use the keywords AND, OR, - and () to narrow the search results.";
    private static final String CAMEL_SINK_TWITTERSEARCH_PATH_KEYWORDS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_TWITTERSEARCH_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_TWITTERSEARCH_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_TWITTERSEARCH_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_HTTP_PROXY_HOST_CONF = "camel.sink.endpoint.httpProxyHost";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_HTTP_PROXY_HOST_DOC = "The http proxy host which can be used for the camel-twitter. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_HTTP_PROXY_HOST_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_HTTP_PROXY_PASSWORD_DOC = "The http proxy password which can be used for the camel-twitter. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_HTTP_PROXY_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_HTTP_PROXY_PORT_CONF = "camel.sink.endpoint.httpProxyPort";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_HTTP_PROXY_PORT_DOC = "The http proxy port which can be used for the camel-twitter. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_HTTP_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_HTTP_PROXY_USER_CONF = "camel.sink.endpoint.httpProxyUser";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_HTTP_PROXY_USER_DOC = "The http proxy user which can be used for the camel-twitter. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_HTTP_PROXY_USER_DEFAULT = null;
    public static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_ACCESS_TOKEN_CONF = "camel.sink.endpoint.accessToken";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_ACCESS_TOKEN_DOC = "The access token. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_ACCESS_TOKEN_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_ACCESS_TOKEN_SECRET_DOC = "The access secret. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_ACCESS_TOKEN_SECRET_DEFAULT = null;
    public static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_CONSUMER_KEY_CONF = "camel.sink.endpoint.consumerKey";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_CONSUMER_KEY_DOC = "The consumer key. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_CONSUMER_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_CONSUMER_SECRET_CONF = "camel.sink.endpoint.consumerSecret";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_CONSUMER_SECRET_DOC = "The consumer secret. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SINK_TWITTERSEARCH_ENDPOINT_CONSUMER_SECRET_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_TWITTERSEARCH_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_TWITTERSEARCH_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_HTTP_PROXY_HOST_DOC = "The http proxy host which can be used for the camel-twitter.";
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_HTTP_PROXY_HOST_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_HTTP_PROXY_PASSWORD_DOC = "The http proxy password which can be used for the camel-twitter.";
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_HTTP_PROXY_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_HTTP_PROXY_PORT_DOC = "The http proxy port which can be used for the camel-twitter.";
    private static final Integer CAMEL_SINK_TWITTERSEARCH_COMPONENT_HTTP_PROXY_PORT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_HTTP_PROXY_USER_DOC = "The http proxy user which can be used for the camel-twitter.";
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_HTTP_PROXY_USER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_ACCESS_TOKEN_DOC = "The access token";
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_ACCESS_TOKEN_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_ACCESS_TOKEN_SECRET_DOC = "The access token secret";
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_ACCESS_TOKEN_SECRET_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_CONSUMER_KEY_DOC = "The consumer key";
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_CONSUMER_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_CONSUMER_SECRET_DOC = "The consumer secret";
    private static final String CAMEL_SINK_TWITTERSEARCH_COMPONENT_CONSUMER_SECRET_DEFAULT = null;
