...
public class CamelServicenowSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    public static final Boolean CAMEL_SINK_SERVICENOW_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_CONFIGURATION_DOC = "The ServiceNow default configuration";
    ...
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_PASSWORD_DOC = "ServiceNow account password";
    ...
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_USER_NAME_DOC = "ServiceNow user account name";
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SINK_SERVICENOW_COMPONENT_PASSWORD_CONF, ConfigDef.Type.STRING, CAMEL_SINK_SERVICENOW_COMPONENT_PASSWORD_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SERVICENOW_COMPONENT_PASSWORD_DOC);
        ...
        conf.define(CAMEL_SINK_SERVICENOW_COMPONENT_USER_NAME_CONF, ConfigDef.Type.STRING, CAMEL_SINK_SERVICENOW_COMPONENT_USER_NAME_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SERVICENOW_COMPONENT_USER_NAME_DOC);
        return conf;
    }
}