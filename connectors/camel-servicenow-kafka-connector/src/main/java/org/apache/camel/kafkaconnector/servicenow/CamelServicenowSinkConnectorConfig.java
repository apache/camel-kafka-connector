...
public class CamelServicenowSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_SERVICENOW_PATH_INSTANCE_NAME_DOC = "The ServiceNow instance name";
    private static final String CAMEL_SINK_SERVICENOW_PATH_INSTANCE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_DISPLAY_CONF = "camel.sink.endpoint.display";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_DISPLAY_DOC = "Set this parameter to true to return only scorecards where the indicator Display field is selected. Set this parameter to all to return scorecards with any Display field value. This parameter is true by default. One of: [false] [true] [all]";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_DISPLAY_DEFAULT = "true";
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_DISPLAY_VALUE_CONF = "camel.sink.endpoint.displayValue";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_DISPLAY_VALUE_DOC = "Return the display value (true), actual value (false), or both (all) for reference fields (default: false) One of: [false] [true] [all]";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_DISPLAY_VALUE_DEFAULT = "false";
    ...
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_EXCLUDE_REFERENCE_LINK_DOC = "True to exclude Table API links for reference fields (default: false)";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_EXCLUDE_REFERENCE_LINK_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_FAVORITES_CONF = "camel.sink.endpoint.favorites";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_FAVORITES_DOC = "Set this parameter to true to return only scorecards that are favorites of the querying user.";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_FAVORITES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INCLUDE_AGGREGATES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INCLUDE_AVAILABLE_AGGREGATES_DOC = "Set this parameter to true to return all available aggregates for an indicator when no aggregate has been applied. If a value is not specified, this parameter defaults to false and returns no aggregates.";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INCLUDE_AVAILABLE_AGGREGATES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INCLUDE_AVAILABLE_BREAKDOWNS_DOC = "Set this parameter to true to return all available breakdowns for an indicator. If a value is not specified, this parameter defaults to false and returns no breakdowns.";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INCLUDE_AVAILABLE_BREAKDOWNS_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INCLUDE_SCORE_NOTES_CONF = "camel.sink.endpoint.includeScoreNotes";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INCLUDE_SCORE_NOTES_DOC = "Set this parameter to true to return all notes associated with the score. The note element contains the note text as well as the author and timestamp when the note was added.";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INCLUDE_SCORE_NOTES_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INCLUDE_SCORES_CONF = "camel.sink.endpoint.includeScores";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INCLUDE_SCORES_DOC = "Set this parameter to true to return all scores for a scorecard. If a value is not specified, this parameter defaults to false and returns only the most recent score value.";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INCLUDE_SCORES_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INPUT_DISPLAY_VALUE_CONF = "camel.sink.endpoint.inputDisplayValue";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INPUT_DISPLAY_VALUE_DOC = "True to set raw value of input fields (default: false)";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_INPUT_DISPLAY_VALUE_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_KEY_CONF = "camel.sink.endpoint.key";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_KEY_DOC = "Set this parameter to true to return only scorecards for key indicators.";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_KEY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SERVICENOW_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_MODELS_CONF = "camel.sink.endpoint.models";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_MODELS_DOC = "Defines both request and response models";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_MODELS_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PER_PAGE_CONF = "camel.sink.endpoint.perPage";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PER_PAGE_DOC = "Enter the maximum number of scorecards each query can return. By default this value is 10, and the maximum is 100.";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PER_PAGE_DEFAULT = "10";
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_RELEASE_CONF = "camel.sink.endpoint.release";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_RELEASE_DOC = "The ServiceNow release to target, default to Helsinki See https://docs.servicenow.com One of: [FUJI] [GENEVA] [HELSINKI]";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_RELEASE_DEFAULT = "HELSINKI";
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_REQUEST_MODELS_CONF = "camel.sink.endpoint.requestModels";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_REQUEST_MODELS_DOC = "Defines the request model";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_REQUEST_MODELS_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_RESOURCE_CONF = "camel.sink.endpoint.resource";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_RESOURCE_DOC = "The default resource, can be overridden by header CamelServiceNowResource";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_RESOURCE_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_RESPONSE_MODELS_CONF = "camel.sink.endpoint.responseModels";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_RESPONSE_MODELS_DOC = "Defines the response model";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_RESPONSE_MODELS_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SORT_BY_CONF = "camel.sink.endpoint.sortBy";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SORT_BY_DOC = "Specify the value to use when sorting results. By default, queries sort records by value. One of: [value] [change] [changeperc] [gap] [gapperc] [duedate] [name] [order] [default] [group] [indicator_group] [frequency] [target] [date] [trend] [bullet] [direction]";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SORT_BY_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SORT_DIR_CONF = "camel.sink.endpoint.sortDir";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SORT_DIR_DOC = "Specify the sort direction, ascending or descending. By default, queries sort records in descending order. Use sysparm_sortdir=asc to sort in ascending order. One of: [asc] [desc]";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SORT_DIR_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SUPPRESS_AUTO_SYS_FIELD_DOC = "True to suppress auto generation of system fields (default: false)";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SUPPRESS_AUTO_SYS_FIELD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SUPPRESS_PAGINATION_HEADER_DOC = "Set this value to true to remove the Link header from the response. The Link header allows you to request additional pages of data when the number of records matching your query exceeds the query limit";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SUPPRESS_PAGINATION_HEADER_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_TABLE_CONF = "camel.sink.endpoint.table";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_TABLE_DOC = "The default table, can be overridden by header CamelServiceNowTable";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_TABLE_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_TARGET_CONF = "camel.sink.endpoint.target";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_TARGET_DOC = "Set this parameter to true to return only scorecards that have a target.";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_TARGET_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_TOP_LEVEL_ONLY_CONF = "camel.sink.endpoint.topLevelOnly";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_TOP_LEVEL_ONLY_DOC = "Gets only those categories whose parent is a catalog.";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_TOP_LEVEL_ONLY_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_API_VERSION_CONF = "camel.sink.endpoint.apiVersion";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_API_VERSION_DOC = "The ServiceNow REST API version, default latest";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_API_VERSION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SERVICENOW_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_DATE_FORMAT_CONF = "camel.sink.endpoint.dateFormat";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_DATE_FORMAT_DOC = "The date format used for Json serialization/deserialization";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_DATE_FORMAT_DEFAULT = "yyyy-MM-dd";
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_DATE_TIME_FORMAT_CONF = "camel.sink.endpoint.dateTimeFormat";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_DATE_TIME_FORMAT_DOC = "The date-time format used for Json serialization/deserialization";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_DATE_TIME_FORMAT_DEFAULT = "yyyy-MM-dd HH:mm:ss";
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_HTTP_CLIENT_POLICY_CONF = "camel.sink.endpoint.httpClientPolicy";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_HTTP_CLIENT_POLICY_DOC = "To configure http-client";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_HTTP_CLIENT_POLICY_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_MAPPER_CONF = "camel.sink.endpoint.mapper";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_MAPPER_DOC = "Sets Jackson's ObjectMapper to use for request/reply";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_MAPPER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_AUTHORIZATION_POLICY_DOC = "To configure proxy authentication";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_AUTHORIZATION_POLICY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_RETRIEVE_TARGET_RECORD_ON_IMPORT_DOC = "Set this parameter to true to retrieve the target record when using import set api. The import set result is then replaced by the target record";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_RETRIEVE_TARGET_RECORD_ON_IMPORT_DEFAULT = "false";
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_SERVICENOW_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_TIME_FORMAT_CONF = "camel.sink.endpoint.timeFormat";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_TIME_FORMAT_DOC = "The time format used for Json serialization/deserialization";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_TIME_FORMAT_DEFAULT = "HH:mm:ss";
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_HOST_CONF = "camel.sink.endpoint.proxyHost";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_HOST_DOC = "The proxy host name";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_PORT_CONF = "camel.sink.endpoint.proxyPort";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_PORT_DOC = "The proxy port number";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_API_URL_CONF = "camel.sink.endpoint.apiUrl";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_API_URL_DOC = "The ServiceNow REST API url";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_API_URL_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_OAUTH_CLIENT_ID_CONF = "camel.sink.endpoint.oauthClientId";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_OAUTH_CLIENT_ID_DOC = "OAuth2 ClientID";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_OAUTH_CLIENT_ID_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_OAUTH_CLIENT_SECRET_CONF = "camel.sink.endpoint.oauthClientSecret";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_OAUTH_CLIENT_SECRET_DOC = "OAuth2 ClientSecret";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_OAUTH_CLIENT_SECRET_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_OAUTH_TOKEN_URL_CONF = "camel.sink.endpoint.oauthTokenUrl";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_OAUTH_TOKEN_URL_DOC = "OAuth token Url";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_OAUTH_TOKEN_URL_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PASSWORD_DOC = "ServiceNow account password, MUST be provided";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_PASSWORD_CONF = "camel.sink.endpoint.proxyPassword";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_PASSWORD_DOC = "Password for proxy authentication";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_USER_NAME_CONF = "camel.sink.endpoint.proxyUserName";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_USER_NAME_DOC = "Username for proxy authentication";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_PROXY_USER_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters. See http://camel.apache.org/camel-configuration-utilities.html";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_ENDPOINT_USER_NAME_CONF = "camel.sink.endpoint.userName";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_USER_NAME_DOC = "ServiceNow user account name, MUST be provided";
    private static final String CAMEL_SINK_SERVICENOW_ENDPOINT_USER_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_CONFIGURATION_CONF = "camel.component.servicenow.configuration";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_CONFIGURATION_DOC = "Component configuration";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_DISPLAY_DEFAULT = "true";
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_DISPLAY_VALUE_CONF = "camel.component.servicenow.displayValue";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_DISPLAY_VALUE_DOC = "Return the display value (true), actual value (false), or both (all) for reference fields (default: false) One of: [false] [true] [all]";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_DISPLAY_VALUE_DEFAULT = "false";
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_EXCLUDE_REFERENCE_LINK_DOC = "True to exclude Table API links for reference fields (default: false)";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_EXCLUDE_REFERENCE_LINK_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_FAVORITES_CONF = "camel.component.servicenow.favorites";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_FAVORITES_DOC = "Set this parameter to true to return only scorecards that are favorites of the querying user.";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_FAVORITES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_INCLUDE_AGGREGATES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_INCLUDE_AVAILABLE_AGGREGATES_DOC = "Set this parameter to true to return all available aggregates for an indicator when no aggregate has been applied. If a value is not specified, this parameter defaults to false and returns no aggregates.";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_INCLUDE_AVAILABLE_AGGREGATES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_INCLUDE_AVAILABLE_BREAKDOWNS_DOC = "Set this parameter to true to return all available breakdowns for an indicator. If a value is not specified, this parameter defaults to false and returns no breakdowns.";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_INCLUDE_AVAILABLE_BREAKDOWNS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_INCLUDE_SCORE_NOTES_DOC = "Set this parameter to true to return all notes associated with the score. The note element contains the note text as well as the author and timestamp when the note was added.";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_INCLUDE_SCORE_NOTES_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_INCLUDE_SCORES_CONF = "camel.component.servicenow.includeScores";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_INCLUDE_SCORES_DOC = "Set this parameter to true to return all scores for a scorecard. If a value is not specified, this parameter defaults to false and returns only the most recent score value.";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_INCLUDE_SCORES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_INPUT_DISPLAY_VALUE_DOC = "True to set raw value of input fields (default: false)";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_INPUT_DISPLAY_VALUE_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_KEY_CONF = "camel.component.servicenow.key";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_KEY_DOC = "Set this parameter to true to return only scorecards for key indicators.";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_KEY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SERVICENOW_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_MODELS_CONF = "camel.component.servicenow.models";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_MODELS_DOC = "Defines both request and response models";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_MODELS_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_PER_PAGE_CONF = "camel.component.servicenow.perPage";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PER_PAGE_DOC = "Enter the maximum number of scorecards each query can return. By default this value is 10, and the maximum is 100.";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PER_PAGE_DEFAULT = "10";
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_RELEASE_CONF = "camel.component.servicenow.release";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_RELEASE_DOC = "The ServiceNow release to target, default to Helsinki See https://docs.servicenow.com One of: [FUJI] [GENEVA] [HELSINKI]";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_RELEASE_DEFAULT = "HELSINKI";
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_REQUEST_MODELS_CONF = "camel.component.servicenow.requestModels";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_REQUEST_MODELS_DOC = "Defines the request model";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_REQUEST_MODELS_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_RESOURCE_CONF = "camel.component.servicenow.resource";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_RESOURCE_DOC = "The default resource, can be overridden by header CamelServiceNowResource";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_RESOURCE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_RESPONSE_MODELS_DOC = "Defines the response model";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_RESPONSE_MODELS_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_SORT_BY_CONF = "camel.component.servicenow.sortBy";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_SORT_BY_DOC = "Specify the value to use when sorting results. By default, queries sort records by value. One of: [value] [change] [changeperc] [gap] [gapperc] [duedate] [name] [order] [default] [group] [indicator_group] [frequency] [target] [date] [trend] [bullet] [direction]";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_SORT_BY_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_SORT_DIR_CONF = "camel.component.servicenow.sortDir";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_SORT_DIR_DOC = "Specify the sort direction, ascending or descending. By default, queries sort records in descending order. Use sysparm_sortdir=asc to sort in ascending order. One of: [asc] [desc]";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_SORT_DIR_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_SUPPRESS_AUTO_SYS_FIELD_DOC = "True to suppress auto generation of system fields (default: false)";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_SUPPRESS_AUTO_SYS_FIELD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_SUPPRESS_PAGINATION_HEADER_DOC = "Set this value to true to remove the Link header from the response. The Link header allows you to request additional pages of data when the number of records matching your query exceeds the query limit";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_SUPPRESS_PAGINATION_HEADER_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_TABLE_CONF = "camel.component.servicenow.table";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_TABLE_DOC = "The default table, can be overridden by header CamelServiceNowTable";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_TABLE_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_TARGET_CONF = "camel.component.servicenow.target";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_TARGET_DOC = "Set this parameter to true to return only scorecards that have a target.";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_TARGET_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_TOP_LEVEL_ONLY_CONF = "camel.component.servicenow.topLevelOnly";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_TOP_LEVEL_ONLY_DOC = "Gets only those categories whose parent is a catalog.";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_TOP_LEVEL_ONLY_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_API_VERSION_CONF = "camel.component.servicenow.apiVersion";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_API_VERSION_DOC = "The ServiceNow REST API version, default latest";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_API_VERSION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SERVICENOW_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_DATE_FORMAT_CONF = "camel.component.servicenow.dateFormat";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_DATE_FORMAT_DOC = "The date format used for Json serialization/deserialization";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_DATE_FORMAT_DEFAULT = "yyyy-MM-dd";
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_DATE_TIME_FORMAT_DOC = "The date-time format used for Json serialization/deserialization";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_DATE_TIME_FORMAT_DEFAULT = "yyyy-MM-dd HH:mm:ss";
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_HTTP_CLIENT_POLICY_DOC = "To configure http-client";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_HTTP_CLIENT_POLICY_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_INSTANCE_NAME_CONF = "camel.component.servicenow.instanceName";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_INSTANCE_NAME_DOC = "The ServiceNow instance name";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_INSTANCE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_MAPPER_CONF = "camel.component.servicenow.mapper";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_MAPPER_DOC = "Sets Jackson's ObjectMapper to use for request/reply";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_MAPPER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_AUTHORIZATION_POLICY_DOC = "To configure proxy authentication";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_AUTHORIZATION_POLICY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_RETRIEVE_TARGET_RECORD_ON_IMPORT_DOC = "Set this parameter to true to retrieve the target record when using import set api. The import set result is then replaced by the target record";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_RETRIEVE_TARGET_RECORD_ON_IMPORT_DEFAULT = "false";
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_TIME_FORMAT_CONF = "camel.component.servicenow.timeFormat";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_TIME_FORMAT_DOC = "The time format used for Json serialization/deserialization";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_TIME_FORMAT_DEFAULT = "HH:mm:ss";
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_HOST_CONF = "camel.component.servicenow.proxyHost";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_HOST_DOC = "The proxy host name";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_PORT_CONF = "camel.component.servicenow.proxyPort";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_PORT_DOC = "The proxy port number";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_API_URL_CONF = "camel.component.servicenow.apiUrl";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_API_URL_DOC = "The ServiceNow REST API url";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_API_URL_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_OAUTH_CLIENT_ID_CONF = "camel.component.servicenow.oauthClientId";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_OAUTH_CLIENT_ID_DOC = "OAuth2 ClientID";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_OAUTH_CLIENT_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_OAUTH_CLIENT_SECRET_DOC = "OAuth2 ClientSecret";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_OAUTH_CLIENT_SECRET_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_OAUTH_TOKEN_URL_CONF = "camel.component.servicenow.oauthTokenUrl";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_OAUTH_TOKEN_URL_DOC = "OAuth token Url";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_OAUTH_TOKEN_URL_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_PASSWORD_CONF = "camel.component.servicenow.password";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PASSWORD_DOC = "ServiceNow account password, MUST be provided";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_PASSWORD_CONF = "camel.component.servicenow.proxyPassword";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_PASSWORD_DOC = "Password for proxy authentication";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_USER_NAME_CONF = "camel.component.servicenow.proxyUserName";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_USER_NAME_DOC = "Username for proxy authentication";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_PROXY_USER_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters. See http://camel.apache.org/camel-configuration-utilities.html";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SINK_SERVICENOW_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
    public static final String CAMEL_SINK_SERVICENOW_COMPONENT_USER_NAME_CONF = "camel.component.servicenow.userName";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_USER_NAME_DOC = "ServiceNow user account name, MUST be provided";
    private static final String CAMEL_SINK_SERVICENOW_COMPONENT_USER_NAME_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_SERVICENOW_ENDPOINT_SYNCHRONOUS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_SERVICENOW_ENDPOINT_SYNCHRONOUS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SERVICENOW_ENDPOINT_SYNCHRONOUS_DOC);
        ...
        conf.define(CAMEL_SINK_SERVICENOW_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_SERVICENOW_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SERVICENOW_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
