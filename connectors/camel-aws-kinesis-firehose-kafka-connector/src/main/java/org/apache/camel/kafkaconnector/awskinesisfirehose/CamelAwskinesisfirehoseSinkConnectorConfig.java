...
public class CamelAwskinesisfirehoseSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_AWSKINESISFIREHOSE_COMPONENT_REGION_DOC = "Amazon AWS Region";
    ...
    public static final String CAMEL_SINK_AWSKINESISFIREHOSE_COMPONENT_CONFIGURATION_DOC = "The AWS Kinesis Firehose default configuration";
