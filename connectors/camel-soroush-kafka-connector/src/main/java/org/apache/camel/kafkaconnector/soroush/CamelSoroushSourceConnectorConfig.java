...
public class CamelSoroushSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_SOROUSH_PATH_ACTION_DOC = "The action to do. One of: [sendMessage] [getMessage] [uploadFile] [downloadFile]";
    private static final String CAMEL_SOURCE_SOROUSH_PATH_ACTION_DEFAULT = null;
    public static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_CONNECTION_TIMEOUT_CONF = "camel.source.endpoint.connectionTimeout";
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_CONNECTION_TIMEOUT_DOC = "Connection timeout in ms when connecting to soroush API";
    private static final Integer CAMEL_SOURCE_SOROUSH_ENDPOINT_CONNECTION_TIMEOUT_DEFAULT = 30000;
    ...
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_MAX_CONNECTION_RETRY_DOC = "Maximum connection retry when fail to connect to soroush API, if the quota is reached, MaximumConnectionRetryReachedException is thrown for that message.";
    private static final Integer CAMEL_SOURCE_SOROUSH_ENDPOINT_MAX_CONNECTION_RETRY_DEFAULT = 4;
    ...
    private static final Boolean CAMEL_SOURCE_SOROUSH_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final Integer CAMEL_SOURCE_SOROUSH_ENDPOINT_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final Integer CAMEL_SOURCE_SOROUSH_ENDPOINT_QUEUE_CAPACITY_PER_THREAD_DEFAULT = 0;
    ...
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    public static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.source.endpoint.basicPropertyBinding";
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SOROUSH_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_SOROUSH_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_BACK_OFF_STRATEGY_DEFAULT = "Exponential";
    ...
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_MAX_RETRY_WAITING_TIME_DOC = "Maximum amount of time (in millisecond) a thread wait before retrying failed request.";
    private static final Long CAMEL_SOURCE_SOROUSH_ENDPOINT_MAX_RETRY_WAITING_TIME_DEFAULT = 3600000L;
    ...
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_RECONNECT_IDLE_CONNECTION_TIMEOUT_DOC = "The timeout in millisecond to reconnect the existing getMessage connection to ensure that the connection is always live and does not dead without notifying the bot. this value should not be changed.";
    private static final Long CAMEL_SOURCE_SOROUSH_ENDPOINT_RECONNECT_IDLE_CONNECTION_TIMEOUT_DEFAULT = 300000L;
    ...
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_RETRY_EXPONENTIAL_COEFFICIENT_DOC = "Coefficient to compute back off time when using Exponential Back Off strategy";
    private static final Long CAMEL_SOURCE_SOROUSH_ENDPOINT_RETRY_EXPONENTIAL_COEFFICIENT_DEFAULT = 2L;
    ...
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_RETRY_LINEAR_INCREMENT_DOC = "The amount of time (in millisecond) which adds to waiting time when using Linear back off strategy";
    private static final Long CAMEL_SOURCE_SOROUSH_ENDPOINT_RETRY_LINEAR_INCREMENT_DEFAULT = 10000L;
    ...
    private static final Long CAMEL_SOURCE_SOROUSH_ENDPOINT_RETRY_WAITING_TIME_DEFAULT = 1000L;
    ...
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_AUTHORIZATION_TOKEN_DOC = "The authorization token for using the bot. if uri path does not contain authorization token, this token will be used.";
    private static final String CAMEL_SOURCE_SOROUSH_ENDPOINT_AUTHORIZATION_TOKEN_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_SOROUSH_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_SOROUSH_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.soroush.basicPropertyBinding";
    private static final String CAMEL_SOURCE_SOROUSH_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SOROUSH_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SOROUSH_COMPONENT_AUTHORIZATION_TOKEN_DOC = "The default Soroush authorization token to be used when the information is not provided in the endpoints.";
    private static final String CAMEL_SOURCE_SOROUSH_COMPONENT_AUTHORIZATION_TOKEN_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_SOROUSH_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_SOROUSH_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SOROUSH_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
        ...
        conf.define(CAMEL_SOURCE_SOROUSH_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_SOROUSH_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SOROUSH_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
