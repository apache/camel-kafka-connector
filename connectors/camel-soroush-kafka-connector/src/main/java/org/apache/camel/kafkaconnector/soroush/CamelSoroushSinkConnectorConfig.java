...
public class CamelSoroushSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_SOROUSH_PATH_ACTION_DOC = "The action to do. One of: [sendMessage] [getMessage] [uploadFile] [downloadFile]";
    private static final String CAMEL_SINK_SOROUSH_PATH_ACTION_DEFAULT = null;
    public static final String CAMEL_SINK_SOROUSH_ENDPOINT_CONNECTION_TIMEOUT_CONF = "camel.sink.endpoint.connectionTimeout";
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_CONNECTION_TIMEOUT_DOC = "Connection timeout in ms when connecting to soroush API";
    private static final Integer CAMEL_SINK_SOROUSH_ENDPOINT_CONNECTION_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SINK_SOROUSH_ENDPOINT_MAX_CONNECTION_RETRY_CONF = "camel.sink.endpoint.maxConnectionRetry";
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_MAX_CONNECTION_RETRY_DOC = "Maximum connection retry when fail to connect to soroush API, if the quota is reached, MaximumConnectionRetryReachedException is thrown for that message.";
    private static final Integer CAMEL_SINK_SOROUSH_ENDPOINT_MAX_CONNECTION_RETRY_DEFAULT = 4;
    public static final String CAMEL_SINK_SOROUSH_ENDPOINT_AUTO_DOWNLOAD_CONF = "camel.sink.endpoint.autoDownload";
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_AUTO_DOWNLOAD_DOC = "Automatically download SoroushMessage.fileUrl and SoroushMessage.thumbnailUrl if exists for the message and store them in SoroushMessage.file and SoroushMessage.thumbnail field";
    private static final Boolean CAMEL_SINK_SOROUSH_ENDPOINT_AUTO_DOWNLOAD_DEFAULT = false;
    public static final String CAMEL_SINK_SOROUSH_ENDPOINT_AUTO_UPLOAD_FILE_CONF = "camel.sink.endpoint.autoUploadFile";
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_AUTO_UPLOAD_FILE_DOC = "Automatically upload attachments when a message goes to the sendMessage endpoint and the SoroushMessage.file (SoroushMessage.thumbnail) has been set and SoroushMessage.fileUrl(SoroushMessage.thumbnailUrl) is null";
    private static final Boolean CAMEL_SINK_SOROUSH_ENDPOINT_AUTO_UPLOAD_FILE_DEFAULT = true;
    public static final String CAMEL_SINK_SOROUSH_ENDPOINT_DOWNLOAD_THUMBNAIL_CONF = "camel.sink.endpoint.downloadThumbnail";
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_DOWNLOAD_THUMBNAIL_DOC = "If true, when downloading an attached file, thumbnail will be downloaded if provided in the message. Otherwise, only the file will be downloaded";
    private static final Boolean CAMEL_SINK_SOROUSH_ENDPOINT_DOWNLOAD_THUMBNAIL_DEFAULT = true;
    public static final String CAMEL_SINK_SOROUSH_ENDPOINT_FORCE_DOWNLOAD_CONF = "camel.sink.endpoint.forceDownload";
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_FORCE_DOWNLOAD_DOC = "Force to download SoroushMessage.fileUrl(SoroushMessage.thumbnailUrl) if exists, even if the SoroushMessage.file(SoroushMessage.thumbnail) was not null in that message";
    private static final Boolean CAMEL_SINK_SOROUSH_ENDPOINT_FORCE_DOWNLOAD_DEFAULT = false;
    public static final String CAMEL_SINK_SOROUSH_ENDPOINT_FORCE_UPLOAD_CONF = "camel.sink.endpoint.forceUpload";
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_FORCE_UPLOAD_DOC = "Force to upload SoroushMessage.file(SoroushMessage.thumbnail) if exists, even if the SoroushMessage.fileUrl(SoroushMessage.thumbnailUrl) is not null in the message";
    private static final Boolean CAMEL_SINK_SOROUSH_ENDPOINT_FORCE_UPLOAD_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SOROUSH_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SOROUSH_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SOROUSH_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_SOROUSH_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_BACK_OFF_STRATEGY_DEFAULT = "Exponential";
    ...
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_MAX_RETRY_WAITING_TIME_DOC = "Maximum amount of time (in millisecond) a thread wait before retrying failed request.";
    private static final Long CAMEL_SINK_SOROUSH_ENDPOINT_MAX_RETRY_WAITING_TIME_DEFAULT = 3600000L;
    ...
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_RECONNECT_IDLE_CONNECTION_TIMEOUT_DOC = "The timeout in millisecond to reconnect the existing getMessage connection to ensure that the connection is always live and does not dead without notifying the bot. this value should not be changed.";
    private static final Long CAMEL_SINK_SOROUSH_ENDPOINT_RECONNECT_IDLE_CONNECTION_TIMEOUT_DEFAULT = 300000L;
    ...
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_RETRY_EXPONENTIAL_COEFFICIENT_DOC = "Coefficient to compute back off time when using Exponential Back Off strategy";
    private static final Long CAMEL_SINK_SOROUSH_ENDPOINT_RETRY_EXPONENTIAL_COEFFICIENT_DEFAULT = 2L;
    ...
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_RETRY_LINEAR_INCREMENT_DOC = "The amount of time (in millisecond) which adds to waiting time when using Linear back off strategy";
    private static final Long CAMEL_SINK_SOROUSH_ENDPOINT_RETRY_LINEAR_INCREMENT_DEFAULT = 10000L;
    ...
    private static final Long CAMEL_SINK_SOROUSH_ENDPOINT_RETRY_WAITING_TIME_DEFAULT = 1000L;
    public static final String CAMEL_SINK_SOROUSH_ENDPOINT_AUTHORIZATION_TOKEN_CONF = "camel.sink.endpoint.authorizationToken";
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_AUTHORIZATION_TOKEN_DOC = "The authorization token for using the bot. if uri path does not contain authorization token, this token will be used.";
    private static final String CAMEL_SINK_SOROUSH_ENDPOINT_AUTHORIZATION_TOKEN_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SOROUSH_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SOROUSH_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SOROUSH_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SOROUSH_COMPONENT_AUTHORIZATION_TOKEN_DOC = "The default Soroush authorization token to be used when the information is not provided in the endpoints.";
    private static final String CAMEL_SINK_SOROUSH_COMPONENT_AUTHORIZATION_TOKEN_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_SOROUSH_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_SOROUSH_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SOROUSH_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
