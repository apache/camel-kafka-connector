...
public class CamelReactivestreamsSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_PATH_STREAM_DOC = "Name of the stream channel used by the endpoint to exchange messages.";
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_PATH_STREAM_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_CONCURRENT_CONSUMERS_DOC = "Number of threads used to process exchanges in the Camel route.";
    private static final Integer CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final Double CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_EXCHANGES_REFILL_LOW_WATERMARK_DEFAULT = 0.25D;
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_FORWARD_ON_COMPLETE_DOC = "Determines if onComplete events should be pushed to the Camel route.";
    private static final Boolean CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_FORWARD_ON_COMPLETE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_FORWARD_ON_ERROR_DOC = "Determines if onError events should be pushed to the Camel route. Exceptions will be set as message body.";
    private static final Boolean CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_FORWARD_ON_ERROR_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_MAX_INFLIGHT_EXCHANGES_DOC = "Maximum number of exchanges concurrently being processed by Camel. This parameter controls backpressure on the stream. Setting a non-positive value will disable backpressure.";
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_MAX_INFLIGHT_EXCHANGES_DEFAULT = "128";
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_REACTIVESTREAMS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_THREAD_POOL_MAX_SIZE_DOC = "The maximum number of threads used by the reactive streams internal engine.";
    private static final Integer CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_THREAD_POOL_MAX_SIZE_DEFAULT = 10;
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_THREAD_POOL_MIN_SIZE_DOC = "The minimum number of threads used by the reactive streams internal engine.";
    private static final Integer CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_THREAD_POOL_MIN_SIZE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_THREAD_POOL_NAME_DOC = "The name of the thread pool used by the reactive streams internal engine.";
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_THREAD_POOL_NAME_DEFAULT = "CamelReactiveStreamsWorker";
    ...
    private static final Boolean CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_REACTIVE_STREAMS_ENGINE_CONFIGURATION_DOC = "To use an existing reactive stream engine configuration.";
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_REACTIVE_STREAMS_ENGINE_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_SERVICE_TYPE_DOC = "Set the type of the underlying reactive streams implementation to use. The implementation is looked up from the registry or using a ServiceLoader, the default implementation is DefaultCamelReactiveStreamsService";
    private static final String CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_SERVICE_TYPE_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_REACTIVESTREAMS_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
