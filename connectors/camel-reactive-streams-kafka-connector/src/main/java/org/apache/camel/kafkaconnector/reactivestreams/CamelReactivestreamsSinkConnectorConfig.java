...
public class CamelReactivestreamsSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_REACTIVESTREAMS_PATH_STREAM_DOC = "Name of the stream channel used by the endpoint to exchange messages.";
    private static final String CAMEL_SINK_REACTIVESTREAMS_PATH_STREAM_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_REACTIVESTREAMS_ENDPOINT_BACKPRESSURE_STRATEGY_DOC = "The backpressure strategy to use when pushing events to a slow subscriber. One of: [BUFFER] [OLDEST] [LATEST]";
    private static final String CAMEL_SINK_REACTIVESTREAMS_ENDPOINT_BACKPRESSURE_STRATEGY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_REACTIVESTREAMS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_REACTIVESTREAMS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_REACTIVESTREAMS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_REACTIVESTREAMS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_REACTIVESTREAMS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_REACTIVESTREAMS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_REACTIVESTREAMS_COMPONENT_THREAD_POOL_MAX_SIZE_DOC = "The maximum number of threads used by the reactive streams internal engine.";
    private static final Integer CAMEL_SINK_REACTIVESTREAMS_COMPONENT_THREAD_POOL_MAX_SIZE_DEFAULT = 10;
    ...
    private static final String CAMEL_SINK_REACTIVESTREAMS_COMPONENT_THREAD_POOL_MIN_SIZE_DOC = "The minimum number of threads used by the reactive streams internal engine.";
    private static final Integer CAMEL_SINK_REACTIVESTREAMS_COMPONENT_THREAD_POOL_MIN_SIZE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_REACTIVESTREAMS_COMPONENT_THREAD_POOL_NAME_DOC = "The name of the thread pool used by the reactive streams internal engine.";
    private static final String CAMEL_SINK_REACTIVESTREAMS_COMPONENT_THREAD_POOL_NAME_DEFAULT = "CamelReactiveStreamsWorker";
    ...
    private static final String CAMEL_SINK_REACTIVESTREAMS_COMPONENT_BACKPRESSURE_STRATEGY_DOC = "The backpressure strategy to use when pushing events to a slow subscriber. One of: [BUFFER] [OLDEST] [LATEST]";
    private static final String CAMEL_SINK_REACTIVESTREAMS_COMPONENT_BACKPRESSURE_STRATEGY_DEFAULT = "BUFFER";
    ...
    private static final Boolean CAMEL_SINK_REACTIVESTREAMS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_REACTIVESTREAMS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_REACTIVESTREAMS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_REACTIVESTREAMS_COMPONENT_REACTIVE_STREAMS_ENGINE_CONFIGURATION_DOC = "To use an existing reactive stream engine configuration.";
    private static final String CAMEL_SINK_REACTIVESTREAMS_COMPONENT_REACTIVE_STREAMS_ENGINE_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_REACTIVESTREAMS_COMPONENT_SERVICE_TYPE_DOC = "Set the type of the underlying reactive streams implementation to use. The implementation is looked up from the registry or using a ServiceLoader, the default implementation is DefaultCamelReactiveStreamsService";
    private static final String CAMEL_SINK_REACTIVESTREAMS_COMPONENT_SERVICE_TYPE_DEFAULT = null;
