...
public class CamelKafkabatchazureschemaregistrysourceSourceTask
        extends
            CamelSourceTask {
    ...
    protected CamelSourceConnectorConfig getCamelSourceConnectorConfig(
        ...
        return new CamelKafkabatchazureschemaregistrysourceSourceConnectorConfig(props);
    }
    @Override
    protected String getSourceKamelet() {
        return "kamelet:kafka-batch-azure-schema-registry-source";
    }
}