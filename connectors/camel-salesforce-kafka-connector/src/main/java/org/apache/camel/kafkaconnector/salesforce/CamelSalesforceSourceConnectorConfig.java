...
public class CamelSalesforceSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_SALESFORCE_ENDPOINT_API_VERSION_DOC = "Salesforce API version, defaults to SalesforceEndpointConfig.DEFAULT_VERSION";
    public static final String CAMEL_SOURCE_SALESFORCE_ENDPOINT_API_VERSION_DEFAULT = null;
    ...
    public static final Long CAMEL_SOURCE_SALESFORCE_ENDPOINT_BACKOFF_INCREMENT_DEFAULT = null;
    ...
    public static final Long CAMEL_SOURCE_SALESFORCE_ENDPOINT_MAX_BACKOFF_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_SALESFORCE_ENDPOINT_NOT_FOUND_BEHAVIOUR_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_SALESFORCE_COMPONENT_IS_HTTP_PROXY_SOCKS_4CONF = "camel.component.salesforce.isHttpProxySocks4";
    public static final String CAMEL_SOURCE_SALESFORCE_COMPONENT_IS_HTTP_PROXY_SOCKS_4DOC = "If set to true the configures the HTTP proxy to use as a SOCKS4 proxy.";
    public static final Boolean CAMEL_SOURCE_SALESFORCE_COMPONENT_IS_HTTP_PROXY_SOCKS_4DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_SALESFORCE_COMPONENT_IS_HTTP_PROXY_SECURE_CONF = "camel.component.salesforce.isHttpProxySecure";
    public static final String CAMEL_SOURCE_SALESFORCE_COMPONENT_IS_HTTP_PROXY_SECURE_DOC = "If set to false disables the use of TLS when accessing the HTTP proxy.";
    public static final Boolean CAMEL_SOURCE_SALESFORCE_COMPONENT_IS_HTTP_PROXY_SECURE_DEFAULT = true;
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SOURCE_SALESFORCE_COMPONENT_IS_HTTP_PROXY_SOCKS_4CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_SALESFORCE_COMPONENT_IS_HTTP_PROXY_SOCKS_4DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SALESFORCE_COMPONENT_IS_HTTP_PROXY_SOCKS_4DOC);
        ...
        conf.define(CAMEL_SOURCE_SALESFORCE_COMPONENT_IS_HTTP_PROXY_SECURE_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_SALESFORCE_COMPONENT_IS_HTTP_PROXY_SECURE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SALESFORCE_COMPONENT_IS_HTTP_PROXY_SECURE_DOC);
