...
The camel-salesforce sink connector supports 112 options, which are listed below.
...
| *camel.sink.endpoint.defaultReplayId* | Default replayId setting if no value is found in initialReplayIdMap | null | false | MEDIUM
