...
public class CamelAtomixvalueSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_PATH_RESOURCE_NAME_DOC = "The distributed resource name";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_PATH_RESOURCE_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_ATOMIX_CONF = "camel.source.endpoint.atomix";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_ATOMIX_DOC = "The Atomix instance to use";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_ATOMIX_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_CONFIGURATION_URI_DOC = "The Atomix configuration uri.";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_CONFIGURATION_URI_DEFAULT = null;
    public static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_DEFAULT_ACTION_CONF = "camel.source.endpoint.defaultAction";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_DEFAULT_ACTION_DOC = "The default action. One of: [SET] [GET] [GET_AND_SET] [COMPARE_AND_SET]";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_DEFAULT_ACTION_DEFAULT = "SET";
    public static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_NODES_CONF = "camel.source.endpoint.nodes";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_NODES_DOC = "The address of the nodes composing the cluster.";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_NODES_DEFAULT = null;
    public static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_RESULT_HEADER_CONF = "camel.source.endpoint.resultHeader";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_RESULT_HEADER_DOC = "The header that wil carry the result.";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_RESULT_HEADER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_TRANSPORT_CLASS_NAME_DOC = "The class name (fqn) of the Atomix transport";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_TRANSPORT_CLASS_NAME_DEFAULT = "io.atomix.catalyst.transport.netty.NettyTransport";
    public static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_TTL_CONF = "camel.source.endpoint.ttl";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_TTL_DOC = "The resource ttl.";
    private static final Long CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_TTL_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_DEFAULT_RESOURCE_CONFIG_DOC = "The cluster wide default resource configuration.";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_DEFAULT_RESOURCE_CONFIG_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_DEFAULT_RESOURCE_OPTIONS_DOC = "The local default resource options.";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_DEFAULT_RESOURCE_OPTIONS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_EPHEMERAL_CONF = "camel.source.endpoint.ephemeral";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_EPHEMERAL_DOC = "Sets if the local member should join groups as PersistentMember or not. If set to ephemeral the local member will receive an auto generated ID thus the local one is ignored.";
    private static final Boolean CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_EPHEMERAL_DEFAULT = false;
    public static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_READ_CONSISTENCY_CONF = "camel.source.endpoint.readConsistency";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_READ_CONSISTENCY_DOC = "The read consistency level. One of: [ATOMIC] [ATOMIC_LEASE] [SEQUENTIAL] [LOCAL]";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_READ_CONSISTENCY_DEFAULT = null;
    public static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_RESOURCE_CONFIGS_CONF = "camel.source.endpoint.resourceConfigs";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_RESOURCE_CONFIGS_DOC = "Cluster wide resources configuration.";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_RESOURCE_CONFIGS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_RESOURCE_OPTIONS_CONF = "camel.source.endpoint.resourceOptions";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_RESOURCE_OPTIONS_DOC = "Local resources configurations";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_RESOURCE_OPTIONS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_ATOMIX_CONF = "camel.component.atomix-value.atomix";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_ATOMIX_DOC = "The Atomix instance to use";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_ATOMIX_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_CONFIGURATION_DOC = "The shared component configuration";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_CONFIGURATION_URI_DOC = "The path to the AtomixClient configuration";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_CONFIGURATION_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_DEFAULT_ACTION_DOC = "The default action. One of: [SET] [GET] [GET_AND_SET] [COMPARE_AND_SET]";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_DEFAULT_ACTION_DEFAULT = "SET";
    public static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_NODES_CONF = "camel.component.atomix-value.nodes";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_NODES_DOC = "The nodes the AtomixClient should connect to";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_NODES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_RESULT_HEADER_DOC = "The header that wil carry the result.";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_RESULT_HEADER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_TRANSPORT_CLASS_NAME_DOC = "The class name (fqn) of the Atomix transport";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_TRANSPORT_CLASS_NAME_DEFAULT = "io.atomix.catalyst.transport.netty.NettyTransport";
    public static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_TTL_CONF = "camel.component.atomix-value.ttl";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_TTL_DOC = "The resource ttl.";
    private static final Long CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_TTL_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_DEFAULT_RESOURCE_CONFIG_DOC = "The cluster wide default resource configuration.";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_DEFAULT_RESOURCE_CONFIG_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_DEFAULT_RESOURCE_OPTIONS_DOC = "The local default resource options.";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_DEFAULT_RESOURCE_OPTIONS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_EPHEMERAL_CONF = "camel.component.atomix-value.ephemeral";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_EPHEMERAL_DOC = "Sets if the local member should join groups as PersistentMember or not. If set to ephemeral the local member will receive an auto generated ID thus the local one is ignored.";
    private static final Boolean CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_EPHEMERAL_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_READ_CONSISTENCY_DOC = "The read consistency level. One of: [ATOMIC] [ATOMIC_LEASE] [SEQUENTIAL] [LOCAL]";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_READ_CONSISTENCY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_RESOURCE_CONFIGS_DOC = "Cluster wide resources configuration.";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_RESOURCE_CONFIGS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_RESOURCE_OPTIONS_DOC = "Local resources configurations";
    private static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_RESOURCE_OPTIONS_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_SYNCHRONOUS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_SYNCHRONOUS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_SYNCHRONOUS_DOC);
