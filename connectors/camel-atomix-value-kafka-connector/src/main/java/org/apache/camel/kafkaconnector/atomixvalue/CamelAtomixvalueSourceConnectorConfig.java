...
public class CamelAtomixvalueSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    public static final Boolean CAMEL_SOURCE_ATOMIXVALUE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_ATOMIX_CONF = "camel.component.atomix-value.atomix";
    public static final String CAMEL_SOURCE_ATOMIXVALUE_COMPONENT_ATOMIX_DOC = "The shared AtomixClient instance";
