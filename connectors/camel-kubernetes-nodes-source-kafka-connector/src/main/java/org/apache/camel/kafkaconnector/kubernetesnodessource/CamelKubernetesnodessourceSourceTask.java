...
public class CamelKubernetesnodessourceSourceTask extends CamelSourceTask {

    @Override
    protected CamelSourceConnectorConfig getCamelSourceConnectorConfig(
            Map<String, String> props) {
        return new CamelKubernetesnodessourceSourceConnectorConfig(props);
    }
    @Override
    protected String getSourceKamelet() {
        return "kamelet:kubernetes-nodes-source";
    }
}