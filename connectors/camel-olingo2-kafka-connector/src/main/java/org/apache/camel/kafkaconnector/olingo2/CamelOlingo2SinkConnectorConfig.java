...
public class CamelOlingo2SinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_OLINGO2_PATH_API_NAME_DOC = "What kind of operation to perform One of: [DEFAULT]";
    private static final String CAMEL_SINK_OLINGO2_PATH_API_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_OLINGO2_PATH_METHOD_NAME_CONF = "camel.sink.path.methodName";
    private static final String CAMEL_SINK_OLINGO2_PATH_METHOD_NAME_DOC = "What sub operation to use for the selected operation";
    private static final String CAMEL_SINK_OLINGO2_PATH_METHOD_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_OLINGO2_ENDPOINT_CONNECT_TIMEOUT_CONF = "camel.sink.endpoint.connectTimeout";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_CONNECT_TIMEOUT_DOC = "HTTP connection creation timeout in milliseconds, defaults to 30,000 (30 seconds)";
    private static final Integer CAMEL_SINK_OLINGO2_ENDPOINT_CONNECT_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SINK_OLINGO2_ENDPOINT_CONTENT_TYPE_CONF = "camel.sink.endpoint.contentType";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_CONTENT_TYPE_DOC = "Content-Type header value can be used to specify JSON or XML message format, defaults to application/json;charset=utf-8";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_CONTENT_TYPE_DEFAULT = "application/json;charset=utf-8";
    public static final String CAMEL_SINK_OLINGO2_ENDPOINT_FILTER_ALREADY_SEEN_CONF = "camel.sink.endpoint.filterAlreadySeen";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_FILTER_ALREADY_SEEN_DOC = "Set this to true to filter out results that have already been communicated by this component.";
    private static final Boolean CAMEL_SINK_OLINGO2_ENDPOINT_FILTER_ALREADY_SEEN_DEFAULT = false;
    public static final String CAMEL_SINK_OLINGO2_ENDPOINT_HTTP_HEADERS_CONF = "camel.sink.endpoint.httpHeaders";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_HTTP_HEADERS_DOC = "Custom HTTP headers to inject into every request, this could include OAuth tokens, etc.";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_HTTP_HEADERS_DEFAULT = null;
    public static final String CAMEL_SINK_OLINGO2_ENDPOINT_IN_BODY_CONF = "camel.sink.endpoint.inBody";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_IN_BODY_DOC = "Sets the name of a parameter to be passed in the exchange In Body";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_IN_BODY_DEFAULT = null;
    public static final String CAMEL_SINK_OLINGO2_ENDPOINT_PROXY_CONF = "camel.sink.endpoint.proxy";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_PROXY_DOC = "HTTP proxy server configuration";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_PROXY_DEFAULT = null;
    public static final String CAMEL_SINK_OLINGO2_ENDPOINT_SERVICE_URI_CONF = "camel.sink.endpoint.serviceUri";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_SERVICE_URI_DOC = "Target OData service base URI, e.g. http://services.odata.org/OData/OData.svc";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_SERVICE_URI_DEFAULT = null;
    public static final String CAMEL_SINK_OLINGO2_ENDPOINT_SOCKET_TIMEOUT_CONF = "camel.sink.endpoint.socketTimeout";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_SOCKET_TIMEOUT_DOC = "HTTP request timeout in milliseconds, defaults to 30,000 (30 seconds)";
    private static final Integer CAMEL_SINK_OLINGO2_ENDPOINT_SOCKET_TIMEOUT_DEFAULT = 30000;
    ...
    private static final Boolean CAMEL_SINK_OLINGO2_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_OLINGO2_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_HTTP_ASYNC_CLIENT_BUILDER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_HTTP_CLIENT_BUILDER_DEFAULT = null;
    public static final String CAMEL_SINK_OLINGO2_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_OLINGO2_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    private static final String CAMEL_SINK_OLINGO2_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_OLINGO2_COMPONENT_CONFIGURATION_CONF = "camel.component.olingo2.configuration";
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_CONFIGURATION_DOC = "To use the shared configuration";
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_OLINGO2_COMPONENT_CONNECT_TIMEOUT_CONF = "camel.component.olingo2.connectTimeout";
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_CONNECT_TIMEOUT_DOC = "HTTP connection creation timeout in milliseconds, defaults to 30,000 (30 seconds)";
    private static final Integer CAMEL_SINK_OLINGO2_COMPONENT_CONNECT_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SINK_OLINGO2_COMPONENT_CONTENT_TYPE_CONF = "camel.component.olingo2.contentType";
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_CONTENT_TYPE_DOC = "Content-Type header value can be used to specify JSON or XML message format, defaults to application/json;charset=utf-8";
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_CONTENT_TYPE_DEFAULT = "application/json;charset=utf-8";
    ...
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_FILTER_ALREADY_SEEN_DOC = "Set this to true to filter out results that have already been communicated by this component.";
    private static final Boolean CAMEL_SINK_OLINGO2_COMPONENT_FILTER_ALREADY_SEEN_DEFAULT = false;
    public static final String CAMEL_SINK_OLINGO2_COMPONENT_HTTP_HEADERS_CONF = "camel.component.olingo2.httpHeaders";
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_HTTP_HEADERS_DOC = "Custom HTTP headers to inject into every request, this could include OAuth tokens, etc.";
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_HTTP_HEADERS_DEFAULT = null;
    public static final String CAMEL_SINK_OLINGO2_COMPONENT_PROXY_CONF = "camel.component.olingo2.proxy";
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_PROXY_DOC = "HTTP proxy server configuration";
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_PROXY_DEFAULT = null;
    public static final String CAMEL_SINK_OLINGO2_COMPONENT_SERVICE_URI_CONF = "camel.component.olingo2.serviceUri";
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_SERVICE_URI_DOC = "Target OData service base URI, e.g. http://services.odata.org/OData/OData.svc";
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_SERVICE_URI_DEFAULT = null;
    public static final String CAMEL_SINK_OLINGO2_COMPONENT_SOCKET_TIMEOUT_CONF = "camel.component.olingo2.socketTimeout";
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_SOCKET_TIMEOUT_DOC = "HTTP request timeout in milliseconds, defaults to 30,000 (30 seconds)";
    private static final Integer CAMEL_SINK_OLINGO2_COMPONENT_SOCKET_TIMEOUT_DEFAULT = 30000;
    ...
    private static final Boolean CAMEL_SINK_OLINGO2_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_OLINGO2_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_HTTP_ASYNC_CLIENT_BUILDER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_HTTP_CLIENT_BUILDER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_OLINGO2_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SINK_OLINGO2_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
