...
public class CamelOlingo2SourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_OLINGO2_PATH_METHOD_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_CONNECT_TIMEOUT_CONF = "camel.source.endpoint.connectTimeout";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_CONNECT_TIMEOUT_DOC = "HTTP connection creation timeout in milliseconds, defaults to 30,000 (30 seconds)";
    public static final Integer CAMEL_SOURCE_OLINGO2_ENDPOINT_CONNECT_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_CONTENT_TYPE_CONF = "camel.source.endpoint.contentType";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_CONTENT_TYPE_DOC = "Content-Type header value can be used to specify JSON or XML message format, defaults to application/json;charset=utf-8";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_CONTENT_TYPE_DEFAULT = "application/json;charset=utf-8";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_ENTITY_PROVIDER_READ_PROPERTIES_CONF = "camel.source.endpoint.entityProviderReadProperties";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_ENTITY_PROVIDER_READ_PROPERTIES_DOC = "Custom entity provider read properties applied to all read operations.";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_ENTITY_PROVIDER_READ_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_ENTITY_PROVIDER_WRITE_PROPERTIES_CONF = "camel.source.endpoint.entityProviderWriteProperties";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_ENTITY_PROVIDER_WRITE_PROPERTIES_DOC = "Custom entity provider write properties applied to create, update, patch, batch and merge operations. For instance users can skip the Json object wrapper or enable content only mode when sending request data. A service URI set in the properties will always be overwritten by the serviceUri configuration parameter. Please consider to using the serviceUri configuration parameter instead of setting the respective write property here.";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_ENTITY_PROVIDER_WRITE_PROPERTIES_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_FILTER_ALREADY_SEEN_DOC = "Set this to true to filter out results that have already been communicated by this component.";
    public static final Boolean CAMEL_SOURCE_OLINGO2_ENDPOINT_FILTER_ALREADY_SEEN_DEFAULT = false;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_HTTP_HEADERS_CONF = "camel.source.endpoint.httpHeaders";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_HTTP_HEADERS_DOC = "Custom HTTP headers to inject into every request, this could include OAuth tokens, etc.";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_HTTP_HEADERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_IN_BODY_CONF = "camel.source.endpoint.inBody";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_IN_BODY_DOC = "Sets the name of a parameter to be passed in the exchange In Body";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_IN_BODY_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_PROXY_CONF = "camel.source.endpoint.proxy";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_PROXY_DOC = "HTTP proxy server configuration";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_PROXY_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SERVICE_URI_CONF = "camel.source.endpoint.serviceUri";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SERVICE_URI_DOC = "Target OData service base URI, e.g. http://services.odata.org/OData/OData.svc";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SERVICE_URI_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SOCKET_TIMEOUT_CONF = "camel.source.endpoint.socketTimeout";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SOCKET_TIMEOUT_DOC = "HTTP request timeout in milliseconds, defaults to 30,000 (30 seconds)";
    public static final Integer CAMEL_SOURCE_OLINGO2_ENDPOINT_SOCKET_TIMEOUT_DEFAULT = 30000;
    ...
    public static final Boolean CAMEL_SOURCE_OLINGO2_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DOC = "If the polling consumer did not poll any files, you can enable this option to send an empty message (no body) instead.";
    public static final Boolean CAMEL_SOURCE_OLINGO2_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SPLIT_RESULT_CONF = "camel.source.endpoint.splitResult";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SPLIT_RESULT_DOC = "For endpoints that return an array or collection, a consumer endpoint will map every element to distinct messages, unless splitResult is set to false.";
    public static final Boolean CAMEL_SOURCE_OLINGO2_ENDPOINT_SPLIT_RESULT_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_POLL_STRATEGY_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_OLINGO2_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_HTTP_ASYNC_CLIENT_BUILDER_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_HTTP_CLIENT_BUILDER_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    public static final Boolean CAMEL_SOURCE_OLINGO2_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DOC = "The number of subsequent error polls (failed due some error) that should happen before the backoffMultipler should kick-in.";
    public static final Integer CAMEL_SOURCE_OLINGO2_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DOC = "The number of subsequent idle polls that should happen before the backoffMultipler should kick-in.";
    public static final Integer CAMEL_SOURCE_OLINGO2_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DEFAULT = null;
    ...
    public static final Integer CAMEL_SOURCE_OLINGO2_ENDPOINT_BACKOFF_MULTIPLIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll.";
    public static final Long CAMEL_SOURCE_OLINGO2_ENDPOINT_DELAY_DEFAULT = 500L;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_GREEDY_CONF = "camel.source.endpoint.greedy";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_GREEDY_DOC = "If greedy is enabled, then the ScheduledPollConsumer will run immediately again, if the previous run polled 1 or more messages.";
    public static final Boolean CAMEL_SOURCE_OLINGO2_ENDPOINT_GREEDY_DEFAULT = false;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_INITIAL_DELAY_CONF = "camel.source.endpoint.initialDelay";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts.";
    public static final Long CAMEL_SOURCE_OLINGO2_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_REPEAT_COUNT_CONF = "camel.source.endpoint.repeatCount";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_REPEAT_COUNT_DOC = "Specifies a maximum limit of number of fires. So if you set it to 1, the scheduler will only fire once. If you set it to 5, it will only fire five times. A value of zero or negative means fire forever.";
    public static final Long CAMEL_SOURCE_OLINGO2_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_RUN_LOGGING_LEVEL_CONF = "camel.source.endpoint.runLoggingLevel";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_RUN_LOGGING_LEVEL_DOC = "The consumer logs a start/complete log line when it polls. This option allows you to configure the logging level for that. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_RUN_LOGGING_LEVEL_DEFAULT = "TRACE";
    ...
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DOC = "Allows for configuring a custom/shared thread pool to use for the consumer. By default each consumer has its own single threaded thread pool.";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SCHEDULER_CONF = "camel.source.endpoint.scheduler";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component. Use value spring or quartz for built in scheduler";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SCHEDULER_DEFAULT = "none";
    ...
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SCHEDULER_PROPERTIES_DOC = "To configure additional properties when using a custom scheduler or any of the Quartz, Spring based scheduler.";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SCHEDULER_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_START_SCHEDULER_CONF = "camel.source.endpoint.startScheduler";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_START_SCHEDULER_DOC = "Whether the scheduler should be auto started.";
    public static final Boolean CAMEL_SOURCE_OLINGO2_ENDPOINT_START_SCHEDULER_DEFAULT = true;
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_TIME_UNIT_CONF = "camel.source.endpoint.timeUnit";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_TIME_UNIT_DOC = "Time unit for initialDelay and delay options. One of: [NANOSECONDS] [MICROSECONDS] [MILLISECONDS] [SECONDS] [MINUTES] [HOURS] [DAYS]";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_TIME_UNIT_DEFAULT = "MILLISECONDS";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_USE_FIXED_DELAY_CONF = "camel.source.endpoint.useFixedDelay";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_USE_FIXED_DELAY_DOC = "Controls if fixed delay or fixed rate is used. See ScheduledExecutorService in JDK for details.";
    public static final Boolean CAMEL_SOURCE_OLINGO2_ENDPOINT_USE_FIXED_DELAY_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    public static final String CAMEL_SOURCE_OLINGO2_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_CONFIGURATION_CONF = "camel.component.olingo2.configuration";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_CONFIGURATION_DOC = "To use the shared configuration";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_CONNECT_TIMEOUT_CONF = "camel.component.olingo2.connectTimeout";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_CONNECT_TIMEOUT_DOC = "HTTP connection creation timeout in milliseconds, defaults to 30,000 (30 seconds)";
    public static final Integer CAMEL_SOURCE_OLINGO2_COMPONENT_CONNECT_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_CONTENT_TYPE_CONF = "camel.component.olingo2.contentType";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_CONTENT_TYPE_DOC = "Content-Type header value can be used to specify JSON or XML message format, defaults to application/json;charset=utf-8";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_CONTENT_TYPE_DEFAULT = "application/json;charset=utf-8";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_ENTITY_PROVIDER_READ_PROPERTIES_CONF = "camel.component.olingo2.entityProviderReadProperties";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_ENTITY_PROVIDER_READ_PROPERTIES_DOC = "Custom entity provider read properties applied to all read operations.";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_ENTITY_PROVIDER_READ_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_ENTITY_PROVIDER_WRITE_PROPERTIES_CONF = "camel.component.olingo2.entityProviderWriteProperties";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_ENTITY_PROVIDER_WRITE_PROPERTIES_DOC = "Custom entity provider write properties applied to create, update, patch, batch and merge operations. For instance users can skip the Json object wrapper or enable content only mode when sending request data. A service URI set in the properties will always be overwritten by the serviceUri configuration parameter. Please consider to using the serviceUri configuration parameter instead of setting the respective write property here.";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_ENTITY_PROVIDER_WRITE_PROPERTIES_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_FILTER_ALREADY_SEEN_DOC = "Set this to true to filter out results that have already been communicated by this component.";
    public static final Boolean CAMEL_SOURCE_OLINGO2_COMPONENT_FILTER_ALREADY_SEEN_DEFAULT = false;
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_HTTP_HEADERS_CONF = "camel.component.olingo2.httpHeaders";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_HTTP_HEADERS_DOC = "Custom HTTP headers to inject into every request, this could include OAuth tokens, etc.";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_HTTP_HEADERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_PROXY_CONF = "camel.component.olingo2.proxy";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_PROXY_DOC = "HTTP proxy server configuration";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_PROXY_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_SERVICE_URI_CONF = "camel.component.olingo2.serviceUri";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_SERVICE_URI_DOC = "Target OData service base URI, e.g. http://services.odata.org/OData/OData.svc";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_SERVICE_URI_DEFAULT = null;
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_SOCKET_TIMEOUT_CONF = "camel.component.olingo2.socketTimeout";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_SOCKET_TIMEOUT_DOC = "HTTP request timeout in milliseconds, defaults to 30,000 (30 seconds)";
    public static final Integer CAMEL_SOURCE_OLINGO2_COMPONENT_SOCKET_TIMEOUT_DEFAULT = 30000;
    ...
    public static final Boolean CAMEL_SOURCE_OLINGO2_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_SPLIT_RESULT_CONF = "camel.component.olingo2.splitResult";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_SPLIT_RESULT_DOC = "For endpoints that return an array or collection, a consumer endpoint will map every element to distinct messages, unless splitResult is set to false.";
    public static final Boolean CAMEL_SOURCE_OLINGO2_COMPONENT_SPLIT_RESULT_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_OLINGO2_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_HTTP_ASYNC_CLIENT_BUILDER_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_HTTP_CLIENT_BUILDER_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_OLINGO2_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    public static final Boolean CAMEL_SOURCE_OLINGO2_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_OLINGO2_ENDPOINT_ENTITY_PROVIDER_READ_PROPERTIES_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_OLINGO2_ENDPOINT_ENTITY_PROVIDER_READ_PROPERTIES_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_OLINGO2_ENDPOINT_ENTITY_PROVIDER_READ_PROPERTIES_DOC);
        conf.define(CAMEL_SOURCE_OLINGO2_ENDPOINT_ENTITY_PROVIDER_WRITE_PROPERTIES_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_OLINGO2_ENDPOINT_ENTITY_PROVIDER_WRITE_PROPERTIES_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_OLINGO2_ENDPOINT_ENTITY_PROVIDER_WRITE_PROPERTIES_DOC);
        ...
        conf.define(CAMEL_SOURCE_OLINGO2_COMPONENT_ENTITY_PROVIDER_READ_PROPERTIES_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_OLINGO2_COMPONENT_ENTITY_PROVIDER_READ_PROPERTIES_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_OLINGO2_COMPONENT_ENTITY_PROVIDER_READ_PROPERTIES_DOC);
        conf.define(CAMEL_SOURCE_OLINGO2_COMPONENT_ENTITY_PROVIDER_WRITE_PROPERTIES_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_OLINGO2_COMPONENT_ENTITY_PROVIDER_WRITE_PROPERTIES_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_OLINGO2_COMPONENT_ENTITY_PROVIDER_WRITE_PROPERTIES_DOC);
        ...
        conf.define(CAMEL_SOURCE_OLINGO2_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_OLINGO2_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SOURCE_OLINGO2_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
