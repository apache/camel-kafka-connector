...
public class CamelSpringwsSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_SPRINGWS_PATH_WEB_SERVICE_ENDPOINT_URI_DOC = "The default Web Service endpoint uri to use for the producer.";
    private static final String CAMEL_SINK_SPRINGWS_PATH_WEB_SERVICE_ENDPOINT_URI_DEFAULT = null;
    public static final String CAMEL_SINK_SPRINGWS_ENDPOINT_MESSAGE_FILTER_CONF = "camel.sink.endpoint.messageFilter";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_MESSAGE_FILTER_DOC = "Option to provide a custom MessageFilter. For example when you want to process your headers or attachments by your own.";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_MESSAGE_FILTER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SPRINGWS_ENDPOINT_ALLOW_RESPONSE_ATTACHMENT_OVERRIDE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SPRINGWS_ENDPOINT_ALLOW_RESPONSE_HEADER_OVERRIDE_DEFAULT = false;
    public static final String CAMEL_SINK_SPRINGWS_ENDPOINT_FAULT_ACTION_CONF = "camel.sink.endpoint.faultAction";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_FAULT_ACTION_DOC = "Signifies the value for the faultAction response WS-Addressing Fault Action header that is provided by the method.";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_FAULT_ACTION_DEFAULT = null;
    public static final String CAMEL_SINK_SPRINGWS_ENDPOINT_FAULT_TO_CONF = "camel.sink.endpoint.faultTo";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_FAULT_TO_DOC = "Signifies the value for the faultAction response WS-Addressing FaultTo header that is provided by the method.";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_FAULT_TO_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SPRINGWS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_SPRINGWS_ENDPOINT_MESSAGE_FACTORY_CONF = "camel.sink.endpoint.messageFactory";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_MESSAGE_FACTORY_DOC = "Option to provide a custom WebServiceMessageFactory. For example when you want Apache Axiom to handle web service messages instead of SAAJ.";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_MESSAGE_FACTORY_DEFAULT = null;
    public static final String CAMEL_SINK_SPRINGWS_ENDPOINT_MESSAGE_ID_STRATEGY_CONF = "camel.sink.endpoint.messageIdStrategy";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_MESSAGE_ID_STRATEGY_DOC = "Option to provide a custom MessageIdStrategy to control generation of unique message ids.";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_MESSAGE_ID_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SINK_SPRINGWS_ENDPOINT_MESSAGE_SENDER_CONF = "camel.sink.endpoint.messageSender";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_MESSAGE_SENDER_DOC = "Option to provide a custom WebServiceMessageSender. For example to perform authentication or use alternative transports";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_MESSAGE_SENDER_DEFAULT = null;
    public static final String CAMEL_SINK_SPRINGWS_ENDPOINT_OUTPUT_ACTION_CONF = "camel.sink.endpoint.outputAction";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_OUTPUT_ACTION_DOC = "Signifies the value for the response WS-Addressing Action header that is provided by the method.";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_OUTPUT_ACTION_DEFAULT = null;
    public static final String CAMEL_SINK_SPRINGWS_ENDPOINT_REPLY_TO_CONF = "camel.sink.endpoint.replyTo";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_REPLY_TO_DOC = "Signifies the value for the replyTo response WS-Addressing ReplyTo header that is provided by the method.";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_REPLY_TO_DEFAULT = null;
    public static final String CAMEL_SINK_SPRINGWS_ENDPOINT_SOAP_ACTION_CONF = "camel.sink.endpoint.soapAction";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_SOAP_ACTION_DOC = "SOAP action to include inside a SOAP request when accessing remote web services";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_SOAP_ACTION_DEFAULT = null;
    ...
    private static final Integer CAMEL_SINK_SPRINGWS_ENDPOINT_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_SPRINGWS_ENDPOINT_WEB_SERVICE_TEMPLATE_CONF = "camel.sink.endpoint.webServiceTemplate";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_WEB_SERVICE_TEMPLATE_DOC = "Option to provide a custom WebServiceTemplate. This allows for full control over client-side web services handling; like adding a custom interceptor or specifying a fault resolver, message sender or message factory.";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_WEB_SERVICE_TEMPLATE_DEFAULT = null;
    public static final String CAMEL_SINK_SPRINGWS_ENDPOINT_WS_ADDRESSING_ACTION_CONF = "camel.sink.endpoint.wsAddressingAction";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_WS_ADDRESSING_ACTION_DOC = "WS-Addressing 1.0 action header to include when accessing web services. The To header is set to the address of the web service as specified in the endpoint URI (default Spring-WS behavior).";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_WS_ADDRESSING_ACTION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SPRINGWS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SPRINGWS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_SPRINGWS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    private static final String CAMEL_SINK_SPRINGWS_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SPRINGWS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SPRINGWS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SPRINGWS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SPRINGWS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SINK_SPRINGWS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
