...
public class CamelJiraupdateissuesinkSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_JIRAUPDATEISSUESINK_KAMELET_PASSWORD_DOC = "The password or the API Token to access Jira";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_JIRAUPDATEISSUESINK_KAMELET_USERNAME_CONF, ConfigDef.Type.STRING, CAMEL_SINK_JIRAUPDATEISSUESINK_KAMELET_USERNAME_DEFAULT, ConfigDef.Importance.HIGH, CAMEL_SINK_JIRAUPDATEISSUESINK_KAMELET_USERNAME_DOC);
        conf.define(CAMEL_SINK_JIRAUPDATEISSUESINK_KAMELET_PASSWORD_CONF, ConfigDef.Type.PASSWORD, CAMEL_SINK_JIRAUPDATEISSUESINK_KAMELET_PASSWORD_DEFAULT, ConfigDef.Importance.HIGH, CAMEL_SINK_JIRAUPDATEISSUESINK_KAMELET_PASSWORD_DOC);
        return conf;
    }
}