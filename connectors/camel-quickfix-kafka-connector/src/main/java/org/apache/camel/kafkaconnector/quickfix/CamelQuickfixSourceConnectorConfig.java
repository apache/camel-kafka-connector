...
public class CamelQuickfixSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_QUICKFIX_COMPONENT_CONFIGURATIONS_CONF = "camel.component.quickfix.configurations";
    public static final String CAMEL_SOURCE_QUICKFIX_COMPONENT_CONFIGURATIONS_DOC = "To use the given map of pre configured QuickFix configurations mapped to the key";
    public static final String CAMEL_SOURCE_QUICKFIX_COMPONENT_CONFIGURATIONS_DEFAULT = null;
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SOURCE_QUICKFIX_COMPONENT_CONFIGURATIONS_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_QUICKFIX_COMPONENT_CONFIGURATIONS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_QUICKFIX_COMPONENT_CONFIGURATIONS_DOC);
