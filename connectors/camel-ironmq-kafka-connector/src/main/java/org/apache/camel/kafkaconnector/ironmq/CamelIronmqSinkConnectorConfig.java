...
public class CamelIronmqSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_IRONMQ_PATH_QUEUE_NAME_DOC = "The name of the IronMQ queue";
    private static final String CAMEL_SINK_IRONMQ_PATH_QUEUE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_IRONMQ_ENDPOINT_CLIENT_CONF = "camel.sink.endpoint.client";
    private static final String CAMEL_SINK_IRONMQ_ENDPOINT_CLIENT_DOC = "Reference to a io.iron.ironmq.Client in the Registry.";
    private static final String CAMEL_SINK_IRONMQ_ENDPOINT_CLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_IRONMQ_ENDPOINT_IRON_MQCLOUD_CONF = "camel.sink.endpoint.ironMQCloud";
    private static final String CAMEL_SINK_IRONMQ_ENDPOINT_IRON_MQCLOUD_DOC = "IronMq Cloud url. Urls for public clusters: https://mq-aws-us-east-1-1.iron.io (US) and https://mq-aws-eu-west-1-1.iron.io (EU)";
    private static final String CAMEL_SINK_IRONMQ_ENDPOINT_IRON_MQCLOUD_DEFAULT = "https://mq-aws-us-east-1-1.iron.io";
    public static final String CAMEL_SINK_IRONMQ_ENDPOINT_PRESERVE_HEADERS_CONF = "camel.sink.endpoint.preserveHeaders";
    private static final String CAMEL_SINK_IRONMQ_ENDPOINT_PRESERVE_HEADERS_DOC = "Should message headers be preserved when publishing messages. This will add the Camel headers to the Iron MQ message as a json payload with a header list, and a message body. Useful when Camel is both consumer and producer.";
    private static final Boolean CAMEL_SINK_IRONMQ_ENDPOINT_PRESERVE_HEADERS_DEFAULT = false;
    public static final String CAMEL_SINK_IRONMQ_ENDPOINT_PROJECT_ID_CONF = "camel.sink.endpoint.projectId";
    private static final String CAMEL_SINK_IRONMQ_ENDPOINT_PROJECT_ID_DOC = "IronMQ projectId";
    private static final String CAMEL_SINK_IRONMQ_ENDPOINT_PROJECT_ID_DEFAULT = null;
    public static final String CAMEL_SINK_IRONMQ_ENDPOINT_TOKEN_CONF = "camel.sink.endpoint.token";
    private static final String CAMEL_SINK_IRONMQ_ENDPOINT_TOKEN_DOC = "IronMQ token";
    private static final String CAMEL_SINK_IRONMQ_ENDPOINT_TOKEN_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_IRONMQ_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_IRONMQ_ENDPOINT_VISIBILITY_DELAY_CONF = "camel.sink.endpoint.visibilityDelay";
    private static final String CAMEL_SINK_IRONMQ_ENDPOINT_VISIBILITY_DELAY_DOC = "The item will not be available on the queue until this many seconds have passed. Default is 0 seconds.";
    private static final Integer CAMEL_SINK_IRONMQ_ENDPOINT_VISIBILITY_DELAY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IRONMQ_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_IRONMQ_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_IRONMQ_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_IRONMQ_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_IRONMQ_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_IRONMQ_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_IRONMQ_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_IRONMQ_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
