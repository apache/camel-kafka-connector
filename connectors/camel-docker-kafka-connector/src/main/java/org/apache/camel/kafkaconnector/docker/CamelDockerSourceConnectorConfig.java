...
public class CamelDockerSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_DOCKER_PATH_OPERATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_EMAIL_CONF = "camel.source.endpoint.email";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_EMAIL_DOC = "Email address associated with the user";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_EMAIL_DEFAULT = null;
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_HOST_CONF = "camel.source.endpoint.host";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_HOST_DOC = "Docker host";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_HOST_DEFAULT = "localhost";
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_PORT_CONF = "camel.source.endpoint.port";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_PORT_DOC = "Docker port";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_PORT_DEFAULT = "2375";
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_REQUEST_TIMEOUT_CONF = "camel.source.endpoint.requestTimeout";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_REQUEST_TIMEOUT_DOC = "Request timeout for response (in seconds)";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_REQUEST_TIMEOUT_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_DOCKER_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_DOCKER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_CMD_EXEC_FACTORY_CONF = "camel.source.endpoint.cmdExecFactory";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_CMD_EXEC_FACTORY_DOC = "The fully qualified class name of the DockerCmdExecFactory implementation to use";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_CMD_EXEC_FACTORY_DEFAULT = "com.github.dockerjava.netty.NettyDockerCmdExecFactory";
    ...
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_FOLLOW_REDIRECT_FILTER_DOC = "Whether to follow redirect filter";
    private static final Boolean CAMEL_SOURCE_DOCKER_ENDPOINT_FOLLOW_REDIRECT_FILTER_DEFAULT = false;
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_LOGGING_FILTER_CONF = "camel.source.endpoint.loggingFilter";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_LOGGING_FILTER_DOC = "Whether to use logging filter";
    private static final Boolean CAMEL_SOURCE_DOCKER_ENDPOINT_LOGGING_FILTER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_MAX_PER_ROUTE_CONNECTIONS_DOC = "Maximum route connections";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_MAX_PER_ROUTE_CONNECTIONS_DEFAULT = "100";
    ...
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_MAX_TOTAL_CONNECTIONS_DOC = "Maximum total connections";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_MAX_TOTAL_CONNECTIONS_DEFAULT = "100";
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_PARAMETERS_CONF = "camel.source.endpoint.parameters";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_PARAMETERS_DOC = "Additional configuration parameters as key/value pairs";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_SERVER_ADDRESS_CONF = "camel.source.endpoint.serverAddress";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_SERVER_ADDRESS_DOC = "Server address for docker registry.";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_SERVER_ADDRESS_DEFAULT = "https://index.docker.io/v1/";
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_SOCKET_CONF = "camel.source.endpoint.socket";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_SOCKET_DOC = "Socket connection mode";
    private static final Boolean CAMEL_SOURCE_DOCKER_ENDPOINT_SOCKET_DEFAULT = true;
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_DOCKER_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_CERT_PATH_CONF = "camel.source.endpoint.certPath";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_CERT_PATH_DOC = "Location containing the SSL certificate chain";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_CERT_PATH_DEFAULT = null;
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_PASSWORD_DOC = "Password to authenticate with";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_SECURE_CONF = "camel.source.endpoint.secure";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_SECURE_DOC = "Use HTTPS communication";
    private static final Boolean CAMEL_SOURCE_DOCKER_ENDPOINT_SECURE_DEFAULT = false;
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_TLS_VERIFY_CONF = "camel.source.endpoint.tlsVerify";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_TLS_VERIFY_DOC = "Check TLS";
    private static final Boolean CAMEL_SOURCE_DOCKER_ENDPOINT_TLS_VERIFY_DEFAULT = false;
    public static final String CAMEL_SOURCE_DOCKER_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_USERNAME_DOC = "User name to authenticate with";
    private static final String CAMEL_SOURCE_DOCKER_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_CONFIGURATION_CONF = "camel.component.docker.configuration";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_CONFIGURATION_DOC = "To use the shared docker configuration";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_EMAIL_CONF = "camel.component.docker.email";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_EMAIL_DOC = "Email address associated with the user";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_EMAIL_DEFAULT = null;
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_HOST_CONF = "camel.component.docker.host";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_HOST_DOC = "Docker host";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_HOST_DEFAULT = "localhost";
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_PORT_CONF = "camel.component.docker.port";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_PORT_DOC = "Docker port";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_PORT_DEFAULT = "2375";
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_REQUEST_TIMEOUT_CONF = "camel.component.docker.requestTimeout";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_REQUEST_TIMEOUT_DOC = "Request timeout for response (in seconds)";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_REQUEST_TIMEOUT_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_DOCKER_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_DOCKER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_CMD_EXEC_FACTORY_CONF = "camel.component.docker.cmdExecFactory";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_CMD_EXEC_FACTORY_DOC = "The fully qualified class name of the DockerCmdExecFactory implementation to use";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_CMD_EXEC_FACTORY_DEFAULT = "com.github.dockerjava.netty.NettyDockerCmdExecFactory";
    ...
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_FOLLOW_REDIRECT_FILTER_DOC = "Whether to follow redirect filter";
    private static final Boolean CAMEL_SOURCE_DOCKER_COMPONENT_FOLLOW_REDIRECT_FILTER_DEFAULT = false;
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_LOGGING_FILTER_CONF = "camel.component.docker.loggingFilter";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_LOGGING_FILTER_DOC = "Whether to use logging filter";
    private static final Boolean CAMEL_SOURCE_DOCKER_COMPONENT_LOGGING_FILTER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_MAX_PER_ROUTE_CONNECTIONS_DOC = "Maximum route connections";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_MAX_PER_ROUTE_CONNECTIONS_DEFAULT = "100";
    ...
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_MAX_TOTAL_CONNECTIONS_DOC = "Maximum total connections";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_MAX_TOTAL_CONNECTIONS_DEFAULT = "100";
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_PARAMETERS_CONF = "camel.component.docker.parameters";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_PARAMETERS_DOC = "Additional configuration parameters as key/value pairs";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_SERVER_ADDRESS_CONF = "camel.component.docker.serverAddress";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_SERVER_ADDRESS_DOC = "Server address for docker registry.";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_SERVER_ADDRESS_DEFAULT = "https://index.docker.io/v1/";
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_SOCKET_CONF = "camel.component.docker.socket";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_SOCKET_DOC = "Socket connection mode";
    private static final Boolean CAMEL_SOURCE_DOCKER_COMPONENT_SOCKET_DEFAULT = true;
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_CERT_PATH_CONF = "camel.component.docker.certPath";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_CERT_PATH_DOC = "Location containing the SSL certificate chain";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_CERT_PATH_DEFAULT = null;
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_PASSWORD_CONF = "camel.component.docker.password";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_PASSWORD_DOC = "Password to authenticate with";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_SECURE_CONF = "camel.component.docker.secure";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_SECURE_DOC = "Use HTTPS communication";
    private static final Boolean CAMEL_SOURCE_DOCKER_COMPONENT_SECURE_DEFAULT = false;
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_TLS_VERIFY_CONF = "camel.component.docker.tlsVerify";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_TLS_VERIFY_DOC = "Check TLS";
    private static final Boolean CAMEL_SOURCE_DOCKER_COMPONENT_TLS_VERIFY_DEFAULT = false;
    public static final String CAMEL_SOURCE_DOCKER_COMPONENT_USERNAME_CONF = "camel.component.docker.username";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_USERNAME_DOC = "User name to authenticate with";
    private static final String CAMEL_SOURCE_DOCKER_COMPONENT_USERNAME_DEFAULT = null;
