...
public class CamelUndertowSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_PATH_HTTP_URIDOC = "The url of the HTTP endpoint to use.";
    private static final String CAMEL_SOURCE_UNDERTOW_PATH_HTTP_URIDEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_UNDERTOW_ENDPOINT_USE_STREAMING_DEFAULT = false;
    public static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_ACCESS_LOG_CONF = "camel.source.endpoint.accessLog";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_ACCESS_LOG_DOC = "Whether or not the consumer should write access log";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_ACCESS_LOG_DEFAULT = "false";
    ...
    private static final Boolean CAMEL_SOURCE_UNDERTOW_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_HTTP_METHOD_RESTRICT_DOC = "Used to only allow consuming if the HttpMethod matches, such as GET/POST/PUT etc. Multiple methods can be specified separated by comma.";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_HTTP_METHOD_RESTRICT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_MATCH_ON_URI_PREFIX_DOC = "Whether or not the consumer should try to find a target consumer by matching the URI prefix if no exact match is found.";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_MATCH_ON_URI_PREFIX_DEFAULT = "false";
    public static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_MUTE_EXCEPTION_CONF = "camel.source.endpoint.muteException";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_MUTE_EXCEPTION_DOC = "If enabled and an Exchange failed processing on the consumer side the response's body won't contain the exception's stack trace.";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_MUTE_EXCEPTION_DEFAULT = "false";
    public static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_OPTIONS_ENABLED_CONF = "camel.source.endpoint.optionsEnabled";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_OPTIONS_ENABLED_DOC = "Specifies whether to enable HTTP OPTIONS for this Servlet consumer. By default OPTIONS is turned off.";
    private static final Boolean CAMEL_SOURCE_UNDERTOW_ENDPOINT_OPTIONS_ENABLED_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_HANDLERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_ACCESS_LOG_RECEIVER_DOC = "Which Undertow AccessLogReciever should be used Will use JBossLoggingAccessLogReceiver if not specifid";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_ACCESS_LOG_RECEIVER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_UNDERTOW_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_UNDERTOW_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_UNDERTOW_HTTP_BINDING_DOC = "To use a custom UndertowHttpBinding to control the mapping between Camel message and undertow.";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_UNDERTOW_HTTP_BINDING_DEFAULT = null;
    public static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_ALLOWED_ROLES_CONF = "camel.source.endpoint.allowedRoles";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_ALLOWED_ROLES_DOC = "Configuration used by UndertowSecurityProvider. Comma separated list of allowed roles.";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_ALLOWED_ROLES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_SECURITY_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_SECURITY_PROVIDER_CONF = "camel.source.endpoint.securityProvider";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_SECURITY_PROVIDER_DOC = "Security provider allows plug in the provider, which will be used to secure requests. SPI approach could be used too (endpoint then finds security provider using SPI).";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_SECURITY_PROVIDER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_ENDPOINT_FIRE_WEB_SOCKET_CHANNEL_EVENTS_DOC = "if true, the consumer will post notifications to the route when a new WebSocket peer connects, disconnects, etc. See UndertowConstants.EVENT_TYPE and EventType.";
    private static final Boolean CAMEL_SOURCE_UNDERTOW_ENDPOINT_FIRE_WEB_SOCKET_CHANNEL_EVENTS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_UNDERTOW_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_MUTE_EXCEPTION_CONF = "camel.component.undertow.muteException";
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_MUTE_EXCEPTION_DOC = "If enabled and an Exchange failed processing on the consumer side the response's body won't contain the exception's stack trace.";
    private static final Boolean CAMEL_SOURCE_UNDERTOW_COMPONENT_MUTE_EXCEPTION_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_UNDERTOW_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_HOST_OPTIONS_CONF = "camel.component.undertow.hostOptions";
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_HOST_OPTIONS_DOC = "To configure common options, such as thread pools";
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_HOST_OPTIONS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_UNDERTOW_HTTP_BINDING_DOC = "To use a custom HttpBinding to control the mapping between Camel message and HttpClient.";
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_UNDERTOW_HTTP_BINDING_DEFAULT = null;
    public static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_ALLOWED_ROLES_CONF = "camel.component.undertow.allowedRoles";
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_ALLOWED_ROLES_DOC = "Configuration used by UndertowSecurityProvider. Comma separated list of allowed roles.";
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_ALLOWED_ROLES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_SECURITY_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_SECURITY_PROVIDER_DOC = "Security provider allows plug in the provider, which will be used to secure requests. SPI approach could be used too (component then finds security provider using SPI).";
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_SECURITY_PROVIDER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_UNDERTOW_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SOURCE_UNDERTOW_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_UNDERTOW_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_UNDERTOW_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_UNDERTOW_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
