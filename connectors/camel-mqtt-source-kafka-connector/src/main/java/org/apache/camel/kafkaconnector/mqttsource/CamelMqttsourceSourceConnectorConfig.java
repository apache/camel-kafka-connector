...
public class CamelMqttsourceSourceConnectorConfig
        extends
            CamelSourceConnectorConfig {

    public static final String CAMEL_SOURCE_MQTTSOURCE_KAMELET_TOPIC_CONF = "camel.kamelet.mqtt-source.topic";
    public static final String CAMEL_SOURCE_MQTTSOURCE_KAMELET_TOPIC_DOC = "The topic to subscribe to Example: mytopic";
    public static final String CAMEL_SOURCE_MQTTSOURCE_KAMELET_TOPIC_DEFAULT = null;
    public static final String CAMEL_SOURCE_MQTTSOURCE_KAMELET_BROKER_URL_CONF = "camel.kamelet.mqtt-source.brokerUrl";
    public static final String CAMEL_SOURCE_MQTTSOURCE_KAMELET_BROKER_URL_DOC = "The URL of the broker where to establish the connection Example: tcp://mosquitto:1883";
    public static final String CAMEL_SOURCE_MQTTSOURCE_KAMELET_BROKER_URL_DEFAULT = null;
    ...
    public CamelMqttsourceSourceConnectorConfig(Map<String, String> parsedConfig) {
