...
public class CamelMinaSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_MINA_PATH_PROTOCOL_DOC = "Protocol to use";
    private static final String CAMEL_SOURCE_MINA_PATH_PROTOCOL_DEFAULT = null;
    public static final String CAMEL_SOURCE_MINA_PATH_HOST_CONF = "camel.source.path.host";
    private static final String CAMEL_SOURCE_MINA_PATH_HOST_DOC = "Hostname to use. Use localhost or 0.0.0.0 for local server as consumer. For producer use the hostname or ip address of the remote server.";
    private static final String CAMEL_SOURCE_MINA_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SOURCE_MINA_PATH_PORT_CONF = "camel.source.path.port";
    private static final String CAMEL_SOURCE_MINA_PATH_PORT_DOC = "Port number";
    private static final Integer CAMEL_SOURCE_MINA_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_DISCONNECT_CONF = "camel.source.endpoint.disconnect";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_DISCONNECT_DOC = "Whether or not to disconnect(close) from Mina session right after use. Can be used for both consumer and producer.";
    private static final Boolean CAMEL_SOURCE_MINA_ENDPOINT_DISCONNECT_DEFAULT = false;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_MINA_LOGGER_CONF = "camel.source.endpoint.minaLogger";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_MINA_LOGGER_DOC = "You can enable the Apache MINA logging filter. Apache MINA uses slf4j logging at INFO level to log all input and output.";
    private static final Boolean CAMEL_SOURCE_MINA_ENDPOINT_MINA_LOGGER_DEFAULT = false;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_SYNC_CONF = "camel.source.endpoint.sync";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_SYNC_DOC = "Setting to set endpoint as one-way or request-response.";
    private static final Boolean CAMEL_SOURCE_MINA_ENDPOINT_SYNC_DEFAULT = true;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_TIMEOUT_CONF = "camel.source.endpoint.timeout";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_TIMEOUT_DOC = "You can configure the timeout that specifies how long to wait for a response from a remote server. The timeout unit is in milliseconds, so 60000 is 60 seconds.";
    private static final Long CAMEL_SOURCE_MINA_ENDPOINT_TIMEOUT_DEFAULT = 30000L;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_WRITE_TIMEOUT_CONF = "camel.source.endpoint.writeTimeout";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_WRITE_TIMEOUT_DOC = "Maximum amount of time it should take to send data to the MINA session. Default is 10000 milliseconds.";
    private static final Long CAMEL_SOURCE_MINA_ENDPOINT_WRITE_TIMEOUT_DEFAULT = 10000L;
    ...
    private static final Boolean CAMEL_SOURCE_MINA_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_CLIENT_MODE_CONF = "camel.source.endpoint.clientMode";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_CLIENT_MODE_DOC = "If the clientMode is true, mina consumer will connect the address as a TCP client.";
    private static final Boolean CAMEL_SOURCE_MINA_ENDPOINT_CLIENT_MODE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_DISCONNECT_ON_NO_REPLY_DOC = "If sync is enabled then this option dictates MinaConsumer if it should disconnect where there is no reply to send back.";
    private static final Boolean CAMEL_SOURCE_MINA_ENDPOINT_DISCONNECT_ON_NO_REPLY_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_NO_REPLY_LOG_LEVEL_CONF = "camel.source.endpoint.noReplyLogLevel";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_NO_REPLY_LOG_LEVEL_DOC = "If sync is enabled this option dictates MinaConsumer which logging level to use when logging a there is no reply to send back. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_NO_REPLY_LOG_LEVEL_DEFAULT = "WARN";
    ...
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_MINA_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_MAXIMUM_POOL_SIZE_CONF = "camel.source.endpoint.maximumPoolSize";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_MAXIMUM_POOL_SIZE_DOC = "Number of worker threads in the worker pool for TCP and UDP";
    private static final Integer CAMEL_SOURCE_MINA_ENDPOINT_MAXIMUM_POOL_SIZE_DEFAULT = 16;
    ...
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_ORDERED_THREAD_POOL_EXECUTOR_DOC = "Whether to use ordered thread pool, to ensure events are processed orderly on the same channel.";
    private static final Boolean CAMEL_SOURCE_MINA_ENDPOINT_ORDERED_THREAD_POOL_EXECUTOR_DEFAULT = true;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_MINA_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_MINA_ENDPOINT_TRANSFER_EXCHANGE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_MINA_ENDPOINT_ALLOW_DEFAULT_CODEC_DEFAULT = true;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_CODEC_CONF = "camel.source.endpoint.codec";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_CODEC_DOC = "To use a custom minda codec implementation.";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_CODEC_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_DECODER_MAX_LINE_LENGTH_DOC = "To set the textline protocol decoder max line length. By default the default value of Mina itself is used which are 1024.";
    private static final Integer CAMEL_SOURCE_MINA_ENDPOINT_DECODER_MAX_LINE_LENGTH_DEFAULT = 1024;
    ...
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_ENCODER_MAX_LINE_LENGTH_DOC = "To set the textline protocol encoder max line length. By default the default value of Mina itself is used which are Integer.MAX_VALUE.";
    private static final Integer CAMEL_SOURCE_MINA_ENDPOINT_ENCODER_MAX_LINE_LENGTH_DEFAULT = -1;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_ENCODING_CONF = "camel.source.endpoint.encoding";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_ENCODING_DOC = "You can configure the encoding (a charset name) to use for the TCP textline codec and the UDP protocol. If not provided, Camel will use the JVM default Charset";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_ENCODING_DEFAULT = null;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_FILTERS_CONF = "camel.source.endpoint.filters";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_FILTERS_DOC = "You can set a list of Mina IoFilters to use.";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_FILTERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_TEXTLINE_CONF = "camel.source.endpoint.textline";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_TEXTLINE_DOC = "Only used for TCP. If no codec is specified, you can use this flag to indicate a text line based codec; if not specified or the value is false, then Object Serialization is assumed over TCP.";
    private static final Boolean CAMEL_SOURCE_MINA_ENDPOINT_TEXTLINE_DEFAULT = false;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_TEXTLINE_DELIMITER_CONF = "camel.source.endpoint.textlineDelimiter";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_TEXTLINE_DELIMITER_DOC = "Only used for TCP and if textline=true. Sets the text line delimiter to use. If none provided, Camel will use DEFAULT. This delimiter is used to mark the end of text. One of: [DEFAULT] [AUTO] [UNIX] [WINDOWS] [MAC]";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_TEXTLINE_DELIMITER_DEFAULT = null;
    public static final String CAMEL_SOURCE_MINA_ENDPOINT_AUTO_START_TLS_CONF = "camel.source.endpoint.autoStartTls";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_AUTO_START_TLS_DOC = "Whether to auto start SSL handshake.";
    private static final Boolean CAMEL_SOURCE_MINA_ENDPOINT_AUTO_START_TLS_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure SSL security.";
    private static final String CAMEL_SOURCE_MINA_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_DISCONNECT_CONF = "camel.component.mina.disconnect";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_DISCONNECT_DOC = "Whether or not to disconnect(close) from Mina session right after use. Can be used for both consumer and producer.";
    private static final Boolean CAMEL_SOURCE_MINA_COMPONENT_DISCONNECT_DEFAULT = false;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_MINA_LOGGER_CONF = "camel.component.mina.minaLogger";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_MINA_LOGGER_DOC = "You can enable the Apache MINA logging filter. Apache MINA uses slf4j logging at INFO level to log all input and output.";
    private static final Boolean CAMEL_SOURCE_MINA_COMPONENT_MINA_LOGGER_DEFAULT = false;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_SYNC_CONF = "camel.component.mina.sync";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_SYNC_DOC = "Setting to set endpoint as one-way or request-response.";
    private static final Boolean CAMEL_SOURCE_MINA_COMPONENT_SYNC_DEFAULT = true;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_TIMEOUT_CONF = "camel.component.mina.timeout";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_TIMEOUT_DOC = "You can configure the timeout that specifies how long to wait for a response from a remote server. The timeout unit is in milliseconds, so 60000 is 60 seconds.";
    private static final Long CAMEL_SOURCE_MINA_COMPONENT_TIMEOUT_DEFAULT = 30000L;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_WRITE_TIMEOUT_CONF = "camel.component.mina.writeTimeout";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_WRITE_TIMEOUT_DOC = "Maximum amount of time it should take to send data to the MINA session. Default is 10000 milliseconds.";
    private static final Long CAMEL_SOURCE_MINA_COMPONENT_WRITE_TIMEOUT_DEFAULT = 10000L;
    ...
    private static final Boolean CAMEL_SOURCE_MINA_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_CLIENT_MODE_CONF = "camel.component.mina.clientMode";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_CLIENT_MODE_DOC = "If the clientMode is true, mina consumer will connect the address as a TCP client.";
    private static final Boolean CAMEL_SOURCE_MINA_COMPONENT_CLIENT_MODE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_MINA_COMPONENT_DISCONNECT_ON_NO_REPLY_DOC = "If sync is enabled then this option dictates MinaConsumer if it should disconnect where there is no reply to send back.";
    private static final Boolean CAMEL_SOURCE_MINA_COMPONENT_DISCONNECT_ON_NO_REPLY_DEFAULT = true;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_NO_REPLY_LOG_LEVEL_CONF = "camel.component.mina.noReplyLogLevel";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_NO_REPLY_LOG_LEVEL_DOC = "If sync is enabled this option dictates MinaConsumer which logging level to use when logging a there is no reply to send back. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_NO_REPLY_LOG_LEVEL_DEFAULT = "WARN";
    ...
    private static final String CAMEL_SOURCE_MINA_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_MINA_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_CONFIGURATION_CONF = "camel.component.mina.configuration";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_CONFIGURATION_DOC = "To use the shared mina configuration.";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_MAXIMUM_POOL_SIZE_CONF = "camel.component.mina.maximumPoolSize";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_MAXIMUM_POOL_SIZE_DOC = "Number of worker threads in the worker pool for TCP and UDP";
    private static final Integer CAMEL_SOURCE_MINA_COMPONENT_MAXIMUM_POOL_SIZE_DEFAULT = 16;
    ...
    private static final String CAMEL_SOURCE_MINA_COMPONENT_ORDERED_THREAD_POOL_EXECUTOR_DOC = "Whether to use ordered thread pool, to ensure events are processed orderly on the same channel.";
    private static final Boolean CAMEL_SOURCE_MINA_COMPONENT_ORDERED_THREAD_POOL_EXECUTOR_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_MINA_COMPONENT_TRANSFER_EXCHANGE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_MINA_COMPONENT_ALLOW_DEFAULT_CODEC_DEFAULT = true;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_CODEC_CONF = "camel.component.mina.codec";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_CODEC_DOC = "To use a custom minda codec implementation.";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_CODEC_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MINA_COMPONENT_DECODER_MAX_LINE_LENGTH_DOC = "To set the textline protocol decoder max line length. By default the default value of Mina itself is used which are 1024.";
    private static final Integer CAMEL_SOURCE_MINA_COMPONENT_DECODER_MAX_LINE_LENGTH_DEFAULT = 1024;
    ...
    private static final String CAMEL_SOURCE_MINA_COMPONENT_ENCODER_MAX_LINE_LENGTH_DOC = "To set the textline protocol encoder max line length. By default the default value of Mina itself is used which are Integer.MAX_VALUE.";
    private static final Integer CAMEL_SOURCE_MINA_COMPONENT_ENCODER_MAX_LINE_LENGTH_DEFAULT = -1;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_ENCODING_CONF = "camel.component.mina.encoding";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_ENCODING_DOC = "You can configure the encoding (a charset name) to use for the TCP textline codec and the UDP protocol. If not provided, Camel will use the JVM default Charset";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_ENCODING_DEFAULT = null;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_FILTERS_CONF = "camel.component.mina.filters";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_FILTERS_DOC = "You can set a list of Mina IoFilters to use.";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_FILTERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_TEXTLINE_CONF = "camel.component.mina.textline";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_TEXTLINE_DOC = "Only used for TCP. If no codec is specified, you can use this flag to indicate a text line based codec; if not specified or the value is false, then Object Serialization is assumed over TCP.";
    private static final Boolean CAMEL_SOURCE_MINA_COMPONENT_TEXTLINE_DEFAULT = false;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_TEXTLINE_DELIMITER_CONF = "camel.component.mina.textlineDelimiter";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_TEXTLINE_DELIMITER_DOC = "Only used for TCP and if textline=true. Sets the text line delimiter to use. If none provided, Camel will use DEFAULT. This delimiter is used to mark the end of text. One of: [DEFAULT] [AUTO] [UNIX] [WINDOWS] [MAC]";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_TEXTLINE_DELIMITER_DEFAULT = null;
    public static final String CAMEL_SOURCE_MINA_COMPONENT_AUTO_START_TLS_CONF = "camel.component.mina.autoStartTls";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_AUTO_START_TLS_DOC = "Whether to auto start SSL handshake.";
    private static final Boolean CAMEL_SOURCE_MINA_COMPONENT_AUTO_START_TLS_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_MINA_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "To configure SSL security.";
    private static final String CAMEL_SOURCE_MINA_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MINA_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SOURCE_MINA_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_MINA_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_MINA_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_MINA_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
