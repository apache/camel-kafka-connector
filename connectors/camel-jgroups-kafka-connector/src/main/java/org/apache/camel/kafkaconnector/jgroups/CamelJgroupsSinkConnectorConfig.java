...
public class CamelJgroupsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_JGROUPS_PATH_CLUSTER_NAME_DOC = "The name of the JGroups cluster the component should connect to.";
    private static final String CAMEL_SINK_JGROUPS_PATH_CLUSTER_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_JGROUPS_ENDPOINT_CHANNEL_PROPERTIES_CONF = "camel.sink.endpoint.channelProperties";
    private static final String CAMEL_SINK_JGROUPS_ENDPOINT_CHANNEL_PROPERTIES_DOC = "Specifies configuration properties of the JChannel used by the endpoint.";
    private static final String CAMEL_SINK_JGROUPS_ENDPOINT_CHANNEL_PROPERTIES_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JGROUPS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_JGROUPS_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_JGROUPS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JGROUPS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JGROUPS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_JGROUPS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_JGROUPS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_JGROUPS_COMPONENT_CHANNEL_CONF = "camel.component.jgroups.channel";
    private static final String CAMEL_SINK_JGROUPS_COMPONENT_CHANNEL_DOC = "Channel to use";
    private static final String CAMEL_SINK_JGROUPS_COMPONENT_CHANNEL_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_JGROUPS_COMPONENT_CHANNEL_PROPERTIES_DOC = "Specifies configuration properties of the JChannel used by the endpoint.";
    private static final String CAMEL_SINK_JGROUPS_COMPONENT_CHANNEL_PROPERTIES_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JGROUPS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_JGROUPS_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.jgroups.basicPropertyBinding";
    private static final String CAMEL_SINK_JGROUPS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JGROUPS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_JGROUPS_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_JGROUPS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_JGROUPS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
