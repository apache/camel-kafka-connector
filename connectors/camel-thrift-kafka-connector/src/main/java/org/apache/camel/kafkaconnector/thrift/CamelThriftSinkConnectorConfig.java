...
public class CamelThriftSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_THRIFT_PATH_HOST_DOC = "The Thrift server host name. This is localhost or 0.0.0.0 (if not defined) when being a consumer or remote server host name when using producer.";
    private static final String CAMEL_SINK_THRIFT_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_THRIFT_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_THRIFT_PATH_PORT_DOC = "The Thrift server port";
    private static final Integer CAMEL_SINK_THRIFT_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_THRIFT_PATH_SERVICE_CONF = "camel.sink.path.service";
    private static final String CAMEL_SINK_THRIFT_PATH_SERVICE_DOC = "Fully qualified service name from the thrift descriptor file (package dot service definition name)";
    private static final String CAMEL_SINK_THRIFT_PATH_SERVICE_DEFAULT = null;
    public static final String CAMEL_SINK_THRIFT_ENDPOINT_COMPRESSION_TYPE_CONF = "camel.sink.endpoint.compressionType";
    private static final String CAMEL_SINK_THRIFT_ENDPOINT_COMPRESSION_TYPE_DOC = "Protocol compression mechanism type One of: [NONE] [ZLIB]";
    private static final String CAMEL_SINK_THRIFT_ENDPOINT_COMPRESSION_TYPE_DEFAULT = "NONE";
    public static final String CAMEL_SINK_THRIFT_ENDPOINT_EXCHANGE_PROTOCOL_CONF = "camel.sink.endpoint.exchangeProtocol";
    private static final String CAMEL_SINK_THRIFT_ENDPOINT_EXCHANGE_PROTOCOL_DOC = "Exchange protocol serialization type One of: [BINARY] [JSON] [SJSON] [COMPACT]";
    private static final String CAMEL_SINK_THRIFT_ENDPOINT_EXCHANGE_PROTOCOL_DEFAULT = "BINARY";
    ...
    private static final Boolean CAMEL_SINK_THRIFT_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_THRIFT_ENDPOINT_METHOD_CONF = "camel.sink.endpoint.method";
    private static final String CAMEL_SINK_THRIFT_ENDPOINT_METHOD_DOC = "The Thrift invoked method name";
    private static final String CAMEL_SINK_THRIFT_ENDPOINT_METHOD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_THRIFT_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_THRIFT_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_THRIFT_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_THRIFT_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_THRIFT_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_THRIFT_ENDPOINT_NEGOTIATION_TYPE_CONF = "camel.sink.endpoint.negotiationType";
    private static final String CAMEL_SINK_THRIFT_ENDPOINT_NEGOTIATION_TYPE_DOC = "Security negotiation type One of: [PLAINTEXT] [SSL] [SASL]";
    private static final String CAMEL_SINK_THRIFT_ENDPOINT_NEGOTIATION_TYPE_DEFAULT = "PLAINTEXT";
    public static final String CAMEL_SINK_THRIFT_ENDPOINT_SSL_PARAMETERS_CONF = "camel.sink.endpoint.sslParameters";
    private static final String CAMEL_SINK_THRIFT_ENDPOINT_SSL_PARAMETERS_DOC = "Configuration parameters for SSL/TLS security negotiation";
    private static final String CAMEL_SINK_THRIFT_ENDPOINT_SSL_PARAMETERS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_THRIFT_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_THRIFT_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_THRIFT_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_THRIFT_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Determine if the thrift component is using global SSL context parameters";
    private static final Boolean CAMEL_SINK_THRIFT_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
