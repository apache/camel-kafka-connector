...
public class CamelAzureservicebussourceSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AZURESERVICEBUSSOURCE_KAMELET_CREDENTIAL_TYPE_CONF = "camel.kamelet.azure-servicebus-source.credentialType";
    public static final String CAMEL_SOURCE_AZURESERVICEBUSSOURCE_KAMELET_CREDENTIAL_TYPE_DOC = "Determines the credential strategy to adopt.";
    public static final String CAMEL_SOURCE_AZURESERVICEBUSSOURCE_KAMELET_CREDENTIAL_TYPE_DEFAULT = "CONNECTION_STRING";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_AZURESERVICEBUSSOURCE_KAMELET_CREDENTIAL_TYPE_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_AZURESERVICEBUSSOURCE_KAMELET_CREDENTIAL_TYPE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AZURESERVICEBUSSOURCE_KAMELET_CREDENTIAL_TYPE_DOC);
        return conf;
    }
}