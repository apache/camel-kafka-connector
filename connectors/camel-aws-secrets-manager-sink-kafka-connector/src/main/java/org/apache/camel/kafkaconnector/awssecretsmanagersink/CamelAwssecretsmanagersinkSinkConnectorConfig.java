...
public class CamelAwssecretsmanagersinkSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_CONF = "camel.kamelet.aws-secrets-manager-sink.useProfileCredentialsProvider";
    public static final String CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DOC = "Set whether the Secrets Manager client should expect to load credentials through a profile credentials provider.";
    public static final Boolean CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DEFAULT = false;
    public static final String CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_USE_SESSION_CREDENTIALS_CONF = "camel.kamelet.aws-secrets-manager-sink.useSessionCredentials";
    ...
    public static final String CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_SESSION_TOKEN_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DOC);
        conf.define(CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_USE_SESSION_CREDENTIALS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_USE_SESSION_CREDENTIALS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_USE_SESSION_CREDENTIALS_DOC);
        conf.define(CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_PROFILE_CREDENTIALS_NAME_CONF, ConfigDef.Type.STRING, CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_PROFILE_CREDENTIALS_NAME_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_PROFILE_CREDENTIALS_NAME_DOC);
        conf.define(CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_SESSION_TOKEN_CONF, ConfigDef.Type.PASSWORD, CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_SESSION_TOKEN_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWSSECRETSMANAGERSINK_KAMELET_SESSION_TOKEN_DOC);
        return conf;
    }
}