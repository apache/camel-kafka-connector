...
public class CamelFtpsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_FTPS_PATH_HOST_DOC = "Hostname of the FTP server";
    private static final String CAMEL_SINK_FTPS_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_FTPS_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_FTPS_PATH_PORT_DOC = "Port of the FTP server";
    private static final Integer CAMEL_SINK_FTPS_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_FTPS_PATH_DIRECTORY_NAME_CONF = "camel.sink.path.directoryName";
    private static final String CAMEL_SINK_FTPS_PATH_DIRECTORY_NAME_DOC = "The starting directory";
    private static final String CAMEL_SINK_FTPS_PATH_DIRECTORY_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_BINARY_CONF = "camel.sink.endpoint.binary";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_BINARY_DOC = "Specifies the file transfer mode, BINARY or ASCII. Default is ASCII (false).";
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_BINARY_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_CHARSET_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_DISCONNECT_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_DONE_FILE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FILE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_PASSIVE_MODE_CONF = "camel.sink.endpoint.passiveMode";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_PASSIVE_MODE_DOC = "Sets passive mode connections. Default is active mode connections.";
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_PASSIVE_MODE_DEFAULT = false;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_SEPARATOR_CONF = "camel.sink.endpoint.separator";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_SEPARATOR_DOC = "Sets the path separator to be used. UNIX = Uses unix style path separator Windows = Uses windows style path separator Auto = (is default) Use existing path separator in file name One of: [UNIX] [Windows] [Auto]";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_SEPARATOR_DEFAULT = "UNIX";
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_TRANSFER_LOGGING_INTERVAL_SECONDS_DOC = "Configures the interval in seconds to use when logging the progress of upload and download operations that are in-flight. This is used for logging progress when operations takes longer time.";
    private static final Integer CAMEL_SINK_FTPS_ENDPOINT_TRANSFER_LOGGING_INTERVAL_SECONDS_DEFAULT = 5;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_TRANSFER_LOGGING_LEVEL_CONF = "camel.sink.endpoint.transferLoggingLevel";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_TRANSFER_LOGGING_LEVEL_DOC = "Configure the logging level to use when logging the progress of upload and download operations. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_TRANSFER_LOGGING_LEVEL_DEFAULT = "DEBUG";
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_TRANSFER_LOGGING_VERBOSE_DOC = "Configures whether the perform verbose (fine grained) logging of the progress of upload and download operations.";
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_TRANSFER_LOGGING_VERBOSE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_FAST_EXISTS_CHECK_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FILE_EXIST_DEFAULT = "Override";
    ...
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_FLATTEN_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_JAIL_STARTING_DIRECTORY_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_MOVE_EXISTING_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_TEMP_FILE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_TEMP_PREFIX_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_ALLOW_NULL_BODY_DEFAULT = false;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_CHMOD_CONF = "camel.sink.endpoint.chmod";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_CHMOD_DOC = "Allows you to set chmod on the stored file. For example chmod=640.";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_CHMOD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_DISCONNECT_ON_BATCH_COMPLETE_DOC = "Whether or not to disconnect from remote FTP server right after a Batch upload is complete. disconnectOnBatchComplete will only disconnect the current connection to the FTP server.";
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_DISCONNECT_ON_BATCH_COMPLETE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_EAGER_DELETE_TARGET_FILE_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_KEEP_LAST_MODIFIED_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_MOVE_EXISTING_FILE_STRATEGY_DOC = "Strategy (Custom Strategy) used to move file with special naming token to use when fileExist=Move is configured. By default, there is an implementation used if no custom strategy is provided";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_MOVE_EXISTING_FILE_STRATEGY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_SEND_NOOP_DEFAULT = true;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_ACTIVE_PORT_RANGE_CONF = "camel.sink.endpoint.activePortRange";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_ACTIVE_PORT_RANGE_DOC = "Set the client side port range in active mode. The syntax is: minPort-maxPort Both port numbers are inclusive, eg 10000-19999 to include all 1xxxx ports.";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_ACTIVE_PORT_RANGE_DEFAULT = null;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_AUTO_CREATE_CONF = "camel.sink.endpoint.autoCreate";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_AUTO_CREATE_DOC = "Automatically create missing directories in the file's pathname. For the file consumer, that means creating the starting directory. For the file producer, it means the directory the files should be written to.";
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_AUTO_CREATE_DEFAULT = true;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_BUFFER_SIZE_CONF = "camel.sink.endpoint.bufferSize";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_BUFFER_SIZE_DOC = "Buffer size in bytes used for writing files (or in case of FTP for downloading and uploading files).";
    private static final Integer CAMEL_SINK_FTPS_ENDPOINT_BUFFER_SIZE_DEFAULT = 131072;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_CONNECT_TIMEOUT_CONF = "camel.sink.endpoint.connectTimeout";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_CONNECT_TIMEOUT_DOC = "Sets the connect timeout for waiting for a connection to be established Used by both FTPClient and JSCH";
    private static final Integer CAMEL_SINK_FTPS_ENDPOINT_CONNECT_TIMEOUT_DEFAULT = 10000;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_CONF = "camel.sink.endpoint.ftpClient";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_DOC = "To use a custom instance of FTPClient";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_CONFIG_CONF = "camel.sink.endpoint.ftpClientConfig";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_CONFIG_DOC = "To use a custom instance of FTPClientConfig to configure the FTP client the endpoint should use.";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_CONFIG_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_CONFIG_PARAMETERS_DOC = "Used by FtpComponent to provide additional parameters for the FTPClientConfig";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_CONFIG_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_PARAMETERS_CONF = "camel.sink.endpoint.ftpClientParameters";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_PARAMETERS_DOC = "Used by FtpComponent to provide additional parameters for the FTPClient";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_MAXIMUM_RECONNECT_ATTEMPTS_DOC = "Specifies the maximum reconnect attempts Camel performs when it tries to connect to the remote FTP server. Use 0 to disable this behavior.";
    private static final Integer CAMEL_SINK_FTPS_ENDPOINT_MAXIMUM_RECONNECT_ATTEMPTS_DEFAULT = null;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_RECONNECT_DELAY_CONF = "camel.sink.endpoint.reconnectDelay";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_RECONNECT_DELAY_DOC = "Delay in millis Camel will wait before performing a reconnect attempt.";
    private static final Long CAMEL_SINK_FTPS_ENDPOINT_RECONNECT_DELAY_DEFAULT = null;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_SITE_COMMAND_CONF = "camel.sink.endpoint.siteCommand";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_SITE_COMMAND_DOC = "Sets optional site command(s) to be executed after successful login. Multiple site commands can be separated using a new line character.";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_SITE_COMMAND_DEFAULT = null;
    ...
    private static final Integer CAMEL_SINK_FTPS_ENDPOINT_SO_TIMEOUT_DEFAULT = 300000;
    ...
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_STEPWISE_DEFAULT = true;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_THROW_EXCEPTION_ON_CONNECT_FAILED_DEFAULT = false;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_TIMEOUT_CONF = "camel.sink.endpoint.timeout";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_TIMEOUT_DOC = "Sets the data timeout for waiting for reply Used only by FTPClient";
    private static final Integer CAMEL_SINK_FTPS_ENDPOINT_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_ACCOUNT_CONF = "camel.sink.endpoint.account";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_ACCOUNT_DOC = "Account to use for login";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_ACCOUNT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_DISABLE_SECURE_DATA_CHANNEL_DEFAULTS_DOC = "Use this option to disable default options when using secure data channel. This allows you to be in full control what the execPbsz and execProt setting should be used. Default is false";
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_DISABLE_SECURE_DATA_CHANNEL_DEFAULTS_DEFAULT = false;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_EXEC_PBSZ_CONF = "camel.sink.endpoint.execPbsz";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_EXEC_PBSZ_DOC = "When using secure data channel you can set the exec protection buffer size";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_EXEC_PBSZ_DEFAULT = null;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_EXEC_PROT_CONF = "camel.sink.endpoint.execProt";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_EXEC_PROT_DOC = "The exec protection level PROT command. C - Clear S - Safe(SSL protocol only) E - Confidential(SSL protocol only) P - Private";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_EXEC_PROT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_KEY_STORE_PARAMETERS_DOC = "Set the key store parameters";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_KEY_STORE_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_TRUST_STORE_PARAMETERS_DOC = "Set the trust store parameters";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_FTP_CLIENT_TRUST_STORE_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_IMPLICIT_CONF = "camel.sink.endpoint.implicit";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_IMPLICIT_DOC = "Set the security mode (Implicit/Explicit). true - Implicit Mode / False - Explicit Mode";
    private static final Boolean CAMEL_SINK_FTPS_ENDPOINT_IMPLICIT_DEFAULT = false;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_PASSWORD_DOC = "Password to use for login";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_SECURITY_PROTOCOL_CONF = "camel.sink.endpoint.securityProtocol";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_SECURITY_PROTOCOL_DOC = "Set the underlying security protocol.";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_SECURITY_PROTOCOL_DEFAULT = "TLSv1.2";
    public static final String CAMEL_SINK_FTPS_ENDPOINT_SSL_CONTEXT_PARAMETERS_CONF = "camel.sink.endpoint.sslContextParameters";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "Gets the JSSE configuration that overrides any settings in FtpsEndpoint#ftpClientKeyStoreParameters, ftpClientTrustStoreParameters, and FtpsConfiguration#getSecurityProtocol().";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_FTPS_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_USERNAME_DOC = "Username to use for login";
    private static final String CAMEL_SINK_FTPS_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_FTPS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_FTPS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_FTPS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_FTPS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SINK_FTPS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
