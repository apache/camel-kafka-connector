...
public class CamelFtpsSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_FTPS_PATH_HOST_DOC = "Hostname of the FTP server";
    private static final String CAMEL_SOURCE_FTPS_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_PATH_PORT_CONF = "camel.source.path.port";
    private static final String CAMEL_SOURCE_FTPS_PATH_PORT_DOC = "Port of the FTP server";
    private static final Integer CAMEL_SOURCE_FTPS_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_PATH_DIRECTORY_NAME_CONF = "camel.source.path.directoryName";
    private static final String CAMEL_SOURCE_FTPS_PATH_DIRECTORY_NAME_DOC = "The starting directory";
    private static final String CAMEL_SOURCE_FTPS_PATH_DIRECTORY_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_BINARY_CONF = "camel.source.endpoint.binary";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_BINARY_DOC = "Specifies the file transfer mode, BINARY or ASCII. Default is ASCII (false).";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_BINARY_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_CHARSET_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_DISCONNECT_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_DONE_FILE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FILE_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_PASSIVE_MODE_CONF = "camel.source.endpoint.passiveMode";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_PASSIVE_MODE_DOC = "Sets passive mode connections. Default is active mode connections.";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_PASSIVE_MODE_DEFAULT = false;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_SEPARATOR_CONF = "camel.source.endpoint.separator";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SEPARATOR_DOC = "Sets the path separator to be used. UNIX = Uses unix style path separator Windows = Uses windows style path separator Auto = (is default) Use existing path separator in file name One of: [UNIX] [Windows] [Auto]";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SEPARATOR_DEFAULT = "UNIX";
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_TRANSFER_LOGGING_INTERVAL_SECONDS_DOC = "Configures the interval in seconds to use when logging the progress of upload and download operations that are in-flight. This is used for logging progress when operations takes longer time.";
    private static final Integer CAMEL_SOURCE_FTPS_ENDPOINT_TRANSFER_LOGGING_INTERVAL_SECONDS_DEFAULT = 5;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_TRANSFER_LOGGING_LEVEL_DOC = "Configure the logging level to use when logging the progress of upload and download operations. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_TRANSFER_LOGGING_LEVEL_DEFAULT = "DEBUG";
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_TRANSFER_LOGGING_VERBOSE_DOC = "Configures whether the perform verbose (fine grained) logging of the progress of upload and download operations.";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_TRANSFER_LOGGING_VERBOSE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_FAST_EXISTS_CHECK_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_DELETE_CONF = "camel.source.endpoint.delete";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_DELETE_DOC = "If true, the file will be deleted after it is processed successfully.";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_DELETE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_MOVE_FAILED_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_NOOP_CONF = "camel.source.endpoint.noop";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_NOOP_DOC = "If true, the file is not moved or deleted in any way. This option is good for readonly data, or for ETL type requirements. If noop=true, Camel will set idempotent=true as well, to avoid consuming the same files over and over again.";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_NOOP_DEFAULT = false;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_PRE_MOVE_CONF = "camel.source.endpoint.preMove";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_PRE_MOVE_DOC = "Expression (such as File Language) used to dynamically set the filename when moving it before processing. For example to move in-progress files into the order directory set this value to order.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_PRE_MOVE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_PRE_SORT_DEFAULT = false;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_RECURSIVE_CONF = "camel.source.endpoint.recursive";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_RECURSIVE_DOC = "If a directory, will look for files in all the sub-directories as well.";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_RECURSIVE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_RESUME_DOWNLOAD_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DOC = "If the polling consumer did not poll any files, you can enable this option to send an empty message (no body) instead.";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_STREAM_DOWNLOAD_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_DOWNLOAD_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_HANDLE_DIRECTORY_PARSER_ABSOLUTE_RESULT_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_IGNORE_FILE_NOT_FOUND_OR_PERMISSION_ERROR_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_IN_PROGRESS_REPOSITORY_DOC = "A pluggable in-progress repository org.apache.camel.spi.IdempotentRepository. The in-progress repository is used to account the current in progress files being consumed. By default a memory based repository is used.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_IN_PROGRESS_REPOSITORY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_LOCAL_WORK_DIRECTORY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_ON_COMPLETION_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_POLL_STRATEGY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_PROCESS_STRATEGY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_USE_LIST_DEFAULT = true;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_ACTIVE_PORT_RANGE_CONF = "camel.source.endpoint.activePortRange";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_ACTIVE_PORT_RANGE_DOC = "Set the client side port range in active mode. The syntax is: minPort-maxPort Both port numbers are inclusive, eg 10000-19999 to include all 1xxxx ports.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_ACTIVE_PORT_RANGE_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_AUTO_CREATE_CONF = "camel.source.endpoint.autoCreate";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_AUTO_CREATE_DOC = "Automatically create missing directories in the file's pathname. For the file consumer, that means creating the starting directory. For the file producer, it means the directory the files should be written to.";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_AUTO_CREATE_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_BUFFER_SIZE_CONF = "camel.source.endpoint.bufferSize";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_BUFFER_SIZE_DOC = "Buffer size in bytes used for writing files (or in case of FTP for downloading and uploading files).";
    private static final Integer CAMEL_SOURCE_FTPS_ENDPOINT_BUFFER_SIZE_DEFAULT = 131072;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_CONNECT_TIMEOUT_CONF = "camel.source.endpoint.connectTimeout";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_CONNECT_TIMEOUT_DOC = "Sets the connect timeout for waiting for a connection to be established Used by both FTPClient and JSCH";
    private static final Integer CAMEL_SOURCE_FTPS_ENDPOINT_CONNECT_TIMEOUT_DEFAULT = 10000;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_CONF = "camel.source.endpoint.ftpClient";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_DOC = "To use a custom instance of FTPClient";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_CONFIG_CONF = "camel.source.endpoint.ftpClientConfig";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_CONFIG_DOC = "To use a custom instance of FTPClientConfig to configure the FTP client the endpoint should use.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_CONFIG_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_CONFIG_PARAMETERS_DOC = "Used by FtpComponent to provide additional parameters for the FTPClientConfig";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_CONFIG_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_PARAMETERS_DOC = "Used by FtpComponent to provide additional parameters for the FTPClient";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_MAXIMUM_RECONNECT_ATTEMPTS_DOC = "Specifies the maximum reconnect attempts Camel performs when it tries to connect to the remote FTP server. Use 0 to disable this behavior.";
    private static final Integer CAMEL_SOURCE_FTPS_ENDPOINT_MAXIMUM_RECONNECT_ATTEMPTS_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_RECONNECT_DELAY_CONF = "camel.source.endpoint.reconnectDelay";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_RECONNECT_DELAY_DOC = "Delay in millis Camel will wait before performing a reconnect attempt.";
    private static final Long CAMEL_SOURCE_FTPS_ENDPOINT_RECONNECT_DELAY_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_SITE_COMMAND_CONF = "camel.source.endpoint.siteCommand";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SITE_COMMAND_DOC = "Sets optional site command(s) to be executed after successful login. Multiple site commands can be separated using a new line character.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SITE_COMMAND_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_FTPS_ENDPOINT_SO_TIMEOUT_DEFAULT = 300000;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_STEPWISE_DEFAULT = true;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_THROW_EXCEPTION_ON_CONNECT_FAILED_DEFAULT = false;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_TIMEOUT_CONF = "camel.source.endpoint.timeout";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_TIMEOUT_DOC = "Sets the data timeout for waiting for reply Used only by FTPClient";
    private static final Integer CAMEL_SOURCE_FTPS_ENDPOINT_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_ANT_EXCLUDE_CONF = "camel.source.endpoint.antExclude";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_ANT_EXCLUDE_DOC = "Ant style filter exclusion. If both antInclude and antExclude are used, antExclude takes precedence over antInclude. Multiple exclusions may be specified in comma-delimited format.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_ANT_EXCLUDE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_ANT_FILTER_CASE_SENSITIVE_DOC = "Sets case sensitive flag on ant filter.";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_ANT_FILTER_CASE_SENSITIVE_DEFAULT = true;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_ANT_INCLUDE_CONF = "camel.source.endpoint.antInclude";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_ANT_INCLUDE_DOC = "Ant style filter inclusion. Multiple inclusions may be specified in comma-delimited format.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_ANT_INCLUDE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_EAGER_MAX_MESSAGES_PER_POLL_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_EXCLUDE_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_FILTER_CONF = "camel.source.endpoint.filter";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FILTER_DOC = "Pluggable filter as a org.apache.camel.component.file.GenericFileFilter class. Will skip files if filter returns false in its accept() method.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FILTER_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_FILTER_DIRECTORY_CONF = "camel.source.endpoint.filterDirectory";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FILTER_DIRECTORY_DOC = "Filters the directory based on Simple language. For example to filter on current date, you can use a simple date pattern such as ${date:now:yyyMMdd}";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FILTER_DIRECTORY_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_FILTER_FILE_CONF = "camel.source.endpoint.filterFile";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FILTER_FILE_DOC = "Filters the file based on Simple language. For example to filter on file size, you can use ${file:size} 5000";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FILTER_FILE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_IDEMPOTENT_DEFAULT = "false";
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_IDEMPOTENT_KEY_CONF = "camel.source.endpoint.idempotentKey";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_IDEMPOTENT_KEY_DOC = "To use a custom idempotent key. By default the absolute path of the file is used. You can use the File Language, for example to use the file name and file size, you can do: idempotentKey=${file:name}-${file:size}";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_IDEMPOTENT_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_IDEMPOTENT_REPOSITORY_DOC = "A pluggable repository org.apache.camel.spi.IdempotentRepository which by default use MemoryMessageIdRepository if none is specified and idempotent is true.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_IDEMPOTENT_REPOSITORY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_INCLUDE_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_MAX_DEPTH_CONF = "camel.source.endpoint.maxDepth";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_MAX_DEPTH_DOC = "The maximum depth to traverse when recursively processing a directory.";
    private static final Integer CAMEL_SOURCE_FTPS_ENDPOINT_MAX_DEPTH_DEFAULT = 2147483647;
    ...
    private static final Integer CAMEL_SOURCE_FTPS_ENDPOINT_MAX_MESSAGES_PER_POLL_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_MIN_DEPTH_CONF = "camel.source.endpoint.minDepth";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_MIN_DEPTH_DOC = "The minimum depth to start processing when recursively processing a directory. Using minDepth=1 means the base directory. Using minDepth=2 means the first sub directory.";
    private static final Integer CAMEL_SOURCE_FTPS_ENDPOINT_MIN_DEPTH_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_MOVE_CONF = "camel.source.endpoint.move";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_MOVE_DOC = "Expression (such as Simple Language) used to dynamically set the filename when moving it after processing. To move files into a .done subdirectory just enter .done.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_MOVE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_EXCLUSIVE_READ_LOCK_STRATEGY_DOC = "Pluggable read-lock as a org.apache.camel.component.file.GenericFileExclusiveReadLockStrategy implementation.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_EXCLUSIVE_READ_LOCK_STRATEGY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_READ_LOCK_DEFAULT = "none";
    ...
    private static final Long CAMEL_SOURCE_FTPS_ENDPOINT_READ_LOCK_CHECK_INTERVAL_DEFAULT = 1000L;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_READ_LOCK_DELETE_ORPHAN_LOCK_FILES_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_READ_LOCK_LOGGING_LEVEL_DEFAULT = "DEBUG";
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_READ_LOCK_MARKER_FILE_DEFAULT = true;
    ...
    private static final Long CAMEL_SOURCE_FTPS_ENDPOINT_READ_LOCK_MIN_AGE_DEFAULT = 0L;
    ...
    private static final Long CAMEL_SOURCE_FTPS_ENDPOINT_READ_LOCK_MIN_LENGTH_DEFAULT = 1L;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_READ_LOCK_REMOVE_ON_COMMIT_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_READ_LOCK_REMOVE_ON_ROLLBACK_DEFAULT = true;
    ...
    private static final Long CAMEL_SOURCE_FTPS_ENDPOINT_READ_LOCK_TIMEOUT_DEFAULT = 10000L;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DOC = "The number of subsequent error polls (failed due some error) that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_FTPS_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DOC = "The number of subsequent idle polls that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_FTPS_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_FTPS_ENDPOINT_BACKOFF_MULTIPLIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll.";
    private static final Long CAMEL_SOURCE_FTPS_ENDPOINT_DELAY_DEFAULT = 500L;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_GREEDY_CONF = "camel.source.endpoint.greedy";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_GREEDY_DOC = "If greedy is enabled, then the ScheduledPollConsumer will run immediately again, if the previous run polled 1 or more messages.";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_GREEDY_DEFAULT = false;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_INITIAL_DELAY_CONF = "camel.source.endpoint.initialDelay";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts.";
    private static final Long CAMEL_SOURCE_FTPS_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_REPEAT_COUNT_CONF = "camel.source.endpoint.repeatCount";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_REPEAT_COUNT_DOC = "Specifies a maximum limit of number of fires. So if you set it to 1, the scheduler will only fire once. If you set it to 5, it will only fire five times. A value of zero or negative means fire forever.";
    private static final Long CAMEL_SOURCE_FTPS_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_RUN_LOGGING_LEVEL_CONF = "camel.source.endpoint.runLoggingLevel";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_RUN_LOGGING_LEVEL_DOC = "The consumer logs a start/complete log line when it polls. This option allows you to configure the logging level for that. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_RUN_LOGGING_LEVEL_DEFAULT = "TRACE";
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DOC = "Allows for configuring a custom/shared thread pool to use for the consumer. By default each consumer has its own single threaded thread pool.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_SCHEDULER_CONF = "camel.source.endpoint.scheduler";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component One of: [none] [spring] [quartz]";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SCHEDULER_DEFAULT = "none";
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SCHEDULER_PROPERTIES_DOC = "To configure additional properties when using a custom scheduler or any of the Quartz, Spring based scheduler.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SCHEDULER_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_START_SCHEDULER_CONF = "camel.source.endpoint.startScheduler";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_START_SCHEDULER_DOC = "Whether the scheduler should be auto started.";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_START_SCHEDULER_DEFAULT = true;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_TIME_UNIT_CONF = "camel.source.endpoint.timeUnit";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_TIME_UNIT_DOC = "Time unit for initialDelay and delay options. One of: [NANOSECONDS] [MICROSECONDS] [MILLISECONDS] [SECONDS] [MINUTES] [HOURS] [DAYS]";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_TIME_UNIT_DEFAULT = "MILLISECONDS";
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_USE_FIXED_DELAY_CONF = "camel.source.endpoint.useFixedDelay";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_USE_FIXED_DELAY_DOC = "Controls if fixed delay or fixed rate is used. See ScheduledExecutorService in JDK for details.";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_USE_FIXED_DELAY_DEFAULT = true;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_ACCOUNT_CONF = "camel.source.endpoint.account";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_ACCOUNT_DOC = "Account to use for login";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_ACCOUNT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_DISABLE_SECURE_DATA_CHANNEL_DEFAULTS_DOC = "Use this option to disable default options when using secure data channel. This allows you to be in full control what the execPbsz and execProt setting should be used. Default is false";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_DISABLE_SECURE_DATA_CHANNEL_DEFAULTS_DEFAULT = false;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_EXEC_PBSZ_CONF = "camel.source.endpoint.execPbsz";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_EXEC_PBSZ_DOC = "When using secure data channel you can set the exec protection buffer size";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_EXEC_PBSZ_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_EXEC_PROT_CONF = "camel.source.endpoint.execProt";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_EXEC_PROT_DOC = "The exec protection level PROT command. C - Clear S - Safe(SSL protocol only) E - Confidential(SSL protocol only) P - Private";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_EXEC_PROT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_KEY_STORE_PARAMETERS_DOC = "Set the key store parameters";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_KEY_STORE_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_TRUST_STORE_PARAMETERS_DOC = "Set the trust store parameters";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_FTP_CLIENT_TRUST_STORE_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_IMPLICIT_CONF = "camel.source.endpoint.implicit";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_IMPLICIT_DOC = "Set the security mode (Implicit/Explicit). true - Implicit Mode / False - Explicit Mode";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_IMPLICIT_DEFAULT = false;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_PASSWORD_DOC = "Password to use for login";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_SECURITY_PROTOCOL_CONF = "camel.source.endpoint.securityProtocol";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SECURITY_PROTOCOL_DOC = "Set the underlying security protocol.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SECURITY_PROTOCOL_DEFAULT = "TLSv1.2";
    ...
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "Gets the JSSE configuration that overrides any settings in FtpsEndpoint#ftpClientKeyStoreParameters, ftpClientTrustStoreParameters, and FtpsConfiguration#getSecurityProtocol().";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_USERNAME_DOC = "Username to use for login";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_SHUFFLE_CONF = "camel.source.endpoint.shuffle";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SHUFFLE_DOC = "To shuffle the list of files (sort in random order)";
    private static final Boolean CAMEL_SOURCE_FTPS_ENDPOINT_SHUFFLE_DEFAULT = false;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_SORT_BY_CONF = "camel.source.endpoint.sortBy";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SORT_BY_DOC = "Built-in sort by using the File Language. Supports nested sorts, so you can have a sort by file name and as a 2nd group sort by modified date.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SORT_BY_DEFAULT = null;
    public static final String CAMEL_SOURCE_FTPS_ENDPOINT_SORTER_CONF = "camel.source.endpoint.sorter";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SORTER_DOC = "Pluggable sorter as a java.util.Comparator class.";
    private static final String CAMEL_SOURCE_FTPS_ENDPOINT_SORTER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_FTPS_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_FTPS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_FTPS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_FTPS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SOURCE_FTPS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
