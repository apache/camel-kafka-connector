...
public class CamelMongodbgridfsSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_MONGODBGRIDFS_COMPONENT_AUTOWIRED_ENABLED_CONF = "camel.component.mongodb-gridfs.autowiredEnabled";
    ...
    public static final Boolean CAMEL_SINK_MONGODBGRIDFS_COMPONENT_AUTOWIRED_ENABLED_DEFAULT = true;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_MONGODBGRIDFS_COMPONENT_AUTOWIRED_ENABLED_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_MONGODBGRIDFS_COMPONENT_AUTOWIRED_ENABLED_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_MONGODBGRIDFS_COMPONENT_AUTOWIRED_ENABLED_DOC);
        return conf;
    }
}