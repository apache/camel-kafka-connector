...
public class CamelMongodbgridfsSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_PATH_CONNECTION_BEAN_DOC = "Name of com.mongodb.client.MongoClient to use.";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_PATH_CONNECTION_BEAN_DEFAULT = null;
    public static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_BUCKET_CONF = "camel.source.endpoint.bucket";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_BUCKET_DOC = "Sets the name of the GridFS bucket within the database. Default is fs.";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_BUCKET_DEFAULT = "fs";
    public static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_DATABASE_CONF = "camel.source.endpoint.database";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_DATABASE_DOC = "Sets the name of the MongoDB database to target";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_DATABASE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_READ_PREFERENCE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_WRITE_CONCERN_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_DELAY_DOC = "Sets the delay between polls within the Consumer. Default is 500ms";
    private static final Long CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_DELAY_DEFAULT = 500L;
    ...
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_FILE_ATTRIBUTE_NAME_DOC = "If the QueryType uses a FileAttribute, this sets the name of the attribute that is used. Default is camel-processed.";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_FILE_ATTRIBUTE_NAME_DEFAULT = "camel-processed";
    public static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_INITIAL_DELAY_CONF = "camel.source.endpoint.initialDelay";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_INITIAL_DELAY_DOC = "Sets the initialDelay before the consumer will start polling. Default is 1000ms";
    private static final Long CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    ...
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_PERSISTENT_TSCOLLECTION_DOC = "If the QueryType uses a persistent timestamp, this sets the name of the collection within the DB to store the timestamp.";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_PERSISTENT_TSCOLLECTION_DEFAULT = "camel-timestamps";
    ...
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_PERSISTENT_TSOBJECT_DOC = "If the QueryType uses a persistent timestamp, this is the ID of the object in the collection to store the timestamp.";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_PERSISTENT_TSOBJECT_DEFAULT = "camel-timestamp";
    public static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_QUERY_CONF = "camel.source.endpoint.query";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_QUERY_DOC = "Additional query parameters (in JSON) that are used to configure the query used for finding files in the GridFsConsumer";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_QUERY_DEFAULT = null;
    public static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_QUERY_STRATEGY_CONF = "camel.source.endpoint.queryStrategy";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_QUERY_STRATEGY_DOC = "Sets the QueryStrategy that is used for polling for new files. Default is Timestamp One of: [TimeStamp] [PersistentTimestamp] [FileAttribute] [TimeStampAndFileAttribute] [PersistentTimestampAndFileAttribute]";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_QUERY_STRATEGY_DEFAULT = "TimeStamp";
    ...
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_MONGODBGRIDFS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_MONGODBGRIDFS_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_MONGODBGRIDFS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_MONGODBGRIDFS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
