...
public class CamelTelegramSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_TELEGRAM_PATH_TYPE_DOC = "The endpoint type. Currently, only the 'bots' type is supported. One of: [bots]";
    private static final String CAMEL_SINK_TELEGRAM_PATH_TYPE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_CHAT_ID_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_TELEGRAM_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_TELEGRAM_ENDPOINT_BASE_URI_CONF = "camel.sink.endpoint.baseUri";
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_BASE_URI_DOC = "Can be used to set an alternative base URI, e.g. when you want to test the component against a mock Telegram API";
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_BASE_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_TELEGRAM_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_TELEGRAM_ENDPOINT_BUFFER_SIZE_CONF = "camel.sink.endpoint.bufferSize";
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_BUFFER_SIZE_DOC = "The initial in-memory buffer size used when transferring data between Camel and AHC Client.";
    private static final Integer CAMEL_SINK_TELEGRAM_ENDPOINT_BUFFER_SIZE_DEFAULT = 4096;
    public static final String CAMEL_SINK_TELEGRAM_ENDPOINT_CLIENT_CONFIG_CONF = "camel.sink.endpoint.clientConfig";
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_CLIENT_CONFIG_DOC = "To configure the AsyncHttpClient to use a custom com.ning.http.client.AsyncHttpClientConfig instance.";
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_CLIENT_CONFIG_DEFAULT = null;
    public static final String CAMEL_SINK_TELEGRAM_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_TELEGRAM_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_TELEGRAM_ENDPOINT_PROXY_HOST_CONF = "camel.sink.endpoint.proxyHost";
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_PROXY_HOST_DOC = "HTTP proxy host which could be used when sending out the message.";
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_TELEGRAM_ENDPOINT_PROXY_PORT_CONF = "camel.sink.endpoint.proxyPort";
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_PROXY_PORT_DOC = "HTTP proxy port which could be used when sending out the message.";
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_TELEGRAM_ENDPOINT_AUTHORIZATION_TOKEN_CONF = "camel.sink.endpoint.authorizationToken";
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_AUTHORIZATION_TOKEN_DOC = "The authorization token for using the bot (ask the BotFather)";
    private static final String CAMEL_SINK_TELEGRAM_ENDPOINT_AUTHORIZATION_TOKEN_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_TELEGRAM_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_TELEGRAM_COMPONENT_BASE_URI_CONF = "camel.component.telegram.baseUri";
    private static final String CAMEL_SINK_TELEGRAM_COMPONENT_BASE_URI_DOC = "Can be used to set an alternative base URI, e.g. when you want to test the component against a mock Telegram API";
    private static final String CAMEL_SINK_TELEGRAM_COMPONENT_BASE_URI_DEFAULT = "https://api.telegram.org";
    ...
    private static final String CAMEL_SINK_TELEGRAM_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_TELEGRAM_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_TELEGRAM_COMPONENT_CLIENT_CONF = "camel.component.telegram.client";
    private static final String CAMEL_SINK_TELEGRAM_COMPONENT_CLIENT_DOC = "To use a custom AsyncHttpClient";
    private static final String CAMEL_SINK_TELEGRAM_COMPONENT_CLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_TELEGRAM_COMPONENT_CLIENT_CONFIG_CONF = "camel.component.telegram.clientConfig";
    private static final String CAMEL_SINK_TELEGRAM_COMPONENT_CLIENT_CONFIG_DOC = "To configure the AsyncHttpClient to use a custom com.ning.http.client.AsyncHttpClientConfig instance.";
    private static final String CAMEL_SINK_TELEGRAM_COMPONENT_CLIENT_CONFIG_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_TELEGRAM_COMPONENT_AUTHORIZATION_TOKEN_DOC = "The default Telegram authorization token to be used when the information is not provided in the endpoints.";
    private static final String CAMEL_SINK_TELEGRAM_COMPONENT_AUTHORIZATION_TOKEN_DEFAULT = null;
