...
public class CamelSpringintegrationSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_SPRINGINTEGRATION_PATH_DEFAULT_CHANNEL_DOC = "The default channel name which is used by the Spring Integration Spring context. It will equal to the inputChannel name for the Spring Integration consumer and the outputChannel name for the Spring Integration provider.";
    public static final String CAMEL_SINK_SPRINGINTEGRATION_PATH_DEFAULT_CHANNEL_DEFAULT = null;
    public static final String CAMEL_SINK_SPRINGINTEGRATION_ENDPOINT_IN_OUT_CONF = "camel.sink.endpoint.inOut";
    public static final String CAMEL_SINK_SPRINGINTEGRATION_ENDPOINT_IN_OUT_DOC = "The exchange pattern that the Spring integration endpoint should use. If inOut=true then a reply channel is expected, either from the Spring Integration Message header or configured on the endpoint.";
    public static final Boolean CAMEL_SINK_SPRINGINTEGRATION_ENDPOINT_IN_OUT_DEFAULT = false;
    ...
    public static final Boolean CAMEL_SINK_SPRINGINTEGRATION_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_SPRINGINTEGRATION_ENDPOINT_OUTPUT_CHANNEL_CONF = "camel.sink.endpoint.outputChannel";
    public static final String CAMEL_SINK_SPRINGINTEGRATION_ENDPOINT_OUTPUT_CHANNEL_DOC = "The Spring integration output channel name that is used to send messages to Spring integration.";
    public static final String CAMEL_SINK_SPRINGINTEGRATION_ENDPOINT_OUTPUT_CHANNEL_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_SPRINGINTEGRATION_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SINK_SPRINGINTEGRATION_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SPRINGINTEGRATION_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    public static final String CAMEL_SINK_SPRINGINTEGRATION_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    public static final Boolean CAMEL_SINK_SPRINGINTEGRATION_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    public static final Boolean CAMEL_SINK_SPRINGINTEGRATION_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_SPRINGINTEGRATION_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SINK_SPRINGINTEGRATION_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_SPRINGINTEGRATION_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_SPRINGINTEGRATION_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_SPRINGINTEGRATION_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
        return conf;
    }
}