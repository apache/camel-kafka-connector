...
public class CamelKafkaazureschemaregistrysourceSourceTask
        extends
            CamelSourceTask {
    ...
    protected CamelSourceConnectorConfig getCamelSourceConnectorConfig(
        ...
        return new CamelKafkaazureschemaregistrysourceSourceConnectorConfig(props);
    }
    @Override
    protected String getSourceKamelet() {
        return "kamelet:kafka-azure-schema-registry-source";
    }
}