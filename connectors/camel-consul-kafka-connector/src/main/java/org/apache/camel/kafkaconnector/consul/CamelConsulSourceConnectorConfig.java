...
public class CamelConsulSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_CONSUL_PATH_API_ENDPOINT_DOC = "The API endpoint";
    private static final String CAMEL_SOURCE_CONSUL_PATH_API_ENDPOINT_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_CONNECT_TIMEOUT_CONF = "camel.source.endpoint.connectTimeout";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_CONNECT_TIMEOUT_DOC = "Connect timeout for OkHttpClient";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_CONNECT_TIMEOUT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_CONNECT_TIMEOUT_MILLIS_DOC = "Connect timeout for OkHttpClient. Deprecation note: Use connectTimeout instead";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_CONNECT_TIMEOUT_MILLIS_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_CONSUL_CLIENT_CONF = "camel.source.endpoint.consulClient";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_CONSUL_CLIENT_DOC = "Reference to a com.orbitz.consul.Consul in the registry.";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_CONSUL_CLIENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_KEY_CONF = "camel.source.endpoint.key";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_KEY_DOC = "The default key. Can be overridden by CamelConsulKey";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_KEY_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_PING_INSTANCE_CONF = "camel.source.endpoint.pingInstance";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_PING_INSTANCE_DOC = "Configure if the AgentClient should attempt a ping before returning the Consul instance";
    private static final Boolean CAMEL_SOURCE_CONSUL_ENDPOINT_PING_INSTANCE_DEFAULT = true;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_READ_TIMEOUT_CONF = "camel.source.endpoint.readTimeout";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_READ_TIMEOUT_DOC = "Read timeout for OkHttpClient";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_READ_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_READ_TIMEOUT_MILLIS_CONF = "camel.source.endpoint.readTimeoutMillis";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_READ_TIMEOUT_MILLIS_DOC = "Read timeout for OkHttpClient. Deprecation note: Use readTimeout instead";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_READ_TIMEOUT_MILLIS_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_TAGS_CONF = "camel.source.endpoint.tags";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_TAGS_DOC = "Set tags. You can separate multiple tags by comma.";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_TAGS_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_URL_CONF = "camel.source.endpoint.url";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_URL_DOC = "The Consul agent URL";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_URL_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_WRITE_TIMEOUT_CONF = "camel.source.endpoint.writeTimeout";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_WRITE_TIMEOUT_DOC = "Write timeout for OkHttpClient";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_WRITE_TIMEOUT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_WRITE_TIMEOUT_MILLIS_DOC = "Write timeout for OkHttpClient. Deprecation note: Use writeTimeout instead";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_WRITE_TIMEOUT_MILLIS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_CONSUL_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.source.endpoint.basicPropertyBinding";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_CONSUL_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_CONSISTENCY_MODE_CONF = "camel.source.endpoint.consistencyMode";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_CONSISTENCY_MODE_DOC = "The consistencyMode used for queries, default ConsistencyMode.DEFAULT One of: [DEFAULT] [STALE] [CONSISTENT]";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_CONSISTENCY_MODE_DEFAULT = "DEFAULT";
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_DATACENTER_CONF = "camel.source.endpoint.datacenter";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_DATACENTER_DOC = "The data center";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_DATACENTER_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_NEAR_NODE_CONF = "camel.source.endpoint.nearNode";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_NEAR_NODE_DOC = "The near node to use for queries.";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_NEAR_NODE_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_NODE_META_CONF = "camel.source.endpoint.nodeMeta";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_NODE_META_DOC = "The note meta-data to use for queries.";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_NODE_META_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_CONSUL_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_ACL_TOKEN_CONF = "camel.source.endpoint.aclToken";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_ACL_TOKEN_DOC = "Sets the ACL token to be used with Consul";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_ACL_TOKEN_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_PASSWORD_DOC = "Sets the password to be used for basic authentication";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "SSL configuration using an org.apache.camel.support.jsse.SSLContextParameters instance.";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_USER_NAME_CONF = "camel.source.endpoint.userName";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_USER_NAME_DOC = "Sets the username to be used for basic authentication";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_USER_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_BLOCK_SECONDS_CONF = "camel.source.endpoint.blockSeconds";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_BLOCK_SECONDS_DOC = "The second to wait for a watch event, default 10 seconds";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_BLOCK_SECONDS_DEFAULT = "10";
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_FIRST_INDEX_CONF = "camel.source.endpoint.firstIndex";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_FIRST_INDEX_DOC = "The first index for watch for, default 0";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_FIRST_INDEX_DEFAULT = "0";
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_RECURSIVE_CONF = "camel.source.endpoint.recursive";
    private static final String CAMEL_SOURCE_CONSUL_ENDPOINT_RECURSIVE_DOC = "Recursively watch, default false";
    private static final Boolean CAMEL_SOURCE_CONSUL_ENDPOINT_RECURSIVE_DEFAULT = false;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONNECT_TIMEOUT_CONF = "camel.component.consul.connectTimeout";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONNECT_TIMEOUT_DOC = "Connect timeout for OkHttpClient";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONNECT_TIMEOUT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONNECT_TIMEOUT_MILLIS_DOC = "Connect timeout for OkHttpClient. Deprecation note: Use connectTimeout instead";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONNECT_TIMEOUT_MILLIS_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONSUL_CLIENT_CONF = "camel.component.consul.consulClient";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONSUL_CLIENT_DOC = "Reference to a com.orbitz.consul.Consul in the registry.";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONSUL_CLIENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_KEY_CONF = "camel.component.consul.key";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_KEY_DOC = "The default key. Can be overridden by CamelConsulKey";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_KEY_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_PING_INSTANCE_CONF = "camel.component.consul.pingInstance";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_PING_INSTANCE_DOC = "Configure if the AgentClient should attempt a ping before returning the Consul instance";
    private static final Boolean CAMEL_SOURCE_CONSUL_COMPONENT_PING_INSTANCE_DEFAULT = true;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_READ_TIMEOUT_CONF = "camel.component.consul.readTimeout";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_READ_TIMEOUT_DOC = "Read timeout for OkHttpClient";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_READ_TIMEOUT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_READ_TIMEOUT_MILLIS_DOC = "Read timeout for OkHttpClient. Deprecation note: Use readTimeout instead";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_READ_TIMEOUT_MILLIS_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_TAGS_CONF = "camel.component.consul.tags";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_TAGS_DOC = "Set tags. You can separate multiple tags by comma.";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_TAGS_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_URL_CONF = "camel.component.consul.url";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_URL_DOC = "The Consul agent URL";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_URL_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_WRITE_TIMEOUT_CONF = "camel.component.consul.writeTimeout";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_WRITE_TIMEOUT_DOC = "Write timeout for OkHttpClient";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_WRITE_TIMEOUT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_WRITE_TIMEOUT_MILLIS_DOC = "Write timeout for OkHttpClient. Deprecation note: Use writeTimeout instead";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_WRITE_TIMEOUT_MILLIS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_CONSUL_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.consul.basicPropertyBinding";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_CONSUL_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONFIGURATION_CONF = "camel.component.consul.configuration";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONFIGURATION_DOC = "Consul configuration";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONSISTENCY_MODE_CONF = "camel.component.consul.consistencyMode";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONSISTENCY_MODE_DOC = "The consistencyMode used for queries, default ConsistencyMode.DEFAULT One of: [DEFAULT] [STALE] [CONSISTENT]";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONSISTENCY_MODE_DEFAULT = "DEFAULT";
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_DATACENTER_CONF = "camel.component.consul.datacenter";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_DATACENTER_DOC = "The data center";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_DATACENTER_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_NEAR_NODE_CONF = "camel.component.consul.nearNode";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_NEAR_NODE_DOC = "The near node to use for queries.";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_NEAR_NODE_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_NODE_META_CONF = "camel.component.consul.nodeMeta";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_NODE_META_DOC = "The note meta-data to use for queries.";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_NODE_META_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_ACL_TOKEN_CONF = "camel.component.consul.aclToken";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_ACL_TOKEN_DOC = "Sets the ACL token to be used with Consul";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_ACL_TOKEN_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_PASSWORD_CONF = "camel.component.consul.password";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_PASSWORD_DOC = "Sets the password to be used for basic authentication";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "SSL configuration using an org.apache.camel.support.jsse.SSLContextParameters instance.";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SOURCE_CONSUL_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_USER_NAME_CONF = "camel.component.consul.userName";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_USER_NAME_DOC = "Sets the username to be used for basic authentication";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_USER_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_BLOCK_SECONDS_CONF = "camel.component.consul.blockSeconds";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_BLOCK_SECONDS_DOC = "The second to wait for a watch event, default 10 seconds";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_BLOCK_SECONDS_DEFAULT = "10";
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_FIRST_INDEX_CONF = "camel.component.consul.firstIndex";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_FIRST_INDEX_DOC = "The first index for watch for, default 0";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_FIRST_INDEX_DEFAULT = "0";
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_RECURSIVE_CONF = "camel.component.consul.recursive";
    private static final String CAMEL_SOURCE_CONSUL_COMPONENT_RECURSIVE_DOC = "Recursively watch, default false";
    private static final Boolean CAMEL_SOURCE_CONSUL_COMPONENT_RECURSIVE_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_CONSUL_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_CONSUL_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_CONSUL_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
        ...
        conf.define(CAMEL_SOURCE_CONSUL_ENDPOINT_SYNCHRONOUS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_CONSUL_ENDPOINT_SYNCHRONOUS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_CONSUL_ENDPOINT_SYNCHRONOUS_DOC);
