...
public class CamelConsulSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_CONNECT_TIMEOUT_MILLIS_DOC = "Connect timeout for OkHttpClient";
    ...
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_READ_TIMEOUT_MILLIS_DOC = "Read timeout for OkHttpClient";
    ...
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_WRITE_TIMEOUT_MILLIS_DOC = "Write timeout for OkHttpClient";
    ...
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_CONSUL_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_CONSUL_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    public static final Boolean CAMEL_SOURCE_CONSUL_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_CONNECT_TIMEOUT_MILLIS_DOC = "Connect timeout for OkHttpClient";
    ...
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_READ_TIMEOUT_MILLIS_DOC = "Read timeout for OkHttpClient";
    ...
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_WRITE_TIMEOUT_MILLIS_DOC = "Write timeout for OkHttpClient";
    ...
    public static final String CAMEL_SOURCE_CONSUL_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_CONSUL_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_CONSUL_ENDPOINT_CONNECT_TIMEOUT_MILLIS_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_CONSUL_ENDPOINT_CONNECT_TIMEOUT_MILLIS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_CONSUL_ENDPOINT_CONNECT_TIMEOUT_MILLIS_DOC);
        ...
        conf.define(CAMEL_SOURCE_CONSUL_ENDPOINT_READ_TIMEOUT_MILLIS_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_CONSUL_ENDPOINT_READ_TIMEOUT_MILLIS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_CONSUL_ENDPOINT_READ_TIMEOUT_MILLIS_DOC);
        ...
        conf.define(CAMEL_SOURCE_CONSUL_ENDPOINT_WRITE_TIMEOUT_MILLIS_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_CONSUL_ENDPOINT_WRITE_TIMEOUT_MILLIS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_CONSUL_ENDPOINT_WRITE_TIMEOUT_MILLIS_DOC);
        ...
        conf.define(CAMEL_SOURCE_CONSUL_COMPONENT_CONNECT_TIMEOUT_MILLIS_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_CONSUL_COMPONENT_CONNECT_TIMEOUT_MILLIS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_CONSUL_COMPONENT_CONNECT_TIMEOUT_MILLIS_DOC);
        ...
        conf.define(CAMEL_SOURCE_CONSUL_COMPONENT_READ_TIMEOUT_MILLIS_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_CONSUL_COMPONENT_READ_TIMEOUT_MILLIS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_CONSUL_COMPONENT_READ_TIMEOUT_MILLIS_DOC);
        ...
        conf.define(CAMEL_SOURCE_CONSUL_COMPONENT_WRITE_TIMEOUT_MILLIS_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_CONSUL_COMPONENT_WRITE_TIMEOUT_MILLIS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_CONSUL_COMPONENT_WRITE_TIMEOUT_MILLIS_DOC);
