...
public class CamelConsulSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_CONSUL_PATH_API_ENDPOINT_DOC = "The API endpoint";
    private static final String CAMEL_SINK_CONSUL_PATH_API_ENDPOINT_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_CONNECT_TIMEOUT_CONF = "camel.sink.endpoint.connectTimeout";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_CONNECT_TIMEOUT_DOC = "Connect timeout for OkHttpClient";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_CONNECT_TIMEOUT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_CONNECT_TIMEOUT_MILLIS_DOC = "Connect timeout for OkHttpClient. Deprecation note: Use connectTimeout instead";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_CONNECT_TIMEOUT_MILLIS_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_CONSUL_CLIENT_CONF = "camel.sink.endpoint.consulClient";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_CONSUL_CLIENT_DOC = "Reference to a com.orbitz.consul.Consul in the registry.";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_CONSUL_CLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_KEY_CONF = "camel.sink.endpoint.key";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_KEY_DOC = "The default key. Can be overridden by CamelConsulKey";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_PING_INSTANCE_CONF = "camel.sink.endpoint.pingInstance";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_PING_INSTANCE_DOC = "Configure if the AgentClient should attempt a ping before returning the Consul instance";
    private static final Boolean CAMEL_SINK_CONSUL_ENDPOINT_PING_INSTANCE_DEFAULT = true;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_READ_TIMEOUT_CONF = "camel.sink.endpoint.readTimeout";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_READ_TIMEOUT_DOC = "Read timeout for OkHttpClient";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_READ_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_READ_TIMEOUT_MILLIS_CONF = "camel.sink.endpoint.readTimeoutMillis";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_READ_TIMEOUT_MILLIS_DOC = "Read timeout for OkHttpClient. Deprecation note: Use readTimeout instead";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_READ_TIMEOUT_MILLIS_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_TAGS_CONF = "camel.sink.endpoint.tags";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_TAGS_DOC = "Set tags. You can separate multiple tags by comma.";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_TAGS_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_URL_CONF = "camel.sink.endpoint.url";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_URL_DOC = "The Consul agent URL";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_URL_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_WRITE_TIMEOUT_CONF = "camel.sink.endpoint.writeTimeout";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_WRITE_TIMEOUT_DOC = "Write timeout for OkHttpClient";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_WRITE_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_WRITE_TIMEOUT_MILLIS_CONF = "camel.sink.endpoint.writeTimeoutMillis";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_WRITE_TIMEOUT_MILLIS_DOC = "Write timeout for OkHttpClient. Deprecation note: Use writeTimeout instead";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_WRITE_TIMEOUT_MILLIS_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_ACTION_CONF = "camel.sink.endpoint.action";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_ACTION_DOC = "The default action. Can be overridden by CamelConsulAction";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_ACTION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_CONSUL_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_VALUE_AS_STRING_CONF = "camel.sink.endpoint.valueAsString";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_VALUE_AS_STRING_DOC = "Default to transform values retrieved from Consul i.e. on KV endpoint to string.";
    private static final Boolean CAMEL_SINK_CONSUL_ENDPOINT_VALUE_AS_STRING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CONSUL_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_CONSISTENCY_MODE_CONF = "camel.sink.endpoint.consistencyMode";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_CONSISTENCY_MODE_DOC = "The consistencyMode used for queries, default ConsistencyMode.DEFAULT One of: [DEFAULT] [STALE] [CONSISTENT]";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_CONSISTENCY_MODE_DEFAULT = "DEFAULT";
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_DATACENTER_CONF = "camel.sink.endpoint.datacenter";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_DATACENTER_DOC = "The data center";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_DATACENTER_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_NEAR_NODE_CONF = "camel.sink.endpoint.nearNode";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_NEAR_NODE_DOC = "The near node to use for queries.";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_NEAR_NODE_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_NODE_META_CONF = "camel.sink.endpoint.nodeMeta";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_NODE_META_DOC = "The note meta-data to use for queries.";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_NODE_META_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_CONSUL_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_ACL_TOKEN_CONF = "camel.sink.endpoint.aclToken";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_ACL_TOKEN_DOC = "Sets the ACL token to be used with Consul";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_ACL_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_PASSWORD_DOC = "Sets the password to be used for basic authentication";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "SSL configuration using an org.apache.camel.support.jsse.SSLContextParameters instance.";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_ENDPOINT_USER_NAME_CONF = "camel.sink.endpoint.userName";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_USER_NAME_DOC = "Sets the username to be used for basic authentication";
    private static final String CAMEL_SINK_CONSUL_ENDPOINT_USER_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_CONNECT_TIMEOUT_CONF = "camel.component.consul.connectTimeout";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_CONNECT_TIMEOUT_DOC = "Connect timeout for OkHttpClient";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_CONNECT_TIMEOUT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CONSUL_COMPONENT_CONNECT_TIMEOUT_MILLIS_DOC = "Connect timeout for OkHttpClient. Deprecation note: Use connectTimeout instead";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_CONNECT_TIMEOUT_MILLIS_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_CONSUL_CLIENT_CONF = "camel.component.consul.consulClient";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_CONSUL_CLIENT_DOC = "Reference to a com.orbitz.consul.Consul in the registry.";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_CONSUL_CLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_KEY_CONF = "camel.component.consul.key";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_KEY_DOC = "The default key. Can be overridden by CamelConsulKey";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_PING_INSTANCE_CONF = "camel.component.consul.pingInstance";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_PING_INSTANCE_DOC = "Configure if the AgentClient should attempt a ping before returning the Consul instance";
    private static final Boolean CAMEL_SINK_CONSUL_COMPONENT_PING_INSTANCE_DEFAULT = true;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_READ_TIMEOUT_CONF = "camel.component.consul.readTimeout";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_READ_TIMEOUT_DOC = "Read timeout for OkHttpClient";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_READ_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_READ_TIMEOUT_MILLIS_CONF = "camel.component.consul.readTimeoutMillis";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_READ_TIMEOUT_MILLIS_DOC = "Read timeout for OkHttpClient. Deprecation note: Use readTimeout instead";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_READ_TIMEOUT_MILLIS_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_TAGS_CONF = "camel.component.consul.tags";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_TAGS_DOC = "Set tags. You can separate multiple tags by comma.";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_TAGS_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_URL_CONF = "camel.component.consul.url";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_URL_DOC = "The Consul agent URL";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_URL_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_WRITE_TIMEOUT_CONF = "camel.component.consul.writeTimeout";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_WRITE_TIMEOUT_DOC = "Write timeout for OkHttpClient";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_WRITE_TIMEOUT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CONSUL_COMPONENT_WRITE_TIMEOUT_MILLIS_DOC = "Write timeout for OkHttpClient. Deprecation note: Use writeTimeout instead";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_WRITE_TIMEOUT_MILLIS_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_ACTION_CONF = "camel.component.consul.action";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_ACTION_DOC = "The default action. Can be overridden by CamelConsulAction";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_ACTION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_CONSUL_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_VALUE_AS_STRING_CONF = "camel.component.consul.valueAsString";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_VALUE_AS_STRING_DOC = "Default to transform values retrieved from Consul i.e. on KV endpoint to string.";
    private static final Boolean CAMEL_SINK_CONSUL_COMPONENT_VALUE_AS_STRING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CONSUL_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CONSUL_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_CONFIGURATION_CONF = "camel.component.consul.configuration";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_CONFIGURATION_DOC = "Consul configuration";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_CONSISTENCY_MODE_CONF = "camel.component.consul.consistencyMode";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_CONSISTENCY_MODE_DOC = "The consistencyMode used for queries, default ConsistencyMode.DEFAULT One of: [DEFAULT] [STALE] [CONSISTENT]";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_CONSISTENCY_MODE_DEFAULT = "DEFAULT";
    public static final String CAMEL_SINK_CONSUL_COMPONENT_DATACENTER_CONF = "camel.component.consul.datacenter";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_DATACENTER_DOC = "The data center";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_DATACENTER_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_NEAR_NODE_CONF = "camel.component.consul.nearNode";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_NEAR_NODE_DOC = "The near node to use for queries.";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_NEAR_NODE_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_NODE_META_CONF = "camel.component.consul.nodeMeta";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_NODE_META_DOC = "The note meta-data to use for queries.";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_NODE_META_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_ACL_TOKEN_CONF = "camel.component.consul.aclToken";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_ACL_TOKEN_DOC = "Sets the ACL token to be used with Consul";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_ACL_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_PASSWORD_CONF = "camel.component.consul.password";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_PASSWORD_DOC = "Sets the password to be used for basic authentication";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CONSUL_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "SSL configuration using an org.apache.camel.support.jsse.SSLContextParameters instance.";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CONSUL_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SINK_CONSUL_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
    public static final String CAMEL_SINK_CONSUL_COMPONENT_USER_NAME_CONF = "camel.component.consul.userName";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_USER_NAME_DOC = "Sets the username to be used for basic authentication";
    private static final String CAMEL_SINK_CONSUL_COMPONENT_USER_NAME_DEFAULT = null;
