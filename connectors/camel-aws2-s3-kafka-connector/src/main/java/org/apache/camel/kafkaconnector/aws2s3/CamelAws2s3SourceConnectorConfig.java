...
public class CamelAws2s3SourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AWS2S3_ENDPOINT_IGNORE_BODY_CONF = "camel.source.endpoint.ignoreBody";
    public static final String CAMEL_SOURCE_AWS2S3_ENDPOINT_IGNORE_BODY_DOC = "If it is true, the S3 Object Body will be ignored completely, if it is set to false the S3 Object will be put in the body. Setting this to true, will override any behavior defined by includeBody option.";
    public static final Boolean CAMEL_SOURCE_AWS2S3_ENDPOINT_IGNORE_BODY_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_AWS2S3_COMPONENT_IGNORE_BODY_CONF = "camel.component.aws2-s3.ignoreBody";
    public static final String CAMEL_SOURCE_AWS2S3_COMPONENT_IGNORE_BODY_DOC = "If it is true, the S3 Object Body will be ignored completely, if it is set to false the S3 Object will be put in the body. Setting this to true, will override any behavior defined by includeBody option.";
    public static final Boolean CAMEL_SOURCE_AWS2S3_COMPONENT_IGNORE_BODY_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_AWS2S3_ENDPOINT_IGNORE_BODY_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AWS2S3_ENDPOINT_IGNORE_BODY_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWS2S3_ENDPOINT_IGNORE_BODY_DOC);
        ...
        conf.define(CAMEL_SOURCE_AWS2S3_COMPONENT_IGNORE_BODY_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AWS2S3_COMPONENT_IGNORE_BODY_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWS2S3_COMPONENT_IGNORE_BODY_DOC);
