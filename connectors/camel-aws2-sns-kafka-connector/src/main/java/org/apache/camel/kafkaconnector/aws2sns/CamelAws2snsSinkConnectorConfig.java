...
public class CamelAws2snsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWS2SNS_COMPONENT_REGION_DOC = "The region in which SNS client needs to work";
    ...
    public static final String CAMEL_SINK_AWS2SNS_COMPONENT_CONFIGURATION_DOC = "The AWS SNS default configuration";
