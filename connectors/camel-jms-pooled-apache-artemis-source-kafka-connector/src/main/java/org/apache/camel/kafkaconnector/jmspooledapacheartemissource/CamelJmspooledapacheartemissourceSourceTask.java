...
public class CamelJmspooledapacheartemissourceSourceTask
        extends
            CamelSourceTask {
    ...
    protected CamelSourceConnectorConfig getCamelSourceConnectorConfig(
        ...
        return new CamelJmspooledapacheartemissourceSourceConnectorConfig(props);
    }
    @Override
    protected String getSourceKamelet() {
        return "kamelet:jms-pooled-apache-artemis-source";
    }
}