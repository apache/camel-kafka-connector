...
public class CamelPop3sSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_POP3S_PATH_HOST_DOC = "The mail server host name";
    private static final String CAMEL_SOURCE_POP3S_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_PATH_PORT_CONF = "camel.source.path.port";
    private static final String CAMEL_SOURCE_POP3S_PATH_PORT_DOC = "The port number of the mail server";
    private static final Integer CAMEL_SOURCE_POP3S_PATH_PORT_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_CLOSE_FOLDER_CONF = "camel.source.endpoint.closeFolder";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_CLOSE_FOLDER_DOC = "Whether the consumer should close the folder after polling. Setting this option to false and having disconnect=false as well, then the consumer keep the folder open between polls.";
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_CLOSE_FOLDER_DEFAULT = true;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_COPY_TO_CONF = "camel.source.endpoint.copyTo";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_COPY_TO_DOC = "After processing a mail message, it can be copied to a mail folder with the given name. You can override this configuration value, with a header with the key copyTo, allowing you to copy messages to folder names configured at runtime.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_COPY_TO_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_DELETE_DEFAULT = false;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_DISCONNECT_CONF = "camel.source.endpoint.disconnect";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_DISCONNECT_DOC = "Whether the consumer should disconnect after polling. If enabled this forces Camel to connect on each poll.";
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_DISCONNECT_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_HANDLE_FAILED_MESSAGE_DEFAULT = false;
    ...
    private static final Integer CAMEL_SOURCE_POP3S_ENDPOINT_MAX_MESSAGES_PER_POLL_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_MIME_DECODE_HEADERS_CONF = "camel.source.endpoint.mimeDecodeHeaders";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_MIME_DECODE_HEADERS_DOC = "This option enables transparent MIME decoding and unfolding for mail headers.";
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_MIME_DECODE_HEADERS_DEFAULT = false;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_MOVE_TO_CONF = "camel.source.endpoint.moveTo";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_MOVE_TO_DOC = "After processing a mail message, it can be moved to a mail folder with the given name. You can override this configuration value, with a header with the key moveTo, allowing you to move messages to folder names configured at runtime.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_MOVE_TO_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_PEEK_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DOC = "If the polling consumer did not poll any files, you can enable this option to send an empty message (no body) instead.";
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_SKIP_FAILED_MESSAGE_DEFAULT = false;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_UNSEEN_CONF = "camel.source.endpoint.unseen";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_UNSEEN_DOC = "Whether to limit by unseen mails only.";
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_UNSEEN_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_POP3S_ENDPOINT_FETCH_SIZE_DEFAULT = -1;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_FOLDER_NAME_CONF = "camel.source.endpoint.folderName";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_FOLDER_NAME_DOC = "The folder to poll.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_FOLDER_NAME_DEFAULT = "INBOX";
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_MAIL_UID_GENERATOR_CONF = "camel.source.endpoint.mailUidGenerator";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_MAIL_UID_GENERATOR_DOC = "A pluggable MailUidGenerator that allows to use custom logic to generate UUID of the mail message.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_MAIL_UID_GENERATOR_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_MAP_MAIL_MESSAGE_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_POLL_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_POST_PROCESS_ACTION_CONF = "camel.source.endpoint.postProcessAction";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_POST_PROCESS_ACTION_DOC = "Refers to an MailBoxPostProcessAction for doing post processing tasks on the mailbox once the normal processing ended.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_POST_PROCESS_ACTION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_ADDITIONAL_JAVA_MAIL_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_ALTERNATIVE_BODY_HEADER_DEFAULT = "CamelMailAlternativeBody";
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_ATTACHMENTS_CONTENT_TRANSFER_ENCODING_RESOLVER_DOC = "To use a custom AttachmentsContentTransferEncodingResolver to resolve what content-type-encoding to use for attachments.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_ATTACHMENTS_CONTENT_TRANSFER_ENCODING_RESOLVER_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_AUTHENTICATOR_CONF = "camel.source.endpoint.authenticator";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_AUTHENTICATOR_DOC = "The authenticator for login. If set then the password and username are ignored. Can be used for tokens which can expire and therefore must be read dynamically.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_AUTHENTICATOR_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_BINDING_CONF = "camel.source.endpoint.binding";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_BINDING_DOC = "Sets the binding used to convert from a Camel message to and from a Mail message";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_BINDING_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_CONNECTION_TIMEOUT_CONF = "camel.source.endpoint.connectionTimeout";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_CONNECTION_TIMEOUT_DOC = "The connection timeout in milliseconds.";
    private static final Integer CAMEL_SOURCE_POP3S_ENDPOINT_CONNECTION_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_CONTENT_TYPE_CONF = "camel.source.endpoint.contentType";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_CONTENT_TYPE_DOC = "The mail message content type. Use text/html for HTML mails.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_CONTENT_TYPE_DEFAULT = "text/plain";
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_CONTENT_TYPE_RESOLVER_DOC = "Resolver to determine Content-Type for file attachments.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_CONTENT_TYPE_RESOLVER_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_DEBUG_MODE_CONF = "camel.source.endpoint.debugMode";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_DEBUG_MODE_DOC = "Enable debug mode on the underlying mail framework. The SUN Mail framework logs the debug messages to System.out by default.";
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_DEBUG_MODE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter headers.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_IGNORE_UNSUPPORTED_CHARSET_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_IGNORE_URI_SCHEME_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_JAVA_MAIL_PROPERTIES_DOC = "Sets the java mail options. Will clear any default properties and only use the properties provided for this method.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_JAVA_MAIL_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SESSION_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_USE_INLINE_ATTACHMENTS_DOC = "Whether to use disposition inline or attachment.";
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_USE_INLINE_ATTACHMENTS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_IDEMPOTENT_REPOSITORY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_IDEMPOTENT_REPOSITORY_REMOVE_ON_COMMIT_DEFAULT = true;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_SEARCH_TERM_CONF = "camel.source.endpoint.searchTerm";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SEARCH_TERM_DOC = "Refers to a javax.mail.search.SearchTerm which allows to filter mails based on search criteria such as subject, body, from, sent after a certain date etc.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SEARCH_TERM_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DOC = "The number of subsequent error polls (failed due some error) that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_POP3S_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DOC = "The number of subsequent idle polls that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_POP3S_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_POP3S_ENDPOINT_BACKOFF_MULTIPLIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll.";
    private static final Long CAMEL_SOURCE_POP3S_ENDPOINT_DELAY_DEFAULT = 60000L;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_GREEDY_CONF = "camel.source.endpoint.greedy";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_GREEDY_DOC = "If greedy is enabled, then the ScheduledPollConsumer will run immediately again, if the previous run polled 1 or more messages.";
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_GREEDY_DEFAULT = false;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_INITIAL_DELAY_CONF = "camel.source.endpoint.initialDelay";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts.";
    private static final Long CAMEL_SOURCE_POP3S_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_REPEAT_COUNT_CONF = "camel.source.endpoint.repeatCount";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_REPEAT_COUNT_DOC = "Specifies a maximum limit of number of fires. So if you set it to 1, the scheduler will only fire once. If you set it to 5, it will only fire five times. A value of zero or negative means fire forever.";
    private static final Long CAMEL_SOURCE_POP3S_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_RUN_LOGGING_LEVEL_CONF = "camel.source.endpoint.runLoggingLevel";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_RUN_LOGGING_LEVEL_DOC = "The consumer logs a start/complete log line when it polls. This option allows you to configure the logging level for that. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_RUN_LOGGING_LEVEL_DEFAULT = "TRACE";
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DOC = "Allows for configuring a custom/shared thread pool to use for the consumer. By default each consumer has its own single threaded thread pool.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_SCHEDULER_CONF = "camel.source.endpoint.scheduler";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component One of: [none] [spring] [quartz]";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SCHEDULER_DEFAULT = "none";
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SCHEDULER_PROPERTIES_DOC = "To configure additional properties when using a custom scheduler or any of the Quartz, Spring based scheduler.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SCHEDULER_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_START_SCHEDULER_CONF = "camel.source.endpoint.startScheduler";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_START_SCHEDULER_DOC = "Whether the scheduler should be auto started.";
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_START_SCHEDULER_DEFAULT = true;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_TIME_UNIT_CONF = "camel.source.endpoint.timeUnit";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_TIME_UNIT_DOC = "Time unit for initialDelay and delay options. One of: [NANOSECONDS] [MICROSECONDS] [MILLISECONDS] [SECONDS] [MINUTES] [HOURS] [DAYS]";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_TIME_UNIT_DEFAULT = "MILLISECONDS";
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_USE_FIXED_DELAY_CONF = "camel.source.endpoint.useFixedDelay";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_USE_FIXED_DELAY_DOC = "Controls if fixed delay or fixed rate is used. See ScheduledExecutorService in JDK for details.";
    private static final Boolean CAMEL_SOURCE_POP3S_ENDPOINT_USE_FIXED_DELAY_DEFAULT = true;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_PASSWORD_DOC = "The password for login. See also setAuthenticator(MailAuthenticator).";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_USERNAME_DOC = "The username for login. See also setAuthenticator(MailAuthenticator).";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_ENDPOINT_SORT_TERM_CONF = "camel.source.endpoint.sortTerm";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SORT_TERM_DOC = "Sorting order for messages. Only natively supported for IMAP. Emulated to some degree when using POP3 or when IMAP server does not have the SORT capability.";
    private static final String CAMEL_SOURCE_POP3S_ENDPOINT_SORT_TERM_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_CLOSE_FOLDER_CONF = "camel.component.pop3s.closeFolder";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_CLOSE_FOLDER_DOC = "Whether the consumer should close the folder after polling. Setting this option to false and having disconnect=false as well, then the consumer keep the folder open between polls.";
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_CLOSE_FOLDER_DEFAULT = true;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_COPY_TO_CONF = "camel.component.pop3s.copyTo";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_COPY_TO_DOC = "After processing a mail message, it can be copied to a mail folder with the given name. You can override this configuration value, with a header with the key copyTo, allowing you to copy messages to folder names configured at runtime.";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_COPY_TO_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_DELETE_DEFAULT = false;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_DISCONNECT_CONF = "camel.component.pop3s.disconnect";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_DISCONNECT_DOC = "Whether the consumer should disconnect after polling. If enabled this forces Camel to connect on each poll.";
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_DISCONNECT_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_HANDLE_FAILED_MESSAGE_DEFAULT = false;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_MIME_DECODE_HEADERS_CONF = "camel.component.pop3s.mimeDecodeHeaders";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_MIME_DECODE_HEADERS_DOC = "This option enables transparent MIME decoding and unfolding for mail headers.";
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_MIME_DECODE_HEADERS_DEFAULT = false;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_MOVE_TO_CONF = "camel.component.pop3s.moveTo";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_MOVE_TO_DOC = "After processing a mail message, it can be moved to a mail folder with the given name. You can override this configuration value, with a header with the key moveTo, allowing you to move messages to folder names configured at runtime.";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_MOVE_TO_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_PEEK_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_SKIP_FAILED_MESSAGE_DEFAULT = false;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_UNSEEN_CONF = "camel.component.pop3s.unseen";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_UNSEEN_DOC = "Whether to limit by unseen mails only.";
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_UNSEEN_DEFAULT = true;
    ...
    private static final Integer CAMEL_SOURCE_POP3S_COMPONENT_FETCH_SIZE_DEFAULT = -1;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_FOLDER_NAME_CONF = "camel.component.pop3s.folderName";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_FOLDER_NAME_DOC = "The folder to poll.";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_FOLDER_NAME_DEFAULT = "INBOX";
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_MAP_MAIL_MESSAGE_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_ADDITIONAL_JAVA_MAIL_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_ALTERNATIVE_BODY_HEADER_DEFAULT = "CamelMailAlternativeBody";
    ...
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_ATTACHMENTS_CONTENT_TRANSFER_ENCODING_RESOLVER_DOC = "To use a custom AttachmentsContentTransferEncodingResolver to resolve what content-type-encoding to use for attachments.";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_ATTACHMENTS_CONTENT_TRANSFER_ENCODING_RESOLVER_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_AUTHENTICATOR_CONF = "camel.component.pop3s.authenticator";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_AUTHENTICATOR_DOC = "The authenticator for login. If set then the password and username are ignored. Can be used for tokens which can expire and therefore must be read dynamically.";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_AUTHENTICATOR_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_CONFIGURATION_CONF = "camel.component.pop3s.configuration";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_CONFIGURATION_DOC = "Sets the Mail configuration";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_CONNECTION_TIMEOUT_CONF = "camel.component.pop3s.connectionTimeout";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_CONNECTION_TIMEOUT_DOC = "The connection timeout in milliseconds.";
    private static final Integer CAMEL_SOURCE_POP3S_COMPONENT_CONNECTION_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_CONTENT_TYPE_CONF = "camel.component.pop3s.contentType";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_CONTENT_TYPE_DOC = "The mail message content type. Use text/html for HTML mails.";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_CONTENT_TYPE_DEFAULT = "text/plain";
    ...
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_CONTENT_TYPE_RESOLVER_DOC = "Resolver to determine Content-Type for file attachments.";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_CONTENT_TYPE_RESOLVER_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_DEBUG_MODE_CONF = "camel.component.pop3s.debugMode";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_DEBUG_MODE_DOC = "Enable debug mode on the underlying mail framework. The SUN Mail framework logs the debug messages to System.out by default.";
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_DEBUG_MODE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_IGNORE_UNSUPPORTED_CHARSET_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_IGNORE_URI_SCHEME_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_JAVA_MAIL_PROPERTIES_DOC = "Sets the java mail options. Will clear any default properties and only use the properties provided for this method.";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_JAVA_MAIL_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_SESSION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_USE_INLINE_ATTACHMENTS_DOC = "Whether to use disposition inline or attachment.";
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_USE_INLINE_ATTACHMENTS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_HEADER_FILTER_STRATEGY_DOC = "To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_PASSWORD_CONF = "camel.component.pop3s.password";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_PASSWORD_DOC = "The password for login. See also setAuthenticator(MailAuthenticator).";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters.";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SOURCE_POP3S_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
    public static final String CAMEL_SOURCE_POP3S_COMPONENT_USERNAME_CONF = "camel.component.pop3s.username";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_USERNAME_DOC = "The username for login. See also setAuthenticator(MailAuthenticator).";
    private static final String CAMEL_SOURCE_POP3S_COMPONENT_USERNAME_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_POP3S_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_POP3S_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_POP3S_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
