...
public class CamelScpsinkSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_SCPSINK_KAMELET_PRIVATE_KEY_PASSPHRASE_CONF, ConfigDef.Type.PASSWORD, CAMEL_SINK_SCPSINK_KAMELET_PRIVATE_KEY_PASSPHRASE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SCPSINK_KAMELET_PRIVATE_KEY_PASSPHRASE_DOC);
