...
public class CamelCometdsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_COMETDS_PATH_HOST_DOC = "Hostname";
    private static final String CAMEL_SINK_COMETDS_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_COMETDS_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_COMETDS_PATH_PORT_DOC = "Host port number";
    private static final Integer CAMEL_SINK_COMETDS_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_COMETDS_PATH_CHANNEL_NAME_CONF = "camel.sink.path.channelName";
    private static final String CAMEL_SINK_COMETDS_PATH_CHANNEL_NAME_DOC = "The channelName represents a topic that can be subscribed to by the Camel endpoints.";
    private static final String CAMEL_SINK_COMETDS_PATH_CHANNEL_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_COMETDS_ENDPOINT_ALLOWED_ORIGINS_CONF = "camel.sink.endpoint.allowedOrigins";
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_ALLOWED_ORIGINS_DOC = "The origins domain that support to cross, if the crosssOriginFilterOn is true";
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_ALLOWED_ORIGINS_DEFAULT = "*";
    ...
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_BASE_RESOURCE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_CROSS_ORIGIN_FILTER_ON_DOC = "If true, the server will support for cross-domain filtering";
    private static final Boolean CAMEL_SINK_COMETDS_ENDPOINT_CROSS_ORIGIN_FILTER_ON_DEFAULT = false;
    public static final String CAMEL_SINK_COMETDS_ENDPOINT_FILTER_PATH_CONF = "camel.sink.endpoint.filterPath";
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_FILTER_PATH_DOC = "The filterPath will be used by the CrossOriginFilter, if the crosssOriginFilterOn is true";
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_FILTER_PATH_DEFAULT = null;
    public static final String CAMEL_SINK_COMETDS_ENDPOINT_INTERVAL_CONF = "camel.sink.endpoint.interval";
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_INTERVAL_DOC = "The client side poll timeout in milliseconds. How long a client will wait between reconnects";
    private static final Integer CAMEL_SINK_COMETDS_ENDPOINT_INTERVAL_DEFAULT = null;
    public static final String CAMEL_SINK_COMETDS_ENDPOINT_JSON_COMMENTED_CONF = "camel.sink.endpoint.jsonCommented";
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_JSON_COMMENTED_DOC = "If true, the server will accept JSON wrapped in a comment and will generate JSON wrapped in a comment. This is a defence against Ajax Hijacking.";
    private static final Boolean CAMEL_SINK_COMETDS_ENDPOINT_JSON_COMMENTED_DEFAULT = true;
    public static final String CAMEL_SINK_COMETDS_ENDPOINT_LOG_LEVEL_CONF = "camel.sink.endpoint.logLevel";
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_LOG_LEVEL_DOC = "Logging level. 0=none, 1=info, 2=debug. One of: [0] [1] [2]";
    private static final Integer CAMEL_SINK_COMETDS_ENDPOINT_LOG_LEVEL_DEFAULT = 1;
    public static final String CAMEL_SINK_COMETDS_ENDPOINT_MAX_INTERVAL_CONF = "camel.sink.endpoint.maxInterval";
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_MAX_INTERVAL_DOC = "The max client side poll timeout in milliseconds. A client will be removed if a connection is not received in this time.";
    private static final Integer CAMEL_SINK_COMETDS_ENDPOINT_MAX_INTERVAL_DEFAULT = 30000;
    public static final String CAMEL_SINK_COMETDS_ENDPOINT_MULTI_FRAME_INTERVAL_CONF = "camel.sink.endpoint.multiFrameInterval";
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_MULTI_FRAME_INTERVAL_DOC = "The client side poll timeout, if multiple connections are detected from the same browser.";
    private static final Integer CAMEL_SINK_COMETDS_ENDPOINT_MULTI_FRAME_INTERVAL_DEFAULT = 1500;
    public static final String CAMEL_SINK_COMETDS_ENDPOINT_TIMEOUT_CONF = "camel.sink.endpoint.timeout";
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_TIMEOUT_DOC = "The server side poll timeout in milliseconds. This is how long the server will hold a reconnect request before responding.";
    private static final Integer CAMEL_SINK_COMETDS_ENDPOINT_TIMEOUT_DEFAULT = 240000;
    ...
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_DISCONNECT_LOCAL_SESSION_DOC = "Whether to disconnect local sessions after publishing a message to its channel. Disconnecting local session is needed as they are not swept by default by CometD, and therefore you can run out of memory.";
    private static final Boolean CAMEL_SINK_COMETDS_ENDPOINT_DISCONNECT_LOCAL_SESSION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_COMETDS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_COMETDS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_COMETDS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_COMETDS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_COMETDS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_COMETDS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_COMETDS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_COMETDS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_COMETDS_COMPONENT_EXTENSIONS_CONF = "camel.component.cometds.extensions";
    private static final String CAMEL_SINK_COMETDS_COMPONENT_EXTENSIONS_DOC = "To use a list of custom BayeuxServer.Extension that allows modifying incoming and outgoing requests.";
    private static final String CAMEL_SINK_COMETDS_COMPONENT_EXTENSIONS_DEFAULT = null;
    public static final String CAMEL_SINK_COMETDS_COMPONENT_SECURITY_POLICY_CONF = "camel.component.cometds.securityPolicy";
    private static final String CAMEL_SINK_COMETDS_COMPONENT_SECURITY_POLICY_DOC = "To use a custom configured SecurityPolicy to control authorization";
    private static final String CAMEL_SINK_COMETDS_COMPONENT_SECURITY_POLICY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_COMETDS_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    private static final String CAMEL_SINK_COMETDS_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_COMETDS_COMPONENT_SSL_KEY_PASSWORD_CONF = "camel.component.cometds.sslKeyPassword";
    private static final String CAMEL_SINK_COMETDS_COMPONENT_SSL_KEY_PASSWORD_DOC = "The password for the keystore when using SSL.";
    private static final String CAMEL_SINK_COMETDS_COMPONENT_SSL_KEY_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_COMETDS_COMPONENT_SSL_KEYSTORE_CONF = "camel.component.cometds.sslKeystore";
    private static final String CAMEL_SINK_COMETDS_COMPONENT_SSL_KEYSTORE_DOC = "The path to the keystore.";
    private static final String CAMEL_SINK_COMETDS_COMPONENT_SSL_KEYSTORE_DEFAULT = null;
    public static final String CAMEL_SINK_COMETDS_COMPONENT_SSL_PASSWORD_CONF = "camel.component.cometds.sslPassword";
    private static final String CAMEL_SINK_COMETDS_COMPONENT_SSL_PASSWORD_DOC = "The password when using SSL.";
    private static final String CAMEL_SINK_COMETDS_COMPONENT_SSL_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_COMETDS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SINK_COMETDS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
