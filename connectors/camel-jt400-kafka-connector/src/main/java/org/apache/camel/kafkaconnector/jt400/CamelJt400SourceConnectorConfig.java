...
public class CamelJt400SourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_JT400_PATH_USER_IDDOC = "Returns the ID of the AS/400 user.";
    private static final String CAMEL_SOURCE_JT400_PATH_USER_IDDEFAULT = null;
    public static final String CAMEL_SOURCE_JT400_PATH_PASSWORD_CONF = "camel.source.path.password";
    private static final String CAMEL_SOURCE_JT400_PATH_PASSWORD_DOC = "Returns the password of the AS/400 user.";
    private static final String CAMEL_SOURCE_JT400_PATH_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_JT400_PATH_SYSTEM_NAME_CONF = "camel.source.path.systemName";
    private static final String CAMEL_SOURCE_JT400_PATH_SYSTEM_NAME_DOC = "Returns the name of the AS/400 system.";
    private static final String CAMEL_SOURCE_JT400_PATH_SYSTEM_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_JT400_PATH_OBJECT_PATH_CONF = "camel.source.path.objectPath";
    private static final String CAMEL_SOURCE_JT400_PATH_OBJECT_PATH_DOC = "Returns the fully qualified integrated file system path name of the target object of this endpoint.";
    private static final String CAMEL_SOURCE_JT400_PATH_OBJECT_PATH_DEFAULT = null;
    public static final String CAMEL_SOURCE_JT400_PATH_TYPE_CONF = "camel.source.path.type";
    private static final String CAMEL_SOURCE_JT400_PATH_TYPE_DOC = "Whether to work with data queues or remote program call One of: [DTAQ] [PGM] [SRVPGM]";
    private static final String CAMEL_SOURCE_JT400_PATH_TYPE_DEFAULT = null;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_CCSID_CONF = "camel.source.endpoint.ccsid";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_CCSID_DOC = "Sets the CCSID to use for the connection with the AS/400 system.";
    private static final Integer CAMEL_SOURCE_JT400_ENDPOINT_CCSID_DEFAULT = null;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_FORMAT_CONF = "camel.source.endpoint.format";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_FORMAT_DOC = "Sets the data format for sending messages. One of: [text] [binary]";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_FORMAT_DEFAULT = "text";
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_GUI_AVAILABLE_CONF = "camel.source.endpoint.guiAvailable";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_GUI_AVAILABLE_DOC = "Sets whether AS/400 prompting is enabled in the environment running Camel.";
    private static final Boolean CAMEL_SOURCE_JT400_ENDPOINT_GUI_AVAILABLE_DEFAULT = false;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_KEYED_CONF = "camel.source.endpoint.keyed";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_KEYED_DOC = "Whether to use keyed or non-keyed data queues.";
    private static final Boolean CAMEL_SOURCE_JT400_ENDPOINT_KEYED_DEFAULT = false;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_SEARCH_KEY_CONF = "camel.source.endpoint.searchKey";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_SEARCH_KEY_DOC = "Search key for keyed data queues.";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_SEARCH_KEY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_JT400_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_READ_TIMEOUT_CONF = "camel.source.endpoint.readTimeout";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_READ_TIMEOUT_DOC = "Timeout in millis the consumer will wait while trying to read a new message of the data queue.";
    private static final Integer CAMEL_SOURCE_JT400_ENDPOINT_READ_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_SEARCH_TYPE_CONF = "camel.source.endpoint.searchType";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_SEARCH_TYPE_DOC = "Search type such as EQ for equal etc. One of: [EQ] [NE] [LT] [LE] [GT] [GE]";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_SEARCH_TYPE_DEFAULT = "EQ";
    ...
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DOC = "If the polling consumer did not poll any files, you can enable this option to send an empty message (no body) instead.";
    private static final Boolean CAMEL_SOURCE_JT400_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_POLL_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.source.endpoint.basicPropertyBinding";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_JT400_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_JT400_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DOC = "The number of subsequent error polls (failed due some error) that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_JT400_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DOC = "The number of subsequent idle polls that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_JT400_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_JT400_ENDPOINT_BACKOFF_MULTIPLIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll.";
    private static final Long CAMEL_SOURCE_JT400_ENDPOINT_DELAY_DEFAULT = 500L;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_GREEDY_CONF = "camel.source.endpoint.greedy";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_GREEDY_DOC = "If greedy is enabled, then the ScheduledPollConsumer will run immediately again, if the previous run polled 1 or more messages.";
    private static final Boolean CAMEL_SOURCE_JT400_ENDPOINT_GREEDY_DEFAULT = false;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_INITIAL_DELAY_CONF = "camel.source.endpoint.initialDelay";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts.";
    private static final Long CAMEL_SOURCE_JT400_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_REPEAT_COUNT_CONF = "camel.source.endpoint.repeatCount";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_REPEAT_COUNT_DOC = "Specifies a maximum limit of number of fires. So if you set it to 1, the scheduler will only fire once. If you set it to 5, it will only fire five times. A value of zero or negative means fire forever.";
    private static final Long CAMEL_SOURCE_JT400_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_RUN_LOGGING_LEVEL_CONF = "camel.source.endpoint.runLoggingLevel";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_RUN_LOGGING_LEVEL_DOC = "The consumer logs a start/complete log line when it polls. This option allows you to configure the logging level for that. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_RUN_LOGGING_LEVEL_DEFAULT = "TRACE";
    ...
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DOC = "Allows for configuring a custom/shared thread pool to use for the consumer. By default each consumer has its own single threaded thread pool.";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DEFAULT = null;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_SCHEDULER_CONF = "camel.source.endpoint.scheduler";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component One of: [none] [spring] [quartz]";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_SCHEDULER_DEFAULT = "none";
    ...
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_SCHEDULER_PROPERTIES_DOC = "To configure additional properties when using a custom scheduler or any of the Quartz, Spring based scheduler.";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_SCHEDULER_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_START_SCHEDULER_CONF = "camel.source.endpoint.startScheduler";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_START_SCHEDULER_DOC = "Whether the scheduler should be auto started.";
    private static final Boolean CAMEL_SOURCE_JT400_ENDPOINT_START_SCHEDULER_DEFAULT = true;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_TIME_UNIT_CONF = "camel.source.endpoint.timeUnit";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_TIME_UNIT_DOC = "Time unit for initialDelay and delay options. One of: [NANOSECONDS] [MICROSECONDS] [MILLISECONDS] [SECONDS] [MINUTES] [HOURS] [DAYS]";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_TIME_UNIT_DEFAULT = "MILLISECONDS";
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_USE_FIXED_DELAY_CONF = "camel.source.endpoint.useFixedDelay";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_USE_FIXED_DELAY_DOC = "Controls if fixed delay or fixed rate is used. See ScheduledExecutorService in JDK for details.";
    private static final Boolean CAMEL_SOURCE_JT400_ENDPOINT_USE_FIXED_DELAY_DEFAULT = true;
    public static final String CAMEL_SOURCE_JT400_ENDPOINT_SECURED_CONF = "camel.source.endpoint.secured";
    private static final String CAMEL_SOURCE_JT400_ENDPOINT_SECURED_DOC = "Whether connections to AS/400 are secured with SSL.";
    private static final Boolean CAMEL_SOURCE_JT400_ENDPOINT_SECURED_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_JT400_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_JT400_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.jt400.basicPropertyBinding";
    private static final String CAMEL_SOURCE_JT400_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_JT400_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_JT400_COMPONENT_CONNECTION_POOL_CONF = "camel.component.jt400.connectionPool";
    private static final String CAMEL_SOURCE_JT400_COMPONENT_CONNECTION_POOL_DOC = "Default connection pool used by the component. Note that this pool is lazily initialized. This is because in a scenario where the user always provides a pool, it would be wasteful for Camel to initialize and keep an idle pool.";
    private static final String CAMEL_SOURCE_JT400_COMPONENT_CONNECTION_POOL_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_JT400_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_JT400_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_JT400_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
        conf.define(CAMEL_SOURCE_JT400_ENDPOINT_SYNCHRONOUS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_JT400_ENDPOINT_SYNCHRONOUS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_JT400_ENDPOINT_SYNCHRONOUS_DOC);
