...
public class CamelJt400SinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_JT400_PATH_USER_IDDOC = "Returns the ID of the AS/400 user.";
    ...
    public static final String CAMEL_SINK_JT400_PATH_PASSWORD_DOC = "Returns the password of the AS/400 user.";
    ...
    public static final String CAMEL_SINK_JT400_PATH_SYSTEM_NAME_DOC = "Returns the name of the AS/400 system.";
    ...
    public static final String CAMEL_SINK_JT400_PATH_TYPE_DOC = "Whether to work with data queues or remote program call One of: [DTAQ] [PGM] [SRVPGM]";
    ...
    public static final String CAMEL_SINK_JT400_ENDPOINT_CCSID_DOC = "Sets the CCSID to use for the connection with the AS/400 system.";
    ...
    public static final String CAMEL_SINK_JT400_ENDPOINT_GUI_AVAILABLE_DOC = "Sets whether AS/400 prompting is enabled in the environment running Camel.";
    ...
    public static final String CAMEL_SINK_JT400_ENDPOINT_OUTPUT_FIELDS_LENGTH_ARRAY_DOC = "Specifies the fields (program parameters) length as in the AS/400 program definition.";
    ...
    public static final String CAMEL_SINK_JT400_ENDPOINT_SECURED_DOC = "Whether connections to AS/400 are secured with SSL.";
