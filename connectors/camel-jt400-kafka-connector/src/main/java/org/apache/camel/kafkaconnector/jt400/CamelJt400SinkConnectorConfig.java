...
public class CamelJt400SinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_JT400_PATH_USER_IDDOC = "Returns the ID of the AS/400 user.";
    private static final String CAMEL_SINK_JT400_PATH_USER_IDDEFAULT = null;
    public static final String CAMEL_SINK_JT400_PATH_PASSWORD_CONF = "camel.sink.path.password";
    private static final String CAMEL_SINK_JT400_PATH_PASSWORD_DOC = "Returns the password of the AS/400 user.";
    private static final String CAMEL_SINK_JT400_PATH_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_JT400_PATH_SYSTEM_NAME_CONF = "camel.sink.path.systemName";
    private static final String CAMEL_SINK_JT400_PATH_SYSTEM_NAME_DOC = "Returns the name of the AS/400 system.";
    private static final String CAMEL_SINK_JT400_PATH_SYSTEM_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_JT400_PATH_OBJECT_PATH_CONF = "camel.sink.path.objectPath";
    private static final String CAMEL_SINK_JT400_PATH_OBJECT_PATH_DOC = "Returns the fully qualified integrated file system path name of the target object of this endpoint.";
    private static final String CAMEL_SINK_JT400_PATH_OBJECT_PATH_DEFAULT = null;
    public static final String CAMEL_SINK_JT400_PATH_TYPE_CONF = "camel.sink.path.type";
    private static final String CAMEL_SINK_JT400_PATH_TYPE_DOC = "Whether to work with data queues or remote program call One of: [DTAQ] [PGM] [SRVPGM]";
    private static final String CAMEL_SINK_JT400_PATH_TYPE_DEFAULT = null;
    public static final String CAMEL_SINK_JT400_ENDPOINT_CCSID_CONF = "camel.sink.endpoint.ccsid";
    private static final String CAMEL_SINK_JT400_ENDPOINT_CCSID_DOC = "Sets the CCSID to use for the connection with the AS/400 system.";
    private static final Integer CAMEL_SINK_JT400_ENDPOINT_CCSID_DEFAULT = null;
    public static final String CAMEL_SINK_JT400_ENDPOINT_FORMAT_CONF = "camel.sink.endpoint.format";
    private static final String CAMEL_SINK_JT400_ENDPOINT_FORMAT_DOC = "Sets the data format for sending messages. One of: [text] [binary]";
    private static final String CAMEL_SINK_JT400_ENDPOINT_FORMAT_DEFAULT = "text";
    public static final String CAMEL_SINK_JT400_ENDPOINT_GUI_AVAILABLE_CONF = "camel.sink.endpoint.guiAvailable";
    private static final String CAMEL_SINK_JT400_ENDPOINT_GUI_AVAILABLE_DOC = "Sets whether AS/400 prompting is enabled in the environment running Camel.";
    private static final Boolean CAMEL_SINK_JT400_ENDPOINT_GUI_AVAILABLE_DEFAULT = false;
    public static final String CAMEL_SINK_JT400_ENDPOINT_KEYED_CONF = "camel.sink.endpoint.keyed";
    private static final String CAMEL_SINK_JT400_ENDPOINT_KEYED_DOC = "Whether to use keyed or non-keyed data queues.";
    private static final Boolean CAMEL_SINK_JT400_ENDPOINT_KEYED_DEFAULT = false;
    public static final String CAMEL_SINK_JT400_ENDPOINT_SEARCH_KEY_CONF = "camel.sink.endpoint.searchKey";
    private static final String CAMEL_SINK_JT400_ENDPOINT_SEARCH_KEY_DOC = "Search key for keyed data queues.";
    private static final String CAMEL_SINK_JT400_ENDPOINT_SEARCH_KEY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JT400_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_JT400_ENDPOINT_OUTPUT_FIELDS_IDX_ARRAY_DOC = "Specifies which fields (program parameters) are output parameters.";
    private static final String CAMEL_SINK_JT400_ENDPOINT_OUTPUT_FIELDS_IDX_ARRAY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_JT400_ENDPOINT_OUTPUT_FIELDS_LENGTH_ARRAY_DOC = "Specifies the fields (program parameters) length as in the AS/400 program definition.";
    private static final String CAMEL_SINK_JT400_ENDPOINT_OUTPUT_FIELDS_LENGTH_ARRAY_DEFAULT = null;
    public static final String CAMEL_SINK_JT400_ENDPOINT_PROCEDURE_NAME_CONF = "camel.sink.endpoint.procedureName";
    private static final String CAMEL_SINK_JT400_ENDPOINT_PROCEDURE_NAME_DOC = "Procedure name from a service program to call";
    private static final String CAMEL_SINK_JT400_ENDPOINT_PROCEDURE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_JT400_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JT400_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JT400_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_JT400_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_JT400_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_JT400_ENDPOINT_SECURED_CONF = "camel.sink.endpoint.secured";
    private static final String CAMEL_SINK_JT400_ENDPOINT_SECURED_DOC = "Whether connections to AS/400 are secured with SSL.";
    private static final Boolean CAMEL_SINK_JT400_ENDPOINT_SECURED_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_JT400_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_JT400_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JT400_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JT400_COMPONENT_CONNECTION_POOL_CONF = "camel.component.jt400.connectionPool";
    private static final String CAMEL_SINK_JT400_COMPONENT_CONNECTION_POOL_DOC = "Default connection pool used by the component. Note that this pool is lazily initialized. This is because in a scenario where the user always provides a pool, it would be wasteful for Camel to initialize and keep an idle pool.";
    private static final String CAMEL_SINK_JT400_COMPONENT_CONNECTION_POOL_DEFAULT = null;
