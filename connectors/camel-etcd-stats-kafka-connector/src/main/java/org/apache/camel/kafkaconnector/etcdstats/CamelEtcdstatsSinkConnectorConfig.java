...
public class CamelEtcdstatsSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_ETCDSTATS_COMPONENT_CONFIGURATION_DOC = "Sets the common configuration shared among endpoints";
    ...
    public static final String CAMEL_SINK_ETCDSTATS_COMPONENT_URIS_DEFAULT = null;
