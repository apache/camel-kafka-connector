...
public class CamelEtcdstatsSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_ETCDSTATS_PATH_PATH_DOC = "The path the endpoint refers to";
    private static final String CAMEL_SINK_ETCDSTATS_PATH_PATH_DEFAULT = null;
    public static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_RECURSIVE_CONF = "camel.sink.endpoint.recursive";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_RECURSIVE_DOC = "To apply an action recursively.";
    private static final Boolean CAMEL_SINK_ETCDSTATS_ENDPOINT_RECURSIVE_DEFAULT = false;
    public static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_SERVICE_PATH_CONF = "camel.sink.endpoint.servicePath";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_SERVICE_PATH_DOC = "The path to look for for service discovery";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_SERVICE_PATH_DEFAULT = "/services/";
    public static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_TIMEOUT_CONF = "camel.sink.endpoint.timeout";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_TIMEOUT_DOC = "To set the maximum time an action could take to complete.";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_URIS_CONF = "camel.sink.endpoint.uris";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_URIS_DOC = "To set the URIs the client connects.";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_URIS_DEFAULT = "http://localhost:2379,http://localhost:4001";
    ...
    private static final Boolean CAMEL_SINK_ETCDSTATS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_TIME_TO_LIVE_CONF = "camel.sink.endpoint.timeToLive";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_TIME_TO_LIVE_DOC = "To set the lifespan of a key in milliseconds.";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_TIME_TO_LIVE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_ETCDSTATS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_ETCDSTATS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_PASSWORD_DOC = "The password to use for basic authentication.";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters.";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_USER_NAME_CONF = "camel.sink.endpoint.userName";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_USER_NAME_DOC = "The user name to use for basic authentication.";
    private static final String CAMEL_SINK_ETCDSTATS_ENDPOINT_USER_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_ETCDSTATS_COMPONENT_CONFIGURATION_CONF = "camel.component.etcd-stats.configuration";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_CONFIGURATION_DOC = "Component configuration.";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_ETCDSTATS_COMPONENT_RECURSIVE_CONF = "camel.component.etcd-stats.recursive";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_RECURSIVE_DOC = "To apply an action recursively.";
    private static final Boolean CAMEL_SINK_ETCDSTATS_COMPONENT_RECURSIVE_DEFAULT = false;
    public static final String CAMEL_SINK_ETCDSTATS_COMPONENT_SERVICE_PATH_CONF = "camel.component.etcd-stats.servicePath";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_SERVICE_PATH_DOC = "The path to look for for service discovery";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_SERVICE_PATH_DEFAULT = "/services/";
    public static final String CAMEL_SINK_ETCDSTATS_COMPONENT_TIMEOUT_CONF = "camel.component.etcd-stats.timeout";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_TIMEOUT_DOC = "To set the maximum time an action could take to complete.";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_ETCDSTATS_COMPONENT_URIS_CONF = "camel.component.etcd-stats.uris";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_URIS_DOC = "To set the URIs the client connects.";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_URIS_DEFAULT = "http://localhost:2379,http://localhost:4001";
    ...
    private static final Boolean CAMEL_SINK_ETCDSTATS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_ETCDSTATS_COMPONENT_TIME_TO_LIVE_CONF = "camel.component.etcd-stats.timeToLive";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_TIME_TO_LIVE_DOC = "To set the lifespan of a key in milliseconds.";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_TIME_TO_LIVE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_ETCDSTATS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_ETCDSTATS_COMPONENT_PASSWORD_CONF = "camel.component.etcd-stats.password";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_PASSWORD_DOC = "The password to use for basic authentication.";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters.";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SINK_ETCDSTATS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
    public static final String CAMEL_SINK_ETCDSTATS_COMPONENT_USER_NAME_CONF = "camel.component.etcd-stats.userName";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_USER_NAME_DOC = "The user name to use for basic authentication.";
    private static final String CAMEL_SINK_ETCDSTATS_COMPONENT_USER_NAME_DEFAULT = null;
