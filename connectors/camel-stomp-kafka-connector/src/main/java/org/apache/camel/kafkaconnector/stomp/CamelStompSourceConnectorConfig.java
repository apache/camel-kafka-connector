...
public class CamelStompSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_STOMP_PATH_DESTINATION_DOC = "Name of the queue";
    private static final String CAMEL_SOURCE_STOMP_PATH_DESTINATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_STOMP_ENDPOINT_BROKER_URLCONF = "camel.source.endpoint.brokerURL";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_BROKER_URLDOC = "The URI of the Stomp broker to connect to";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_BROKER_URLDEFAULT = "tcp://localhost:61613";
    public static final String CAMEL_SOURCE_STOMP_ENDPOINT_CUSTOM_HEADERS_CONF = "camel.source.endpoint.customHeaders";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_CUSTOM_HEADERS_DOC = "To set custom headers";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_CUSTOM_HEADERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_STOMP_ENDPOINT_HOST_CONF = "camel.source.endpoint.host";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_HOST_DOC = "The virtual host name";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_HOST_DEFAULT = null;
    public static final String CAMEL_SOURCE_STOMP_ENDPOINT_VERSION_CONF = "camel.source.endpoint.version";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_VERSION_DOC = "The stomp version (1.1, or 1.2)";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_VERSION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_STOMP_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_STOMP_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_STOMP_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_STOMP_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_STOMP_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_STOMP_ENDPOINT_LOGIN_CONF = "camel.source.endpoint.login";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_LOGIN_DOC = "The username";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_LOGIN_DEFAULT = null;
    public static final String CAMEL_SOURCE_STOMP_ENDPOINT_PASSCODE_CONF = "camel.source.endpoint.passcode";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_PASSCODE_DOC = "The password";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_PASSCODE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    private static final String CAMEL_SOURCE_STOMP_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_STOMP_COMPONENT_BROKER_URLCONF = "camel.component.stomp.brokerURL";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_BROKER_URLDOC = "The URI of the Stomp broker to connect to";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_BROKER_URLDEFAULT = "tcp://localhost:61613";
    public static final String CAMEL_SOURCE_STOMP_COMPONENT_CUSTOM_HEADERS_CONF = "camel.component.stomp.customHeaders";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_CUSTOM_HEADERS_DOC = "To set custom headers";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_CUSTOM_HEADERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_STOMP_COMPONENT_HOST_CONF = "camel.component.stomp.host";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_HOST_DOC = "The virtual host name";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_HOST_DEFAULT = null;
    public static final String CAMEL_SOURCE_STOMP_COMPONENT_VERSION_CONF = "camel.component.stomp.version";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_VERSION_DOC = "The stomp version (1.1, or 1.2)";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_VERSION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_STOMP_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_STOMP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_STOMP_COMPONENT_CONFIGURATION_CONF = "camel.component.stomp.configuration";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_CONFIGURATION_DOC = "Component configuration.";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_HEADER_FILTER_STRATEGY_DOC = "To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_STOMP_COMPONENT_LOGIN_CONF = "camel.component.stomp.login";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_LOGIN_DOC = "The username";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_LOGIN_DEFAULT = null;
    public static final String CAMEL_SOURCE_STOMP_COMPONENT_PASSCODE_CONF = "camel.component.stomp.passcode";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_PASSCODE_DOC = "The password";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_PASSCODE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_STOMP_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SOURCE_STOMP_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
