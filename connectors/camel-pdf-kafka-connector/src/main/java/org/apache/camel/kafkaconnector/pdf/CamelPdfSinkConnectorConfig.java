...
public class CamelPdfSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_PDF_PATH_OPERATION_DOC = "Operation type One of: [create] [append] [extractText]";
    private static final String CAMEL_SINK_PDF_PATH_OPERATION_DEFAULT = null;
    public static final String CAMEL_SINK_PDF_ENDPOINT_FONT_CONF = "camel.sink.endpoint.font";
    private static final String CAMEL_SINK_PDF_ENDPOINT_FONT_DOC = "Font One of: [Courier] [Courier-Bold] [Courier-Oblique] [Courier-BoldOblique] [Helvetica] [Helvetica-Bold] [Helvetica-Oblique] [Helvetica-BoldOblique] [Times-Roman] [Times-Bold] [Times-Italic] [Times-BoldItalic] [Symbol] [ZapfDingbats]";
    private static final String CAMEL_SINK_PDF_ENDPOINT_FONT_DEFAULT = "Helvetica";
    public static final String CAMEL_SINK_PDF_ENDPOINT_FONT_SIZE_CONF = "camel.sink.endpoint.fontSize";
    private static final String CAMEL_SINK_PDF_ENDPOINT_FONT_SIZE_DOC = "Font size in pixels";
    private static final Float CAMEL_SINK_PDF_ENDPOINT_FONT_SIZE_DEFAULT = 14F;
    ...
    private static final Boolean CAMEL_SINK_PDF_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_PDF_ENDPOINT_MARGIN_BOTTOM_CONF = "camel.sink.endpoint.marginBottom";
    private static final String CAMEL_SINK_PDF_ENDPOINT_MARGIN_BOTTOM_DOC = "Margin bottom in pixels";
    private static final Integer CAMEL_SINK_PDF_ENDPOINT_MARGIN_BOTTOM_DEFAULT = 20;
    public static final String CAMEL_SINK_PDF_ENDPOINT_MARGIN_LEFT_CONF = "camel.sink.endpoint.marginLeft";
    private static final String CAMEL_SINK_PDF_ENDPOINT_MARGIN_LEFT_DOC = "Margin left in pixels";
    private static final Integer CAMEL_SINK_PDF_ENDPOINT_MARGIN_LEFT_DEFAULT = 20;
    public static final String CAMEL_SINK_PDF_ENDPOINT_MARGIN_RIGHT_CONF = "camel.sink.endpoint.marginRight";
    private static final String CAMEL_SINK_PDF_ENDPOINT_MARGIN_RIGHT_DOC = "Margin right in pixels";
    private static final Integer CAMEL_SINK_PDF_ENDPOINT_MARGIN_RIGHT_DEFAULT = 40;
    public static final String CAMEL_SINK_PDF_ENDPOINT_MARGIN_TOP_CONF = "camel.sink.endpoint.marginTop";
    private static final String CAMEL_SINK_PDF_ENDPOINT_MARGIN_TOP_DOC = "Margin top in pixels";
    private static final Integer CAMEL_SINK_PDF_ENDPOINT_MARGIN_TOP_DEFAULT = 20;
    public static final String CAMEL_SINK_PDF_ENDPOINT_PAGE_SIZE_CONF = "camel.sink.endpoint.pageSize";
    private static final String CAMEL_SINK_PDF_ENDPOINT_PAGE_SIZE_DOC = "Page size One of: [LETTER] [LEGAL] [A0] [A1] [A2] [A3] [A4] [A5] [A6]";
    private static final String CAMEL_SINK_PDF_ENDPOINT_PAGE_SIZE_DEFAULT = "A4";
    ...
    private static final String CAMEL_SINK_PDF_ENDPOINT_TEXT_PROCESSING_FACTORY_DEFAULT = "lineTermination";
    public static final String CAMEL_SINK_PDF_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_PDF_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_PDF_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_PDF_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_PDF_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_PDF_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_PDF_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_PDF_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.pdf.basicPropertyBinding";
    private static final String CAMEL_SINK_PDF_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_PDF_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
