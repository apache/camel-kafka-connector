...
public class CamelFopSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_FOP_PATH_OUTPUT_TYPE_DOC = "The primary output format is PDF but other output formats are also supported. One of: [pdf] [ps] [pcl] [png] [jpeg] [svg] [xml] [mif] [rtf] [txt]";
    private static final String CAMEL_SINK_FOP_PATH_OUTPUT_TYPE_DEFAULT = null;
    public static final String CAMEL_SINK_FOP_ENDPOINT_FOP_FACTORY_CONF = "camel.sink.endpoint.fopFactory";
    private static final String CAMEL_SINK_FOP_ENDPOINT_FOP_FACTORY_DOC = "Allows to use a custom configured or implementation of org.apache.fop.apps.FopFactory.";
    private static final String CAMEL_SINK_FOP_ENDPOINT_FOP_FACTORY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_FOP_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_FOP_ENDPOINT_USER_CONFIG_URLCONF = "camel.sink.endpoint.userConfigURL";
    private static final String CAMEL_SINK_FOP_ENDPOINT_USER_CONFIG_URLDOC = "The location of a configuration file which can be loaded from classpath or file system.";
    private static final String CAMEL_SINK_FOP_ENDPOINT_USER_CONFIG_URLDEFAULT = null;
    public static final String CAMEL_SINK_FOP_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_FOP_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_FOP_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_FOP_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_FOP_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_FOP_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_FOP_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_FOP_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.fop.basicPropertyBinding";
    private static final String CAMEL_SINK_FOP_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_FOP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
