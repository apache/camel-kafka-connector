...
public class CamelDirectSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_DIRECT_PATH_NAME_DOC = "Name of direct endpoint";
    private static final String CAMEL_SINK_DIRECT_PATH_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_DIRECT_ENDPOINT_BLOCK_CONF = "camel.sink.endpoint.block";
    private static final String CAMEL_SINK_DIRECT_ENDPOINT_BLOCK_DOC = "If sending a message to a direct endpoint which has no active consumer, then we can tell the producer to block and wait for the consumer to become active.";
    private static final Boolean CAMEL_SINK_DIRECT_ENDPOINT_BLOCK_DEFAULT = true;
    public static final String CAMEL_SINK_DIRECT_ENDPOINT_FAIL_IF_NO_CONSUMERS_CONF = "camel.sink.endpoint.failIfNoConsumers";
    private static final String CAMEL_SINK_DIRECT_ENDPOINT_FAIL_IF_NO_CONSUMERS_DOC = "Whether the producer should fail by throwing an exception, when sending to a DIRECT endpoint with no active consumers.";
    private static final Boolean CAMEL_SINK_DIRECT_ENDPOINT_FAIL_IF_NO_CONSUMERS_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_DIRECT_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_DIRECT_ENDPOINT_TIMEOUT_CONF = "camel.sink.endpoint.timeout";
    private static final String CAMEL_SINK_DIRECT_ENDPOINT_TIMEOUT_DOC = "The timeout value to use if block is enabled.";
    private static final Long CAMEL_SINK_DIRECT_ENDPOINT_TIMEOUT_DEFAULT = 30000L;
    ...
    private static final String CAMEL_SINK_DIRECT_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_DIRECT_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_DIRECT_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_DIRECT_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_DIRECT_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_DIRECT_COMPONENT_BLOCK_CONF = "camel.component.direct.block";
    private static final String CAMEL_SINK_DIRECT_COMPONENT_BLOCK_DOC = "If sending a message to a direct endpoint which has no active consumer, then we can tell the producer to block and wait for the consumer to become active.";
    private static final Boolean CAMEL_SINK_DIRECT_COMPONENT_BLOCK_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_DIRECT_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_DIRECT_COMPONENT_TIMEOUT_CONF = "camel.component.direct.timeout";
    private static final String CAMEL_SINK_DIRECT_COMPONENT_TIMEOUT_DOC = "The timeout value to use if block is enabled.";
    private static final Long CAMEL_SINK_DIRECT_COMPONENT_TIMEOUT_DEFAULT = 30000L;
    ...
    private static final String CAMEL_SINK_DIRECT_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_DIRECT_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
