...
public class CamelXmlsecurityverifySinkConnectorConfig
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_PATH_NAME_DOC = "The name part in the URI can be chosen by the user to distinguish between different verify endpoints within the camel context.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_PATH_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_BASE_URI_CONF = "camel.sink.endpoint.baseUri";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_BASE_URI_DOC = "You can set a base URI which is used in the URI dereferencing. Relative URIs are then concatenated with the base URI.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_BASE_URI_DEFAULT = null;
    public static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_CLEAR_HEADERS_CONF = "camel.sink.endpoint.clearHeaders";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_CLEAR_HEADERS_DOC = "Determines if the XML signature specific headers be cleared after signing and verification. Defaults to true.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_CLEAR_HEADERS_DEFAULT = "true";
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_CRYPTO_CONTEXT_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_DISALLOW_DOCTYPE_DECL_DOC = "Disallows that the incoming XML document contains DTD DOCTYPE declaration. The default value is Boolean#TRUE.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_DISALLOW_DOCTYPE_DECL_DEFAULT = "true";
    public static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_KEY_SELECTOR_CONF = "camel.sink.endpoint.keySelector";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_KEY_SELECTOR_DOC = "Provides the key for validating the XML signature.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_KEY_SELECTOR_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_OMIT_XML_DECLARATION_DOC = "Indicator whether the XML declaration in the outgoing message body should be omitted. Default value is false. Can be overwritten by the header XmlSignatureConstants#HEADER_OMIT_XML_DECLARATION.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_OMIT_XML_DECLARATION_DEFAULT = "false";
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_OUTPUT_NODE_SEARCH_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_OUTPUT_NODE_SEARCH_TYPE_DEFAULT = "Default";
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_OUTPUT_XML_ENCODING_DOC = "The character encoding of the resulting signed XML document. If null then the encoding of the original XML document is used.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_OUTPUT_XML_ENCODING_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_REMOVE_SIGNATURE_ELEMENTS_DEFAULT = "false";
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_SCHEMA_RESOURCE_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_SECURE_VALIDATION_DOC = "Enables secure validation. If true then secure validation is enabled.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_SECURE_VALIDATION_DEFAULT = "true";
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_VALIDATION_FAILED_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_XML_SIGNATURE_2MESSAGE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_XML_SIGNATURE_CHECKER_DOC = "This interface allows the application to check the XML signature before the validation is executed. This step is recommended in http://www.w3.org/TR/xmldsig-bestpractices/#check-what-is-signed";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_XML_SIGNATURE_CHECKER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_ENDPOINT_URI_DEREFERENCER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_BASE_URI_DOC = "You can set a base URI which is used in the URI dereferencing. Relative URIs are then concatenated with the base URI.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_BASE_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_CLEAR_HEADERS_DOC = "Determines if the XML signature specific headers be cleared after signing and verification. Defaults to true.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_CLEAR_HEADERS_DEFAULT = "true";
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_CRYPTO_CONTEXT_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_DISALLOW_DOCTYPE_DECL_DOC = "Disallows that the incoming XML document contains DTD DOCTYPE declaration. The default value is Boolean#TRUE.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_DISALLOW_DOCTYPE_DECL_DEFAULT = "true";
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_KEY_SELECTOR_DOC = "Provides the key for validating the XML signature.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_KEY_SELECTOR_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_OMIT_XML_DECLARATION_DOC = "Indicator whether the XML declaration in the outgoing message body should be omitted. Default value is false. Can be overwritten by the header XmlSignatureConstants#HEADER_OMIT_XML_DECLARATION.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_OMIT_XML_DECLARATION_DEFAULT = "false";
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_OUTPUT_NODE_SEARCH_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_OUTPUT_NODE_SEARCH_TYPE_DEFAULT = "Default";
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_OUTPUT_XML_ENCODING_DOC = "The character encoding of the resulting signed XML document. If null then the encoding of the original XML document is used.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_OUTPUT_XML_ENCODING_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_REMOVE_SIGNATURE_ELEMENTS_DEFAULT = "false";
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_SCHEMA_RESOURCE_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_SECURE_VALIDATION_DOC = "Enables secure validation. If true then secure validation is enabled.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_SECURE_VALIDATION_DEFAULT = "true";
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_VALIDATION_FAILED_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_XML_SIGNATURE_2MESSAGE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_XML_SIGNATURE_CHECKER_DOC = "This interface allows the application to check the XML signature before the validation is executed. This step is recommended in http://www.w3.org/TR/xmldsig-bestpractices/#check-what-is-signed";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_XML_SIGNATURE_CHECKER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_URI_DEREFERENCER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_VERIFIER_CONFIGURATION_DOC = "To use a shared XmlVerifierConfiguration configuration to use as base for configuring endpoints.";
    private static final String CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_VERIFIER_CONFIGURATION_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_XMLSECURITYVERIFY_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
