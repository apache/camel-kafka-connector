...
The camel-velocity sink connector supports 15 options, which are listed below.
...
| *camel.component.velocity.basicPropertyBinding* | Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities | false | false | LOW
