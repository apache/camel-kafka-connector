...
public class CamelKuberneteshpaSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_KUBERNETESHPA_PATH_MASTER_URL_DOC = "Kubernetes Master url";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_PATH_MASTER_URL_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_API_VERSION_CONF = "camel.source.endpoint.apiVersion";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_API_VERSION_DOC = "The Kubernetes API Version to use";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_API_VERSION_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_DNS_DOMAIN_CONF = "camel.source.endpoint.dnsDomain";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_DNS_DOMAIN_DOC = "The dns domain, used for ServiceCall EIP";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_DNS_DOMAIN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_KUBERNETES_CLIENT_DOC = "Default KubernetesClient to use if provided";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_KUBERNETES_CLIENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_PORT_NAME_CONF = "camel.source.endpoint.portName";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_PORT_NAME_DOC = "The port name, used for ServiceCall EIP";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_PORT_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_PORT_PROTOCOL_CONF = "camel.source.endpoint.portProtocol";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_PORT_PROTOCOL_DOC = "The port protocol, used for ServiceCall EIP";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_PORT_PROTOCOL_DEFAULT = "tcp";
    ...
    private static final Boolean CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_LABEL_KEY_CONF = "camel.source.endpoint.labelKey";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_LABEL_KEY_DOC = "The Consumer Label key when watching at some resources";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_LABEL_KEY_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_LABEL_VALUE_CONF = "camel.source.endpoint.labelValue";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_LABEL_VALUE_DOC = "The Consumer Label value when watching at some resources";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_LABEL_VALUE_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_NAMESPACE_CONF = "camel.source.endpoint.namespace";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_NAMESPACE_DOC = "The namespace";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_NAMESPACE_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_POOL_SIZE_CONF = "camel.source.endpoint.poolSize";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_POOL_SIZE_DOC = "The Consumer pool size";
    private static final Integer CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_POOL_SIZE_DEFAULT = 1;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_RESOURCE_NAME_CONF = "camel.source.endpoint.resourceName";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_RESOURCE_NAME_DOC = "The Consumer Resource Name we would like to watch";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_RESOURCE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CONNECTION_TIMEOUT_DOC = "Connection timeout in milliseconds to use when making requests to the Kubernetes API server.";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CONNECTION_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CA_CERT_DATA_CONF = "camel.source.endpoint.caCertData";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CA_CERT_DATA_DOC = "The CA Cert Data";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CA_CERT_DATA_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CA_CERT_FILE_CONF = "camel.source.endpoint.caCertFile";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CA_CERT_FILE_DOC = "The CA Cert File";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CA_CERT_FILE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_CERT_DATA_DOC = "The Client Cert Data";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_CERT_DATA_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_CERT_FILE_DOC = "The Client Cert File";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_CERT_FILE_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_KEY_ALGO_CONF = "camel.source.endpoint.clientKeyAlgo";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_KEY_ALGO_DOC = "The Key Algorithm used by the client";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_KEY_ALGO_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_KEY_DATA_CONF = "camel.source.endpoint.clientKeyData";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_KEY_DATA_DOC = "The Client Key data";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_KEY_DATA_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_KEY_FILE_CONF = "camel.source.endpoint.clientKeyFile";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_KEY_FILE_DOC = "The Client Key file";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_KEY_FILE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_KEY_PASSPHRASE_DOC = "The Client Key Passphrase";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_CLIENT_KEY_PASSPHRASE_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_OAUTH_TOKEN_CONF = "camel.source.endpoint.oauthToken";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_OAUTH_TOKEN_DOC = "The Auth Token";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_OAUTH_TOKEN_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_PASSWORD_DOC = "Password to connect to Kubernetes";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_TRUST_CERTS_CONF = "camel.source.endpoint.trustCerts";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_TRUST_CERTS_DOC = "Define if the certs we used are trusted anyway or not";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_TRUST_CERTS_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_USERNAME_DOC = "Username to connect to Kubernetes";
    private static final String CAMEL_SOURCE_KUBERNETESHPA_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_KUBERNETESHPA_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_KUBERNETESHPA_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_KUBERNETESHPA_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
