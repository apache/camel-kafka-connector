...
public class CamelJettySourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_JETTY_PATH_HTTP_URI_DOC = "The url of the HTTP endpoint to call.";
    private static final String CAMEL_SOURCE_JETTY_PATH_HTTP_URI_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_DISABLE_STREAM_CACHE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_HTTP_BINDING_CONF = "camel.source.endpoint.httpBinding";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_HTTP_BINDING_DOC = "To use a custom HttpBinding to control the mapping between Camel message and HttpClient.";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_HTTP_BINDING_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_ASYNC_CONF = "camel.source.endpoint.async";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_ASYNC_DOC = "Configure the consumer to work in async mode";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_ASYNC_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_CHUNKED_CONF = "camel.source.endpoint.chunked";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_CHUNKED_DOC = "If this option is false the Servlet will disable the HTTP streaming and set the content-length header on the response";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_CHUNKED_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_CONTINUATION_TIMEOUT_DEFAULT = "30000";
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_ENABLE_CORSCONF = "camel.source.endpoint.enableCORS";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_ENABLE_CORSDOC = "If the option is true, Jetty server will setup the CrossOriginFilter which supports the CORS out of box.";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_ENABLE_CORSDEFAULT = false;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_ENABLE_JMX_CONF = "camel.source.endpoint.enableJmx";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_ENABLE_JMX_DOC = "If this option is true, Jetty JMX support will be enabled for this endpoint. See Jetty JMX support for more details.";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_ENABLE_JMX_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_ENABLE_MULTIPART_FILTER_DOC = "Whether org.apache.camel.component.jetty.MultiPartFilter is enabled or not. You should set this value to false when bridging endpoints, to ensure multipart requests is proxied/bridged as well.";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_ENABLE_MULTIPART_FILTER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_HTTP_METHOD_RESTRICT_DOC = "Used to only allow consuming if the HttpMethod matches, such as GET/POST/PUT etc. Multiple methods can be specified separated by comma.";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_HTTP_METHOD_RESTRICT_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_MATCH_ON_URI_PREFIX_CONF = "camel.source.endpoint.matchOnUriPrefix";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_MATCH_ON_URI_PREFIX_DOC = "Whether or not the consumer should try to find a target consumer by matching the URI prefix if no exact match is found.";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_MATCH_ON_URI_PREFIX_DEFAULT = false;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_MUTE_EXCEPTION_CONF = "camel.source.endpoint.muteException";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_MUTE_EXCEPTION_DOC = "If enabled and an Exchange failed processing on the consumer side the response's body won't contain the exception's stack trace.";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_MUTE_EXCEPTION_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_RESPONSE_BUFFER_SIZE_DOC = "To use a custom buffer size on the javax.servlet.ServletResponse.";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_RESPONSE_BUFFER_SIZE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_SEND_DATE_HEADER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_SEND_SERVER_VERSION_DEFAULT = true;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_SESSION_SUPPORT_CONF = "camel.source.endpoint.sessionSupport";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_SESSION_SUPPORT_DOC = "Specifies whether to enable the session manager on the server side of Jetty.";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_SESSION_SUPPORT_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_TRANSFER_EXCEPTION_DEFAULT = false;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_USE_CONTINUATION_CONF = "camel.source.endpoint.useContinuation";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_USE_CONTINUATION_DOC = "Whether or not to use Jetty continuations for the Jetty Server.";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_USE_CONTINUATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_EAGER_CHECK_CONTENT_AVAILABLE_DOC = "Whether to eager check whether the HTTP requests has content if the content-length header is 0 or not present. This can be turned on in case HTTP clients do not send streamed data.";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_EAGER_CHECK_CONTENT_AVAILABLE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_FILTER_INIT_PARAMETERS_DOC = "Configuration of the filter init parameters. These parameters will be applied to the filter list before starting the jetty server.";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_FILTER_INIT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_FILTERS_CONF = "camel.source.endpoint.filters";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_FILTERS_DOC = "Allows using a custom filters which is putted into a list and can be find in the Registry. Multiple values can be separated by comma.";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_FILTERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_HANDLERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_MULTIPART_FILTER_CONF = "camel.source.endpoint.multipartFilter";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_MULTIPART_FILTER_DOC = "Allows using a custom multipart filter. Note: setting multipartFilterRef forces the value of enableMultipartFilter to true.";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_MULTIPART_FILTER_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_OPTIONS_ENABLED_CONF = "camel.source.endpoint.optionsEnabled";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_OPTIONS_ENABLED_DOC = "Specifies whether to enable HTTP OPTIONS for this Servlet consumer. By default OPTIONS is turned off.";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_OPTIONS_ENABLED_DEFAULT = false;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_TRACE_ENABLED_CONF = "camel.source.endpoint.traceEnabled";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_TRACE_ENABLED_DOC = "Specifies whether to enable HTTP TRACE for this Servlet consumer. By default TRACE is turned off.";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_TRACE_ENABLED_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_MAP_HTTP_MESSAGE_BODY_DOC = "If this option is true then IN exchange Body of the exchange will be mapped to HTTP body. Setting this to false will avoid the HTTP mapping.";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_MAP_HTTP_MESSAGE_BODY_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_MAP_HTTP_MESSAGE_FORM_URL_ENCODED_BODY_DOC = "If this option is true then IN exchange Form Encoded body of the exchange will be mapped to HTTP. Setting this to false will avoid the HTTP Form Encoded body mapping.";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_MAP_HTTP_MESSAGE_FORM_URL_ENCODED_BODY_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_MAP_HTTP_MESSAGE_HEADERS_DOC = "If this option is true then IN exchange Headers of the exchange will be mapped to HTTP headers. Setting this to false will avoid the HTTP Headers mapping.";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_MAP_HTTP_MESSAGE_HEADERS_DEFAULT = true;
    public static final String CAMEL_SOURCE_JETTY_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_JETTY_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    private static final String CAMEL_SOURCE_JETTY_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_JETTY_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_CONTINUATION_TIMEOUT_DEFAULT = "30000";
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_ENABLE_JMX_CONF = "camel.component.jetty.enableJmx";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_ENABLE_JMX_DOC = "If this option is true, Jetty JMX support will be enabled for this endpoint.";
    private static final Boolean CAMEL_SOURCE_JETTY_COMPONENT_ENABLE_JMX_DEFAULT = false;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_MAX_THREADS_CONF = "camel.component.jetty.maxThreads";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_MAX_THREADS_DOC = "To set a value for maximum number of threads in server thread pool. Notice that both a min and max size must be configured.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_MAX_THREADS_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_MIN_THREADS_CONF = "camel.component.jetty.minThreads";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_MIN_THREADS_DOC = "To set a value for minimum number of threads in server thread pool. Notice that both a min and max size must be configured.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_MIN_THREADS_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_REQUEST_BUFFER_SIZE_CONF = "camel.component.jetty.requestBufferSize";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_REQUEST_BUFFER_SIZE_DOC = "Allows to configure a custom value of the request buffer size on the Jetty connectors.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_REQUEST_BUFFER_SIZE_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_REQUEST_HEADER_SIZE_CONF = "camel.component.jetty.requestHeaderSize";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_REQUEST_HEADER_SIZE_DOC = "Allows to configure a custom value of the request header size on the Jetty connectors.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_REQUEST_HEADER_SIZE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_RESPONSE_BUFFER_SIZE_DOC = "Allows to configure a custom value of the response buffer size on the Jetty connectors.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_RESPONSE_BUFFER_SIZE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_RESPONSE_HEADER_SIZE_DOC = "Allows to configure a custom value of the response header size on the Jetty connectors.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_RESPONSE_HEADER_SIZE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_JETTY_COMPONENT_SEND_SERVER_VERSION_DEFAULT = true;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_USE_CONTINUATION_CONF = "camel.component.jetty.useContinuation";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_USE_CONTINUATION_DOC = "Whether or not to use Jetty continuations for the Jetty Server.";
    private static final Boolean CAMEL_SOURCE_JETTY_COMPONENT_USE_CONTINUATION_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_USE_XFORWARDED_FOR_HEADER_DOC = "To use the X-Forwarded-For header in HttpServletRequest.getRemoteAddr.";
    private static final Boolean CAMEL_SOURCE_JETTY_COMPONENT_USE_XFORWARDED_FOR_HEADER_DEFAULT = false;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_THREAD_POOL_CONF = "camel.component.jetty.threadPool";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_THREAD_POOL_DOC = "To use a custom thread pool for the server. This option should only be used in special circumstances.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_THREAD_POOL_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_JETTY_COMPONENT_ALLOW_JAVA_SERIALIZED_OBJECT_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_JETTY_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_ERROR_HANDLER_CONF = "camel.component.jetty.errorHandler";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_ERROR_HANDLER_DOC = "This option is used to set the ErrorHandler that Jetty server uses.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_ERROR_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_HTTP_BINDING_CONF = "camel.component.jetty.httpBinding";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_HTTP_BINDING_DOC = "Not to be used - use JettyHttpBinding instead.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_HTTP_BINDING_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_HTTP_CONFIGURATION_CONF = "camel.component.jetty.httpConfiguration";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_HTTP_CONFIGURATION_DOC = "Jetty component does not use HttpConfiguration.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_HTTP_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_JETTY_HTTP_BINDING_CONF = "camel.component.jetty.jettyHttpBinding";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_JETTY_HTTP_BINDING_DOC = "To use a custom org.apache.camel.component.jetty.JettyHttpBinding, which are used to customize how a response should be written for the producer.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_JETTY_HTTP_BINDING_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_MB_CONTAINER_CONF = "camel.component.jetty.mbContainer";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_MB_CONTAINER_DOC = "To use a existing configured org.eclipse.jetty.jmx.MBeanContainer if JMX is enabled that Jetty uses for registering mbeans.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_MB_CONTAINER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_HEADER_FILTER_STRATEGY_DOC = "To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_PROXY_HOST_CONF = "camel.component.jetty.proxyHost";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_PROXY_HOST_DOC = "To use a http proxy to configure the hostname.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_PROXY_PORT_CONF = "camel.component.jetty.proxyPort";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_PROXY_PORT_DOC = "To use a http proxy to configure the port number.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_KEYSTORE_CONF = "camel.component.jetty.keystore";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_KEYSTORE_DOC = "Specifies the location of the Java keystore file, which contains the Jetty server's own X.509 certificate in a key entry.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_KEYSTORE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SOCKET_CONNECTOR_PROPERTIES_DOC = "A map which contains general HTTP connector properties. Uses the same principle as sslSocketConnectorProperties.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SOCKET_CONNECTOR_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_SOCKET_CONNECTORS_CONF = "camel.component.jetty.socketConnectors";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SOCKET_CONNECTORS_DOC = "A map which contains per port number specific HTTP connectors. Uses the same principle as sslSocketConnectors.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SOCKET_CONNECTORS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_SSL_KEY_PASSWORD_CONF = "camel.component.jetty.sslKeyPassword";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SSL_KEY_PASSWORD_DOC = "The key password, which is used to access the certificate's key entry in the keystore (this is the same password that is supplied to the keystore command's -keypass option).";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SSL_KEY_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_JETTY_COMPONENT_SSL_PASSWORD_CONF = "camel.component.jetty.sslPassword";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SSL_PASSWORD_DOC = "The ssl password, which is required to access the keystore file (this is the same password that is supplied to the keystore command's -storepass option).";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SSL_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SSL_SOCKET_CONNECTOR_PROPERTIES_DOC = "A map which contains general SSL connector properties.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SSL_SOCKET_CONNECTOR_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SSL_SOCKET_CONNECTORS_DOC = "A map which contains per port number specific SSL connectors.";
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_SSL_SOCKET_CONNECTORS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JETTY_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters";
    private static final Boolean CAMEL_SOURCE_JETTY_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
