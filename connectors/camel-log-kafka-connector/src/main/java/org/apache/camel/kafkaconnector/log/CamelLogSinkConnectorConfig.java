...
public class CamelLogSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_LOG_PATH_LOGGER_NAME_DOC = "Name of the logging category to use";
    private static final String CAMEL_SINK_LOG_PATH_LOGGER_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_LOG_ENDPOINT_GROUP_ACTIVE_ONLY_CONF = "camel.sink.endpoint.groupActiveOnly";
    private static final String CAMEL_SINK_LOG_ENDPOINT_GROUP_ACTIVE_ONLY_DOC = "If true, will hide stats when no new messages have been received for a time interval, if false, show stats regardless of message traffic.";
    private static final String CAMEL_SINK_LOG_ENDPOINT_GROUP_ACTIVE_ONLY_DEFAULT = "true";
    public static final String CAMEL_SINK_LOG_ENDPOINT_GROUP_DELAY_CONF = "camel.sink.endpoint.groupDelay";
    private static final String CAMEL_SINK_LOG_ENDPOINT_GROUP_DELAY_DOC = "Set the initial delay for stats (in millis)";
    private static final String CAMEL_SINK_LOG_ENDPOINT_GROUP_DELAY_DEFAULT = null;
    public static final String CAMEL_SINK_LOG_ENDPOINT_GROUP_INTERVAL_CONF = "camel.sink.endpoint.groupInterval";
    private static final String CAMEL_SINK_LOG_ENDPOINT_GROUP_INTERVAL_DOC = "If specified will group message stats by this time interval (in millis)";
    private static final String CAMEL_SINK_LOG_ENDPOINT_GROUP_INTERVAL_DEFAULT = null;
    public static final String CAMEL_SINK_LOG_ENDPOINT_GROUP_SIZE_CONF = "camel.sink.endpoint.groupSize";
    private static final String CAMEL_SINK_LOG_ENDPOINT_GROUP_SIZE_DOC = "An integer that specifies a group size for throughput logging.";
    private static final String CAMEL_SINK_LOG_ENDPOINT_GROUP_SIZE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_ENDPOINT_LEVEL_CONF = "camel.sink.endpoint.level";
    private static final String CAMEL_SINK_LOG_ENDPOINT_LEVEL_DOC = "Logging level to use. The default value is INFO. One of: [ERROR] [WARN] [INFO] [DEBUG] [TRACE] [OFF]";
    private static final String CAMEL_SINK_LOG_ENDPOINT_LEVEL_DEFAULT = "INFO";
    public static final String CAMEL_SINK_LOG_ENDPOINT_LOG_MASK_CONF = "camel.sink.endpoint.logMask";
    private static final String CAMEL_SINK_LOG_ENDPOINT_LOG_MASK_DOC = "If true, mask sensitive information like password or passphrase in the log.";
    private static final String CAMEL_SINK_LOG_ENDPOINT_LOG_MASK_DEFAULT = null;
    public static final String CAMEL_SINK_LOG_ENDPOINT_MARKER_CONF = "camel.sink.endpoint.marker";
    private static final String CAMEL_SINK_LOG_ENDPOINT_MARKER_DOC = "An optional Marker name to use.";
    private static final String CAMEL_SINK_LOG_ENDPOINT_MARKER_DEFAULT = null;
    public static final String CAMEL_SINK_LOG_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_LOG_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_ENDPOINT_EXCHANGE_FORMATTER_CONF = "camel.sink.endpoint.exchangeFormatter";
    private static final String CAMEL_SINK_LOG_ENDPOINT_EXCHANGE_FORMATTER_DOC = "To use a custom exchange formatter";
    private static final String CAMEL_SINK_LOG_ENDPOINT_EXCHANGE_FORMATTER_DEFAULT = null;
    public static final String CAMEL_SINK_LOG_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_LOG_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_ENDPOINT_MAX_CHARS_CONF = "camel.sink.endpoint.maxChars";
    private static final String CAMEL_SINK_LOG_ENDPOINT_MAX_CHARS_DOC = "Limits the number of characters logged per line.";
    private static final Integer CAMEL_SINK_LOG_ENDPOINT_MAX_CHARS_DEFAULT = 10000;
    public static final String CAMEL_SINK_LOG_ENDPOINT_MULTILINE_CONF = "camel.sink.endpoint.multiline";
    private static final String CAMEL_SINK_LOG_ENDPOINT_MULTILINE_DOC = "If enabled then each information is outputted on a newline.";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_MULTILINE_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_ALL_CONF = "camel.sink.endpoint.showAll";
    private static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_ALL_DOC = "Quick option for turning all options on. (multiline, maxChars has to be manually set if to be used)";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SHOW_ALL_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_BODY_CONF = "camel.sink.endpoint.showBody";
    private static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_BODY_DOC = "Show the message body.";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SHOW_BODY_DEFAULT = true;
    public static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_BODY_TYPE_CONF = "camel.sink.endpoint.showBodyType";
    private static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_BODY_TYPE_DOC = "Show the body Java type.";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SHOW_BODY_TYPE_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SHOW_CAUGHT_EXCEPTION_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_EXCEPTION_CONF = "camel.sink.endpoint.showException";
    private static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_EXCEPTION_DOC = "If the exchange has an exception, show the exception message (no stacktrace)";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SHOW_EXCEPTION_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_EXCHANGE_ID_CONF = "camel.sink.endpoint.showExchangeId";
    private static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_EXCHANGE_ID_DOC = "Show the unique exchange ID.";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SHOW_EXCHANGE_ID_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_EXCHANGE_PATTERN_CONF = "camel.sink.endpoint.showExchangePattern";
    private static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_EXCHANGE_PATTERN_DOC = "Shows the Message Exchange Pattern (or MEP for short).";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SHOW_EXCHANGE_PATTERN_DEFAULT = true;
    public static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_FILES_CONF = "camel.sink.endpoint.showFiles";
    private static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_FILES_DOC = "If enabled Camel will output files";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SHOW_FILES_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_FUTURE_CONF = "camel.sink.endpoint.showFuture";
    private static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_FUTURE_DOC = "If enabled Camel will on Future objects wait for it to complete to obtain the payload to be logged.";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SHOW_FUTURE_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_HEADERS_CONF = "camel.sink.endpoint.showHeaders";
    private static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_HEADERS_DOC = "Show the message headers.";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SHOW_HEADERS_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_PROPERTIES_CONF = "camel.sink.endpoint.showProperties";
    private static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_PROPERTIES_DOC = "Show the exchange properties.";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SHOW_PROPERTIES_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_STACK_TRACE_CONF = "camel.sink.endpoint.showStackTrace";
    private static final String CAMEL_SINK_LOG_ENDPOINT_SHOW_STACK_TRACE_DOC = "Show the stack trace, if an exchange has an exception. Only effective if one of showAll, showException or showCaughtException are enabled.";
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SHOW_STACK_TRACE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SHOW_STREAMS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_LOG_ENDPOINT_SKIP_BODY_LINE_SEPARATOR_DEFAULT = true;
    public static final String CAMEL_SINK_LOG_ENDPOINT_STYLE_CONF = "camel.sink.endpoint.style";
    private static final String CAMEL_SINK_LOG_ENDPOINT_STYLE_DOC = "Sets the outputs style to use. One of: [Default] [Tab] [Fixed]";
    private static final String CAMEL_SINK_LOG_ENDPOINT_STYLE_DEFAULT = "Default";
    ...
    private static final Boolean CAMEL_SINK_LOG_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.log.basicPropertyBinding";
    private static final String CAMEL_SINK_LOG_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_LOG_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_LOG_COMPONENT_EXCHANGE_FORMATTER_CONF = "camel.component.log.exchangeFormatter";
    private static final String CAMEL_SINK_LOG_COMPONENT_EXCHANGE_FORMATTER_DOC = "Sets a custom ExchangeFormatter to convert the Exchange to a String suitable for logging. If not specified, we default to DefaultExchangeFormatter.";
    private static final String CAMEL_SINK_LOG_COMPONENT_EXCHANGE_FORMATTER_DEFAULT = null;
