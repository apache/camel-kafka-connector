...
public class CamelFlatpackSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_FLATPACK_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_FLATPACK_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_FLATPACK_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll. You can also specify time values using units, such as 60s (60 seconds), 5m30s (5 minutes and 30 seconds), and 1h (1 hour).";
    ...
    public static final String CAMEL_SOURCE_FLATPACK_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts. You can also specify time values using units, such as 60s (60 seconds), 5m30s (5 minutes and 30 seconds), and 1h (1 hour).";
    ...
    public static final String CAMEL_SOURCE_FLATPACK_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_FLATPACK_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
