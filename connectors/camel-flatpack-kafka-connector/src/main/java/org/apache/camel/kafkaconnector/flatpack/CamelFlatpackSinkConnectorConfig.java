...
public class CamelFlatpackSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_FLATPACK_PATH_TYPE_DOC = "Whether to use fixed or delimiter One of: [fixed] [delim]";
    private static final String CAMEL_SINK_FLATPACK_PATH_TYPE_DEFAULT = "delim";
    public static final String CAMEL_SINK_FLATPACK_PATH_RESOURCE_URI_CONF = "camel.sink.path.resourceUri";
    private static final String CAMEL_SINK_FLATPACK_PATH_RESOURCE_URI_DOC = "URL for loading the flatpack mapping file from classpath or file system";
    private static final String CAMEL_SINK_FLATPACK_PATH_RESOURCE_URI_DEFAULT = null;
    public static final String CAMEL_SINK_FLATPACK_ENDPOINT_ALLOW_SHORT_LINES_CONF = "camel.sink.endpoint.allowShortLines";
    private static final String CAMEL_SINK_FLATPACK_ENDPOINT_ALLOW_SHORT_LINES_DOC = "Allows for lines to be shorter than expected and ignores the extra characters";
    private static final Boolean CAMEL_SINK_FLATPACK_ENDPOINT_ALLOW_SHORT_LINES_DEFAULT = false;
    public static final String CAMEL_SINK_FLATPACK_ENDPOINT_DELIMITER_CONF = "camel.sink.endpoint.delimiter";
    private static final String CAMEL_SINK_FLATPACK_ENDPOINT_DELIMITER_DOC = "The default character delimiter for delimited files.";
    private static final String CAMEL_SINK_FLATPACK_ENDPOINT_DELIMITER_DEFAULT = ",";
    public static final String CAMEL_SINK_FLATPACK_ENDPOINT_IGNORE_EXTRA_COLUMNS_CONF = "camel.sink.endpoint.ignoreExtraColumns";
    private static final String CAMEL_SINK_FLATPACK_ENDPOINT_IGNORE_EXTRA_COLUMNS_DOC = "Allows for lines to be longer than expected and ignores the extra characters";
    private static final Boolean CAMEL_SINK_FLATPACK_ENDPOINT_IGNORE_EXTRA_COLUMNS_DEFAULT = false;
    public static final String CAMEL_SINK_FLATPACK_ENDPOINT_IGNORE_FIRST_RECORD_CONF = "camel.sink.endpoint.ignoreFirstRecord";
    private static final String CAMEL_SINK_FLATPACK_ENDPOINT_IGNORE_FIRST_RECORD_DOC = "Whether the first line is ignored for delimited files (for the column headers).";
    private static final Boolean CAMEL_SINK_FLATPACK_ENDPOINT_IGNORE_FIRST_RECORD_DEFAULT = true;
    public static final String CAMEL_SINK_FLATPACK_ENDPOINT_SPLIT_ROWS_CONF = "camel.sink.endpoint.splitRows";
    private static final String CAMEL_SINK_FLATPACK_ENDPOINT_SPLIT_ROWS_DOC = "Sets the Component to send each row as a separate exchange once parsed";
    private static final Boolean CAMEL_SINK_FLATPACK_ENDPOINT_SPLIT_ROWS_DEFAULT = true;
    public static final String CAMEL_SINK_FLATPACK_ENDPOINT_TEXT_QUALIFIER_CONF = "camel.sink.endpoint.textQualifier";
    private static final String CAMEL_SINK_FLATPACK_ENDPOINT_TEXT_QUALIFIER_DOC = "The text qualifier for delimited files.";
    private static final String CAMEL_SINK_FLATPACK_ENDPOINT_TEXT_QUALIFIER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_FLATPACK_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_FLATPACK_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_FLATPACK_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_FLATPACK_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_FLATPACK_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_FLATPACK_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_FLATPACK_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_FLATPACK_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_FLATPACK_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
