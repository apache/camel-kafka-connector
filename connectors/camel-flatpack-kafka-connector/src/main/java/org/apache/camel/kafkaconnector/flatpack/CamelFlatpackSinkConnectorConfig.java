...
public class CamelFlatpackSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_FLATPACK_COMPONENT_AUTOWIRED_ENABLED_CONF = "camel.component.flatpack.autowiredEnabled";
    public static final String CAMEL_SINK_FLATPACK_COMPONENT_AUTOWIRED_ENABLED_DOC = "Whether autowiring is enabled. This is used for automatic autowiring options (the option must be marked as autowired) by looking up in the registry to find if there is a single instance of matching type, which then gets configured on the component. This can be used for automatic configuring JDBC data sources, JMS connection factories, AWS Clients, etc.";
    public static final Boolean CAMEL_SINK_FLATPACK_COMPONENT_AUTOWIRED_ENABLED_DEFAULT = true;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_FLATPACK_COMPONENT_AUTOWIRED_ENABLED_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_FLATPACK_COMPONENT_AUTOWIRED_ENABLED_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_FLATPACK_COMPONENT_AUTOWIRED_ENABLED_DOC);
        return conf;
    }
}