...
public class CamelSnmpSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_SNMP_PATH_HOST_DOC = "Hostname of the SNMP enabled device";
    private static final String CAMEL_SINK_SNMP_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_SNMP_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_SNMP_PATH_PORT_DOC = "Port number of the SNMP enabled device";
    private static final String CAMEL_SINK_SNMP_PATH_PORT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SNMP_ENDPOINT_OIDS_DEFAULT = null;
    public static final String CAMEL_SINK_SNMP_ENDPOINT_PROTOCOL_CONF = "camel.sink.endpoint.protocol";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_PROTOCOL_DOC = "Here you can select which protocol to use. You can use either udp or tcp. One of: [tcp] [udp]";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_PROTOCOL_DEFAULT = "udp";
    public static final String CAMEL_SINK_SNMP_ENDPOINT_RETRIES_CONF = "camel.sink.endpoint.retries";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_RETRIES_DOC = "Defines how often a retry is made before canceling the request.";
    private static final Integer CAMEL_SINK_SNMP_ENDPOINT_RETRIES_DEFAULT = 2;
    public static final String CAMEL_SINK_SNMP_ENDPOINT_SNMP_COMMUNITY_CONF = "camel.sink.endpoint.snmpCommunity";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_SNMP_COMMUNITY_DOC = "Sets the community octet string for the snmp request.";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_SNMP_COMMUNITY_DEFAULT = "public";
    public static final String CAMEL_SINK_SNMP_ENDPOINT_SNMP_CONTEXT_ENGINE_ID_CONF = "camel.sink.endpoint.snmpContextEngineId";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_SNMP_CONTEXT_ENGINE_ID_DOC = "Sets the context engine ID field of the scoped PDU.";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_SNMP_CONTEXT_ENGINE_ID_DEFAULT = null;
    public static final String CAMEL_SINK_SNMP_ENDPOINT_SNMP_CONTEXT_NAME_CONF = "camel.sink.endpoint.snmpContextName";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_SNMP_CONTEXT_NAME_DOC = "Sets the context name field of this scoped PDU.";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_SNMP_CONTEXT_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_SNMP_ENDPOINT_SNMP_VERSION_CONF = "camel.sink.endpoint.snmpVersion";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_SNMP_VERSION_DOC = "Sets the snmp version for the request. The value 0 means SNMPv1, 1 means SNMPv2c, and the value 3 means SNMPv3 One of: [0] [1] [3]";
    private static final Integer CAMEL_SINK_SNMP_ENDPOINT_SNMP_VERSION_DEFAULT = 0;
    public static final String CAMEL_SINK_SNMP_ENDPOINT_TIMEOUT_CONF = "camel.sink.endpoint.timeout";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_TIMEOUT_DOC = "Sets the timeout value for the request in millis.";
    private static final Integer CAMEL_SINK_SNMP_ENDPOINT_TIMEOUT_DEFAULT = 1500;
    public static final String CAMEL_SINK_SNMP_ENDPOINT_TYPE_CONF = "camel.sink.endpoint.type";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_TYPE_DOC = "Which operation to perform such as poll, trap, etc. One of: [TRAP] [POLL] [GET_NEXT]";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_TYPE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SNMP_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_SNMP_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SNMP_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SNMP_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_SNMP_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SNMP_ENDPOINT_AUTHENTICATION_PASSPHRASE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SNMP_ENDPOINT_AUTHENTICATION_PROTOCOL_DOC = "Authentication protocol to use if security level is set to enable authentication The possible values are: MD5, SHA1 One of: [MD5] [SHA1]";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_AUTHENTICATION_PROTOCOL_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SNMP_ENDPOINT_PRIVACY_PASSPHRASE_DEFAULT = null;
    public static final String CAMEL_SINK_SNMP_ENDPOINT_PRIVACY_PROTOCOL_CONF = "camel.sink.endpoint.privacyProtocol";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_PRIVACY_PROTOCOL_DOC = "The privacy protocol ID to be associated with this user. If set to null, this user only supports unencrypted messages.";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_PRIVACY_PROTOCOL_DEFAULT = null;
    ...
    private static final Integer CAMEL_SINK_SNMP_ENDPOINT_SECURITY_LEVEL_DEFAULT = 3;
    public static final String CAMEL_SINK_SNMP_ENDPOINT_SECURITY_NAME_CONF = "camel.sink.endpoint.securityName";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_SECURITY_NAME_DOC = "Sets the security name to be used with this target.";
    private static final String CAMEL_SINK_SNMP_ENDPOINT_SECURITY_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SNMP_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SNMP_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SNMP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_SNMP_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_SNMP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_SNMP_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
        return conf;
    }
}