...
public class CamelSedaSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_SEDA_PATH_NAME_DOC = "Name of queue";
    private static final String CAMEL_SINK_SEDA_PATH_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_SEDA_ENDPOINT_SIZE_CONF = "camel.sink.endpoint.size";
    private static final String CAMEL_SINK_SEDA_ENDPOINT_SIZE_DOC = "The maximum capacity of the SEDA queue (i.e., the number of messages it can hold). Will by default use the defaultSize set on the SEDA component.";
    private static final Integer CAMEL_SINK_SEDA_ENDPOINT_SIZE_DEFAULT = 1000;
    ...
    private static final Boolean CAMEL_SINK_SEDA_ENDPOINT_BLOCK_WHEN_FULL_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SEDA_ENDPOINT_DISCARD_IF_NO_CONSUMERS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SEDA_ENDPOINT_DISCARD_WHEN_FULL_DEFAULT = false;
    public static final String CAMEL_SINK_SEDA_ENDPOINT_FAIL_IF_NO_CONSUMERS_CONF = "camel.sink.endpoint.failIfNoConsumers";
    private static final String CAMEL_SINK_SEDA_ENDPOINT_FAIL_IF_NO_CONSUMERS_DOC = "Whether the producer should fail by throwing an exception, when sending to a queue with no active consumers. Only one of the options discardIfNoConsumers and failIfNoConsumers can be enabled at the same time.";
    private static final Boolean CAMEL_SINK_SEDA_ENDPOINT_FAIL_IF_NO_CONSUMERS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SEDA_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_SEDA_ENDPOINT_OFFER_TIMEOUT_CONF = "camel.sink.endpoint.offerTimeout";
    private static final String CAMEL_SINK_SEDA_ENDPOINT_OFFER_TIMEOUT_DOC = "offerTimeout (in milliseconds) can be added to the block case when queue is full. You can disable timeout by using 0 or a negative value.";
    private static final Long CAMEL_SINK_SEDA_ENDPOINT_OFFER_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_SEDA_ENDPOINT_TIMEOUT_CONF = "camel.sink.endpoint.timeout";
    private static final String CAMEL_SINK_SEDA_ENDPOINT_TIMEOUT_DOC = "Timeout (in milliseconds) before a SEDA producer will stop waiting for an asynchronous task to complete. You can disable timeout by using 0 or a negative value.";
    private static final Long CAMEL_SINK_SEDA_ENDPOINT_TIMEOUT_DEFAULT = 30000L;
    ...
    private static final String CAMEL_SINK_SEDA_ENDPOINT_WAIT_FOR_TASK_TO_COMPLETE_DEFAULT = "IfReplyExpected";
    public static final String CAMEL_SINK_SEDA_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_SEDA_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SEDA_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SEDA_ENDPOINT_QUEUE_CONF = "camel.sink.endpoint.queue";
    private static final String CAMEL_SINK_SEDA_ENDPOINT_QUEUE_DOC = "Define the queue instance which will be used by the endpoint";
    private static final String CAMEL_SINK_SEDA_ENDPOINT_QUEUE_DEFAULT = null;
    public static final String CAMEL_SINK_SEDA_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_SEDA_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_SEDA_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SEDA_COMPONENT_DEFAULT_BLOCK_WHEN_FULL_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SEDA_COMPONENT_DEFAULT_DISCARD_WHEN_FULL_DEFAULT = false;
    ...
    private static final Long CAMEL_SINK_SEDA_COMPONENT_DEFAULT_OFFER_TIMEOUT_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SEDA_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SEDA_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SEDA_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SEDA_COMPONENT_DEFAULT_QUEUE_FACTORY_CONF = "camel.component.seda.defaultQueueFactory";
    private static final String CAMEL_SINK_SEDA_COMPONENT_DEFAULT_QUEUE_FACTORY_DOC = "Sets the default queue factory.";
    private static final String CAMEL_SINK_SEDA_COMPONENT_DEFAULT_QUEUE_FACTORY_DEFAULT = null;
    public static final String CAMEL_SINK_SEDA_COMPONENT_QUEUE_SIZE_CONF = "camel.component.seda.queueSize";
    private static final String CAMEL_SINK_SEDA_COMPONENT_QUEUE_SIZE_DOC = "Sets the default maximum capacity of the SEDA queue (i.e., the number of messages it can hold).";
    private static final Integer CAMEL_SINK_SEDA_COMPONENT_QUEUE_SIZE_DEFAULT = 1000;
