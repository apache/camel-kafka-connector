...
public class CamelAzurequeueSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_AZUREQUEUE_PATH_CONTAINER_AND_QUEUE_URI_DOC = "Container Queue compact Uri";
    private static final String CAMEL_SINK_AZUREQUEUE_PATH_CONTAINER_AND_QUEUE_URI_DEFAULT = null;
    public static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_AZURE_QUEUE_CLIENT_CONF = "camel.sink.endpoint.azureQueueClient";
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_AZURE_QUEUE_CLIENT_DOC = "The queue service client";
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_AZURE_QUEUE_CLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_CREDENTIALS_CONF = "camel.sink.endpoint.credentials";
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_CREDENTIALS_DOC = "Set the storage credentials, required in most cases";
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_CREDENTIALS_DEFAULT = null;
    public static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_VALIDATE_CLIENT_URICONF = "camel.sink.endpoint.validateClientURI";
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_VALIDATE_CLIENT_URIDOC = "Whether to validate the Azure client URI";
    private static final Boolean CAMEL_SINK_AZUREQUEUE_ENDPOINT_VALIDATE_CLIENT_URIDEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_AZUREQUEUE_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_MESSAGE_TIME_TO_LIVE_DOC = "Message Time To Live in seconds";
    private static final Integer CAMEL_SINK_AZUREQUEUE_ENDPOINT_MESSAGE_TIME_TO_LIVE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_MESSAGE_VISIBILITY_DELAY_DOC = "Message Visibility Delay in seconds";
    private static final Integer CAMEL_SINK_AZUREQUEUE_ENDPOINT_MESSAGE_VISIBILITY_DELAY_DEFAULT = null;
    public static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_OPERATION_CONF = "camel.sink.endpoint.operation";
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_OPERATION_DOC = "Queue service operation hint to the producer One of: [listQueues] [createQueue] [deleteQueue] [addMessage] [retrieveMessage] [peekMessage] [updateMessage] [deleteMessage]";
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_OPERATION_DEFAULT = "listQueues";
    public static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_QUEUE_PREFIX_CONF = "camel.sink.endpoint.queuePrefix";
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_QUEUE_PREFIX_DOC = "Set a prefix which can be used for listing the queues";
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_QUEUE_PREFIX_DEFAULT = null;
    public static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AZUREQUEUE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_AZUREQUEUE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_CREDENTIALS_ACCOUNT_KEY_DOC = "Set the storage account key used during authentication phase";
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_CREDENTIALS_ACCOUNT_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_CREDENTIALS_ACCOUNT_NAME_DOC = "Set the storage account name used during authentication phase";
    private static final String CAMEL_SINK_AZUREQUEUE_ENDPOINT_CREDENTIALS_ACCOUNT_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_AZURE_QUEUE_CLIENT_DOC = "The queue service client";
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_AZURE_QUEUE_CLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_CREDENTIALS_CONF = "camel.component.azure-queue.credentials";
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_CREDENTIALS_DOC = "Set the storage credentials, required in most cases";
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_CREDENTIALS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_VALIDATE_CLIENT_URIDOC = "Whether to validate the Azure client URI";
    private static final Boolean CAMEL_SINK_AZUREQUEUE_COMPONENT_VALIDATE_CLIENT_URIDEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_AZUREQUEUE_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_MESSAGE_TIME_TO_LIVE_DOC = "Message Time To Live in seconds";
    private static final Integer CAMEL_SINK_AZUREQUEUE_COMPONENT_MESSAGE_TIME_TO_LIVE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_MESSAGE_VISIBILITY_DELAY_DOC = "Message Visibility Delay in seconds";
    private static final Integer CAMEL_SINK_AZUREQUEUE_COMPONENT_MESSAGE_VISIBILITY_DELAY_DEFAULT = null;
    public static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_OPERATION_CONF = "camel.component.azure-queue.operation";
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_OPERATION_DOC = "Queue service operation hint to the producer One of: [listQueues] [createQueue] [deleteQueue] [addMessage] [retrieveMessage] [peekMessage] [updateMessage] [deleteMessage]";
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_OPERATION_DEFAULT = "listQueues";
    public static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_QUEUE_PREFIX_CONF = "camel.component.azure-queue.queuePrefix";
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_QUEUE_PREFIX_DOC = "Set a prefix which can be used for listing the queues";
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_QUEUE_PREFIX_DEFAULT = null;
    public static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.azure-queue.basicPropertyBinding";
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AZUREQUEUE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_CONFIGURATION_CONF = "camel.component.azure-queue.configuration";
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_CONFIGURATION_DOC = "The Queue Service configuration";
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_CREDENTIALS_ACCOUNT_KEY_DOC = "Set the storage account key used during authentication phase";
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_CREDENTIALS_ACCOUNT_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_CREDENTIALS_ACCOUNT_NAME_DOC = "Set the storage account name used during authentication phase";
    private static final String CAMEL_SINK_AZUREQUEUE_COMPONENT_CREDENTIALS_ACCOUNT_NAME_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_AZUREQUEUE_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_AZUREQUEUE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AZUREQUEUE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
