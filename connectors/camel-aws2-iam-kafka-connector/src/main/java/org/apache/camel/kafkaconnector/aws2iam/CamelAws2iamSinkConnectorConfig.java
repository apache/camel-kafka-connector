...
public class CamelAws2iamSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWS2IAM_ENDPOINT_IAM_CLIENT_DOC = "To use an existing configured AWS IAM client";
    ...
    public static final String CAMEL_SINK_AWS2IAM_ENDPOINT_OVERRIDE_ENDPOINT_DOC = "Set the need for overriding the endpoint. This option needs to be used in combination with the uriEndpointOverride option";
    ...
    public static final String CAMEL_SINK_AWS2IAM_ENDPOINT_SESSION_TOKEN_CONF = "camel.sink.endpoint.sessionToken";
    public static final String CAMEL_SINK_AWS2IAM_ENDPOINT_SESSION_TOKEN_DOC = "Amazon AWS Session Token used when the user needs to assume an IAM role";
    public static final String CAMEL_SINK_AWS2IAM_ENDPOINT_SESSION_TOKEN_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_AWS2IAM_ENDPOINT_USE_SESSION_CREDENTIALS_CONF = "camel.sink.endpoint.useSessionCredentials";
    public static final String CAMEL_SINK_AWS2IAM_ENDPOINT_USE_SESSION_CREDENTIALS_DOC = "Set whether the IAM client should expect to use Session Credentials. This is useful in a situation in which the user needs to assume a IAM role for doing operations in IAM.";
    public static final Boolean CAMEL_SINK_AWS2IAM_ENDPOINT_USE_SESSION_CREDENTIALS_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_AWS2IAM_COMPONENT_IAM_CLIENT_DOC = "To use an existing configured AWS IAM client";
    ...
    public static final String CAMEL_SINK_AWS2IAM_COMPONENT_OVERRIDE_ENDPOINT_DOC = "Set the need for overriding the endpoint. This option needs to be used in combination with the uriEndpointOverride option";
    ...
    public static final String CAMEL_SINK_AWS2IAM_COMPONENT_SESSION_TOKEN_CONF = "camel.component.aws2-iam.sessionToken";
    public static final String CAMEL_SINK_AWS2IAM_COMPONENT_SESSION_TOKEN_DOC = "Amazon AWS Session Token used when the user needs to assume an IAM role";
    public static final String CAMEL_SINK_AWS2IAM_COMPONENT_SESSION_TOKEN_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_AWS2IAM_COMPONENT_USE_SESSION_CREDENTIALS_CONF = "camel.component.aws2-iam.useSessionCredentials";
    public static final String CAMEL_SINK_AWS2IAM_COMPONENT_USE_SESSION_CREDENTIALS_DOC = "Set whether the IAM client should expect to use Session Credentials. This is useful in a situation in which the user needs to assume a IAM role for doing operations in IAM.";
    public static final Boolean CAMEL_SINK_AWS2IAM_COMPONENT_USE_SESSION_CREDENTIALS_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_AWS2IAM_ENDPOINT_SESSION_TOKEN_CONF, ConfigDef.Type.PASSWORD, CAMEL_SINK_AWS2IAM_ENDPOINT_SESSION_TOKEN_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWS2IAM_ENDPOINT_SESSION_TOKEN_DOC);
        ...
        conf.define(CAMEL_SINK_AWS2IAM_ENDPOINT_USE_SESSION_CREDENTIALS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_AWS2IAM_ENDPOINT_USE_SESSION_CREDENTIALS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWS2IAM_ENDPOINT_USE_SESSION_CREDENTIALS_DOC);
        ...
        conf.define(CAMEL_SINK_AWS2IAM_COMPONENT_SESSION_TOKEN_CONF, ConfigDef.Type.PASSWORD, CAMEL_SINK_AWS2IAM_COMPONENT_SESSION_TOKEN_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWS2IAM_COMPONENT_SESSION_TOKEN_DOC);
        ...
        conf.define(CAMEL_SINK_AWS2IAM_COMPONENT_USE_SESSION_CREDENTIALS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_AWS2IAM_COMPONENT_USE_SESSION_CREDENTIALS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWS2IAM_COMPONENT_USE_SESSION_CREDENTIALS_DOC);
        return conf;
    }
}