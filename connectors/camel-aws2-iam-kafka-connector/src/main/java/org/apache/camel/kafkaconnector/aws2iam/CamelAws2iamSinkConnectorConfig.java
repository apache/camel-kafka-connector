...
public class CamelAws2iamSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWS2IAM_ENDPOINT_AUTO_DISCOVER_CLIENT_CONF = "camel.sink.endpoint.autoDiscoverClient";
    public static final String CAMEL_SINK_AWS2IAM_ENDPOINT_AUTO_DISCOVER_CLIENT_DOC = "Setting the autoDiscoverClient mechanism, if true, the component will look for a client instance in the registry automatically otherwise it will skip that checking.";
    public static final Boolean CAMEL_SINK_AWS2IAM_ENDPOINT_AUTO_DISCOVER_CLIENT_DEFAULT = true;
    ...
    public static final String CAMEL_SINK_AWS2IAM_COMPONENT_AUTO_DISCOVER_CLIENT_CONF = "camel.component.aws2-iam.autoDiscoverClient";
    public static final String CAMEL_SINK_AWS2IAM_COMPONENT_AUTO_DISCOVER_CLIENT_DOC = "Setting the autoDiscoverClient mechanism, if true, the component will look for a client instance in the registry automatically otherwise it will skip that checking.";
    public static final Boolean CAMEL_SINK_AWS2IAM_COMPONENT_AUTO_DISCOVER_CLIENT_DEFAULT = true;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_AWS2IAM_ENDPOINT_AUTO_DISCOVER_CLIENT_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_AWS2IAM_ENDPOINT_AUTO_DISCOVER_CLIENT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWS2IAM_ENDPOINT_AUTO_DISCOVER_CLIENT_DOC);
        ...
        conf.define(CAMEL_SINK_AWS2IAM_COMPONENT_AUTO_DISCOVER_CLIENT_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_AWS2IAM_COMPONENT_AUTO_DISCOVER_CLIENT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWS2IAM_COMPONENT_AUTO_DISCOVER_CLIENT_DOC);
