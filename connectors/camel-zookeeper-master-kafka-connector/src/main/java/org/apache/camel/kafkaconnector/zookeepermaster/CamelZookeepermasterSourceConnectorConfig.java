...
public class CamelZookeepermasterSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_PATH_GROUP_NAME_DOC = "The name of the cluster group to use";
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_PATH_GROUP_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_PATH_CONSUMER_ENDPOINT_URI_DOC = "The consumer endpoint to use in master/slave mode";
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_PATH_CONSUMER_ENDPOINT_URI_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ZOOKEEPERMASTER_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_ZOOKEEPERMASTER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_ZOOKEEPERMASTER_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_ZOOKEEPERMASTER_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_MAXIMUM_CONNECTION_TIMEOUT_DOC = "Timeout in millis to use when connecting to the zookeeper ensemble";
    private static final Integer CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_MAXIMUM_CONNECTION_TIMEOUT_DEFAULT = 10000;
    public static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_ZK_ROOT_CONF = "camel.component.zookeeper-master.zkRoot";
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_ZK_ROOT_DOC = "The root path to use in zookeeper where information is stored which nodes are master/slave etc. Will by default use: /camel/zookeepermaster/clusters/master";
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_ZK_ROOT_DEFAULT = "/camel/zookeepermaster/clusters/master";
    ...
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_ZOO_KEEPER_URL_DOC = "The url for the zookeeper ensemble";
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_ZOO_KEEPER_URL_DEFAULT = "localhost:2181";
    ...
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_CONTAINER_ID_FACTORY_DOC = "To use a custom ContainerIdFactory for creating container ids.";
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_CONTAINER_ID_FACTORY_DEFAULT = null;
    public static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_CURATOR_CONF = "camel.component.zookeeper-master.curator";
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_CURATOR_DOC = "To use a custom configured CuratorFramework as connection to zookeeper ensemble.";
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_CURATOR_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_ZOO_KEEPER_PASSWORD_DOC = "The password to use when connecting to the zookeeper ensemble";
    private static final String CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_ZOO_KEEPER_PASSWORD_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_ZOOKEEPERMASTER_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
