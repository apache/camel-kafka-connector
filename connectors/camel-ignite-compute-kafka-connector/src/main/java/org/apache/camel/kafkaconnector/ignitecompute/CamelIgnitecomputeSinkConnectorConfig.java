...
public class CamelIgnitecomputeSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_IGNITECOMPUTE_PATH_ENDPOINT_ID_DOC = "The endpoint ID (not used).";
    private static final String CAMEL_SINK_IGNITECOMPUTE_PATH_ENDPOINT_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_CLUSTER_GROUP_EXPRESSION_DOC = "An expression that returns the Cluster Group for the IgniteCompute instance.";
    private static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_CLUSTER_GROUP_EXPRESSION_DEFAULT = null;
    public static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_COMPUTE_NAME_CONF = "camel.sink.endpoint.computeName";
    private static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_COMPUTE_NAME_DOC = "The name of the compute job, which will be set via IgniteCompute#withName(String).";
    private static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_COMPUTE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_EXECUTION_TYPE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_PROPAGATE_INCOMING_BODY_IF_NO_RETURN_VALUE_DOC = "Sets whether to propagate the incoming body if the return type of the underlying Ignite operation is void.";
    private static final Boolean CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_PROPAGATE_INCOMING_BODY_IF_NO_RETURN_VALUE_DEFAULT = true;
    public static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_TASK_NAME_CONF = "camel.sink.endpoint.taskName";
    private static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_TASK_NAME_DOC = "The task name, only applicable if using the IgniteComputeExecutionType#EXECUTE execution type.";
    private static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_TASK_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_TIMEOUT_MILLIS_CONF = "camel.sink.endpoint.timeoutMillis";
    private static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_TIMEOUT_MILLIS_DOC = "The timeout interval for triggered jobs, in milliseconds, which will be set via IgniteCompute#withTimeout(long).";
    private static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_TIMEOUT_MILLIS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_TREAT_COLLECTIONS_AS_CACHE_OBJECTS_DOC = "Sets whether to treat Collections as cache objects or as Collections of items to insert/update/compute, etc.";
    private static final Boolean CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_TREAT_COLLECTIONS_AS_CACHE_OBJECTS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_IGNITECOMPUTE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_IGNITECOMPUTE_COMPONENT_CONFIGURATION_RESOURCE_DOC = "Resource from where to load configuration.";
    private static final String CAMEL_SINK_IGNITECOMPUTE_COMPONENT_CONFIGURATION_RESOURCE_DEFAULT = null;
    public static final String CAMEL_SINK_IGNITECOMPUTE_COMPONENT_IGNITE_CONF = "camel.component.ignite-compute.ignite";
    private static final String CAMEL_SINK_IGNITECOMPUTE_COMPONENT_IGNITE_DOC = "Ignite instance.";
    private static final String CAMEL_SINK_IGNITECOMPUTE_COMPONENT_IGNITE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IGNITECOMPUTE_COMPONENT_IGNITE_CONFIGURATION_DOC = "Ignite configuration.";
    private static final String CAMEL_SINK_IGNITECOMPUTE_COMPONENT_IGNITE_CONFIGURATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_IGNITECOMPUTE_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_IGNITECOMPUTE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_IGNITECOMPUTE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
