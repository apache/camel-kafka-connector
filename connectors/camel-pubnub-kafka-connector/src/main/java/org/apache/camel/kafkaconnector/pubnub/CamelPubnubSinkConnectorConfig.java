...
public class CamelPubnubSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_PUBNUB_PATH_CHANNEL_DOC = "The channel used for subscribing/publishing events";
    private static final String CAMEL_SINK_PUBNUB_PATH_CHANNEL_DEFAULT = null;
    public static final String CAMEL_SINK_PUBNUB_ENDPOINT_UUID_CONF = "camel.sink.endpoint.uuid";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_UUID_DOC = "UUID to be used as a device identifier, a default UUID is generated if not passed.";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_UUID_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_PUBNUB_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_OPERATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_PUBNUB_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_PUBNUB_ENDPOINT_PUBNUB_CONF = "camel.sink.endpoint.pubnub";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_PUBNUB_DOC = "Reference to a Pubnub client in the registry.";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_PUBNUB_DEFAULT = null;
    public static final String CAMEL_SINK_PUBNUB_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_PUBNUB_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_PUBNUB_ENDPOINT_AUTH_KEY_CONF = "camel.sink.endpoint.authKey";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_AUTH_KEY_DOC = "If Access Manager is utilized, client will use this authKey in all restricted requests.";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_AUTH_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_PUBNUB_ENDPOINT_CIPHER_KEY_CONF = "camel.sink.endpoint.cipherKey";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_CIPHER_KEY_DOC = "If cipher is passed, all communications to/from PubNub will be encrypted.";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_CIPHER_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_PUBNUB_ENDPOINT_PUBLISH_KEY_CONF = "camel.sink.endpoint.publishKey";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_PUBLISH_KEY_DOC = "The publish key obtained from your PubNub account. Required when publishing messages.";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_PUBLISH_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_PUBNUB_ENDPOINT_SECRET_KEY_CONF = "camel.sink.endpoint.secretKey";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_SECRET_KEY_DOC = "The secret key used for message signing.";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_SECRET_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_PUBNUB_ENDPOINT_SECURE_CONF = "camel.sink.endpoint.secure";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_SECURE_DOC = "Use SSL for secure transmission.";
    private static final Boolean CAMEL_SINK_PUBNUB_ENDPOINT_SECURE_DEFAULT = true;
    public static final String CAMEL_SINK_PUBNUB_ENDPOINT_SUBSCRIBE_KEY_CONF = "camel.sink.endpoint.subscribeKey";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_SUBSCRIBE_KEY_DOC = "The subscribe key obtained from your PubNub account. Required when subscribing to channels or listening for presence events";
    private static final String CAMEL_SINK_PUBNUB_ENDPOINT_SUBSCRIBE_KEY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_PUBNUB_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_PUBNUB_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_PUBNUB_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_PUBNUB_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_PUBNUB_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_PUBNUB_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
        return conf;
    }
}