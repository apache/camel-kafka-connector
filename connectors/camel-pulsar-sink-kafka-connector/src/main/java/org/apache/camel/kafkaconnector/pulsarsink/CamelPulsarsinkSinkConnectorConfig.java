...
public class CamelPulsarsinkSinkConnectorConfig
    ...
    public static final Long CAMEL_SINK_PULSARSINK_KAMELET_BATCHING_MAX_PUBLISH_DELAY_MICROS_DEFAULT = 1000L;
    ...
    public static final String CAMEL_SINK_PULSARSINK_KAMELET_COMPRESSION_TYPE_DOC = "Compression type to use. Possible values are: NONE, LZ4, ZLIB, ZSTD, SNAPPY";
    ...
    public static final Long CAMEL_SINK_PULSARSINK_KAMELET_INITIAL_SEQUENCE_ID_DEFAULT = -1L;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_PULSARSINK_KAMELET_BATCHING_MAX_PUBLISH_DELAY_MICROS_CONF, ConfigDef.Type.LONG, CAMEL_SINK_PULSARSINK_KAMELET_BATCHING_MAX_PUBLISH_DELAY_MICROS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_PULSARSINK_KAMELET_BATCHING_MAX_PUBLISH_DELAY_MICROS_DOC);
        ...
        conf.define(CAMEL_SINK_PULSARSINK_KAMELET_INITIAL_SEQUENCE_ID_CONF, ConfigDef.Type.LONG, CAMEL_SINK_PULSARSINK_KAMELET_INITIAL_SEQUENCE_ID_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_PULSARSINK_KAMELET_INITIAL_SEQUENCE_ID_DOC);
