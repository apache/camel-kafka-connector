...
public class CamelHipchatSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_HIPCHAT_PATH_PROTOCOL_DOC = "The protocol for the hipchat server, such as http.";
    private static final String CAMEL_SINK_HIPCHAT_PATH_PROTOCOL_DEFAULT = null;
    public static final String CAMEL_SINK_HIPCHAT_PATH_HOST_CONF = "camel.sink.path.host";
    private static final String CAMEL_SINK_HIPCHAT_PATH_HOST_DOC = "The host for the hipchat server, such as api.hipchat.com";
    private static final String CAMEL_SINK_HIPCHAT_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_HIPCHAT_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_HIPCHAT_PATH_PORT_DOC = "The port for the hipchat server. Is by default 80.";
    private static final String CAMEL_SINK_HIPCHAT_PATH_PORT_DEFAULT = "80";
    public static final String CAMEL_SINK_HIPCHAT_ENDPOINT_AUTH_TOKEN_CONF = "camel.sink.endpoint.authToken";
    private static final String CAMEL_SINK_HIPCHAT_ENDPOINT_AUTH_TOKEN_DOC = "OAuth 2 auth token";
    private static final String CAMEL_SINK_HIPCHAT_ENDPOINT_AUTH_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_HIPCHAT_ENDPOINT_CONSUME_USERS_CONF = "camel.sink.endpoint.consumeUsers";
    private static final String CAMEL_SINK_HIPCHAT_ENDPOINT_CONSUME_USERS_DOC = "Username(s) when consuming messages from the hiptchat server. Multiple user names can be separated by comma.";
    private static final String CAMEL_SINK_HIPCHAT_ENDPOINT_CONSUME_USERS_DEFAULT = null;
    public static final String CAMEL_SINK_HIPCHAT_ENDPOINT_HTTP_CLIENT_CONF = "camel.sink.endpoint.httpClient";
    private static final String CAMEL_SINK_HIPCHAT_ENDPOINT_HTTP_CLIENT_DOC = "The CloseableHttpClient reference from registry to be used during API HTTP requests.";
    private static final String CAMEL_SINK_HIPCHAT_ENDPOINT_HTTP_CLIENT_DEFAULT = "CloseableHttpClient default from HttpClient library";
    ...
    private static final Boolean CAMEL_SINK_HIPCHAT_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_HIPCHAT_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_HIPCHAT_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_HIPCHAT_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_HIPCHAT_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_HIPCHAT_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_HIPCHAT_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_HIPCHAT_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_HIPCHAT_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
