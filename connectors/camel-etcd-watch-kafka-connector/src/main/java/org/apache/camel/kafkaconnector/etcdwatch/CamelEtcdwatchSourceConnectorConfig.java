...
public class CamelEtcdwatchSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_ETCDWATCH_PATH_PATH_DOC = "The path the endpoint refers to";
    private static final String CAMEL_SOURCE_ETCDWATCH_PATH_PATH_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ETCDWATCH_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_RECURSIVE_CONF = "camel.source.endpoint.recursive";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_RECURSIVE_DOC = "To apply an action recursively.";
    private static final Boolean CAMEL_SOURCE_ETCDWATCH_ENDPOINT_RECURSIVE_DEFAULT = false;
    public static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_SERVICE_PATH_CONF = "camel.source.endpoint.servicePath";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_SERVICE_PATH_DOC = "The path to look for for service discovery";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_SERVICE_PATH_DEFAULT = "/services/";
    public static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_URIS_CONF = "camel.source.endpoint.uris";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_URIS_DOC = "To set the URIs the client connects.";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_URIS_DEFAULT = "http://localhost:2379,http://localhost:4001";
    ...
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_SEND_EMPTY_EXCHANGE_ON_TIMEOUT_DOC = "To send an empty message in case of timeout watching for a key.";
    private static final Boolean CAMEL_SOURCE_ETCDWATCH_ENDPOINT_SEND_EMPTY_EXCHANGE_ON_TIMEOUT_DEFAULT = false;
    public static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_TIMEOUT_CONF = "camel.source.endpoint.timeout";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_TIMEOUT_DOC = "To set the maximum time an action could take to complete.";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_TIMEOUT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    public static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_FROM_INDEX_CONF = "camel.source.endpoint.fromIndex";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_FROM_INDEX_DOC = "The index to watch from";
    private static final Long CAMEL_SOURCE_ETCDWATCH_ENDPOINT_FROM_INDEX_DEFAULT = 0L;
    ...
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_ETCDWATCH_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_ETCDWATCH_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_PASSWORD_DOC = "The password to use for basic authentication.";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters.";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_USER_NAME_CONF = "camel.source.endpoint.userName";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_USER_NAME_DOC = "The user name to use for basic authentication.";
    private static final String CAMEL_SOURCE_ETCDWATCH_ENDPOINT_USER_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ETCDWATCH_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_CONFIGURATION_CONF = "camel.component.etcd-watch.configuration";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_CONFIGURATION_DOC = "Component configuration.";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_RECURSIVE_CONF = "camel.component.etcd-watch.recursive";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_RECURSIVE_DOC = "To apply an action recursively.";
    private static final Boolean CAMEL_SOURCE_ETCDWATCH_COMPONENT_RECURSIVE_DEFAULT = false;
    public static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_SERVICE_PATH_CONF = "camel.component.etcd-watch.servicePath";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_SERVICE_PATH_DOC = "The path to look for for service discovery";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_SERVICE_PATH_DEFAULT = "/services/";
    public static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_TIMEOUT_CONF = "camel.component.etcd-watch.timeout";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_TIMEOUT_DOC = "To set the maximum time an action could take to complete.";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_URIS_CONF = "camel.component.etcd-watch.uris";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_URIS_DOC = "To set the URIs the client connects.";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_URIS_DEFAULT = "http://localhost:2379,http://localhost:4001";
    ...
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_SEND_EMPTY_EXCHANGE_ON_TIMEOUT_DOC = "To send an empty message in case of timeout watching for a key.";
    private static final Boolean CAMEL_SOURCE_ETCDWATCH_COMPONENT_SEND_EMPTY_EXCHANGE_ON_TIMEOUT_DEFAULT = false;
    public static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_FROM_INDEX_CONF = "camel.component.etcd-watch.fromIndex";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_FROM_INDEX_DOC = "The index to watch from";
    private static final Long CAMEL_SOURCE_ETCDWATCH_COMPONENT_FROM_INDEX_DEFAULT = 0L;
    ...
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_ETCDWATCH_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_PASSWORD_CONF = "camel.component.etcd-watch.password";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_PASSWORD_DOC = "The password to use for basic authentication.";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters.";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SOURCE_ETCDWATCH_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
    public static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_USER_NAME_CONF = "camel.component.etcd-watch.userName";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_USER_NAME_DOC = "The user name to use for basic authentication.";
    private static final String CAMEL_SOURCE_ETCDWATCH_COMPONENT_USER_NAME_DEFAULT = null;
