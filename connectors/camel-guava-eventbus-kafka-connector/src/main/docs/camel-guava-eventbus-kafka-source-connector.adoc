...
| *camel.source.path.eventBusRef* | To lookup the Guava EventBus from the registry with the given name | null | false | MEDIUM
...
| *camel.component.guava-eventbus.basicProperty Binding* | Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities | false | false | LOW
|===
