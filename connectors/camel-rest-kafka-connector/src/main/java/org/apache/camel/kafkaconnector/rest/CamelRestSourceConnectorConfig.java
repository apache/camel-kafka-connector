...
public class CamelRestSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_REST_PATH_METHOD_DOC = "HTTP method to use. One of: [get] [post] [put] [delete] [patch] [head] [trace] [connect] [options]";
    private static final String CAMEL_SOURCE_REST_PATH_METHOD_DEFAULT = null;
    public static final String CAMEL_SOURCE_REST_PATH_PATH_CONF = "camel.source.path.path";
    private static final String CAMEL_SOURCE_REST_PATH_PATH_DOC = "The base path";
    private static final String CAMEL_SOURCE_REST_PATH_PATH_DEFAULT = null;
    public static final String CAMEL_SOURCE_REST_PATH_URI_TEMPLATE_CONF = "camel.source.path.uriTemplate";
    private static final String CAMEL_SOURCE_REST_PATH_URI_TEMPLATE_DOC = "The uri template";
    private static final String CAMEL_SOURCE_REST_PATH_URI_TEMPLATE_DEFAULT = null;
    public static final String CAMEL_SOURCE_REST_ENDPOINT_CONSUMES_CONF = "camel.source.endpoint.consumes";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_CONSUMES_DOC = "Media type such as: 'text/xml', or 'application/json' this REST service accepts. By default we accept all kinds of types.";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_CONSUMES_DEFAULT = null;
    public static final String CAMEL_SOURCE_REST_ENDPOINT_IN_TYPE_CONF = "camel.source.endpoint.inType";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_IN_TYPE_DOC = "To declare the incoming POJO binding type as a FQN class name";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_IN_TYPE_DEFAULT = null;
    public static final String CAMEL_SOURCE_REST_ENDPOINT_OUT_TYPE_CONF = "camel.source.endpoint.outType";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_OUT_TYPE_DOC = "To declare the outgoing POJO binding type as a FQN class name";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_OUT_TYPE_DEFAULT = null;
    public static final String CAMEL_SOURCE_REST_ENDPOINT_PRODUCES_CONF = "camel.source.endpoint.produces";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_PRODUCES_DOC = "Media type such as: 'text/xml', or 'application/json' this REST service returns.";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_PRODUCES_DEFAULT = null;
    public static final String CAMEL_SOURCE_REST_ENDPOINT_ROUTE_ID_CONF = "camel.source.endpoint.routeId";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_ROUTE_ID_DOC = "Name of the route this REST services creates";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_ROUTE_ID_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_REST_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_REST_ENDPOINT_CONSUMER_COMPONENT_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_REST_ENDPOINT_DESCRIPTION_CONF = "camel.source.endpoint.description";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_DESCRIPTION_DOC = "Human description to document this REST service";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_DESCRIPTION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_REST_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_REST_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_REST_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_REST_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_REST_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_REST_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_REST_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_REST_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_REST_COMPONENT_CONSUMER_COMPONENT_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_REST_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_REST_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_REST_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_REST_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_REST_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
        return conf;
    }
}