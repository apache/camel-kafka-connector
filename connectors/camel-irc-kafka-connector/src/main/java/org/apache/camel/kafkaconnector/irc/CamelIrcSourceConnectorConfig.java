...
public class CamelIrcSourceConnectorConfig extends CamelSourceConnectorConfig {
    ...
    private static final String CAMEL_SOURCE_IRC_PATH_HOSTNAME_DOC = "Hostname for the IRC chat server";
    private static final String CAMEL_SOURCE_IRC_PATH_HOSTNAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_IRC_PATH_PORT_CONF = "camel.source.path.port";
    private static final String CAMEL_SOURCE_IRC_PATH_PORT_DOC = "Port number for the IRC chat server. If no port is configured then a default port of either 6667, 6668 or 6669 is used.";
    private static final Integer CAMEL_SOURCE_IRC_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_AUTO_REJOIN_CONF = "camel.source.endpoint.autoRejoin";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_AUTO_REJOIN_DOC = "Whether to auto re-join when being kicked";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_AUTO_REJOIN_DEFAULT = true;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_CHANNELS_CONF = "camel.source.endpoint.channels";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_CHANNELS_DOC = "Comma separated list of IRC channels.";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_CHANNELS_DEFAULT = null;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_COMMAND_TIMEOUT_CONF = "camel.source.endpoint.commandTimeout";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_COMMAND_TIMEOUT_DOC = "Delay in milliseconds before sending commands after the connection is established.";
    private static final Long CAMEL_SOURCE_IRC_ENDPOINT_COMMAND_TIMEOUT_DEFAULT = 5000L;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_KEYS_CONF = "camel.source.endpoint.keys";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_KEYS_DOC = "Comma separated list of keys for channels.";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_KEYS_DEFAULT = null;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_NAMES_ON_JOIN_CONF = "camel.source.endpoint.namesOnJoin";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_NAMES_ON_JOIN_DOC = "Sends NAMES command to channel after joining it. onReply has to be true in order to process the result which will have the header value irc.num = '353'.";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_NAMES_ON_JOIN_DEFAULT = false;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_NICKNAME_CONF = "camel.source.endpoint.nickname";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_NICKNAME_DOC = "The nickname used in chat.";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_NICKNAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_PERSISTENT_CONF = "camel.source.endpoint.persistent";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_PERSISTENT_DOC = "Use persistent messages.";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_PERSISTENT_DEFAULT = true;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_REALNAME_CONF = "camel.source.endpoint.realname";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_REALNAME_DOC = "The IRC user's actual name.";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_REALNAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_COLORS_CONF = "camel.source.endpoint.colors";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_COLORS_DOC = "Whether or not the server supports color codes.";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_COLORS_DEFAULT = true;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_JOIN_CONF = "camel.source.endpoint.onJoin";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_JOIN_DOC = "Handle user join events.";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_ON_JOIN_DEFAULT = true;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_KICK_CONF = "camel.source.endpoint.onKick";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_KICK_DOC = "Handle kick events.";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_ON_KICK_DEFAULT = true;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_MODE_CONF = "camel.source.endpoint.onMode";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_MODE_DOC = "Handle mode change events.";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_ON_MODE_DEFAULT = true;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_NICK_CONF = "camel.source.endpoint.onNick";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_NICK_DOC = "Handle nickname change events.";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_ON_NICK_DEFAULT = true;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_PART_CONF = "camel.source.endpoint.onPart";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_PART_DOC = "Handle user part events.";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_ON_PART_DEFAULT = true;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_PRIVMSG_CONF = "camel.source.endpoint.onPrivmsg";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_PRIVMSG_DOC = "Handle private message events.";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_ON_PRIVMSG_DEFAULT = true;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_QUIT_CONF = "camel.source.endpoint.onQuit";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_QUIT_DOC = "Handle user quit events.";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_ON_QUIT_DEFAULT = true;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_REPLY_CONF = "camel.source.endpoint.onReply";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_REPLY_DOC = "Whether or not to handle general responses to commands or informational messages.";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_ON_REPLY_DEFAULT = false;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_TOPIC_CONF = "camel.source.endpoint.onTopic";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_ON_TOPIC_DOC = "Handle topic change events.";
    private static final Boolean CAMEL_SOURCE_IRC_ENDPOINT_ON_TOPIC_DEFAULT = true;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_NICK_PASSWORD_CONF = "camel.source.endpoint.nickPassword";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_NICK_PASSWORD_DOC = "Your IRC server nickname password.";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_NICK_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_PASSWORD_DOC = "The IRC server password.";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_TRUST_MANAGER_CONF = "camel.source.endpoint.trustManager";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_TRUST_MANAGER_DOC = "The trust manager used to verify the SSL server's certificate.";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_TRUST_MANAGER_DEFAULT = null;
    public static final String CAMEL_SOURCE_IRC_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_USERNAME_DOC = "The IRC server user name.";
    private static final String CAMEL_SOURCE_IRC_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_IRC_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_IRC_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_IRC_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_IRC_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SOURCE_IRC_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
