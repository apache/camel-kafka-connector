...
public class CamelIrcSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_IRC_PATH_HOSTNAME_DOC = "Hostname for the IRC chat server";
    private static final String CAMEL_SINK_IRC_PATH_HOSTNAME_DEFAULT = null;
    public static final String CAMEL_SINK_IRC_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_IRC_PATH_PORT_DOC = "Port number for the IRC chat server. If no port is configured then a default port of either 6667, 6668 or 6669 is used.";
    private static final Integer CAMEL_SINK_IRC_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_IRC_ENDPOINT_AUTO_REJOIN_CONF = "camel.sink.endpoint.autoRejoin";
    private static final String CAMEL_SINK_IRC_ENDPOINT_AUTO_REJOIN_DOC = "Whether to auto re-join when being kicked";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_AUTO_REJOIN_DEFAULT = true;
    public static final String CAMEL_SINK_IRC_ENDPOINT_CHANNELS_CONF = "camel.sink.endpoint.channels";
    private static final String CAMEL_SINK_IRC_ENDPOINT_CHANNELS_DOC = "Comma separated list of IRC channels.";
    private static final String CAMEL_SINK_IRC_ENDPOINT_CHANNELS_DEFAULT = null;
    public static final String CAMEL_SINK_IRC_ENDPOINT_COMMAND_TIMEOUT_CONF = "camel.sink.endpoint.commandTimeout";
    private static final String CAMEL_SINK_IRC_ENDPOINT_COMMAND_TIMEOUT_DOC = "Delay in milliseconds before sending commands after the connection is established.";
    private static final Long CAMEL_SINK_IRC_ENDPOINT_COMMAND_TIMEOUT_DEFAULT = 5000L;
    public static final String CAMEL_SINK_IRC_ENDPOINT_KEYS_CONF = "camel.sink.endpoint.keys";
    private static final String CAMEL_SINK_IRC_ENDPOINT_KEYS_DOC = "Comma separated list of keys for channels.";
    private static final String CAMEL_SINK_IRC_ENDPOINT_KEYS_DEFAULT = null;
    public static final String CAMEL_SINK_IRC_ENDPOINT_NAMES_ON_JOIN_CONF = "camel.sink.endpoint.namesOnJoin";
    private static final String CAMEL_SINK_IRC_ENDPOINT_NAMES_ON_JOIN_DOC = "Sends NAMES command to channel after joining it. onReply has to be true in order to process the result which will have the header value irc.num = '353'.";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_NAMES_ON_JOIN_DEFAULT = false;
    public static final String CAMEL_SINK_IRC_ENDPOINT_NICKNAME_CONF = "camel.sink.endpoint.nickname";
    private static final String CAMEL_SINK_IRC_ENDPOINT_NICKNAME_DOC = "The nickname used in chat.";
    private static final String CAMEL_SINK_IRC_ENDPOINT_NICKNAME_DEFAULT = null;
    public static final String CAMEL_SINK_IRC_ENDPOINT_PERSISTENT_CONF = "camel.sink.endpoint.persistent";
    private static final String CAMEL_SINK_IRC_ENDPOINT_PERSISTENT_DOC = "Use persistent messages.";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_PERSISTENT_DEFAULT = true;
    public static final String CAMEL_SINK_IRC_ENDPOINT_REALNAME_CONF = "camel.sink.endpoint.realname";
    private static final String CAMEL_SINK_IRC_ENDPOINT_REALNAME_DOC = "The IRC user's actual name.";
    private static final String CAMEL_SINK_IRC_ENDPOINT_REALNAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_IRC_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_IRC_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_IRC_ENDPOINT_COLORS_CONF = "camel.sink.endpoint.colors";
    private static final String CAMEL_SINK_IRC_ENDPOINT_COLORS_DOC = "Whether or not the server supports color codes.";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_COLORS_DEFAULT = true;
    public static final String CAMEL_SINK_IRC_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_IRC_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_IRC_ENDPOINT_ON_JOIN_CONF = "camel.sink.endpoint.onJoin";
    private static final String CAMEL_SINK_IRC_ENDPOINT_ON_JOIN_DOC = "Handle user join events.";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_ON_JOIN_DEFAULT = true;
    public static final String CAMEL_SINK_IRC_ENDPOINT_ON_KICK_CONF = "camel.sink.endpoint.onKick";
    private static final String CAMEL_SINK_IRC_ENDPOINT_ON_KICK_DOC = "Handle kick events.";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_ON_KICK_DEFAULT = true;
    public static final String CAMEL_SINK_IRC_ENDPOINT_ON_MODE_CONF = "camel.sink.endpoint.onMode";
    private static final String CAMEL_SINK_IRC_ENDPOINT_ON_MODE_DOC = "Handle mode change events.";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_ON_MODE_DEFAULT = true;
    public static final String CAMEL_SINK_IRC_ENDPOINT_ON_NICK_CONF = "camel.sink.endpoint.onNick";
    private static final String CAMEL_SINK_IRC_ENDPOINT_ON_NICK_DOC = "Handle nickname change events.";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_ON_NICK_DEFAULT = true;
    public static final String CAMEL_SINK_IRC_ENDPOINT_ON_PART_CONF = "camel.sink.endpoint.onPart";
    private static final String CAMEL_SINK_IRC_ENDPOINT_ON_PART_DOC = "Handle user part events.";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_ON_PART_DEFAULT = true;
    public static final String CAMEL_SINK_IRC_ENDPOINT_ON_PRIVMSG_CONF = "camel.sink.endpoint.onPrivmsg";
    private static final String CAMEL_SINK_IRC_ENDPOINT_ON_PRIVMSG_DOC = "Handle private message events.";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_ON_PRIVMSG_DEFAULT = true;
    public static final String CAMEL_SINK_IRC_ENDPOINT_ON_QUIT_CONF = "camel.sink.endpoint.onQuit";
    private static final String CAMEL_SINK_IRC_ENDPOINT_ON_QUIT_DOC = "Handle user quit events.";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_ON_QUIT_DEFAULT = true;
    public static final String CAMEL_SINK_IRC_ENDPOINT_ON_REPLY_CONF = "camel.sink.endpoint.onReply";
    private static final String CAMEL_SINK_IRC_ENDPOINT_ON_REPLY_DOC = "Whether or not to handle general responses to commands or informational messages.";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_ON_REPLY_DEFAULT = false;
    public static final String CAMEL_SINK_IRC_ENDPOINT_ON_TOPIC_CONF = "camel.sink.endpoint.onTopic";
    private static final String CAMEL_SINK_IRC_ENDPOINT_ON_TOPIC_DOC = "Handle topic change events.";
    private static final Boolean CAMEL_SINK_IRC_ENDPOINT_ON_TOPIC_DEFAULT = true;
    public static final String CAMEL_SINK_IRC_ENDPOINT_NICK_PASSWORD_CONF = "camel.sink.endpoint.nickPassword";
    private static final String CAMEL_SINK_IRC_ENDPOINT_NICK_PASSWORD_DOC = "Your IRC server nickname password.";
    private static final String CAMEL_SINK_IRC_ENDPOINT_NICK_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_IRC_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_IRC_ENDPOINT_PASSWORD_DOC = "The IRC server password.";
    private static final String CAMEL_SINK_IRC_ENDPOINT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IRC_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_IRC_ENDPOINT_TRUST_MANAGER_CONF = "camel.sink.endpoint.trustManager";
    private static final String CAMEL_SINK_IRC_ENDPOINT_TRUST_MANAGER_DOC = "The trust manager used to verify the SSL server's certificate.";
    private static final String CAMEL_SINK_IRC_ENDPOINT_TRUST_MANAGER_DEFAULT = null;
    public static final String CAMEL_SINK_IRC_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_IRC_ENDPOINT_USERNAME_DOC = "The IRC server user name.";
    private static final String CAMEL_SINK_IRC_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_IRC_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_IRC_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.irc.basicPropertyBinding";
    private static final String CAMEL_SINK_IRC_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_IRC_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_IRC_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SINK_IRC_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
