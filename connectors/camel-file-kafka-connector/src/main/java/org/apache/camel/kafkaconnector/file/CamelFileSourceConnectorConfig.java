...
public class CamelFileSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_FILE_ENDPOINT_JAIL_STARTING_DIRECTORY_CONF = "camel.source.endpoint.jailStartingDirectory";
    public static final String CAMEL_SOURCE_FILE_ENDPOINT_JAIL_STARTING_DIRECTORY_DOC = "Used for jailing (restricting) writing files to the starting directory (and sub) only. This is enabled by default to not allow Camel to write files to outside directories (to be more secured out of the box). You can turn this off to allow writing files to directories outside the starting directory, such as parent or root folders. For consumers that use a localWorkDirectory, this also restricts the downloaded files to stay within the configured localWorkDirectory.";
    public static final Boolean CAMEL_SOURCE_FILE_ENDPOINT_JAIL_STARTING_DIRECTORY_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_FILE_ENDPOINT_PRE_SORT_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_FILE_COMPONENT_BRIDGE_ERROR_HANDLER_DOC = "Allows for bridging the consumer to the Camel routing Error Handler, which mean any exceptions (if possible) occurred while the Camel consumer is trying to pickup incoming messages, or the likes, will now be processed as a message and handled by the routing Error Handler. Important: This is only possible if the 3rd party component allows Camel to be alerted if an exception was thrown. Some components handle this internally only, and therefore bridgeErrorHandler is not possible. In other situations we may improve the Camel component to hook into the 3rd party component and make this possible for future releases. By default the consumer will use the org.apache.camel.spi.ExceptionHandler to deal with exceptions, that will be logged at WARN or ERROR level and ignored.";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_FILE_ENDPOINT_JAIL_STARTING_DIRECTORY_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_FILE_ENDPOINT_JAIL_STARTING_DIRECTORY_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_FILE_ENDPOINT_JAIL_STARTING_DIRECTORY_DOC);
        ...
        conf.define(CAMEL_SOURCE_FILE_ENDPOINT_PRE_SORT_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_FILE_ENDPOINT_PRE_SORT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_FILE_ENDPOINT_PRE_SORT_DOC);
        ...
        conf.define(CAMEL_SOURCE_FILE_ENDPOINT_INCLUDE_HIDDEN_DIRS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_FILE_ENDPOINT_INCLUDE_HIDDEN_DIRS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_FILE_ENDPOINT_INCLUDE_HIDDEN_DIRS_DOC);
