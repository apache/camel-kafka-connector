...
public class CamelFileSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_FILE_PATH_DIRECTORY_NAME_DOC = "The starting directory";
    private static final String CAMEL_SINK_FILE_PATH_DIRECTORY_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FILE_ENDPOINT_CHARSET_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FILE_ENDPOINT_DONE_FILE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FILE_ENDPOINT_FILE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FILE_ENDPOINT_APPEND_CHARS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FILE_ENDPOINT_FILE_EXIST_DEFAULT = "Override";
    ...
    private static final Boolean CAMEL_SINK_FILE_ENDPOINT_FLATTEN_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_FILE_ENDPOINT_JAIL_STARTING_DIRECTORY_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_FILE_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_FILE_ENDPOINT_MOVE_EXISTING_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FILE_ENDPOINT_TEMP_FILE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_FILE_ENDPOINT_TEMP_PREFIX_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_FILE_ENDPOINT_ALLOW_NULL_BODY_DEFAULT = false;
    public static final String CAMEL_SINK_FILE_ENDPOINT_CHMOD_CONF = "camel.sink.endpoint.chmod";
    private static final String CAMEL_SINK_FILE_ENDPOINT_CHMOD_DOC = "Specify the file permissions which is sent by the producer, the chmod value must be between 000 and 777; If there is a leading digit like in 0755 we will ignore it.";
    private static final String CAMEL_SINK_FILE_ENDPOINT_CHMOD_DEFAULT = null;
    public static final String CAMEL_SINK_FILE_ENDPOINT_CHMOD_DIRECTORY_CONF = "camel.sink.endpoint.chmodDirectory";
    private static final String CAMEL_SINK_FILE_ENDPOINT_CHMOD_DIRECTORY_DOC = "Specify the directory permissions used when the producer creates missing directories, the chmod value must be between 000 and 777; If there is a leading digit like in 0755 we will ignore it.";
    private static final String CAMEL_SINK_FILE_ENDPOINT_CHMOD_DIRECTORY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_FILE_ENDPOINT_EAGER_DELETE_TARGET_FILE_DEFAULT = true;
    public static final String CAMEL_SINK_FILE_ENDPOINT_FORCE_WRITES_CONF = "camel.sink.endpoint.forceWrites";
    private static final String CAMEL_SINK_FILE_ENDPOINT_FORCE_WRITES_DOC = "Whether to force syncing writes to the file system. You can turn this off if you do not want this level of guarantee, for example if writing to logs / audit logs etc; this would yield better performance.";
    private static final Boolean CAMEL_SINK_FILE_ENDPOINT_FORCE_WRITES_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_FILE_ENDPOINT_KEEP_LAST_MODIFIED_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_FILE_ENDPOINT_MOVE_EXISTING_FILE_STRATEGY_DOC = "Strategy (Custom Strategy) used to move file with special naming token to use when fileExist=Move is configured. By default, there is an implementation used if no custom strategy is provided";
    private static final String CAMEL_SINK_FILE_ENDPOINT_MOVE_EXISTING_FILE_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SINK_FILE_ENDPOINT_AUTO_CREATE_CONF = "camel.sink.endpoint.autoCreate";
    private static final String CAMEL_SINK_FILE_ENDPOINT_AUTO_CREATE_DOC = "Automatically create missing directories in the file's pathname. For the file consumer, that means creating the starting directory. For the file producer, it means the directory the files should be written to.";
    private static final Boolean CAMEL_SINK_FILE_ENDPOINT_AUTO_CREATE_DEFAULT = true;
    public static final String CAMEL_SINK_FILE_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_FILE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_FILE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_FILE_ENDPOINT_BUFFER_SIZE_CONF = "camel.sink.endpoint.bufferSize";
    private static final String CAMEL_SINK_FILE_ENDPOINT_BUFFER_SIZE_DOC = "Buffer size in bytes used for writing files (or in case of FTP for downloading and uploading files).";
    private static final Integer CAMEL_SINK_FILE_ENDPOINT_BUFFER_SIZE_DEFAULT = 131072;
    ...
    private static final String CAMEL_SINK_FILE_ENDPOINT_COPY_AND_DELETE_ON_RENAME_FAIL_DOC = "Whether to fallback and do a copy and delete file, in case the file could not be renamed directly. This option is not available for the FTP component.";
    private static final Boolean CAMEL_SINK_FILE_ENDPOINT_COPY_AND_DELETE_ON_RENAME_FAIL_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_FILE_ENDPOINT_RENAME_USING_COPY_DEFAULT = false;
    public static final String CAMEL_SINK_FILE_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_FILE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_FILE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_FILE_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_FILE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_FILE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
