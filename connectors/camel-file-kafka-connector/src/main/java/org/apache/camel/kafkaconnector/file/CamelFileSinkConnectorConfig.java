...
public class CamelFileSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_FILE_ENDPOINT_CHECKSUM_FILE_ALGORITHM_DOC = "If provided, then Camel will calculate a checksum from the file that has been written, and store the result in the CamelFileChecksum header. One of: [MD2] [MD5] [SHA_1] [SHA_224] [SHA_256] [SHA_384] [SHA_512] [SHA_512_224] [SHA_512_256] [SHA3_224] [SHA3_256] [SHA3_384] [SHA3_512]";
    public static final String CAMEL_SINK_FILE_ENDPOINT_CHECKSUM_FILE_ALGORITHM_DEFAULT = null;
    public static final String CAMEL_SINK_FILE_ENDPOINT_CHECKSUM_WRITE_FILE_CONF = "camel.sink.endpoint.checksumWriteFile";
    public static final String CAMEL_SINK_FILE_ENDPOINT_CHECKSUM_WRITE_FILE_DOC = "If checksumFileAlgorithm has been configured then this option controls whether to write a checksum file as well or not. The checksum file will always be written in the same folder as the original file.";
    public static final Boolean CAMEL_SINK_FILE_ENDPOINT_CHECKSUM_WRITE_FILE_DEFAULT = true;
    ...
    public static final String CAMEL_SINK_FILE_ENDPOINT_CHMOD_DOC = "Specify the file permissions that are sent by the producer, the chmod value must be between 000 and 777; If there is a leading digit like in 0755, we will ignore it.";
    ...
    public static final Boolean CAMEL_SINK_FILE_ENDPOINT_FORCE_WRITES_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_FILE_ENDPOINT_COPY_AND_DELETE_ON_RENAME_FAIL_DOC = "Whether to fall back and do a copy and delete file, in case the file could not be renamed directly. This option is not available for the FTP component.";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_FILE_ENDPOINT_CHECKSUM_WRITE_FILE_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_FILE_ENDPOINT_CHECKSUM_WRITE_FILE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_FILE_ENDPOINT_CHECKSUM_WRITE_FILE_DOC);
        ...
        conf.define(CAMEL_SINK_FILE_ENDPOINT_FORCE_WRITES_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_FILE_ENDPOINT_FORCE_WRITES_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_FILE_ENDPOINT_FORCE_WRITES_DOC);
