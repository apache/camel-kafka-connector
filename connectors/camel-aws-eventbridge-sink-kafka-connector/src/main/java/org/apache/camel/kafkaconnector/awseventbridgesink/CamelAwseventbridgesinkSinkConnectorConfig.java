...
public class CamelAwseventbridgesinkSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_AWSEVENTBRIDGESINK_KAMELET_PROFILE_CREDENTIALS_NAME_DOC = "If using a profile credentials provider this parameter will set the profile name.";
