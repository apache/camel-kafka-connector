...
public class CamelKafkanotsecuredsourceSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_KAFKANOTSECUREDSOURCE_KAMELET_BROKERS_CONF = "camel.kamelet.kafka-not-secured-source.brokers";
    public static final String CAMEL_SOURCE_KAFKANOTSECUREDSOURCE_KAMELET_BROKERS_DOC = "Comma separated list of Kafka Broker URLs";
    public static final String CAMEL_SOURCE_KAFKANOTSECUREDSOURCE_KAMELET_BROKERS_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_KAFKANOTSECUREDSOURCE_KAMELET_BROKERS_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_KAFKANOTSECUREDSOURCE_KAMELET_BROKERS_DEFAULT, ConfigDef.Importance.HIGH, CAMEL_SOURCE_KAFKANOTSECUREDSOURCE_KAMELET_BROKERS_DOC);
