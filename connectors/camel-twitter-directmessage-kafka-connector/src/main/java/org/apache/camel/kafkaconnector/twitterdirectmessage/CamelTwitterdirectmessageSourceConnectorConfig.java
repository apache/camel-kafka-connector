...
public class CamelTwitterdirectmessageSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    public static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts. You can also specify time values using units, such as 60s (60 seconds), 5m30s (5 minutes and 30 seconds), and 1h (1 hour).";
    ...
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component One of: [none] [spring] [quartz]";
    ...
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
