...
public class CamelTwitterdirectmessageSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_PATH_USER_DOC = "The user name to send a direct message. This will be ignored for consumer.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_PATH_USER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DOC = "If the polling consumer did not poll any files, you can enable this option to send an empty message (no body) instead.";
    private static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_TYPE_CONF = "camel.source.endpoint.type";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_TYPE_DOC = "Endpoint type to use. One of: [polling] [direct]";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_TYPE_DEFAULT = "polling";
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_DISTANCE_METRIC_DEFAULT = "km";
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_EXTENDED_MODE_DOC = "Used for enabling full text from twitter (eg receive tweets that contains more than 140 characters).";
    private static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_EXTENDED_MODE_DEFAULT = true;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_LATITUDE_CONF = "camel.source.endpoint.latitude";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_LATITUDE_DOC = "Used by the geography search to search by latitude. You need to configure all the following options: longitude, latitude, radius, and distanceMetric.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_LATITUDE_DEFAULT = null;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_LOCATIONS_CONF = "camel.source.endpoint.locations";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_LOCATIONS_DOC = "Bounding boxes, created by pairs of lat/lons. Can be used for filter. A pair is defined as lat,lon. And multiple paris can be separated by semi colon.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_LOCATIONS_DEFAULT = null;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_LONGITUDE_CONF = "camel.source.endpoint.longitude";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_LONGITUDE_DOC = "Used by the geography search to search by longitude. You need to configure all the following options: longitude, latitude, radius, and distanceMetric.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_LONGITUDE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_POLL_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_RADIUS_CONF = "camel.source.endpoint.radius";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_RADIUS_DOC = "Used by the geography search to search by radius. You need to configure all the following options: longitude, latitude, radius, and distanceMetric.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_RADIUS_DEFAULT = null;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.source.endpoint.basicPropertyBinding";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_COUNT_CONF = "camel.source.endpoint.count";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_COUNT_DOC = "Limiting number of results per page.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_COUNT_DEFAULT = "5";
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_FILTER_OLD_CONF = "camel.source.endpoint.filterOld";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_FILTER_OLD_DOC = "Filter out old tweets, that has previously been polled. This state is stored in memory only, and based on last tweet id.";
    private static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_FILTER_OLD_DEFAULT = true;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_LANG_CONF = "camel.source.endpoint.lang";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_LANG_DOC = "The lang string ISO_639-1 which will be used for searching";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_LANG_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_NUMBER_OF_PAGES_DOC = "The number of pages result which you want camel-twitter to consume.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_NUMBER_OF_PAGES_DEFAULT = "1";
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SINCE_ID_CONF = "camel.source.endpoint.sinceId";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SINCE_ID_DOC = "The last tweet id which will be used for pulling the tweets. It is useful when the camel route is restarted after a long running.";
    private static final Long CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SINCE_ID_DEFAULT = 1L;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_USER_IDS_CONF = "camel.source.endpoint.userIds";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_USER_IDS_DOC = "To filter by user ids for filter. Multiple values can be separated by comma.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_USER_IDS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_HTTP_PROXY_HOST_DOC = "The http proxy host which can be used for the camel-twitter. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_HTTP_PROXY_HOST_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_HTTP_PROXY_PASSWORD_DOC = "The http proxy password which can be used for the camel-twitter. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_HTTP_PROXY_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_HTTP_PROXY_PORT_DOC = "The http proxy port which can be used for the camel-twitter. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_HTTP_PROXY_PORT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_HTTP_PROXY_USER_DOC = "The http proxy user which can be used for the camel-twitter. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_HTTP_PROXY_USER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DOC = "The number of subsequent error polls (failed due some error) that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DOC = "The number of subsequent idle polls that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BACKOFF_MULTIPLIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll.";
    private static final Long CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_DELAY_DEFAULT = 30000L;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_GREEDY_CONF = "camel.source.endpoint.greedy";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_GREEDY_DOC = "If greedy is enabled, then the ScheduledPollConsumer will run immediately again, if the previous run polled 1 or more messages.";
    private static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_GREEDY_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts.";
    private static final Long CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_REPEAT_COUNT_DOC = "Specifies a maximum limit of number of fires. So if you set it to 1, the scheduler will only fire once. If you set it to 5, it will only fire five times. A value of zero or negative means fire forever.";
    private static final Long CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_RUN_LOGGING_LEVEL_DOC = "The consumer logs a start/complete log line when it polls. This option allows you to configure the logging level for that. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_RUN_LOGGING_LEVEL_DEFAULT = "TRACE";
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DOC = "Allows for configuring a custom/shared thread pool to use for the consumer. By default each consumer has its own single threaded thread pool.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DEFAULT = null;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SCHEDULER_CONF = "camel.source.endpoint.scheduler";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component One of: [none] [spring] [quartz]";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SCHEDULER_DEFAULT = "none";
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SCHEDULER_PROPERTIES_DOC = "To configure additional properties when using a custom scheduler or any of the Quartz, Spring based scheduler.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SCHEDULER_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_START_SCHEDULER_DOC = "Whether the scheduler should be auto started.";
    private static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_START_SCHEDULER_DEFAULT = true;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_TIME_UNIT_CONF = "camel.source.endpoint.timeUnit";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_TIME_UNIT_DOC = "Time unit for initialDelay and delay options. One of: [NANOSECONDS] [MICROSECONDS] [MILLISECONDS] [SECONDS] [MINUTES] [HOURS] [DAYS]";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_TIME_UNIT_DEFAULT = "MILLISECONDS";
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_USE_FIXED_DELAY_DOC = "Controls if fixed delay or fixed rate is used. See ScheduledExecutorService in JDK for details.";
    private static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_USE_FIXED_DELAY_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_ACCESS_TOKEN_DOC = "The access token. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_ACCESS_TOKEN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_ACCESS_TOKEN_SECRET_DOC = "The access secret. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_ACCESS_TOKEN_SECRET_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_CONSUMER_KEY_DOC = "The consumer key. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_CONSUMER_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_CONSUMER_SECRET_DOC = "The consumer secret. Can also be configured on the TwitterComponent level instead.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_CONSUMER_SECRET_DEFAULT = null;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SORT_BY_ID_CONF = "camel.source.endpoint.sortById";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SORT_BY_ID_DOC = "Sorts by id, so the oldest are first, and newest last.";
    private static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SORT_BY_ID_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.twitter-directmessage.basicPropertyBinding";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_HTTP_PROXY_HOST_DOC = "The http proxy host which can be used for the camel-twitter.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_HTTP_PROXY_HOST_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_HTTP_PROXY_PASSWORD_DOC = "The http proxy password which can be used for the camel-twitter.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_HTTP_PROXY_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_HTTP_PROXY_PORT_DOC = "The http proxy port which can be used for the camel-twitter.";
    private static final Integer CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_HTTP_PROXY_PORT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_HTTP_PROXY_USER_DOC = "The http proxy user which can be used for the camel-twitter.";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_HTTP_PROXY_USER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_ACCESS_TOKEN_DOC = "The access token";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_ACCESS_TOKEN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_ACCESS_TOKEN_SECRET_DOC = "The access token secret";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_ACCESS_TOKEN_SECRET_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_CONSUMER_KEY_DOC = "The consumer key";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_CONSUMER_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_CONSUMER_SECRET_DOC = "The consumer secret";
    private static final String CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_CONSUMER_SECRET_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
        conf.define(CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SYNCHRONOUS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SYNCHRONOUS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_TWITTERDIRECTMESSAGE_ENDPOINT_SYNCHRONOUS_DOC);
        ...
        conf.define(CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_TWITTERDIRECTMESSAGE_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
