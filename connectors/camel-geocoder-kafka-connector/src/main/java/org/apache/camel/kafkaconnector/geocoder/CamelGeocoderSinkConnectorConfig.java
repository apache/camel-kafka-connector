...
public class CamelGeocoderSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_GEOCODER_PATH_ADDRESS_DOC = "The geo address which should be prefixed with address:";
    private static final String CAMEL_SINK_GEOCODER_PATH_ADDRESS_DEFAULT = null;
    public static final String CAMEL_SINK_GEOCODER_PATH_LATLNG_CONF = "camel.sink.path.latlng";
    private static final String CAMEL_SINK_GEOCODER_PATH_LATLNG_DOC = "The geo latitude and longitude which should be prefixed with latlng:";
    private static final String CAMEL_SINK_GEOCODER_PATH_LATLNG_DEFAULT = null;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_HEADERS_ONLY_CONF = "camel.sink.endpoint.headersOnly";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_HEADERS_ONLY_DOC = "Whether to only enrich the Exchange with headers, and leave the body as-is.";
    private static final Boolean CAMEL_SINK_GEOCODER_ENDPOINT_HEADERS_ONLY_DEFAULT = false;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_LANGUAGE_CONF = "camel.sink.endpoint.language";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_LANGUAGE_DOC = "The language to use.";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_LANGUAGE_DEFAULT = "en";
    ...
    private static final Boolean CAMEL_SINK_GEOCODER_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_SERVER_URL_CONF = "camel.sink.endpoint.serverUrl";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_SERVER_URL_DOC = "URL to the geocoder server. Mandatory for Nominatim server.";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_SERVER_URL_DEFAULT = null;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_TYPE_CONF = "camel.sink.endpoint.type";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_TYPE_DOC = "Type of GeoCoding server. Supported Nominatim and Google. One of: [NOMINATIM] [GOOGLE]";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_TYPE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GEOCODER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_GEOCODER_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_DOMAIN_CONF = "camel.sink.endpoint.proxyAuthDomain";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_DOMAIN_DOC = "Proxy Authentication Domain to access Google GeoCoding server.";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_DOMAIN_DEFAULT = null;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_HOST_CONF = "camel.sink.endpoint.proxyAuthHost";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_HOST_DOC = "Proxy Authentication Host to access Google GeoCoding server.";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_METHOD_CONF = "camel.sink.endpoint.proxyAuthMethod";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_METHOD_DOC = "Authentication Method to Google GeoCoding server.";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_METHOD_DEFAULT = null;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_PASSWORD_CONF = "camel.sink.endpoint.proxyAuthPassword";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_PASSWORD_DOC = "Proxy Password to access GeoCoding server.";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_USERNAME_CONF = "camel.sink.endpoint.proxyAuthUsername";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_USERNAME_DOC = "Proxy Username to access GeoCoding server.";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_AUTH_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_HOST_CONF = "camel.sink.endpoint.proxyHost";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_HOST_DOC = "Proxy Host to access GeoCoding server.";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_PORT_CONF = "camel.sink.endpoint.proxyPort";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_PORT_DOC = "Proxy Port to access GeoCoding server.";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_API_KEY_CONF = "camel.sink.endpoint.apiKey";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_API_KEY_DOC = "API Key to access Google. Mandatory for Google GeoCoding server.";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_API_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_CLIENT_ID_CONF = "camel.sink.endpoint.clientId";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_CLIENT_ID_DOC = "Client ID to access Google GeoCoding server.";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_CLIENT_ID_DEFAULT = null;
    public static final String CAMEL_SINK_GEOCODER_ENDPOINT_CLIENT_KEY_CONF = "camel.sink.endpoint.clientKey";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_CLIENT_KEY_DOC = "Client Key to access Google GeoCoding server.";
    private static final String CAMEL_SINK_GEOCODER_ENDPOINT_CLIENT_KEY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_GEOCODER_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_GEOCODER_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GEOCODER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
