...
public class CamelControlbusSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_CONTROLBUS_PATH_COMMAND_DOC = "Command can be either route or language One of: [route] [language]";
    private static final String CAMEL_SINK_CONTROLBUS_PATH_COMMAND_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CONTROLBUS_PATH_LANGUAGE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_ACTION_DEFAULT = null;
    public static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_ASYNC_CONF = "camel.sink.endpoint.async";
    private static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_ASYNC_DOC = "Whether to execute the control bus task asynchronously. Important: If this option is enabled, then any result from the task is not set on the Exchange. This is only possible if executing tasks synchronously.";
    private static final Boolean CAMEL_SINK_CONTROLBUS_ENDPOINT_ASYNC_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_CONTROLBUS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_LOGGING_LEVEL_CONF = "camel.sink.endpoint.loggingLevel";
    private static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_LOGGING_LEVEL_DOC = "Logging level used for logging when task is done, or if any exceptions occurred during processing the task. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_LOGGING_LEVEL_DEFAULT = "INFO";
    public static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_RESTART_DELAY_CONF = "camel.sink.endpoint.restartDelay";
    private static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_RESTART_DELAY_DOC = "The delay in millis to use when restarting a route.";
    private static final Integer CAMEL_SINK_CONTROLBUS_ENDPOINT_RESTART_DELAY_DEFAULT = 1000;
    public static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_ROUTE_ID_CONF = "camel.sink.endpoint.routeId";
    private static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_ROUTE_ID_DOC = "To specify a route by its id. The special keyword current indicates the current route.";
    private static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_ROUTE_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CONTROLBUS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_CONTROLBUS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_CONTROLBUS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_CONTROLBUS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CONTROLBUS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CONTROLBUS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
