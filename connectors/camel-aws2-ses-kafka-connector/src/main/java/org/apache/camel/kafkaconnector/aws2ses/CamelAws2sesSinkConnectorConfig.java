...
public class CamelAws2sesSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWS2SES_COMPONENT_REGION_DOC = "The region in which SES client needs to work";
    ...
    public static final String CAMEL_SINK_AWS2SES_COMPONENT_CONFIGURATION_DOC = "The AWS SES default configuration";
