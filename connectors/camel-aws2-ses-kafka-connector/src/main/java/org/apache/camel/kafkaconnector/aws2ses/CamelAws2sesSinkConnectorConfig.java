...
public class CamelAws2sesSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_AWS2SES_PATH_FROM_DOC = "The sender's email address.";
    private static final String CAMEL_SINK_AWS2SES_PATH_FROM_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_ENDPOINT_AMAZON_SESCLIENT_CONF = "camel.sink.endpoint.amazonSESClient";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_AMAZON_SESCLIENT_DOC = "To use the AmazonSimpleEmailService as the client";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_AMAZON_SESCLIENT_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_AWS2SES_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_AWS2SES_ENDPOINT_PROXY_HOST_CONF = "camel.sink.endpoint.proxyHost";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_PROXY_HOST_DOC = "To define a proxy host when instantiating the SES client";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_ENDPOINT_PROXY_PORT_CONF = "camel.sink.endpoint.proxyPort";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_PROXY_PORT_DOC = "To define a proxy port when instantiating the SES client";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_ENDPOINT_PROXY_PROTOCOL_CONF = "camel.sink.endpoint.proxyProtocol";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_PROXY_PROTOCOL_DOC = "To define a proxy protocol when instantiating the SES client One of: [HTTP] [HTTPS]";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_PROXY_PROTOCOL_DEFAULT = "HTTPS";
    public static final String CAMEL_SINK_AWS2SES_ENDPOINT_REGION_CONF = "camel.sink.endpoint.region";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_REGION_DOC = "The region in which SES client needs to work. When using this parameter, the configuration will expect the lowercase name of the region (for example ap-east-1) You'll need to use the name Region.EU_WEST_1.id()";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_REGION_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_ENDPOINT_REPLY_TO_ADDRESSES_CONF = "camel.sink.endpoint.replyToAddresses";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_REPLY_TO_ADDRESSES_DOC = "List of reply-to email address(es) for the message, override it using 'CamelAwsSesReplyToAddresses' header.";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_REPLY_TO_ADDRESSES_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_ENDPOINT_RETURN_PATH_CONF = "camel.sink.endpoint.returnPath";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_RETURN_PATH_DOC = "The email address to which bounce notifications are to be forwarded, override it using 'CamelAwsSesReturnPath' header.";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_RETURN_PATH_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_ENDPOINT_SUBJECT_CONF = "camel.sink.endpoint.subject";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_SUBJECT_DOC = "The subject which is used if the message header 'CamelAwsSesSubject' is not present.";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_SUBJECT_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_ENDPOINT_TO_CONF = "camel.sink.endpoint.to";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_TO_DOC = "List of destination email address. Can be overriden with 'CamelAwsSesTo' header.";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_TO_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AWS2SES_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AWS2SES_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_AWS2SES_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_AWS2SES_ENDPOINT_ACCESS_KEY_CONF = "camel.sink.endpoint.accessKey";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_ACCESS_KEY_DOC = "Amazon AWS Access Key";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_ACCESS_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_ENDPOINT_SECRET_KEY_CONF = "camel.sink.endpoint.secretKey";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_SECRET_KEY_DOC = "Amazon AWS Secret Key";
    private static final String CAMEL_SINK_AWS2SES_ENDPOINT_SECRET_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_COMPONENT_AMAZON_SESCLIENT_CONF = "camel.component.aws2-ses.amazonSESClient";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_AMAZON_SESCLIENT_DOC = "To use the AmazonSimpleEmailService as the client";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_AMAZON_SESCLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_COMPONENT_CONFIGURATION_CONF = "camel.component.aws2-ses.configuration";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_CONFIGURATION_DOC = "component configuration";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_AWS2SES_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_AWS2SES_COMPONENT_PROXY_HOST_CONF = "camel.component.aws2-ses.proxyHost";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_PROXY_HOST_DOC = "To define a proxy host when instantiating the SES client";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_COMPONENT_PROXY_PORT_CONF = "camel.component.aws2-ses.proxyPort";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_PROXY_PORT_DOC = "To define a proxy port when instantiating the SES client";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_COMPONENT_PROXY_PROTOCOL_CONF = "camel.component.aws2-ses.proxyProtocol";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_PROXY_PROTOCOL_DOC = "To define a proxy protocol when instantiating the SES client One of: [HTTP] [HTTPS]";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_PROXY_PROTOCOL_DEFAULT = "HTTPS";
    public static final String CAMEL_SINK_AWS2SES_COMPONENT_REGION_CONF = "camel.component.aws2-ses.region";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_REGION_DOC = "The region in which SES client needs to work. When using this parameter, the configuration will expect the lowercase name of the region (for example ap-east-1) You'll need to use the name Region.EU_WEST_1.id()";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_REGION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_REPLY_TO_ADDRESSES_DOC = "List of reply-to email address(es) for the message, override it using 'CamelAwsSesReplyToAddresses' header.";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_REPLY_TO_ADDRESSES_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_COMPONENT_RETURN_PATH_CONF = "camel.component.aws2-ses.returnPath";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_RETURN_PATH_DOC = "The email address to which bounce notifications are to be forwarded, override it using 'CamelAwsSesReturnPath' header.";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_RETURN_PATH_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_COMPONENT_SUBJECT_CONF = "camel.component.aws2-ses.subject";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_SUBJECT_DOC = "The subject which is used if the message header 'CamelAwsSesSubject' is not present.";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_SUBJECT_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_COMPONENT_TO_CONF = "camel.component.aws2-ses.to";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_TO_DOC = "List of destination email address. Can be overriden with 'CamelAwsSesTo' header.";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_TO_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AWS2SES_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AWS2SES_COMPONENT_ACCESS_KEY_CONF = "camel.component.aws2-ses.accessKey";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_ACCESS_KEY_DOC = "Amazon AWS Access Key";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_ACCESS_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2SES_COMPONENT_SECRET_KEY_CONF = "camel.component.aws2-ses.secretKey";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_SECRET_KEY_DOC = "Amazon AWS Secret Key";
    private static final String CAMEL_SINK_AWS2SES_COMPONENT_SECRET_KEY_DEFAULT = null;
