...
public class CamelAhcwsSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_AHCWS_PATH_HTTP_URI_DOC = "The URI to use such as http://hostname:port/path";
    private static final String CAMEL_SOURCE_AHCWS_PATH_HTTP_URI_DEFAULT = null;
    public static final String CAMEL_SOURCE_AHCWS_ENDPOINT_BRIDGE_ENDPOINT_CONF = "camel.source.endpoint.bridgeEndpoint";
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_BRIDGE_ENDPOINT_DOC = "If the option is true, then the Exchange.HTTP_URI header is ignored, and use the endpoint's URI for request. You may also set the throwExceptionOnFailure to be false to let the AhcProducer send all the fault response back.";
    private static final Boolean CAMEL_SOURCE_AHCWS_ENDPOINT_BRIDGE_ENDPOINT_DEFAULT = false;
    public static final String CAMEL_SOURCE_AHCWS_ENDPOINT_BUFFER_SIZE_CONF = "camel.source.endpoint.bufferSize";
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_BUFFER_SIZE_DOC = "The initial in-memory buffer size used when transferring data between Camel and AHC Client.";
    private static final Integer CAMEL_SOURCE_AHCWS_ENDPOINT_BUFFER_SIZE_DEFAULT = 4096;
    ...
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_THROW_EXCEPTION_ON_FAILURE_DOC = "Option to disable throwing the AhcOperationFailedException in case of failed responses from the remote server. This allows you to get all responses regardless of the HTTP status code.";
    private static final Boolean CAMEL_SOURCE_AHCWS_ENDPOINT_THROW_EXCEPTION_ON_FAILURE_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_AHCWS_ENDPOINT_TRANSFER_EXCEPTION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_AHCWS_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_SEND_MESSAGE_ON_ERROR_DOC = "Whether to send an message if the web-socket listener received an error.";
    private static final Boolean CAMEL_SOURCE_AHCWS_ENDPOINT_SEND_MESSAGE_ON_ERROR_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_AHCWS_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_AHCWS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_AHCWS_ENDPOINT_BINDING_CONF = "camel.source.endpoint.binding";
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_BINDING_DOC = "To use a custom AhcBinding which allows to control how to bind between AHC and Camel.";
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_BINDING_DEFAULT = null;
    public static final String CAMEL_SOURCE_AHCWS_ENDPOINT_CLIENT_CONFIG_CONF = "camel.source.endpoint.clientConfig";
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_CLIENT_CONFIG_DOC = "To configure the AsyncHttpClient to use a custom com.ning.http.client.AsyncHttpClientConfig instance.";
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_CLIENT_CONFIG_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_CLIENT_CONFIG_OPTIONS_DOC = "To configure the AsyncHttpClientConfig using the key/values from the Map.";
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_CLIENT_CONFIG_OPTIONS_DEFAULT = null;
    public static final String CAMEL_SOURCE_AHCWS_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_AHCWS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_CLIENT_CONFIG_REALM_OPTIONS_DOC = "To configure the AsyncHttpClientConfig Realm using the key/values from the Map.";
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_CLIENT_CONFIG_REALM_OPTIONS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AHCWS_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_AHCWS_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_AHCWS_COMPONENT_ALLOW_JAVA_SERIALIZED_OBJECT_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AHCWS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_AHCWS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_AHCWS_COMPONENT_BINDING_CONF = "camel.component.ahc-ws.binding";
    private static final String CAMEL_SOURCE_AHCWS_COMPONENT_BINDING_DOC = "To use a custom AhcBinding which allows to control how to bind between AHC and Camel.";
    private static final String CAMEL_SOURCE_AHCWS_COMPONENT_BINDING_DEFAULT = null;
    public static final String CAMEL_SOURCE_AHCWS_COMPONENT_CLIENT_CONF = "camel.component.ahc-ws.client";
    private static final String CAMEL_SOURCE_AHCWS_COMPONENT_CLIENT_DOC = "To use a custom AsyncHttpClient";
    private static final String CAMEL_SOURCE_AHCWS_COMPONENT_CLIENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_AHCWS_COMPONENT_CLIENT_CONFIG_CONF = "camel.component.ahc-ws.clientConfig";
    private static final String CAMEL_SOURCE_AHCWS_COMPONENT_CLIENT_CONFIG_DOC = "To configure the AsyncHttpClient to use a custom com.ning.http.client.AsyncHttpClientConfig instance.";
    private static final String CAMEL_SOURCE_AHCWS_COMPONENT_CLIENT_CONFIG_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AHCWS_COMPONENT_HEADER_FILTER_STRATEGY_DOC = "To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_AHCWS_COMPONENT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AHCWS_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AHCWS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SOURCE_AHCWS_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_AHCWS_ENDPOINT_SYNCHRONOUS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AHCWS_ENDPOINT_SYNCHRONOUS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AHCWS_ENDPOINT_SYNCHRONOUS_DOC);
