...
public class CamelAhcwsSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AHCWS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    public static final Boolean CAMEL_SOURCE_AHCWS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
