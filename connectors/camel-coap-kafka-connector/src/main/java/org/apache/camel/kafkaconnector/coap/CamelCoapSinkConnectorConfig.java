...
public class CamelCoapSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_COAP_PATH_URI_DOC = "The URI for the CoAP endpoint";
    private static final String CAMEL_SINK_COAP_PATH_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_COAP_ENDPOINT_ALIAS_DEFAULT = null;
    public static final String CAMEL_SINK_COAP_ENDPOINT_CIPHER_SUITES_CONF = "camel.sink.endpoint.cipherSuites";
    private static final String CAMEL_SINK_COAP_ENDPOINT_CIPHER_SUITES_DOC = "Sets the cipherSuites String. This is a comma separated String of ciphersuites to configure. If it is not specified, then it falls back to getting the ciphersuites from the sslContextParameters object.";
    private static final String CAMEL_SINK_COAP_ENDPOINT_CIPHER_SUITES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_COAP_ENDPOINT_CLIENT_AUTHENTICATION_DEFAULT = null;
    public static final String CAMEL_SINK_COAP_ENDPOINT_PRIVATE_KEY_CONF = "camel.sink.endpoint.privateKey";
    private static final String CAMEL_SINK_COAP_ENDPOINT_PRIVATE_KEY_DOC = "Set the configured private key for use with Raw Public Key.";
    private static final String CAMEL_SINK_COAP_ENDPOINT_PRIVATE_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_COAP_ENDPOINT_PSK_STORE_CONF = "camel.sink.endpoint.pskStore";
    private static final String CAMEL_SINK_COAP_ENDPOINT_PSK_STORE_DOC = "Set the PskStore to use for pre-shared key.";
    private static final String CAMEL_SINK_COAP_ENDPOINT_PSK_STORE_DEFAULT = null;
    public static final String CAMEL_SINK_COAP_ENDPOINT_PUBLIC_KEY_CONF = "camel.sink.endpoint.publicKey";
    private static final String CAMEL_SINK_COAP_ENDPOINT_PUBLIC_KEY_DOC = "Set the configured public key for use with Raw Public Key.";
    private static final String CAMEL_SINK_COAP_ENDPOINT_PUBLIC_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_COAP_ENDPOINT_RECOMMENDED_CIPHER_SUITES_ONLY_DOC = "The CBC cipher suites are not recommended. If you want to use them, you first need to set the recommendedCipherSuitesOnly option to false.";
    private static final Boolean CAMEL_SINK_COAP_ENDPOINT_RECOMMENDED_CIPHER_SUITES_ONLY_DEFAULT = true;
    public static final String CAMEL_SINK_COAP_ENDPOINT_SSL_CONTEXT_PARAMETERS_CONF = "camel.sink.endpoint.sslContextParameters";
    private static final String CAMEL_SINK_COAP_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "Set the SSLContextParameters object for setting up TLS. This is required for coapstcp, and for coaps when we are using certificates for TLS (as opposed to RPK or PKS).";
    private static final String CAMEL_SINK_COAP_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_COAP_ENDPOINT_TRUSTED_RPK_STORE_CONF = "camel.sink.endpoint.trustedRpkStore";
    private static final String CAMEL_SINK_COAP_ENDPOINT_TRUSTED_RPK_STORE_DOC = "Set the TrustedRpkStore to use to determine trust in raw public keys.";
    private static final String CAMEL_SINK_COAP_ENDPOINT_TRUSTED_RPK_STORE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_COAP_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_COAP_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_COAP_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_COAP_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_COAP_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_COAP_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_COAP_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_COAP_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_COAP_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.coap.basicPropertyBinding";
    private static final String CAMEL_SINK_COAP_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_COAP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_COAP_ENDPOINT_PRIVATE_KEY_CONF, ConfigDef.Type.STRING, CAMEL_SINK_COAP_ENDPOINT_PRIVATE_KEY_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_COAP_ENDPOINT_PRIVATE_KEY_DOC);
