...
public class CamelAzurestorageblobsourceSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_CLIENT_ID_CONF = "camel.kamelet.azure-storage-blob-source.clientId";
    public static final String CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_CLIENT_ID_DOC = "The Azure Storage Blob client Id.";
    public static final String CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_CLIENT_ID_DEFAULT = null;
    public static final String CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_CLIENT_SECRET_CONF = "camel.kamelet.azure-storage-blob-source.clientSecret";
    public static final String CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_CLIENT_SECRET_DOC = "The Azure Storage Blob client secret.";
    public static final String CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_CLIENT_SECRET_DEFAULT = null;
    public static final String CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_TENANT_ID_CONF = "camel.kamelet.azure-storage-blob-source.tenantId";
    public static final String CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_TENANT_ID_DOC = "The Azure Storage Blob tenant id.";
    public static final String CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_TENANT_ID_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_CLIENT_ID_CONF, ConfigDef.Type.PASSWORD, CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_CLIENT_ID_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_CLIENT_ID_DOC);
        conf.define(CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_CLIENT_SECRET_CONF, ConfigDef.Type.PASSWORD, CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_CLIENT_SECRET_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_CLIENT_SECRET_DOC);
        conf.define(CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_TENANT_ID_CONF, ConfigDef.Type.PASSWORD, CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_TENANT_ID_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AZURESTORAGEBLOBSOURCE_KAMELET_TENANT_ID_DOC);
