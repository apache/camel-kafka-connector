...
public class CamelSftpsourceSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_SFTPSOURCE_KAMELET_DELETE_DOC = "If true, the file is deleted after it is processed successfully.";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_SFTPSOURCE_KAMELET_PRIVATE_KEY_PASSPHRASE_CONF, ConfigDef.Type.PASSWORD, CAMEL_SOURCE_SFTPSOURCE_KAMELET_PRIVATE_KEY_PASSPHRASE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SFTPSOURCE_KAMELET_PRIVATE_KEY_PASSPHRASE_DOC);
