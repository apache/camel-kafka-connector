...
public class CamelIgniteeventsSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_IGNITEEVENTS_PATH_ENDPOINT_ID_DOC = "The endpoint ID (not used).";
    private static final String CAMEL_SOURCE_IGNITEEVENTS_PATH_ENDPOINT_ID_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_CLUSTER_GROUP_EXPRESSION_DOC = "The cluster group expression.";
    private static final String CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_CLUSTER_GROUP_EXPRESSION_DEFAULT = null;
    public static final String CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_EVENTS_CONF = "camel.source.endpoint.events";
    private static final String CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_EVENTS_DOC = "The event types to subscribe to as a comma-separated string of event constants as defined in EventType. For example: EVT_CACHE_ENTRY_CREATED,EVT_CACHE_OBJECT_REMOVED,EVT_IGFS_DIR_CREATED.";
    private static final String CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_EVENTS_DEFAULT = "EVTS_ALL";
    ...
    private static final String CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_PROPAGATE_INCOMING_BODY_IF_NO_RETURN_VALUE_DOC = "Sets whether to propagate the incoming body if the return type of the underlying Ignite operation is void.";
    private static final Boolean CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_PROPAGATE_INCOMING_BODY_IF_NO_RETURN_VALUE_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_TREAT_COLLECTIONS_AS_CACHE_OBJECTS_DOC = "Sets whether to treat Collections as cache objects or as Collections of items to insert/update/compute, etc.";
    private static final Boolean CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_TREAT_COLLECTIONS_AS_CACHE_OBJECTS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_IGNITEEVENTS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_IGNITEEVENTS_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_IGNITEEVENTS_COMPONENT_CONFIGURATION_RESOURCE_DOC = "Resource from where to load configuration.";
    private static final String CAMEL_SOURCE_IGNITEEVENTS_COMPONENT_CONFIGURATION_RESOURCE_DEFAULT = null;
    public static final String CAMEL_SOURCE_IGNITEEVENTS_COMPONENT_IGNITE_CONF = "camel.component.ignite-events.ignite";
    private static final String CAMEL_SOURCE_IGNITEEVENTS_COMPONENT_IGNITE_DOC = "Ignite instance.";
    private static final String CAMEL_SOURCE_IGNITEEVENTS_COMPONENT_IGNITE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_IGNITEEVENTS_COMPONENT_IGNITE_CONFIGURATION_DOC = "Ignite configuration.";
    private static final String CAMEL_SOURCE_IGNITEEVENTS_COMPONENT_IGNITE_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_IGNITEEVENTS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_IGNITEEVENTS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
