...
public class CamelSqlstoredSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_SQLSTORED_PATH_TEMPLATE_DOC = "Sets the StoredProcedure template to perform";
    private static final String CAMEL_SINK_SQLSTORED_PATH_TEMPLATE_DEFAULT = null;
    public static final String CAMEL_SINK_SQLSTORED_ENDPOINT_BATCH_CONF = "camel.sink.endpoint.batch";
    private static final String CAMEL_SINK_SQLSTORED_ENDPOINT_BATCH_DOC = "Enables or disables batch mode";
    private static final Boolean CAMEL_SINK_SQLSTORED_ENDPOINT_BATCH_DEFAULT = false;
    public static final String CAMEL_SINK_SQLSTORED_ENDPOINT_DATA_SOURCE_CONF = "camel.sink.endpoint.dataSource";
    private static final String CAMEL_SINK_SQLSTORED_ENDPOINT_DATA_SOURCE_DOC = "Sets the DataSource to use to communicate with the database.";
    private static final String CAMEL_SINK_SQLSTORED_ENDPOINT_DATA_SOURCE_DEFAULT = null;
    public static final String CAMEL_SINK_SQLSTORED_ENDPOINT_FUNCTION_CONF = "camel.sink.endpoint.function";
    private static final String CAMEL_SINK_SQLSTORED_ENDPOINT_FUNCTION_DOC = "Whether this call is for a function.";
    private static final Boolean CAMEL_SINK_SQLSTORED_ENDPOINT_FUNCTION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_SQLSTORED_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_SQLSTORED_ENDPOINT_NOOP_CONF = "camel.sink.endpoint.noop";
    private static final String CAMEL_SINK_SQLSTORED_ENDPOINT_NOOP_DOC = "If set, will ignore the results of the template and use the existing IN message as the OUT message for the continuation of processing";
    private static final Boolean CAMEL_SINK_SQLSTORED_ENDPOINT_NOOP_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SQLSTORED_ENDPOINT_OUTPUT_HEADER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SQLSTORED_ENDPOINT_USE_MESSAGE_BODY_FOR_TEMPLATE_DOC = "Whether to use the message body as the template and then headers for parameters. If this option is enabled then the template in the uri is not used.";
    private static final Boolean CAMEL_SINK_SQLSTORED_ENDPOINT_USE_MESSAGE_BODY_FOR_TEMPLATE_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SQLSTORED_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SQLSTORED_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SQLSTORED_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_SQLSTORED_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_SQLSTORED_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_SQLSTORED_COMPONENT_DATA_SOURCE_CONF = "camel.component.sql-stored.dataSource";
    private static final String CAMEL_SINK_SQLSTORED_COMPONENT_DATA_SOURCE_DOC = "Sets the DataSource to use to communicate with the database.";
    private static final String CAMEL_SINK_SQLSTORED_COMPONENT_DATA_SOURCE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SQLSTORED_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SQLSTORED_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SQLSTORED_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
