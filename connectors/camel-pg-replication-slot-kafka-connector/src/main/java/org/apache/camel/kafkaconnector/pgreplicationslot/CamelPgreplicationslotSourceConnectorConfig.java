...
public class CamelPgreplicationslotSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_SLOT_DOC = "Replication Slot name";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_SLOT_DEFAULT = null;
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_HOST_CONF = "camel.source.path.host";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_HOST_DOC = "Postgres host";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_HOST_DEFAULT = "localhost";
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_PORT_CONF = "camel.source.path.port";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_PORT_DOC = "Postgres port";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_PORT_DEFAULT = "5432";
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_DATABASE_CONF = "camel.source.path.database";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_DATABASE_DOC = "Postgres database name";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_DATABASE_DEFAULT = null;
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_OUTPUT_PLUGIN_CONF = "camel.source.path.outputPlugin";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_OUTPUT_PLUGIN_DOC = "Output plugin name";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_PATH_OUTPUT_PLUGIN_DEFAULT = null;
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_PASSWORD_DOC = "Postgres password";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_USER_CONF = "camel.source.endpoint.user";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_USER_DOC = "Postgres user";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_USER_DEFAULT = "postgres";
    ...
    private static final Boolean CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DOC = "If the polling consumer did not poll any files, you can enable this option to send an empty message (no body) instead.";
    private static final Boolean CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_POLL_STRATEGY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_AUTO_CREATE_SLOT_DOC = "Auto create slot if it does not exist";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_AUTO_CREATE_SLOT_DEFAULT = "true";
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SLOT_OPTIONS_CONF = "camel.source.endpoint.slotOptions";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SLOT_OPTIONS_DOC = "Slot options to be passed to the output plugin.";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SLOT_OPTIONS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_STATUS_INTERVAL_DOC = "Specifies the number of seconds between status packets sent back to Postgres server.";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_STATUS_INTERVAL_DEFAULT = "10";
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DOC = "The number of subsequent error polls (failed due some error) that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DOC = "The number of subsequent idle polls that should happen before the backoffMultipler should kick-in.";
    private static final Integer CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_BACKOFF_MULTIPLIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll.";
    private static final Long CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_DELAY_DEFAULT = 500L;
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_GREEDY_CONF = "camel.source.endpoint.greedy";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_GREEDY_DOC = "If greedy is enabled, then the ScheduledPollConsumer will run immediately again, if the previous run polled 1 or more messages.";
    private static final Boolean CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_GREEDY_DEFAULT = false;
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_INITIAL_DELAY_CONF = "camel.source.endpoint.initialDelay";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts.";
    private static final Long CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_REPEAT_COUNT_CONF = "camel.source.endpoint.repeatCount";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_REPEAT_COUNT_DOC = "Specifies a maximum limit of number of fires. So if you set it to 1, the scheduler will only fire once. If you set it to 5, it will only fire five times. A value of zero or negative means fire forever.";
    private static final Long CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_RUN_LOGGING_LEVEL_DOC = "The consumer logs a start/complete log line when it polls. This option allows you to configure the logging level for that. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_RUN_LOGGING_LEVEL_DEFAULT = "TRACE";
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DOC = "Allows for configuring a custom/shared thread pool to use for the consumer. By default each consumer has its own single threaded thread pool.";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SCHEDULED_EXECUTOR_SERVICE_DEFAULT = null;
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SCHEDULER_CONF = "camel.source.endpoint.scheduler";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component One of: [none] [spring] [quartz]";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SCHEDULER_DEFAULT = "none";
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SCHEDULER_PROPERTIES_DOC = "To configure additional properties when using a custom scheduler or any of the Quartz, Spring based scheduler.";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_SCHEDULER_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_START_SCHEDULER_DOC = "Whether the scheduler should be auto started.";
    private static final Boolean CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_START_SCHEDULER_DEFAULT = true;
    public static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_TIME_UNIT_CONF = "camel.source.endpoint.timeUnit";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_TIME_UNIT_DOC = "Time unit for initialDelay and delay options. One of: [NANOSECONDS] [MICROSECONDS] [MILLISECONDS] [SECONDS] [MINUTES] [HOURS] [DAYS]";
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_TIME_UNIT_DEFAULT = "MILLISECONDS";
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_USE_FIXED_DELAY_DOC = "Controls if fixed delay or fixed rate is used. See ScheduledExecutorService in JDK for details.";
    private static final Boolean CAMEL_SOURCE_PGREPLICATIONSLOT_ENDPOINT_USE_FIXED_DELAY_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_PGREPLICATIONSLOT_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_PGREPLICATIONSLOT_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_PGREPLICATIONSLOT_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
