...
public class CamelKameletSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_KAMELET_ENDPOINT_LOCATION_CONF = "camel.source.endpoint.location";
    public static final String CAMEL_SOURCE_KAMELET_ENDPOINT_LOCATION_DOC = "Location of the Kamelet to use which can be specified as a resource from file system, classpath etc. The location cannot use wildcards, and must refer to a file including extension, for example file:/etc/foo-kamelet.xml";
    public static final String CAMEL_SOURCE_KAMELET_ENDPOINT_LOCATION_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_KAMELET_COMPONENT_ROUTE_TEMPLATE_LOADER_LISTENER_CONF = "camel.component.kamelet.routeTemplateLoaderListener";
    public static final String CAMEL_SOURCE_KAMELET_COMPONENT_ROUTE_TEMPLATE_LOADER_LISTENER_DOC = "To plugin a custom listener for when the Kamelet component is loading Kamelets from external resources.";
    public static final String CAMEL_SOURCE_KAMELET_COMPONENT_ROUTE_TEMPLATE_LOADER_LISTENER_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_KAMELET_ENDPOINT_LOCATION_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_KAMELET_ENDPOINT_LOCATION_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_KAMELET_ENDPOINT_LOCATION_DOC);
        ...
        conf.define(CAMEL_SOURCE_KAMELET_COMPONENT_ROUTE_TEMPLATE_LOADER_LISTENER_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_KAMELET_COMPONENT_ROUTE_TEMPLATE_LOADER_LISTENER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_KAMELET_COMPONENT_ROUTE_TEMPLATE_LOADER_LISTENER_DOC);
        return conf;
    }
}