...
public class CamelAws2kmsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWS2KMS_COMPONENT_REGION_DOC = "The region in which KMS client needs to work";
    ...
    public static final String CAMEL_SINK_AWS2KMS_COMPONENT_CONFIGURATION_DOC = "The AWS KMS default configuration";
