...
public class CamelGooglemailSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_GOOGLEMAIL_PATH_METHOD_NAME_DOC = "What sub operation to use for the selected operation One of: [attachments] [create] [delete] [get] [getProfile] [gmailImport] [insert] [list] [modify] [patch] [send] [stop] [trash] [untrash] [update] [watch]";
    ...
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_APPLICATION_NAME_DOC = "Google mail application name. Example would be camel-google-mail/1.0";
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_APPLICATION_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_ID_CONF = "camel.component.google-mail.clientId";
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_ID_DOC = "Client ID of the mail application";
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_ID_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_AUTOWIRED_ENABLED_CONF = "camel.component.google-mail.autowiredEnabled";
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_AUTOWIRED_ENABLED_DOC = "Whether autowiring is enabled. This is used for automatic autowiring options (the option must be marked as autowired) by looking up in the registry to find if there is a single instance of matching type, which then gets configured on the component. This can be used for automatic configuring JDBC data sources, JMS connection factories, AWS Clients, etc.";
    public static final Boolean CAMEL_SINK_GOOGLEMAIL_COMPONENT_AUTOWIRED_ENABLED_DEFAULT = true;
    ...
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_ACCESS_TOKEN_DOC = "OAuth 2 access token. This typically expires after an hour so refreshToken is recommended for long term usage.";
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_ACCESS_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_SECRET_CONF = "camel.component.google-mail.clientSecret";
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_SECRET_DOC = "Client secret of the mail application";
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_SECRET_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_REFRESH_TOKEN_CONF = "camel.component.google-mail.refreshToken";
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_REFRESH_TOKEN_DOC = "OAuth 2 refresh token. Using this, the Google Calendar component can obtain a new accessToken whenever the current one expires - a necessity if the application is long-lived.";
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_REFRESH_TOKEN_DEFAULT = null;
