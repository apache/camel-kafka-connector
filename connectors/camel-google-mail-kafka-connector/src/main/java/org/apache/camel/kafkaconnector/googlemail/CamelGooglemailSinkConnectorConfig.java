...
public class CamelGooglemailSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_GOOGLEMAIL_PATH_API_NAME_DOC = "What kind of operation to perform One of: [THREADS] [MESSAGES] [ATTACHMENTS] [LABELS] [HISTORY] [DRAFTS] [USERS]";
    private static final String CAMEL_SINK_GOOGLEMAIL_PATH_API_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_PATH_METHOD_NAME_CONF = "camel.sink.path.methodName";
    private static final String CAMEL_SINK_GOOGLEMAIL_PATH_METHOD_NAME_DOC = "What sub operation to use for the selected operation One of: [attachments] [create] [delete] [get] [getProfile] [gmailImport] [insert] [list] [modify] [patch] [send] [stop] [trash] [untrash] [update] [watch]";
    private static final String CAMEL_SINK_GOOGLEMAIL_PATH_METHOD_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_APPLICATION_NAME_CONF = "camel.sink.endpoint.applicationName";
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_APPLICATION_NAME_DOC = "Google mail application name. Example would be camel-google-mail/1.0";
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_APPLICATION_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_CLIENT_ID_CONF = "camel.sink.endpoint.clientId";
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_CLIENT_ID_DOC = "Client ID of the mail application";
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_CLIENT_ID_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_IN_BODY_CONF = "camel.sink.endpoint.inBody";
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_IN_BODY_DOC = "Sets the name of a parameter to be passed in the exchange In Body";
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_IN_BODY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_GOOGLEMAIL_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GOOGLEMAIL_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_GOOGLEMAIL_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_ACCESS_TOKEN_CONF = "camel.sink.endpoint.accessToken";
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_ACCESS_TOKEN_DOC = "OAuth 2 access token. This typically expires after an hour so refreshToken is recommended for long term usage.";
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_ACCESS_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_CLIENT_SECRET_CONF = "camel.sink.endpoint.clientSecret";
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_CLIENT_SECRET_DOC = "Client secret of the mail application";
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_CLIENT_SECRET_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_REFRESH_TOKEN_CONF = "camel.sink.endpoint.refreshToken";
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_REFRESH_TOKEN_DOC = "OAuth 2 refresh token. Using this, the Google Calendar component can obtain a new accessToken whenever the current one expires - a necessity if the application is long-lived.";
    private static final String CAMEL_SINK_GOOGLEMAIL_ENDPOINT_REFRESH_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_APPLICATION_NAME_CONF = "camel.component.google-mail.applicationName";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_APPLICATION_NAME_DOC = "Google mail application name. Example would be camel-google-mail/1.0";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_APPLICATION_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_ID_CONF = "camel.component.google-mail.clientId";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_ID_DOC = "Client ID of the mail application";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_ID_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CONFIGURATION_CONF = "camel.component.google-mail.configuration";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CONFIGURATION_DOC = "To use the shared configuration";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_GOOGLEMAIL_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GOOGLEMAIL_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_FACTORY_CONF = "camel.component.google-mail.clientFactory";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_FACTORY_DOC = "To use the GoogleCalendarClientFactory as factory for creating the client. Will by default use BatchGoogleMailClientFactory";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_FACTORY_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_ACCESS_TOKEN_CONF = "camel.component.google-mail.accessToken";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_ACCESS_TOKEN_DOC = "OAuth 2 access token. This typically expires after an hour so refreshToken is recommended for long term usage.";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_ACCESS_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_SECRET_CONF = "camel.component.google-mail.clientSecret";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_SECRET_DOC = "Client secret of the mail application";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_CLIENT_SECRET_DEFAULT = null;
    public static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_REFRESH_TOKEN_CONF = "camel.component.google-mail.refreshToken";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_REFRESH_TOKEN_DOC = "OAuth 2 refresh token. Using this, the Google Calendar component can obtain a new accessToken whenever the current one expires - a necessity if the application is long-lived.";
    private static final String CAMEL_SINK_GOOGLEMAIL_COMPONENT_REFRESH_TOKEN_DEFAULT = null;
