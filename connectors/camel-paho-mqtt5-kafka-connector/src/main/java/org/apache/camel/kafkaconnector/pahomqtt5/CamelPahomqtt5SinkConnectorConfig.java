...
public class CamelPahomqtt5SinkConnectorConfig
    ...
    public static final String CAMEL_SINK_PAHOMQTT5_COMPONENT_SESSION_EXPIRY_INTERVAL_CONF = "camel.component.paho-mqtt5.sessionExpiryInterval";
    public static final String CAMEL_SINK_PAHOMQTT5_COMPONENT_SESSION_EXPIRY_INTERVAL_DOC = "Sets the Session Expiry Interval. This value, measured in seconds, defines the maximum time that the broker will maintain the session for once the client disconnects. Clients should only connect with a long Session Expiry interval if they intend to connect to the server at some later point in time. By default this value is -1 and so will not be sent, in this case, the session will not expire. If a 0 is sent, the session will end immediately once the Network Connection is closed. When the client has determined that it has no longer any use for the session, it should disconnect with a Session Expiry Interval set to 0.";
    public static final Long CAMEL_SINK_PAHOMQTT5_COMPONENT_SESSION_EXPIRY_INTERVAL_DEFAULT = -1L;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_PAHOMQTT5_ENDPOINT_SESSION_EXPIRY_INTERVAL_CONF, ConfigDef.Type.LONG, CAMEL_SINK_PAHOMQTT5_ENDPOINT_SESSION_EXPIRY_INTERVAL_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_PAHOMQTT5_ENDPOINT_SESSION_EXPIRY_INTERVAL_DOC);
        ...
        conf.define(CAMEL_SINK_PAHOMQTT5_COMPONENT_SESSION_EXPIRY_INTERVAL_CONF, ConfigDef.Type.LONG, CAMEL_SINK_PAHOMQTT5_COMPONENT_SESSION_EXPIRY_INTERVAL_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_PAHOMQTT5_COMPONENT_SESSION_EXPIRY_INTERVAL_DOC);
