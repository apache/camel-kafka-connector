...
public class CamelMongodbchangesstreamsourceSourceTask
        extends
            CamelSourceTask {
    ...
    protected CamelSourceConnectorConfig getCamelSourceConnectorConfig(
        ...
        return new CamelMongodbchangesstreamsourceSourceConnectorConfig(props);
    }
    @Override
    protected String getSourceKamelet() {
        return "kamelet:mongodb-changes-stream-source";
    }
}