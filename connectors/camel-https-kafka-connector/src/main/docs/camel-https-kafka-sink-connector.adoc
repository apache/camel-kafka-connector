...
The camel-https sink connector supports 89 options, which are listed below.
...
| *camel.sink.endpoint.userAgent* | To set a custom HTTP User-Agent request header | null | false | MEDIUM
