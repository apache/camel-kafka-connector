...
public class CamelHttpsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_SKIP_CONTROL_HEADERS_CONF = "camel.sink.endpoint.skipControlHeaders";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_SKIP_CONTROL_HEADERS_DOC = "Whether to skip Camel control headers (CamelHttp... headers) to influence this endpoint. Control headers from previous HTTP components can influence how this Camel component behaves such as CamelHttpPath, CamelHttpQuery, etc.";
    public static final Boolean CAMEL_SINK_HTTPS_ENDPOINT_SKIP_CONTROL_HEADERS_DEFAULT = false;
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_SKIP_REQUEST_HEADERS_CONF = "camel.sink.endpoint.skipRequestHeaders";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_SKIP_REQUEST_HEADERS_DOC = "Whether to skip mapping the Camel headers as HTTP request headers. This is useful when you know that calling the HTTP service should not include any custom headers.";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_SKIP_RESPONSE_HEADERS_DOC = "Whether to skip mapping all the HTTP response headers to Camel headers.";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_HTTP_ACTIVITY_LISTENER_CONF = "camel.sink.endpoint.httpActivityListener";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_HTTP_ACTIVITY_LISTENER_DOC = "To use a custom activity listener";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_HTTP_ACTIVITY_LISTENER_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_HTTP_CLIENT_OPTIONS_DOC = "To configure the HttpClient using the key/values from the Map. This is a multi-value option with prefix: httpClient.";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_HTTP_CONNECTION_OPTIONS_DOC = "To configure the connection and the socket using the key/values from the Map. This is a multi-value option with prefix: httpConnection.";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_PROXY_AUTH_HOST_DOC = "Proxy server host";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_PROXY_AUTH_METHOD_DOC = "Proxy authentication method to use (NTLM is deprecated) One of: [Basic] [Bearer] [NTLM]";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_PROXY_AUTH_NT_HOST_DOC = "Proxy authentication domain (workstation name) to use with NTLM";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_PROXY_AUTH_PASSWORD_DOC = "Proxy server password";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_PROXY_AUTH_PORT_DOC = "Proxy server port";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_PROXY_AUTH_SCHEME_DOC = "Proxy server authentication protocol scheme to use One of: [http] [https]";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_PROXY_AUTH_USERNAME_DOC = "Proxy server username";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_PROXY_HOST_DOC = "Proxy server host";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_PROXY_PORT_DOC = "Proxy server port";
    public static final Integer CAMEL_SINK_HTTPS_ENDPOINT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_AUTH_BEARER_TOKEN_CONF = "camel.sink.endpoint.authBearerToken";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_AUTH_BEARER_TOKEN_DOC = "Authentication bearer token";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_AUTH_BEARER_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_AUTH_DOMAIN_CONF = "camel.sink.endpoint.authDomain";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_AUTH_DOMAIN_DOC = "Authentication domain to use with NTLM";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_AUTH_HOST_DOC = "Authentication host to use with NTLM";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_AUTH_METHOD_DOC = "Authentication methods allowed to use as a comma separated list of values Basic, Bearer, or NTLM. (NTLM is deprecated) One of: [Basic] [Bearer] [NTLM]";
    ...
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2CLIENT_SECRET_CONF = "camel.sink.endpoint.oauth2ClientSecret";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2CLIENT_SECRET_DOC = "OAuth2 client secret";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2CLIENT_SECRET_DEFAULT = null;
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2RESOURCE_INDICATOR_CONF = "camel.sink.endpoint.oauth2ResourceIndicator";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2RESOURCE_INDICATOR_DOC = "OAuth2 Token endpoint";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2RESOURCE_INDICATOR_DEFAULT = null;
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2SCOPE_CONF = "camel.sink.endpoint.oauth2Scope";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2SCOPE_DOC = "OAuth2 scope";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2SCOPE_DEFAULT = null;
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2TOKEN_ENDPOINT_CONF = "camel.sink.endpoint.oauth2TokenEndpoint";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2TOKEN_ENDPOINT_DOC = "OAuth2 Resource Indicator";
    public static final String CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2TOKEN_ENDPOINT_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_HTTPS_COMPONENT_LOG_HTTP_ACTIVITY_CONF = "camel.component.https.logHttpActivity";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_LOG_HTTP_ACTIVITY_DOC = "To enable logging HTTP request and response. You can use a custom LoggingHttpActivityListener as httpActivityListener to control logging options.";
    public static final Boolean CAMEL_SINK_HTTPS_COMPONENT_LOG_HTTP_ACTIVITY_DEFAULT = false;
    public static final String CAMEL_SINK_HTTPS_COMPONENT_SKIP_CONTROL_HEADERS_CONF = "camel.component.https.skipControlHeaders";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_SKIP_CONTROL_HEADERS_DOC = "Whether to skip Camel control headers (CamelHttp... headers) to influence this endpoint. Control headers from previous HTTP components can influence how this Camel component behaves such as CamelHttpPath, CamelHttpQuery, etc.";
    public static final Boolean CAMEL_SINK_HTTPS_COMPONENT_SKIP_CONTROL_HEADERS_DEFAULT = false;
    public static final String CAMEL_SINK_HTTPS_COMPONENT_SKIP_REQUEST_HEADERS_CONF = "camel.component.https.skipRequestHeaders";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_SKIP_REQUEST_HEADERS_DOC = "Whether to skip mapping all the Camel headers as HTTP request headers. This is useful when you know that calling the HTTP service should not include any custom headers.";
    ...
    public static final String CAMEL_SINK_HTTPS_COMPONENT_HTTP_ACTIVITY_LISTENER_CONF = "camel.component.https.httpActivityListener";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_HTTP_ACTIVITY_LISTENER_DOC = "To use a custom activity listener";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_HTTP_ACTIVITY_LISTENER_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_HTTPS_COMPONENT_USER_AGENT_CONF = "camel.component.https.userAgent";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_USER_AGENT_DOC = "To set a custom HTTP User-Agent request header";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_USER_AGENT_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_HTTPS_COMPONENT_CONNECTION_TIME_TO_LIVE_DOC = "The time for connection to live, the time unit is millisecond, the default value is always keepAlive.";
    ...
    public static final String CAMEL_SINK_HTTPS_COMPONENT_USE_SYSTEM_PROPERTIES_CONF = "camel.component.https.useSystemProperties";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_USE_SYSTEM_PROPERTIES_DOC = "To use System Properties as fallback for configuration for configuring HTTP Client";
    public static final Boolean CAMEL_SINK_HTTPS_COMPONENT_USE_SYSTEM_PROPERTIES_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_AUTH_HOST_DOC = "Proxy server host";
    ...
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_AUTH_METHOD_DOC = "Proxy authentication method to use (NTLM is deprecated) One of: [Basic] [Digest] [NTLM]";
    ...
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_AUTH_NT_HOST_DOC = "Proxy authentication domain (workstation name) to use with NTLM (NTLM is deprecated)";
    ...
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_AUTH_PASSWORD_DOC = "Proxy server password";
    ...
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_AUTH_PORT_DOC = "Proxy server port";
    ...
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_AUTH_SCHEME_DOC = "Proxy server authentication protocol scheme to use One of: [http] [https]";
    ...
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_AUTH_USERNAME_DOC = "Proxy server username";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_AUTH_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_HOST_CONF = "camel.component.https.proxyHost";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_HOST_DOC = "Proxy server host";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_PORT_CONF = "camel.component.https.proxyPort";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_PORT_DOC = "Proxy server port";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_HTTPS_COMPONENT_DESERIALIZATION_FILTER_CONF = "camel.component.https.deserializationFilter";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_DESERIALIZATION_FILTER_DOC = "Sets an ObjectInputFilter pattern (jdk.serialFilter syntax) applied when deserializing Java objects from requests or responses with Content-Type application/x-java-serialized-object (only used when allowJavaSerializedObject or transferException is enabled). When not set, the JVM-wide jdk.serialFilter is used if present; otherwise a conservative default filter denying java.net. and otherwise allowing java., javax. and org.apache.camel. packages is applied.";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_DESERIALIZATION_FILTER_DEFAULT = null;
    public static final String CAMEL_SINK_HTTPS_COMPONENT_HOSTNAME_VERIFICATION_POLICY_CONF = "camel.component.https.hostnameVerificationPolicy";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_HOSTNAME_VERIFICATION_POLICY_DOC = "Controls how hostname verification is performed during the TLS handshake. CLIENT (default) delegates entirely to the configured x509HostnameVerifier, preserving the behaviour of httpclient 5.5 and earlier a NoopHostnameVerifier will disable verification. BUILTIN uses the JDK SSLParameters hostname check only, ignoring the configured verifier. BOTH runs the JDK built-in check first and then the configured verifier; a NoopHostnameVerifier cannot bypass the built-in check under BUILTIN or BOTH. Prefer BOTH when no custom verifier semantics are needed for stronger out-of-the-box security. One of: [CLIENT] [BUILTIN] [BOTH]";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_HOSTNAME_VERIFICATION_POLICY_DEFAULT = "CLIENT";
    ...
    public static final String CAMEL_SINK_HTTPS_COMPONENT_CONNECTION_REQUEST_TIMEOUT_DOC = "Returns the connection lease request timeout (in millis) used when requesting a connection from the connection manager. A timeout value of zero is interpreted as a disabled timeout.";
    public static final Long CAMEL_SINK_HTTPS_COMPONENT_CONNECTION_REQUEST_TIMEOUT_DEFAULT = 180000L;
    public static final String CAMEL_SINK_HTTPS_COMPONENT_CONNECT_TIMEOUT_CONF = "camel.component.https.connectTimeout";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_CONNECT_TIMEOUT_DOC = "Determines the timeout (in millis) until a new connection is fully established. A timeout value of zero is interpreted as an infinite timeout.";
    public static final Long CAMEL_SINK_HTTPS_COMPONENT_CONNECT_TIMEOUT_DEFAULT = 180000L;
    public static final String CAMEL_SINK_HTTPS_COMPONENT_RESPONSE_TIMEOUT_CONF = "camel.component.https.responseTimeout";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_RESPONSE_TIMEOUT_DOC = "Determines the timeout (in millis) until arrival of a response from the opposite endpoint. A timeout value of zero is interpreted as an infinite timeout. Please note that response timeout may be unsupported by HTTP transports with message multiplexing.";
    public static final Long CAMEL_SINK_HTTPS_COMPONENT_RESPONSE_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_HTTPS_COMPONENT_SO_TIMEOUT_CONF = "camel.component.https.soTimeout";
    public static final String CAMEL_SINK_HTTPS_COMPONENT_SO_TIMEOUT_DOC = "Determines the default socket timeout (in millis) value for blocking I/O operations.";
    public static final Long CAMEL_SINK_HTTPS_COMPONENT_SO_TIMEOUT_DEFAULT = 180000L;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_HTTPS_ENDPOINT_SKIP_CONTROL_HEADERS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_HTTPS_ENDPOINT_SKIP_CONTROL_HEADERS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_ENDPOINT_SKIP_CONTROL_HEADERS_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_ENDPOINT_HTTP_ACTIVITY_LISTENER_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_ENDPOINT_HTTP_ACTIVITY_LISTENER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_ENDPOINT_HTTP_ACTIVITY_LISTENER_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_ENDPOINT_PROXY_AUTH_NT_HOST_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_ENDPOINT_PROXY_AUTH_NT_HOST_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_HTTPS_ENDPOINT_PROXY_AUTH_NT_HOST_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_ENDPOINT_PROXY_AUTH_PORT_CONF, ConfigDef.Type.INT, CAMEL_SINK_HTTPS_ENDPOINT_PROXY_AUTH_PORT_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_HTTPS_ENDPOINT_PROXY_AUTH_PORT_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_ENDPOINT_AUTH_BEARER_TOKEN_CONF, ConfigDef.Type.PASSWORD, CAMEL_SINK_HTTPS_ENDPOINT_AUTH_BEARER_TOKEN_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_ENDPOINT_AUTH_BEARER_TOKEN_DOC);
        conf.define(CAMEL_SINK_HTTPS_ENDPOINT_AUTH_DOMAIN_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_ENDPOINT_AUTH_DOMAIN_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_HTTPS_ENDPOINT_AUTH_DOMAIN_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_ENDPOINT_AUTH_HOST_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_ENDPOINT_AUTH_HOST_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_HTTPS_ENDPOINT_AUTH_HOST_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_ENDPOINT_HOSTNAME_VERIFICATION_POLICY_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_ENDPOINT_HOSTNAME_VERIFICATION_POLICY_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_ENDPOINT_HOSTNAME_VERIFICATION_POLICY_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2RESOURCE_INDICATOR_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2RESOURCE_INDICATOR_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2RESOURCE_INDICATOR_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2TOKEN_ENDPOINT_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2TOKEN_ENDPOINT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_ENDPOINT_OAUTH_2TOKEN_ENDPOINT_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_COMPONENT_LOG_HTTP_ACTIVITY_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_HTTPS_COMPONENT_LOG_HTTP_ACTIVITY_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_COMPONENT_LOG_HTTP_ACTIVITY_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_COMPONENT_HTTP_ACTIVITY_LISTENER_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_COMPONENT_HTTP_ACTIVITY_LISTENER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_COMPONENT_HTTP_ACTIVITY_LISTENER_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_COMPONENT_USER_AGENT_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_COMPONENT_USER_AGENT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_COMPONENT_USER_AGENT_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_COMPONENT_PROXY_AUTH_PORT_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_COMPONENT_PROXY_AUTH_PORT_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_HTTPS_COMPONENT_PROXY_AUTH_PORT_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_COMPONENT_PROXY_HOST_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_COMPONENT_PROXY_HOST_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_COMPONENT_PROXY_HOST_DOC);
        conf.define(CAMEL_SINK_HTTPS_COMPONENT_PROXY_PORT_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_COMPONENT_PROXY_PORT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_COMPONENT_PROXY_PORT_DOC);
        conf.define(CAMEL_SINK_HTTPS_COMPONENT_DESERIALIZATION_FILTER_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_COMPONENT_DESERIALIZATION_FILTER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_COMPONENT_DESERIALIZATION_FILTER_DOC);
        conf.define(CAMEL_SINK_HTTPS_COMPONENT_HOSTNAME_VERIFICATION_POLICY_CONF, ConfigDef.Type.STRING, CAMEL_SINK_HTTPS_COMPONENT_HOSTNAME_VERIFICATION_POLICY_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_COMPONENT_HOSTNAME_VERIFICATION_POLICY_DOC);
        ...
        conf.define(CAMEL_SINK_HTTPS_COMPONENT_CONNECTION_REQUEST_TIMEOUT_CONF, ConfigDef.Type.LONG, CAMEL_SINK_HTTPS_COMPONENT_CONNECTION_REQUEST_TIMEOUT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_COMPONENT_CONNECTION_REQUEST_TIMEOUT_DOC);
        conf.define(CAMEL_SINK_HTTPS_COMPONENT_CONNECT_TIMEOUT_CONF, ConfigDef.Type.LONG, CAMEL_SINK_HTTPS_COMPONENT_CONNECT_TIMEOUT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_COMPONENT_CONNECT_TIMEOUT_DOC);
        conf.define(CAMEL_SINK_HTTPS_COMPONENT_RESPONSE_TIMEOUT_CONF, ConfigDef.Type.LONG, CAMEL_SINK_HTTPS_COMPONENT_RESPONSE_TIMEOUT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_COMPONENT_RESPONSE_TIMEOUT_DOC);
        conf.define(CAMEL_SINK_HTTPS_COMPONENT_SO_TIMEOUT_CONF, ConfigDef.Type.LONG, CAMEL_SINK_HTTPS_COMPONENT_SO_TIMEOUT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HTTPS_COMPONENT_SO_TIMEOUT_DOC);
        return conf;
    }
}