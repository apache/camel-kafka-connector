...
public class CamelNsqSourceConnectorConfig extends CamelSourceConnectorConfig {
    ...
    private static final String CAMEL_SOURCE_NSQ_PATH_TOPIC_DOC = "The NSQ topic";
    private static final String CAMEL_SOURCE_NSQ_PATH_TOPIC_DEFAULT = null;
    public static final String CAMEL_SOURCE_NSQ_ENDPOINT_SERVERS_CONF = "camel.source.endpoint.servers";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_SERVERS_DOC = "The hostnames of one or more nsqlookupd servers (consumer) or nsqd servers (producer)";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_SERVERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_NSQ_ENDPOINT_USER_AGENT_CONF = "camel.source.endpoint.userAgent";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_USER_AGENT_DOC = "A String to identify the kind of client";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_USER_AGENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_NSQ_ENDPOINT_AUTO_FINISH_CONF = "camel.source.endpoint.autoFinish";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_AUTO_FINISH_DOC = "Automatically finish the NSQ Message when it is retrieved from the queue and before the Exchange is processed";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_AUTO_FINISH_DEFAULT = "true";
    ...
    private static final Boolean CAMEL_SOURCE_NSQ_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_NSQ_ENDPOINT_CHANNEL_CONF = "camel.source.endpoint.channel";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_CHANNEL_DOC = "The NSQ channel";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_CHANNEL_DEFAULT = null;
    public static final String CAMEL_SOURCE_NSQ_ENDPOINT_LOOKUP_INTERVAL_CONF = "camel.source.endpoint.lookupInterval";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_LOOKUP_INTERVAL_DOC = "The lookup interval";
    private static final Long CAMEL_SOURCE_NSQ_ENDPOINT_LOOKUP_INTERVAL_DEFAULT = 5000L;
    public static final String CAMEL_SOURCE_NSQ_ENDPOINT_LOOKUP_SERVER_PORT_CONF = "camel.source.endpoint.lookupServerPort";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_LOOKUP_SERVER_PORT_DOC = "The NSQ lookup server port";
    private static final Integer CAMEL_SOURCE_NSQ_ENDPOINT_LOOKUP_SERVER_PORT_DEFAULT = 4161;
    public static final String CAMEL_SOURCE_NSQ_ENDPOINT_MESSAGE_TIMEOUT_CONF = "camel.source.endpoint.messageTimeout";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_MESSAGE_TIMEOUT_DOC = "The NSQ consumer timeout period for messages retrieved from the queue. A value of -1 is the server default";
    private static final Long CAMEL_SOURCE_NSQ_ENDPOINT_MESSAGE_TIMEOUT_DEFAULT = -1L;
    public static final String CAMEL_SOURCE_NSQ_ENDPOINT_POOL_SIZE_CONF = "camel.source.endpoint.poolSize";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_POOL_SIZE_DOC = "Consumer pool size";
    private static final Integer CAMEL_SOURCE_NSQ_ENDPOINT_POOL_SIZE_DEFAULT = 10;
    public static final String CAMEL_SOURCE_NSQ_ENDPOINT_REQUEUE_INTERVAL_CONF = "camel.source.endpoint.requeueInterval";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_REQUEUE_INTERVAL_DOC = "The requeue interval in milliseconds. A value of -1 is the server default";
    private static final Long CAMEL_SOURCE_NSQ_ENDPOINT_REQUEUE_INTERVAL_DEFAULT = -1L;
    ...
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_NSQ_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_NSQ_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_NSQ_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_NSQ_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_NSQ_ENDPOINT_SECURE_CONF = "camel.source.endpoint.secure";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_SECURE_DOC = "Set secure option indicating TLS is required";
    private static final Boolean CAMEL_SOURCE_NSQ_ENDPOINT_SECURE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    private static final String CAMEL_SOURCE_NSQ_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_NSQ_COMPONENT_SERVERS_CONF = "camel.component.nsq.servers";
    private static final String CAMEL_SOURCE_NSQ_COMPONENT_SERVERS_DOC = "The hostnames of one or more nsqlookupd servers (consumer) or nsqd servers (producer).";
    private static final String CAMEL_SOURCE_NSQ_COMPONENT_SERVERS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_NSQ_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_NSQ_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_NSQ_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_NSQ_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SOURCE_NSQ_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
