...
public class CamelNsqSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_NSQ_PATH_TOPIC_DOC = "The NSQ topic";
    private static final String CAMEL_SINK_NSQ_PATH_TOPIC_DEFAULT = null;
    public static final String CAMEL_SINK_NSQ_ENDPOINT_SERVERS_CONF = "camel.sink.endpoint.servers";
    private static final String CAMEL_SINK_NSQ_ENDPOINT_SERVERS_DOC = "The hostnames of one or more nsqlookupd servers (consumer) or nsqd servers (producer)";
    private static final String CAMEL_SINK_NSQ_ENDPOINT_SERVERS_DEFAULT = null;
    public static final String CAMEL_SINK_NSQ_ENDPOINT_USER_AGENT_CONF = "camel.sink.endpoint.userAgent";
    private static final String CAMEL_SINK_NSQ_ENDPOINT_USER_AGENT_DOC = "A String to identify the kind of client";
    private static final String CAMEL_SINK_NSQ_ENDPOINT_USER_AGENT_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_NSQ_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_NSQ_ENDPOINT_PORT_CONF = "camel.sink.endpoint.port";
    private static final String CAMEL_SINK_NSQ_ENDPOINT_PORT_DOC = "The port of the nsqd server";
    private static final Integer CAMEL_SINK_NSQ_ENDPOINT_PORT_DEFAULT = 4150;
    public static final String CAMEL_SINK_NSQ_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_NSQ_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_NSQ_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_NSQ_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_NSQ_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_NSQ_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_NSQ_ENDPOINT_SECURE_CONF = "camel.sink.endpoint.secure";
    private static final String CAMEL_SINK_NSQ_ENDPOINT_SECURE_DOC = "Set secure option indicating TLS is required";
    private static final Boolean CAMEL_SINK_NSQ_ENDPOINT_SECURE_DEFAULT = false;
    public static final String CAMEL_SINK_NSQ_ENDPOINT_SSL_CONTEXT_PARAMETERS_CONF = "camel.sink.endpoint.sslContextParameters";
    private static final String CAMEL_SINK_NSQ_ENDPOINT_SSL_CONTEXT_PARAMETERS_DOC = "To configure security using SSLContextParameters";
    private static final String CAMEL_SINK_NSQ_ENDPOINT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    public static final String CAMEL_SINK_NSQ_COMPONENT_SERVERS_CONF = "camel.component.nsq.servers";
    private static final String CAMEL_SINK_NSQ_COMPONENT_SERVERS_DOC = "The hostnames of one or more nsqlookupd servers (consumer) or nsqd servers (producer).";
    private static final String CAMEL_SINK_NSQ_COMPONENT_SERVERS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_NSQ_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_NSQ_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.nsq.basicPropertyBinding";
    private static final String CAMEL_SINK_NSQ_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_NSQ_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_NSQ_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    private static final Boolean CAMEL_SINK_NSQ_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
