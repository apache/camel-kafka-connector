...
public class CamelCmsmsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_CMSMS_PATH_HOST_DOC = "SMS Provider HOST with scheme";
    private static final String CAMEL_SINK_CMSMS_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_CMSMS_ENDPOINT_DEFAULT_FROM_CONF = "camel.sink.endpoint.defaultFrom";
    private static final String CAMEL_SINK_CMSMS_ENDPOINT_DEFAULT_FROM_DOC = "This is the sender name. The maximum length is 11 characters.";
    private static final String CAMEL_SINK_CMSMS_ENDPOINT_DEFAULT_FROM_DEFAULT = null;
    ...
    private static final Integer CAMEL_SINK_CMSMS_ENDPOINT_DEFAULT_MAX_NUMBER_OF_PARTS_DEFAULT = 8;
    ...
    private static final Boolean CAMEL_SINK_CMSMS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_CMSMS_ENDPOINT_PRODUCT_TOKEN_CONF = "camel.sink.endpoint.productToken";
    private static final String CAMEL_SINK_CMSMS_ENDPOINT_PRODUCT_TOKEN_DOC = "The unique token to use";
    private static final String CAMEL_SINK_CMSMS_ENDPOINT_PRODUCT_TOKEN_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CMSMS_ENDPOINT_TEST_CONNECTION_ON_STARTUP_DOC = "Whether to test the connection to the SMS Gateway on startup";
    private static final Boolean CAMEL_SINK_CMSMS_ENDPOINT_TEST_CONNECTION_ON_STARTUP_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CMSMS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CMSMS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_CMSMS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_CMSMS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_CMSMS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_CMSMS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CMSMS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CMSMS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
