...
public class CamelAzurestoragedatalakesourceSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AZURESTORAGEDATALAKESOURCE_KAMELET_CREDENTIAL_TYPE_CONF = "camel.kamelet.azure-storage-datalake-source.credentialType";
    public static final String CAMEL_SOURCE_AZURESTORAGEDATALAKESOURCE_KAMELET_CREDENTIAL_TYPE_DOC = "Determines the credential strategy to adopt.";
    public static final String CAMEL_SOURCE_AZURESTORAGEDATALAKESOURCE_KAMELET_CREDENTIAL_TYPE_DEFAULT = "CLIENT_SECRET";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_AZURESTORAGEDATALAKESOURCE_KAMELET_CREDENTIAL_TYPE_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_AZURESTORAGEDATALAKESOURCE_KAMELET_CREDENTIAL_TYPE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AZURESTORAGEDATALAKESOURCE_KAMELET_CREDENTIAL_TYPE_DOC);
        return conf;
    }
}