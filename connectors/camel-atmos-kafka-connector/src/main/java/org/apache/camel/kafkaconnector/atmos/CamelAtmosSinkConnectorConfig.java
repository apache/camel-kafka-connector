...
public class CamelAtmosSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_ATMOS_PATH_NAME_DOC = "Atmos name";
    private static final String CAMEL_SINK_ATMOS_PATH_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOS_PATH_OPERATION_CONF = "camel.sink.path.operation";
    private static final String CAMEL_SINK_ATMOS_PATH_OPERATION_DOC = "Operation to perform One of: [put] [del] [search] [get] [move]";
    private static final String CAMEL_SINK_ATMOS_PATH_OPERATION_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOS_ENDPOINT_LOCAL_PATH_CONF = "camel.sink.endpoint.localPath";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_LOCAL_PATH_DOC = "Local path to put files";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_LOCAL_PATH_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOS_ENDPOINT_NEW_REMOTE_PATH_CONF = "camel.sink.endpoint.newRemotePath";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_NEW_REMOTE_PATH_DOC = "New path on Atmos when moving files";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_NEW_REMOTE_PATH_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOS_ENDPOINT_QUERY_CONF = "camel.sink.endpoint.query";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_QUERY_DOC = "Search query on Atmos";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_QUERY_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOS_ENDPOINT_REMOTE_PATH_CONF = "camel.sink.endpoint.remotePath";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_REMOTE_PATH_DOC = "Where to put files on Atmos";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_REMOTE_PATH_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ATMOS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_ATMOS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_ATMOS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_ATMOS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_ATMOS_ENDPOINT_URI_CONF = "camel.sink.endpoint.uri";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_URI_DOC = "Atomos server uri";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_URI_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOS_ENDPOINT_FULL_TOKEN_ID_CONF = "camel.sink.endpoint.fullTokenId";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_FULL_TOKEN_ID_DOC = "Atmos client fullTokenId";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_FULL_TOKEN_ID_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOS_ENDPOINT_SECRET_KEY_CONF = "camel.sink.endpoint.secretKey";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_SECRET_KEY_DOC = "The secret key to pass to the Atmos client (should be base64 encoded)";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_SECRET_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOS_ENDPOINT_SSL_VALIDATION_CONF = "camel.sink.endpoint.sslValidation";
    private static final String CAMEL_SINK_ATMOS_ENDPOINT_SSL_VALIDATION_DOC = "Atmos SSL validation";
    private static final Boolean CAMEL_SINK_ATMOS_ENDPOINT_SSL_VALIDATION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ATMOS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ATMOS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_ATMOS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_ATMOS_COMPONENT_URI_CONF = "camel.component.atmos.uri";
    private static final String CAMEL_SINK_ATMOS_COMPONENT_URI_DOC = "The URI of the server for the Atmos client to connect to";
    private static final String CAMEL_SINK_ATMOS_COMPONENT_URI_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOS_COMPONENT_FULL_TOKEN_ID_CONF = "camel.component.atmos.fullTokenId";
    private static final String CAMEL_SINK_ATMOS_COMPONENT_FULL_TOKEN_ID_DOC = "The token id to pass to the Atmos client";
    private static final String CAMEL_SINK_ATMOS_COMPONENT_FULL_TOKEN_ID_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOS_COMPONENT_SECRET_KEY_CONF = "camel.component.atmos.secretKey";
    private static final String CAMEL_SINK_ATMOS_COMPONENT_SECRET_KEY_DOC = "The secret key to pass to the Atmos client (should be base64 encoded)";
    private static final String CAMEL_SINK_ATMOS_COMPONENT_SECRET_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOS_COMPONENT_SSL_VALIDATION_CONF = "camel.component.atmos.sslValidation";
    private static final String CAMEL_SINK_ATMOS_COMPONENT_SSL_VALIDATION_DOC = "Whether the Atmos client should perform SSL validation";
    private static final Boolean CAMEL_SINK_ATMOS_COMPONENT_SSL_VALIDATION_DEFAULT = false;
