...
public class CamelExecSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_EXEC_PATH_EXECUTABLE_DOC = "Sets the executable to be executed. The executable must not be empty or null.";
    private static final String CAMEL_SINK_EXEC_PATH_EXECUTABLE_DEFAULT = null;
    public static final String CAMEL_SINK_EXEC_ENDPOINT_ARGS_CONF = "camel.sink.endpoint.args";
    private static final String CAMEL_SINK_EXEC_ENDPOINT_ARGS_DOC = "The arguments may be one or many whitespace-separated tokens.";
    private static final String CAMEL_SINK_EXEC_ENDPOINT_ARGS_DEFAULT = null;
    public static final String CAMEL_SINK_EXEC_ENDPOINT_BINDING_CONF = "camel.sink.endpoint.binding";
    private static final String CAMEL_SINK_EXEC_ENDPOINT_BINDING_DOC = "A reference to a org.apache.commons.exec.ExecBinding in the Registry.";
    private static final String CAMEL_SINK_EXEC_ENDPOINT_BINDING_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_EXEC_ENDPOINT_COMMAND_EXECUTOR_DEFAULT = null;
    public static final String CAMEL_SINK_EXEC_ENDPOINT_COMMAND_LOG_LEVEL_CONF = "camel.sink.endpoint.commandLogLevel";
    private static final String CAMEL_SINK_EXEC_ENDPOINT_COMMAND_LOG_LEVEL_DOC = "Logging level to be used for commands during execution. The default value is DEBUG. Possible values are TRACE, DEBUG, INFO, WARN, ERROR or OFF. (Values of ExecCommandLogLevelType enum) One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SINK_EXEC_ENDPOINT_COMMAND_LOG_LEVEL_DEFAULT = "DEBUG";
    ...
    private static final Boolean CAMEL_SINK_EXEC_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_EXEC_ENDPOINT_OUT_FILE_CONF = "camel.sink.endpoint.outFile";
    private static final String CAMEL_SINK_EXEC_ENDPOINT_OUT_FILE_DOC = "The name of a file, created by the executable, that should be considered as its output. If no outFile is set, the standard output (stdout) of the executable will be used instead.";
    private static final String CAMEL_SINK_EXEC_ENDPOINT_OUT_FILE_DEFAULT = null;
    public static final String CAMEL_SINK_EXEC_ENDPOINT_TIMEOUT_CONF = "camel.sink.endpoint.timeout";
    private static final String CAMEL_SINK_EXEC_ENDPOINT_TIMEOUT_DOC = "The timeout, in milliseconds, after which the executable should be terminated. If execution has not completed within the timeout, the component will send a termination request.";
    private static final Long CAMEL_SINK_EXEC_ENDPOINT_TIMEOUT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_EXEC_ENDPOINT_USE_STDERR_ON_EMPTY_STDOUT_DOC = "A boolean indicating that when stdout is empty, this component will populate the Camel Message Body with stderr. This behavior is disabled (false) by default.";
    private static final Boolean CAMEL_SINK_EXEC_ENDPOINT_USE_STDERR_ON_EMPTY_STDOUT_DEFAULT = false;
    public static final String CAMEL_SINK_EXEC_ENDPOINT_WORKING_DIR_CONF = "camel.sink.endpoint.workingDir";
    private static final String CAMEL_SINK_EXEC_ENDPOINT_WORKING_DIR_DOC = "The directory in which the command should be executed. If null, the working directory of the current process will be used.";
    private static final String CAMEL_SINK_EXEC_ENDPOINT_WORKING_DIR_DEFAULT = null;
    public static final String CAMEL_SINK_EXEC_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_EXEC_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_EXEC_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_EXEC_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_EXEC_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_EXEC_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_EXEC_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_EXEC_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_EXEC_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
