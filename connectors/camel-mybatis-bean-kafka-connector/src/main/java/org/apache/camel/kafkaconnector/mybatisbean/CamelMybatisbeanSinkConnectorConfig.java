...
public class CamelMybatisbeanSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_MYBATISBEAN_PATH_BEAN_NAME_DOC = "Name of the bean with the MyBatis annotations. This can either by a type alias or a FQN class name.";
    private static final String CAMEL_SINK_MYBATISBEAN_PATH_BEAN_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_MYBATISBEAN_PATH_METHOD_NAME_CONF = "camel.sink.path.methodName";
    private static final String CAMEL_SINK_MYBATISBEAN_PATH_METHOD_NAME_DOC = "Name of the method on the bean that has the SQL query to be executed.";
    private static final String CAMEL_SINK_MYBATISBEAN_PATH_METHOD_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_MYBATISBEAN_ENDPOINT_EXECUTOR_TYPE_CONF = "camel.sink.endpoint.executorType";
    private static final String CAMEL_SINK_MYBATISBEAN_ENDPOINT_EXECUTOR_TYPE_DOC = "The executor type to be used while executing statements. simple - executor does nothing special. reuse - executor reuses prepared statements. batch - executor reuses statements and batches updates. One of: [SIMPLE] [REUSE] [BATCH]";
    private static final String CAMEL_SINK_MYBATISBEAN_ENDPOINT_EXECUTOR_TYPE_DEFAULT = "SIMPLE";
    ...
    private static final String CAMEL_SINK_MYBATISBEAN_ENDPOINT_INPUT_HEADER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_MYBATISBEAN_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_MYBATISBEAN_ENDPOINT_OUTPUT_HEADER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_MYBATISBEAN_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_MYBATISBEAN_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_MYBATISBEAN_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_MYBATISBEAN_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_MYBATISBEAN_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_MYBATISBEAN_COMPONENT_CONFIGURATION_URI_DOC = "Location of MyBatis xml configuration file. The default value is: SqlMapConfig.xml loaded from the classpath";
    private static final String CAMEL_SINK_MYBATISBEAN_COMPONENT_CONFIGURATION_URI_DEFAULT = "SqlMapConfig.xml";
    ...
    private static final Boolean CAMEL_SINK_MYBATISBEAN_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_MYBATISBEAN_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_MYBATISBEAN_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_MYBATISBEAN_COMPONENT_SQL_SESSION_FACTORY_DOC = "To use the SqlSessionFactory";
    private static final String CAMEL_SINK_MYBATISBEAN_COMPONENT_SQL_SESSION_FACTORY_DEFAULT = null;
