...
public class CamelAzurestoragequeuesinkSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_AZURESTORAGEQUEUESINK_KAMELET_CREDENTIAL_TYPE_CONF = "camel.kamelet.azure-storage-queue-sink.credentialType";
    public static final String CAMEL_SINK_AZURESTORAGEQUEUESINK_KAMELET_CREDENTIAL_TYPE_DOC = "Determines the credential strategy to adopt.";
    public static final String CAMEL_SINK_AZURESTORAGEQUEUESINK_KAMELET_CREDENTIAL_TYPE_DEFAULT = "SHARED_ACCOUNT_KEY";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_AZURESTORAGEQUEUESINK_KAMELET_CREDENTIAL_TYPE_CONF, ConfigDef.Type.STRING, CAMEL_SINK_AZURESTORAGEQUEUESINK_KAMELET_CREDENTIAL_TYPE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AZURESTORAGEQUEUESINK_KAMELET_CREDENTIAL_TYPE_DOC);
        return conf;
    }
}