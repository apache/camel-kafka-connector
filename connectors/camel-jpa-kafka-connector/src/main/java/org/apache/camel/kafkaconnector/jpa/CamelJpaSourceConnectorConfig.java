...
public class CamelJpaSourceConnectorConfig extends CamelSourceConnectorConfig {
    ...
    public static final String CAMEL_SOURCE_JPA_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll. You can also specify time values using units, such as 60s (60 seconds), 5m30s (5 minutes and 30 seconds), and 1h (1 hour).";
    ...
    public static final String CAMEL_SOURCE_JPA_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts. You can also specify time values using units, such as 60s (60 seconds), 5m30s (5 minutes and 30 seconds), and 1h (1 hour).";
    ...
    public static final String CAMEL_SOURCE_JPA_ENDPOINT_SCHEDULER_DOC = "To use a cron scheduler from either camel-spring or camel-quartz component One of: [none] [spring] [quartz]";
