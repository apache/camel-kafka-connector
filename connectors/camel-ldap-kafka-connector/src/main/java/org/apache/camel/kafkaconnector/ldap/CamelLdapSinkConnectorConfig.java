...
public class CamelLdapSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_LDAP_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_LDAP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_LDAP_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
        return conf;
    }
}