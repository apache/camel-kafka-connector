...
public class CamelJcacheSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_JCACHE_PATH_CACHE_NAME_DOC = "The name of the cache";
    private static final String CAMEL_SOURCE_JCACHE_PATH_CACHE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CACHE_CONFIGURATION_DOC = "A Configuration for the Cache";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CACHE_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CACHE_CONFIGURATION_PROPERTIES_DOC = "The Properties for the javax.cache.spi.CachingProvider to create the CacheManager";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CACHE_CONFIGURATION_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CACHING_PROVIDER_CONF = "camel.source.endpoint.cachingProvider";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CACHING_PROVIDER_DOC = "The fully qualified class name of the javax.cache.spi.CachingProvider";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CACHING_PROVIDER_DEFAULT = null;
    public static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CONFIGURATION_URI_CONF = "camel.source.endpoint.configurationUri";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CONFIGURATION_URI_DOC = "An implementation specific URI for the CacheManager";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CONFIGURATION_URI_DEFAULT = null;
    public static final String CAMEL_SOURCE_JCACHE_ENDPOINT_MANAGEMENT_ENABLED_CONF = "camel.source.endpoint.managementEnabled";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_MANAGEMENT_ENABLED_DOC = "Whether management gathering is enabled";
    private static final Boolean CAMEL_SOURCE_JCACHE_ENDPOINT_MANAGEMENT_ENABLED_DEFAULT = false;
    public static final String CAMEL_SOURCE_JCACHE_ENDPOINT_READ_THROUGH_CONF = "camel.source.endpoint.readThrough";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_READ_THROUGH_DOC = "If read-through caching should be used";
    private static final Boolean CAMEL_SOURCE_JCACHE_ENDPOINT_READ_THROUGH_DEFAULT = false;
    public static final String CAMEL_SOURCE_JCACHE_ENDPOINT_STATISTICS_ENABLED_CONF = "camel.source.endpoint.statisticsEnabled";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_STATISTICS_ENABLED_DOC = "Whether statistics gathering is enabled";
    private static final Boolean CAMEL_SOURCE_JCACHE_ENDPOINT_STATISTICS_ENABLED_DEFAULT = false;
    public static final String CAMEL_SOURCE_JCACHE_ENDPOINT_STORE_BY_VALUE_CONF = "camel.source.endpoint.storeByValue";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_STORE_BY_VALUE_DOC = "If cache should use store-by-value or store-by-reference semantics";
    private static final Boolean CAMEL_SOURCE_JCACHE_ENDPOINT_STORE_BY_VALUE_DEFAULT = true;
    public static final String CAMEL_SOURCE_JCACHE_ENDPOINT_WRITE_THROUGH_CONF = "camel.source.endpoint.writeThrough";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_WRITE_THROUGH_DOC = "If write-through caching should be used";
    private static final Boolean CAMEL_SOURCE_JCACHE_ENDPOINT_WRITE_THROUGH_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_JCACHE_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_JCACHE_ENDPOINT_FILTERED_EVENTS_CONF = "camel.source.endpoint.filteredEvents";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_FILTERED_EVENTS_DOC = "Events a consumer should filter (multiple events can be separated by comma). If using filteredEvents option, then eventFilters one will be ignored One of: [CREATED] [UPDATED] [REMOVED] [EXPIRED]";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_FILTERED_EVENTS_DEFAULT = null;
    public static final String CAMEL_SOURCE_JCACHE_ENDPOINT_OLD_VALUE_REQUIRED_CONF = "camel.source.endpoint.oldValueRequired";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_OLD_VALUE_REQUIRED_DOC = "if the old value is required for events";
    private static final Boolean CAMEL_SOURCE_JCACHE_ENDPOINT_OLD_VALUE_REQUIRED_DEFAULT = false;
    public static final String CAMEL_SOURCE_JCACHE_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_SYNCHRONOUS_DOC = "if the event listener should block the thread causing the event";
    private static final Boolean CAMEL_SOURCE_JCACHE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_JCACHE_ENDPOINT_EVENT_FILTERS_CONF = "camel.source.endpoint.eventFilters";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_EVENT_FILTERS_DOC = "The CacheEntryEventFilter. If using eventFilters option, then filteredEvents one will be ignored";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_EVENT_FILTERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_JCACHE_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_JCACHE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CACHE_LOADER_FACTORY_DOC = "The CacheLoader factory";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CACHE_LOADER_FACTORY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CACHE_WRITER_FACTORY_DOC = "The CacheWriter factory";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CACHE_WRITER_FACTORY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_CREATE_CACHE_IF_NOT_EXISTS_DOC = "Configure if a cache need to be created if it does exist or can't be pre-configured.";
    private static final Boolean CAMEL_SOURCE_JCACHE_ENDPOINT_CREATE_CACHE_IF_NOT_EXISTS_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_EXPIRY_POLICY_FACTORY_DOC = "The ExpiryPolicy factory";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_EXPIRY_POLICY_FACTORY_DEFAULT = null;
    public static final String CAMEL_SOURCE_JCACHE_ENDPOINT_LOOKUP_PROVIDERS_CONF = "camel.source.endpoint.lookupProviders";
    private static final String CAMEL_SOURCE_JCACHE_ENDPOINT_LOOKUP_PROVIDERS_DOC = "Configure if a camel-cache should try to find implementations of jcache api in runtimes like OSGi.";
    private static final Boolean CAMEL_SOURCE_JCACHE_ENDPOINT_LOOKUP_PROVIDERS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JCACHE_COMPONENT_CACHE_CONFIGURATION_DOC = "A Configuration for the Cache";
    private static final String CAMEL_SOURCE_JCACHE_COMPONENT_CACHE_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JCACHE_COMPONENT_CACHE_CONFIGURATION_PROPERTIES_DOC = "Properties to configure jcache";
    private static final String CAMEL_SOURCE_JCACHE_COMPONENT_CACHE_CONFIGURATION_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_JCACHE_COMPONENT_CACHE_CONFIGURATION_PROPERTIES_REF_DOC = "References to an existing Properties or Map to lookup in the registry to use for configuring jcache.";
    private static final String CAMEL_SOURCE_JCACHE_COMPONENT_CACHE_CONFIGURATION_PROPERTIES_REF_DEFAULT = null;
    public static final String CAMEL_SOURCE_JCACHE_COMPONENT_CACHING_PROVIDER_CONF = "camel.component.jcache.cachingProvider";
    private static final String CAMEL_SOURCE_JCACHE_COMPONENT_CACHING_PROVIDER_DOC = "The fully qualified class name of the javax.cache.spi.CachingProvider";
    private static final String CAMEL_SOURCE_JCACHE_COMPONENT_CACHING_PROVIDER_DEFAULT = null;
    public static final String CAMEL_SOURCE_JCACHE_COMPONENT_CONFIGURATION_URI_CONF = "camel.component.jcache.configurationUri";
    private static final String CAMEL_SOURCE_JCACHE_COMPONENT_CONFIGURATION_URI_DOC = "An implementation specific URI for the CacheManager";
    private static final String CAMEL_SOURCE_JCACHE_COMPONENT_CONFIGURATION_URI_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_JCACHE_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_JCACHE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_JCACHE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
