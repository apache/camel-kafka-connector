...
public class CamelJcacheSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_JCACHE_PATH_CACHE_NAME_DOC = "The name of the cache";
    private static final String CAMEL_SINK_JCACHE_PATH_CACHE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHE_CONFIGURATION_CONF = "camel.sink.endpoint.cacheConfiguration";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHE_CONFIGURATION_DOC = "A Configuration for the Cache";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHE_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHE_CONFIGURATION_PROPERTIES_DOC = "The Properties for the javax.cache.spi.CachingProvider to create the CacheManager";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHE_CONFIGURATION_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHING_PROVIDER_CONF = "camel.sink.endpoint.cachingProvider";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHING_PROVIDER_DOC = "The fully qualified class name of the javax.cache.spi.CachingProvider";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHING_PROVIDER_DEFAULT = null;
    public static final String CAMEL_SINK_JCACHE_ENDPOINT_CONFIGURATION_URI_CONF = "camel.sink.endpoint.configurationUri";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_CONFIGURATION_URI_DOC = "An implementation specific URI for the CacheManager";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_CONFIGURATION_URI_DEFAULT = null;
    public static final String CAMEL_SINK_JCACHE_ENDPOINT_MANAGEMENT_ENABLED_CONF = "camel.sink.endpoint.managementEnabled";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_MANAGEMENT_ENABLED_DOC = "Whether management gathering is enabled";
    private static final Boolean CAMEL_SINK_JCACHE_ENDPOINT_MANAGEMENT_ENABLED_DEFAULT = false;
    public static final String CAMEL_SINK_JCACHE_ENDPOINT_READ_THROUGH_CONF = "camel.sink.endpoint.readThrough";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_READ_THROUGH_DOC = "If read-through caching should be used";
    private static final Boolean CAMEL_SINK_JCACHE_ENDPOINT_READ_THROUGH_DEFAULT = false;
    public static final String CAMEL_SINK_JCACHE_ENDPOINT_STATISTICS_ENABLED_CONF = "camel.sink.endpoint.statisticsEnabled";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_STATISTICS_ENABLED_DOC = "Whether statistics gathering is enabled";
    private static final Boolean CAMEL_SINK_JCACHE_ENDPOINT_STATISTICS_ENABLED_DEFAULT = false;
    public static final String CAMEL_SINK_JCACHE_ENDPOINT_STORE_BY_VALUE_CONF = "camel.sink.endpoint.storeByValue";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_STORE_BY_VALUE_DOC = "If cache should use store-by-value or store-by-reference semantics";
    private static final Boolean CAMEL_SINK_JCACHE_ENDPOINT_STORE_BY_VALUE_DEFAULT = true;
    public static final String CAMEL_SINK_JCACHE_ENDPOINT_WRITE_THROUGH_CONF = "camel.sink.endpoint.writeThrough";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_WRITE_THROUGH_DOC = "If write-through caching should be used";
    private static final Boolean CAMEL_SINK_JCACHE_ENDPOINT_WRITE_THROUGH_DEFAULT = false;
    public static final String CAMEL_SINK_JCACHE_ENDPOINT_ACTION_CONF = "camel.sink.endpoint.action";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_ACTION_DOC = "To configure using a cache operation by default. If an operation in the message header, then the operation from the header takes precedence.";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_ACTION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JCACHE_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JCACHE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHE_LOADER_FACTORY_CONF = "camel.sink.endpoint.cacheLoaderFactory";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHE_LOADER_FACTORY_DOC = "The CacheLoader factory";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHE_LOADER_FACTORY_DEFAULT = null;
    public static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHE_WRITER_FACTORY_CONF = "camel.sink.endpoint.cacheWriterFactory";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHE_WRITER_FACTORY_DOC = "The CacheWriter factory";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_CACHE_WRITER_FACTORY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_CREATE_CACHE_IF_NOT_EXISTS_DOC = "Configure if a cache need to be created if it does exist or can't be pre-configured.";
    private static final Boolean CAMEL_SINK_JCACHE_ENDPOINT_CREATE_CACHE_IF_NOT_EXISTS_DEFAULT = true;
    public static final String CAMEL_SINK_JCACHE_ENDPOINT_EXPIRY_POLICY_FACTORY_CONF = "camel.sink.endpoint.expiryPolicyFactory";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_EXPIRY_POLICY_FACTORY_DOC = "The ExpiryPolicy factory";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_EXPIRY_POLICY_FACTORY_DEFAULT = null;
    public static final String CAMEL_SINK_JCACHE_ENDPOINT_LOOKUP_PROVIDERS_CONF = "camel.sink.endpoint.lookupProviders";
    private static final String CAMEL_SINK_JCACHE_ENDPOINT_LOOKUP_PROVIDERS_DOC = "Configure if a camel-cache should try to find implementations of jcache api in runtimes like OSGi.";
    private static final Boolean CAMEL_SINK_JCACHE_ENDPOINT_LOOKUP_PROVIDERS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_JCACHE_COMPONENT_CACHE_CONFIGURATION_DOC = "A Configuration for the Cache";
    private static final String CAMEL_SINK_JCACHE_COMPONENT_CACHE_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_JCACHE_COMPONENT_CACHE_CONFIGURATION_PROPERTIES_DOC = "Properties to configure jcache";
    private static final String CAMEL_SINK_JCACHE_COMPONENT_CACHE_CONFIGURATION_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_JCACHE_COMPONENT_CACHE_CONFIGURATION_PROPERTIES_REF_DOC = "References to an existing Properties or Map to lookup in the registry to use for configuring jcache.";
    private static final String CAMEL_SINK_JCACHE_COMPONENT_CACHE_CONFIGURATION_PROPERTIES_REF_DEFAULT = null;
    public static final String CAMEL_SINK_JCACHE_COMPONENT_CACHING_PROVIDER_CONF = "camel.component.jcache.cachingProvider";
    private static final String CAMEL_SINK_JCACHE_COMPONENT_CACHING_PROVIDER_DOC = "The fully qualified class name of the javax.cache.spi.CachingProvider";
    private static final String CAMEL_SINK_JCACHE_COMPONENT_CACHING_PROVIDER_DEFAULT = null;
    public static final String CAMEL_SINK_JCACHE_COMPONENT_CONFIGURATION_URI_CONF = "camel.component.jcache.configurationUri";
    private static final String CAMEL_SINK_JCACHE_COMPONENT_CONFIGURATION_URI_DOC = "An implementation specific URI for the CacheManager";
    private static final String CAMEL_SINK_JCACHE_COMPONENT_CONFIGURATION_URI_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JCACHE_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_JCACHE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JCACHE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
