...
public class CamelDropboxSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_DROPBOX_PATH_OPERATION_DOC = "The specific action (typically is a CRUD action) to perform on Dropbox remote folder. One of: [put] [del] [search] [get] [move]";
    private static final String CAMEL_SOURCE_DROPBOX_PATH_OPERATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_ACCESS_TOKEN_CONF = "camel.source.endpoint.accessToken";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_ACCESS_TOKEN_DOC = "The access token to make API requests for a specific Dropbox user";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_ACCESS_TOKEN_DEFAULT = null;
    public static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_CLIENT_CONF = "camel.source.endpoint.client";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_CLIENT_DOC = "To use an existing DbxClient instance as DropBox client.";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_CLIENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_CLIENT_IDENTIFIER_CONF = "camel.source.endpoint.clientIdentifier";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_CLIENT_IDENTIFIER_DOC = "Name of the app registered to make API requests";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_CLIENT_IDENTIFIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_LOCAL_PATH_CONF = "camel.source.endpoint.localPath";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_LOCAL_PATH_DOC = "Optional folder or file to upload on Dropbox from the local filesystem. If this option has not been configured then the message body is used as the content to upload.";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_LOCAL_PATH_DEFAULT = null;
    public static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_NEW_REMOTE_PATH_CONF = "camel.source.endpoint.newRemotePath";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_NEW_REMOTE_PATH_DOC = "Destination file or folder";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_NEW_REMOTE_PATH_DEFAULT = null;
    public static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_QUERY_CONF = "camel.source.endpoint.query";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_QUERY_DOC = "A space-separated list of sub-strings to search for. A file matches only if it contains all the sub-strings. If this option is not set, all files will be matched.";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_QUERY_DEFAULT = null;
    public static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_REMOTE_PATH_CONF = "camel.source.endpoint.remotePath";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_REMOTE_PATH_DOC = "Original file or folder to move";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_REMOTE_PATH_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_UPLOAD_MODE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_DROPBOX_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_DROPBOX_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_DROPBOX_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_DROPBOX_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_DROPBOX_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DROPBOX_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_DROPBOX_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
