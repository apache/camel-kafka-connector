...
The camel-hwcloud-iam sink connector supports 16 options, which are listed below.
...
| *camel.sink.endpoint.endpoint* | IAM endpoint url. Carries higher precedence than region parameter based client initialization | null | false | MEDIUM
...
| *camel.sink.endpoint.region* | IAM service region. This is lower precedence than endpoint based configuration | null | true | HIGH
