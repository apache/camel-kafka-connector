...
public class CamelGrapeSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_GRAPE_PATH_DEFAULT_COORDINATES_DOC = "Maven coordinates to use as default to grab if the message body is empty.";
    private static final String CAMEL_SINK_GRAPE_PATH_DEFAULT_COORDINATES_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_GRAPE_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_GRAPE_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_GRAPE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GRAPE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_GRAPE_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_GRAPE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_GRAPE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_GRAPE_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_GRAPE_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.grape.basicPropertyBinding";
    private static final String CAMEL_SINK_GRAPE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GRAPE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_GRAPE_COMPONENT_PATCHES_REPOSITORY_CONF = "camel.component.grape.patchesRepository";
    private static final String CAMEL_SINK_GRAPE_COMPONENT_PATCHES_REPOSITORY_DOC = "Implementation of org.apache.camel.component.grape.PatchesRepository, by default: FilePatchesRepository";
    private static final String CAMEL_SINK_GRAPE_COMPONENT_PATCHES_REPOSITORY_DEFAULT = null;
