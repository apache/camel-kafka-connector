...
public class CamelJcloudsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_JCLOUDS_PATH_COMMAND_DOC = "What command to execute such as blobstore or compute. One of: [blobstore] [compute]";
    private static final String CAMEL_SINK_JCLOUDS_PATH_COMMAND_DEFAULT = null;
    public static final String CAMEL_SINK_JCLOUDS_PATH_PROVIDER_ID_CONF = "camel.sink.path.providerId";
    private static final String CAMEL_SINK_JCLOUDS_PATH_PROVIDER_ID_DOC = "The name of the cloud provider that provides the target service (e.g. aws-s3 or aws_ec2).";
    private static final String CAMEL_SINK_JCLOUDS_PATH_PROVIDER_ID_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JCLOUDS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JCLOUDS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JCLOUDS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_JCLOUDS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_JCLOUDS_ENDPOINT_BLOB_NAME_CONF = "camel.sink.endpoint.blobName";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_BLOB_NAME_DOC = "The name of the blob.";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_BLOB_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_JCLOUDS_ENDPOINT_CONTAINER_CONF = "camel.sink.endpoint.container";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_CONTAINER_DOC = "The name of the blob container.";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_CONTAINER_DEFAULT = null;
    public static final String CAMEL_SINK_JCLOUDS_ENDPOINT_GROUP_CONF = "camel.sink.endpoint.group";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_GROUP_DOC = "The group that will be assigned to the newly created node. Values depend on the actual cloud provider.";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_GROUP_DEFAULT = null;
    public static final String CAMEL_SINK_JCLOUDS_ENDPOINT_HARDWARE_ID_CONF = "camel.sink.endpoint.hardwareId";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_HARDWARE_ID_DOC = "The hardware that will be used for creating a node. Values depend on the actual cloud provider.";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_HARDWARE_ID_DEFAULT = null;
    public static final String CAMEL_SINK_JCLOUDS_ENDPOINT_IMAGE_ID_CONF = "camel.sink.endpoint.imageId";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_IMAGE_ID_DOC = "The imageId that will be used for creating a node. Values depend on the actual cloud provider.";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_IMAGE_ID_DEFAULT = null;
    public static final String CAMEL_SINK_JCLOUDS_ENDPOINT_LOCATION_ID_CONF = "camel.sink.endpoint.locationId";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_LOCATION_ID_DOC = "The location that will be used for creating a node. Values depend on the actual cloud provider.";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_LOCATION_ID_DEFAULT = null;
    public static final String CAMEL_SINK_JCLOUDS_ENDPOINT_NODE_ID_CONF = "camel.sink.endpoint.nodeId";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_NODE_ID_DOC = "The id of the node that will run the script or destroyed.";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_NODE_ID_DEFAULT = null;
    public static final String CAMEL_SINK_JCLOUDS_ENDPOINT_NODE_STATE_CONF = "camel.sink.endpoint.nodeState";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_NODE_STATE_DOC = "To filter by node status to only select running nodes etc. One of: [PENDING] [TERMINATED] [SUSPENDED] [RUNNING] [ERROR] [UNRECOGNIZED]";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_NODE_STATE_DEFAULT = null;
    public static final String CAMEL_SINK_JCLOUDS_ENDPOINT_OPERATION_CONF = "camel.sink.endpoint.operation";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_OPERATION_DOC = "Specifies the type of operation that will be performed to the blobstore.";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_OPERATION_DEFAULT = null;
    public static final String CAMEL_SINK_JCLOUDS_ENDPOINT_USER_CONF = "camel.sink.endpoint.user";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_USER_DOC = "The user on the target node that will run the script.";
    private static final String CAMEL_SINK_JCLOUDS_ENDPOINT_USER_DEFAULT = null;
    public static final String CAMEL_SINK_JCLOUDS_COMPONENT_BLOB_STORES_CONF = "camel.component.jclouds.blobStores";
    private static final String CAMEL_SINK_JCLOUDS_COMPONENT_BLOB_STORES_DOC = "To use the given BlobStore which must be configured when using blobstore.";
    private static final String CAMEL_SINK_JCLOUDS_COMPONENT_BLOB_STORES_DEFAULT = null;
    public static final String CAMEL_SINK_JCLOUDS_COMPONENT_COMPUTE_SERVICES_CONF = "camel.component.jclouds.computeServices";
    private static final String CAMEL_SINK_JCLOUDS_COMPONENT_COMPUTE_SERVICES_DOC = "To use the given ComputeService which must be configured when use compute.";
    private static final String CAMEL_SINK_JCLOUDS_COMPONENT_COMPUTE_SERVICES_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JCLOUDS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_JCLOUDS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JCLOUDS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
