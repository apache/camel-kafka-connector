...
public class CamelHazelcastmapSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_HAZELCASTMAP_PATH_CACHE_NAME_DOC = "The name of the cache";
    public static final String CAMEL_SINK_HAZELCASTMAP_PATH_CACHE_NAME_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_HAZELCASTMAP_ENDPOINT_DEFAULT_OPERATION_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_HAZELCASTMAP_ENDPOINT_HAZELCAST_INSTANCE_DOC = "The hazelcast instance reference which can be used for hazelcast endpoint.";
    public static final String CAMEL_SINK_HAZELCASTMAP_ENDPOINT_HAZELCAST_INSTANCE_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_HAZELCASTMAP_ENDPOINT_HAZELCAST_INSTANCE_NAME_DOC = "The hazelcast instance reference name which can be used for hazelcast endpoint. If you don't specify the instance reference, camel use the default hazelcast instance from the camel-hazelcast instance.";
    public static final String CAMEL_SINK_HAZELCASTMAP_ENDPOINT_HAZELCAST_INSTANCE_NAME_DEFAULT = null;
    ...
    public static final Boolean CAMEL_SINK_HAZELCASTMAP_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_HAZELCASTMAP_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    public static final String CAMEL_SINK_HAZELCASTMAP_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    public static final Boolean CAMEL_SINK_HAZELCASTMAP_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    public static final Boolean CAMEL_SINK_HAZELCASTMAP_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_HAZELCASTMAP_COMPONENT_AUTOWIRED_ENABLED_CONF = "camel.component.hazelcast-map.autowiredEnabled";
    public static final String CAMEL_SINK_HAZELCASTMAP_COMPONENT_AUTOWIRED_ENABLED_DOC = "Whether autowiring is enabled. This is used for automatic autowiring options (the option must be marked as autowired) by looking up in the registry to find if there is a single instance of matching type, which then gets configured on the component. This can be used for automatic configuring JDBC data sources, JMS connection factories, AWS Clients, etc.";
    public static final Boolean CAMEL_SINK_HAZELCASTMAP_COMPONENT_AUTOWIRED_ENABLED_DEFAULT = true;
    ...
    public static final String CAMEL_SINK_HAZELCASTMAP_COMPONENT_HAZELCAST_INSTANCE_DOC = "The hazelcast instance reference which can be used for hazelcast endpoint. If you don't specify the instance reference, camel use the default hazelcast instance from the camel-hazelcast instance.";
    public static final String CAMEL_SINK_HAZELCASTMAP_COMPONENT_HAZELCAST_INSTANCE_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_HAZELCASTMAP_COMPONENT_HAZELCAST_MODE_DOC = "The hazelcast mode reference which kind of instance should be used. If you don't specify the mode, then the node mode will be the default.";
    public static final String CAMEL_SINK_HAZELCASTMAP_COMPONENT_HAZELCAST_MODE_DEFAULT = "node";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_HAZELCASTMAP_COMPONENT_AUTOWIRED_ENABLED_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_HAZELCASTMAP_COMPONENT_AUTOWIRED_ENABLED_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_HAZELCASTMAP_COMPONENT_AUTOWIRED_ENABLED_DOC);
