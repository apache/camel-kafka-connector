...
public class CamelAws2ddbstreamSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AWS2DDBSTREAM_ENDPOINT_STREAM_ITERATOR_TYPE_CONF = "camel.source.endpoint.streamIteratorType";
    public static final String CAMEL_SOURCE_AWS2DDBSTREAM_ENDPOINT_STREAM_ITERATOR_TYPE_DOC = "Defines where in the DynamoDB stream to start getting records. Note that using FROM_START can cause a significant delay before the stream has caught up to real-time. One of: [FROM_LATEST] [FROM_START]";
    public static final String CAMEL_SOURCE_AWS2DDBSTREAM_ENDPOINT_STREAM_ITERATOR_TYPE_DEFAULT = "FROM_LATEST";
    ...
    public static final String CAMEL_SOURCE_AWS2DDBSTREAM_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_CONF = "camel.source.endpoint.useDefaultCredentialsProvider";
    public static final String CAMEL_SOURCE_AWS2DDBSTREAM_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_DOC = "Set whether the DynamoDB Streams client should expect to load credentials through a default credentials provider or to expect static credentials to be passed in.";
    public static final Boolean CAMEL_SOURCE_AWS2DDBSTREAM_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_AWS2DDBSTREAM_COMPONENT_STREAM_ITERATOR_TYPE_CONF = "camel.component.aws2-ddbstream.streamIteratorType";
    public static final String CAMEL_SOURCE_AWS2DDBSTREAM_COMPONENT_STREAM_ITERATOR_TYPE_DOC = "Defines where in the DynamoDB stream to start getting records. Note that using FROM_START can cause a significant delay before the stream has caught up to real-time. One of: [FROM_LATEST] [FROM_START]";
    public static final String CAMEL_SOURCE_AWS2DDBSTREAM_COMPONENT_STREAM_ITERATOR_TYPE_DEFAULT = "FROM_LATEST";
    ...
    public static final String CAMEL_SOURCE_AWS2DDBSTREAM_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_CONF = "camel.component.aws2-ddbstream.useDefaultCredentialsProvider";
    public static final String CAMEL_SOURCE_AWS2DDBSTREAM_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_DOC = "Set whether the DynamoDB Streams client should expect to load credentials through a default credentials provider or to expect static credentials to be passed in.";
    public static final Boolean CAMEL_SOURCE_AWS2DDBSTREAM_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_AWS2DDBSTREAM_ENDPOINT_STREAM_ITERATOR_TYPE_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_AWS2DDBSTREAM_ENDPOINT_STREAM_ITERATOR_TYPE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWS2DDBSTREAM_ENDPOINT_STREAM_ITERATOR_TYPE_DOC);
        ...
        conf.define(CAMEL_SOURCE_AWS2DDBSTREAM_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AWS2DDBSTREAM_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWS2DDBSTREAM_ENDPOINT_USE_DEFAULT_CREDENTIALS_PROVIDER_DOC);
        ...
        conf.define(CAMEL_SOURCE_AWS2DDBSTREAM_COMPONENT_STREAM_ITERATOR_TYPE_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_AWS2DDBSTREAM_COMPONENT_STREAM_ITERATOR_TYPE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWS2DDBSTREAM_COMPONENT_STREAM_ITERATOR_TYPE_DOC);
        ...
        conf.define(CAMEL_SOURCE_AWS2DDBSTREAM_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AWS2DDBSTREAM_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWS2DDBSTREAM_COMPONENT_USE_DEFAULT_CREDENTIALS_PROVIDER_DOC);
