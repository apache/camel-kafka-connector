...
public class CamelAws2cwSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_AWS2CW_COMPONENT_REGION_DOC = "The region in which CW client needs to work";
    ...
    public static final String CAMEL_SINK_AWS2CW_COMPONENT_CONFIGURATION_DOC = "The AWS CW default configuration";
