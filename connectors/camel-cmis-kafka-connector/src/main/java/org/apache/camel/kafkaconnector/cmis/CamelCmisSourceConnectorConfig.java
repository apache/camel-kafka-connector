...
public class CamelCmisSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_CMIS_PATH_CMS_URL_DOC = "URL to the cmis repository";
    private static final String CAMEL_SOURCE_CMIS_PATH_CMS_URL_DEFAULT = null;
    public static final String CAMEL_SOURCE_CMIS_ENDPOINT_PAGE_SIZE_CONF = "camel.source.endpoint.pageSize";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_PAGE_SIZE_DOC = "Number of nodes to retrieve per page";
    private static final Integer CAMEL_SOURCE_CMIS_ENDPOINT_PAGE_SIZE_DEFAULT = 100;
    public static final String CAMEL_SOURCE_CMIS_ENDPOINT_READ_CONTENT_CONF = "camel.source.endpoint.readContent";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_READ_CONTENT_DOC = "If set to true, the content of document node will be retrieved in addition to the properties";
    private static final Boolean CAMEL_SOURCE_CMIS_ENDPOINT_READ_CONTENT_DEFAULT = false;
    public static final String CAMEL_SOURCE_CMIS_ENDPOINT_READ_COUNT_CONF = "camel.source.endpoint.readCount";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_READ_COUNT_DOC = "Max number of nodes to read";
    private static final Integer CAMEL_SOURCE_CMIS_ENDPOINT_READ_COUNT_DEFAULT = null;
    public static final String CAMEL_SOURCE_CMIS_ENDPOINT_REPOSITORY_ID_CONF = "camel.source.endpoint.repositoryId";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_REPOSITORY_ID_DOC = "The Id of the repository to use. If not specified the first available repository is used";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_REPOSITORY_ID_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_CMIS_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_CMIS_ENDPOINT_QUERY_CONF = "camel.source.endpoint.query";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_QUERY_DOC = "The cmis query to execute against the repository. If not specified, the consumer will retrieve every node from the content repository by iterating the content tree recursively";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_QUERY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_CMIS_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    public static final String CAMEL_SOURCE_CMIS_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.source.endpoint.basicPropertyBinding";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_CMIS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_SESSION_FACADE_FACTORY_DOC = "To use a custom CMISSessionFacadeFactory to create the CMISSessionFacade instances";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_SESSION_FACADE_FACTORY_DEFAULT = null;
    public static final String CAMEL_SOURCE_CMIS_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_CMIS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_CMIS_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_PASSWORD_DOC = "Password for the cmis repository";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_CMIS_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_USERNAME_DOC = "Username for the cmis repository";
    private static final String CAMEL_SOURCE_CMIS_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CMIS_COMPONENT_SESSION_FACADE_FACTORY_DOC = "To use a custom CMISSessionFacadeFactory to create the CMISSessionFacade instances";
    private static final String CAMEL_SOURCE_CMIS_COMPONENT_SESSION_FACADE_FACTORY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_CMIS_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_CMIS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_CMIS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_CMIS_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_CMIS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_CMIS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
