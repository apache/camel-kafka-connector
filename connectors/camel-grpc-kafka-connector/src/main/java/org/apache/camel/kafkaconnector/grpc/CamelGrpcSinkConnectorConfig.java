...
public class CamelGrpcSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_GRPC_PATH_HOST_DOC = "The gRPC server host name. This is localhost or 0.0.0.0 when being a consumer or remote server host name when using producer.";
    private static final String CAMEL_SINK_GRPC_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_GRPC_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_GRPC_PATH_PORT_DOC = "The gRPC local or remote server port";
    private static final Integer CAMEL_SINK_GRPC_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_GRPC_PATH_SERVICE_CONF = "camel.sink.path.service";
    private static final String CAMEL_SINK_GRPC_PATH_SERVICE_DOC = "Fully qualified service name from the protocol buffer descriptor file (package dot service definition name)";
    private static final String CAMEL_SINK_GRPC_PATH_SERVICE_DEFAULT = null;
    public static final String CAMEL_SINK_GRPC_ENDPOINT_FLOW_CONTROL_WINDOW_CONF = "camel.sink.endpoint.flowControlWindow";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_FLOW_CONTROL_WINDOW_DOC = "The HTTP/2 flow control window size (MiB)";
    private static final Integer CAMEL_SINK_GRPC_ENDPOINT_FLOW_CONTROL_WINDOW_DEFAULT = 1048576;
    public static final String CAMEL_SINK_GRPC_ENDPOINT_MAX_MESSAGE_SIZE_CONF = "camel.sink.endpoint.maxMessageSize";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_MAX_MESSAGE_SIZE_DOC = "The maximum message size allowed to be received/sent (MiB)";
    private static final Integer CAMEL_SINK_GRPC_ENDPOINT_MAX_MESSAGE_SIZE_DEFAULT = 4194304;
    ...
    private static final Boolean CAMEL_SINK_GRPC_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_GRPC_ENDPOINT_METHOD_CONF = "camel.sink.endpoint.method";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_METHOD_DOC = "gRPC method name";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_METHOD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_GRPC_ENDPOINT_PRODUCER_STRATEGY_DEFAULT = "SIMPLE";
    public static final String CAMEL_SINK_GRPC_ENDPOINT_STREAM_REPLIES_TO_CONF = "camel.sink.endpoint.streamRepliesTo";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_STREAM_REPLIES_TO_DOC = "When using STREAMING client mode, it indicates the endpoint where responses should be forwarded.";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_STREAM_REPLIES_TO_DEFAULT = null;
    public static final String CAMEL_SINK_GRPC_ENDPOINT_USER_AGENT_CONF = "camel.sink.endpoint.userAgent";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_USER_AGENT_DOC = "The user agent header passed to the server";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_USER_AGENT_DEFAULT = null;
    public static final String CAMEL_SINK_GRPC_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GRPC_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_GRPC_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_GRPC_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_GRPC_ENDPOINT_AUTHENTICATION_TYPE_CONF = "camel.sink.endpoint.authenticationType";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_AUTHENTICATION_TYPE_DOC = "Authentication method type in advance to the SSL/TLS negotiation One of: [NONE] [GOOGLE] [JWT]";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_AUTHENTICATION_TYPE_DEFAULT = "NONE";
    public static final String CAMEL_SINK_GRPC_ENDPOINT_JWT_ALGORITHM_CONF = "camel.sink.endpoint.jwtAlgorithm";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_JWT_ALGORITHM_DOC = "JSON Web Token sign algorithm One of: [HMAC256] [HMAC384] [HMAC512]";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_JWT_ALGORITHM_DEFAULT = "HMAC256";
    public static final String CAMEL_SINK_GRPC_ENDPOINT_JWT_ISSUER_CONF = "camel.sink.endpoint.jwtIssuer";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_JWT_ISSUER_DOC = "JSON Web Token issuer";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_JWT_ISSUER_DEFAULT = null;
    public static final String CAMEL_SINK_GRPC_ENDPOINT_JWT_SECRET_CONF = "camel.sink.endpoint.jwtSecret";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_JWT_SECRET_DOC = "JSON Web Token secret";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_JWT_SECRET_DEFAULT = null;
    public static final String CAMEL_SINK_GRPC_ENDPOINT_JWT_SUBJECT_CONF = "camel.sink.endpoint.jwtSubject";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_JWT_SUBJECT_DOC = "JSON Web Token subject";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_JWT_SUBJECT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_GRPC_ENDPOINT_KEY_CERT_CHAIN_RESOURCE_DOC = "The X.509 certificate chain file resource in PEM format link";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_KEY_CERT_CHAIN_RESOURCE_DEFAULT = null;
    public static final String CAMEL_SINK_GRPC_ENDPOINT_KEY_PASSWORD_CONF = "camel.sink.endpoint.keyPassword";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_KEY_PASSWORD_DOC = "The PKCS#8 private key file password";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_KEY_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_GRPC_ENDPOINT_KEY_RESOURCE_CONF = "camel.sink.endpoint.keyResource";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_KEY_RESOURCE_DOC = "The PKCS#8 private key file resource in PEM format link";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_KEY_RESOURCE_DEFAULT = null;
    public static final String CAMEL_SINK_GRPC_ENDPOINT_NEGOTIATION_TYPE_CONF = "camel.sink.endpoint.negotiationType";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_NEGOTIATION_TYPE_DOC = "Identifies the security negotiation type used for HTTP/2 communication One of: [TLS] [PLAINTEXT_UPGRADE] [PLAINTEXT]";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_NEGOTIATION_TYPE_DEFAULT = "PLAINTEXT";
    ...
    private static final String CAMEL_SINK_GRPC_ENDPOINT_SERVICE_ACCOUNT_RESOURCE_DOC = "Service Account key file in JSON format resource link supported by the Google Cloud SDK";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_SERVICE_ACCOUNT_RESOURCE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_GRPC_ENDPOINT_TRUST_CERT_COLLECTION_RESOURCE_DOC = "The trusted certificates collection file resource in PEM format for verifying the remote endpoint's certificate";
    private static final String CAMEL_SINK_GRPC_ENDPOINT_TRUST_CERT_COLLECTION_RESOURCE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_GRPC_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_GRPC_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GRPC_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
