...
public class CamelSjmsbatchSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_PATH_DESTINATION_NAME_DOC = "The destination name. Only queues are supported, names may be prefixed by 'queue:'.";
    private static final String CAMEL_SOURCE_SJMSBATCH_PATH_DESTINATION_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_AGGREGATION_STRATEGY_DOC = "The aggregation strategy to use, which merges all the batched messages into a single message";
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_AGGREGATION_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_ALLOW_NULL_BODY_CONF = "camel.source.endpoint.allowNullBody";
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_ALLOW_NULL_BODY_DOC = "Whether to allow sending messages with no body. If this option is false and the message body is null, then an JMSException is thrown.";
    private static final Boolean CAMEL_SOURCE_SJMSBATCH_ENDPOINT_ALLOW_NULL_BODY_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_SJMSBATCH_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final Integer CAMEL_SOURCE_SJMSBATCH_ENDPOINT_COMPLETION_INTERVAL_DEFAULT = 1000;
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_COMPLETION_PREDICATE_DEFAULT = null;
    public static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_COMPLETION_SIZE_CONF = "camel.source.endpoint.completionSize";
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_COMPLETION_SIZE_DOC = "The number of messages consumed at which the batch will be completed";
    private static final Integer CAMEL_SOURCE_SJMSBATCH_ENDPOINT_COMPLETION_SIZE_DEFAULT = 200;
    ...
    private static final Integer CAMEL_SOURCE_SJMSBATCH_ENDPOINT_COMPLETION_TIMEOUT_DEFAULT = 500;
    public static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_CONSUMER_COUNT_CONF = "camel.source.endpoint.consumerCount";
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_CONSUMER_COUNT_DOC = "The number of JMS sessions to consume from";
    private static final Integer CAMEL_SOURCE_SJMSBATCH_ENDPOINT_CONSUMER_COUNT_DEFAULT = 1;
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_EAGER_CHECK_COMPLETION_DOC = "Use eager completion checking which means that the completionPredicate will use the incoming Exchange. As opposed to without eager completion checking the completionPredicate will use the aggregated Exchange.";
    private static final Boolean CAMEL_SOURCE_SJMSBATCH_ENDPOINT_EAGER_CHECK_COMPLETION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_SJMSBATCH_ENDPOINT_INCLUDE_ALL_JMSXPROPERTIES_DEFAULT = false;
    public static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_MAP_JMS_MESSAGE_CONF = "camel.source.endpoint.mapJmsMessage";
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_MAP_JMS_MESSAGE_DOC = "Specifies whether Camel should auto map the received JMS message to a suited payload type, such as javax.jms.TextMessage to a String etc. See section about how mapping works below for more details.";
    private static final Boolean CAMEL_SOURCE_SJMSBATCH_ENDPOINT_MAP_JMS_MESSAGE_DEFAULT = true;
    public static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_POLL_DURATION_CONF = "camel.source.endpoint.pollDuration";
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_POLL_DURATION_DOC = "The duration in milliseconds of each poll for messages. completionTimeOut will be used if it is shorter and a batch has started.";
    private static final Integer CAMEL_SOURCE_SJMSBATCH_ENDPOINT_POLL_DURATION_DEFAULT = 1000;
    ...
    private static final Boolean CAMEL_SOURCE_SJMSBATCH_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_SJMSBATCH_ENDPOINT_ASYNC_START_LISTENER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SJMSBATCH_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_JMS_KEY_FORMAT_STRATEGY_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_SJMSBATCH_ENDPOINT_KEEP_ALIVE_DELAY_DEFAULT = -1;
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_MESSAGE_CREATED_STRATEGY_DOC = "To use the given MessageCreatedStrategy which are invoked when Camel creates new instances of javax.jms.Message objects when Camel is sending a JMS message.";
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_MESSAGE_CREATED_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_RECOVERY_INTERVAL_CONF = "camel.source.endpoint.recoveryInterval";
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_RECOVERY_INTERVAL_DOC = "Specifies the interval between recovery attempts, i.e. when a connection is being refreshed, in milliseconds. The default is 5000 ms, that is, 5 seconds.";
    private static final Integer CAMEL_SOURCE_SJMSBATCH_ENDPOINT_RECOVERY_INTERVAL_DEFAULT = 5000;
    public static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_SJMSBATCH_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_ENDPOINT_TIMEOUT_CHECKER_EXECUTOR_SERVICE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_SJMSBATCH_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_SJMSBATCH_COMPONENT_ASYNC_START_LISTENER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SJMSBATCH_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_COMPONENT_CONNECTION_FACTORY_DOC = "A ConnectionFactory is required to enable the SjmsBatchComponent.";
    private static final String CAMEL_SOURCE_SJMSBATCH_COMPONENT_CONNECTION_FACTORY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_COMPONENT_RECOVERY_INTERVAL_DOC = "Specifies the interval between recovery attempts, i.e. when a connection is being refreshed, in milliseconds. The default is 5000 ms, that is, 5 seconds.";
    private static final Integer CAMEL_SOURCE_SJMSBATCH_COMPONENT_RECOVERY_INTERVAL_DEFAULT = 5000;
    ...
    private static final String CAMEL_SOURCE_SJMSBATCH_COMPONENT_HEADER_FILTER_STRATEGY_DOC = "To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_SJMSBATCH_COMPONENT_HEADER_FILTER_STRATEGY_DEFAULT = null;
