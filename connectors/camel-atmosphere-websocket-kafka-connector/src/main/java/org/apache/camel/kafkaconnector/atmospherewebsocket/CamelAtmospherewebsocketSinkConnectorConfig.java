...
public class CamelAtmospherewebsocketSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_PATH_SERVICE_PATH_DOC = "Name of websocket endpoint";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_PATH_SERVICE_PATH_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_CHUNKED_CONF = "camel.sink.endpoint.chunked";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_CHUNKED_DOC = "If this option is false the Servlet will disable the HTTP streaming and set the content-length header on the response";
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_CHUNKED_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_DISABLE_STREAM_CACHE_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_SEND_TO_ALL_CONF = "camel.sink.endpoint.sendToAll";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_SEND_TO_ALL_DOC = "Whether to send to all (broadcast) or send to a single receiver.";
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_SEND_TO_ALL_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_TRANSFER_EXCEPTION_DEFAULT = false;
    public static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_USE_STREAMING_CONF = "camel.sink.endpoint.useStreaming";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_USE_STREAMING_DOC = "To enable streaming to send data as multiple text fragments.";
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_USE_STREAMING_DEFAULT = false;
    public static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_HTTP_BINDING_CONF = "camel.sink.endpoint.httpBinding";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_HTTP_BINDING_DOC = "To use a custom HttpBinding to control the mapping between Camel message and HttpClient.";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_HTTP_BINDING_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_BRIDGE_ENDPOINT_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_CONNECTION_CLOSE_DOC = "Specifies whether a Connection Close header must be added to HTTP Request. By default connectionClose is false.";
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_CONNECTION_CLOSE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_COPY_HEADERS_DEFAULT = true;
    public static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_HTTP_METHOD_CONF = "camel.sink.endpoint.httpMethod";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_HTTP_METHOD_DOC = "Configure the HTTP method to use. The HttpMethod header cannot override this option if set. One of: [GET] [POST] [PUT] [DELETE] [HEAD] [OPTIONS] [TRACE] [PATCH]";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_HTTP_METHOD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_IGNORE_RESPONSE_BODY_DOC = "If this option is true, The http producer won't read response body and cache the input stream";
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_IGNORE_RESPONSE_BODY_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_PRESERVE_HOST_HEADER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_THROW_EXCEPTION_ON_FAILURE_DOC = "Option to disable throwing the HttpOperationFailedException in case of failed responses from the remote server. This allows you to get all responses regardless of the HTTP status code.";
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_THROW_EXCEPTION_ON_FAILURE_DEFAULT = true;
    public static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_COOKIE_HANDLER_CONF = "camel.sink.endpoint.cookieHandler";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_COOKIE_HANDLER_DOC = "Configure a cookie handler to maintain a HTTP session";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_COOKIE_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_OK_STATUS_CODE_RANGE_DEFAULT = "200-299";
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_MAP_HTTP_MESSAGE_BODY_DOC = "If this option is true then IN exchange Body of the exchange will be mapped to HTTP body. Setting this to false will avoid the HTTP mapping.";
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_MAP_HTTP_MESSAGE_BODY_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_MAP_HTTP_MESSAGE_FORM_URL_ENCODED_BODY_DOC = "If this option is true then IN exchange Form Encoded body of the exchange will be mapped to HTTP. Setting this to false will avoid the HTTP Form Encoded body mapping.";
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_MAP_HTTP_MESSAGE_FORM_URL_ENCODED_BODY_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_MAP_HTTP_MESSAGE_HEADERS_DOC = "If this option is true then IN exchange Headers of the exchange will be mapped to HTTP headers. Setting this to false will avoid the HTTP Headers mapping.";
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_MAP_HTTP_MESSAGE_HEADERS_DEFAULT = true;
    public static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_PROXY_AUTH_SCHEME_DOC = "Proxy authentication scheme to use One of: [http] [https]";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_PROXY_AUTH_SCHEME_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_PROXY_HOST_CONF = "camel.sink.endpoint.proxyHost";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_PROXY_HOST_DOC = "Proxy hostname to use";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_PROXY_PORT_CONF = "camel.sink.endpoint.proxyPort";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_PROXY_PORT_DOC = "Proxy port to use";
    private static final Integer CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_AUTH_HOST_CONF = "camel.sink.endpoint.authHost";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_AUTH_HOST_DOC = "Authentication host to use with NTML";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_ENDPOINT_AUTH_HOST_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_COMPONENT_ALLOW_JAVA_SERIALIZED_OBJECT_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_ATMOSPHEREWEBSOCKET_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_COMPONENT_HTTP_BINDING_DOC = "To use a custom HttpBinding to control the mapping between Camel message and HttpClient.";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_COMPONENT_HTTP_BINDING_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_COMPONENT_HTTP_CONFIGURATION_DOC = "To use the shared HttpConfiguration as base configuration.";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_COMPONENT_HTTP_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_COMPONENT_HEADER_FILTER_STRATEGY_DOC = "To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SINK_ATMOSPHEREWEBSOCKET_COMPONENT_HEADER_FILTER_STRATEGY_DEFAULT = null;
