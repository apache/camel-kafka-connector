...
public class CamelAwskinesissourceSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_CONF = "camel.kamelet.aws-kinesis-source.useProfileCredentialsProvider";
    public static final String CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DOC = "Set whether the Kinesis client should expect to load credentials through a profile credentials provider.";
    public static final Boolean CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DEFAULT = false;
    public static final String CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_SESSION_CREDENTIALS_CONF = "camel.kamelet.aws-kinesis-source.useSessionCredentials";
    ...
    public static final String CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_SESSION_TOKEN_DEFAULT = null;
    ...
    public static final Boolean CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_KCL_CONSUMERS_DEFAULT = false;
    public static final String CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_KCL_DISABLE_CLOUDWATCH_METRICS_EXPORT_CONF = "camel.kamelet.aws-kinesis-source.kclDisableCloudwatchMetricsExport";
    public static final String CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_KCL_DISABLE_CLOUDWATCH_METRICS_EXPORT_DOC = "Define if we want to use a KCL Consumer and disable the CloudWatch Metrics Export";
    public static final Boolean CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_KCL_DISABLE_CLOUDWATCH_METRICS_EXPORT_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DOC);
        conf.define(CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_SESSION_CREDENTIALS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_SESSION_CREDENTIALS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_SESSION_CREDENTIALS_DOC);
        conf.define(CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_PROFILE_CREDENTIALS_NAME_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_PROFILE_CREDENTIALS_NAME_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_PROFILE_CREDENTIALS_NAME_DOC);
        conf.define(CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_SESSION_TOKEN_CONF, ConfigDef.Type.PASSWORD, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_SESSION_TOKEN_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_SESSION_TOKEN_DOC);
        ...
        conf.define(CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_ASYNC_CLIENT_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_ASYNC_CLIENT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_ASYNC_CLIENT_DOC);
        conf.define(CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_KCL_CONSUMERS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_KCL_CONSUMERS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_USE_KCL_CONSUMERS_DOC);
        conf.define(CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_KCL_DISABLE_CLOUDWATCH_METRICS_EXPORT_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_KCL_DISABLE_CLOUDWATCH_METRICS_EXPORT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_AWSKINESISSOURCE_KAMELET_KCL_DISABLE_CLOUDWATCH_METRICS_EXPORT_DOC);
        return conf;
    }
}