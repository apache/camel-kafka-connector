...
public class CamelAws2lambdaSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_AWS2LAMBDA_PATH_FUNCTION_DOC = "Name of the Lambda function.";
    private static final String CAMEL_SINK_AWS2LAMBDA_PATH_FUNCTION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_AWS2LAMBDA_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_OPERATION_DEFAULT = "invokeFunction";
    public static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_POJO_REQUEST_CONF = "camel.sink.endpoint.pojoRequest";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_POJO_REQUEST_DOC = "If we want to use a POJO request as body or not";
    private static final Boolean CAMEL_SINK_AWS2LAMBDA_ENDPOINT_POJO_REQUEST_DEFAULT = false;
    public static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_REGION_CONF = "camel.sink.endpoint.region";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_REGION_DOC = "The region in which ECS client needs to work. When using this parameter, the configuration will expect the lowercase name of the region (for example ap-east-1) You'll need to use the name Region.EU_WEST_1.id()";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_REGION_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_AWS_LAMBDA_CLIENT_CONF = "camel.sink.endpoint.awsLambdaClient";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_AWS_LAMBDA_CLIENT_DOC = "To use a existing configured AwsLambdaClient as client";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_AWS_LAMBDA_CLIENT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AWS2LAMBDA_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_AWS2LAMBDA_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_PROXY_HOST_CONF = "camel.sink.endpoint.proxyHost";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_PROXY_HOST_DOC = "To define a proxy host when instantiating the Lambda client";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_PROXY_PORT_CONF = "camel.sink.endpoint.proxyPort";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_PROXY_PORT_DOC = "To define a proxy port when instantiating the Lambda client";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_PROXY_PROTOCOL_CONF = "camel.sink.endpoint.proxyProtocol";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_PROXY_PROTOCOL_DOC = "To define a proxy protocol when instantiating the Lambda client One of: [HTTP] [HTTPS]";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_PROXY_PROTOCOL_DEFAULT = "HTTPS";
    public static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_ACCESS_KEY_CONF = "camel.sink.endpoint.accessKey";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_ACCESS_KEY_DOC = "Amazon AWS Access Key";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_ACCESS_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_SECRET_KEY_CONF = "camel.sink.endpoint.secretKey";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_SECRET_KEY_DOC = "Amazon AWS Secret Key";
    private static final String CAMEL_SINK_AWS2LAMBDA_ENDPOINT_SECRET_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_CONFIGURATION_CONF = "camel.component.aws2-lambda.configuration";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_CONFIGURATION_DOC = "Component configuration";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_AWS2LAMBDA_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_OPERATION_DEFAULT = "invokeFunction";
    public static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_POJO_REQUEST_CONF = "camel.component.aws2-lambda.pojoRequest";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_POJO_REQUEST_DOC = "If we want to use a POJO request as body or not";
    private static final Boolean CAMEL_SINK_AWS2LAMBDA_COMPONENT_POJO_REQUEST_DEFAULT = false;
    public static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_REGION_CONF = "camel.component.aws2-lambda.region";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_REGION_DOC = "The region in which ECS client needs to work. When using this parameter, the configuration will expect the lowercase name of the region (for example ap-east-1) You'll need to use the name Region.EU_WEST_1.id()";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_REGION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_AWS_LAMBDA_CLIENT_DOC = "To use a existing configured AwsLambdaClient as client";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_AWS_LAMBDA_CLIENT_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_AWS2LAMBDA_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_PROXY_HOST_CONF = "camel.component.aws2-lambda.proxyHost";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_PROXY_HOST_DOC = "To define a proxy host when instantiating the Lambda client";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_PROXY_PORT_CONF = "camel.component.aws2-lambda.proxyPort";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_PROXY_PORT_DOC = "To define a proxy port when instantiating the Lambda client";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_PROXY_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_PROXY_PROTOCOL_CONF = "camel.component.aws2-lambda.proxyProtocol";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_PROXY_PROTOCOL_DOC = "To define a proxy protocol when instantiating the Lambda client One of: [HTTP] [HTTPS]";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_PROXY_PROTOCOL_DEFAULT = "HTTPS";
    public static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_ACCESS_KEY_CONF = "camel.component.aws2-lambda.accessKey";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_ACCESS_KEY_DOC = "Amazon AWS Access Key";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_ACCESS_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_SECRET_KEY_CONF = "camel.component.aws2-lambda.secretKey";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_SECRET_KEY_DOC = "Amazon AWS Secret Key";
    private static final String CAMEL_SINK_AWS2LAMBDA_COMPONENT_SECRET_KEY_DEFAULT = null;
