...
public class CamelCaffeinecacheSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_PATH_CACHE_NAME_DOC = "the cache name";
    private static final String CAMEL_SINK_CAFFEINECACHE_PATH_CACHE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_ACTION_CONF = "camel.sink.endpoint.action";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_ACTION_DOC = "To configure the default cache action. If an action is set in the message header, then the operation from the header takes precedence.";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_ACTION_DEFAULT = null;
    public static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_CACHE_CONF = "camel.sink.endpoint.cache";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_CACHE_DOC = "To configure an already instantiated cache to be used";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_CACHE_DEFAULT = null;
    public static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_CACHE_LOADER_CONF = "camel.sink.endpoint.cacheLoader";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_CACHE_LOADER_DOC = "To configure a CacheLoader in case of a LoadCache use";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_CACHE_LOADER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_CREATE_CACHE_IF_NOT_EXIST_DOC = "Configure if a cache need to be created if it does exist or can't be pre-configured.";
    private static final Boolean CAMEL_SINK_CAFFEINECACHE_ENDPOINT_CREATE_CACHE_IF_NOT_EXIST_DEFAULT = true;
    public static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_EVICTION_TYPE_CONF = "camel.sink.endpoint.evictionType";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_EVICTION_TYPE_DOC = "Set the eviction Type for this cache One of: [size_based] [time_based]";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_EVICTION_TYPE_DEFAULT = "SIZE_BASED";
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_EXPIRE_AFTER_ACCESS_TIME_DOC = "Set the expire After Access Time in case of time based Eviction (in seconds)";
    private static final Integer CAMEL_SINK_CAFFEINECACHE_ENDPOINT_EXPIRE_AFTER_ACCESS_TIME_DEFAULT = 300;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_EXPIRE_AFTER_WRITE_TIME_DOC = "Set the expire After Access Write in case of time based Eviction (in seconds)";
    private static final Integer CAMEL_SINK_CAFFEINECACHE_ENDPOINT_EXPIRE_AFTER_WRITE_TIME_DEFAULT = 300;
    public static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_INITIAL_CAPACITY_CONF = "camel.sink.endpoint.initialCapacity";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_INITIAL_CAPACITY_DOC = "Set the initial Capacity for the cache";
    private static final Integer CAMEL_SINK_CAFFEINECACHE_ENDPOINT_INITIAL_CAPACITY_DEFAULT = 10000;
    public static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_KEY_CONF = "camel.sink.endpoint.key";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_KEY_DOC = "To configure the default action key. If a key is set in the message header, then the key from the header takes precedence.";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_KEY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_CAFFEINECACHE_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_MAXIMUM_SIZE_CONF = "camel.sink.endpoint.maximumSize";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_MAXIMUM_SIZE_DOC = "Set the maximum size for the cache";
    private static final Integer CAMEL_SINK_CAFFEINECACHE_ENDPOINT_MAXIMUM_SIZE_DEFAULT = 10000;
    public static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_REMOVAL_LISTENER_CONF = "camel.sink.endpoint.removalListener";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_REMOVAL_LISTENER_DOC = "Set a specific removal Listener for the cache";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_REMOVAL_LISTENER_DEFAULT = null;
    public static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_STATS_COUNTER_CONF = "camel.sink.endpoint.statsCounter";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_STATS_COUNTER_DOC = "Set a specific Stats Counter for the cache stats";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_STATS_COUNTER_DEFAULT = null;
    public static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_STATS_ENABLED_CONF = "camel.sink.endpoint.statsEnabled";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_STATS_ENABLED_DOC = "To enable stats on the cache";
    private static final Boolean CAMEL_SINK_CAFFEINECACHE_ENDPOINT_STATS_ENABLED_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CAFFEINECACHE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_KEY_TYPE_CONF = "camel.sink.endpoint.keyType";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_KEY_TYPE_DOC = "The cache key type, default java.lang.Object";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_KEY_TYPE_DEFAULT = null;
    public static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_CAFFEINECACHE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_VALUE_TYPE_CONF = "camel.sink.endpoint.valueType";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_VALUE_TYPE_DOC = "The cache value type, default java.lang.Object";
    private static final String CAMEL_SINK_CAFFEINECACHE_ENDPOINT_VALUE_TYPE_DEFAULT = null;
    public static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_ACTION_CONF = "camel.component.caffeine-cache.action";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_ACTION_DOC = "To configure the default cache action. If an action is set in the message header, then the operation from the header takes precedence.";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_ACTION_DEFAULT = null;
    public static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_CACHE_CONF = "camel.component.caffeine-cache.cache";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_CACHE_DOC = "To configure an already instantiated cache to be used";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_CACHE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_CACHE_LOADER_DOC = "To configure a CacheLoader in case of a LoadCache use";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_CACHE_LOADER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_CREATE_CACHE_IF_NOT_EXIST_DOC = "Configure if a cache need to be created if it does exist or can't be pre-configured.";
    private static final Boolean CAMEL_SINK_CAFFEINECACHE_COMPONENT_CREATE_CACHE_IF_NOT_EXIST_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_EVICTION_TYPE_DOC = "Set the eviction Type for this cache One of: [size_based] [time_based]";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_EVICTION_TYPE_DEFAULT = "SIZE_BASED";
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_EXPIRE_AFTER_ACCESS_TIME_DOC = "Set the expire After Access Time in case of time based Eviction (in seconds)";
    private static final Integer CAMEL_SINK_CAFFEINECACHE_COMPONENT_EXPIRE_AFTER_ACCESS_TIME_DEFAULT = 300;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_EXPIRE_AFTER_WRITE_TIME_DOC = "Set the expire After Access Write in case of time based Eviction (in seconds)";
    private static final Integer CAMEL_SINK_CAFFEINECACHE_COMPONENT_EXPIRE_AFTER_WRITE_TIME_DEFAULT = 300;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_INITIAL_CAPACITY_DOC = "Set the initial Capacity for the cache";
    private static final Integer CAMEL_SINK_CAFFEINECACHE_COMPONENT_INITIAL_CAPACITY_DEFAULT = 10000;
    public static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_KEY_CONF = "camel.component.caffeine-cache.key";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_KEY_DOC = "To configure the default action key. If a key is set in the message header, then the key from the header takes precedence.";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_KEY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_CAFFEINECACHE_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_MAXIMUM_SIZE_DOC = "Set the maximum size for the cache";
    private static final Integer CAMEL_SINK_CAFFEINECACHE_COMPONENT_MAXIMUM_SIZE_DEFAULT = 10000;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_REMOVAL_LISTENER_DOC = "Set a specific removal Listener for the cache";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_REMOVAL_LISTENER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_STATS_COUNTER_DOC = "Set a specific Stats Counter for the cache stats";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_STATS_COUNTER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_STATS_ENABLED_DOC = "To enable stats on the cache";
    private static final Boolean CAMEL_SINK_CAFFEINECACHE_COMPONENT_STATS_ENABLED_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CAFFEINECACHE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_CONFIGURATION_DOC = "Sets the global component configuration";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_KEY_TYPE_CONF = "camel.component.caffeine-cache.keyType";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_KEY_TYPE_DOC = "The cache key type, default java.lang.Object";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_KEY_TYPE_DEFAULT = null;
    public static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_VALUE_TYPE_CONF = "camel.component.caffeine-cache.valueType";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_VALUE_TYPE_DOC = "The cache value type, default java.lang.Object";
    private static final String CAMEL_SINK_CAFFEINECACHE_COMPONENT_VALUE_TYPE_DEFAULT = null;
