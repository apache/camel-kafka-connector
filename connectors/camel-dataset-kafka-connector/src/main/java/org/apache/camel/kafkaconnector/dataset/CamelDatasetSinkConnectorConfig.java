...
public class CamelDatasetSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_DATASET_PATH_NAME_DOC = "Name of DataSet to lookup in the registry";
    public static final String CAMEL_SINK_DATASET_PATH_NAME_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_DATASET_ENDPOINT_DATA_SET_INDEX_DEFAULT = "lenient";
    ...
    public static final Long CAMEL_SINK_DATASET_ENDPOINT_ASSERT_PERIOD_DEFAULT = 0L;
    public static final String CAMEL_SINK_DATASET_ENDPOINT_CONSUME_DELAY_CONF = "camel.sink.endpoint.consumeDelay";
    public static final String CAMEL_SINK_DATASET_ENDPOINT_CONSUME_DELAY_DOC = "Allows a delay to be specified which causes a delay when a message is consumed by the producer (to simulate slow processing)";
    public static final Long CAMEL_SINK_DATASET_ENDPOINT_CONSUME_DELAY_DEFAULT = 0L;
    ...
    public static final Integer CAMEL_SINK_DATASET_ENDPOINT_EXPECTED_COUNT_DEFAULT = -1;
    ...
    public static final Boolean CAMEL_SINK_DATASET_ENDPOINT_FAIL_FAST_DEFAULT = false;
    ...
    public static final Boolean CAMEL_SINK_DATASET_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_DATASET_ENDPOINT_REPORT_GROUP_CONF = "camel.sink.endpoint.reportGroup";
    public static final String CAMEL_SINK_DATASET_ENDPOINT_REPORT_GROUP_DOC = "A number that is used to turn on throughput logging based on groups of the size.";
    public static final Integer CAMEL_SINK_DATASET_ENDPOINT_REPORT_GROUP_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_DATASET_ENDPOINT_RESULT_MINIMUM_WAIT_TIME_DOC = "Sets the minimum expected amount of time (in millis) the assertIsSatisfied() will wait on a latch until it is satisfied";
    public static final Long CAMEL_SINK_DATASET_ENDPOINT_RESULT_MINIMUM_WAIT_TIME_DEFAULT = 0L;
    public static final String CAMEL_SINK_DATASET_ENDPOINT_RESULT_WAIT_TIME_CONF = "camel.sink.endpoint.resultWaitTime";
    public static final String CAMEL_SINK_DATASET_ENDPOINT_RESULT_WAIT_TIME_DOC = "Sets the maximum amount of time (in millis) the assertIsSatisfied() will wait on a latch until it is satisfied";
    public static final Long CAMEL_SINK_DATASET_ENDPOINT_RESULT_WAIT_TIME_DEFAULT = 0L;
    ...
    public static final Integer CAMEL_SINK_DATASET_ENDPOINT_RETAIN_FIRST_DEFAULT = -1;
    ...
    public static final Integer CAMEL_SINK_DATASET_ENDPOINT_RETAIN_LAST_DEFAULT = -1;
    public static final String CAMEL_SINK_DATASET_ENDPOINT_SLEEP_FOR_EMPTY_TEST_CONF = "camel.sink.endpoint.sleepForEmptyTest";
    public static final String CAMEL_SINK_DATASET_ENDPOINT_SLEEP_FOR_EMPTY_TEST_DOC = "Allows a sleep to be specified to wait to check that this endpoint really is empty when expectedMessageCount(int) is called with zero";
    public static final Long CAMEL_SINK_DATASET_ENDPOINT_SLEEP_FOR_EMPTY_TEST_DEFAULT = 0L;
    public static final String CAMEL_SINK_DATASET_ENDPOINT_COPY_ON_EXCHANGE_CONF = "camel.sink.endpoint.copyOnExchange";
    public static final String CAMEL_SINK_DATASET_ENDPOINT_COPY_ON_EXCHANGE_DOC = "Sets whether to make a deep copy of the incoming Exchange when received at this mock endpoint. Is by default true.";
    public static final Boolean CAMEL_SINK_DATASET_ENDPOINT_COPY_ON_EXCHANGE_DEFAULT = true;
    ...
    public static final String CAMEL_SINK_DATASET_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SINK_DATASET_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_DATASET_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    public static final String CAMEL_SINK_DATASET_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    public static final Boolean CAMEL_SINK_DATASET_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    public static final Boolean CAMEL_SINK_DATASET_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_DATASET_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SINK_DATASET_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_DATASET_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_DATASET_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_DATASET_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
        return conf;
    }
}