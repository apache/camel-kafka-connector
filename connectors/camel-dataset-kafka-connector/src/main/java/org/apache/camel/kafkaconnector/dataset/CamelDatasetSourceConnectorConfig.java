...
public class CamelDatasetSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_DATASET_PATH_NAME_DOC = "Name of DataSet to lookup in the registry";
    private static final String CAMEL_SOURCE_DATASET_PATH_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DATASET_ENDPOINT_DATA_SET_INDEX_DEFAULT = "lenient";
    ...
    private static final Boolean CAMEL_SOURCE_DATASET_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_DATASET_ENDPOINT_INITIAL_DELAY_CONF = "camel.source.endpoint.initialDelay";
    private static final String CAMEL_SOURCE_DATASET_ENDPOINT_INITIAL_DELAY_DOC = "Time period in millis to wait before starting sending messages.";
    private static final Long CAMEL_SOURCE_DATASET_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_DATASET_ENDPOINT_MIN_RATE_CONF = "camel.source.endpoint.minRate";
    private static final String CAMEL_SOURCE_DATASET_ENDPOINT_MIN_RATE_DOC = "Wait until the DataSet contains at least this number of messages";
    private static final Integer CAMEL_SOURCE_DATASET_ENDPOINT_MIN_RATE_DEFAULT = 0;
    public static final String CAMEL_SOURCE_DATASET_ENDPOINT_PRELOAD_SIZE_CONF = "camel.source.endpoint.preloadSize";
    private static final String CAMEL_SOURCE_DATASET_ENDPOINT_PRELOAD_SIZE_DOC = "Sets how many messages should be preloaded (sent) before the route completes its initialization";
    private static final Long CAMEL_SOURCE_DATASET_ENDPOINT_PRELOAD_SIZE_DEFAULT = 0L;
    public static final String CAMEL_SOURCE_DATASET_ENDPOINT_PRODUCE_DELAY_CONF = "camel.source.endpoint.produceDelay";
    private static final String CAMEL_SOURCE_DATASET_ENDPOINT_PRODUCE_DELAY_DOC = "Allows a delay to be specified which causes a delay when a message is sent by the consumer (to simulate slow processing)";
    private static final Long CAMEL_SOURCE_DATASET_ENDPOINT_PRODUCE_DELAY_DEFAULT = 3L;
    ...
    private static final String CAMEL_SOURCE_DATASET_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_DATASET_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_DATASET_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_DATASET_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_DATASET_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_DATASET_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_DATASET_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_DATASET_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_DATASET_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_DATASET_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DATASET_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_DATASET_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
