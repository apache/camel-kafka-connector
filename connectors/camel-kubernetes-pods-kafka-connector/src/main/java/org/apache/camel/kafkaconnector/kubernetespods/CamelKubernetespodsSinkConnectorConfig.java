...
public class CamelKubernetespodsSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_KUBERNETESPODS_PATH_MASTER_URL_DOC = "Kubernetes Master url";
    public static final String CAMEL_SINK_KUBERNETESPODS_PATH_MASTER_URL_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_API_VERSION_CONF = "camel.sink.endpoint.apiVersion";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_API_VERSION_DOC = "The Kubernetes API Version to use";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_API_VERSION_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_DNS_DOMAIN_CONF = "camel.sink.endpoint.dnsDomain";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_DNS_DOMAIN_DOC = "The dns domain, used for ServiceCall EIP";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_DNS_DOMAIN_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_KUBERNETES_CLIENT_DOC = "Default KubernetesClient to use if provided";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_KUBERNETES_CLIENT_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_PORT_NAME_CONF = "camel.sink.endpoint.portName";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_PORT_NAME_DOC = "The port name, used for ServiceCall EIP";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_PORT_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_PORT_PROTOCOL_CONF = "camel.sink.endpoint.portProtocol";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_PORT_PROTOCOL_DOC = "The port protocol, used for ServiceCall EIP";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_PORT_PROTOCOL_DEFAULT = "tcp";
    ...
    public static final Boolean CAMEL_SINK_KUBERNETESPODS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_OPERATION_CONF = "camel.sink.endpoint.operation";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_OPERATION_DOC = "Producer operation to do on Kubernetes";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_OPERATION_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SINK_KUBERNETESPODS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CONNECTION_TIMEOUT_DOC = "Connection timeout in milliseconds to use when making requests to the Kubernetes API server.";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CONNECTION_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    public static final Boolean CAMEL_SINK_KUBERNETESPODS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CA_CERT_DATA_CONF = "camel.sink.endpoint.caCertData";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CA_CERT_DATA_DOC = "The CA Cert Data";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CA_CERT_DATA_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CA_CERT_FILE_CONF = "camel.sink.endpoint.caCertFile";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CA_CERT_FILE_DOC = "The CA Cert File";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CA_CERT_FILE_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_CERT_DATA_CONF = "camel.sink.endpoint.clientCertData";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_CERT_DATA_DOC = "The Client Cert Data";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_CERT_DATA_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_CERT_FILE_CONF = "camel.sink.endpoint.clientCertFile";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_CERT_FILE_DOC = "The Client Cert File";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_CERT_FILE_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_ALGO_CONF = "camel.sink.endpoint.clientKeyAlgo";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_ALGO_DOC = "The Key Algorithm used by the client";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_ALGO_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_DATA_CONF = "camel.sink.endpoint.clientKeyData";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_DATA_DOC = "The Client Key data";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_DATA_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_FILE_CONF = "camel.sink.endpoint.clientKeyFile";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_FILE_DOC = "The Client Key file";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_FILE_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_PASSPHRASE_DOC = "The Client Key Passphrase";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_PASSPHRASE_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_OAUTH_TOKEN_CONF = "camel.sink.endpoint.oauthToken";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_OAUTH_TOKEN_DOC = "The Auth Token";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_OAUTH_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_PASSWORD_DOC = "Password to connect to Kubernetes";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_TRUST_CERTS_CONF = "camel.sink.endpoint.trustCerts";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_TRUST_CERTS_DOC = "Define if the certs we used are trusted anyway or not";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_TRUST_CERTS_DEFAULT = null;
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_USERNAME_DOC = "Username to connect to Kubernetes";
    public static final String CAMEL_SINK_KUBERNETESPODS_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    public static final Boolean CAMEL_SINK_KUBERNETESPODS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_KUBERNETESPODS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SINK_KUBERNETESPODS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_KUBERNETESPODS_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_KUBERNETESPODS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_KUBERNETESPODS_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
        return conf;
    }
}