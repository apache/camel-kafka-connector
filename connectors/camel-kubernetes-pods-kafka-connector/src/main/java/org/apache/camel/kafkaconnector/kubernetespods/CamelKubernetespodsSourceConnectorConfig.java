...
public class CamelKubernetespodsSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_KUBERNETESPODS_PATH_MASTER_URL_DOC = "Kubernetes Master url";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_PATH_MASTER_URL_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_API_VERSION_CONF = "camel.source.endpoint.apiVersion";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_API_VERSION_DOC = "The Kubernetes API Version to use";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_API_VERSION_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_DNS_DOMAIN_CONF = "camel.source.endpoint.dnsDomain";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_DNS_DOMAIN_DOC = "The dns domain, used for ServiceCall EIP";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_DNS_DOMAIN_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_KUBERNETES_CLIENT_DOC = "Default KubernetesClient to use if provided";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_KUBERNETES_CLIENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_PORT_NAME_CONF = "camel.source.endpoint.portName";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_PORT_NAME_DOC = "The port name, used for ServiceCall EIP";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_PORT_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_PORT_PROTOCOL_CONF = "camel.source.endpoint.portProtocol";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_PORT_PROTOCOL_DOC = "The port protocol, used for ServiceCall EIP";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_PORT_PROTOCOL_DEFAULT = "tcp";
    ...
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_LABEL_VALUE_DOC = "The Consumer Label value when watching at some resources";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_LABEL_VALUE_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_NAMESPACE_CONF = "camel.source.endpoint.namespace";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_NAMESPACE_DOC = "The namespace";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_NAMESPACE_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_POOL_SIZE_CONF = "camel.source.endpoint.poolSize";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_POOL_SIZE_DOC = "The Consumer pool size";
    public static final Integer CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_POOL_SIZE_DEFAULT = 1;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_RESOURCE_NAME_CONF = "camel.source.endpoint.resourceName";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_RESOURCE_NAME_DOC = "The Consumer Resource Name we would like to watch";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_RESOURCE_NAME_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CONNECTION_TIMEOUT_DOC = "Connection timeout in milliseconds to use when making requests to the Kubernetes API server.";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CONNECTION_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    public static final Boolean CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CA_CERT_DATA_CONF = "camel.source.endpoint.caCertData";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CA_CERT_DATA_DOC = "The CA Cert Data";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CA_CERT_DATA_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CA_CERT_FILE_CONF = "camel.source.endpoint.caCertFile";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CA_CERT_FILE_DOC = "The CA Cert File";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CA_CERT_FILE_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_CERT_DATA_DOC = "The Client Cert Data";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_CERT_DATA_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_CERT_FILE_DOC = "The Client Cert File";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_CERT_FILE_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_ALGO_CONF = "camel.source.endpoint.clientKeyAlgo";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_ALGO_DOC = "The Key Algorithm used by the client";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_ALGO_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_DATA_CONF = "camel.source.endpoint.clientKeyData";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_DATA_DOC = "The Client Key data";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_DATA_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_FILE_CONF = "camel.source.endpoint.clientKeyFile";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_FILE_DOC = "The Client Key file";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_FILE_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_PASSPHRASE_DOC = "The Client Key Passphrase";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_CLIENT_KEY_PASSPHRASE_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_OAUTH_TOKEN_CONF = "camel.source.endpoint.oauthToken";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_OAUTH_TOKEN_DOC = "The Auth Token";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_OAUTH_TOKEN_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_PASSWORD_DOC = "Password to connect to Kubernetes";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_TRUST_CERTS_CONF = "camel.source.endpoint.trustCerts";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_TRUST_CERTS_DOC = "Define if the certs we used are trusted anyway or not";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_TRUST_CERTS_DEFAULT = null;
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_USERNAME_DOC = "Username to connect to Kubernetes";
    public static final String CAMEL_SOURCE_KUBERNETESPODS_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    public static final Boolean CAMEL_SOURCE_KUBERNETESPODS_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_KUBERNETESPODS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_KUBERNETESPODS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_KUBERNETESPODS_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_KUBERNETESPODS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SOURCE_KUBERNETESPODS_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
        return conf;
    }
}