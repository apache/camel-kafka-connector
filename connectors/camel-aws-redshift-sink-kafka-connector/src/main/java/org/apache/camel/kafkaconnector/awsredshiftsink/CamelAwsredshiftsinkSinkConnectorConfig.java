...
public class CamelAwsredshiftsinkSinkConnectorConfig
        extends
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_SERVER_NAME_CONF, ConfigDef.Type.STRING, CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_SERVER_NAME_DEFAULT, ConfigDef.Importance.HIGH, CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_SERVER_NAME_DOC);
        conf.define(CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_SERVER_PORT_CONF, ConfigDef.Type.STRING, CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_SERVER_PORT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_SERVER_PORT_DOC);
        conf.define(CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_USERNAME_CONF, ConfigDef.Type.STRING, CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_USERNAME_DEFAULT, ConfigDef.Importance.HIGH, CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_USERNAME_DOC);
        conf.define(CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_PASSWORD_CONF, ConfigDef.Type.PASSWORD, CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_PASSWORD_DEFAULT, ConfigDef.Importance.HIGH, CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_PASSWORD_DOC);
        ...
        conf.define(CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_DATABASE_NAME_CONF, ConfigDef.Type.STRING, CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_DATABASE_NAME_DEFAULT, ConfigDef.Importance.HIGH, CAMEL_SINK_AWSREDSHIFTSINK_KAMELET_DATABASE_NAME_DOC);
        return conf;
    }
}