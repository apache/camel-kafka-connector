...
public class CamelJcrSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_JCR_PATH_HOST_DOC = "Name of the javax.jcr.Repository to lookup from the Camel registry to be used.";
    private static final String CAMEL_SINK_JCR_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_JCR_PATH_BASE_CONF = "camel.sink.path.base";
    private static final String CAMEL_SINK_JCR_PATH_BASE_DOC = "Get the base node when accessing the repository";
    private static final String CAMEL_SINK_JCR_PATH_BASE_DEFAULT = null;
    public static final String CAMEL_SINK_JCR_ENDPOINT_DEEP_CONF = "camel.sink.endpoint.deep";
    private static final String CAMEL_SINK_JCR_ENDPOINT_DEEP_DOC = "When isDeep is true, events whose associated parent node is at absPath or within its subgraph are received.";
    private static final Boolean CAMEL_SINK_JCR_ENDPOINT_DEEP_DEFAULT = false;
    public static final String CAMEL_SINK_JCR_ENDPOINT_EVENT_TYPES_CONF = "camel.sink.endpoint.eventTypes";
    private static final String CAMEL_SINK_JCR_ENDPOINT_EVENT_TYPES_DOC = "eventTypes (a combination of one or more event types encoded as a bit mask value such as javax.jcr.observation.Event.NODE_ADDED, javax.jcr.observation.Event.NODE_REMOVED, etc.).";
    private static final Integer CAMEL_SINK_JCR_ENDPOINT_EVENT_TYPES_DEFAULT = null;
    public static final String CAMEL_SINK_JCR_ENDPOINT_NODE_TYPE_NAMES_CONF = "camel.sink.endpoint.nodeTypeNames";
    private static final String CAMEL_SINK_JCR_ENDPOINT_NODE_TYPE_NAMES_DOC = "When a comma separated nodeTypeName list string is set, only events whose associated parent node has one of the node types (or a subtype of one of the node types) in this list will be received.";
    private static final String CAMEL_SINK_JCR_ENDPOINT_NODE_TYPE_NAMES_DEFAULT = null;
    public static final String CAMEL_SINK_JCR_ENDPOINT_NO_LOCAL_CONF = "camel.sink.endpoint.noLocal";
    private static final String CAMEL_SINK_JCR_ENDPOINT_NO_LOCAL_DOC = "If noLocal is true, then events generated by the session through which the listener was registered are ignored. Otherwise, they are not ignored.";
    private static final Boolean CAMEL_SINK_JCR_ENDPOINT_NO_LOCAL_DEFAULT = false;
    public static final String CAMEL_SINK_JCR_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_JCR_ENDPOINT_PASSWORD_DOC = "Password for login";
    private static final String CAMEL_SINK_JCR_ENDPOINT_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_JCR_ENDPOINT_SESSION_LIVE_CHECK_INTERVAL_DOC = "Interval in milliseconds to wait before each session live checking The default value is 60000 ms.";
    private static final Long CAMEL_SINK_JCR_ENDPOINT_SESSION_LIVE_CHECK_INTERVAL_DEFAULT = 60000L;
    ...
    private static final String CAMEL_SINK_JCR_ENDPOINT_SESSION_LIVE_CHECK_INTERVAL_ON_START_DOC = "Interval in milliseconds to wait before the first session live checking. The default value is 3000 ms.";
    private static final Long CAMEL_SINK_JCR_ENDPOINT_SESSION_LIVE_CHECK_INTERVAL_ON_START_DEFAULT = 3000L;
    public static final String CAMEL_SINK_JCR_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_JCR_ENDPOINT_USERNAME_DOC = "Username for login";
    private static final String CAMEL_SINK_JCR_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_JCR_ENDPOINT_UUIDS_CONF = "camel.sink.endpoint.uuids";
    private static final String CAMEL_SINK_JCR_ENDPOINT_UUIDS_DOC = "When a comma separated uuid list string is set, only events whose associated parent node has one of the identifiers in the comma separated uuid list will be received.";
    private static final String CAMEL_SINK_JCR_ENDPOINT_UUIDS_DEFAULT = null;
    public static final String CAMEL_SINK_JCR_ENDPOINT_WORKSPACE_NAME_CONF = "camel.sink.endpoint.workspaceName";
    private static final String CAMEL_SINK_JCR_ENDPOINT_WORKSPACE_NAME_DOC = "The workspace to access. If it's not specified then the default one will be used";
    private static final String CAMEL_SINK_JCR_ENDPOINT_WORKSPACE_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JCR_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_JCR_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_JCR_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JCR_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JCR_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_JCR_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_JCR_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_JCR_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_JCR_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.jcr.basicPropertyBinding";
    private static final String CAMEL_SINK_JCR_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JCR_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
