...
public class CamelNettySinkConnector extends CamelSinkConnector {
    ...
    protected Map<String, String> getConnectorDefaults() {
        return Collections.singletonMap(CamelSinkConnectorConfig.CAMEL_SINK_COMPONENT_CONF, "netty");
    }
}