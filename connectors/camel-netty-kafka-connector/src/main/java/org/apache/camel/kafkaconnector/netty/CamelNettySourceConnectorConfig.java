...
public class CamelNettySourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_NETTY_ENDPOINT_DISCONNECT_DOC = "Whether or not to disconnect(close) from Netty Channel right after use.";
    ...
    public static final String CAMEL_SOURCE_NETTY_ENDPOINT_SYNC_DOC = "Setting to set endpoint as one-way (false) or request-response (true)";
    ...
    public static final String CAMEL_SOURCE_NETTY_ENDPOINT_BRIDGE_ERROR_HANDLER_DOC = "Allows for bridging the consumer to the Camel routing Error Handler, which mean any exceptions (if possible) occurred while the Camel consumer is trying to pickup incoming messages, or the likes, will now be processed as a message and handled by the routing Error Handler. Important: This is only possible if the 3rd party component allows Camel to be alerted if an exception was thrown. Some components handle this internally only, and therefore bridgeErrorHandler is not possible. In other situations we may improve the Camel component to hook into the 3rd party component and make this possible for future releases. By default the consumer will use the org.apache.camel.spi.ExceptionHandler to deal with exceptions, that will be logged at WARN or ERROR level and ignored.";
    ...
    public static final String CAMEL_SOURCE_NETTY_ENDPOINT_CHANNEL_GROUP_DOC = "To use an explicit ChannelGroup.";
    ...
    public static final String CAMEL_SOURCE_NETTY_ENDPOINT_OPTIONS_DOC = "Allows to configure additional netty options using option. as prefix. For example option.child.keepAlive=false. See the Netty documentation for possible options that can be used. This is a multi-value option with prefix: option.";
    ...
    public static final String CAMEL_SOURCE_NETTY_ENDPOINT_SHUTDOWN_TIMEOUT_CONF = "camel.source.endpoint.shutdownTimeout";
    public static final String CAMEL_SOURCE_NETTY_ENDPOINT_SHUTDOWN_TIMEOUT_DOC = "Shutdown await timeout in milliseconds";
    public static final Integer CAMEL_SOURCE_NETTY_ENDPOINT_SHUTDOWN_TIMEOUT_DEFAULT = 100;
    ...
    public static final String CAMEL_SOURCE_NETTY_ENDPOINT_UNIX_DOMAIN_SOCKET_PATH_CONF = "camel.source.endpoint.unixDomainSocketPath";
    public static final String CAMEL_SOURCE_NETTY_ENDPOINT_UNIX_DOMAIN_SOCKET_PATH_DOC = "Path to unix domain socket to use instead of inet socket. Host and port parameters will not be used, however required. It is ok to set dummy values for them. Must be used with nativeTransport=true and clientMode=false.";
    public static final String CAMEL_SOURCE_NETTY_ENDPOINT_UNIX_DOMAIN_SOCKET_PATH_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_NETTY_COMPONENT_DISCONNECT_DOC = "Whether or not to disconnect(close) from Netty Channel right after use.";
    ...
    public static final String CAMEL_SOURCE_NETTY_COMPONENT_SYNC_DOC = "Setting to set endpoint as one-way (false) or request-response (true)";
    ...
    public static final String CAMEL_SOURCE_NETTY_COMPONENT_BRIDGE_ERROR_HANDLER_DOC = "Allows for bridging the consumer to the Camel routing Error Handler, which mean any exceptions (if possible) occurred while the Camel consumer is trying to pickup incoming messages, or the likes, will now be processed as a message and handled by the routing Error Handler. Important: This is only possible if the 3rd party component allows Camel to be alerted if an exception was thrown. Some components handle this internally only, and therefore bridgeErrorHandler is not possible. In other situations we may improve the Camel component to hook into the 3rd party component and make this possible for future releases. By default the consumer will use the org.apache.camel.spi.ExceptionHandler to deal with exceptions, that will be logged at WARN or ERROR level and ignored.";
    ...
    public static final String CAMEL_SOURCE_NETTY_COMPONENT_EXECUTOR_SERVICE_DOC = "To use the given custom EventExecutorGroup.";
    ...
    public static final String CAMEL_SOURCE_NETTY_COMPONENT_CHANNEL_GROUP_DOC = "To use an explicit ChannelGroup.";
    ...
    public static final String CAMEL_SOURCE_NETTY_COMPONENT_OPTIONS_DOC = "Allows to configure additional netty options using option. as prefix. For example option.child.keepAlive=false. See the Netty documentation for possible options that can be used. This is a multi-value option with prefix: option.";
    ...
    public static final String CAMEL_SOURCE_NETTY_COMPONENT_SHUTDOWN_TIMEOUT_CONF = "camel.component.netty.shutdownTimeout";
    public static final String CAMEL_SOURCE_NETTY_COMPONENT_SHUTDOWN_TIMEOUT_DOC = "Shutdown await timeout in milliseconds";
    public static final Integer CAMEL_SOURCE_NETTY_COMPONENT_SHUTDOWN_TIMEOUT_DEFAULT = 100;
    ...
    public static final String CAMEL_SOURCE_NETTY_COMPONENT_UNIX_DOMAIN_SOCKET_PATH_CONF = "camel.component.netty.unixDomainSocketPath";
    public static final String CAMEL_SOURCE_NETTY_COMPONENT_UNIX_DOMAIN_SOCKET_PATH_DOC = "Path to unix domain socket to use instead of inet socket. Host and port parameters will not be used, however required. It is ok to set dummy values for them. Must be used with nativeTransport=true and clientMode=false.";
    public static final String CAMEL_SOURCE_NETTY_COMPONENT_UNIX_DOMAIN_SOCKET_PATH_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_NETTY_ENDPOINT_SHUTDOWN_TIMEOUT_CONF, ConfigDef.Type.INT, CAMEL_SOURCE_NETTY_ENDPOINT_SHUTDOWN_TIMEOUT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_NETTY_ENDPOINT_SHUTDOWN_TIMEOUT_DOC);
        ...
        conf.define(CAMEL_SOURCE_NETTY_ENDPOINT_UNIX_DOMAIN_SOCKET_PATH_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_NETTY_ENDPOINT_UNIX_DOMAIN_SOCKET_PATH_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_NETTY_ENDPOINT_UNIX_DOMAIN_SOCKET_PATH_DOC);
        ...
        conf.define(CAMEL_SOURCE_NETTY_COMPONENT_SHUTDOWN_TIMEOUT_CONF, ConfigDef.Type.INT, CAMEL_SOURCE_NETTY_COMPONENT_SHUTDOWN_TIMEOUT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_NETTY_COMPONENT_SHUTDOWN_TIMEOUT_DOC);
        ...
        conf.define(CAMEL_SOURCE_NETTY_COMPONENT_UNIX_DOMAIN_SOCKET_PATH_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_NETTY_COMPONENT_UNIX_DOMAIN_SOCKET_PATH_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_NETTY_COMPONENT_UNIX_DOMAIN_SOCKET_PATH_DOC);
