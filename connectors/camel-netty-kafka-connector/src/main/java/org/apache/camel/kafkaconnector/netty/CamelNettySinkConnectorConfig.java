...
public class CamelNettySinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_NETTY_ENDPOINT_DISCONNECT_DOC = "Whether or not to disconnect(close) from Netty Channel right after use.";
    ...
    public static final String CAMEL_SINK_NETTY_ENDPOINT_SYNC_DOC = "Setting to set endpoint as one-way (false) or request-response (true)";
    ...
    public static final String CAMEL_SINK_NETTY_ENDPOINT_NETWORK_INTERFACE_CONF = "camel.sink.endpoint.networkInterface";
    public static final String CAMEL_SINK_NETTY_ENDPOINT_NETWORK_INTERFACE_DOC = "When using UDP then this option can be used to specify a network interface by its name, such as eth0 to join a multicast group.";
    public static final String CAMEL_SINK_NETTY_ENDPOINT_NETWORK_INTERFACE_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_NETTY_ENDPOINT_CHANNEL_GROUP_DOC = "To use an explicit ChannelGroup.";
    ...
    public static final String CAMEL_SINK_NETTY_ENDPOINT_OPTIONS_DOC = "Allows to configure additional netty options using option. as prefix. For example option.child.keepAlive=false. See the Netty documentation for possible options that can be used. This is a multi-value option with prefix: option.";
    ...
    public static final String CAMEL_SINK_NETTY_ENDPOINT_SHUTDOWN_TIMEOUT_CONF = "camel.sink.endpoint.shutdownTimeout";
    public static final String CAMEL_SINK_NETTY_ENDPOINT_SHUTDOWN_TIMEOUT_DOC = "Shutdown await timeout in milliseconds";
    public static final Integer CAMEL_SINK_NETTY_ENDPOINT_SHUTDOWN_TIMEOUT_DEFAULT = 100;
    ...
    public static final String CAMEL_SINK_NETTY_COMPONENT_DISCONNECT_DOC = "Whether or not to disconnect(close) from Netty Channel right after use.";
    ...
    public static final String CAMEL_SINK_NETTY_COMPONENT_SYNC_DOC = "Setting to set endpoint as one-way (false) or request-response (true)";
    ...
    public static final String CAMEL_SINK_NETTY_COMPONENT_NETWORK_INTERFACE_CONF = "camel.component.netty.networkInterface";
    public static final String CAMEL_SINK_NETTY_COMPONENT_NETWORK_INTERFACE_DOC = "When using UDP then this option can be used to specify a network interface by its name, such as eth0 to join a multicast group.";
    public static final String CAMEL_SINK_NETTY_COMPONENT_NETWORK_INTERFACE_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_NETTY_COMPONENT_CHANNEL_GROUP_DOC = "To use an explicit ChannelGroup.";
    ...
    public static final String CAMEL_SINK_NETTY_COMPONENT_OPTIONS_DOC = "Allows to configure additional netty options using option. as prefix. For example option.child.keepAlive=false. See the Netty documentation for possible options that can be used. This is a multi-value option with prefix: option.";
    ...
    public static final String CAMEL_SINK_NETTY_COMPONENT_SHUTDOWN_TIMEOUT_CONF = "camel.component.netty.shutdownTimeout";
    public static final String CAMEL_SINK_NETTY_COMPONENT_SHUTDOWN_TIMEOUT_DOC = "Shutdown await timeout in milliseconds";
    public static final Integer CAMEL_SINK_NETTY_COMPONENT_SHUTDOWN_TIMEOUT_DEFAULT = 100;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_NETTY_ENDPOINT_NETWORK_INTERFACE_CONF, ConfigDef.Type.STRING, CAMEL_SINK_NETTY_ENDPOINT_NETWORK_INTERFACE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_NETTY_ENDPOINT_NETWORK_INTERFACE_DOC);
        ...
        conf.define(CAMEL_SINK_NETTY_ENDPOINT_SHUTDOWN_TIMEOUT_CONF, ConfigDef.Type.INT, CAMEL_SINK_NETTY_ENDPOINT_SHUTDOWN_TIMEOUT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_NETTY_ENDPOINT_SHUTDOWN_TIMEOUT_DOC);
        ...
        conf.define(CAMEL_SINK_NETTY_ENDPOINT_KEY_STORE_FILE_CONF, ConfigDef.Type.STRING, CAMEL_SINK_NETTY_ENDPOINT_KEY_STORE_FILE_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_NETTY_ENDPOINT_KEY_STORE_FILE_DOC);
        ...
        conf.define(CAMEL_SINK_NETTY_ENDPOINT_TRUST_STORE_FILE_CONF, ConfigDef.Type.STRING, CAMEL_SINK_NETTY_ENDPOINT_TRUST_STORE_FILE_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_NETTY_ENDPOINT_TRUST_STORE_FILE_DOC);
        ...
        conf.define(CAMEL_SINK_NETTY_COMPONENT_NETWORK_INTERFACE_CONF, ConfigDef.Type.STRING, CAMEL_SINK_NETTY_COMPONENT_NETWORK_INTERFACE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_NETTY_COMPONENT_NETWORK_INTERFACE_DOC);
        ...
        conf.define(CAMEL_SINK_NETTY_COMPONENT_SHUTDOWN_TIMEOUT_CONF, ConfigDef.Type.INT, CAMEL_SINK_NETTY_COMPONENT_SHUTDOWN_TIMEOUT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_NETTY_COMPONENT_SHUTDOWN_TIMEOUT_DOC);
        ...
        conf.define(CAMEL_SINK_NETTY_COMPONENT_KEY_STORE_FILE_CONF, ConfigDef.Type.STRING, CAMEL_SINK_NETTY_COMPONENT_KEY_STORE_FILE_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_NETTY_COMPONENT_KEY_STORE_FILE_DOC);
        ...
        conf.define(CAMEL_SINK_NETTY_COMPONENT_TRUST_STORE_FILE_CONF, ConfigDef.Type.STRING, CAMEL_SINK_NETTY_COMPONENT_TRUST_STORE_FILE_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_NETTY_COMPONENT_TRUST_STORE_FILE_DOC);
