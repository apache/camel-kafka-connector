...
public class CamelNettySourceConnector extends CamelSourceConnector {
    ...
    protected Map<String, String> getConnectorDefaults() {
        return Collections.singletonMap(CamelSourceConnectorConfig.CAMEL_SOURCE_COMPONENT_CONF, "netty");
    }
}