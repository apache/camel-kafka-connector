...
public class CamelRestswaggerSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_PATH_SPECIFICATION_URI_DEFAULT = "swagger.json";
    public static final String CAMEL_SINK_RESTSWAGGER_PATH_OPERATION_ID_CONF = "camel.sink.path.operationId";
    public static final String CAMEL_SINK_RESTSWAGGER_PATH_OPERATION_ID_DOC = "ID of the operation from the Swagger specification.";
    public static final String CAMEL_SINK_RESTSWAGGER_PATH_OPERATION_ID_DEFAULT = null;
    public static final String CAMEL_SINK_RESTSWAGGER_ENDPOINT_BASE_PATH_CONF = "camel.sink.endpoint.basePath";
    public static final String CAMEL_SINK_RESTSWAGGER_ENDPOINT_BASE_PATH_DOC = "API basePath, for example /v2. Default is unset, if set overrides the value present in Swagger specification and in the component configuration.";
    public static final String CAMEL_SINK_RESTSWAGGER_ENDPOINT_BASE_PATH_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_ENDPOINT_COMPONENT_NAME_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_ENDPOINT_CONSUMES_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_ENDPOINT_HOST_DEFAULT = null;
    ...
    public static final Boolean CAMEL_SINK_RESTSWAGGER_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SINK_RESTSWAGGER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_COMPONENT_BASE_PATH_DOC = "API basePath, for example /v2. Default is unset, if set overrides the value present in Swagger specification.";
    public static final String CAMEL_SINK_RESTSWAGGER_COMPONENT_BASE_PATH_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_COMPONENT_COMPONENT_NAME_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_COMPONENT_CONSUMES_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_COMPONENT_HOST_DEFAULT = null;
    ...
    public static final Boolean CAMEL_SINK_RESTSWAGGER_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_COMPONENT_PRODUCES_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_COMPONENT_SPECIFICATION_URI_DEFAULT = "swagger.json";
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SINK_RESTSWAGGER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_COMPONENT_SSL_CONTEXT_PARAMETERS_DOC = "Customize TLS parameters used by the component. If not set defaults to the TLS parameters set in the Camel context";
    public static final String CAMEL_SINK_RESTSWAGGER_COMPONENT_SSL_CONTEXT_PARAMETERS_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_RESTSWAGGER_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DOC = "Enable usage of global SSL context parameters.";
    public static final Boolean CAMEL_SINK_RESTSWAGGER_COMPONENT_USE_GLOBAL_SSL_CONTEXT_PARAMETERS_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_RESTSWAGGER_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_RESTSWAGGER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_RESTSWAGGER_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
