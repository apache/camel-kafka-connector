...
public class CamelChunkSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_CHUNK_PATH_RESOURCE_URI_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_CHUNK_ENDPOINT_ALLOW_CONTEXT_MAP_ALL_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_CHUNK_ENDPOINT_ALLOW_TEMPLATE_FROM_HEADER_DEFAULT = false;
    public static final String CAMEL_SINK_CHUNK_ENDPOINT_CONTENT_CACHE_CONF = "camel.sink.endpoint.contentCache";
    private static final String CAMEL_SINK_CHUNK_ENDPOINT_CONTENT_CACHE_DOC = "Sets whether to use resource content cache or not";
    private static final Boolean CAMEL_SINK_CHUNK_ENDPOINT_CONTENT_CACHE_DEFAULT = false;
    public static final String CAMEL_SINK_CHUNK_ENDPOINT_ENCODING_CONF = "camel.sink.endpoint.encoding";
    private static final String CAMEL_SINK_CHUNK_ENDPOINT_ENCODING_DOC = "Define the encoding of the body";
    private static final String CAMEL_SINK_CHUNK_ENDPOINT_ENCODING_DEFAULT = null;
    public static final String CAMEL_SINK_CHUNK_ENDPOINT_EXTENSION_CONF = "camel.sink.endpoint.extension";
    private static final String CAMEL_SINK_CHUNK_ENDPOINT_EXTENSION_DOC = "Define the file extension of the template";
    private static final String CAMEL_SINK_CHUNK_ENDPOINT_EXTENSION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_CHUNK_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_CHUNK_ENDPOINT_THEME_FOLDER_CONF = "camel.sink.endpoint.themeFolder";
    private static final String CAMEL_SINK_CHUNK_ENDPOINT_THEME_FOLDER_DOC = "Define the themes folder to scan";
    private static final String CAMEL_SINK_CHUNK_ENDPOINT_THEME_FOLDER_DEFAULT = null;
    public static final String CAMEL_SINK_CHUNK_ENDPOINT_THEME_LAYER_CONF = "camel.sink.endpoint.themeLayer";
    private static final String CAMEL_SINK_CHUNK_ENDPOINT_THEME_LAYER_DOC = "Define the theme layer to elaborate";
    private static final String CAMEL_SINK_CHUNK_ENDPOINT_THEME_LAYER_DEFAULT = null;
    public static final String CAMEL_SINK_CHUNK_ENDPOINT_THEME_SUBFOLDER_CONF = "camel.sink.endpoint.themeSubfolder";
    private static final String CAMEL_SINK_CHUNK_ENDPOINT_THEME_SUBFOLDER_DOC = "Define the themes subfolder to scan";
    private static final String CAMEL_SINK_CHUNK_ENDPOINT_THEME_SUBFOLDER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CHUNK_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CHUNK_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_CHUNK_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_CHUNK_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_CHUNK_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_CHUNK_COMPONENT_ALLOW_CONTEXT_MAP_ALL_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_CHUNK_COMPONENT_ALLOW_TEMPLATE_FROM_HEADER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_CHUNK_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CHUNK_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CHUNK_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
