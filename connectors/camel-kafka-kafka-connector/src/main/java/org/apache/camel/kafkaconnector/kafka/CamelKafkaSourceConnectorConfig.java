...
public class CamelKafkaSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_KAFKA_COMPONENT_WORKER_POOL_CONF = "camel.component.kafka.workerPool";
    ...
    public static final String CAMEL_SOURCE_KAFKA_COMPONENT_WORKER_POOL_DEFAULT = null;
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SOURCE_KAFKA_COMPONENT_WORKER_POOL_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_KAFKA_COMPONENT_WORKER_POOL_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_KAFKA_COMPONENT_WORKER_POOL_DOC);
