...
public class CamelCouchdbSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_COUCHDB_PATH_PROTOCOL_DOC = "The protocol to use for communicating with the database. One of: [http] [https]";
    private static final String CAMEL_SOURCE_COUCHDB_PATH_PROTOCOL_DEFAULT = null;
    public static final String CAMEL_SOURCE_COUCHDB_PATH_HOSTNAME_CONF = "camel.source.path.hostname";
    private static final String CAMEL_SOURCE_COUCHDB_PATH_HOSTNAME_DOC = "Hostname of the running couchdb instance";
    private static final String CAMEL_SOURCE_COUCHDB_PATH_HOSTNAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_COUCHDB_PATH_PORT_CONF = "camel.source.path.port";
    private static final String CAMEL_SOURCE_COUCHDB_PATH_PORT_DOC = "Port number for the running couchdb instance";
    private static final Integer CAMEL_SOURCE_COUCHDB_PATH_PORT_DEFAULT = 5984;
    public static final String CAMEL_SOURCE_COUCHDB_PATH_DATABASE_CONF = "camel.source.path.database";
    private static final String CAMEL_SOURCE_COUCHDB_PATH_DATABASE_DOC = "Name of the database to use";
    private static final String CAMEL_SOURCE_COUCHDB_PATH_DATABASE_DEFAULT = null;
    public static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_CREATE_DATABASE_CONF = "camel.source.endpoint.createDatabase";
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_CREATE_DATABASE_DOC = "Creates the database if it does not already exist";
    private static final Boolean CAMEL_SOURCE_COUCHDB_ENDPOINT_CREATE_DATABASE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_COUCHDB_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_DELETES_CONF = "camel.source.endpoint.deletes";
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_DELETES_DOC = "Document deletes are published as events";
    private static final Boolean CAMEL_SOURCE_COUCHDB_ENDPOINT_DELETES_DEFAULT = true;
    public static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_HEARTBEAT_CONF = "camel.source.endpoint.heartbeat";
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_HEARTBEAT_DOC = "How often to send an empty message to keep socket alive in millis";
    private static final Long CAMEL_SOURCE_COUCHDB_ENDPOINT_HEARTBEAT_DEFAULT = 30000L;
    public static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_SINCE_CONF = "camel.source.endpoint.since";
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_SINCE_DOC = "Start tracking changes immediately after the given update sequence. The default, null, will start monitoring from the latest sequence.";
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_SINCE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_STYLE_DEFAULT = "main_only";
    public static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_UPDATES_CONF = "camel.source.endpoint.updates";
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_UPDATES_DOC = "Document inserts/updates are published as events";
    private static final Boolean CAMEL_SOURCE_COUCHDB_ENDPOINT_UPDATES_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_COUCHDB_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_COUCHDB_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_PASSWORD_DOC = "Password for authenticated databases";
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_USERNAME_DOC = "Username in case of authenticated databases";
    private static final String CAMEL_SOURCE_COUCHDB_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_COUCHDB_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_COUCHDB_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_COUCHDB_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
