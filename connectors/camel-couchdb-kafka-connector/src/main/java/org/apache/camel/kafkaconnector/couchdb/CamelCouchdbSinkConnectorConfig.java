...
public class CamelCouchdbSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_COUCHDB_PATH_PROTOCOL_DOC = "The protocol to use for communicating with the database. One of: [http] [https]";
    private static final String CAMEL_SINK_COUCHDB_PATH_PROTOCOL_DEFAULT = null;
    public static final String CAMEL_SINK_COUCHDB_PATH_HOSTNAME_CONF = "camel.sink.path.hostname";
    private static final String CAMEL_SINK_COUCHDB_PATH_HOSTNAME_DOC = "Hostname of the running couchdb instance";
    private static final String CAMEL_SINK_COUCHDB_PATH_HOSTNAME_DEFAULT = null;
    public static final String CAMEL_SINK_COUCHDB_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_COUCHDB_PATH_PORT_DOC = "Port number for the running couchdb instance";
    private static final Integer CAMEL_SINK_COUCHDB_PATH_PORT_DEFAULT = 5984;
    public static final String CAMEL_SINK_COUCHDB_PATH_DATABASE_CONF = "camel.sink.path.database";
    private static final String CAMEL_SINK_COUCHDB_PATH_DATABASE_DOC = "Name of the database to use";
    private static final String CAMEL_SINK_COUCHDB_PATH_DATABASE_DEFAULT = null;
    public static final String CAMEL_SINK_COUCHDB_ENDPOINT_CREATE_DATABASE_CONF = "camel.sink.endpoint.createDatabase";
    private static final String CAMEL_SINK_COUCHDB_ENDPOINT_CREATE_DATABASE_DOC = "Creates the database if it does not already exist";
    private static final Boolean CAMEL_SINK_COUCHDB_ENDPOINT_CREATE_DATABASE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_COUCHDB_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_COUCHDB_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_COUCHDB_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_COUCHDB_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_COUCHDB_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_COUCHDB_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_COUCHDB_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_COUCHDB_ENDPOINT_PASSWORD_DOC = "Password for authenticated databases";
    private static final String CAMEL_SINK_COUCHDB_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_COUCHDB_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_COUCHDB_ENDPOINT_USERNAME_DOC = "Username in case of authenticated databases";
    private static final String CAMEL_SINK_COUCHDB_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_COUCHDB_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_COUCHDB_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_COUCHDB_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
