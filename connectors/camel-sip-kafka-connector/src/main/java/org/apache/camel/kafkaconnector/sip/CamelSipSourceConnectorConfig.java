...
public class CamelSipSourceConnectorConfig extends CamelSourceConnectorConfig {
    ...
    private static final String CAMEL_SOURCE_SIP_PATH_URI_DOC = "URI of the SIP server to connect to (the username and password can be included such as: john:secretmyserver:9999)";
    private static final String CAMEL_SOURCE_SIP_PATH_URI_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_CACHE_CONNECTIONS_CONF = "camel.source.endpoint.cacheConnections";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_CACHE_CONNECTIONS_DOC = "Should connections be cached by the SipStack to reduce cost of connection creation. This is useful if the connection is used for long running conversations.";
    private static final Boolean CAMEL_SOURCE_SIP_ENDPOINT_CACHE_CONNECTIONS_DEFAULT = false;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_CONTENT_SUB_TYPE_CONF = "camel.source.endpoint.contentSubType";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_CONTENT_SUB_TYPE_DOC = "Setting for contentSubType can be set to any valid MimeSubType.";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_CONTENT_SUB_TYPE_DEFAULT = "plain";
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_CONTENT_TYPE_CONF = "camel.source.endpoint.contentType";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_CONTENT_TYPE_DOC = "Setting for contentType can be set to any valid MimeType.";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_CONTENT_TYPE_DEFAULT = "text";
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_EVENT_HEADER_NAME_CONF = "camel.source.endpoint.eventHeaderName";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_EVENT_HEADER_NAME_DOC = "Setting for a String based event type.";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_EVENT_HEADER_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_EVENT_ID_CONF = "camel.source.endpoint.eventId";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_EVENT_ID_DOC = "Setting for a String based event Id. Mandatory setting unless a registry based FromHeader is specified";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_EVENT_ID_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_FROM_HOST_CONF = "camel.source.endpoint.fromHost";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_FROM_HOST_DOC = "Hostname of the message originator. Mandatory setting unless a registry based FromHeader is specified";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_FROM_HOST_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_FROM_PORT_CONF = "camel.source.endpoint.fromPort";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_FROM_PORT_DOC = "Port of the message originator. Mandatory setting unless a registry based FromHeader is specified";
    private static final Integer CAMEL_SOURCE_SIP_ENDPOINT_FROM_PORT_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_FROM_USER_CONF = "camel.source.endpoint.fromUser";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_FROM_USER_DOC = "Username of the message originator. Mandatory setting unless a registry based custom FromHeader is specified.";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_FROM_USER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_MSG_EXPIRATION_CONF = "camel.source.endpoint.msgExpiration";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_MSG_EXPIRATION_DOC = "The amount of time a message received at an endpoint is considered valid";
    private static final Integer CAMEL_SOURCE_SIP_ENDPOINT_MSG_EXPIRATION_DEFAULT = 3600;
    ...
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_RECEIVE_TIMEOUT_MILLIS_DOC = "Setting for specifying amount of time to wait for a Response and/or Acknowledgement can be received from another SIP stack";
    private static final Long CAMEL_SOURCE_SIP_ENDPOINT_RECEIVE_TIMEOUT_MILLIS_DEFAULT = 10000L;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_STACK_NAME_CONF = "camel.source.endpoint.stackName";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_STACK_NAME_DOC = "Name of the SIP Stack instance associated with an SIP Endpoint.";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_STACK_NAME_DEFAULT = "NAME_NOT_SET";
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_TO_HOST_CONF = "camel.source.endpoint.toHost";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_TO_HOST_DOC = "Hostname of the message receiver. Mandatory setting unless a registry based ToHeader is specified";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_TO_HOST_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_TO_PORT_CONF = "camel.source.endpoint.toPort";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_TO_PORT_DOC = "Portname of the message receiver. Mandatory setting unless a registry based ToHeader is specified";
    private static final Integer CAMEL_SOURCE_SIP_ENDPOINT_TO_PORT_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_TO_USER_CONF = "camel.source.endpoint.toUser";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_TO_USER_DOC = "Username of the message receiver. Mandatory setting unless a registry based custom ToHeader is specified.";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_TO_USER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_TRANSPORT_CONF = "camel.source.endpoint.transport";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_TRANSPORT_DOC = "Setting for choice of transport protocol. Valid choices are tcp or udp. One of: [tcp] [udp]";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_TRANSPORT_DEFAULT = "tcp";
    ...
    private static final Boolean CAMEL_SOURCE_SIP_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_CONSUMER_CONF = "camel.source.endpoint.consumer";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_CONSUMER_DOC = "This setting is used to determine whether the kind of header (FromHeader,ToHeader etc) that needs to be created for this endpoint";
    private static final Boolean CAMEL_SOURCE_SIP_ENDPOINT_CONSUMER_DEFAULT = false;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_PRESENCE_AGENT_CONF = "camel.source.endpoint.presenceAgent";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_PRESENCE_AGENT_DOC = "This setting is used to distinguish between a Presence Agent & a consumer. This is due to the fact that the SIP Camel component ships with a basic Presence Agent (for testing purposes only). Consumers have to set this flag to true.";
    private static final Boolean CAMEL_SOURCE_SIP_ENDPOINT_PRESENCE_AGENT_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_ADDRESS_FACTORY_CONF = "camel.source.endpoint.addressFactory";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_ADDRESS_FACTORY_DOC = "To use a custom AddressFactory";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_ADDRESS_FACTORY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SIP_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_CALL_ID_HEADER_CONF = "camel.source.endpoint.callIdHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_CALL_ID_HEADER_DOC = "A custom Header object containing call details. Must implement the type javax.sip.header.CallIdHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_CALL_ID_HEADER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_CONTACT_HEADER_CONF = "camel.source.endpoint.contactHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_CONTACT_HEADER_DOC = "An optional custom Header object containing verbose contact details (email, phone number etc). Must implement the type javax.sip.header.ContactHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_CONTACT_HEADER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_CONTENT_TYPE_HEADER_CONF = "camel.source.endpoint.contentTypeHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_CONTENT_TYPE_HEADER_DOC = "A custom Header object containing message content details. Must implement the type javax.sip.header.ContentTypeHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_CONTENT_TYPE_HEADER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_EVENT_HEADER_CONF = "camel.source.endpoint.eventHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_EVENT_HEADER_DOC = "A custom Header object containing event details. Must implement the type javax.sip.header.EventHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_EVENT_HEADER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_EXPIRES_HEADER_CONF = "camel.source.endpoint.expiresHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_EXPIRES_HEADER_DOC = "A custom Header object containing message expiration details. Must implement the type javax.sip.header.ExpiresHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_EXPIRES_HEADER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_EXTENSION_HEADER_CONF = "camel.source.endpoint.extensionHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_EXTENSION_HEADER_DOC = "A custom Header object containing user/application specific details. Must implement the type javax.sip.header.ExtensionHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_EXTENSION_HEADER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_FROM_HEADER_CONF = "camel.source.endpoint.fromHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_FROM_HEADER_DOC = "A custom Header object containing message originator settings. Must implement the type javax.sip.header.FromHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_FROM_HEADER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_HEADER_FACTORY_CONF = "camel.source.endpoint.headerFactory";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_HEADER_FACTORY_DOC = "To use a custom HeaderFactory";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_HEADER_FACTORY_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_LISTENING_POINT_CONF = "camel.source.endpoint.listeningPoint";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_LISTENING_POINT_DOC = "To use a custom ListeningPoint implementation";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_LISTENING_POINT_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_MAX_FORWARDS_HEADER_CONF = "camel.source.endpoint.maxForwardsHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_MAX_FORWARDS_HEADER_DOC = "A custom Header object containing details on maximum proxy forwards. This header places a limit on the viaHeaders possible. Must implement the type javax.sip.header.MaxForwardsHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_MAX_FORWARDS_HEADER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_MAX_MESSAGE_SIZE_CONF = "camel.source.endpoint.maxMessageSize";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_MAX_MESSAGE_SIZE_DOC = "Setting for maximum allowed Message size in bytes.";
    private static final Integer CAMEL_SOURCE_SIP_ENDPOINT_MAX_MESSAGE_SIZE_DEFAULT = 1048576;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_MESSAGE_FACTORY_CONF = "camel.source.endpoint.messageFactory";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_MESSAGE_FACTORY_DOC = "To use a custom MessageFactory";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_MESSAGE_FACTORY_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_SIP_FACTORY_CONF = "camel.source.endpoint.sipFactory";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_SIP_FACTORY_DOC = "To use a custom SipFactory to create the SipStack to be used";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_SIP_FACTORY_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_SIP_STACK_CONF = "camel.source.endpoint.sipStack";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_SIP_STACK_DOC = "To use a custom SipStack";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_SIP_STACK_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_SIP_URI_CONF = "camel.source.endpoint.sipUri";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_SIP_URI_DOC = "To use a custom SipURI. If none configured, then the SipUri fallback to use the options toUser toHost:toPort";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_SIP_URI_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_SIP_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_TO_HEADER_CONF = "camel.source.endpoint.toHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_TO_HEADER_DOC = "A custom Header object containing message receiver settings. Must implement the type javax.sip.header.ToHeader";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_TO_HEADER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_VIA_HEADERS_CONF = "camel.source.endpoint.viaHeaders";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_VIA_HEADERS_DOC = "List of custom Header objects of the type javax.sip.header.ViaHeader. Each ViaHeader containing a proxy address for request forwarding. (Note this header is automatically updated by each proxy when the request arrives at its listener)";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_VIA_HEADERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_IMPLEMENTATION_DEBUG_LOG_FILE_DOC = "Name of client debug log file to use for logging";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_IMPLEMENTATION_DEBUG_LOG_FILE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_IMPLEMENTATION_SERVER_LOG_FILE_DOC = "Name of server log file to use for logging";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_IMPLEMENTATION_SERVER_LOG_FILE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_IMPLEMENTATION_TRACE_LEVEL_DOC = "Logging level for tracing";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_IMPLEMENTATION_TRACE_LEVEL_DEFAULT = "0";
    public static final String CAMEL_SOURCE_SIP_ENDPOINT_MAX_FORWARDS_CONF = "camel.source.endpoint.maxForwards";
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_MAX_FORWARDS_DOC = "Number of maximum proxy forwards";
    private static final Integer CAMEL_SOURCE_SIP_ENDPOINT_MAX_FORWARDS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SIP_ENDPOINT_USE_ROUTER_FOR_ALL_URIS_DOC = "This setting is used when requests are sent to the Presence Agent via a proxy.";
    private static final Boolean CAMEL_SOURCE_SIP_ENDPOINT_USE_ROUTER_FOR_ALL_URIS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_SIP_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SIP_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SIP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
