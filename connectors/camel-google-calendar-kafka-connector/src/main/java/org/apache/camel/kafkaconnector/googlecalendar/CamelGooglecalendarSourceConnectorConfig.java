...
public class CamelGooglecalendarSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_PATH_METHOD_NAME_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_APPLICATION_NAME_DOC = "Google calendar application name. Example would be camel-google-calendar/1.0";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_APPLICATION_NAME_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DOC = "If the polling consumer did not poll any files, you can enable this option to send an empty message (no body) instead.";
    public static final Boolean CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_SEND_EMPTY_MESSAGE_WHEN_IDLE_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_POLL_STRATEGY_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    public static final Boolean CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DOC = "The number of subsequent error polls (failed due some error) that should happen before the backoffMultipler should kick-in.";
    public static final Integer CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_BACKOFF_ERROR_THRESHOLD_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DOC = "The number of subsequent idle polls that should happen before the backoffMultipler should kick-in.";
    public static final Integer CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_BACKOFF_IDLE_THRESHOLD_DEFAULT = null;
    ...
    public static final Integer CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_BACKOFF_MULTIPLIER_DEFAULT = null;
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_DELAY_DOC = "Milliseconds before the next poll.";
    public static final Long CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_DELAY_DEFAULT = 500L;
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_GREEDY_CONF = "camel.source.endpoint.greedy";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_GREEDY_DOC = "If greedy is enabled, then the ScheduledPollConsumer will run immediately again, if the previous run polled 1 or more messages.";
    public static final Boolean CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_GREEDY_DEFAULT = false;
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_INITIAL_DELAY_CONF = "camel.source.endpoint.initialDelay";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_INITIAL_DELAY_DOC = "Milliseconds before the first poll starts.";
    public static final Long CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_INITIAL_DELAY_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_REPEAT_COUNT_CONF = "camel.source.endpoint.repeatCount";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_REPEAT_COUNT_DOC = "Specifies a maximum limit of number of fires. So if you set it to 1, the scheduler will only fire once. If you set it to 5, it will only fire five times. A value of zero or negative means fire forever.";
    public static final Long CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_RUN_LOGGING_LEVEL_DOC = "The consumer logs a start/complete log line when it polls. This option allows you to configure the logging level for that. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_RUN_LOGGING_LEVEL_DEFAULT = "TRACE";
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_SCHEDULER_PROPERTIES_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_START_SCHEDULER_DOC = "Whether the scheduler should be auto started.";
    public static final Boolean CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_START_SCHEDULER_DEFAULT = true;
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_TIME_UNIT_CONF = "camel.source.endpoint.timeUnit";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_TIME_UNIT_DOC = "Time unit for initialDelay and delay options. One of: [NANOSECONDS] [MICROSECONDS] [MILLISECONDS] [SECONDS] [MINUTES] [HOURS] [DAYS]";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_TIME_UNIT_DEFAULT = "MILLISECONDS";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_USE_FIXED_DELAY_CONF = "camel.source.endpoint.useFixedDelay";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_USE_FIXED_DELAY_DOC = "Controls if fixed delay or fixed rate is used. See ScheduledExecutorService in JDK for details.";
    public static final Boolean CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_USE_FIXED_DELAY_DEFAULT = true;
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_ACCESS_TOKEN_CONF = "camel.source.endpoint.accessToken";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_ACCESS_TOKEN_DOC = "OAuth 2 access token. This typically expires after an hour so refreshToken is recommended for long term usage.";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_ENDPOINT_ACCESS_TOKEN_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_COMPONENT_CLIENT_ID_DOC = "Client ID of the calendar application";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_COMPONENT_CLIENT_ID_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_GOOGLECALENDAR_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_COMPONENT_CLIENT_FACTORY_DOC = "To use the GoogleCalendarClientFactory as factory for creating the client. Will by default use BatchGoogleCalendarClientFactory";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_COMPONENT_CLIENT_FACTORY_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_COMPONENT_ACCESS_TOKEN_DOC = "OAuth 2 access token. This typically expires after an hour so refreshToken is recommended for long term usage.";
    public static final String CAMEL_SOURCE_GOOGLECALENDAR_COMPONENT_ACCESS_TOKEN_DEFAULT = null;
