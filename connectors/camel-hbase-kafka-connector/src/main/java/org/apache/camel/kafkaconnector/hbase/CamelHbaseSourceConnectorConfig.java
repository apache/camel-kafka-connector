...
public class CamelHbaseSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_HBASE_PATH_TABLE_NAME_DOC = "The name of the table";
    private static final String CAMEL_SOURCE_HBASE_PATH_TABLE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_CELL_MAPPING_STRATEGY_FACTORY_DOC = "To use a custom CellMappingStrategyFactory that is responsible for mapping cells.";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_CELL_MAPPING_STRATEGY_FACTORY_DEFAULT = null;
    public static final String CAMEL_SOURCE_HBASE_ENDPOINT_FILTERS_CONF = "camel.source.endpoint.filters";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_FILTERS_DOC = "A list of filters to use.";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_FILTERS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_MAPPING_STRATEGY_CLASS_NAME_DOC = "The class name of a custom mapping strategy implementation.";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_MAPPING_STRATEGY_CLASS_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_MAPPING_STRATEGY_NAME_DOC = "The strategy to use for mapping Camel messages to HBase columns. Supported values: header, or body. One of: [header] [body]";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_MAPPING_STRATEGY_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_ROW_MAPPING_DEFAULT = null;
    public static final String CAMEL_SOURCE_HBASE_ENDPOINT_ROW_MODEL_CONF = "camel.source.endpoint.rowModel";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_ROW_MODEL_DOC = "An instance of org.apache.camel.component.hbase.model.HBaseRow which describes how each row should be modeled";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_ROW_MODEL_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_USER_GROUP_INFORMATION_DOC = "Defines privileges to communicate with HBase such as using kerberos.";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_USER_GROUP_INFORMATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_HBASE_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_MAX_MESSAGES_PER_POLL_DOC = "Gets the maximum number of messages as a limit to poll at each polling. Is default unlimited, but use 0 or negative number to disable it as unlimited.";
    private static final Integer CAMEL_SOURCE_HBASE_ENDPOINT_MAX_MESSAGES_PER_POLL_DEFAULT = null;
    public static final String CAMEL_SOURCE_HBASE_ENDPOINT_OPERATION_CONF = "camel.source.endpoint.operation";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_OPERATION_DOC = "The HBase operation to perform One of: [CamelHBasePut] [CamelHBaseGet] [CamelHBaseScan] [CamelHBaseDelete]";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_OPERATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_HBASE_ENDPOINT_REMOVE_CONF = "camel.source.endpoint.remove";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_REMOVE_DOC = "If the option is true, Camel HBase Consumer will remove the rows which it processes.";
    private static final Boolean CAMEL_SOURCE_HBASE_ENDPOINT_REMOVE_DEFAULT = true;
    public static final String CAMEL_SOURCE_HBASE_ENDPOINT_REMOVE_HANDLER_CONF = "camel.source.endpoint.removeHandler";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_REMOVE_HANDLER_DOC = "To use a custom HBaseRemoveHandler that is executed when a row is to be removed.";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_REMOVE_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_HBASE_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_HBASE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_HBASE_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_HBASE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_HBASE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_HBASE_COMPONENT_POOL_MAX_SIZE_CONF = "camel.component.hbase.poolMaxSize";
    private static final String CAMEL_SOURCE_HBASE_COMPONENT_POOL_MAX_SIZE_DOC = "Maximum number of references to keep for each table in the HTable pool. The default value is 10.";
    private static final Integer CAMEL_SOURCE_HBASE_COMPONENT_POOL_MAX_SIZE_DEFAULT = 10;
    ...
    private static final Boolean CAMEL_SOURCE_HBASE_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_HBASE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_HBASE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_HBASE_COMPONENT_CONFIGURATION_CONF = "camel.component.hbase.configuration";
    private static final String CAMEL_SOURCE_HBASE_COMPONENT_CONFIGURATION_DOC = "To use the shared configuration";
    private static final String CAMEL_SOURCE_HBASE_COMPONENT_CONFIGURATION_DEFAULT = null;
