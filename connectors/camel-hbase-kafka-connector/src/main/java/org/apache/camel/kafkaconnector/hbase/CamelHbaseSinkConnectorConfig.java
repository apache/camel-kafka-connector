...
public class CamelHbaseSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_HBASE_PATH_TABLE_NAME_DOC = "The name of the table";
    private static final String CAMEL_SINK_HBASE_PATH_TABLE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_HBASE_ENDPOINT_CELL_MAPPING_STRATEGY_FACTORY_DOC = "To use a custom CellMappingStrategyFactory that is responsible for mapping cells.";
    private static final String CAMEL_SINK_HBASE_ENDPOINT_CELL_MAPPING_STRATEGY_FACTORY_DEFAULT = null;
    public static final String CAMEL_SINK_HBASE_ENDPOINT_FILTERS_CONF = "camel.sink.endpoint.filters";
    private static final String CAMEL_SINK_HBASE_ENDPOINT_FILTERS_DOC = "A list of filters to use.";
    private static final String CAMEL_SINK_HBASE_ENDPOINT_FILTERS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_HBASE_ENDPOINT_MAPPING_STRATEGY_CLASS_NAME_DOC = "The class name of a custom mapping strategy implementation.";
    private static final String CAMEL_SINK_HBASE_ENDPOINT_MAPPING_STRATEGY_CLASS_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_HBASE_ENDPOINT_MAPPING_STRATEGY_NAME_CONF = "camel.sink.endpoint.mappingStrategyName";
    private static final String CAMEL_SINK_HBASE_ENDPOINT_MAPPING_STRATEGY_NAME_DOC = "The strategy to use for mapping Camel messages to HBase columns. Supported values: header, or body. One of: [header] [body]";
    private static final String CAMEL_SINK_HBASE_ENDPOINT_MAPPING_STRATEGY_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_HBASE_ENDPOINT_ROW_MAPPING_DEFAULT = null;
    public static final String CAMEL_SINK_HBASE_ENDPOINT_ROW_MODEL_CONF = "camel.sink.endpoint.rowModel";
    private static final String CAMEL_SINK_HBASE_ENDPOINT_ROW_MODEL_DOC = "An instance of org.apache.camel.component.hbase.model.HBaseRow which describes how each row should be modeled";
    private static final String CAMEL_SINK_HBASE_ENDPOINT_ROW_MODEL_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_HBASE_ENDPOINT_USER_GROUP_INFORMATION_DOC = "Defines privileges to communicate with HBase such as using kerberos.";
    private static final String CAMEL_SINK_HBASE_ENDPOINT_USER_GROUP_INFORMATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_HBASE_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_HBASE_ENDPOINT_MAX_RESULTS_CONF = "camel.sink.endpoint.maxResults";
    private static final String CAMEL_SINK_HBASE_ENDPOINT_MAX_RESULTS_DOC = "The maximum number of rows to scan.";
    private static final Integer CAMEL_SINK_HBASE_ENDPOINT_MAX_RESULTS_DEFAULT = 100;
    ...
    private static final String CAMEL_SINK_HBASE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_HBASE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_HBASE_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_HBASE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_HBASE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_HBASE_COMPONENT_POOL_MAX_SIZE_CONF = "camel.component.hbase.poolMaxSize";
    private static final String CAMEL_SINK_HBASE_COMPONENT_POOL_MAX_SIZE_DOC = "Maximum number of references to keep for each table in the HTable pool. The default value is 10.";
    private static final Integer CAMEL_SINK_HBASE_COMPONENT_POOL_MAX_SIZE_DEFAULT = 10;
    ...
    private static final Boolean CAMEL_SINK_HBASE_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_HBASE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_HBASE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_HBASE_COMPONENT_CONFIGURATION_CONF = "camel.component.hbase.configuration";
    private static final String CAMEL_SINK_HBASE_COMPONENT_CONFIGURATION_DOC = "To use the shared configuration";
    private static final String CAMEL_SINK_HBASE_COMPONENT_CONFIGURATION_DEFAULT = null;
