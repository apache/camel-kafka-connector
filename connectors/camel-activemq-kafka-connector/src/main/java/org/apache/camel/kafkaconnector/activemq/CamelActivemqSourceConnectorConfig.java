...
public class CamelActivemqSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    ...
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_BROKER_URLDOC = "Sets the broker URL to use to connect to ActiveMQ";
    ...
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_CONFIGURATION_DOC = "Configuration of ActiveMQ";
    ...
    public static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_USE_POOLED_CONNECTION_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ACKNOWLEDGEMENT_MODE_CONF = "camel.component.activemq.acknowledgementMode";
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ACKNOWLEDGEMENT_MODE_DOC = "The JMS acknowledgement mode defined as an Integer. Allows you to set vendor-specific extensions to the acknowledgment mode. For the regular modes, it is preferable to use the acknowledgementModeName instead.";
    public static final Integer CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ACKNOWLEDGEMENT_MODE_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_BRIDGE_ERROR_HANDLER_CONF = "camel.component.activemq.bridgeErrorHandler";
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_BRIDGE_ERROR_HANDLER_DOC = "Allows for bridging the consumer to the Camel routing Error Handler, which mean any exceptions occurred while the consumer is trying to pickup incoming messages, or the likes, will now be processed as a message and handled by the routing Error Handler. By default the consumer will use the org.apache.camel.spi.ExceptionHandler to deal with exceptions, that will be logged at WARN or ERROR level and ignored.";
    public static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    public static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ALLOW_AUTO_WIRED_CONNECTION_FACTORY_DEFAULT = false;
    ...
    public static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ALLOW_AUTO_WIRED_DESTINATION_RESOLVER_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_JMS_OPERATIONS_CONF = "camel.component.activemq.jmsOperations";
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_JMS_OPERATIONS_DOC = "Allows you to use your own implementation of the org.springframework.jms.core.JmsOperations interface. Camel uses JmsTemplate as default. Can be used for testing purpose, but not used much as stated in the spring API docs.";
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_JMS_OPERATIONS_DEFAULT = null;
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ACKNOWLEDGEMENT_MODE_CONF, ConfigDef.Type.INT, CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ACKNOWLEDGEMENT_MODE_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ACKNOWLEDGEMENT_MODE_DOC);
        ...
        conf.define(CAMEL_SOURCE_ACTIVEMQ_COMPONENT_BRIDGE_ERROR_HANDLER_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_ACTIVEMQ_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_ACTIVEMQ_COMPONENT_BRIDGE_ERROR_HANDLER_DOC);
        ...
        conf.define(CAMEL_SOURCE_ACTIVEMQ_COMPONENT_JMS_OPERATIONS_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_ACTIVEMQ_COMPONENT_JMS_OPERATIONS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_ACTIVEMQ_COMPONENT_JMS_OPERATIONS_DOC);
