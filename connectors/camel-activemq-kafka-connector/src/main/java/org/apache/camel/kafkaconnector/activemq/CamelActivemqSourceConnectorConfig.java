...
public class CamelActivemqSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ARTEMIS_STREAMING_ENABLED_DOC = "Whether optimizing for Apache Artemis streaming mode.";
    public static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ARTEMIS_STREAMING_ENABLED_DEFAULT = true;
    ...
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ARTEMIS_STREAMING_ENABLED_DOC = "Whether optimizing for Apache Artemis streaming mode.";
    public static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ARTEMIS_STREAMING_ENABLED_DEFAULT = true;
