...
public class CamelActivemqSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_PATH_DESTINATION_TYPE_DOC = "The kind of destination to use One of: [queue] [topic] [temp-queue] [temp-topic]";
    private static final String CAMEL_SOURCE_ACTIVEMQ_PATH_DESTINATION_TYPE_DEFAULT = "queue";
    public static final String CAMEL_SOURCE_ACTIVEMQ_PATH_DESTINATION_NAME_CONF = "camel.source.path.destinationName";
    private static final String CAMEL_SOURCE_ACTIVEMQ_PATH_DESTINATION_NAME_DOC = "Name of the queue or topic to use as destination";
    private static final String CAMEL_SOURCE_ACTIVEMQ_PATH_DESTINATION_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_CLIENT_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_CONNECTION_FACTORY_DOC = "The connection factory to be use. A connection factory must be configured either on the component or endpoint.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_CONNECTION_FACTORY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_DISABLE_REPLY_TO_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_DURABLE_SUBSCRIPTION_NAME_DOC = "The durable subscriber name for specifying durable topic subscriptions. The clientId option must be configured as well.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_DURABLE_SUBSCRIPTION_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_JMS_MESSAGE_TYPE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TEST_CONNECTION_ON_STARTUP_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ACKNOWLEDGEMENT_MODE_NAME_DOC = "The JMS acknowledgement name, which is one of: SESSION_TRANSACTED, CLIENT_ACKNOWLEDGE, AUTO_ACKNOWLEDGE, DUPS_OK_ACKNOWLEDGE One of: [SESSION_TRANSACTED] [CLIENT_ACKNOWLEDGE] [AUTO_ACKNOWLEDGE] [DUPS_OK_ACKNOWLEDGE]";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ACKNOWLEDGEMENT_MODE_NAME_DEFAULT = "AUTO_ACKNOWLEDGE";
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ASYNC_CONSUMER_DEFAULT = false;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_AUTO_STARTUP_CONF = "camel.source.endpoint.autoStartup";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_AUTO_STARTUP_DOC = "Specifies whether the consumer container should auto-startup.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_AUTO_STARTUP_DEFAULT = true;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_CACHE_LEVEL_CONF = "camel.source.endpoint.cacheLevel";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_CACHE_LEVEL_DOC = "Sets the cache level by ID for the underlying JMS resources. See cacheLevelName option for more details.";
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_CACHE_LEVEL_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_CACHE_LEVEL_NAME_DEFAULT = "CACHE_AUTO";
    ...
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_MAX_CONCURRENT_CONSUMERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_REPLY_TO_CONF = "camel.source.endpoint.replyTo";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_REPLY_TO_DOC = "Provides an explicit ReplyTo destination, which overrides any incoming value of Message.getJMSReplyTo().";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_REPLY_TO_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_REPLY_TO_DELIVERY_PERSISTENT_DOC = "Specifies whether to use persistent delivery by default for replies.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_REPLY_TO_DELIVERY_PERSISTENT_DEFAULT = true;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_SELECTOR_CONF = "camel.source.endpoint.selector";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_SELECTOR_DOC = "Sets the JMS selector to use";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_SELECTOR_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_SUBSCRIPTION_DURABLE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_SUBSCRIPTION_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_SUBSCRIPTION_SHARED_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ACCEPT_MESSAGES_WHILE_STOPPING_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ALLOW_REPLY_MANAGER_QUICK_STOP_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_CONSUMER_TYPE_DEFAULT = "Default";
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_DEFAULT_TASK_EXECUTOR_TYPE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_EAGER_LOADING_OF_PROPERTIES_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_EAGER_POISON_BODY_DEFAULT = "Poison JMS message due to ${exception.message}";
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_EXPOSE_LISTENER_SESSION_DOC = "Specifies whether the listener session should be exposed when consuming messages.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_EXPOSE_LISTENER_SESSION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_REPLY_TO_SAME_DESTINATION_ALLOWED_DEFAULT = false;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TASK_EXECUTOR_CONF = "camel.source.endpoint.taskExecutor";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TASK_EXECUTOR_DOC = "Allows you to specify a custom task executor for consuming messages.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TASK_EXECUTOR_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ALLOW_SERIALIZED_HEADERS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ARTEMIS_STREAMING_ENABLED_DOC = "Whether optimizing for Apache Artemis streaming mode.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ARTEMIS_STREAMING_ENABLED_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ASYNC_START_LISTENER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ASYNC_STOP_LISTENER_DOC = "Whether to stop the JmsConsumer message listener asynchronously, when stopping a route.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ASYNC_STOP_LISTENER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_DESTINATION_RESOLVER_DOC = "A pluggable org.springframework.jms.support.destination.DestinationResolver that allows you to use your own resolver (for example, to lookup the real destination in a JNDI registry).";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_DESTINATION_RESOLVER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ERROR_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_EXCEPTION_LISTENER_DOC = "Specifies the JMS Exception Listener that is to be notified of any underlying JMS exceptions.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_EXCEPTION_LISTENER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_IDLE_CONSUMER_LIMIT_DOC = "Specify the limit for the number of consumers that are allowed to be idle at any given time.";
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_IDLE_CONSUMER_LIMIT_DEFAULT = 1;
    ...
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_IDLE_TASK_EXECUTION_LIMIT_DEFAULT = 1;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_INCLUDE_ALL_JMSXPROPERTIES_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_JMS_KEY_FORMAT_STRATEGY_DOC = "Pluggable strategy for encoding and decoding JMS keys so they can be compliant with the JMS specification. Camel provides two implementations out of the box: default and passthrough. The default strategy will safely marshal dots and hyphens (. and -). The passthrough strategy leaves the key as is. Can be used for JMS brokers which do not care whether JMS header keys contain illegal characters. You can provide your own implementation of the org.apache.camel.component.jms.JmsKeyFormatStrategy and refer to it using the # notation. One of: [default] [passthrough]";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_JMS_KEY_FORMAT_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_MAP_JMS_MESSAGE_CONF = "camel.source.endpoint.mapJmsMessage";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_MAP_JMS_MESSAGE_DOC = "Specifies whether Camel should auto map the received JMS message to a suited payload type, such as javax.jms.TextMessage to a String etc.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_MAP_JMS_MESSAGE_DEFAULT = true;
    ...
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_MAX_MESSAGES_PER_TASK_DEFAULT = -1;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_MESSAGE_CONVERTER_CONF = "camel.source.endpoint.messageConverter";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_MESSAGE_CONVERTER_DOC = "To use a custom Spring org.springframework.jms.support.converter.MessageConverter so you can be in control how to map to/from a javax.jms.Message.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_MESSAGE_CONVERTER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_MESSAGE_CREATED_STRATEGY_DOC = "To use the given MessageCreatedStrategy which are invoked when Camel creates new instances of javax.jms.Message objects when Camel is sending a JMS message.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_MESSAGE_CREATED_STRATEGY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_MESSAGE_ID_ENABLED_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_MESSAGE_LISTENER_CONTAINER_FACTORY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_MESSAGE_TIMESTAMP_ENABLED_DEFAULT = true;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_PUB_SUB_NO_LOCAL_CONF = "camel.source.endpoint.pubSubNoLocal";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_PUB_SUB_NO_LOCAL_DOC = "Specifies whether to inhibit the delivery of messages published by its own connection.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_PUB_SUB_NO_LOCAL_DEFAULT = false;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_RECEIVE_TIMEOUT_CONF = "camel.source.endpoint.receiveTimeout";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_RECEIVE_TIMEOUT_DOC = "The timeout for receiving messages (in milliseconds).";
    private static final Long CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_RECEIVE_TIMEOUT_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_RECOVERY_INTERVAL_CONF = "camel.source.endpoint.recoveryInterval";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_RECOVERY_INTERVAL_DOC = "Specifies the interval between recovery attempts, i.e. when a connection is being refreshed, in milliseconds. The default is 5000 ms, that is, 5 seconds.";
    private static final Long CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_RECOVERY_INTERVAL_DEFAULT = 5000L;
    ...
    private static final Long CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_REQUEST_TIMEOUT_CHECKER_INTERVAL_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TRANSFER_EXCEPTION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TRANSFER_EXCHANGE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_USE_MESSAGE_IDAS_CORRELATION_IDDOC = "Specifies whether JMSMessageID should always be used as JMSCorrelationID for InOut messages.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_USE_MESSAGE_IDAS_CORRELATION_IDDEFAULT = false;
    ...
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_WAIT_FOR_PROVISION_CORRELATION_TO_BE_UPDATED_COUNTER_DEFAULT = 50;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_WAIT_FOR_PROVISION_CORRELATION_TO_BE_UPDATED_THREAD_SLEEPING_TIME_DOC = "Interval in millis to sleep each time while waiting for provisional correlation id to be updated.";
    private static final Long CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_WAIT_FOR_PROVISION_CORRELATION_TO_BE_UPDATED_THREAD_SLEEPING_TIME_DEFAULT = 100L;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ERROR_HANDLER_LOGGING_LEVEL_DOC = "Allows to configure the default errorHandler logging level for logging uncaught exceptions. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ERROR_HANDLER_LOGGING_LEVEL_DEFAULT = "WARN";
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ERROR_HANDLER_LOG_STACK_TRACE_DOC = "Allows to control whether stacktraces should be logged or not, by the default errorHandler.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_ERROR_HANDLER_LOG_STACK_TRACE_DEFAULT = true;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_PASSWORD_DOC = "Password to use with the ConnectionFactory. You can also configure username/password directly on the ConnectionFactory.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_USERNAME_DOC = "Username to use with the ConnectionFactory. You can also configure username/password directly on the ConnectionFactory.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TRANSACTED_CONF = "camel.source.endpoint.transacted";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TRANSACTED_DOC = "Specifies whether to use transacted mode";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TRANSACTED_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_LAZY_CREATE_TRANSACTION_MANAGER_DOC = "If true, Camel will create a JmsTransactionManager, if there is no transactionManager injected when option transacted=true.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_LAZY_CREATE_TRANSACTION_MANAGER_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TRANSACTION_MANAGER_DOC = "The Spring transaction manager to use.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TRANSACTION_MANAGER_DEFAULT = null;
    public static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TRANSACTION_NAME_CONF = "camel.source.endpoint.transactionName";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TRANSACTION_NAME_DOC = "The name of the transaction to use.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TRANSACTION_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TRANSACTION_TIMEOUT_DOC = "The timeout value of the transaction (in seconds), if using transacted mode.";
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_ENDPOINT_TRANSACTION_TIMEOUT_DEFAULT = -1;
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_BROKER_URLCONF = "camel.component.activemq.brokerURL";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_BROKER_URLDOC = "Sets the broker URL to use to connect to ActiveMQ. If none configured then localhost:61616 is used by default (however can be overridden by configuration from environment variables)";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_BROKER_URLDEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_CLIENT_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_CONNECTION_FACTORY_DOC = "The connection factory to be use. A connection factory must be configured either on the component or endpoint.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_CONNECTION_FACTORY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_DISABLE_REPLY_TO_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_DURABLE_SUBSCRIPTION_NAME_DOC = "The durable subscriber name for specifying durable topic subscriptions. The clientId option must be configured as well.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_DURABLE_SUBSCRIPTION_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_JMS_MESSAGE_TYPE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TEST_CONNECTION_ON_STARTUP_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_USE_POOLED_CONNECTION_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_USE_SINGLE_CONNECTION_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ACKNOWLEDGEMENT_MODE_NAME_DOC = "The JMS acknowledgement name, which is one of: SESSION_TRANSACTED, CLIENT_ACKNOWLEDGE, AUTO_ACKNOWLEDGE, DUPS_OK_ACKNOWLEDGE One of: [SESSION_TRANSACTED] [CLIENT_ACKNOWLEDGE] [AUTO_ACKNOWLEDGE] [DUPS_OK_ACKNOWLEDGE]";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ACKNOWLEDGEMENT_MODE_NAME_DEFAULT = "AUTO_ACKNOWLEDGE";
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ASYNC_CONSUMER_DEFAULT = false;
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_AUTO_STARTUP_CONF = "camel.component.activemq.autoStartup";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_AUTO_STARTUP_DOC = "Specifies whether the consumer container should auto-startup.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_AUTO_STARTUP_DEFAULT = true;
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_CACHE_LEVEL_CONF = "camel.component.activemq.cacheLevel";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_CACHE_LEVEL_DOC = "Sets the cache level by ID for the underlying JMS resources. See cacheLevelName option for more details.";
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_COMPONENT_CACHE_LEVEL_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_CACHE_LEVEL_NAME_DEFAULT = "CACHE_AUTO";
    ...
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_COMPONENT_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_COMPONENT_MAX_CONCURRENT_CONSUMERS_DEFAULT = null;
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_REPLY_TO_CONF = "camel.component.activemq.replyTo";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_REPLY_TO_DOC = "Provides an explicit ReplyTo destination, which overrides any incoming value of Message.getJMSReplyTo().";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_REPLY_TO_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_REPLY_TO_DELIVERY_PERSISTENT_DOC = "Specifies whether to use persistent delivery by default for replies.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_REPLY_TO_DELIVERY_PERSISTENT_DEFAULT = true;
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_SELECTOR_CONF = "camel.component.activemq.selector";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_SELECTOR_DOC = "Sets the JMS selector to use";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_SELECTOR_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_SUBSCRIPTION_DURABLE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_SUBSCRIPTION_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_SUBSCRIPTION_SHARED_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ACCEPT_MESSAGES_WHILE_STOPPING_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ALLOW_REPLY_MANAGER_QUICK_STOP_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_CONSUMER_TYPE_DEFAULT = "Default";
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_DEFAULT_TASK_EXECUTOR_TYPE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_EAGER_LOADING_OF_PROPERTIES_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_EAGER_POISON_BODY_DEFAULT = "Poison JMS message due to ${exception.message}";
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_EXPOSE_LISTENER_SESSION_DOC = "Specifies whether the listener session should be exposed when consuming messages.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_EXPOSE_LISTENER_SESSION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_REPLY_TO_SAME_DESTINATION_ALLOWED_DEFAULT = false;
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TASK_EXECUTOR_CONF = "camel.component.activemq.taskExecutor";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TASK_EXECUTOR_DOC = "Allows you to specify a custom task executor for consuming messages.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TASK_EXECUTOR_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ALLOW_AUTO_WIRED_CONNECTION_FACTORY_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ALLOW_AUTO_WIRED_DESTINATION_RESOLVER_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ALLOW_SERIALIZED_HEADERS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ARTEMIS_STREAMING_ENABLED_DOC = "Whether optimizing for Apache Artemis streaming mode.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ARTEMIS_STREAMING_ENABLED_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ASYNC_START_LISTENER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ASYNC_STOP_LISTENER_DOC = "Whether to stop the JmsConsumer message listener asynchronously, when stopping a route.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ASYNC_STOP_LISTENER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_CONFIGURATION_CONF = "camel.component.activemq.configuration";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_CONFIGURATION_DOC = "To use a shared JMS configuration";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_DESTINATION_RESOLVER_DOC = "A pluggable org.springframework.jms.support.destination.DestinationResolver that allows you to use your own resolver (for example, to lookup the real destination in a JNDI registry).";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_DESTINATION_RESOLVER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ERROR_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_EXCEPTION_LISTENER_DOC = "Specifies the JMS Exception Listener that is to be notified of any underlying JMS exceptions.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_EXCEPTION_LISTENER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_IDLE_CONSUMER_LIMIT_DOC = "Specify the limit for the number of consumers that are allowed to be idle at any given time.";
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_COMPONENT_IDLE_CONSUMER_LIMIT_DEFAULT = 1;
    ...
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_COMPONENT_IDLE_TASK_EXECUTION_LIMIT_DEFAULT = 1;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_INCLUDE_ALL_JMSXPROPERTIES_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_JMS_KEY_FORMAT_STRATEGY_DOC = "Pluggable strategy for encoding and decoding JMS keys so they can be compliant with the JMS specification. Camel provides two implementations out of the box: default and passthrough. The default strategy will safely marshal dots and hyphens (. and -). The passthrough strategy leaves the key as is. Can be used for JMS brokers which do not care whether JMS header keys contain illegal characters. You can provide your own implementation of the org.apache.camel.component.jms.JmsKeyFormatStrategy and refer to it using the # notation. One of: [default] [passthrough]";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_JMS_KEY_FORMAT_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_MAP_JMS_MESSAGE_CONF = "camel.component.activemq.mapJmsMessage";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_MAP_JMS_MESSAGE_DOC = "Specifies whether Camel should auto map the received JMS message to a suited payload type, such as javax.jms.TextMessage to a String etc.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_MAP_JMS_MESSAGE_DEFAULT = true;
    ...
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_COMPONENT_MAX_MESSAGES_PER_TASK_DEFAULT = -1;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_MESSAGE_CONVERTER_DOC = "To use a custom Spring org.springframework.jms.support.converter.MessageConverter so you can be in control how to map to/from a javax.jms.Message.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_MESSAGE_CONVERTER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_MESSAGE_CREATED_STRATEGY_DOC = "To use the given MessageCreatedStrategy which are invoked when Camel creates new instances of javax.jms.Message objects when Camel is sending a JMS message.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_MESSAGE_CREATED_STRATEGY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_MESSAGE_ID_ENABLED_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_MESSAGE_LISTENER_CONTAINER_FACTORY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_MESSAGE_TIMESTAMP_ENABLED_DEFAULT = true;
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_PUB_SUB_NO_LOCAL_CONF = "camel.component.activemq.pubSubNoLocal";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_PUB_SUB_NO_LOCAL_DOC = "Specifies whether to inhibit the delivery of messages published by its own connection.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_PUB_SUB_NO_LOCAL_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_QUEUE_BROWSE_STRATEGY_DOC = "To use a custom QueueBrowseStrategy when browsing queues";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_QUEUE_BROWSE_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_RECEIVE_TIMEOUT_CONF = "camel.component.activemq.receiveTimeout";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_RECEIVE_TIMEOUT_DOC = "The timeout for receiving messages (in milliseconds).";
    private static final Long CAMEL_SOURCE_ACTIVEMQ_COMPONENT_RECEIVE_TIMEOUT_DEFAULT = 1000L;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_RECOVERY_INTERVAL_DOC = "Specifies the interval between recovery attempts, i.e. when a connection is being refreshed, in milliseconds. The default is 5000 ms, that is, 5 seconds.";
    private static final Long CAMEL_SOURCE_ACTIVEMQ_COMPONENT_RECOVERY_INTERVAL_DEFAULT = 5000L;
    ...
    private static final Long CAMEL_SOURCE_ACTIVEMQ_COMPONENT_REQUEST_TIMEOUT_CHECKER_INTERVAL_DEFAULT = 1000L;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TRANSFER_EXCEPTION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TRANSFER_EXCHANGE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TRUST_ALL_PACKAGES_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_USE_MESSAGE_IDAS_CORRELATION_IDDOC = "Specifies whether JMSMessageID should always be used as JMSCorrelationID for InOut messages.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_USE_MESSAGE_IDAS_CORRELATION_IDDEFAULT = false;
    ...
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_COMPONENT_WAIT_FOR_PROVISION_CORRELATION_TO_BE_UPDATED_COUNTER_DEFAULT = 50;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_WAIT_FOR_PROVISION_CORRELATION_TO_BE_UPDATED_THREAD_SLEEPING_TIME_DOC = "Interval in millis to sleep each time while waiting for provisional correlation id to be updated.";
    private static final Long CAMEL_SOURCE_ACTIVEMQ_COMPONENT_WAIT_FOR_PROVISION_CORRELATION_TO_BE_UPDATED_THREAD_SLEEPING_TIME_DEFAULT = 100L;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_HEADER_FILTER_STRATEGY_DOC = "To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ERROR_HANDLER_LOGGING_LEVEL_DOC = "Allows to configure the default errorHandler logging level for logging uncaught exceptions. One of: [TRACE] [DEBUG] [INFO] [WARN] [ERROR] [OFF]";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ERROR_HANDLER_LOGGING_LEVEL_DEFAULT = "WARN";
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ERROR_HANDLER_LOG_STACK_TRACE_DOC = "Allows to control whether stacktraces should be logged or not, by the default errorHandler.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_ERROR_HANDLER_LOG_STACK_TRACE_DEFAULT = true;
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_PASSWORD_CONF = "camel.component.activemq.password";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_PASSWORD_DOC = "Password to use with the ConnectionFactory. You can also configure username/password directly on the ConnectionFactory.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_USERNAME_CONF = "camel.component.activemq.username";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_USERNAME_DOC = "Username to use with the ConnectionFactory. You can also configure username/password directly on the ConnectionFactory.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TRANSACTED_CONF = "camel.component.activemq.transacted";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TRANSACTED_DOC = "Specifies whether to use transacted mode";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TRANSACTED_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_LAZY_CREATE_TRANSACTION_MANAGER_DOC = "If true, Camel will create a JmsTransactionManager, if there is no transactionManager injected when option transacted=true.";
    private static final Boolean CAMEL_SOURCE_ACTIVEMQ_COMPONENT_LAZY_CREATE_TRANSACTION_MANAGER_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TRANSACTION_MANAGER_DOC = "The Spring transaction manager to use.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TRANSACTION_MANAGER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TRANSACTION_NAME_DOC = "The name of the transaction to use.";
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TRANSACTION_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TRANSACTION_TIMEOUT_DOC = "The timeout value of the transaction (in seconds), if using transacted mode.";
    private static final Integer CAMEL_SOURCE_ACTIVEMQ_COMPONENT_TRANSACTION_TIMEOUT_DEFAULT = -1;
