...
public class CamelActivemqSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_PATH_DESTINATION_TYPE_DOC = "The kind of destination to use One of: [queue] [topic] [temp-queue] [temp-topic]";
    private static final String CAMEL_SINK_ACTIVEMQ_PATH_DESTINATION_TYPE_DEFAULT = "queue";
    public static final String CAMEL_SINK_ACTIVEMQ_PATH_DESTINATION_NAME_CONF = "camel.sink.path.destinationName";
    private static final String CAMEL_SINK_ACTIVEMQ_PATH_DESTINATION_NAME_DOC = "Name of the queue or topic to use as destination";
    private static final String CAMEL_SINK_ACTIVEMQ_PATH_DESTINATION_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_CLIENT_ID_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_CONNECTION_FACTORY_CONF = "camel.sink.endpoint.connectionFactory";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_CONNECTION_FACTORY_DOC = "The connection factory to be use. A connection factory must be configured either on the component or endpoint.";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_CONNECTION_FACTORY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_DISABLE_REPLY_TO_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_DURABLE_SUBSCRIPTION_NAME_DOC = "The durable subscriber name for specifying durable topic subscriptions. The clientId option must be configured as well.";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_DURABLE_SUBSCRIPTION_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_JMS_MESSAGE_TYPE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_TEST_CONNECTION_ON_STARTUP_DEFAULT = false;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_DELIVERY_DELAY_CONF = "camel.sink.endpoint.deliveryDelay";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_DELIVERY_DELAY_DOC = "Sets delivery delay to use for send calls for JMS. This option requires JMS 2.0 compliant broker.";
    private static final Long CAMEL_SINK_ACTIVEMQ_ENDPOINT_DELIVERY_DELAY_DEFAULT = -1L;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_DELIVERY_MODE_CONF = "camel.sink.endpoint.deliveryMode";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_DELIVERY_MODE_DOC = "Specifies the delivery mode to be used. Possibles values are those defined by javax.jms.DeliveryMode. NON_PERSISTENT = 1 and PERSISTENT = 2. One of: [1] [2]";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_DELIVERY_MODE_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_DELIVERY_PERSISTENT_CONF = "camel.sink.endpoint.deliveryPersistent";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_DELIVERY_PERSISTENT_DOC = "Specifies whether persistent delivery is used by default.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_DELIVERY_PERSISTENT_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_EXPLICIT_QOS_ENABLED_DEFAULT = "false";
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_FORMAT_DATE_HEADERS_TO_ISO_8601DOC = "Sets whether JMS date properties should be formatted according to the ISO 8601 standard.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_FORMAT_DATE_HEADERS_TO_ISO_8601DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_PRESERVE_MESSAGE_QOS_DEFAULT = false;
    ...
    private static final Integer CAMEL_SINK_ACTIVEMQ_ENDPOINT_PRIORITY_DEFAULT = 4;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_REPLY_TO_CONCURRENT_CONSUMERS_DOC = "Specifies the default number of concurrent consumers when doing request/reply over JMS. See also the maxMessagesPerTask option to control dynamic scaling up/down of threads.";
    private static final Integer CAMEL_SINK_ACTIVEMQ_ENDPOINT_REPLY_TO_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_REPLY_TO_MAX_CONCURRENT_CONSUMERS_DOC = "Specifies the maximum number of concurrent consumers when using request/reply over JMS. See also the maxMessagesPerTask option to control dynamic scaling up/down of threads.";
    private static final Integer CAMEL_SINK_ACTIVEMQ_ENDPOINT_REPLY_TO_MAX_CONCURRENT_CONSUMERS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_REPLY_TO_ON_TIMEOUT_MAX_CONCURRENT_CONSUMERS_DOC = "Specifies the maximum number of concurrent consumers for continue routing when timeout occurred when using request/reply over JMS.";
    private static final Integer CAMEL_SINK_ACTIVEMQ_ENDPOINT_REPLY_TO_ON_TIMEOUT_MAX_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_REPLY_TO_OVERRIDE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_REPLY_TO_TYPE_DEFAULT = null;
    ...
    private static final Long CAMEL_SINK_ACTIVEMQ_ENDPOINT_REQUEST_TIMEOUT_DEFAULT = 20000L;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_TIME_TO_LIVE_CONF = "camel.sink.endpoint.timeToLive";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_TIME_TO_LIVE_DOC = "When sending messages, specifies the time-to-live of the message (in milliseconds).";
    private static final Long CAMEL_SINK_ACTIVEMQ_ENDPOINT_TIME_TO_LIVE_DEFAULT = -1L;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_ALLOW_ADDITIONAL_HEADERS_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_ALLOW_NULL_BODY_CONF = "camel.sink.endpoint.allowNullBody";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_ALLOW_NULL_BODY_DOC = "Whether to allow sending messages with no body. If this option is false and the message body is null, then an JMSException is thrown.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_ALLOW_NULL_BODY_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_ALWAYS_COPY_MESSAGE_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_CORRELATION_PROPERTY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_DISABLE_TIME_TO_LIVE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_FORCE_SEND_ORIGINAL_MESSAGE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_INCLUDE_SENT_JMSMESSAGE_IDDEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_REPLY_TO_CACHE_LEVEL_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_REPLY_TO_DESTINATION_SELECTOR_NAME_DOC = "Sets the JMS Selector using the fixed name to be used so you can filter out your own replies from the others when using a shared queue (that is, if you are not using a temporary reply queue).";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_REPLY_TO_DESTINATION_SELECTOR_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_STREAM_MESSAGE_TYPE_ENABLED_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_ALLOW_SERIALIZED_HEADERS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_ARTEMIS_STREAMING_ENABLED_DOC = "Whether optimizing for Apache Artemis streaming mode.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_ARTEMIS_STREAMING_ENABLED_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_ASYNC_START_LISTENER_DEFAULT = false;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_ASYNC_STOP_LISTENER_CONF = "camel.sink.endpoint.asyncStopListener";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_ASYNC_STOP_LISTENER_DOC = "Whether to stop the JmsConsumer message listener asynchronously, when stopping a route.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_ASYNC_STOP_LISTENER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_DESTINATION_RESOLVER_DOC = "A pluggable org.springframework.jms.support.destination.DestinationResolver that allows you to use your own resolver (for example, to lookup the real destination in a JNDI registry).";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_DESTINATION_RESOLVER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_ERROR_HANDLER_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_EXCEPTION_LISTENER_CONF = "camel.sink.endpoint.exceptionListener";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_EXCEPTION_LISTENER_DOC = "Specifies the JMS Exception Listener that is to be notified of any underlying JMS exceptions.";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_EXCEPTION_LISTENER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_IDLE_CONSUMER_LIMIT_CONF = "camel.sink.endpoint.idleConsumerLimit";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_IDLE_CONSUMER_LIMIT_DOC = "Specify the limit for the number of consumers that are allowed to be idle at any given time.";
    private static final Integer CAMEL_SINK_ACTIVEMQ_ENDPOINT_IDLE_CONSUMER_LIMIT_DEFAULT = 1;
    ...
    private static final Integer CAMEL_SINK_ACTIVEMQ_ENDPOINT_IDLE_TASK_EXECUTION_LIMIT_DEFAULT = 1;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_INCLUDE_ALL_JMSXPROPERTIES_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_JMS_KEY_FORMAT_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_MAP_JMS_MESSAGE_CONF = "camel.sink.endpoint.mapJmsMessage";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_MAP_JMS_MESSAGE_DOC = "Specifies whether Camel should auto map the received JMS message to a suited payload type, such as javax.jms.TextMessage to a String etc.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_MAP_JMS_MESSAGE_DEFAULT = true;
    ...
    private static final Integer CAMEL_SINK_ACTIVEMQ_ENDPOINT_MAX_MESSAGES_PER_TASK_DEFAULT = -1;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_MESSAGE_CONVERTER_CONF = "camel.sink.endpoint.messageConverter";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_MESSAGE_CONVERTER_DOC = "To use a custom Spring org.springframework.jms.support.converter.MessageConverter so you can be in control how to map to/from a javax.jms.Message.";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_MESSAGE_CONVERTER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_MESSAGE_CREATED_STRATEGY_DOC = "To use the given MessageCreatedStrategy which are invoked when Camel creates new instances of javax.jms.Message objects when Camel is sending a JMS message.";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_MESSAGE_CREATED_STRATEGY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_MESSAGE_ID_ENABLED_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_MESSAGE_LISTENER_CONTAINER_FACTORY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_MESSAGE_TIMESTAMP_ENABLED_DEFAULT = true;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_PUB_SUB_NO_LOCAL_CONF = "camel.sink.endpoint.pubSubNoLocal";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_PUB_SUB_NO_LOCAL_DOC = "Specifies whether to inhibit the delivery of messages published by its own connection.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_PUB_SUB_NO_LOCAL_DEFAULT = false;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_RECEIVE_TIMEOUT_CONF = "camel.sink.endpoint.receiveTimeout";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_RECEIVE_TIMEOUT_DOC = "The timeout for receiving messages (in milliseconds).";
    private static final Long CAMEL_SINK_ACTIVEMQ_ENDPOINT_RECEIVE_TIMEOUT_DEFAULT = 1000L;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_RECOVERY_INTERVAL_CONF = "camel.sink.endpoint.recoveryInterval";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_RECOVERY_INTERVAL_DOC = "Specifies the interval between recovery attempts, i.e. when a connection is being refreshed, in milliseconds. The default is 5000 ms, that is, 5 seconds.";
    private static final Long CAMEL_SINK_ACTIVEMQ_ENDPOINT_RECOVERY_INTERVAL_DEFAULT = 5000L;
    ...
    private static final Long CAMEL_SINK_ACTIVEMQ_ENDPOINT_REQUEST_TIMEOUT_CHECKER_INTERVAL_DEFAULT = 1000L;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSFER_EXCEPTION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSFER_EXCHANGE_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_USE_MESSAGE_IDAS_CORRELATION_IDDOC = "Specifies whether JMSMessageID should always be used as JMSCorrelationID for InOut messages.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_USE_MESSAGE_IDAS_CORRELATION_IDDEFAULT = false;
    ...
    private static final Integer CAMEL_SINK_ACTIVEMQ_ENDPOINT_WAIT_FOR_PROVISION_CORRELATION_TO_BE_UPDATED_COUNTER_DEFAULT = 50;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_WAIT_FOR_PROVISION_CORRELATION_TO_BE_UPDATED_THREAD_SLEEPING_TIME_DOC = "Interval in millis to sleep each time while waiting for provisional correlation id to be updated.";
    private static final Long CAMEL_SINK_ACTIVEMQ_ENDPOINT_WAIT_FOR_PROVISION_CORRELATION_TO_BE_UPDATED_THREAD_SLEEPING_TIME_DEFAULT = 100L;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_PASSWORD_DOC = "Password to use with the ConnectionFactory. You can also configure username/password directly on the ConnectionFactory.";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_USERNAME_DOC = "Username to use with the ConnectionFactory. You can also configure username/password directly on the ConnectionFactory.";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSACTED_CONF = "camel.sink.endpoint.transacted";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSACTED_DOC = "Specifies whether to use transacted mode";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSACTED_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_LAZY_CREATE_TRANSACTION_MANAGER_DOC = "If true, Camel will create a JmsTransactionManager, if there is no transactionManager injected when option transacted=true.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_ENDPOINT_LAZY_CREATE_TRANSACTION_MANAGER_DEFAULT = true;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSACTION_MANAGER_CONF = "camel.sink.endpoint.transactionManager";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSACTION_MANAGER_DOC = "The Spring transaction manager to use.";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSACTION_MANAGER_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSACTION_NAME_CONF = "camel.sink.endpoint.transactionName";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSACTION_NAME_DOC = "The name of the transaction to use.";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSACTION_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSACTION_TIMEOUT_CONF = "camel.sink.endpoint.transactionTimeout";
    private static final String CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSACTION_TIMEOUT_DOC = "The timeout value of the transaction (in seconds), if using transacted mode.";
    private static final Integer CAMEL_SINK_ACTIVEMQ_ENDPOINT_TRANSACTION_TIMEOUT_DEFAULT = -1;
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_BROKER_URLCONF = "camel.component.activemq.brokerURL";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_BROKER_URLDOC = "Sets the broker URL to use to connect to ActiveMQ. If none configured then localhost:61616 is used by default (however can be overridden by configuration from environment variables)";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_BROKER_URLDEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_CLIENT_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_CONNECTION_FACTORY_DOC = "The connection factory to be use. A connection factory must be configured either on the component or endpoint.";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_CONNECTION_FACTORY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_DISABLE_REPLY_TO_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_DURABLE_SUBSCRIPTION_NAME_DOC = "The durable subscriber name for specifying durable topic subscriptions. The clientId option must be configured as well.";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_DURABLE_SUBSCRIPTION_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_JMS_MESSAGE_TYPE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_TEST_CONNECTION_ON_STARTUP_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_USE_POOLED_CONNECTION_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_USE_SINGLE_CONNECTION_DEFAULT = false;
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_DELIVERY_DELAY_CONF = "camel.component.activemq.deliveryDelay";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_DELIVERY_DELAY_DOC = "Sets delivery delay to use for send calls for JMS. This option requires JMS 2.0 compliant broker.";
    private static final Long CAMEL_SINK_ACTIVEMQ_COMPONENT_DELIVERY_DELAY_DEFAULT = -1L;
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_DELIVERY_MODE_CONF = "camel.component.activemq.deliveryMode";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_DELIVERY_MODE_DOC = "Specifies the delivery mode to be used. Possibles values are those defined by javax.jms.DeliveryMode. NON_PERSISTENT = 1 and PERSISTENT = 2. One of: [1] [2]";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_DELIVERY_MODE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_DELIVERY_PERSISTENT_DOC = "Specifies whether persistent delivery is used by default.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_DELIVERY_PERSISTENT_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_EXPLICIT_QOS_ENABLED_DEFAULT = "false";
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_FORMAT_DATE_HEADERS_TO_ISO_8601DOC = "Sets whether JMS date properties should be formatted according to the ISO 8601 standard.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_FORMAT_DATE_HEADERS_TO_ISO_8601DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_PRESERVE_MESSAGE_QOS_DEFAULT = false;
    ...
    private static final Integer CAMEL_SINK_ACTIVEMQ_COMPONENT_PRIORITY_DEFAULT = 4;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_TO_CONCURRENT_CONSUMERS_DOC = "Specifies the default number of concurrent consumers when doing request/reply over JMS. See also the maxMessagesPerTask option to control dynamic scaling up/down of threads.";
    private static final Integer CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_TO_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_TO_MAX_CONCURRENT_CONSUMERS_DOC = "Specifies the maximum number of concurrent consumers when using request/reply over JMS. See also the maxMessagesPerTask option to control dynamic scaling up/down of threads.";
    private static final Integer CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_TO_MAX_CONCURRENT_CONSUMERS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_TO_ON_TIMEOUT_MAX_CONCURRENT_CONSUMERS_DOC = "Specifies the maximum number of concurrent consumers for continue routing when timeout occurred when using request/reply over JMS.";
    private static final Integer CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_TO_ON_TIMEOUT_MAX_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_TO_OVERRIDE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_TO_TYPE_DEFAULT = null;
    ...
    private static final Long CAMEL_SINK_ACTIVEMQ_COMPONENT_REQUEST_TIMEOUT_DEFAULT = 20000L;
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_TIME_TO_LIVE_CONF = "camel.component.activemq.timeToLive";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_TIME_TO_LIVE_DOC = "When sending messages, specifies the time-to-live of the message (in milliseconds).";
    private static final Long CAMEL_SINK_ACTIVEMQ_COMPONENT_TIME_TO_LIVE_DEFAULT = -1L;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_ALLOW_ADDITIONAL_HEADERS_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_ALLOW_NULL_BODY_CONF = "camel.component.activemq.allowNullBody";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_ALLOW_NULL_BODY_DOC = "Whether to allow sending messages with no body. If this option is false and the message body is null, then an JMSException is thrown.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_ALLOW_NULL_BODY_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_ALWAYS_COPY_MESSAGE_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_CORRELATION_PROPERTY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_DISABLE_TIME_TO_LIVE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_FORCE_SEND_ORIGINAL_MESSAGE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_INCLUDE_SENT_JMSMESSAGE_IDDEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_TO_CACHE_LEVEL_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_TO_DESTINATION_SELECTOR_NAME_DOC = "Sets the JMS Selector using the fixed name to be used so you can filter out your own replies from the others when using a shared queue (that is, if you are not using a temporary reply queue).";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_TO_DESTINATION_SELECTOR_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_STREAM_MESSAGE_TYPE_ENABLED_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_ALLOW_AUTO_WIRED_CONNECTION_FACTORY_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_ALLOW_AUTO_WIRED_DESTINATION_RESOLVER_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_ALLOW_SERIALIZED_HEADERS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_ARTEMIS_STREAMING_ENABLED_DOC = "Whether optimizing for Apache Artemis streaming mode.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_ARTEMIS_STREAMING_ENABLED_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_ASYNC_START_LISTENER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_ASYNC_STOP_LISTENER_DOC = "Whether to stop the JmsConsumer message listener asynchronously, when stopping a route.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_ASYNC_STOP_LISTENER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_CONFIGURATION_CONF = "camel.component.activemq.configuration";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_CONFIGURATION_DOC = "To use a shared JMS configuration";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_DESTINATION_RESOLVER_DOC = "A pluggable org.springframework.jms.support.destination.DestinationResolver that allows you to use your own resolver (for example, to lookup the real destination in a JNDI registry).";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_DESTINATION_RESOLVER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_ERROR_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_EXCEPTION_LISTENER_DOC = "Specifies the JMS Exception Listener that is to be notified of any underlying JMS exceptions.";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_EXCEPTION_LISTENER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_IDLE_CONSUMER_LIMIT_DOC = "Specify the limit for the number of consumers that are allowed to be idle at any given time.";
    private static final Integer CAMEL_SINK_ACTIVEMQ_COMPONENT_IDLE_CONSUMER_LIMIT_DEFAULT = 1;
    ...
    private static final Integer CAMEL_SINK_ACTIVEMQ_COMPONENT_IDLE_TASK_EXECUTION_LIMIT_DEFAULT = 1;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_INCLUDE_ALL_JMSXPROPERTIES_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_JMS_KEY_FORMAT_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_MAP_JMS_MESSAGE_CONF = "camel.component.activemq.mapJmsMessage";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_MAP_JMS_MESSAGE_DOC = "Specifies whether Camel should auto map the received JMS message to a suited payload type, such as javax.jms.TextMessage to a String etc.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_MAP_JMS_MESSAGE_DEFAULT = true;
    ...
    private static final Integer CAMEL_SINK_ACTIVEMQ_COMPONENT_MAX_MESSAGES_PER_TASK_DEFAULT = -1;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_MESSAGE_CONVERTER_DOC = "To use a custom Spring org.springframework.jms.support.converter.MessageConverter so you can be in control how to map to/from a javax.jms.Message.";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_MESSAGE_CONVERTER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_MESSAGE_CREATED_STRATEGY_DOC = "To use the given MessageCreatedStrategy which are invoked when Camel creates new instances of javax.jms.Message objects when Camel is sending a JMS message.";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_MESSAGE_CREATED_STRATEGY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_MESSAGE_ID_ENABLED_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_MESSAGE_LISTENER_CONTAINER_FACTORY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_MESSAGE_TIMESTAMP_ENABLED_DEFAULT = true;
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_PUB_SUB_NO_LOCAL_CONF = "camel.component.activemq.pubSubNoLocal";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_PUB_SUB_NO_LOCAL_DOC = "Specifies whether to inhibit the delivery of messages published by its own connection.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_PUB_SUB_NO_LOCAL_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_QUEUE_BROWSE_STRATEGY_DOC = "To use a custom QueueBrowseStrategy when browsing queues";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_QUEUE_BROWSE_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_RECEIVE_TIMEOUT_CONF = "camel.component.activemq.receiveTimeout";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_RECEIVE_TIMEOUT_DOC = "The timeout for receiving messages (in milliseconds).";
    private static final Long CAMEL_SINK_ACTIVEMQ_COMPONENT_RECEIVE_TIMEOUT_DEFAULT = 1000L;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_RECOVERY_INTERVAL_DOC = "Specifies the interval between recovery attempts, i.e. when a connection is being refreshed, in milliseconds. The default is 5000 ms, that is, 5 seconds.";
    private static final Long CAMEL_SINK_ACTIVEMQ_COMPONENT_RECOVERY_INTERVAL_DEFAULT = 5000L;
    ...
    private static final Long CAMEL_SINK_ACTIVEMQ_COMPONENT_REQUEST_TIMEOUT_CHECKER_INTERVAL_DEFAULT = 1000L;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_TRANSFER_EXCEPTION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_TRANSFER_EXCHANGE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_TRUST_ALL_PACKAGES_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_USE_MESSAGE_IDAS_CORRELATION_IDDOC = "Specifies whether JMSMessageID should always be used as JMSCorrelationID for InOut messages.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_USE_MESSAGE_IDAS_CORRELATION_IDDEFAULT = false;
    ...
    private static final Integer CAMEL_SINK_ACTIVEMQ_COMPONENT_WAIT_FOR_PROVISION_CORRELATION_TO_BE_UPDATED_COUNTER_DEFAULT = 50;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_WAIT_FOR_PROVISION_CORRELATION_TO_BE_UPDATED_THREAD_SLEEPING_TIME_DOC = "Interval in millis to sleep each time while waiting for provisional correlation id to be updated.";
    private static final Long CAMEL_SINK_ACTIVEMQ_COMPONENT_WAIT_FOR_PROVISION_CORRELATION_TO_BE_UPDATED_THREAD_SLEEPING_TIME_DEFAULT = 100L;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_HEADER_FILTER_STRATEGY_DOC = "To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_PASSWORD_CONF = "camel.component.activemq.password";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_PASSWORD_DOC = "Password to use with the ConnectionFactory. You can also configure username/password directly on the ConnectionFactory.";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_USERNAME_CONF = "camel.component.activemq.username";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_USERNAME_DOC = "Username to use with the ConnectionFactory. You can also configure username/password directly on the ConnectionFactory.";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_TRANSACTED_CONF = "camel.component.activemq.transacted";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_TRANSACTED_DOC = "Specifies whether to use transacted mode";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_TRANSACTED_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_LAZY_CREATE_TRANSACTION_MANAGER_DOC = "If true, Camel will create a JmsTransactionManager, if there is no transactionManager injected when option transacted=true.";
    private static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_LAZY_CREATE_TRANSACTION_MANAGER_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_TRANSACTION_MANAGER_DOC = "The Spring transaction manager to use.";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_TRANSACTION_MANAGER_DEFAULT = null;
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_TRANSACTION_NAME_CONF = "camel.component.activemq.transactionName";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_TRANSACTION_NAME_DOC = "The name of the transaction to use.";
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_TRANSACTION_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_TRANSACTION_TIMEOUT_DOC = "The timeout value of the transaction (in seconds), if using transacted mode.";
    private static final Integer CAMEL_SINK_ACTIVEMQ_COMPONENT_TRANSACTION_TIMEOUT_DEFAULT = -1;
