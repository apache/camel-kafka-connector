...
public class CamelActivemqSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_BROKER_URLDOC = "Sets the broker URL to use to connect to ActiveMQ";
    ...
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_CONFIGURATION_DOC = "Configuration of ActiveMQ";
    ...
    public static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_USE_POOLED_CONNECTION_DEFAULT = false;
    ...
    public static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_EXPLICIT_QOS_ENABLED_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_FORMAT_DATE_HEADERS_TO_ISO_8601DOC = "Sets whether date headers should be formatted according to the ISO 8601 standard.";
    ...
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_ON_TIMEOUT_TO_MAX_CONCURRENT_CONSUMERS_CONF = "camel.component.activemq.replyOnTimeoutToMaxConcurrentConsumers";
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_ON_TIMEOUT_TO_MAX_CONCURRENT_CONSUMERS_DOC = "Specifies the maximum number of concurrent consumers for continue routing when timeout occurred when using request/reply over JMS.";
    public static final Integer CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_ON_TIMEOUT_TO_MAX_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_CORRELATION_PROPERTY_DOC = "Use this JMS property to correlate messages in InOut exchange pattern (request-reply) instead of JMSCorrelationID property. This allows you to exchange messages with systems that do not correlate messages using JMSCorrelationID JMS property. If used JMSCorrelationID will not be used or set by Camel. The value of here named property will be generated if not supplied in the header of the message under the same name.";
    ...
    public static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_ALLOW_AUTO_WIRED_CONNECTION_FACTORY_DEFAULT = false;
    ...
    public static final Boolean CAMEL_SINK_ACTIVEMQ_COMPONENT_ALLOW_AUTO_WIRED_DESTINATION_RESOLVER_DEFAULT = false;
    ...
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_JMS_OPERATIONS_CONF = "camel.component.activemq.jmsOperations";
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_JMS_OPERATIONS_DOC = "Allows you to use your own implementation of the org.springframework.jms.core.JmsOperations interface. Camel uses JmsTemplate as default. Can be used for testing purpose, but not used much as stated in the spring API docs.";
    public static final String CAMEL_SINK_ACTIVEMQ_COMPONENT_JMS_OPERATIONS_DEFAULT = null;
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SINK_ACTIVEMQ_COMPONENT_EXPLICIT_QOS_ENABLED_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_ACTIVEMQ_COMPONENT_EXPLICIT_QOS_ENABLED_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_ACTIVEMQ_COMPONENT_EXPLICIT_QOS_ENABLED_DOC);
        ...
        conf.define(CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_ON_TIMEOUT_TO_MAX_CONCURRENT_CONSUMERS_CONF, ConfigDef.Type.INT, CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_ON_TIMEOUT_TO_MAX_CONCURRENT_CONSUMERS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_ACTIVEMQ_COMPONENT_REPLY_ON_TIMEOUT_TO_MAX_CONCURRENT_CONSUMERS_DOC);
        ...
        conf.define(CAMEL_SINK_ACTIVEMQ_COMPONENT_JMS_OPERATIONS_CONF, ConfigDef.Type.STRING, CAMEL_SINK_ACTIVEMQ_COMPONENT_JMS_OPERATIONS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_ACTIVEMQ_COMPONENT_JMS_OPERATIONS_DOC);
