...
public class CamelPulsarSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_PULSAR_ENDPOINT_ALLOW_MANUAL_ACKNOWLEDGEMENT_DOC = "Whether to allow manual message acknowledgements. If this option is enabled, then messages are not immediately acknowledged after being consumed. Instead, an instance of PulsarMessageReceipt is stored as a header on the org.apache.camel.Exchange. Messages can then be acknowledged using PulsarMessageReceipt at any time before the ackTimeout occurs.";
    ...
    public static final String CAMEL_SOURCE_PULSAR_ENDPOINT_SUBSCRIPTION_TYPE_DOC = "Type of the subscription EXCLUSIVESHAREDFAILOVER, defaults to EXCLUSIVE One of: [EXCLUSIVE] [SHARED] [FAILOVER]";
    ...
    public static final String CAMEL_SOURCE_PULSAR_COMPONENT_ALLOW_MANUAL_ACKNOWLEDGEMENT_DOC = "Whether to allow manual message acknowledgements. If this option is enabled, then messages are not immediately acknowledged after being consumed. Instead, an instance of PulsarMessageReceipt is stored as a header on the org.apache.camel.Exchange. Messages can then be acknowledged using PulsarMessageReceipt at any time before the ackTimeout occurs.";
