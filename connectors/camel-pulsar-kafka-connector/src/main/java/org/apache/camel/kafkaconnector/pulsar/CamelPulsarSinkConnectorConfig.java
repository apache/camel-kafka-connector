...
public class CamelPulsarSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_PULSAR_ENDPOINT_AUTHENTICATION_CLASS_CONF = "camel.sink.endpoint.authenticationClass";
    public static final String CAMEL_SINK_PULSAR_ENDPOINT_AUTHENTICATION_CLASS_DOC = "The Authentication FQCN to be used while creating the client from URI";
    public static final String CAMEL_SINK_PULSAR_ENDPOINT_AUTHENTICATION_CLASS_DEFAULT = null;
    public static final String CAMEL_SINK_PULSAR_ENDPOINT_AUTHENTICATION_PARAMS_CONF = "camel.sink.endpoint.authenticationParams";
    public static final String CAMEL_SINK_PULSAR_ENDPOINT_AUTHENTICATION_PARAMS_DOC = "The Authentication Parameters to be used while creating the client from URI";
    public static final String CAMEL_SINK_PULSAR_ENDPOINT_AUTHENTICATION_PARAMS_DEFAULT = null;
    public static final String CAMEL_SINK_PULSAR_ENDPOINT_SERVICE_URL_CONF = "camel.sink.endpoint.serviceUrl";
    public static final String CAMEL_SINK_PULSAR_ENDPOINT_SERVICE_URL_DOC = "The Pulsar Service URL to point while creating the client from URI";
    public static final String CAMEL_SINK_PULSAR_ENDPOINT_SERVICE_URL_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_PULSAR_COMPONENT_AUTHENTICATION_CLASS_CONF = "camel.component.pulsar.authenticationClass";
    public static final String CAMEL_SINK_PULSAR_COMPONENT_AUTHENTICATION_CLASS_DOC = "The Authentication FQCN to be used while creating the client from URI";
    public static final String CAMEL_SINK_PULSAR_COMPONENT_AUTHENTICATION_CLASS_DEFAULT = null;
    public static final String CAMEL_SINK_PULSAR_COMPONENT_AUTHENTICATION_PARAMS_CONF = "camel.component.pulsar.authenticationParams";
    public static final String CAMEL_SINK_PULSAR_COMPONENT_AUTHENTICATION_PARAMS_DOC = "The Authentication Parameters to be used while creating the client from URI";
    public static final String CAMEL_SINK_PULSAR_COMPONENT_AUTHENTICATION_PARAMS_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_PULSAR_COMPONENT_SERVICE_URL_CONF = "camel.component.pulsar.serviceUrl";
    public static final String CAMEL_SINK_PULSAR_COMPONENT_SERVICE_URL_DOC = "The Pulsar Service URL to point while creating the client from URI";
    public static final String CAMEL_SINK_PULSAR_COMPONENT_SERVICE_URL_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_PULSAR_ENDPOINT_AUTHENTICATION_CLASS_CONF, ConfigDef.Type.STRING, CAMEL_SINK_PULSAR_ENDPOINT_AUTHENTICATION_CLASS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_PULSAR_ENDPOINT_AUTHENTICATION_CLASS_DOC);
        conf.define(CAMEL_SINK_PULSAR_ENDPOINT_AUTHENTICATION_PARAMS_CONF, ConfigDef.Type.STRING, CAMEL_SINK_PULSAR_ENDPOINT_AUTHENTICATION_PARAMS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_PULSAR_ENDPOINT_AUTHENTICATION_PARAMS_DOC);
        conf.define(CAMEL_SINK_PULSAR_ENDPOINT_SERVICE_URL_CONF, ConfigDef.Type.STRING, CAMEL_SINK_PULSAR_ENDPOINT_SERVICE_URL_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_PULSAR_ENDPOINT_SERVICE_URL_DOC);
        ...
        conf.define(CAMEL_SINK_PULSAR_COMPONENT_AUTHENTICATION_CLASS_CONF, ConfigDef.Type.STRING, CAMEL_SINK_PULSAR_COMPONENT_AUTHENTICATION_CLASS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_PULSAR_COMPONENT_AUTHENTICATION_CLASS_DOC);
        conf.define(CAMEL_SINK_PULSAR_COMPONENT_AUTHENTICATION_PARAMS_CONF, ConfigDef.Type.STRING, CAMEL_SINK_PULSAR_COMPONENT_AUTHENTICATION_PARAMS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_PULSAR_COMPONENT_AUTHENTICATION_PARAMS_DOC);
        ...
        conf.define(CAMEL_SINK_PULSAR_COMPONENT_SERVICE_URL_CONF, ConfigDef.Type.STRING, CAMEL_SINK_PULSAR_COMPONENT_SERVICE_URL_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_PULSAR_COMPONENT_SERVICE_URL_DOC);
