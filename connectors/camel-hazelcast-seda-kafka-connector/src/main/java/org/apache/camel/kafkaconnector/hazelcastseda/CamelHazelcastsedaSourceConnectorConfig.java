...
public class CamelHazelcastsedaSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_PATH_CACHE_NAME_DOC = "The name of the cache";
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_PATH_CACHE_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_DEFAULT_OPERATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_HAZELCAST_INSTANCE_DOC = "The hazelcast instance reference which can be used for hazelcast endpoint.";
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_HAZELCAST_INSTANCE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_HAZELCAST_INSTANCE_NAME_DOC = "The hazelcast instance reference name which can be used for hazelcast endpoint. If you don't specify the instance reference, camel use the default hazelcast instance from the camel-hazelcast instance.";
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_HAZELCAST_INSTANCE_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    public static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.source.endpoint.basicPropertyBinding";
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_CONCURRENT_CONSUMERS_DOC = "To use concurrent consumers polling from the SEDA queue.";
    private static final Integer CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_CONCURRENT_CONSUMERS_DEFAULT = 1;
    public static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_ON_ERROR_DELAY_CONF = "camel.source.endpoint.onErrorDelay";
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_ON_ERROR_DELAY_DOC = "Milliseconds before consumer continues polling after an error has occurred.";
    private static final Integer CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_ON_ERROR_DELAY_DEFAULT = 1000;
    public static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_POLL_TIMEOUT_CONF = "camel.source.endpoint.pollTimeout";
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_POLL_TIMEOUT_DOC = "The timeout used when consuming from the SEDA queue. When a timeout occurs, the consumer can check whether it is allowed to continue running. Setting a lower value allows the consumer to react more quickly upon shutdown.";
    private static final Integer CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_POLL_TIMEOUT_DEFAULT = 1000;
    public static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_TRANSACTED_CONF = "camel.source.endpoint.transacted";
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_TRANSACTED_DOC = "If set to true then the consumer runs in transaction mode, where the messages in the seda queue will only be removed if the transaction commits, which happens when the processing is complete.";
    private static final Boolean CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_TRANSACTED_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_TRANSFER_EXCHANGE_DOC = "If set to true the whole Exchange will be transfered. If header or body contains not serializable objects, they will be skipped.";
    private static final Boolean CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_TRANSFER_EXCHANGE_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_HAZELCASTSEDA_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_HAZELCASTSEDA_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.hazelcast-seda.basicPropertyBinding";
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_HAZELCASTSEDA_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_COMPONENT_HAZELCAST_INSTANCE_DOC = "The hazelcast instance reference which can be used for hazelcast endpoint. If you don't specify the instance reference, camel use the default hazelcast instance from the camel-hazelcast instance.";
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_COMPONENT_HAZELCAST_INSTANCE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_COMPONENT_HAZELCAST_MODE_DOC = "The hazelcast mode reference which kind of instance should be used. If you don't specify the mode, then the node mode will be the default.";
    private static final String CAMEL_SOURCE_HAZELCASTSEDA_COMPONENT_HAZELCAST_MODE_DEFAULT = "node";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
        conf.define(CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_SYNCHRONOUS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_SYNCHRONOUS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_HAZELCASTSEDA_ENDPOINT_SYNCHRONOUS_DOC);
