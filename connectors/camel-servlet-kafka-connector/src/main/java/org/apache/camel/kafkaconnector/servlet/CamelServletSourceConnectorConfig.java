...
public class CamelServletSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_SERVLET_PATH_CONTEXT_PATH_DOC = "The context-path to use";
    private static final String CAMEL_SOURCE_SERVLET_PATH_CONTEXT_PATH_DEFAULT = null;
    public static final String CAMEL_SOURCE_SERVLET_ENDPOINT_CHUNKED_CONF = "camel.source.endpoint.chunked";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_CHUNKED_DOC = "If this option is false the Servlet will disable the HTTP streaming and set the content-length header on the response";
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_CHUNKED_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_DISABLE_STREAM_CACHE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_SERVLET_ENDPOINT_HTTP_BINDING_CONF = "camel.source.endpoint.httpBinding";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_HTTP_BINDING_DOC = "To use a custom HttpBinding to control the mapping between Camel message and HttpClient.";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_HTTP_BINDING_DEFAULT = null;
    public static final String CAMEL_SOURCE_SERVLET_ENDPOINT_ASYNC_CONF = "camel.source.endpoint.async";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_ASYNC_DOC = "Configure the consumer to work in async mode";
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_ASYNC_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_HTTP_METHOD_RESTRICT_DOC = "Used to only allow consuming if the HttpMethod matches, such as GET/POST/PUT etc. Multiple methods can be specified separated by comma.";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_HTTP_METHOD_RESTRICT_DEFAULT = null;
    public static final String CAMEL_SOURCE_SERVLET_ENDPOINT_MATCH_ON_URI_PREFIX_CONF = "camel.source.endpoint.matchOnUriPrefix";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_MATCH_ON_URI_PREFIX_DOC = "Whether or not the consumer should try to find a target consumer by matching the URI prefix if no exact match is found.";
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_MATCH_ON_URI_PREFIX_DEFAULT = false;
    public static final String CAMEL_SOURCE_SERVLET_ENDPOINT_MUTE_EXCEPTION_CONF = "camel.source.endpoint.muteException";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_MUTE_EXCEPTION_DOC = "If enabled and an Exchange failed processing on the consumer side the response's body won't contain the exception's stack trace.";
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_MUTE_EXCEPTION_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_RESPONSE_BUFFER_SIZE_DOC = "To use a custom buffer size on the javax.servlet.ServletResponse.";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_RESPONSE_BUFFER_SIZE_DEFAULT = null;
    public static final String CAMEL_SOURCE_SERVLET_ENDPOINT_SERVLET_NAME_CONF = "camel.source.endpoint.servletName";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_SERVLET_NAME_DOC = "Name of the servlet to use";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_SERVLET_NAME_DEFAULT = "CamelServlet";
    ...
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_TRANSFER_EXCEPTION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_ATTACHMENT_MULTIPART_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_EAGER_CHECK_CONTENT_AVAILABLE_DOC = "Whether to eager check whether the HTTP requests has content if the content-length header is 0 or not present. This can be turned on in case HTTP clients do not send streamed data.";
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_EAGER_CHECK_CONTENT_AVAILABLE_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_SERVLET_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_FILE_NAME_EXT_WHITELIST_DOC = "Whitelist of accepted filename extensions for accepting uploaded files. Multiple extensions can be separated by comma, such as txt,xml.";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_FILE_NAME_EXT_WHITELIST_DEFAULT = null;
    public static final String CAMEL_SOURCE_SERVLET_ENDPOINT_OPTIONS_ENABLED_CONF = "camel.source.endpoint.optionsEnabled";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_OPTIONS_ENABLED_DOC = "Specifies whether to enable HTTP OPTIONS for this Servlet consumer. By default OPTIONS is turned off.";
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_OPTIONS_ENABLED_DEFAULT = false;
    public static final String CAMEL_SOURCE_SERVLET_ENDPOINT_TRACE_ENABLED_CONF = "camel.source.endpoint.traceEnabled";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_TRACE_ENABLED_DOC = "Specifies whether to enable HTTP TRACE for this Servlet consumer. By default TRACE is turned off.";
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_TRACE_ENABLED_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_MAP_HTTP_MESSAGE_BODY_DOC = "If this option is true then IN exchange Body of the exchange will be mapped to HTTP body. Setting this to false will avoid the HTTP mapping.";
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_MAP_HTTP_MESSAGE_BODY_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_MAP_HTTP_MESSAGE_FORM_URL_ENCODED_BODY_DOC = "If this option is true then IN exchange Form Encoded body of the exchange will be mapped to HTTP. Setting this to false will avoid the HTTP Form Encoded body mapping.";
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_MAP_HTTP_MESSAGE_FORM_URL_ENCODED_BODY_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_MAP_HTTP_MESSAGE_HEADERS_DOC = "If this option is true then IN exchange Headers of the exchange will be mapped to HTTP headers. Setting this to false will avoid the HTTP Headers mapping.";
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_MAP_HTTP_MESSAGE_HEADERS_DEFAULT = true;
    public static final String CAMEL_SOURCE_SERVLET_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_SERVLET_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_SERVLET_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_SERVLET_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_SERVLET_COMPONENT_SERVLET_NAME_CONF = "camel.component.servlet.servletName";
    private static final String CAMEL_SOURCE_SERVLET_COMPONENT_SERVLET_NAME_DOC = "Default name of servlet to use. The default name is CamelServlet.";
    private static final String CAMEL_SOURCE_SERVLET_COMPONENT_SERVLET_NAME_DEFAULT = "CamelServlet";
    ...
    private static final Boolean CAMEL_SOURCE_SERVLET_COMPONENT_ATTACHMENT_MULTIPART_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SERVLET_COMPONENT_FILE_NAME_EXT_WHITELIST_DOC = "Whitelist of accepted filename extensions for accepting uploaded files. Multiple extensions can be separated by comma, such as txt,xml.";
    private static final String CAMEL_SOURCE_SERVLET_COMPONENT_FILE_NAME_EXT_WHITELIST_DEFAULT = null;
    public static final String CAMEL_SOURCE_SERVLET_COMPONENT_HTTP_REGISTRY_CONF = "camel.component.servlet.httpRegistry";
    private static final String CAMEL_SOURCE_SERVLET_COMPONENT_HTTP_REGISTRY_DOC = "To use a custom org.apache.camel.component.servlet.HttpRegistry.";
    private static final String CAMEL_SOURCE_SERVLET_COMPONENT_HTTP_REGISTRY_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_SERVLET_COMPONENT_ALLOW_JAVA_SERIALIZED_OBJECT_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_SERVLET_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_SERVLET_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_SERVLET_COMPONENT_HTTP_BINDING_CONF = "camel.component.servlet.httpBinding";
    private static final String CAMEL_SOURCE_SERVLET_COMPONENT_HTTP_BINDING_DOC = "To use a custom HttpBinding to control the mapping between Camel message and HttpClient.";
    private static final String CAMEL_SOURCE_SERVLET_COMPONENT_HTTP_BINDING_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SERVLET_COMPONENT_HTTP_CONFIGURATION_DOC = "To use the shared HttpConfiguration as base configuration.";
    private static final String CAMEL_SOURCE_SERVLET_COMPONENT_HTTP_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_SERVLET_COMPONENT_HEADER_FILTER_STRATEGY_DOC = "To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_SERVLET_COMPONENT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_SERVLET_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_SERVLET_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_SERVLET_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
