...
public class CamelAwsec2sinkSinkConnectorConfig
        extends
    ...
    public static final String CAMEL_SINK_AWSEC2SINK_KAMELET_USE_DEFAULT_CREDENTIALS_PROVIDER_DOC = "If true, the EC2 client loads credentials through a default credentials provider. If false, it uses the basic authentication method (access key and secret key).";
    public static final Boolean CAMEL_SINK_AWSEC2SINK_KAMELET_USE_DEFAULT_CREDENTIALS_PROVIDER_DEFAULT = false;
    public static final String CAMEL_SINK_AWSEC2SINK_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_CONF = "camel.kamelet.aws-ec2-sink.useProfileCredentialsProvider";
    public static final String CAMEL_SINK_AWSEC2SINK_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DOC = "Set whether the EC2 client should expect to load credentials through a profile credentials provider.";
    public static final Boolean CAMEL_SINK_AWSEC2SINK_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DEFAULT = false;
    public static final String CAMEL_SINK_AWSEC2SINK_KAMELET_USE_SESSION_CREDENTIALS_CONF = "camel.kamelet.aws-ec2-sink.useSessionCredentials";
    ...
    public static final String CAMEL_SINK_AWSEC2SINK_KAMELET_SESSION_TOKEN_DEFAULT = null;
    ...
    public CamelAwsec2sinkSinkConnectorConfig(Map<String, String> parsedConfig) {
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_AWSEC2SINK_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_AWSEC2SINK_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWSEC2SINK_KAMELET_USE_PROFILE_CREDENTIALS_PROVIDER_DOC);
        conf.define(CAMEL_SINK_AWSEC2SINK_KAMELET_USE_SESSION_CREDENTIALS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_AWSEC2SINK_KAMELET_USE_SESSION_CREDENTIALS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWSEC2SINK_KAMELET_USE_SESSION_CREDENTIALS_DOC);
        conf.define(CAMEL_SINK_AWSEC2SINK_KAMELET_PROFILE_CREDENTIALS_NAME_CONF, ConfigDef.Type.STRING, CAMEL_SINK_AWSEC2SINK_KAMELET_PROFILE_CREDENTIALS_NAME_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWSEC2SINK_KAMELET_PROFILE_CREDENTIALS_NAME_DOC);
        conf.define(CAMEL_SINK_AWSEC2SINK_KAMELET_SESSION_TOKEN_CONF, ConfigDef.Type.PASSWORD, CAMEL_SINK_AWSEC2SINK_KAMELET_SESSION_TOKEN_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_AWSEC2SINK_KAMELET_SESSION_TOKEN_DOC);
