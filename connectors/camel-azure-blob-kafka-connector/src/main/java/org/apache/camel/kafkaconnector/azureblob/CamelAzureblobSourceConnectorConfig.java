...
public class CamelAzureblobSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_PATH_CONTAINER_OR_BLOB_URI_DOC = "Container or Blob compact Uri";
    private static final String CAMEL_SOURCE_AZUREBLOB_PATH_CONTAINER_OR_BLOB_URI_DEFAULT = null;
    public static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_AZURE_BLOB_CLIENT_CONF = "camel.source.endpoint.azureBlobClient";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_AZURE_BLOB_CLIENT_DOC = "The blob service client";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_AZURE_BLOB_CLIENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_BLOB_OFFSET_CONF = "camel.source.endpoint.blobOffset";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_BLOB_OFFSET_DOC = "Set the blob offset for the upload or download operations, default is 0";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_BLOB_OFFSET_DEFAULT = "0";
    public static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_BLOB_TYPE_CONF = "camel.source.endpoint.blobType";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_BLOB_TYPE_DOC = "Set a blob type, 'blockblob' is default One of: [blockblob] [appendblob] [pageblob]";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_BLOB_TYPE_DEFAULT = "blockblob";
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_CLOSE_STREAM_AFTER_READ_DOC = "Close the stream after read or keep it open, default is true";
    private static final Boolean CAMEL_SOURCE_AZUREBLOB_ENDPOINT_CLOSE_STREAM_AFTER_READ_DEFAULT = true;
    public static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_CREDENTIALS_CONF = "camel.source.endpoint.credentials";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_CREDENTIALS_DOC = "Set the storage credentials, required in most cases";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_CREDENTIALS_DEFAULT = null;
    public static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_DATA_LENGTH_CONF = "camel.source.endpoint.dataLength";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_DATA_LENGTH_DOC = "Set the data length for the download or page blob upload operations";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_DATA_LENGTH_DEFAULT = null;
    public static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_FILE_DIR_CONF = "camel.source.endpoint.fileDir";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_FILE_DIR_DOC = "Set the file directory where the downloaded blobs will be saved to";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_FILE_DIR_DEFAULT = null;
    public static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_PUBLIC_FOR_READ_CONF = "camel.source.endpoint.publicForRead";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_PUBLIC_FOR_READ_DOC = "Storage resources can be public for reading their content, if this property is enabled then the credentials do not have to be set";
    private static final Boolean CAMEL_SOURCE_AZUREBLOB_ENDPOINT_PUBLIC_FOR_READ_DEFAULT = false;
    public static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_STREAM_READ_SIZE_CONF = "camel.source.endpoint.streamReadSize";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_STREAM_READ_SIZE_DOC = "Set the minimum read size in bytes when reading the blob content";
    private static final Integer CAMEL_SOURCE_AZUREBLOB_ENDPOINT_STREAM_READ_SIZE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_VALIDATE_CLIENT_URIDOC = "Whether to validate the Azure client URI";
    private static final Boolean CAMEL_SOURCE_AZUREBLOB_ENDPOINT_VALIDATE_CLIENT_URIDEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_AZUREBLOB_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_AZUREBLOB_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_AZUREBLOB_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_CREDENTIALS_ACCOUNT_KEY_DOC = "Set the storage account key used during authentication phase";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_CREDENTIALS_ACCOUNT_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_CREDENTIALS_ACCOUNT_NAME_DOC = "Set the storage account name used during authentication phase";
    private static final String CAMEL_SOURCE_AZUREBLOB_ENDPOINT_CREDENTIALS_ACCOUNT_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_AZURE_BLOB_CLIENT_DOC = "The blob service client";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_AZURE_BLOB_CLIENT_DEFAULT = null;
    public static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_BLOB_OFFSET_CONF = "camel.component.azure-blob.blobOffset";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_BLOB_OFFSET_DOC = "Set the blob offset for the upload or download operations, default is 0";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_BLOB_OFFSET_DEFAULT = "0";
    public static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_BLOB_TYPE_CONF = "camel.component.azure-blob.blobType";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_BLOB_TYPE_DOC = "Set a blob type, 'blockblob' is default One of: [blockblob] [appendblob] [pageblob]";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_BLOB_TYPE_DEFAULT = "blockblob";
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_CLOSE_STREAM_AFTER_READ_DOC = "Close the stream after read or keep it open, default is true";
    private static final Boolean CAMEL_SOURCE_AZUREBLOB_COMPONENT_CLOSE_STREAM_AFTER_READ_DEFAULT = true;
    public static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_CREDENTIALS_CONF = "camel.component.azure-blob.credentials";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_CREDENTIALS_DOC = "Set the storage credentials, required in most cases";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_CREDENTIALS_DEFAULT = null;
    public static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_DATA_LENGTH_CONF = "camel.component.azure-blob.dataLength";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_DATA_LENGTH_DOC = "Set the data length for the download or page blob upload operations";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_DATA_LENGTH_DEFAULT = null;
    public static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_FILE_DIR_CONF = "camel.component.azure-blob.fileDir";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_FILE_DIR_DOC = "Set the file directory where the downloaded blobs will be saved to";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_FILE_DIR_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_PUBLIC_FOR_READ_DOC = "Storage resources can be public for reading their content, if this property is enabled then the credentials do not have to be set";
    private static final Boolean CAMEL_SOURCE_AZUREBLOB_COMPONENT_PUBLIC_FOR_READ_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_STREAM_READ_SIZE_DOC = "Set the minimum read size in bytes when reading the blob content";
    private static final Integer CAMEL_SOURCE_AZUREBLOB_COMPONENT_STREAM_READ_SIZE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_VALIDATE_CLIENT_URIDOC = "Whether to validate the Azure client URI";
    private static final Boolean CAMEL_SOURCE_AZUREBLOB_COMPONENT_VALIDATE_CLIENT_URIDEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_AZUREBLOB_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_AZUREBLOB_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_CONFIGURATION_CONF = "camel.component.azure-blob.configuration";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_CONFIGURATION_DOC = "The Blob Service configuration";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_CREDENTIALS_ACCOUNT_KEY_DOC = "Set the storage account key used during authentication phase";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_CREDENTIALS_ACCOUNT_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_CREDENTIALS_ACCOUNT_NAME_DOC = "Set the storage account name used during authentication phase";
    private static final String CAMEL_SOURCE_AZUREBLOB_COMPONENT_CREDENTIALS_ACCOUNT_NAME_DEFAULT = null;
