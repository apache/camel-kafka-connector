...
public class CamelMllpSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_MLLP_PATH_HOSTNAME_DOC = "Hostname or IP for connection for the TCP connection. The default value is null, which means any local IP address";
    private static final String CAMEL_SINK_MLLP_PATH_HOSTNAME_DEFAULT = null;
    public static final String CAMEL_SINK_MLLP_PATH_PORT_CONF = "camel.sink.path.port";
    private static final String CAMEL_SINK_MLLP_PATH_PORT_DOC = "Port number for the TCP connection";
    private static final Integer CAMEL_SINK_MLLP_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SINK_MLLP_ENDPOINT_AUTO_ACK_CONF = "camel.sink.endpoint.autoAck";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_AUTO_ACK_DOC = "Enable/Disable the automatic generation of a MLLP Acknowledgement MLLP Consumers only";
    private static final Boolean CAMEL_SINK_MLLP_ENDPOINT_AUTO_ACK_DEFAULT = true;
    public static final String CAMEL_SINK_MLLP_ENDPOINT_BUFFER_WRITES_CONF = "camel.sink.endpoint.bufferWrites";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_BUFFER_WRITES_DOC = "Enable/Disable the buffering of HL7 payloads before writing to the socket.";
    private static final Boolean CAMEL_SINK_MLLP_ENDPOINT_BUFFER_WRITES_DEFAULT = false;
    public static final String CAMEL_SINK_MLLP_ENDPOINT_HL_7HEADERS_CONF = "camel.sink.endpoint.hl7Headers";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_HL_7HEADERS_DOC = "Enable/Disable the automatic generation of message headers from the HL7 Message MLLP Consumers only";
    private static final Boolean CAMEL_SINK_MLLP_ENDPOINT_HL_7HEADERS_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_MLLP_ENDPOINT_REQUIRE_END_OF_DATA_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_MLLP_ENDPOINT_STRING_PAYLOAD_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_MLLP_ENDPOINT_VALIDATE_PAYLOAD_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_MLLP_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_MLLP_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_MLLP_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_MLLP_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used (this component only supports synchronous operations).";
    private static final Boolean CAMEL_SINK_MLLP_ENDPOINT_SYNCHRONOUS_DEFAULT = true;
    public static final String CAMEL_SINK_MLLP_ENDPOINT_CHARSET_NAME_CONF = "camel.sink.endpoint.charsetName";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_CHARSET_NAME_DOC = "Set the CamelCharsetName property on the exchange";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_CHARSET_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_MLLP_ENDPOINT_KEEP_ALIVE_CONF = "camel.sink.endpoint.keepAlive";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_KEEP_ALIVE_DOC = "Enable/disable the SO_KEEPALIVE socket option.";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_KEEP_ALIVE_DEFAULT = "true";
    public static final String CAMEL_SINK_MLLP_ENDPOINT_RECEIVE_BUFFER_SIZE_CONF = "camel.sink.endpoint.receiveBufferSize";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_RECEIVE_BUFFER_SIZE_DOC = "Sets the SO_RCVBUF option to the specified value (in bytes)";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_RECEIVE_BUFFER_SIZE_DEFAULT = "8192";
    public static final String CAMEL_SINK_MLLP_ENDPOINT_SEND_BUFFER_SIZE_CONF = "camel.sink.endpoint.sendBufferSize";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_SEND_BUFFER_SIZE_DOC = "Sets the SO_SNDBUF option to the specified value (in bytes)";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_SEND_BUFFER_SIZE_DEFAULT = "8192";
    public static final String CAMEL_SINK_MLLP_ENDPOINT_TCP_NO_DELAY_CONF = "camel.sink.endpoint.tcpNoDelay";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_TCP_NO_DELAY_DOC = "Enable/disable the TCP_NODELAY socket option.";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_TCP_NO_DELAY_DEFAULT = "true";
    public static final String CAMEL_SINK_MLLP_ENDPOINT_CONNECT_TIMEOUT_CONF = "camel.sink.endpoint.connectTimeout";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_CONNECT_TIMEOUT_DOC = "Timeout (in milliseconds) for establishing for a TCP connection TCP Client only";
    private static final Integer CAMEL_SINK_MLLP_ENDPOINT_CONNECT_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SINK_MLLP_ENDPOINT_IDLE_TIMEOUT_CONF = "camel.sink.endpoint.idleTimeout";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_IDLE_TIMEOUT_DOC = "The approximate idle time allowed before the Client TCP Connection will be reset. A null value or a value less than or equal to zero will disable the idle timeout.";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_IDLE_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SINK_MLLP_ENDPOINT_READ_TIMEOUT_CONF = "camel.sink.endpoint.readTimeout";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_READ_TIMEOUT_DOC = "The SO_TIMEOUT value (in milliseconds) used after the start of an MLLP frame has been received";
    private static final Integer CAMEL_SINK_MLLP_ENDPOINT_READ_TIMEOUT_DEFAULT = 5000;
    public static final String CAMEL_SINK_MLLP_ENDPOINT_RECEIVE_TIMEOUT_CONF = "camel.sink.endpoint.receiveTimeout";
    private static final String CAMEL_SINK_MLLP_ENDPOINT_RECEIVE_TIMEOUT_DOC = "The SO_TIMEOUT value (in milliseconds) used when waiting for the start of an MLLP frame";
    private static final Integer CAMEL_SINK_MLLP_ENDPOINT_RECEIVE_TIMEOUT_DEFAULT = 15000;
    ...
    private static final Boolean CAMEL_SINK_MLLP_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_MLLP_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_MLLP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_MLLP_COMPONENT_DEFAULT_CHARSET_CONF = "camel.component.mllp.defaultCharset";
    private static final String CAMEL_SINK_MLLP_COMPONENT_DEFAULT_CHARSET_DOC = "Set the default character set to use for byte to/from String conversions.";
    private static final String CAMEL_SINK_MLLP_COMPONENT_DEFAULT_CHARSET_DEFAULT = "ISO-8859-1";
    public static final String CAMEL_SINK_MLLP_COMPONENT_LOG_PHI_CONF = "camel.component.mllp.logPhi";
    private static final String CAMEL_SINK_MLLP_COMPONENT_LOG_PHI_DOC = "Set the component to log PHI data.";
    private static final String CAMEL_SINK_MLLP_COMPONENT_LOG_PHI_DEFAULT = "true";
    public static final String CAMEL_SINK_MLLP_COMPONENT_LOG_PHI_MAX_BYTES_CONF = "camel.component.mllp.logPhiMaxBytes";
    private static final String CAMEL_SINK_MLLP_COMPONENT_LOG_PHI_MAX_BYTES_DOC = "Set the maximum number of bytes of PHI that will be logged in a log entry.";
    private static final String CAMEL_SINK_MLLP_COMPONENT_LOG_PHI_MAX_BYTES_DEFAULT = "5120";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_MLLP_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_MLLP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_MLLP_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
