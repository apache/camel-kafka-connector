...
public class CamelMllpSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_MLLP_COMPONENT_CONFIGURATION_CONF = "camel.component.mllp.configuration";
    public static final String CAMEL_SOURCE_MLLP_COMPONENT_CONFIGURATION_DOC = "Sets the default configuration to use when creating MLLP endpoints.";
    public static final String CAMEL_SOURCE_MLLP_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SOURCE_MLLP_COMPONENT_CONFIGURATION_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_MLLP_COMPONENT_CONFIGURATION_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_MLLP_COMPONENT_CONFIGURATION_DOC);
