...
public class CamelMllpSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_MLLP_PATH_HOSTNAME_DOC = "Hostname or IP for connection for the TCP connection. The default value is null, which means any local IP address";
    private static final String CAMEL_SOURCE_MLLP_PATH_HOSTNAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_MLLP_PATH_PORT_CONF = "camel.source.path.port";
    private static final String CAMEL_SOURCE_MLLP_PATH_PORT_DOC = "Port number for the TCP connection";
    private static final Integer CAMEL_SOURCE_MLLP_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_AUTO_ACK_CONF = "camel.source.endpoint.autoAck";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_AUTO_ACK_DOC = "Enable/Disable the automatic generation of a MLLP Acknowledgement MLLP Consumers only";
    private static final Boolean CAMEL_SOURCE_MLLP_ENDPOINT_AUTO_ACK_DEFAULT = true;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_BUFFER_WRITES_CONF = "camel.source.endpoint.bufferWrites";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_BUFFER_WRITES_DOC = "Enable/Disable the buffering of HL7 payloads before writing to the socket.";
    private static final Boolean CAMEL_SOURCE_MLLP_ENDPOINT_BUFFER_WRITES_DEFAULT = false;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_HL_7HEADERS_CONF = "camel.source.endpoint.hl7Headers";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_HL_7HEADERS_DOC = "Enable/Disable the automatic generation of message headers from the HL7 Message MLLP Consumers only";
    private static final Boolean CAMEL_SOURCE_MLLP_ENDPOINT_HL_7HEADERS_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_MLLP_ENDPOINT_REQUIRE_END_OF_DATA_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_MLLP_ENDPOINT_STRING_PAYLOAD_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_MLLP_ENDPOINT_VALIDATE_PAYLOAD_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SOURCE_MLLP_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = true;
    ...
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = "InOut";
    ...
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_MLLP_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used (this component only supports synchronous operations).";
    private static final Boolean CAMEL_SOURCE_MLLP_ENDPOINT_SYNCHRONOUS_DEFAULT = true;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_CHARSET_NAME_CONF = "camel.source.endpoint.charsetName";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_CHARSET_NAME_DOC = "Set the CamelCharsetName property on the exchange";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_CHARSET_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_BACKLOG_CONF = "camel.source.endpoint.backlog";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_BACKLOG_DOC = "The maximum queue length for incoming connection indications (a request to connect) is set to the backlog parameter. If a connection indication arrives when the queue is full, the connection is refused.";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_BACKLOG_DEFAULT = "5";
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_LENIENT_BIND_CONF = "camel.source.endpoint.lenientBind";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_LENIENT_BIND_DOC = "TCP Server Only - Allow the endpoint to start before the TCP ServerSocket is bound. In some environments, it may be desirable to allow the endpoint to start before the TCP ServerSocket is bound.";
    private static final Boolean CAMEL_SOURCE_MLLP_ENDPOINT_LENIENT_BIND_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_MAX_CONCURRENT_CONSUMERS_DOC = "The maximum number of concurrent MLLP Consumer connections that will be allowed. If a new connection is received and the maximum is number are already established, the new connection will be reset immediately.";
    private static final Integer CAMEL_SOURCE_MLLP_ENDPOINT_MAX_CONCURRENT_CONSUMERS_DEFAULT = 5;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_RECEIVE_BUFFER_SIZE_CONF = "camel.source.endpoint.receiveBufferSize";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_RECEIVE_BUFFER_SIZE_DOC = "Sets the SO_RCVBUF option to the specified value (in bytes)";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_RECEIVE_BUFFER_SIZE_DEFAULT = "8192";
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_REUSE_ADDRESS_CONF = "camel.source.endpoint.reuseAddress";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_REUSE_ADDRESS_DOC = "Enable/disable the SO_REUSEADDR socket option.";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_REUSE_ADDRESS_DEFAULT = "false";
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_SEND_BUFFER_SIZE_CONF = "camel.source.endpoint.sendBufferSize";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_SEND_BUFFER_SIZE_DOC = "Sets the SO_SNDBUF option to the specified value (in bytes)";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_SEND_BUFFER_SIZE_DEFAULT = "8192";
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_ACCEPT_TIMEOUT_CONF = "camel.source.endpoint.acceptTimeout";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_ACCEPT_TIMEOUT_DOC = "Timeout (in milliseconds) while waiting for a TCP connection TCP Server Only";
    private static final Integer CAMEL_SOURCE_MLLP_ENDPOINT_ACCEPT_TIMEOUT_DEFAULT = 60000;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_BIND_RETRY_INTERVAL_CONF = "camel.source.endpoint.bindRetryInterval";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_BIND_RETRY_INTERVAL_DOC = "TCP Server Only - The number of milliseconds to wait between bind attempts";
    private static final Integer CAMEL_SOURCE_MLLP_ENDPOINT_BIND_RETRY_INTERVAL_DEFAULT = 5000;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_BIND_TIMEOUT_CONF = "camel.source.endpoint.bindTimeout";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_BIND_TIMEOUT_DOC = "TCP Server Only - The number of milliseconds to retry binding to a server port";
    private static final Integer CAMEL_SOURCE_MLLP_ENDPOINT_BIND_TIMEOUT_DEFAULT = 30000;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_IDLE_TIMEOUT_CONF = "camel.source.endpoint.idleTimeout";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_IDLE_TIMEOUT_DOC = "The approximate idle time allowed before the Client TCP Connection will be reset. A null value or a value less than or equal to zero will disable the idle timeout.";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_IDLE_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_MAX_RECEIVE_TIMEOUTS_CONF = "camel.source.endpoint.maxReceiveTimeouts";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_MAX_RECEIVE_TIMEOUTS_DOC = "The maximum number of timeouts (specified by receiveTimeout) allowed before the TCP Connection will be reset.";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_MAX_RECEIVE_TIMEOUTS_DEFAULT = null;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_READ_TIMEOUT_CONF = "camel.source.endpoint.readTimeout";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_READ_TIMEOUT_DOC = "The SO_TIMEOUT value (in milliseconds) used after the start of an MLLP frame has been received";
    private static final Integer CAMEL_SOURCE_MLLP_ENDPOINT_READ_TIMEOUT_DEFAULT = 5000;
    public static final String CAMEL_SOURCE_MLLP_ENDPOINT_RECEIVE_TIMEOUT_CONF = "camel.source.endpoint.receiveTimeout";
    private static final String CAMEL_SOURCE_MLLP_ENDPOINT_RECEIVE_TIMEOUT_DOC = "The SO_TIMEOUT value (in milliseconds) used when waiting for the start of an MLLP frame";
    private static final Integer CAMEL_SOURCE_MLLP_ENDPOINT_RECEIVE_TIMEOUT_DEFAULT = 15000;
    ...
    private static final Boolean CAMEL_SOURCE_MLLP_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_MLLP_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_MLLP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_MLLP_COMPONENT_DEFAULT_CHARSET_CONF = "camel.component.mllp.defaultCharset";
    private static final String CAMEL_SOURCE_MLLP_COMPONENT_DEFAULT_CHARSET_DOC = "Set the default character set to use for byte to/from String conversions.";
    private static final String CAMEL_SOURCE_MLLP_COMPONENT_DEFAULT_CHARSET_DEFAULT = "ISO-8859-1";
    public static final String CAMEL_SOURCE_MLLP_COMPONENT_LOG_PHI_CONF = "camel.component.mllp.logPhi";
    private static final String CAMEL_SOURCE_MLLP_COMPONENT_LOG_PHI_DOC = "Set the component to log PHI data.";
    private static final String CAMEL_SOURCE_MLLP_COMPONENT_LOG_PHI_DEFAULT = "true";
    public static final String CAMEL_SOURCE_MLLP_COMPONENT_LOG_PHI_MAX_BYTES_CONF = "camel.component.mllp.logPhiMaxBytes";
    private static final String CAMEL_SOURCE_MLLP_COMPONENT_LOG_PHI_MAX_BYTES_DOC = "Set the maximum number of bytes of PHI that will be logged in a log entry.";
    private static final String CAMEL_SOURCE_MLLP_COMPONENT_LOG_PHI_MAX_BYTES_DEFAULT = "5120";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_MLLP_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_MLLP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_MLLP_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
