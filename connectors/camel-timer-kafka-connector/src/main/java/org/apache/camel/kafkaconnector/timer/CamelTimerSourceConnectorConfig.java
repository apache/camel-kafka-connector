...
public class CamelTimerSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_TIMER_PATH_TIMER_NAME_DOC = "The name of the timer";
    private static final String CAMEL_SOURCE_TIMER_PATH_TIMER_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_TIMER_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_TIMER_ENDPOINT_DELAY_CONF = "camel.source.endpoint.delay";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_DELAY_DOC = "Delay before first event is triggered.";
    private static final Long CAMEL_SOURCE_TIMER_ENDPOINT_DELAY_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_TIMER_ENDPOINT_FIXED_RATE_CONF = "camel.source.endpoint.fixedRate";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_FIXED_RATE_DOC = "Events take place at approximately regular intervals, separated by the specified period.";
    private static final Boolean CAMEL_SOURCE_TIMER_ENDPOINT_FIXED_RATE_DEFAULT = false;
    public static final String CAMEL_SOURCE_TIMER_ENDPOINT_INCLUDE_METADATA_CONF = "camel.source.endpoint.includeMetadata";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_INCLUDE_METADATA_DOC = "Whether to include metadata in the exchange such as fired time, timer name, timer count etc. This information is default included.";
    private static final Boolean CAMEL_SOURCE_TIMER_ENDPOINT_INCLUDE_METADATA_DEFAULT = true;
    public static final String CAMEL_SOURCE_TIMER_ENDPOINT_PERIOD_CONF = "camel.source.endpoint.period";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_PERIOD_DOC = "If greater than 0, generate periodic events every period.";
    private static final Long CAMEL_SOURCE_TIMER_ENDPOINT_PERIOD_DEFAULT = 1000L;
    public static final String CAMEL_SOURCE_TIMER_ENDPOINT_REPEAT_COUNT_CONF = "camel.source.endpoint.repeatCount";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_REPEAT_COUNT_DOC = "Specifies a maximum limit of number of fires. So if you set it to 1, the timer will only fire once. If you set it to 5, it will only fire five times. A value of zero or negative means fire forever.";
    private static final Long CAMEL_SOURCE_TIMER_ENDPOINT_REPEAT_COUNT_DEFAULT = 0L;
    ...
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_TIMER_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_TIMER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_TIMER_ENDPOINT_DAEMON_CONF = "camel.source.endpoint.daemon";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_DAEMON_DOC = "Specifies whether or not the thread associated with the timer endpoint runs as a daemon. The default value is true.";
    private static final Boolean CAMEL_SOURCE_TIMER_ENDPOINT_DAEMON_DEFAULT = true;
    public static final String CAMEL_SOURCE_TIMER_ENDPOINT_PATTERN_CONF = "camel.source.endpoint.pattern";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_PATTERN_DOC = "Allows you to specify a custom Date pattern to use for setting the time option using URI syntax.";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_PATTERN_DEFAULT = null;
    public static final String CAMEL_SOURCE_TIMER_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_TIMER_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_TIMER_ENDPOINT_TIME_CONF = "camel.source.endpoint.time";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_TIME_DOC = "A java.util.Date the first event should be generated. If using the URI, the pattern expected is: yyyy-MM-dd HH:mm:ss or yyyy-MM-dd'T'HH:mm:ss.";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_TIME_DEFAULT = null;
    public static final String CAMEL_SOURCE_TIMER_ENDPOINT_TIMER_CONF = "camel.source.endpoint.timer";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_TIMER_DOC = "To use a custom Timer";
    private static final String CAMEL_SOURCE_TIMER_ENDPOINT_TIMER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_TIMER_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_TIMER_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_TIMER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_TIMER_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_TIMER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_TIMER_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
        return conf;
    }
}