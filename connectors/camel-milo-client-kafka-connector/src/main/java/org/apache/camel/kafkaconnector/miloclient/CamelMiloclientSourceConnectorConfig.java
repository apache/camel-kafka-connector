...
public class CamelMiloclientSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_PATH_ENDPOINT_URI_DOC = "The OPC UA server endpoint";
    private static final String CAMEL_SOURCE_MILOCLIENT_PATH_ENDPOINT_URI_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_CLIENT_ID_CONF = "camel.source.endpoint.clientId";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_CLIENT_ID_DOC = "A virtual client id to force the creation of a new connection instance";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_CLIENT_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_DEFAULT_AWAIT_WRITES_DOC = "Default await setting for writes";
    private static final Boolean CAMEL_SOURCE_MILOCLIENT_ENDPOINT_DEFAULT_AWAIT_WRITES_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_DISCOVERY_ENDPOINT_SUFFIX_DOC = "A suffix for endpoint URI when discovering";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_DISCOVERY_ENDPOINT_SUFFIX_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_DISCOVERY_ENDPOINT_URI_DOC = "An alternative discovery URI";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_DISCOVERY_ENDPOINT_URI_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_METHOD_CONF = "camel.source.endpoint.method";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_METHOD_DOC = "The method definition (see Method ID)";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_METHOD_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_NODE_CONF = "camel.source.endpoint.node";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_NODE_DOC = "The node definition (see Node ID)";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_NODE_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_SAMPLING_INTERVAL_DOC = "The sampling interval in milliseconds";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_SAMPLING_INTERVAL_DEFAULT = "0.0";
    ...
    private static final Boolean CAMEL_SOURCE_MILOCLIENT_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_MILOCLIENT_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_MILOCLIENT_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_ALLOWED_SECURITY_POLICIES_DOC = "A set of allowed security policy URIs. Default is to accept all and use the highest.";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_ALLOWED_SECURITY_POLICIES_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_APPLICATION_NAME_CONF = "camel.source.endpoint.applicationName";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_APPLICATION_NAME_DOC = "The application name";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_APPLICATION_NAME_DEFAULT = "Apache Camel adapter for Eclipse Milo";
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_APPLICATION_URI_CONF = "camel.source.endpoint.applicationUri";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_APPLICATION_URI_DOC = "The application URI";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_APPLICATION_URI_DEFAULT = "http://camel.apache.org/EclipseMilo/Client";
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_CHANNEL_LIFETIME_CONF = "camel.source.endpoint.channelLifetime";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_CHANNEL_LIFETIME_DOC = "Channel lifetime in milliseconds";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_CHANNEL_LIFETIME_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_ALIAS_CONF = "camel.source.endpoint.keyAlias";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_ALIAS_DOC = "The name of the key in the keystore file";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_ALIAS_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_PASSWORD_CONF = "camel.source.endpoint.keyPassword";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_PASSWORD_DOC = "The key password";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_STORE_PASSWORD_DOC = "The keystore password";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_STORE_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_STORE_TYPE_CONF = "camel.source.endpoint.keyStoreType";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_STORE_TYPE_DOC = "The key store type";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_STORE_TYPE_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_STORE_URL_CONF = "camel.source.endpoint.keyStoreUrl";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_STORE_URL_DOC = "The URL where the key should be loaded from";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_KEY_STORE_URL_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_MAX_PENDING_PUBLISH_REQUESTS_DOC = "The maximum number of pending publish requests";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_MAX_PENDING_PUBLISH_REQUESTS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_MAX_RESPONSE_MESSAGE_SIZE_DOC = "The maximum number of bytes a response message may have";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_MAX_RESPONSE_MESSAGE_SIZE_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_OVERRIDE_HOST_CONF = "camel.source.endpoint.overrideHost";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_OVERRIDE_HOST_DOC = "Override the server reported endpoint host with the host from the endpoint URI.";
    private static final Boolean CAMEL_SOURCE_MILOCLIENT_ENDPOINT_OVERRIDE_HOST_DEFAULT = false;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_PRODUCT_URI_CONF = "camel.source.endpoint.productUri";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_PRODUCT_URI_DOC = "The product URI";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_PRODUCT_URI_DEFAULT = "http://camel.apache.org/EclipseMilo";
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_REQUESTED_PUBLISHING_INTERVAL_DOC = "The requested publishing interval in milliseconds";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_REQUESTED_PUBLISHING_INTERVAL_DEFAULT = "1_000.0";
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_REQUEST_TIMEOUT_CONF = "camel.source.endpoint.requestTimeout";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_REQUEST_TIMEOUT_DOC = "Request timeout in milliseconds";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_REQUEST_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_SESSION_NAME_CONF = "camel.source.endpoint.sessionName";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_SESSION_NAME_DOC = "Session name";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_SESSION_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_SESSION_TIMEOUT_CONF = "camel.source.endpoint.sessionTimeout";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_SESSION_TIMEOUT_DOC = "Session timeout in milliseconds";
    private static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_SESSION_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_CLIENT_ID_CONF = "camel.component.milo-client.clientId";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_CLIENT_ID_DOC = "A virtual client id to force the creation of a new connection instance";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_CLIENT_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_CONFIGURATION_DOC = "All default options for client configurations";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_DISCOVERY_ENDPOINT_SUFFIX_DOC = "A suffix for endpoint URI when discovering";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_DISCOVERY_ENDPOINT_SUFFIX_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_DISCOVERY_ENDPOINT_URI_DOC = "An alternative discovery URI";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_DISCOVERY_ENDPOINT_URI_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_MILOCLIENT_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_MILOCLIENT_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_ALLOWED_SECURITY_POLICIES_DOC = "A set of allowed security policy URIs. Default is to accept all and use the highest.";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_ALLOWED_SECURITY_POLICIES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_APPLICATION_NAME_DOC = "The application name";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_APPLICATION_NAME_DEFAULT = "Apache Camel adapter for Eclipse Milo";
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_APPLICATION_URI_DOC = "The application URI";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_APPLICATION_URI_DEFAULT = "http://camel.apache.org/EclipseMilo/Client";
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_CHANNEL_LIFETIME_DOC = "Channel lifetime in milliseconds";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_CHANNEL_LIFETIME_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_KEY_ALIAS_CONF = "camel.component.milo-client.keyAlias";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_KEY_ALIAS_DOC = "The name of the key in the keystore file";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_KEY_ALIAS_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_KEY_PASSWORD_CONF = "camel.component.milo-client.keyPassword";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_KEY_PASSWORD_DOC = "The key password";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_KEY_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_KEY_STORE_PASSWORD_DOC = "The keystore password";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_KEY_STORE_PASSWORD_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_KEY_STORE_TYPE_DOC = "The key store type";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_KEY_STORE_TYPE_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_KEY_STORE_URL_CONF = "camel.component.milo-client.keyStoreUrl";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_KEY_STORE_URL_DOC = "The URL where the key should be loaded from";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_KEY_STORE_URL_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_MAX_PENDING_PUBLISH_REQUESTS_DOC = "The maximum number of pending publish requests";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_MAX_PENDING_PUBLISH_REQUESTS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_MAX_RESPONSE_MESSAGE_SIZE_DOC = "The maximum number of bytes a response message may have";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_MAX_RESPONSE_MESSAGE_SIZE_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_OVERRIDE_HOST_CONF = "camel.component.milo-client.overrideHost";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_OVERRIDE_HOST_DOC = "Override the server reported endpoint host with the host from the endpoint URI.";
    private static final Boolean CAMEL_SOURCE_MILOCLIENT_COMPONENT_OVERRIDE_HOST_DEFAULT = false;
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_PRODUCT_URI_CONF = "camel.component.milo-client.productUri";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_PRODUCT_URI_DOC = "The product URI";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_PRODUCT_URI_DEFAULT = "http://camel.apache.org/EclipseMilo";
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_REQUESTED_PUBLISHING_INTERVAL_DOC = "The requested publishing interval in milliseconds";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_REQUESTED_PUBLISHING_INTERVAL_DEFAULT = "1_000.0";
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_REQUEST_TIMEOUT_DOC = "Request timeout in milliseconds";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_REQUEST_TIMEOUT_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_SESSION_NAME_CONF = "camel.component.milo-client.sessionName";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_SESSION_NAME_DOC = "Session name";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_SESSION_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_SESSION_TIMEOUT_DOC = "Session timeout in milliseconds";
    private static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_SESSION_TIMEOUT_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_MILOCLIENT_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_MILOCLIENT_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_MILOCLIENT_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
