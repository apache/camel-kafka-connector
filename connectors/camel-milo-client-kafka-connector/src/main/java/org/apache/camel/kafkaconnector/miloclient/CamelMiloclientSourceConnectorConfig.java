...
public class CamelMiloclientSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_MILOCLIENT_ENDPOINT_SAMPLING_INTERVAL_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_APPLICATION_NAME_DOC = "Default application name";
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_APPLICATION_NAME_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_APPLICATION_URI_DOC = "Default application URI";
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_APPLICATION_URI_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_DEFAULT_CONFIGURATION_CONF = "camel.component.milo-client.defaultConfiguration";
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_DEFAULT_CONFIGURATION_DOC = "All default options for client";
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_DEFAULT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_PRODUCT_URI_CONF = "camel.component.milo-client.productUri";
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_PRODUCT_URI_DOC = "Default product URI";
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_PRODUCT_URI_DEFAULT = null;
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_RECONNECT_TIMEOUT_CONF = "camel.component.milo-client.reconnectTimeout";
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_RECONNECT_TIMEOUT_DOC = "Default reconnect timeout";
    public static final String CAMEL_SOURCE_MILOCLIENT_COMPONENT_RECONNECT_TIMEOUT_DEFAULT = null;
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SOURCE_MILOCLIENT_COMPONENT_DEFAULT_CONFIGURATION_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_MILOCLIENT_COMPONENT_DEFAULT_CONFIGURATION_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_MILOCLIENT_COMPONENT_DEFAULT_CONFIGURATION_DOC);
        ...
        conf.define(CAMEL_SOURCE_MILOCLIENT_COMPONENT_RECONNECT_TIMEOUT_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_MILOCLIENT_COMPONENT_RECONNECT_TIMEOUT_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_MILOCLIENT_COMPONENT_RECONNECT_TIMEOUT_DOC);
