...
public class CamelAwsswfSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AWSSWF_COMPONENT_REGION_DOC = "Amazon AWS Region.";
    ...
    public static final String CAMEL_SOURCE_AWSSWF_COMPONENT_CONFIGURATION_DOC = "The AWS SWF default configuration";
