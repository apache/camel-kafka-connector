...
public class CamelGraphqlSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_GRAPHQL_PATH_HTTP_URI_DOC = "The GraphQL server URI.";
    private static final String CAMEL_SINK_GRAPHQL_PATH_HTTP_URI_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_GRAPHQL_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_GRAPHQL_ENDPOINT_OPERATION_NAME_CONF = "camel.sink.endpoint.operationName";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_OPERATION_NAME_DOC = "The query or mutation name.";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_OPERATION_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_GRAPHQL_ENDPOINT_PROXY_HOST_CONF = "camel.sink.endpoint.proxyHost";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_PROXY_HOST_DOC = "The proxy host in the format hostname:port.";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_PROXY_HOST_DEFAULT = null;
    public static final String CAMEL_SINK_GRAPHQL_ENDPOINT_QUERY_CONF = "camel.sink.endpoint.query";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_QUERY_DOC = "The query text.";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_QUERY_DEFAULT = null;
    public static final String CAMEL_SINK_GRAPHQL_ENDPOINT_QUERY_FILE_CONF = "camel.sink.endpoint.queryFile";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_QUERY_FILE_DOC = "The query file name located in the classpath.";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_QUERY_FILE_DEFAULT = null;
    public static final String CAMEL_SINK_GRAPHQL_ENDPOINT_VARIABLES_CONF = "camel.sink.endpoint.variables";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_VARIABLES_DOC = "The JsonObject instance containing the operation variables.";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_VARIABLES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GRAPHQL_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_GRAPHQL_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_GRAPHQL_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_GRAPHQL_ENDPOINT_ACCESS_TOKEN_CONF = "camel.sink.endpoint.accessToken";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_ACCESS_TOKEN_DOC = "The access token sent in the Authorization header.";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_ACCESS_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_GRAPHQL_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_PASSWORD_DOC = "The password for Basic authentication.";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_GRAPHQL_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_USERNAME_DOC = "The username for Basic authentication.";
    private static final String CAMEL_SINK_GRAPHQL_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_GRAPHQL_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_GRAPHQL_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_GRAPHQL_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
