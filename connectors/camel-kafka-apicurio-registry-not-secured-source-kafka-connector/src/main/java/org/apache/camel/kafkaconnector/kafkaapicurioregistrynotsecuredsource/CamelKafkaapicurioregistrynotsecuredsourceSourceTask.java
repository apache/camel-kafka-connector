...
public class CamelKafkaapicurioregistrynotsecuredsourceSourceTask
        extends
            CamelSourceTask {
    ...
    protected CamelSourceConnectorConfig getCamelSourceConnectorConfig(
        ...
        return new CamelKafkaapicurioregistrynotsecuredsourceSourceConnectorConfig(props);
    }
    @Override
    protected String getSourceKamelet() {
        return "kamelet:kafka-apicurio-registry-not-secured-source";
    }
}