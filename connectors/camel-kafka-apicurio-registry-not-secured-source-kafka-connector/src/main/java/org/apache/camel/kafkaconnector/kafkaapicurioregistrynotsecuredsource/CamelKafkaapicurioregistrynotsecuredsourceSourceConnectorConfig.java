...
public class CamelKafkaapicurioregistrynotsecuredsourceSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_KAFKAAPICURIOREGISTRYNOTSECUREDSOURCE_KAMELET_VALUE_DESERIALIZER_DEFAULT = "io.apicurio.registry.serde.avro.AvroKafkaDeserializer";
    ...
    public static final String CAMEL_SOURCE_KAFKAAPICURIOREGISTRYNOTSECUREDSOURCE_KAMELET_AVRO_DATUM_PROVIDER_CONF = "camel.kamelet.kafka-apicurio-registry-not-secured-source.avroDatumProvider";
    public static final String CAMEL_SOURCE_KAFKAAPICURIOREGISTRYNOTSECUREDSOURCE_KAMELET_AVRO_DATUM_PROVIDER_DOC = "How to read data with Avro";
    public static final String CAMEL_SOURCE_KAFKAAPICURIOREGISTRYNOTSECUREDSOURCE_KAMELET_AVRO_DATUM_PROVIDER_DEFAULT = "io.apicurio.registry.serde.avro.ReflectAvroDatumProvider";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_KAFKAAPICURIOREGISTRYNOTSECUREDSOURCE_KAMELET_AVRO_DATUM_PROVIDER_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_KAFKAAPICURIOREGISTRYNOTSECUREDSOURCE_KAMELET_AVRO_DATUM_PROVIDER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_KAFKAAPICURIOREGISTRYNOTSECUREDSOURCE_KAMELET_AVRO_DATUM_PROVIDER_DOC);
        return conf;
    }
}