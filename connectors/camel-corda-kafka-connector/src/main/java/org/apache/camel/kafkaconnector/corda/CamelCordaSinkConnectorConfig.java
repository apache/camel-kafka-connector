...
public class CamelCordaSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_CORDA_PATH_NODE_DOC = "The url for the corda node";
    private static final String CAMEL_SINK_CORDA_PATH_NODE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_CORDA_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_CORDA_ENDPOINT_OPERATION_CONF = "camel.sink.endpoint.operation";
    private static final String CAMEL_SINK_CORDA_ENDPOINT_OPERATION_DOC = "Operation to use";
    private static final String CAMEL_SINK_CORDA_ENDPOINT_OPERATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CORDA_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CORDA_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_CORDA_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_CORDA_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_CORDA_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_CORDA_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_CORDA_ENDPOINT_PASSWORD_DOC = "Password for login";
    private static final String CAMEL_SINK_CORDA_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_CORDA_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_CORDA_ENDPOINT_USERNAME_DOC = "Username for login";
    private static final String CAMEL_SINK_CORDA_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_CORDA_COMPONENT_CONFIGURATION_CONF = "camel.component.corda.configuration";
    private static final String CAMEL_SINK_CORDA_COMPONENT_CONFIGURATION_DOC = "To use a shared configuration.";
    private static final String CAMEL_SINK_CORDA_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_CORDA_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_CORDA_COMPONENT_OPERATION_CONF = "camel.component.corda.operation";
    private static final String CAMEL_SINK_CORDA_COMPONENT_OPERATION_DOC = "Operation to use";
    private static final String CAMEL_SINK_CORDA_COMPONENT_OPERATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CORDA_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CORDA_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_CORDA_COMPONENT_PASSWORD_CONF = "camel.component.corda.password";
    private static final String CAMEL_SINK_CORDA_COMPONENT_PASSWORD_DOC = "Password for login";
    private static final String CAMEL_SINK_CORDA_COMPONENT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_CORDA_COMPONENT_USERNAME_CONF = "camel.component.corda.username";
    private static final String CAMEL_SINK_CORDA_COMPONENT_USERNAME_DOC = "Username for login";
    private static final String CAMEL_SINK_CORDA_COMPONENT_USERNAME_DEFAULT = null;
