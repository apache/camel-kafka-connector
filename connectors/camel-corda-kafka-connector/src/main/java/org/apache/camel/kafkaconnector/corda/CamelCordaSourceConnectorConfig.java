...
public class CamelCordaSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_CORDA_PATH_NODE_DOC = "The url for the corda node";
    private static final String CAMEL_SOURCE_CORDA_PATH_NODE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_CORDA_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_PAGE_SPECIFICATION_DEFAULT = "200";
    public static final String CAMEL_SOURCE_CORDA_ENDPOINT_PROCESS_SNAPSHOT_CONF = "camel.source.endpoint.processSnapshot";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_PROCESS_SNAPSHOT_DOC = "Whether to process snapshots or not";
    private static final Boolean CAMEL_SOURCE_CORDA_ENDPOINT_PROCESS_SNAPSHOT_DEFAULT = true;
    public static final String CAMEL_SOURCE_CORDA_ENDPOINT_SORT_CONF = "camel.source.endpoint.sort";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_SORT_DOC = "Sort allows specification of a set of entity attribute names and their associated directionality and null handling, to be applied upon processing a query specification. One of: [ASC] [DESC]";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_SORT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_CONTRACT_STATE_CLASS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_CORDA_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_FLOW_LOGIC_ARGUMENTS_DOC = "Start the given flow with the given arguments, returning an Observable with a single observation of the result of running the flow. The flowLogicClass must be annotated with net.corda.core.flows.StartableByRPC.";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_FLOW_LOGIC_ARGUMENTS_DEFAULT = null;
    public static final String CAMEL_SOURCE_CORDA_ENDPOINT_FLOW_LOGIC_CLASS_CONF = "camel.source.endpoint.flowLogicClass";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_FLOW_LOGIC_CLASS_DOC = "Start the given flow with the given arguments, returning an Observable with a single observation of the result of running the flow. The flowLogicClass must be annotated with net.corda.core.flows.StartableByRPC.";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_FLOW_LOGIC_CLASS_DEFAULT = null;
    public static final String CAMEL_SOURCE_CORDA_ENDPOINT_QUERY_CRITERIA_CONF = "camel.source.endpoint.queryCriteria";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_QUERY_CRITERIA_DOC = "QueryCriteria assumes underlying schema tables are correctly indexed for performance.";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_QUERY_CRITERIA_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_CORDA_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_CORDA_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_CORDA_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_CORDA_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_PASSWORD_DOC = "Password for login";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_CORDA_ENDPOINT_USERNAME_CONF = "camel.source.endpoint.username";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_USERNAME_DOC = "Username for login";
    private static final String CAMEL_SOURCE_CORDA_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_CORDA_COMPONENT_CONFIGURATION_CONF = "camel.component.corda.configuration";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_CONFIGURATION_DOC = "To use a shared configuration.";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_CORDA_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_PAGE_SPECIFICATION_DEFAULT = "200";
    public static final String CAMEL_SOURCE_CORDA_COMPONENT_PROCESS_SNAPSHOT_CONF = "camel.component.corda.processSnapshot";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_PROCESS_SNAPSHOT_DOC = "Whether to process snapshots or not";
    private static final Boolean CAMEL_SOURCE_CORDA_COMPONENT_PROCESS_SNAPSHOT_DEFAULT = true;
    public static final String CAMEL_SOURCE_CORDA_COMPONENT_SORT_CONF = "camel.component.corda.sort";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_SORT_DOC = "Sort allows specification of a set of entity attribute names and their associated directionality and null handling, to be applied upon processing a query specification. One of: [ASC] [DESC]";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_SORT_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_CONTRACT_STATE_CLASS_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_FLOW_LOGIC_ARGUMENTS_DOC = "Start the given flow with the given arguments, returning an Observable with a single observation of the result of running the flow. The flowLogicClass must be annotated with net.corda.core.flows.StartableByRPC.";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_FLOW_LOGIC_ARGUMENTS_DEFAULT = null;
    public static final String CAMEL_SOURCE_CORDA_COMPONENT_FLOW_LOGIC_CLASS_CONF = "camel.component.corda.flowLogicClass";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_FLOW_LOGIC_CLASS_DOC = "Start the given flow with the given arguments, returning an Observable with a single observation of the result of running the flow. The flowLogicClass must be annotated with net.corda.core.flows.StartableByRPC.";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_FLOW_LOGIC_CLASS_DEFAULT = null;
    public static final String CAMEL_SOURCE_CORDA_COMPONENT_QUERY_CRITERIA_CONF = "camel.component.corda.queryCriteria";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_QUERY_CRITERIA_DOC = "QueryCriteria assumes underlying schema tables are correctly indexed for performance.";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_QUERY_CRITERIA_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_CORDA_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_CORDA_COMPONENT_PASSWORD_CONF = "camel.component.corda.password";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_PASSWORD_DOC = "Password for login";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_CORDA_COMPONENT_USERNAME_CONF = "camel.component.corda.username";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_USERNAME_DOC = "Username for login";
    private static final String CAMEL_SOURCE_CORDA_COMPONENT_USERNAME_DEFAULT = null;
