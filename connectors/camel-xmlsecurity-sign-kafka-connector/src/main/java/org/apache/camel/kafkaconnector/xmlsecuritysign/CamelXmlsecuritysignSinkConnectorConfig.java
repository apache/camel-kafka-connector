...
public class CamelXmlsecuritysignSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_PATH_NAME_DOC = "The name part in the URI can be chosen by the user to distinguish between different signer endpoints within the camel context.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_PATH_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_ADD_KEY_INFO_REFERENCE_DEFAULT = "true";
    public static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_BASE_URI_CONF = "camel.sink.endpoint.baseUri";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_BASE_URI_DOC = "You can set a base URI which is used in the URI dereferencing. Relative URIs are then concatenated with the base URI.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_BASE_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_CANONICALIZATION_METHOD_DEFAULT = "http://www.w3.org/TR/2001/REC-xml-c14n-20010315";
    public static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_CLEAR_HEADERS_CONF = "camel.sink.endpoint.clearHeaders";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_CLEAR_HEADERS_DOC = "Determines if the XML signature specific headers be cleared after signing and verification. Defaults to true.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_CLEAR_HEADERS_DEFAULT = "true";
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_CONTENT_OBJECT_ID_DOC = "Sets the content object Id attribute value. By default a UUID is generated. If you set the null value, then a new UUID will be generated. Only used in the enveloping case.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_CONTENT_OBJECT_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_CONTENT_REFERENCE_TYPE_DOC = "Type of the content reference. The default value is null. This value can be overwritten by the header XmlSignatureConstants#HEADER_CONTENT_REFERENCE_TYPE.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_CONTENT_REFERENCE_TYPE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_CONTENT_REFERENCE_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_CRYPTO_CONTEXT_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_DIGEST_ALGORITHM_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_DISALLOW_DOCTYPE_DECL_DOC = "Disallows that the incoming XML document contains DTD DOCTYPE declaration. The default value is Boolean#TRUE.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_DISALLOW_DOCTYPE_DECL_DEFAULT = "true";
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_KEY_ACCESSOR_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_OMIT_XML_DECLARATION_DOC = "Indicator whether the XML declaration in the outgoing message body should be omitted. Default value is false. Can be overwritten by the header XmlSignatureConstants#HEADER_OMIT_XML_DECLARATION.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_OMIT_XML_DECLARATION_DEFAULT = "false";
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_OUTPUT_XML_ENCODING_DOC = "The character encoding of the resulting signed XML document. If null then the encoding of the original XML document is used.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_OUTPUT_XML_ENCODING_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PARENT_LOCAL_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PARENT_NAMESPACE_CONF = "camel.sink.endpoint.parentNamespace";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PARENT_NAMESPACE_DOC = "Namespace of the parent element to which the XML signature element will be added.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PARENT_NAMESPACE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PARENT_XPATH_DEFAULT = null;
    public static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PLAIN_TEXT_CONF = "camel.sink.endpoint.plainText";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PLAIN_TEXT_DOC = "Indicator whether the message body contains plain text. The default value is false, indicating that the message body contains XML. The value can be overwritten by the header XmlSignatureConstants#HEADER_MESSAGE_IS_PLAIN_TEXT.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PLAIN_TEXT_DEFAULT = "false";
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PLAIN_TEXT_ENCODING_DOC = "Encoding of the plain text. Only relevant if the message body is plain text (see parameter plainText. Default value is UTF-8.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PLAIN_TEXT_ENCODING_DEFAULT = "UTF-8";
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PREFIX_FOR_XML_SIGNATURE_NAMESPACE_DEFAULT = "ds";
    public static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PROPERTIES_CONF = "camel.sink.endpoint.properties";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PROPERTIES_DOC = "For adding additional References and Objects to the XML signature which contain additional properties, you can provide a bean which implements the XmlSignatureProperties interface.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_SCHEMA_RESOURCE_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_SIGNATURE_ALGORITHM_DOC = "Signature algorithm. Default value is http://www.w3.org/2000/09/xmldsig#rsa-sha1.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_SIGNATURE_ALGORITHM_DEFAULT = "http://www.w3.org/2001/04/xmldsig-more#rsa-sha256";
    public static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_SIGNATURE_ID_CONF = "camel.sink.endpoint.signatureId";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_SIGNATURE_ID_DOC = "Sets the signature Id. If this parameter is not set (null value) then a unique ID is generated for the signature ID (default). If this parameter is set to (empty string) then no Id attribute is created in the signature element.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_SIGNATURE_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_TRANSFORM_METHODS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_XPATHS_TO_ID_ATTRIBUTES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_ENDPOINT_URI_DEREFERENCER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_ADD_KEY_INFO_REFERENCE_DEFAULT = "true";
    public static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_BASE_URI_CONF = "camel.component.xmlsecurity-sign.baseUri";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_BASE_URI_DOC = "You can set a base URI which is used in the URI dereferencing. Relative URIs are then concatenated with the base URI.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_BASE_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_CANONICALIZATION_METHOD_DEFAULT = "http://www.w3.org/TR/2001/REC-xml-c14n-20010315";
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_CLEAR_HEADERS_DOC = "Determines if the XML signature specific headers be cleared after signing and verification. Defaults to true.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_CLEAR_HEADERS_DEFAULT = "true";
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_CONTENT_OBJECT_ID_DOC = "Sets the content object Id attribute value. By default a UUID is generated. If you set the null value, then a new UUID will be generated. Only used in the enveloping case.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_CONTENT_OBJECT_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_CONTENT_REFERENCE_TYPE_DOC = "Type of the content reference. The default value is null. This value can be overwritten by the header XmlSignatureConstants#HEADER_CONTENT_REFERENCE_TYPE.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_CONTENT_REFERENCE_TYPE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_CONTENT_REFERENCE_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_CRYPTO_CONTEXT_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_DIGEST_ALGORITHM_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_DISALLOW_DOCTYPE_DECL_DOC = "Disallows that the incoming XML document contains DTD DOCTYPE declaration. The default value is Boolean#TRUE.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_DISALLOW_DOCTYPE_DECL_DEFAULT = "true";
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_KEY_ACCESSOR_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_OMIT_XML_DECLARATION_DOC = "Indicator whether the XML declaration in the outgoing message body should be omitted. Default value is false. Can be overwritten by the header XmlSignatureConstants#HEADER_OMIT_XML_DECLARATION.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_OMIT_XML_DECLARATION_DEFAULT = "false";
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_OUTPUT_XML_ENCODING_DOC = "The character encoding of the resulting signed XML document. If null then the encoding of the original XML document is used.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_OUTPUT_XML_ENCODING_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_PARENT_LOCAL_NAME_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_PARENT_NAMESPACE_DOC = "Namespace of the parent element to which the XML signature element will be added.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_PARENT_NAMESPACE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_PARENT_XPATH_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_PLAIN_TEXT_DOC = "Indicator whether the message body contains plain text. The default value is false, indicating that the message body contains XML. The value can be overwritten by the header XmlSignatureConstants#HEADER_MESSAGE_IS_PLAIN_TEXT.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_PLAIN_TEXT_DEFAULT = "false";
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_PLAIN_TEXT_ENCODING_DOC = "Encoding of the plain text. Only relevant if the message body is plain text (see parameter plainText. Default value is UTF-8.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_PLAIN_TEXT_ENCODING_DEFAULT = "UTF-8";
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_PREFIX_FOR_XML_SIGNATURE_NAMESPACE_DEFAULT = "ds";
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_PROPERTIES_DOC = "For adding additional References and Objects to the XML signature which contain additional properties, you can provide a bean which implements the XmlSignatureProperties interface.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_SCHEMA_RESOURCE_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_SIGNATURE_ALGORITHM_DOC = "Signature algorithm. Default value is http://www.w3.org/2000/09/xmldsig#rsa-sha1.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_SIGNATURE_ALGORITHM_DEFAULT = "http://www.w3.org/2001/04/xmldsig-more#rsa-sha256";
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_SIGNATURE_ID_DOC = "Sets the signature Id. If this parameter is not set (null value) then a unique ID is generated for the signature ID (default). If this parameter is set to (empty string) then no Id attribute is created in the signature element.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_SIGNATURE_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_TRANSFORM_METHODS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_XPATHS_TO_ID_ATTRIBUTES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_SIGNER_CONFIGURATION_DOC = "To use a shared XmlSignerConfiguration configuration to use as base for configuring endpoints.";
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_SIGNER_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_XMLSECURITYSIGN_COMPONENT_URI_DEREFERENCER_DEFAULT = null;
