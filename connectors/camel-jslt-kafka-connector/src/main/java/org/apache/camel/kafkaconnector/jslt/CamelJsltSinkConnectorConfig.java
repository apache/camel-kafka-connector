...
public class CamelJsltSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_JSLT_ENDPOINT_MAP_BIG_DECIMAL_AS_FLOATS_CONF = "camel.sink.endpoint.mapBigDecimalAsFloats";
    public static final String CAMEL_SINK_JSLT_ENDPOINT_MAP_BIG_DECIMAL_AS_FLOATS_DOC = "If true, the mapper will use the USE_BIG_DECIMAL_FOR_FLOATS in serialization features";
    public static final Boolean CAMEL_SINK_JSLT_ENDPOINT_MAP_BIG_DECIMAL_AS_FLOATS_DEFAULT = false;
    public static final String CAMEL_SINK_JSLT_ENDPOINT_OBJECT_MAPPER_CONF = "camel.sink.endpoint.objectMapper";
    public static final String CAMEL_SINK_JSLT_ENDPOINT_OBJECT_MAPPER_DOC = "Setting a custom JSON Object Mapper to be used";
    public static final String CAMEL_SINK_JSLT_ENDPOINT_OBJECT_MAPPER_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_JSLT_COMPONENT_AUTOWIRED_ENABLED_CONF = "camel.component.jslt.autowiredEnabled";
    public static final String CAMEL_SINK_JSLT_COMPONENT_AUTOWIRED_ENABLED_DOC = "Whether autowiring is enabled. This is used for automatic autowiring options (the option must be marked as autowired) by looking up in the registry to find if there is a single instance of matching type, which then gets configured on the component. This can be used for automatic configuring JDBC data sources, JMS connection factories, AWS Clients, etc.";
    public static final Boolean CAMEL_SINK_JSLT_COMPONENT_AUTOWIRED_ENABLED_DEFAULT = true;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_JSLT_ENDPOINT_MAP_BIG_DECIMAL_AS_FLOATS_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_JSLT_ENDPOINT_MAP_BIG_DECIMAL_AS_FLOATS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_JSLT_ENDPOINT_MAP_BIG_DECIMAL_AS_FLOATS_DOC);
        conf.define(CAMEL_SINK_JSLT_ENDPOINT_OBJECT_MAPPER_CONF, ConfigDef.Type.STRING, CAMEL_SINK_JSLT_ENDPOINT_OBJECT_MAPPER_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_JSLT_ENDPOINT_OBJECT_MAPPER_DOC);
        ...
        conf.define(CAMEL_SINK_JSLT_COMPONENT_AUTOWIRED_ENABLED_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_JSLT_COMPONENT_AUTOWIRED_ENABLED_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_JSLT_COMPONENT_AUTOWIRED_ENABLED_DOC);
