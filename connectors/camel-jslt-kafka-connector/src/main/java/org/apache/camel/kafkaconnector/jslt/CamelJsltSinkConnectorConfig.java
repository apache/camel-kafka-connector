...
public class CamelJsltSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_JSLT_PATH_RESOURCE_URI_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JSLT_ENDPOINT_ALLOW_CONTEXT_MAP_ALL_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_JSLT_ENDPOINT_ALLOW_TEMPLATE_FROM_HEADER_DEFAULT = false;
    public static final String CAMEL_SINK_JSLT_ENDPOINT_CONTENT_CACHE_CONF = "camel.sink.endpoint.contentCache";
    private static final String CAMEL_SINK_JSLT_ENDPOINT_CONTENT_CACHE_DOC = "Sets whether to use resource content cache or not";
    private static final Boolean CAMEL_SINK_JSLT_ENDPOINT_CONTENT_CACHE_DEFAULT = false;
    public static final String CAMEL_SINK_JSLT_ENDPOINT_PRETTY_PRINT_CONF = "camel.sink.endpoint.prettyPrint";
    private static final String CAMEL_SINK_JSLT_ENDPOINT_PRETTY_PRINT_DOC = "If true, JSON in output message is pretty printed.";
    private static final Boolean CAMEL_SINK_JSLT_ENDPOINT_PRETTY_PRINT_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_JSLT_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_JSLT_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_JSLT_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JSLT_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JSLT_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_JSLT_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_JSLT_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_JSLT_COMPONENT_ALLOW_TEMPLATE_FROM_HEADER_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_JSLT_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_JSLT_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JSLT_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JSLT_COMPONENT_FUNCTIONS_CONF = "camel.component.jslt.functions";
    private static final String CAMEL_SINK_JSLT_COMPONENT_FUNCTIONS_DOC = "JSLT can be extended by plugging in functions written in Java.";
    private static final String CAMEL_SINK_JSLT_COMPONENT_FUNCTIONS_DEFAULT = null;
    public static final String CAMEL_SINK_JSLT_COMPONENT_OBJECT_FILTER_CONF = "camel.component.jslt.objectFilter";
    private static final String CAMEL_SINK_JSLT_COMPONENT_OBJECT_FILTER_DOC = "JSLT can be extended by plugging in a custom jslt object filter";
    private static final String CAMEL_SINK_JSLT_COMPONENT_OBJECT_FILTER_DEFAULT = null;
