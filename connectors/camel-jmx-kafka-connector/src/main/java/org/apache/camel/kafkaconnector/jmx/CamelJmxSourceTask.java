...
public class CamelJmxSourceTask extends CamelSourceTask {

    @Override
    protected CamelSourceConnectorConfig getCamelSourceConnectorConfig(
            Map<String, String> props) {
        return new CamelJmxSourceConnectorConfig(props);
    }
    @Override
    protected Map<String, String> getDefaultConfig() {
        return new HashMap<String, String>() {{
            put(CamelSourceConnectorConfig.CAMEL_SOURCE_COMPONENT_CONF, "jmx");
        }};
    }
}