...
public class CamelWordpressSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_WORDPRESS_PATH_OPERATION_DOC = "The endpoint operation. One of: [post] [user]";
    private static final String CAMEL_SINK_WORDPRESS_PATH_OPERATION_DEFAULT = null;
    public static final String CAMEL_SINK_WORDPRESS_PATH_OPERATION_DETAIL_CONF = "camel.sink.path.operationDetail";
    private static final String CAMEL_SINK_WORDPRESS_PATH_OPERATION_DETAIL_DOC = "The second part of an endpoint operation. Needed only when endpoint semantic is not enough, like wordpress:post:delete One of: [delete]";
    private static final String CAMEL_SINK_WORDPRESS_PATH_OPERATION_DETAIL_DEFAULT = null;
    public static final String CAMEL_SINK_WORDPRESS_ENDPOINT_API_VERSION_CONF = "camel.sink.endpoint.apiVersion";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_API_VERSION_DOC = "The Wordpress REST API version";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_API_VERSION_DEFAULT = "2";
    public static final String CAMEL_SINK_WORDPRESS_ENDPOINT_CRITERIA_CONF = "camel.sink.endpoint.criteria";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_CRITERIA_DOC = "The criteria to use with complex searches.";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_CRITERIA_DEFAULT = null;
    public static final String CAMEL_SINK_WORDPRESS_ENDPOINT_FORCE_CONF = "camel.sink.endpoint.force";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_FORCE_DOC = "Whether to bypass trash and force deletion.";
    private static final Boolean CAMEL_SINK_WORDPRESS_ENDPOINT_FORCE_DEFAULT = false;
    public static final String CAMEL_SINK_WORDPRESS_ENDPOINT_ID_CONF = "camel.sink.endpoint.id";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_ID_DOC = "The entity ID. Should be passed when the operation performed requires a specific entity, e.g. deleting a post";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_ID_DEFAULT = null;
    public static final String CAMEL_SINK_WORDPRESS_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_PASSWORD_DOC = "Password from authorized user";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_WORDPRESS_ENDPOINT_SEARCH_CRITERIA_CONF = "camel.sink.endpoint.searchCriteria";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_SEARCH_CRITERIA_DOC = "Search criteria";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_SEARCH_CRITERIA_DEFAULT = null;
    public static final String CAMEL_SINK_WORDPRESS_ENDPOINT_URL_CONF = "camel.sink.endpoint.url";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_URL_DOC = "The Wordpress API URL from your site, e.g. http://myblog.com/wp-json/";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_URL_DEFAULT = null;
    public static final String CAMEL_SINK_WORDPRESS_ENDPOINT_USER_CONF = "camel.sink.endpoint.user";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_USER_DOC = "Authorized user to perform writing operations";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_USER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_WORDPRESS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_WORDPRESS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_WORDPRESS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_WORDPRESS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_WORDPRESS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_WORDPRESS_COMPONENT_API_VERSION_CONF = "camel.component.wordpress.apiVersion";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_API_VERSION_DOC = "The Wordpress REST API version";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_API_VERSION_DEFAULT = "2";
    public static final String CAMEL_SINK_WORDPRESS_COMPONENT_CRITERIA_CONF = "camel.component.wordpress.criteria";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_CRITERIA_DOC = "The criteria to use with complex searches.";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_CRITERIA_DEFAULT = null;
    public static final String CAMEL_SINK_WORDPRESS_COMPONENT_FORCE_CONF = "camel.component.wordpress.force";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_FORCE_DOC = "Whether to bypass trash and force deletion.";
    private static final Boolean CAMEL_SINK_WORDPRESS_COMPONENT_FORCE_DEFAULT = false;
    public static final String CAMEL_SINK_WORDPRESS_COMPONENT_ID_CONF = "camel.component.wordpress.id";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_ID_DOC = "The entity ID. Should be passed when the operation performed requires a specific entity, e.g. deleting a post";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_ID_DEFAULT = null;
    public static final String CAMEL_SINK_WORDPRESS_COMPONENT_PASSWORD_CONF = "camel.component.wordpress.password";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_PASSWORD_DOC = "Password from authorized user";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_WORDPRESS_COMPONENT_SEARCH_CRITERIA_CONF = "camel.component.wordpress.searchCriteria";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_SEARCH_CRITERIA_DOC = "Search criteria";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_SEARCH_CRITERIA_DEFAULT = null;
    public static final String CAMEL_SINK_WORDPRESS_COMPONENT_URL_CONF = "camel.component.wordpress.url";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_URL_DOC = "The Wordpress API URL from your site, e.g. http://myblog.com/wp-json/";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_URL_DEFAULT = null;
    public static final String CAMEL_SINK_WORDPRESS_COMPONENT_USER_CONF = "camel.component.wordpress.user";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_USER_DOC = "Authorized user to perform writing operations";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_USER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_WORDPRESS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_WORDPRESS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_WORDPRESS_COMPONENT_CONFIGURATION_CONF = "camel.component.wordpress.configuration";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_CONFIGURATION_DOC = "Wordpress component configuration";
    private static final String CAMEL_SINK_WORDPRESS_COMPONENT_CONFIGURATION_DEFAULT = null;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_WORDPRESS_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_WORDPRESS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_WORDPRESS_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
