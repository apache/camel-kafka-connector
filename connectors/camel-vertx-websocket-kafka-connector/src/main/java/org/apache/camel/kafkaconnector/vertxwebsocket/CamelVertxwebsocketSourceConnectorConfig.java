...
public class CamelVertxwebsocketSourceConnectorConfig
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_VERTXWEBSOCKET_COMPONENT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_VERTXWEBSOCKET_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_VERTXWEBSOCKET_COMPONENT_BASIC_PROPERTY_BINDING_DOC);
