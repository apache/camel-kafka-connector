...
public class CamelInfinispanSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_INFINISPAN_PATH_CACHE_NAME_DOC = "The name of the cache to use. Use current to use the existing cache name from the currently configured cached manager. Or use default for the default cache manager name.";
    private static final String CAMEL_SINK_INFINISPAN_PATH_CACHE_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_INFINISPAN_ENDPOINT_HOSTS_CONF = "camel.sink.endpoint.hosts";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_HOSTS_DOC = "Specifies the host of the cache on Infinispan instance";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_HOSTS_DEFAULT = null;
    public static final String CAMEL_SINK_INFINISPAN_ENDPOINT_QUERY_BUILDER_CONF = "camel.sink.endpoint.queryBuilder";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_QUERY_BUILDER_DOC = "Specifies the query builder.";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_QUERY_BUILDER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_INFINISPAN_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_OPERATION_DEFAULT = "PUT";
    ...
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_INFINISPAN_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_INFINISPAN_ENDPOINT_CACHE_CONTAINER_CONF = "camel.sink.endpoint.cacheContainer";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_CACHE_CONTAINER_DOC = "Specifies the cache Container to connect";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_CACHE_CONTAINER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_CACHE_CONTAINER_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_CONFIGURATION_PROPERTIES_DOC = "Implementation specific properties for the CacheManager";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_CONFIGURATION_PROPERTIES_DEFAULT = null;
    public static final String CAMEL_SINK_INFINISPAN_ENDPOINT_CONFIGURATION_URI_CONF = "camel.sink.endpoint.configurationUri";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_CONFIGURATION_URI_DOC = "An implementation specific URI for the CacheManager";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_CONFIGURATION_URI_DEFAULT = null;
    public static final String CAMEL_SINK_INFINISPAN_ENDPOINT_FLAGS_CONF = "camel.sink.endpoint.flags";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_FLAGS_DOC = "A comma separated list of Flag to be applied by default on each cache invocation, not applicable to remote caches.";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_FLAGS_DEFAULT = null;
    public static final String CAMEL_SINK_INFINISPAN_ENDPOINT_REMAPPING_FUNCTION_CONF = "camel.sink.endpoint.remappingFunction";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_REMAPPING_FUNCTION_DOC = "Set a specific remappingFunction to use in a compute operation";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_REMAPPING_FUNCTION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_RESULT_HEADER_DEFAULT = null;
    public static final String CAMEL_SINK_INFINISPAN_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_INFINISPAN_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_INFINISPAN_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_INFINISPAN_COMPONENT_CONFIGURATION_CONF = "camel.component.infinispan.configuration";
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_CONFIGURATION_DOC = "Component configuration";
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_INFINISPAN_COMPONENT_HOSTS_CONF = "camel.component.infinispan.hosts";
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_HOSTS_DOC = "Specifies the host of the cache on Infinispan instance";
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_HOSTS_DEFAULT = null;
    public static final String CAMEL_SINK_INFINISPAN_COMPONENT_QUERY_BUILDER_CONF = "camel.component.infinispan.queryBuilder";
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_QUERY_BUILDER_DOC = "Specifies the query builder.";
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_QUERY_BUILDER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_INFINISPAN_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_OPERATION_DEFAULT = "PUT";
    ...
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_INFINISPAN_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_CACHE_CONTAINER_DOC = "Specifies the cache Container to connect";
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_CACHE_CONTAINER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_CACHE_CONTAINER_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_CONFIGURATION_PROPERTIES_DOC = "Implementation specific properties for the CacheManager";
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_CONFIGURATION_PROPERTIES_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_CONFIGURATION_URI_DOC = "An implementation specific URI for the CacheManager";
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_CONFIGURATION_URI_DEFAULT = null;
    public static final String CAMEL_SINK_INFINISPAN_COMPONENT_FLAGS_CONF = "camel.component.infinispan.flags";
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_FLAGS_DOC = "A comma separated list of Flag to be applied by default on each cache invocation, not applicable to remote caches.";
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_FLAGS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_REMAPPING_FUNCTION_DOC = "Set a specific remappingFunction to use in a compute operation";
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_REMAPPING_FUNCTION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_INFINISPAN_COMPONENT_RESULT_HEADER_DEFAULT = null;
