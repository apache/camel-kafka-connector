...
public class CamelInfinispanSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_INFINISPAN_PATH_CACHE_NAME_DOC = "The cache to use";
    ...
    public static final String CAMEL_SOURCE_INFINISPAN_COMPONENT_CACHE_CONTAINER_DOC = "Default Cache container";
    ...
    public static final String CAMEL_SOURCE_INFINISPAN_COMPONENT_CONFIGURATION_DOC = "Default configuration";
