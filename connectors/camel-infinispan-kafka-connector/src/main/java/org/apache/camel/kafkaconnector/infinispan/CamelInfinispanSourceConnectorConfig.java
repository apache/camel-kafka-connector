...
public class CamelInfinispanSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_INFINISPAN_ENDPOINT_CACHE_CONTAINER_CONFIGURATION_DOC = "The CacheContainer configuration. Used if the cacheContainer is not defined.";
    ...
    public static final String CAMEL_SOURCE_INFINISPAN_ENDPOINT_FLAGS_DOC = "A comma separated list of org.infinispan.client.hotrod.Flag to be applied by default on each cache invocation.";
    ...
    public static final String CAMEL_SOURCE_INFINISPAN_COMPONENT_CACHE_CONTAINER_CONFIGURATION_DOC = "The CacheContainer configuration. Used if the cacheContainer is not defined.";
    ...
    public static final String CAMEL_SOURCE_INFINISPAN_COMPONENT_FLAGS_DOC = "A comma separated list of org.infinispan.client.hotrod.Flag to be applied by default on each cache invocation.";
