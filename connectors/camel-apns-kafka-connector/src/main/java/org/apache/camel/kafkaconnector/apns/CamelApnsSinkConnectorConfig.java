...
public class CamelApnsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_APNS_PATH_NAME_DOC = "Name of the endpoint";
    private static final String CAMEL_SINK_APNS_PATH_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_APNS_ENDPOINT_TOKENS_CONF = "camel.sink.endpoint.tokens";
    private static final String CAMEL_SINK_APNS_ENDPOINT_TOKENS_DOC = "Configure this property in case you want to statically declare tokens related to devices you want to notify. Tokens are separated by comma.";
    private static final String CAMEL_SINK_APNS_ENDPOINT_TOKENS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_APNS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_APNS_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_APNS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_APNS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_APNS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_APNS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_APNS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_APNS_COMPONENT_APNS_SERVICE_CONF = "camel.component.apns.apnsService";
    private static final String CAMEL_SINK_APNS_COMPONENT_APNS_SERVICE_DOC = "The ApnsService to use. The org.apache.camel.component.apns.factory.ApnsServiceFactory can be used to build a ApnsService";
    private static final String CAMEL_SINK_APNS_COMPONENT_APNS_SERVICE_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_APNS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_APNS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_APNS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
