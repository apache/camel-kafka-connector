...
public class CamelSlackSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_SLACK_PATH_CHANNEL_DOC = "The channel name (syntax #name) or slackuser (syntax userName) to send a message directly to an user.";
    private static final String CAMEL_SINK_SLACK_PATH_CHANNEL_DEFAULT = null;
    public static final String CAMEL_SINK_SLACK_ENDPOINT_ICON_EMOJI_CONF = "camel.sink.endpoint.iconEmoji";
    private static final String CAMEL_SINK_SLACK_ENDPOINT_ICON_EMOJI_DOC = "Use a Slack emoji as an avatar";
    private static final String CAMEL_SINK_SLACK_ENDPOINT_ICON_EMOJI_DEFAULT = null;
    public static final String CAMEL_SINK_SLACK_ENDPOINT_ICON_URL_CONF = "camel.sink.endpoint.iconUrl";
    private static final String CAMEL_SINK_SLACK_ENDPOINT_ICON_URL_DOC = "The avatar that the component will use when sending message to a channel or user.";
    private static final String CAMEL_SINK_SLACK_ENDPOINT_ICON_URL_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SLACK_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_SLACK_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_SLACK_ENDPOINT_USERNAME_DOC = "This is the username that the bot will have when sending messages to a channel or user.";
    private static final String CAMEL_SINK_SLACK_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_SLACK_ENDPOINT_WEBHOOK_URL_CONF = "camel.sink.endpoint.webhookUrl";
    private static final String CAMEL_SINK_SLACK_ENDPOINT_WEBHOOK_URL_DOC = "The incoming webhook URL";
    private static final String CAMEL_SINK_SLACK_ENDPOINT_WEBHOOK_URL_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_SLACK_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SLACK_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_SLACK_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_SLACK_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_SLACK_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_SLACK_COMPONENT_WEBHOOK_URL_CONF = "camel.component.slack.webhookUrl";
    private static final String CAMEL_SINK_SLACK_COMPONENT_WEBHOOK_URL_DOC = "The incoming webhook URL";
    private static final String CAMEL_SINK_SLACK_COMPONENT_WEBHOOK_URL_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_SLACK_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_SLACK_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_SLACK_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
