...
public class CamelWebsocketSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_WEBSOCKET_ENDPOINT_SUBPROTOCOL_CONF = "camel.source.endpoint.subprotocol";
    public static final String CAMEL_SOURCE_WEBSOCKET_ENDPOINT_SUBPROTOCOL_DOC = "This is a comma-separated list of subprotocols that are supported by the application. The list is in priority order. The first subprotocol on this list that is proposed by the client is the one that will be accepted. If no subprotocol on this list is proposed by the client, then the websocket connection is refused. The special value 'any' means that any subprotocol is acceptable. 'any' can be used on its own, or as a failsafe at the end of a list of more specific protocols. 'any' will also match the case where no subprotocol is proposed by the client.";
    public static final String CAMEL_SOURCE_WEBSOCKET_ENDPOINT_SUBPROTOCOL_DEFAULT = "any";
    ...
    public static final String CAMEL_SOURCE_WEBSOCKET_COMPONENT_SUBPROTOCOL_CONF = "camel.component.websocket.subprotocol";
    public static final String CAMEL_SOURCE_WEBSOCKET_COMPONENT_SUBPROTOCOL_DOC = "This is a comma-separated list of subprotocols that are supported by the application. The list is in priority order. The first subprotocol on this list that is proposed by the client is the one that will be accepted. If no subprotocol on this list is proposed by the client, then the websocket connection is refused. The special value 'any' means that any subprotocol is acceptable. 'any' can be used on its own, or as a failsafe at the end of a list of more specific protocols. 'any' will also match the case where no subprotocol is proposed by the client.";
    public static final String CAMEL_SOURCE_WEBSOCKET_COMPONENT_SUBPROTOCOL_DEFAULT = "any";
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_WEBSOCKET_ENDPOINT_SUBPROTOCOL_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_WEBSOCKET_ENDPOINT_SUBPROTOCOL_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_WEBSOCKET_ENDPOINT_SUBPROTOCOL_DOC);
        ...
        conf.define(CAMEL_SOURCE_WEBSOCKET_COMPONENT_SUBPROTOCOL_CONF, ConfigDef.Type.STRING, CAMEL_SOURCE_WEBSOCKET_COMPONENT_SUBPROTOCOL_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_WEBSOCKET_COMPONENT_SUBPROTOCOL_DOC);
