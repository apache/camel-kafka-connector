...
public class CamelNitriteSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_NITRITE_PATH_DATABASE_DOC = "Path to database file. Will be created if not exists.";
    private static final String CAMEL_SINK_NITRITE_PATH_DATABASE_DEFAULT = null;
    public static final String CAMEL_SINK_NITRITE_ENDPOINT_COLLECTION_CONF = "camel.sink.endpoint.collection";
    private static final String CAMEL_SINK_NITRITE_ENDPOINT_COLLECTION_DOC = "Name of Nitrite collection. Cannot be used in combination with repositoryClass option.";
    private static final String CAMEL_SINK_NITRITE_ENDPOINT_COLLECTION_DEFAULT = null;
    public static final String CAMEL_SINK_NITRITE_ENDPOINT_REPOSITORY_CLASS_CONF = "camel.sink.endpoint.repositoryClass";
    private static final String CAMEL_SINK_NITRITE_ENDPOINT_REPOSITORY_CLASS_DOC = "Class of Nitrite ObjectRepository. Cannot be used in combination with collection option.";
    private static final String CAMEL_SINK_NITRITE_ENDPOINT_REPOSITORY_CLASS_DEFAULT = null;
    public static final String CAMEL_SINK_NITRITE_ENDPOINT_REPOSITORY_NAME_CONF = "camel.sink.endpoint.repositoryName";
    private static final String CAMEL_SINK_NITRITE_ENDPOINT_REPOSITORY_NAME_DOC = "Optional name of ObjectRepository. Can be only used in combination with repositoryClass, otherwise have no effect";
    private static final String CAMEL_SINK_NITRITE_ENDPOINT_REPOSITORY_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_NITRITE_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_NITRITE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_NITRITE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_NITRITE_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_NITRITE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_NITRITE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_NITRITE_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_NITRITE_ENDPOINT_PASSWORD_DOC = "Password for Nitrite database. Required, if option username specified.";
    private static final String CAMEL_SINK_NITRITE_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_NITRITE_ENDPOINT_USERNAME_CONF = "camel.sink.endpoint.username";
    private static final String CAMEL_SINK_NITRITE_ENDPOINT_USERNAME_DOC = "Username for Nitrite database. Database is not secured if option not specified.";
    private static final String CAMEL_SINK_NITRITE_ENDPOINT_USERNAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_NITRITE_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_NITRITE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_NITRITE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
