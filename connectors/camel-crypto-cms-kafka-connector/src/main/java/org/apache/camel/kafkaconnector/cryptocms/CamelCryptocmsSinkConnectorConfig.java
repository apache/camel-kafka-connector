...
public class CamelCryptocmsSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_CRYPTOCMS_PATH_CRYPTO_OPERATION_DOC = "Set the Crypto operation from that supplied after the crypto scheme in the endpoint uri e.g. crypto-cms:sign sets sign as the operation. Possible values: sign, verify, encrypt, or decrypt. One of: [sign] [verify] [encrypt] [decrypt]";
    private static final String CAMEL_SINK_CRYPTOCMS_PATH_CRYPTO_OPERATION_DEFAULT = null;
    public static final String CAMEL_SINK_CRYPTOCMS_PATH_NAME_CONF = "camel.sink.path.name";
    private static final String CAMEL_SINK_CRYPTOCMS_PATH_NAME_DOC = "The name part in the URI can be chosen by the user to distinguish between different signer/verifier/encryptor/decryptor endpoints within the camel context.";
    private static final String CAMEL_SINK_CRYPTOCMS_PATH_NAME_DEFAULT = null;
    public static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_KEY_STORE_CONF = "camel.sink.endpoint.keyStore";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_KEY_STORE_DOC = "Keystore which contains signer private keys, verifier public keys, encryptor public keys, decryptor private keys depending on the operation. Use either this parameter or the parameter 'keyStoreParameters'.";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_KEY_STORE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_KEY_STORE_PARAMETERS_DOC = "Keystore containing signer private keys, verifier public keys, encryptor public keys, decryptor private keys depending on the operation. Use either this parameter or the parameter 'keystore'.";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_KEY_STORE_PARAMETERS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_CRYPTOCMS_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CRYPTOCMS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_CRYPTOCMS_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_FROM_BASE_64CONF = "camel.sink.endpoint.fromBase64";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_FROM_BASE_64DOC = "If true then the CMS message is base 64 encoded and must be decoded during the processing. Default value is false.";
    private static final Boolean CAMEL_SINK_CRYPTOCMS_ENDPOINT_FROM_BASE_64DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_CONTENT_ENCRYPTION_ALGORITHM_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_ORIGINATOR_INFORMATION_PROVIDER_DOC = "Provider for the originator info. See https://tools.ietf.org/html/rfc5652#section-6.1. The default value is null.";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_ORIGINATOR_INFORMATION_PROVIDER_DEFAULT = null;
    public static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_RECIPIENT_CONF = "camel.sink.endpoint.recipient";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_RECIPIENT_DOC = "Recipient Info: reference to a bean which implements the interface org.apache.camel.component.crypto.cms.api.TransRecipientInfo";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_RECIPIENT_DEFAULT = null;
    ...
    private static final Integer CAMEL_SINK_CRYPTOCMS_ENDPOINT_SECRET_KEY_LENGTH_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_UNPROTECTED_ATTRIBUTES_GENERATOR_PROVIDER_DEFAULT = null;
    public static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_TO_BASE_64CONF = "camel.sink.endpoint.toBase64";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_TO_BASE_64DOC = "Indicates whether the Signed Data or Enveloped Data instance shall be base 64 encoded. Default value is false.";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_TO_BASE_64DEFAULT = "false";
    public static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_INCLUDE_CONTENT_CONF = "camel.sink.endpoint.includeContent";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_INCLUDE_CONTENT_DOC = "Indicates whether the signed content should be included into the Signed Data instance. If false then a detached Signed Data instance is created in the header CamelCryptoCmsSignedData.";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_INCLUDE_CONTENT_DEFAULT = "true";
    public static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_SIGNER_CONF = "camel.sink.endpoint.signer";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_SIGNER_DOC = "Signer information: reference to bean(s) which implements org.apache.camel.component.crypto.cms.api.SignerInfo. Multiple values can be separated by comma";
    private static final String CAMEL_SINK_CRYPTOCMS_ENDPOINT_SIGNER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_CRYPTOCMS_ENDPOINT_SIGNED_DATA_HEADER_BASE_64DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_CRYPTOCMS_ENDPOINT_VERIFY_SIGNATURES_OF_ALL_SIGNERS_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SINK_CRYPTOCMS_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CRYPTOCMS_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_CRYPTOCMS_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_CRYPTOCMS_COMPONENT_ENVELOPED_DATA_DECRYPTOR_CONFIGURATION_DOC = "To configure the shared EnvelopedDataDecryptorConfiguration, which determines the uri parameters for the decrypt operation.";
    private static final String CAMEL_SINK_CRYPTOCMS_COMPONENT_ENVELOPED_DATA_DECRYPTOR_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_CRYPTOCMS_COMPONENT_SIGNED_DATA_VERIFIER_CONFIGURATION_DOC = "To configure the shared SignedDataVerifierConfiguration, which determines the uri parameters for the verify operation.";
    private static final String CAMEL_SINK_CRYPTOCMS_COMPONENT_SIGNED_DATA_VERIFIER_CONFIGURATION_DEFAULT = null;
