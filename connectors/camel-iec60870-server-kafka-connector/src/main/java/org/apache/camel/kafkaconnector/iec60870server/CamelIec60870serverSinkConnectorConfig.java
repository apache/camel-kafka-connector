...
public class CamelIec60870serverSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_PATH_URI_PATH_DOC = "The object information address";
    private static final String CAMEL_SINK_IEC60870SERVER_PATH_URI_PATH_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_DATA_MODULE_OPTIONS_DOC = "Data module options";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_DATA_MODULE_OPTIONS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_FILTER_NON_EXECUTE_DOC = "Filter out all requests which don't have the execute bit set";
    private static final Boolean CAMEL_SINK_IEC60870SERVER_ENDPOINT_FILTER_NON_EXECUTE_DEFAULT = true;
    public static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_PROTOCOL_OPTIONS_CONF = "camel.sink.endpoint.protocolOptions";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_PROTOCOL_OPTIONS_DOC = "Protocol options";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_PROTOCOL_OPTIONS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_IEC60870SERVER_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_IEC60870SERVER_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_IEC60870SERVER_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_ACKNOWLEDGE_WINDOW_DOC = "Parameter W - Acknowledgment window.";
    private static final Short CAMEL_SINK_IEC60870SERVER_ENDPOINT_ACKNOWLEDGE_WINDOW_DEFAULT = 10;
    public static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_ADSU_ADDRESS_TYPE_CONF = "camel.sink.endpoint.adsuAddressType";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_ADSU_ADDRESS_TYPE_DOC = "The common ASDU address size. May be either SIZE_1 or SIZE_2. One of: [SIZE_1] [SIZE_2]";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_ADSU_ADDRESS_TYPE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_CAUSE_OF_TRANSMISSION_TYPE_DOC = "The cause of transmission type. May be either SIZE_1 or SIZE_2. One of: [SIZE_1] [SIZE_2]";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_CAUSE_OF_TRANSMISSION_TYPE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_INFORMATION_OBJECT_ADDRESS_TYPE_DOC = "The information address size. May be either SIZE_1, SIZE_2 or SIZE_3. One of: [SIZE_1] [SIZE_2] [SIZE_3]";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_INFORMATION_OBJECT_ADDRESS_TYPE_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_MAX_UNACKNOWLEDGED_DOC = "Parameter K - Maximum number of un-acknowledged messages.";
    private static final Short CAMEL_SINK_IEC60870SERVER_ENDPOINT_MAX_UNACKNOWLEDGED_DEFAULT = 15;
    public static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_TIMEOUT_1CONF = "camel.sink.endpoint.timeout1";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_TIMEOUT_1DOC = "Timeout T1 in milliseconds.";
    private static final Integer CAMEL_SINK_IEC60870SERVER_ENDPOINT_TIMEOUT_1DEFAULT = 15000;
    public static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_TIMEOUT_2CONF = "camel.sink.endpoint.timeout2";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_TIMEOUT_2DOC = "Timeout T2 in milliseconds.";
    private static final Integer CAMEL_SINK_IEC60870SERVER_ENDPOINT_TIMEOUT_2DEFAULT = 10000;
    public static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_TIMEOUT_3CONF = "camel.sink.endpoint.timeout3";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_TIMEOUT_3DOC = "Timeout T3 in milliseconds.";
    private static final Integer CAMEL_SINK_IEC60870SERVER_ENDPOINT_TIMEOUT_3DEFAULT = 20000;
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_CAUSE_SOURCE_ADDRESS_DOC = "Whether to include the source address";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_CAUSE_SOURCE_ADDRESS_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_CONNECTION_TIMEOUT_DOC = "Timeout in millis to wait for client to establish a connected connection.";
    private static final Integer CAMEL_SINK_IEC60870SERVER_ENDPOINT_CONNECTION_TIMEOUT_DEFAULT = 10000;
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_IGNORE_BACKGROUND_SCAN_DOC = "Whether background scan transmissions should be ignored.";
    private static final Boolean CAMEL_SINK_IEC60870SERVER_ENDPOINT_IGNORE_BACKGROUND_SCAN_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_IGNORE_DAYLIGHT_SAVING_TIME_DOC = "Whether to ignore or respect DST";
    private static final Boolean CAMEL_SINK_IEC60870SERVER_ENDPOINT_IGNORE_DAYLIGHT_SAVING_TIME_DEFAULT = false;
    public static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_TIME_ZONE_CONF = "camel.sink.endpoint.timeZone";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_TIME_ZONE_DOC = "The timezone to use. May be any Java time zone string";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_TIME_ZONE_DEFAULT = "UTC";
    public static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_CONNECTION_ID_CONF = "camel.sink.endpoint.connectionId";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_CONNECTION_ID_DOC = "An identifier grouping connection instances";
    private static final String CAMEL_SINK_IEC60870SERVER_ENDPOINT_CONNECTION_ID_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_COMPONENT_DEFAULT_CONNECTION_OPTIONS_DOC = "Default connection options";
    private static final String CAMEL_SINK_IEC60870SERVER_COMPONENT_DEFAULT_CONNECTION_OPTIONS_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_IEC60870SERVER_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_IEC60870SERVER_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_IEC60870SERVER_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
