...
public class CamelEhcacheSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_EHCACHE_PATH_CACHE_NAME_DOC = "the cache name";
    private static final String CAMEL_SOURCE_EHCACHE_PATH_CACHE_NAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CACHE_MANAGER_CONF = "camel.source.endpoint.cacheManager";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CACHE_MANAGER_DOC = "The cache manager";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CACHE_MANAGER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CACHE_MANAGER_CONFIGURATION_DOC = "The cache manager configuration";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CACHE_MANAGER_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CONFIGURATION_URI_CONF = "camel.source.endpoint.configurationUri";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CONFIGURATION_URI_DOC = "URI pointing to the Ehcache XML configuration file's location";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CONFIGURATION_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CREATE_CACHE_IF_NOT_EXIST_DOC = "Configure if a cache need to be created if it does exist or can't be pre-configured.";
    private static final Boolean CAMEL_SOURCE_EHCACHE_ENDPOINT_CREATE_CACHE_IF_NOT_EXIST_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_EHCACHE_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_EVENT_FIRING_CONF = "camel.source.endpoint.eventFiring";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_EVENT_FIRING_DOC = "Set the delivery mode (synchronous, asynchronous) One of: [ASYNCHRONOUS] [SYNCHRONOUS]";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_EVENT_FIRING_DEFAULT = "ASYNCHRONOUS";
    public static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_EVENT_ORDERING_CONF = "camel.source.endpoint.eventOrdering";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_EVENT_ORDERING_DOC = "Set the delivery mode (ordered, unordered) One of: [UNORDERED] [ORDERED]";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_EVENT_ORDERING_DEFAULT = "ORDERED";
    public static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_EVENT_TYPES_CONF = "camel.source.endpoint.eventTypes";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_EVENT_TYPES_DOC = "Set the type of events to listen for (EVICTED,EXPIRED,REMOVED,CREATED,UPDATED). You can specify multiple entries separated by comma. One of: [EVICTED] [EXPIRED] [REMOVED] [CREATED] [UPDATED]";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_EVENT_TYPES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_EHCACHE_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CONFIGURATION_CONF = "camel.source.endpoint.configuration";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CONFIGURATION_DOC = "The default cache configuration to be used to create caches.";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CONFIGURATIONS_CONF = "camel.source.endpoint.configurations";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CONFIGURATIONS_DOC = "A map of cache configuration to be used to create caches.";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_CONFIGURATIONS_DEFAULT = null;
    public static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_KEY_TYPE_CONF = "camel.source.endpoint.keyType";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_KEY_TYPE_DOC = "The cache key type, default java.lang.Object";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_KEY_TYPE_DEFAULT = null;
    public static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_EHCACHE_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_VALUE_TYPE_CONF = "camel.source.endpoint.valueType";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_VALUE_TYPE_DOC = "The cache value type, default java.lang.Object";
    private static final String CAMEL_SOURCE_EHCACHE_ENDPOINT_VALUE_TYPE_DEFAULT = null;
    public static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CACHE_MANAGER_CONF = "camel.component.ehcache.cacheManager";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CACHE_MANAGER_DOC = "The cache manager";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CACHE_MANAGER_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CACHE_MANAGER_CONFIGURATION_DOC = "The cache manager configuration";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CACHE_MANAGER_CONFIGURATION_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CONFIGURATION_URI_DOC = "URI pointing to the Ehcache XML configuration file's location";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CONFIGURATION_URI_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CREATE_CACHE_IF_NOT_EXIST_DOC = "Configure if a cache need to be created if it does exist or can't be pre-configured.";
    private static final Boolean CAMEL_SOURCE_EHCACHE_COMPONENT_CREATE_CACHE_IF_NOT_EXIST_DEFAULT = true;
    ...
    private static final Boolean CAMEL_SOURCE_EHCACHE_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    public static final String CAMEL_SOURCE_EHCACHE_COMPONENT_EVENT_FIRING_CONF = "camel.component.ehcache.eventFiring";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_EVENT_FIRING_DOC = "Set the delivery mode (synchronous, asynchronous) One of: [ASYNCHRONOUS] [SYNCHRONOUS]";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_EVENT_FIRING_DEFAULT = "ASYNCHRONOUS";
    public static final String CAMEL_SOURCE_EHCACHE_COMPONENT_EVENT_ORDERING_CONF = "camel.component.ehcache.eventOrdering";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_EVENT_ORDERING_DOC = "Set the delivery mode (ordered, unordered) One of: [UNORDERED] [ORDERED]";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_EVENT_ORDERING_DEFAULT = "ORDERED";
    public static final String CAMEL_SOURCE_EHCACHE_COMPONENT_EVENT_TYPES_CONF = "camel.component.ehcache.eventTypes";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_EVENT_TYPES_DOC = "Set the type of events to listen for (EVICTED,EXPIRED,REMOVED,CREATED,UPDATED). You can specify multiple entries separated by comma. One of: [EVICTED] [EXPIRED] [REMOVED] [CREATED] [UPDATED]";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_EVENT_TYPES_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_EHCACHE_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CONFIGURATION_CONF = "camel.component.ehcache.configuration";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CONFIGURATION_DOC = "The default cache configuration to be used to create caches.";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CONFIGURATIONS_CONF = "camel.component.ehcache.configurations";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CONFIGURATIONS_DOC = "A map of cache configuration to be used to create caches.";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_CONFIGURATIONS_DEFAULT = null;
    public static final String CAMEL_SOURCE_EHCACHE_COMPONENT_KEY_TYPE_CONF = "camel.component.ehcache.keyType";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_KEY_TYPE_DOC = "The cache key type, default java.lang.Object";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_KEY_TYPE_DEFAULT = null;
    public static final String CAMEL_SOURCE_EHCACHE_COMPONENT_VALUE_TYPE_CONF = "camel.component.ehcache.valueType";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_VALUE_TYPE_DOC = "The cache value type, default java.lang.Object";
    private static final String CAMEL_SOURCE_EHCACHE_COMPONENT_VALUE_TYPE_DEFAULT = null;
