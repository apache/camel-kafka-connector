...
public class CamelEhcacheSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static final String CAMEL_SINK_EHCACHE_COMPONENT_CACHE_CONFIGURATION_CONF = "camel.component.ehcache.cacheConfiguration";
    public static final String CAMEL_SINK_EHCACHE_COMPONENT_CACHE_CONFIGURATION_DOC = "The default cache configuration to be used to create caches.";
    public static final String CAMEL_SINK_EHCACHE_COMPONENT_CACHE_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_EHCACHE_COMPONENT_CACHE_CONFIGURATION_URI_CONF = "camel.component.ehcache.cacheConfigurationUri";
    public static final String CAMEL_SINK_EHCACHE_COMPONENT_CACHE_CONFIGURATION_URI_DOC = "URI pointing to the Ehcache XML configuration file's location";
    public static final String CAMEL_SINK_EHCACHE_COMPONENT_CACHE_CONFIGURATION_URI_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_EHCACHE_COMPONENT_CACHES_CONFIGURATIONS_CONF = "camel.component.ehcache.cachesConfigurations";
    public static final String CAMEL_SINK_EHCACHE_COMPONENT_CACHES_CONFIGURATIONS_DOC = "A map of caches configurations to be used to create caches.";
    public static final String CAMEL_SINK_EHCACHE_COMPONENT_CACHES_CONFIGURATIONS_DEFAULT = null;
    ...
    public static final String CAMEL_SINK_EHCACHE_COMPONENT_CONFIGURATION_DOC = "Sets the global component configuration";
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SINK_EHCACHE_COMPONENT_CACHE_CONFIGURATION_CONF, ConfigDef.Type.STRING, CAMEL_SINK_EHCACHE_COMPONENT_CACHE_CONFIGURATION_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_EHCACHE_COMPONENT_CACHE_CONFIGURATION_DOC);
        conf.define(CAMEL_SINK_EHCACHE_COMPONENT_CACHE_CONFIGURATION_URI_CONF, ConfigDef.Type.STRING, CAMEL_SINK_EHCACHE_COMPONENT_CACHE_CONFIGURATION_URI_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_EHCACHE_COMPONENT_CACHE_CONFIGURATION_URI_DOC);
        ...
        conf.define(CAMEL_SINK_EHCACHE_COMPONENT_CACHES_CONFIGURATIONS_CONF, ConfigDef.Type.STRING, CAMEL_SINK_EHCACHE_COMPONENT_CACHES_CONFIGURATIONS_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_EHCACHE_COMPONENT_CACHES_CONFIGURATIONS_DOC);
