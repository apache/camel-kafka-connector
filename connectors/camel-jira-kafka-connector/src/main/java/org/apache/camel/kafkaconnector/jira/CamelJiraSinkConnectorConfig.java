...
public class CamelJiraSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    private static final String CAMEL_SINK_JIRA_PATH_TYPE_DEFAULT = null;
    public static final String CAMEL_SINK_JIRA_ENDPOINT_DELAY_CONF = "camel.sink.endpoint.delay";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_DELAY_DOC = "Time in milliseconds to elapse for the next poll.";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_DELAY_DEFAULT = "6000";
    public static final String CAMEL_SINK_JIRA_ENDPOINT_JIRA_URL_CONF = "camel.sink.endpoint.jiraUrl";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_JIRA_URL_DOC = "The Jira server url, example: http://my_jira.com:8081";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_JIRA_URL_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JIRA_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    public static final String CAMEL_SINK_JIRA_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.sink.endpoint.basicPropertyBinding";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JIRA_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JIRA_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_JIRA_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_JIRA_ENDPOINT_ACCESS_TOKEN_CONF = "camel.sink.endpoint.accessToken";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_ACCESS_TOKEN_DOC = "(OAuth only) The access token generated by the Jira server.";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_ACCESS_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_JIRA_ENDPOINT_CONSUMER_KEY_CONF = "camel.sink.endpoint.consumerKey";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_CONSUMER_KEY_DOC = "(OAuth only) The consumer key from Jira settings.";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_CONSUMER_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_JIRA_ENDPOINT_PASSWORD_CONF = "camel.sink.endpoint.password";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_PASSWORD_DOC = "(Basic authentication only) The password to authenticate to the Jira server. Use only if username basic authentication is used.";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_JIRA_ENDPOINT_PRIVATE_KEY_CONF = "camel.sink.endpoint.privateKey";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_PRIVATE_KEY_DOC = "(OAuth only) The private key generated by the client to encrypt the conversation to the server.";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_PRIVATE_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_JIRA_ENDPOINT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_JIRA_ENDPOINT_VERIFICATION_CODE_CONF = "camel.sink.endpoint.verificationCode";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_VERIFICATION_CODE_DOC = "(OAuth only) The verification code from Jira generated in the first step of the authorization proccess.";
    private static final String CAMEL_SINK_JIRA_ENDPOINT_VERIFICATION_CODE_DEFAULT = null;
    public static final String CAMEL_SINK_JIRA_COMPONENT_DELAY_CONF = "camel.component.jira.delay";
    private static final String CAMEL_SINK_JIRA_COMPONENT_DELAY_DOC = "Time in milliseconds to elapse for the next poll.";
    private static final String CAMEL_SINK_JIRA_COMPONENT_DELAY_DEFAULT = "6000";
    public static final String CAMEL_SINK_JIRA_COMPONENT_JIRA_URL_CONF = "camel.component.jira.jiraUrl";
    private static final String CAMEL_SINK_JIRA_COMPONENT_JIRA_URL_DOC = "The Jira server url, example: http://my_jira.com:8081";
    private static final String CAMEL_SINK_JIRA_COMPONENT_JIRA_URL_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SINK_JIRA_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_JIRA_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_JIRA_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_JIRA_COMPONENT_CONFIGURATION_CONF = "camel.component.jira.configuration";
    private static final String CAMEL_SINK_JIRA_COMPONENT_CONFIGURATION_DOC = "To use a shared base jira configuration.";
    private static final String CAMEL_SINK_JIRA_COMPONENT_CONFIGURATION_DEFAULT = null;
    public static final String CAMEL_SINK_JIRA_COMPONENT_ACCESS_TOKEN_CONF = "camel.component.jira.accessToken";
    private static final String CAMEL_SINK_JIRA_COMPONENT_ACCESS_TOKEN_DOC = "(OAuth only) The access token generated by the Jira server.";
    private static final String CAMEL_SINK_JIRA_COMPONENT_ACCESS_TOKEN_DEFAULT = null;
    public static final String CAMEL_SINK_JIRA_COMPONENT_CONSUMER_KEY_CONF = "camel.component.jira.consumerKey";
    private static final String CAMEL_SINK_JIRA_COMPONENT_CONSUMER_KEY_DOC = "(OAuth only) The consumer key from Jira settings.";
    private static final String CAMEL_SINK_JIRA_COMPONENT_CONSUMER_KEY_DEFAULT = null;
    public static final String CAMEL_SINK_JIRA_COMPONENT_PASSWORD_CONF = "camel.component.jira.password";
    private static final String CAMEL_SINK_JIRA_COMPONENT_PASSWORD_DOC = "(Basic authentication only) The password to authenticate to the Jira server. Use only if username basic authentication is used.";
    private static final String CAMEL_SINK_JIRA_COMPONENT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SINK_JIRA_COMPONENT_PRIVATE_KEY_CONF = "camel.component.jira.privateKey";
    private static final String CAMEL_SINK_JIRA_COMPONENT_PRIVATE_KEY_DOC = "(OAuth only) The private key generated by the client to encrypt the conversation to the server.";
    private static final String CAMEL_SINK_JIRA_COMPONENT_PRIVATE_KEY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_JIRA_COMPONENT_USERNAME_DEFAULT = null;
    public static final String CAMEL_SINK_JIRA_COMPONENT_VERIFICATION_CODE_CONF = "camel.component.jira.verificationCode";
    private static final String CAMEL_SINK_JIRA_COMPONENT_VERIFICATION_CODE_DOC = "(OAuth only) The verification code from Jira generated in the first step of the authorization proccess.";
    private static final String CAMEL_SINK_JIRA_COMPONENT_VERIFICATION_CODE_DEFAULT = null;
