...
public class CamelAwss3streaminguploadsinkSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_AWSS3STREAMINGUPLOADSINK_KAMELET_KEY_NAME_DOC = "Setting the key name for an element in the bucket through endpoint parameter. In Streaming Upload, with the default configuration, this is the base for the progressive creation of files.";
    ...
    public static final String CAMEL_SINK_AWSS3STREAMINGUPLOADSINK_KAMELET_PROFILE_CREDENTIALS_NAME_DOC = "If using a profile credentials provider this parameter sets the profile name.";
