...
public class CamelXmppSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_XMPP_PATH_HOST_DOC = "Hostname for the chat server";
    private static final String CAMEL_SOURCE_XMPP_PATH_HOST_DEFAULT = null;
    public static final String CAMEL_SOURCE_XMPP_PATH_PORT_CONF = "camel.source.path.port";
    private static final String CAMEL_SOURCE_XMPP_PATH_PORT_DOC = "Port number for the chat server";
    private static final Integer CAMEL_SOURCE_XMPP_PATH_PORT_DEFAULT = null;
    public static final String CAMEL_SOURCE_XMPP_PATH_PARTICIPANT_CONF = "camel.source.path.participant";
    private static final String CAMEL_SOURCE_XMPP_PATH_PARTICIPANT_DOC = "JID (Jabber ID) of person to receive messages. room parameter has precedence over participant.";
    private static final String CAMEL_SOURCE_XMPP_PATH_PARTICIPANT_DEFAULT = null;
    public static final String CAMEL_SOURCE_XMPP_ENDPOINT_LOGIN_CONF = "camel.source.endpoint.login";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_LOGIN_DOC = "Whether to login the user.";
    private static final Boolean CAMEL_SOURCE_XMPP_ENDPOINT_LOGIN_DEFAULT = true;
    public static final String CAMEL_SOURCE_XMPP_ENDPOINT_NICKNAME_CONF = "camel.source.endpoint.nickname";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_NICKNAME_DOC = "Use nickname when joining room. If room is specified and nickname is not, user will be used for the nickname.";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_NICKNAME_DEFAULT = null;
    public static final String CAMEL_SOURCE_XMPP_ENDPOINT_PUBSUB_CONF = "camel.source.endpoint.pubsub";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_PUBSUB_DOC = "Accept pubsub packets on input, default is false";
    private static final Boolean CAMEL_SOURCE_XMPP_ENDPOINT_PUBSUB_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_ROOM_DEFAULT = null;
    public static final String CAMEL_SOURCE_XMPP_ENDPOINT_SERVICE_NAME_CONF = "camel.source.endpoint.serviceName";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_SERVICE_NAME_DOC = "The name of the service you are connecting to. For Google Talk, this would be gmail.com.";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_SERVICE_NAME_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_XMPP_ENDPOINT_TEST_CONNECTION_ON_STARTUP_DEFAULT = true;
    public static final String CAMEL_SOURCE_XMPP_ENDPOINT_CREATE_ACCOUNT_CONF = "camel.source.endpoint.createAccount";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_CREATE_ACCOUNT_DOC = "If true, an attempt to create an account will be made. Default is false.";
    private static final Boolean CAMEL_SOURCE_XMPP_ENDPOINT_CREATE_ACCOUNT_DEFAULT = false;
    public static final String CAMEL_SOURCE_XMPP_ENDPOINT_RESOURCE_CONF = "camel.source.endpoint.resource";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_RESOURCE_DOC = "XMPP resource. The default is Camel.";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_RESOURCE_DEFAULT = "Camel";
    ...
    private static final Boolean CAMEL_SOURCE_XMPP_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final Integer CAMEL_SOURCE_XMPP_ENDPOINT_CONNECTION_POLL_DELAY_DEFAULT = 10;
    public static final String CAMEL_SOURCE_XMPP_ENDPOINT_DOC_CONF = "camel.source.endpoint.doc";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_DOC_DOC = "Set a doc header on the IN message containing a Document form of the incoming packet; default is true if presence or pubsub are true, otherwise false";
    private static final Boolean CAMEL_SOURCE_XMPP_ENDPOINT_DOC_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_XMPP_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    ...
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_XMPP_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_XMPP_ENDPOINT_CONNECTION_CONFIG_CONF = "camel.source.endpoint.connectionConfig";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_CONNECTION_CONFIG_DOC = "To use an existing connection configuration. Currently org.jivesoftware.smack.tcp.XMPPTCPConnectionConfiguration is only supported (XMPP over TCP).";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_CONNECTION_CONFIG_DEFAULT = null;
    public static final String CAMEL_SOURCE_XMPP_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_XMPP_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_HEADER_FILTER_STRATEGY_DOC = "To use a custom HeaderFilterStrategy to filter header to and from Camel message.";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_HEADER_FILTER_STRATEGY_DEFAULT = null;
    public static final String CAMEL_SOURCE_XMPP_ENDPOINT_PASSWORD_CONF = "camel.source.endpoint.password";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_PASSWORD_DOC = "Password for login";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_XMPP_ENDPOINT_ROOM_PASSWORD_CONF = "camel.source.endpoint.roomPassword";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_ROOM_PASSWORD_DOC = "Password for room";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_ROOM_PASSWORD_DEFAULT = null;
    public static final String CAMEL_SOURCE_XMPP_ENDPOINT_USER_CONF = "camel.source.endpoint.user";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_USER_DOC = "User name (without server name). If not specified, anonymous login will be attempted.";
    private static final String CAMEL_SOURCE_XMPP_ENDPOINT_USER_DEFAULT = null;
    ...
    private static final Boolean CAMEL_SOURCE_XMPP_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_XMPP_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_XMPP_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
