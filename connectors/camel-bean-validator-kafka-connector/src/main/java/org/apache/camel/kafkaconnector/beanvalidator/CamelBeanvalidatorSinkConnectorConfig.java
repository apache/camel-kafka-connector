...
public class CamelBeanvalidatorSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_PATH_LABEL_DOC = "Where label is an arbitrary text value describing the endpoint";
    private static final String CAMEL_SINK_BEANVALIDATOR_PATH_LABEL_DEFAULT = null;
    public static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_GROUP_CONF = "camel.sink.endpoint.group";
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_GROUP_DOC = "To use a custom validation group";
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_GROUP_DEFAULT = "javax.validation.groups.Default";
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_IGNORE_XML_CONFIGURATION_DOC = "Whether to ignore data from the META-INF/validation.xml file.";
    private static final Boolean CAMEL_SINK_BEANVALIDATOR_ENDPOINT_IGNORE_XML_CONFIGURATION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_BEANVALIDATOR_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_BEANVALIDATOR_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_CONSTRAINT_VALIDATOR_FACTORY_DOC = "To use a custom ConstraintValidatorFactory";
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_CONSTRAINT_VALIDATOR_FACTORY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_MESSAGE_INTERPOLATOR_DOC = "To use a custom MessageInterpolator";
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_MESSAGE_INTERPOLATOR_DEFAULT = null;
    public static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_BEANVALIDATOR_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_TRAVERSABLE_RESOLVER_DOC = "To use a custom TraversableResolver";
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_TRAVERSABLE_RESOLVER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_VALIDATION_PROVIDER_RESOLVER_DOC = "To use a a custom ValidationProviderResolver";
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_VALIDATION_PROVIDER_RESOLVER_DEFAULT = null;
    public static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_VALIDATOR_FACTORY_CONF = "camel.sink.endpoint.validatorFactory";
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_VALIDATOR_FACTORY_DOC = "To use a custom ValidatorFactory";
    private static final String CAMEL_SINK_BEANVALIDATOR_ENDPOINT_VALIDATOR_FACTORY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_COMPONENT_IGNORE_XML_CONFIGURATION_DOC = "Whether to ignore data from the META-INF/validation.xml file.";
    private static final Boolean CAMEL_SINK_BEANVALIDATOR_COMPONENT_IGNORE_XML_CONFIGURATION_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_BEANVALIDATOR_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_BEANVALIDATOR_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_COMPONENT_CONSTRAINT_VALIDATOR_FACTORY_DOC = "To use a custom ConstraintValidatorFactory";
    private static final String CAMEL_SINK_BEANVALIDATOR_COMPONENT_CONSTRAINT_VALIDATOR_FACTORY_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_COMPONENT_MESSAGE_INTERPOLATOR_DOC = "To use a custom MessageInterpolator";
    private static final String CAMEL_SINK_BEANVALIDATOR_COMPONENT_MESSAGE_INTERPOLATOR_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_COMPONENT_TRAVERSABLE_RESOLVER_DOC = "To use a custom TraversableResolver";
    private static final String CAMEL_SINK_BEANVALIDATOR_COMPONENT_TRAVERSABLE_RESOLVER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_COMPONENT_VALIDATION_PROVIDER_RESOLVER_DOC = "To use a a custom ValidationProviderResolver";
    private static final String CAMEL_SINK_BEANVALIDATOR_COMPONENT_VALIDATION_PROVIDER_RESOLVER_DEFAULT = null;
    ...
    private static final String CAMEL_SINK_BEANVALIDATOR_COMPONENT_VALIDATOR_FACTORY_DOC = "To use a custom ValidatorFactory";
    private static final String CAMEL_SINK_BEANVALIDATOR_COMPONENT_VALIDATOR_FACTORY_DEFAULT = null;
