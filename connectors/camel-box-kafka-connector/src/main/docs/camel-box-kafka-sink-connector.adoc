...
| *camel.sink.path.apiName* | What kind of operation to perform One of: [collaborations] [comments] [event-logs] [files] [folders] [groups] [events] [search] [tasks] [users] | null | HIGH
