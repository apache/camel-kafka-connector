...
public class CamelDisruptorvmSinkConnectorConfig
    ...
    public static final String CAMEL_SINK_DISRUPTORVM_COMPONENT_QUEUE_SIZE_CONF = "camel.component.disruptor-vm.queueSize";
    public static final String CAMEL_SINK_DISRUPTORVM_COMPONENT_QUEUE_SIZE_DOC = "To configure the ring buffer size";
    public static final Integer CAMEL_SINK_DISRUPTORVM_COMPONENT_QUEUE_SIZE_DEFAULT = null;
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SINK_DISRUPTORVM_COMPONENT_QUEUE_SIZE_CONF, ConfigDef.Type.INT, CAMEL_SINK_DISRUPTORVM_COMPONENT_QUEUE_SIZE_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SINK_DISRUPTORVM_COMPONENT_QUEUE_SIZE_DOC);
