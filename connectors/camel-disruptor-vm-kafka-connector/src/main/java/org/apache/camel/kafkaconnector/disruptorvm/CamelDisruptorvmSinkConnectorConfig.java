...
public class CamelDisruptorvmSinkConnectorConfig
    ...
    private static final String CAMEL_SINK_DISRUPTORVM_PATH_NAME_DOC = "Name of queue";
    private static final String CAMEL_SINK_DISRUPTORVM_PATH_NAME_DEFAULT = null;
    ...
    private static final Integer CAMEL_SINK_DISRUPTORVM_ENDPOINT_SIZE_DEFAULT = 1024;
    ...
    private static final Boolean CAMEL_SINK_DISRUPTORVM_ENDPOINT_BLOCK_WHEN_FULL_DEFAULT = false;
    ...
    private static final Boolean CAMEL_SINK_DISRUPTORVM_ENDPOINT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_DISRUPTORVM_ENDPOINT_PRODUCER_TYPE_DEFAULT = "Multi";
    public static final String CAMEL_SINK_DISRUPTORVM_ENDPOINT_TIMEOUT_CONF = "camel.sink.endpoint.timeout";
    private static final String CAMEL_SINK_DISRUPTORVM_ENDPOINT_TIMEOUT_DOC = "Timeout (in milliseconds) before a producer will stop waiting for an asynchronous task to complete. You can disable timeout by using 0 or a negative value.";
    private static final Long CAMEL_SINK_DISRUPTORVM_ENDPOINT_TIMEOUT_DEFAULT = 30000L;
    ...
    private static final String CAMEL_SINK_DISRUPTORVM_ENDPOINT_WAIT_FOR_TASK_TO_COMPLETE_DEFAULT = "IfReplyExpected";
    ...
    private static final String CAMEL_SINK_DISRUPTORVM_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_DISRUPTORVM_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SINK_DISRUPTORVM_ENDPOINT_SYNCHRONOUS_CONF = "camel.sink.endpoint.synchronous";
    private static final String CAMEL_SINK_DISRUPTORVM_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SINK_DISRUPTORVM_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SINK_DISRUPTORVM_COMPONENT_BUFFER_SIZE_CONF = "camel.component.disruptor-vm.bufferSize";
    private static final String CAMEL_SINK_DISRUPTORVM_COMPONENT_BUFFER_SIZE_DOC = "To configure the ring buffer size";
    private static final Integer CAMEL_SINK_DISRUPTORVM_COMPONENT_BUFFER_SIZE_DEFAULT = 1024;
    ...
    private static final String CAMEL_SINK_DISRUPTORVM_COMPONENT_DEFAULT_BLOCK_WHEN_FULL_DOC = "To configure the default value for block when full The default value is true.";
    private static final Boolean CAMEL_SINK_DISRUPTORVM_COMPONENT_DEFAULT_BLOCK_WHEN_FULL_DEFAULT = true;
    ...
    private static final String CAMEL_SINK_DISRUPTORVM_COMPONENT_DEFAULT_PRODUCER_TYPE_DOC = "To configure the default value for DisruptorProducerType The default value is Multi. One of: [Single] [Multi]";
    private static final String CAMEL_SINK_DISRUPTORVM_COMPONENT_DEFAULT_PRODUCER_TYPE_DEFAULT = "Multi";
    ...
    private static final Boolean CAMEL_SINK_DISRUPTORVM_COMPONENT_LAZY_START_PRODUCER_DEFAULT = false;
    ...
    private static final String CAMEL_SINK_DISRUPTORVM_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SINK_DISRUPTORVM_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
