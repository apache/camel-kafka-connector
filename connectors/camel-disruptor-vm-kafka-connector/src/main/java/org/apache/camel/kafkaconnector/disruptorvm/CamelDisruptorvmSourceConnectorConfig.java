...
public class CamelDisruptorvmSourceConnectorConfig
    ...
    private static final String CAMEL_SOURCE_DISRUPTORVM_PATH_NAME_DOC = "Name of queue";
    private static final String CAMEL_SOURCE_DISRUPTORVM_PATH_NAME_DEFAULT = null;
    ...
    private static final Integer CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_SIZE_DEFAULT = 1024;
    ...
    private static final Boolean CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_CONCURRENT_CONSUMERS_DOC = "Number of concurrent threads processing exchanges.";
    private static final Integer CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final Boolean CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_MULTIPLE_CONSUMERS_DEFAULT = false;
    public static final String CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_WAIT_STRATEGY_CONF = "camel.source.endpoint.waitStrategy";
    private static final String CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_WAIT_STRATEGY_DOC = "Defines the strategy used by consumer threads to wait on new exchanges to be published. The options allowed are:Blocking, Sleeping, BusySpin and Yielding. One of: [Blocking] [Sleeping] [BusySpin] [Yielding]";
    private static final String CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_WAIT_STRATEGY_DEFAULT = "Blocking";
    ...
    private static final String CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_EXCEPTION_HANDLER_DEFAULT = null;
    public static final String CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_EXCHANGE_PATTERN_CONF = "camel.source.endpoint.exchangePattern";
    private static final String CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_EXCHANGE_PATTERN_DOC = "Sets the exchange pattern when the consumer creates an exchange. One of: [InOnly] [InOut] [InOptionalOut]";
    private static final String CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_EXCHANGE_PATTERN_DEFAULT = null;
    public static final String CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_BASIC_PROPERTY_BINDING_CONF = "camel.source.endpoint.basicPropertyBinding";
    private static final String CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    public static final String CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_SYNCHRONOUS_CONF = "camel.source.endpoint.synchronous";
    private static final String CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_SYNCHRONOUS_DOC = "Sets whether synchronous processing should be strictly used, or Camel is allowed to use asynchronous processing (if supported).";
    private static final Boolean CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_SYNCHRONOUS_DEFAULT = false;
    public static final String CAMEL_SOURCE_DISRUPTORVM_COMPONENT_BUFFER_SIZE_CONF = "camel.component.disruptor-vm.bufferSize";
    private static final String CAMEL_SOURCE_DISRUPTORVM_COMPONENT_BUFFER_SIZE_DOC = "To configure the ring buffer size";
    private static final Integer CAMEL_SOURCE_DISRUPTORVM_COMPONENT_BUFFER_SIZE_DEFAULT = 1024;
    ...
    private static final Boolean CAMEL_SOURCE_DISRUPTORVM_COMPONENT_BRIDGE_ERROR_HANDLER_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DISRUPTORVM_COMPONENT_DEFAULT_CONCURRENT_CONSUMERS_DOC = "To configure the default number of concurrent consumers";
    private static final Integer CAMEL_SOURCE_DISRUPTORVM_COMPONENT_DEFAULT_CONCURRENT_CONSUMERS_DEFAULT = 1;
    ...
    private static final String CAMEL_SOURCE_DISRUPTORVM_COMPONENT_DEFAULT_MULTIPLE_CONSUMERS_DOC = "To configure the default value for multiple consumers";
    private static final Boolean CAMEL_SOURCE_DISRUPTORVM_COMPONENT_DEFAULT_MULTIPLE_CONSUMERS_DEFAULT = false;
    ...
    private static final String CAMEL_SOURCE_DISRUPTORVM_COMPONENT_DEFAULT_WAIT_STRATEGY_DOC = "To configure the default value for DisruptorWaitStrategy The default value is Blocking. One of: [Blocking] [Sleeping] [BusySpin] [Yielding]";
    private static final String CAMEL_SOURCE_DISRUPTORVM_COMPONENT_DEFAULT_WAIT_STRATEGY_DEFAULT = "Blocking";
    public static final String CAMEL_SOURCE_DISRUPTORVM_COMPONENT_BASIC_PROPERTY_BINDING_CONF = "camel.component.disruptor-vm.basicPropertyBinding";
    private static final String CAMEL_SOURCE_DISRUPTORVM_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    private static final Boolean CAMEL_SOURCE_DISRUPTORVM_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
