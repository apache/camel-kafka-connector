...
public class CamelDisruptorvmSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_BASIC_PROPERTY_BINDING_DOC = "Whether the endpoint should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_DISRUPTORVM_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static final String CAMEL_SOURCE_DISRUPTORVM_COMPONENT_QUEUE_SIZE_CONF = "camel.component.disruptor-vm.queueSize";
    public static final String CAMEL_SOURCE_DISRUPTORVM_COMPONENT_QUEUE_SIZE_DOC = "To configure the ring buffer size";
    public static final Integer CAMEL_SOURCE_DISRUPTORVM_COMPONENT_QUEUE_SIZE_DEFAULT = null;
    ...
    public static final String CAMEL_SOURCE_DISRUPTORVM_COMPONENT_BASIC_PROPERTY_BINDING_DOC = "Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities";
    public static final Boolean CAMEL_SOURCE_DISRUPTORVM_COMPONENT_BASIC_PROPERTY_BINDING_DEFAULT = false;
    ...
    public static ConfigDef conf(Map<String, String> parsedConfig) {
        ...
        conf.define(CAMEL_SOURCE_DISRUPTORVM_COMPONENT_QUEUE_SIZE_CONF, ConfigDef.Type.INT, CAMEL_SOURCE_DISRUPTORVM_COMPONENT_QUEUE_SIZE_DEFAULT, ConfigDef.Importance.LOW, CAMEL_SOURCE_DISRUPTORVM_COMPONENT_QUEUE_SIZE_DOC);
