...
public class CamelIpfsSinkConnectorConfig extends CamelSinkConnectorConfig {
    ...
    public static ConfigDef conf() {
        ...
        conf.define(CAMEL_SINK_IPFS_ENDPOINT_BASIC_PROPERTY_BINDING_CONF, ConfigDef.Type.BOOLEAN, CAMEL_SINK_IPFS_ENDPOINT_BASIC_PROPERTY_BINDING_DEFAULT, ConfigDef.Importance.MEDIUM, CAMEL_SINK_IPFS_ENDPOINT_BASIC_PROPERTY_BINDING_DOC);
